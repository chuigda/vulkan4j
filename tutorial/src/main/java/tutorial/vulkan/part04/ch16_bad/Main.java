package tutorial.vulkan.part04.ch16_bad;
...
class Application {
    ...
    private void createSyncObjects() {
        ...
        pRenderFinishedSemaphores = VkSemaphore.Ptr.allocate(Arena.ofAuto(), MAX_FRAMES_IN_FLIGHT);
    ...
    private void drawFrame() {
        ...
        var pRenderFinishedSemaphore = pRenderFinishedSemaphores.offset(currentFrame);

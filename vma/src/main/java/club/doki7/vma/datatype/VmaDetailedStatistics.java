...
public record VmaDetailedStatistics(@NotNull MemorySegment segment) implements IVmaDetailedStatistics {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVmaDetailedStatistics, Iterable<VmaDetailedStatistics> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VmaDetailedStatistics.BYTES, VmaDetailedStatistics.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VmaDetailedStatistics> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VmaDetailedStatistics.BYTES) > 0;
            }

...
public record VmaVirtualAllocationCreateInfo(@NotNull MemorySegment segment) implements IVmaVirtualAllocationCreateInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVmaVirtualAllocationCreateInfo, Iterable<VmaVirtualAllocationCreateInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VmaVirtualAllocationCreateInfo.BYTES, VmaVirtualAllocationCreateInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VmaVirtualAllocationCreateInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VmaVirtualAllocationCreateInfo.BYTES) > 0;
            }

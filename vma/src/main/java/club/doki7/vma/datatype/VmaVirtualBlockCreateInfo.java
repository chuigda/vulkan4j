...
public record VmaVirtualBlockCreateInfo(@NotNull MemorySegment segment) implements IVmaVirtualBlockCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVmaVirtualBlockCreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VmaVirtualBlockCreateInfo.BYTES, VmaVirtualBlockCreateInfo.BYTES));
        }

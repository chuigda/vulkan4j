...
public record VmaVirtualAllocationInfo(@NotNull MemorySegment segment) implements IVmaVirtualAllocationInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVmaVirtualAllocationInfo, Iterable<VmaVirtualAllocationInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VmaVirtualAllocationInfo.BYTES, VmaVirtualAllocationInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VmaVirtualAllocationInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VmaVirtualAllocationInfo.BYTES) > 0;
            }

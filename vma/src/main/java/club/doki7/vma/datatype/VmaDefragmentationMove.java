...
public record VmaDefragmentationMove(@NotNull MemorySegment segment) implements IVmaDefragmentationMove {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVmaDefragmentationMove {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VmaDefragmentationMove.BYTES, VmaDefragmentationMove.BYTES));
        }

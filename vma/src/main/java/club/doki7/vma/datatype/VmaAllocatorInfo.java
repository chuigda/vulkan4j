...
public record VmaAllocatorInfo(@NotNull MemorySegment segment) implements IVmaAllocatorInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVmaAllocatorInfo, Iterable<VmaAllocatorInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VmaAllocatorInfo.BYTES, VmaAllocatorInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VmaAllocatorInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VmaAllocatorInfo.BYTES) > 0;
            }

...
public record VmaAllocationCreateInfo(@NotNull MemorySegment segment) implements IVmaAllocationCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVmaAllocationCreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VmaAllocationCreateInfo.BYTES, VmaAllocationCreateInfo.BYTES));
        }

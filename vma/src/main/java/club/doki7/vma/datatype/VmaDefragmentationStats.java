...
public record VmaDefragmentationStats(@NotNull MemorySegment segment) implements IVmaDefragmentationStats {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVmaDefragmentationStats, Iterable<VmaDefragmentationStats> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VmaDefragmentationStats.BYTES, VmaDefragmentationStats.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VmaDefragmentationStats> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VmaDefragmentationStats.BYTES) > 0;
            }

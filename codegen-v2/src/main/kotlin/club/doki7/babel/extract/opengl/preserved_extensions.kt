...
val keptOpenGLExtensions = setOf(
    // CGL, macOS specific windowing API
    "CGL",
    // GLX, X11 specific windowing API
    "GLX",
    ...
    "GLX_SGI_video_sync",
    // WGL, Windows specific windowing API
    "WGL",
    ...
    // We won't be supporting window system relevant APIs and extensions in this edition (0.3.2),
    // since GLFW could do these job. However they may be introduced in the future.

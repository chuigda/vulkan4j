...
public record VkCuModuleNVX(MemorySegment segment) {
    ...
    public static final class VkCuModuleNVXFactory implements IDataTypeFactory<VkCuModuleNVX> {
        @Override
    ...
    public static final VkCuModuleNVXFactory FACTORY = new VkCuModuleNVXFactory();
}
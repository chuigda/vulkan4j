...
public record VkSemaphore(MemorySegment segment) {
    ...
    public static final class VkSemaphoreFactory implements IDataTypeFactory<VkSemaphore> {
        @Override
    ...
    public static final VkSemaphoreFactory FACTORY = new VkSemaphoreFactory();
}
...
public record VkDeviceGroupDeviceCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$pPhysicalDevices = PathElement.groupElement(3);
    ...
    public static final class VkDeviceGroupDeviceCreateInfoFactory implements IDataTypeFactory<VkDeviceGroupDeviceCreateInfo> {
        @Override
    ...
    public static final VkDeviceGroupDeviceCreateInfoFactory FACTORY = new VkDeviceGroupDeviceCreateInfoFactory();
}

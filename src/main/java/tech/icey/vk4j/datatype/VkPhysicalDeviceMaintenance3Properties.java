...
public record VkPhysicalDeviceMaintenance3Properties(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxPerSetDescriptors = PathElement.groupElement(2);
    public static final PathElement PATH$maxMemoryAllocationSize = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceMaintenance3PropertiesFactory implements IDataTypeFactory<VkPhysicalDeviceMaintenance3Properties> {
        @Override
    ...
    public static final VkPhysicalDeviceMaintenance3PropertiesFactory FACTORY = new VkPhysicalDeviceMaintenance3PropertiesFactory();
}

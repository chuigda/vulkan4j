...
public record VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderModuleIdentifierAlgorithmUUID = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceShaderModuleIdentifierPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT> {
        @Override

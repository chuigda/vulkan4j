...
public record VkPhysicalDeviceShaderTileImagePropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderTileImageCoherentReadAccelerated = PathElement.groupElement(2);
    public static final PathElement PATH$shaderTileImageReadSampleFromPixelRateInvocation = PathElement.groupElement(3);
    public static final PathElement PATH$shaderTileImageReadFromHelperInvocation = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceShaderTileImagePropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceShaderTileImagePropertiesEXT> {
        @Override
    ...
    public static final VkPhysicalDeviceShaderTileImagePropertiesEXTFactory FACTORY = new VkPhysicalDeviceShaderTileImagePropertiesEXTFactory();
}

...
public record VkPipelineColorWriteCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$attachmentCount = PathElement.groupElement(2);
    public static final PathElement PATH$pColorWriteEnables = PathElement.groupElement(3);
    ...
    public static final class VkPipelineColorWriteCreateInfoEXTFactory implements IDataTypeFactory<VkPipelineColorWriteCreateInfoEXT> {
        @Override

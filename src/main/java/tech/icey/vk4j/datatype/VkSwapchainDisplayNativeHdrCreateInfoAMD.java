...
public record VkSwapchainDisplayNativeHdrCreateInfoAMD(MemorySegment segment) {
    ...
    public static final PathElement PATH$localDimmingEnable = PathElement.groupElement(2);
    ...
    public static final class VkSwapchainDisplayNativeHdrCreateInfoAMDFactory implements IDataTypeFactory<VkSwapchainDisplayNativeHdrCreateInfoAMD> {
        @Override

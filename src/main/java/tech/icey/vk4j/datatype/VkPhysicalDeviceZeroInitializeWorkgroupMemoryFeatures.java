...
public record VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderZeroInitializeWorkgroupMemory = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures> {
        @Override

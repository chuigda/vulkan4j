...
public record VkReleaseCapturedPipelineDataInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$pipeline = PathElement.groupElement(2);
    ...
    public static final class VkReleaseCapturedPipelineDataInfoKHRFactory implements IDataTypeFactory<VkReleaseCapturedPipelineDataInfoKHR> {
        @Override
    ...
    public static final VkReleaseCapturedPipelineDataInfoKHRFactory FACTORY = new VkReleaseCapturedPipelineDataInfoKHRFactory();
}

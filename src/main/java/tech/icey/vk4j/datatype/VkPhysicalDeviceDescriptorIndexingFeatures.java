...
public record VkPhysicalDeviceDescriptorIndexingFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderInputAttachmentArrayDynamicIndexing = PathElement.groupElement(2);
    public static final PathElement PATH$shaderUniformTexelBufferArrayDynamicIndexing = PathElement.groupElement(3);
    public static final PathElement PATH$shaderStorageTexelBufferArrayDynamicIndexing = PathElement.groupElement(4);
    public static final PathElement PATH$shaderUniformBufferArrayNonUniformIndexing = PathElement.groupElement(5);
    public static final PathElement PATH$shaderSampledImageArrayNonUniformIndexing = PathElement.groupElement(6);
    public static final PathElement PATH$shaderStorageBufferArrayNonUniformIndexing = PathElement.groupElement(7);
    public static final PathElement PATH$shaderStorageImageArrayNonUniformIndexing = PathElement.groupElement(8);
    public static final PathElement PATH$shaderInputAttachmentArrayNonUniformIndexing = PathElement.groupElement(9);
    public static final PathElement PATH$shaderUniformTexelBufferArrayNonUniformIndexing = PathElement.groupElement(10);
    public static final PathElement PATH$shaderStorageTexelBufferArrayNonUniformIndexing = PathElement.groupElement(11);
    public static final PathElement PATH$descriptorBindingUniformBufferUpdateAfterBind = PathElement.groupElement(12);
    public static final PathElement PATH$descriptorBindingSampledImageUpdateAfterBind = PathElement.groupElement(13);
    public static final PathElement PATH$descriptorBindingStorageImageUpdateAfterBind = PathElement.groupElement(14);
    public static final PathElement PATH$descriptorBindingStorageBufferUpdateAfterBind = PathElement.groupElement(15);
    public static final PathElement PATH$descriptorBindingUniformTexelBufferUpdateAfterBind = PathElement.groupElement(16);
    public static final PathElement PATH$descriptorBindingStorageTexelBufferUpdateAfterBind = PathElement.groupElement(17);
    public static final PathElement PATH$descriptorBindingUpdateUnusedWhilePending = PathElement.groupElement(18);
    public static final PathElement PATH$descriptorBindingPartiallyBound = PathElement.groupElement(19);
    public static final PathElement PATH$descriptorBindingVariableDescriptorCount = PathElement.groupElement(20);
    public static final PathElement PATH$runtimeDescriptorArray = PathElement.groupElement(21);
    ...
    public static final class VkPhysicalDeviceDescriptorIndexingFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceDescriptorIndexingFeatures> {
        @Override
        public Class<VkPhysicalDeviceDescriptorIndexingFeatures> clazz() {
            return VkPhysicalDeviceDescriptorIndexingFeatures.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkPhysicalDeviceDescriptorIndexingFeatures.LAYOUT;
        }
    ...
    public static final VkPhysicalDeviceDescriptorIndexingFeaturesFactory FACTORY = new VkPhysicalDeviceDescriptorIndexingFeaturesFactory();
}

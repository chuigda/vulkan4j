...
public record VkPhysicalDeviceCornerSampledImageFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$cornerSampledImage = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceCornerSampledImageFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceCornerSampledImageFeaturesNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceCornerSampledImageFeaturesNV.LAYOUT;
        }

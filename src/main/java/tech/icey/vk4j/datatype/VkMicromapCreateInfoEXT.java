...
public record VkMicromapCreateInfoEXT(MemorySegment segment) {
    ...
    public static final class VkMicromapCreateInfoEXTFactory implements IDataTypeFactory<VkMicromapCreateInfoEXT> {
        @Override
        public Class<VkMicromapCreateInfoEXT> clazz() {
            return VkMicromapCreateInfoEXT.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkMicromapCreateInfoEXT.LAYOUT;
        }
    ...
    public static final VkMicromapCreateInfoEXTFactory FACTORY = new VkMicromapCreateInfoEXTFactory();
}

...
public record VkSubresourceLayout(MemorySegment segment) {
    ...
    public static final class VkSubresourceLayoutFactory implements IDataTypeFactory<VkSubresourceLayout> {
        @Override
    ...
    public static final VkSubresourceLayoutFactory FACTORY = new VkSubresourceLayoutFactory();
}

...
public record VkAccelerationStructureMotionInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxInstances = PathElement.groupElement(2);
    ...
    public static final class VkAccelerationStructureMotionInfoNVFactory implements IDataTypeFactory<VkAccelerationStructureMotionInfoNV> {
        @Override

...
public record VkCopyImageToImageInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$dstImage = PathElement.groupElement(5);
    public static final PathElement PATH$dstImageLayout = PathElement.groupElement(6);
    public static final PathElement PATH$regionCount = PathElement.groupElement(7);
    public static final PathElement PATH$pRegions = PathElement.groupElement(8);
    ...
    public VkCopyImageToImageInfoEXT(MemorySegment segment) {
        ...
        this.sType(VK_STRUCTURE_TYPE_COPY_IMAGE_TO_IMAGE_INFO_EXT);
    }
    ...
    public static final class VkCopyImageToImageInfoEXTFactory implements IDataTypeFactory<VkCopyImageToImageInfoEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkCopyImageToImageInfoEXT.LAYOUT;
        }

        @Override
        public VkCopyImageToImageInfoEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkCopyImageToImageInfoEXT createUninit(MemorySegment segment) {
            return new VkCopyImageToImageInfoEXT(segment);
        }
    }

    public static final VkCopyImageToImageInfoEXTFactory FACTORY = new VkCopyImageToImageInfoEXTFactory();
}

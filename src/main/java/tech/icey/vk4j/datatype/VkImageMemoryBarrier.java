...
public record VkImageMemoryBarrier(MemorySegment segment) {
    ...
    public static final class VkImageMemoryBarrierFactory implements IDataTypeFactory<VkImageMemoryBarrier> {
        @Override
    ...
    public static final VkImageMemoryBarrierFactory FACTORY = new VkImageMemoryBarrierFactory();
}

...
public record VkSetLatencyMarkerInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$marker = PathElement.groupElement(3);
    ...
    public static final class VkSetLatencyMarkerInfoNVFactory implements IDataTypeFactory<VkSetLatencyMarkerInfoNV> {
        @Override

...
public record VkBufferDeviceAddressInfo(MemorySegment segment) {
    ...
    public static final class VkBufferDeviceAddressInfoFactory implements IDataTypeFactory<VkBufferDeviceAddressInfo> {
        @Override
    ...
    public static final VkBufferDeviceAddressInfoFactory FACTORY = new VkBufferDeviceAddressInfoFactory();
}

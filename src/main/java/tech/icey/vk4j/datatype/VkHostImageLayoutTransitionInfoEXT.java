...
public record VkHostImageLayoutTransitionInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$oldLayout = PathElement.groupElement(3);
    public static final PathElement PATH$newLayout = PathElement.groupElement(4);
    public static final PathElement PATH$subresourceRange = PathElement.groupElement(5);
    ...
    public static final class VkHostImageLayoutTransitionInfoEXTFactory implements IDataTypeFactory<VkHostImageLayoutTransitionInfoEXT> {
        @Override

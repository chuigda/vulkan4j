...
public record VkPhysicalDeviceTransformFeedbackFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$transformFeedback = PathElement.groupElement(2);
    public static final PathElement PATH$geometryStreams = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceTransformFeedbackFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceTransformFeedbackFeaturesEXT> {
        @Override

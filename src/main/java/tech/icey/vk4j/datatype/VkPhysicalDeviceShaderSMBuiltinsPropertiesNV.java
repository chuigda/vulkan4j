...
public record VkPhysicalDeviceShaderSMBuiltinsPropertiesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderSMCount = PathElement.groupElement(2);
    public static final PathElement PATH$shaderWarpsPerSM = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceShaderSMBuiltinsPropertiesNVFactory implements IDataTypeFactory<VkPhysicalDeviceShaderSMBuiltinsPropertiesNV> {
        @Override

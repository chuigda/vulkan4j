...
public record VkSemaphoreGetZirconHandleInfoFUCHSIA(MemorySegment segment) {
    ...
    public static final class VkSemaphoreGetZirconHandleInfoFUCHSIAFactory implements IDataTypeFactory<VkSemaphoreGetZirconHandleInfoFUCHSIA> {
        @Override
    ...
    public static final VkSemaphoreGetZirconHandleInfoFUCHSIAFactory FACTORY = new VkSemaphoreGetZirconHandleInfoFUCHSIAFactory();
}

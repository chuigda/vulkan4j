...
public record VkPhysicalDeviceOpacityMicromapPropertiesEXT(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceOpacityMicromapPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceOpacityMicromapPropertiesEXT> {
        @Override
    ...
    public static final VkPhysicalDeviceOpacityMicromapPropertiesEXTFactory FACTORY = new VkPhysicalDeviceOpacityMicromapPropertiesEXTFactory();
}

...
public record VkCopyBufferInfo2(MemorySegment segment) {
    ...
    public static final class VkCopyBufferInfo2Factory implements IDataTypeFactory<VkCopyBufferInfo2> {
        @Override
    ...
    public static final VkCopyBufferInfo2Factory FACTORY = new VkCopyBufferInfo2Factory();
}

...
public record VkPhysicalDeviceBufferDeviceAddressFeaturesEXT(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceBufferDeviceAddressFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceBufferDeviceAddressFeaturesEXT> {
        @Override
    ...
    public static final VkPhysicalDeviceBufferDeviceAddressFeaturesEXTFactory FACTORY = new VkPhysicalDeviceBufferDeviceAddressFeaturesEXTFactory();
}

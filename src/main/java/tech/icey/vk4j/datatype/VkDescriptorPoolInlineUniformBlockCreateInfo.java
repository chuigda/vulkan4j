...
public record VkDescriptorPoolInlineUniformBlockCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxInlineUniformBlockBindings = PathElement.groupElement(2);
    ...
    public static final class VkDescriptorPoolInlineUniformBlockCreateInfoFactory implements IDataTypeFactory<VkDescriptorPoolInlineUniformBlockCreateInfo> {
        @Override

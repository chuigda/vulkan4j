...
public record VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$primitiveTopologyListRestart = PathElement.groupElement(2);
    public static final PathElement PATH$primitiveTopologyPatchListRestart = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT> {
        @Override

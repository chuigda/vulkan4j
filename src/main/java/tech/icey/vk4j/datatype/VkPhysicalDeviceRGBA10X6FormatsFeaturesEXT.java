...
public record VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$formatRgba10x6WithoutYCbCrSampler = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceRGBA10X6FormatsFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT> {
        @Override

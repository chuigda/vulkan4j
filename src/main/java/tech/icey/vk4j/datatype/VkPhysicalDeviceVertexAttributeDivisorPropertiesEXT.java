...
public record VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxVertexAttribDivisor = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceVertexAttributeDivisorPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT.LAYOUT;
        }

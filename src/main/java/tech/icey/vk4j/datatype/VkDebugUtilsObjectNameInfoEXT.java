...
public record VkDebugUtilsObjectNameInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$objectHandle = PathElement.groupElement(3);
    public static final PathElement PATH$pObjectName = PathElement.groupElement(4);
    ...
    public static final class VkDebugUtilsObjectNameInfoEXTFactory implements IDataTypeFactory<VkDebugUtilsObjectNameInfoEXT> {
        @Override

...
public record VkDeviceFaultInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$description = PathElement.groupElement(2);
    public static final PathElement PATH$pAddressInfos = PathElement.groupElement(3);
    public static final PathElement PATH$pVendorInfos = PathElement.groupElement(4);
    public static final PathElement PATH$pVendorBinaryData = PathElement.groupElement(5);

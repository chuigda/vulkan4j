...
public record VkPhysicalDeviceExternalSciSync2FeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$sciSyncSemaphore2 = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceExternalSciSync2FeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceExternalSciSync2FeaturesNV> {
        @Override
    ...
    public static final VkPhysicalDeviceExternalSciSync2FeaturesNVFactory FACTORY = new VkPhysicalDeviceExternalSciSync2FeaturesNVFactory();
}

...
public record VkImportSemaphoreWin32HandleInfoKHR(MemorySegment segment) {
    ...
    public static final class VkImportSemaphoreWin32HandleInfoKHRFactory implements IDataTypeFactory<VkImportSemaphoreWin32HandleInfoKHR> {
        @Override
    ...
    public static final VkImportSemaphoreWin32HandleInfoKHRFactory FACTORY = new VkImportSemaphoreWin32HandleInfoKHRFactory();
}

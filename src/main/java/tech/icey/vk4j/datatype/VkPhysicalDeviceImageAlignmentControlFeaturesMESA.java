...
public record VkPhysicalDeviceImageAlignmentControlFeaturesMESA(MemorySegment segment) {
    ...
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA(MemorySegment segment) {
        ...
        this.sType(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ALIGNMENT_CONTROL_FEATURES_MESA);
    }
    ...
    public static final class VkPhysicalDeviceImageAlignmentControlFeaturesMESAFactory implements IDataTypeFactory<VkPhysicalDeviceImageAlignmentControlFeaturesMESA> {
        @Override
        public Class<VkPhysicalDeviceImageAlignmentControlFeaturesMESA> clazz() {
            return VkPhysicalDeviceImageAlignmentControlFeaturesMESA.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkPhysicalDeviceImageAlignmentControlFeaturesMESA.LAYOUT;
        }
    ...
    public static final VkPhysicalDeviceImageAlignmentControlFeaturesMESAFactory FACTORY = new VkPhysicalDeviceImageAlignmentControlFeaturesMESAFactory();
}

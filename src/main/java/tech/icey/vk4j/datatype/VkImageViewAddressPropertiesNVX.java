...
public record VkImageViewAddressPropertiesNVX(MemorySegment segment) {
    ...
    public static final class VkImageViewAddressPropertiesNVXFactory implements IDataTypeFactory<VkImageViewAddressPropertiesNVX> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkImageViewAddressPropertiesNVX.LAYOUT;
        }

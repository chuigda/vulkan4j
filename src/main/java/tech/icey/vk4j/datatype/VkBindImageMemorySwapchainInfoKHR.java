...
public record VkBindImageMemorySwapchainInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$imageIndex = PathElement.groupElement(3);
    ...
    public static final class VkBindImageMemorySwapchainInfoKHRFactory implements IDataTypeFactory<VkBindImageMemorySwapchainInfoKHR> {
        @Override
    ...
    public static final VkBindImageMemorySwapchainInfoKHRFactory FACTORY = new VkBindImageMemorySwapchainInfoKHRFactory();
}

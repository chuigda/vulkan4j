...
public record VkPipelineIndirectDeviceAddressInfoNV(MemorySegment segment) {
    ...
    public static final class VkPipelineIndirectDeviceAddressInfoNVFactory implements IDataTypeFactory<VkPipelineIndirectDeviceAddressInfoNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPipelineIndirectDeviceAddressInfoNV.LAYOUT;
        }

...
public record VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$imageSlicedViewOf3D = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT> {
        @Override

...
public record VkPhysicalDeviceLinearColorAttachmentFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$linearColorAttachment = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceLinearColorAttachmentFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceLinearColorAttachmentFeaturesNV> {
        @Override

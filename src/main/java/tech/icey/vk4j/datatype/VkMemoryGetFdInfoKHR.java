...
public record VkMemoryGetFdInfoKHR(MemorySegment segment) {
    ...
    public static final class VkMemoryGetFdInfoKHRFactory implements IDataTypeFactory<VkMemoryGetFdInfoKHR> {
        @Override
    ...
    public static final VkMemoryGetFdInfoKHRFactory FACTORY = new VkMemoryGetFdInfoKHRFactory();
}

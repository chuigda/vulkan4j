...
public record VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE(MemorySegment segment) {
    ...
    public static final PathElement PATH$descriptorSetHostMapping = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVEFactory implements IDataTypeFactory<VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE> {
        @Override

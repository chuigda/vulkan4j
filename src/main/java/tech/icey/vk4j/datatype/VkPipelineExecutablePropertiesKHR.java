...
public record VkPipelineExecutablePropertiesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$stages = PathElement.groupElement(2);
    public static final PathElement PATH$name = PathElement.groupElement(3);
    public static final PathElement PATH$description = PathElement.groupElement(4);
    public static final PathElement PATH$subgroupSize = PathElement.groupElement(5);
    ...
    public static final class VkPipelineExecutablePropertiesKHRFactory implements IDataTypeFactory<VkPipelineExecutablePropertiesKHR> {
        @Override

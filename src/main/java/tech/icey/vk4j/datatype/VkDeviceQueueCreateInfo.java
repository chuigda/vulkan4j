...
public record VkDeviceQueueCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$queueCount = PathElement.groupElement(4);
    public static final PathElement PATH$pQueuePriorities = PathElement.groupElement(5);
    ...
    public static final class VkDeviceQueueCreateInfoFactory implements IDataTypeFactory<VkDeviceQueueCreateInfo> {
        @Override

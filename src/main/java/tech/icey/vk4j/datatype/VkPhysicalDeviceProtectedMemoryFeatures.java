...
public record VkPhysicalDeviceProtectedMemoryFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$protectedMemory = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceProtectedMemoryFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceProtectedMemoryFeatures> {
        @Override

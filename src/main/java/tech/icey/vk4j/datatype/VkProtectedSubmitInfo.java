...
public record VkProtectedSubmitInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$protectedSubmit = PathElement.groupElement(2);
    ...
    public static final class VkProtectedSubmitInfoFactory implements IDataTypeFactory<VkProtectedSubmitInfo> {
        @Override

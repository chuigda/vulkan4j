...
public record VkSurfaceCapabilitiesFullScreenExclusiveEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$fullScreenExclusiveSupported = PathElement.groupElement(2);
    ...
    public static final class VkSurfaceCapabilitiesFullScreenExclusiveEXTFactory implements IDataTypeFactory<VkSurfaceCapabilitiesFullScreenExclusiveEXT> {
        @Override
        public Class<VkSurfaceCapabilitiesFullScreenExclusiveEXT> clazz() {
            return VkSurfaceCapabilitiesFullScreenExclusiveEXT.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkSurfaceCapabilitiesFullScreenExclusiveEXT.LAYOUT;
        }
    ...
    public static final VkSurfaceCapabilitiesFullScreenExclusiveEXTFactory FACTORY = new VkSurfaceCapabilitiesFullScreenExclusiveEXTFactory();
}

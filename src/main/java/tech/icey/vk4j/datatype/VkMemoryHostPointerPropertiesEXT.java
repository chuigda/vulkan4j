...
public record VkMemoryHostPointerPropertiesEXT(MemorySegment segment) {
    ...
    public static final class VkMemoryHostPointerPropertiesEXTFactory implements IDataTypeFactory<VkMemoryHostPointerPropertiesEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkMemoryHostPointerPropertiesEXT.LAYOUT;
        }

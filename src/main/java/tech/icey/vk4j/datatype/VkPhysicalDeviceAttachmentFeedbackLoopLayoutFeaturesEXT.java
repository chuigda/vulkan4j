...
public record VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$attachmentFeedbackLoopLayout = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT> {
        @Override

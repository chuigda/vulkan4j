...
public record VkQueryPoolPerformanceCreateInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$queueFamilyIndex = PathElement.groupElement(2);
    public static final PathElement PATH$counterIndexCount = PathElement.groupElement(3);
    public static final PathElement PATH$pCounterIndices = PathElement.groupElement(4);

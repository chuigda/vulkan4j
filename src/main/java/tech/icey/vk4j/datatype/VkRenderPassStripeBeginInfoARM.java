...
public record VkRenderPassStripeBeginInfoARM(MemorySegment segment) {
    ...
    public static final PathElement PATH$stripeInfoCount = PathElement.groupElement(2);
    public static final PathElement PATH$pStripeInfos = PathElement.groupElement(3);
    ...
    public static final class VkRenderPassStripeBeginInfoARMFactory implements IDataTypeFactory<VkRenderPassStripeBeginInfoARM> {
        @Override

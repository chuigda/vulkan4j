...
public record VkImportMemoryWin32HandleInfoKHR(MemorySegment segment) {
    ...
    public static final class VkImportMemoryWin32HandleInfoKHRFactory implements IDataTypeFactory<VkImportMemoryWin32HandleInfoKHR> {
        @Override
    ...
    public static final VkImportMemoryWin32HandleInfoKHRFactory FACTORY = new VkImportMemoryWin32HandleInfoKHRFactory();
}

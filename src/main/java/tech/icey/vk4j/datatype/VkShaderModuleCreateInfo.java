...
public record VkShaderModuleCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$codeSize = PathElement.groupElement(3);
    public static final PathElement PATH$pCode = PathElement.groupElement(4);
    ...
    public static final class VkShaderModuleCreateInfoFactory implements IDataTypeFactory<VkShaderModuleCreateInfo> {
        @Override

...
public record VkPhysicalDeviceNestedCommandBufferFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$nestedCommandBuffer = PathElement.groupElement(2);
    public static final PathElement PATH$nestedCommandBufferRendering = PathElement.groupElement(3);
    public static final PathElement PATH$nestedCommandBufferSimultaneousUse = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceNestedCommandBufferFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceNestedCommandBufferFeaturesEXT> {
        @Override

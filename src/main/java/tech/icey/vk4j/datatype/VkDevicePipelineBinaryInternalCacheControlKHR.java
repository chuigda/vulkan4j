...
public record VkDevicePipelineBinaryInternalCacheControlKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$disableInternalCache = PathElement.groupElement(2);
    ...
    public static final class VkDevicePipelineBinaryInternalCacheControlKHRFactory implements IDataTypeFactory<VkDevicePipelineBinaryInternalCacheControlKHR> {
        @Override

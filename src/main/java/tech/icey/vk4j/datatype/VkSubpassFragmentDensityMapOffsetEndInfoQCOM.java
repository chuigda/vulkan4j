...
public record VkSubpassFragmentDensityMapOffsetEndInfoQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$fragmentDensityOffsetCount = PathElement.groupElement(2);
    public static final PathElement PATH$pFragmentDensityOffsets = PathElement.groupElement(3);
    ...
    public static final class VkSubpassFragmentDensityMapOffsetEndInfoQCOMFactory implements IDataTypeFactory<VkSubpassFragmentDensityMapOffsetEndInfoQCOM> {
        @Override

...
public record VkPhysicalDeviceRobustness2FeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$robustBufferAccess2 = PathElement.groupElement(2);
    public static final PathElement PATH$robustImageAccess2 = PathElement.groupElement(3);
    public static final PathElement PATH$nullDescriptor = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceRobustness2FeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceRobustness2FeaturesEXT> {
        @Override

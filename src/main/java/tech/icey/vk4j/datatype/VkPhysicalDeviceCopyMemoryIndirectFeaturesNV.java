...
public record VkPhysicalDeviceCopyMemoryIndirectFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$indirectCopy = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceCopyMemoryIndirectFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceCopyMemoryIndirectFeaturesNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceCopyMemoryIndirectFeaturesNV.LAYOUT;
        }

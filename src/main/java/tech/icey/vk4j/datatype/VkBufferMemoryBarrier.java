...
public record VkBufferMemoryBarrier(MemorySegment segment) {
    ...
    public static final PathElement PATH$srcQueueFamilyIndex = PathElement.groupElement(4);
    public static final PathElement PATH$dstQueueFamilyIndex = PathElement.groupElement(5);
    public static final PathElement PATH$buffer = PathElement.groupElement(6);
    public static final PathElement PATH$offset = PathElement.groupElement(7);
    public static final PathElement PATH$size = PathElement.groupElement(8);
    ...
    public static final class VkBufferMemoryBarrierFactory implements IDataTypeFactory<VkBufferMemoryBarrier> {
        @Override

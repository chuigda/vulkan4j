...
public record VkExternalBufferProperties(MemorySegment segment) {
    ...
    public static final class VkExternalBufferPropertiesFactory implements IDataTypeFactory<VkExternalBufferProperties> {
        @Override
    ...
    public static final VkExternalBufferPropertiesFactory FACTORY = new VkExternalBufferPropertiesFactory();
}

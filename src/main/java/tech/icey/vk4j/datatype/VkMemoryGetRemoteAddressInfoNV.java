...
public record VkMemoryGetRemoteAddressInfoNV(MemorySegment segment) {
    ...
    public static final class VkMemoryGetRemoteAddressInfoNVFactory implements IDataTypeFactory<VkMemoryGetRemoteAddressInfoNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkMemoryGetRemoteAddressInfoNV.LAYOUT;
        }

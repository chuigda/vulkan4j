...
public record VkDeviceAddressBindingCallbackDataEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$baseAddress = PathElement.groupElement(3);
    public static final PathElement PATH$size = PathElement.groupElement(4);
    public static final PathElement PATH$bindingType = PathElement.groupElement(5);
    ...
    public static final class VkDeviceAddressBindingCallbackDataEXTFactory implements IDataTypeFactory<VkDeviceAddressBindingCallbackDataEXT> {
        @Override

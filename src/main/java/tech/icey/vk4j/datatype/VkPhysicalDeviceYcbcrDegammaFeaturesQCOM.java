...
public record VkPhysicalDeviceYcbcrDegammaFeaturesQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$ycbcrDegamma = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceYcbcrDegammaFeaturesQCOMFactory implements IDataTypeFactory<VkPhysicalDeviceYcbcrDegammaFeaturesQCOM> {
        @Override

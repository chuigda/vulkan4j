...
public record VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$multiviewPerViewViewports = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOMFactory implements IDataTypeFactory<VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM> {
        @Override

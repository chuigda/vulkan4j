...
public record VkPhysicalDeviceShaderMaximalReconvergenceFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderMaximalReconvergence = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceShaderMaximalReconvergenceFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceShaderMaximalReconvergenceFeaturesKHR> {
        @Override

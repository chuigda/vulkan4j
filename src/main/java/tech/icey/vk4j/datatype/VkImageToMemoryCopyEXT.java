...
public record VkImageToMemoryCopyEXT(MemorySegment segment) {
    ...
    public static final class VkImageToMemoryCopyEXTFactory implements IDataTypeFactory<VkImageToMemoryCopyEXT> {
        @Override
        public Class<VkImageToMemoryCopyEXT> clazz() {
            return VkImageToMemoryCopyEXT.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkImageToMemoryCopyEXT.LAYOUT;
        }

        @Override
        public VkImageToMemoryCopyEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkImageToMemoryCopyEXT createUninit(MemorySegment segment) {
            return new VkImageToMemoryCopyEXT(segment);
        }
    }

    public static final VkImageToMemoryCopyEXTFactory FACTORY = new VkImageToMemoryCopyEXTFactory();
}

...
public record VkMemoryPriorityAllocateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$priority = PathElement.groupElement(2);
    ...
    public static final class VkMemoryPriorityAllocateInfoEXTFactory implements IDataTypeFactory<VkMemoryPriorityAllocateInfoEXT> {
        @Override

...
public record VkDrmFormatModifierProperties2EXT(MemorySegment segment) {
    ...
    public static final class VkDrmFormatModifierProperties2EXTFactory implements IDataTypeFactory<VkDrmFormatModifierProperties2EXT> {
        @Override
    ...
    public static final VkDrmFormatModifierProperties2EXTFactory FACTORY = new VkDrmFormatModifierProperties2EXTFactory();
}

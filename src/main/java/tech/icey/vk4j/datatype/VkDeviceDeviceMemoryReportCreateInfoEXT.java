...
public record VkDeviceDeviceMemoryReportCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pfnUserCallback = PathElement.groupElement(3);
    public static final PathElement PATH$pUserData = PathElement.groupElement(4);
    ...
    public static final class VkDeviceDeviceMemoryReportCreateInfoEXTFactory implements IDataTypeFactory<VkDeviceDeviceMemoryReportCreateInfoEXT> {
        @Override

...
public record VkImageDrmFormatModifierPropertiesEXT(MemorySegment segment) {
    ...
    public static final class VkImageDrmFormatModifierPropertiesEXTFactory implements IDataTypeFactory<VkImageDrmFormatModifierPropertiesEXT> {
        @Override
    ...
    public static final VkImageDrmFormatModifierPropertiesEXTFactory FACTORY = new VkImageDrmFormatModifierPropertiesEXTFactory();
}

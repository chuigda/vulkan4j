...
public record VkD3D12FenceSubmitInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$waitSemaphoreValuesCount = PathElement.groupElement(2);
    public static final PathElement PATH$pWaitSemaphoreValues = PathElement.groupElement(3);
    public static final PathElement PATH$signalSemaphoreValuesCount = PathElement.groupElement(4);

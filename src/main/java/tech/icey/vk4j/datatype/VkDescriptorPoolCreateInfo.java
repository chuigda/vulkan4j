...
public record VkDescriptorPoolCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxSets = PathElement.groupElement(3);
    public static final PathElement PATH$poolSizeCount = PathElement.groupElement(4);
    public static final PathElement PATH$pPoolSizes = PathElement.groupElement(5);
    ...
    public static final class VkDescriptorPoolCreateInfoFactory implements IDataTypeFactory<VkDescriptorPoolCreateInfo> {
        @Override

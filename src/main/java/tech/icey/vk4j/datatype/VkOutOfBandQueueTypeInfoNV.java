...
public record VkOutOfBandQueueTypeInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$queueType = PathElement.groupElement(2);
    ...
    public static final class VkOutOfBandQueueTypeInfoNVFactory implements IDataTypeFactory<VkOutOfBandQueueTypeInfoNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkOutOfBandQueueTypeInfoNV.LAYOUT;
        }

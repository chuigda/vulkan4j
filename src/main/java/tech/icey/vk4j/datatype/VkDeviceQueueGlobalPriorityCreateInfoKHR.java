...
public record VkDeviceQueueGlobalPriorityCreateInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$globalPriority = PathElement.groupElement(2);
    ...
    public static final class VkDeviceQueueGlobalPriorityCreateInfoKHRFactory implements IDataTypeFactory<VkDeviceQueueGlobalPriorityCreateInfoKHR> {
        @Override

...
public record VkPhysicalDeviceShaderImageFootprintFeaturesNV(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceShaderImageFootprintFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceShaderImageFootprintFeaturesNV> {
        @Override

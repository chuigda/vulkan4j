...
public record VkOpticalFlowSessionCreatePrivateDataInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$id = PathElement.groupElement(2);
    public static final PathElement PATH$size = PathElement.groupElement(3);
    public static final PathElement PATH$pPrivateData = PathElement.groupElement(4);
    ...
    public static final class VkOpticalFlowSessionCreatePrivateDataInfoNVFactory implements IDataTypeFactory<VkOpticalFlowSessionCreatePrivateDataInfoNV> {
        @Override
    ...
    public static final VkOpticalFlowSessionCreatePrivateDataInfoNVFactory FACTORY = new VkOpticalFlowSessionCreatePrivateDataInfoNVFactory();
}

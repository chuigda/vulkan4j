...
public record VkSurfaceFullScreenExclusiveInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$fullScreenExclusive = PathElement.groupElement(2);
    ...
    public static final class VkSurfaceFullScreenExclusiveInfoEXTFactory implements IDataTypeFactory<VkSurfaceFullScreenExclusiveInfoEXT> {
        @Override
    ...
    public static final VkSurfaceFullScreenExclusiveInfoEXTFactory FACTORY = new VkSurfaceFullScreenExclusiveInfoEXTFactory();
}

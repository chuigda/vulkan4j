...
public record VkWaylandSurfaceCreateInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$display = PathElement.groupElement(3);
    public static final PathElement PATH$surface = PathElement.groupElement(4);
    ...
    public static final class VkWaylandSurfaceCreateInfoKHRFactory implements IDataTypeFactory<VkWaylandSurfaceCreateInfoKHR> {
        @Override

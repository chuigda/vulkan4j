...
public record VkPhysicalDevicePipelinePropertiesFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pipelinePropertiesIdentifier = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDevicePipelinePropertiesFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDevicePipelinePropertiesFeaturesEXT> {
        @Override

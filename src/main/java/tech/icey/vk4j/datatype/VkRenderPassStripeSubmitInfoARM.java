...
public record VkRenderPassStripeSubmitInfoARM(MemorySegment segment) {
    ...
    public static final PathElement PATH$stripeSemaphoreInfoCount = PathElement.groupElement(2);
    public static final PathElement PATH$pStripeSemaphoreInfos = PathElement.groupElement(3);
    ...
    public static final class VkRenderPassStripeSubmitInfoARMFactory implements IDataTypeFactory<VkRenderPassStripeSubmitInfoARM> {
        @Override

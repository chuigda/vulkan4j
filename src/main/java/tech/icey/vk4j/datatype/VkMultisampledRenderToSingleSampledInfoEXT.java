...
public record VkMultisampledRenderToSingleSampledInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$multisampledRenderToSingleSampledEnable = PathElement.groupElement(2);
    ...
    public static final class VkMultisampledRenderToSingleSampledInfoEXTFactory implements IDataTypeFactory<VkMultisampledRenderToSingleSampledInfoEXT> {
        @Override

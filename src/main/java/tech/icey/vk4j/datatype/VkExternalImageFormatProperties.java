...
public record VkExternalImageFormatProperties(MemorySegment segment) {
    ...
    public static final PathElement PATH$externalMemoryProperties = PathElement.groupElement(2);
    ...
    public static final class VkExternalImageFormatPropertiesFactory implements IDataTypeFactory<VkExternalImageFormatProperties> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkExternalImageFormatProperties.LAYOUT;
        }

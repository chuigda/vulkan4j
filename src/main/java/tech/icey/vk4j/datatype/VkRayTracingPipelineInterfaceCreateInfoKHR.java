...
public record VkRayTracingPipelineInterfaceCreateInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxPipelineRayPayloadSize = PathElement.groupElement(2);
    public static final PathElement PATH$maxPipelineRayHitAttributeSize = PathElement.groupElement(3);
    ...
    public static final class VkRayTracingPipelineInterfaceCreateInfoKHRFactory implements IDataTypeFactory<VkRayTracingPipelineInterfaceCreateInfoKHR> {
        @Override

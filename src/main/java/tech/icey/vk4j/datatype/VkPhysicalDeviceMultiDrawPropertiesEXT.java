...
public record VkPhysicalDeviceMultiDrawPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxMultiDrawCount = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceMultiDrawPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceMultiDrawPropertiesEXT> {
        @Override
        public Class<VkPhysicalDeviceMultiDrawPropertiesEXT> clazz() {
            return VkPhysicalDeviceMultiDrawPropertiesEXT.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkPhysicalDeviceMultiDrawPropertiesEXT.LAYOUT;
        }
    ...
    public static final VkPhysicalDeviceMultiDrawPropertiesEXTFactory FACTORY = new VkPhysicalDeviceMultiDrawPropertiesEXTFactory();
}

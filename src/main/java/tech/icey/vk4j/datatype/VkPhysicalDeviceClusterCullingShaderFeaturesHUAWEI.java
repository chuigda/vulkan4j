...
public record VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI(MemorySegment segment) {
    ...
    public static final PathElement PATH$clustercullingShader = PathElement.groupElement(2);
    public static final PathElement PATH$multiviewClusterCullingShader = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEIFactory implements IDataTypeFactory<VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI> {
        @Override

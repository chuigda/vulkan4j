...
public record VkDescriptorBufferBindingPushDescriptorBufferHandleEXT(MemorySegment segment) {
    ...
    public static final class VkDescriptorBufferBindingPushDescriptorBufferHandleEXTFactory implements IDataTypeFactory<VkDescriptorBufferBindingPushDescriptorBufferHandleEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkDescriptorBufferBindingPushDescriptorBufferHandleEXT.LAYOUT;
        }

...
public record VkPhysicalDeviceExclusiveScissorFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$exclusiveScissor = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceExclusiveScissorFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceExclusiveScissorFeaturesNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceExclusiveScissorFeaturesNV.LAYOUT;
        }

...
public record VkPhysicalDeviceImage2DViewOf3DFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$image2DViewOf3D = PathElement.groupElement(2);
    public static final PathElement PATH$sampler2DViewOf3D = PathElement.groupElement(3);

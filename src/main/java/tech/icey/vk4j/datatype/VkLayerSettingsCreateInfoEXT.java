...
public record VkLayerSettingsCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$settingCount = PathElement.groupElement(2);
    public static final PathElement PATH$pSettings = PathElement.groupElement(3);
    ...
    public static final class VkLayerSettingsCreateInfoEXTFactory implements IDataTypeFactory<VkLayerSettingsCreateInfoEXT> {
        @Override

...
public record VkSamplerCaptureDescriptorDataInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$sampler = PathElement.groupElement(2);
    ...
    public static final class VkSamplerCaptureDescriptorDataInfoEXTFactory implements IDataTypeFactory<VkSamplerCaptureDescriptorDataInfoEXT> {
        @Override

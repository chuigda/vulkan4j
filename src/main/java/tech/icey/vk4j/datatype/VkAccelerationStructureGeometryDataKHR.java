...
public record VkAccelerationStructureGeometryDataKHR(MemorySegment segment) {
    ...
    public static final class VkAccelerationStructureGeometryDataKHRFactory implements IDataTypeFactory<VkAccelerationStructureGeometryDataKHR> {
        @Override
    ...
    public static final VkAccelerationStructureGeometryDataKHRFactory FACTORY = new VkAccelerationStructureGeometryDataKHRFactory();
}

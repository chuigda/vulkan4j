...
public record VkFilterCubicImageViewImageFormatPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$filterCubic = PathElement.groupElement(2);
    public static final PathElement PATH$filterCubicMinmax = PathElement.groupElement(3);
    ...
    public static final class VkFilterCubicImageViewImageFormatPropertiesEXTFactory implements IDataTypeFactory<VkFilterCubicImageViewImageFormatPropertiesEXT> {
        @Override

...
public record VkMemoryFdPropertiesKHR(MemorySegment segment) {
    ...
    public static final class VkMemoryFdPropertiesKHRFactory implements IDataTypeFactory<VkMemoryFdPropertiesKHR> {
        @Override
        public Class<VkMemoryFdPropertiesKHR> clazz() {
            return VkMemoryFdPropertiesKHR.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkMemoryFdPropertiesKHR.LAYOUT;
        }
    ...
    public static final VkMemoryFdPropertiesKHRFactory FACTORY = new VkMemoryFdPropertiesKHRFactory();
}

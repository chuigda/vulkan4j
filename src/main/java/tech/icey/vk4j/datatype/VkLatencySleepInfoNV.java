...
public record VkLatencySleepInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$signalSemaphore = PathElement.groupElement(2);
    ...
    public static final class VkLatencySleepInfoNVFactory implements IDataTypeFactory<VkLatencySleepInfoNV> {
        @Override

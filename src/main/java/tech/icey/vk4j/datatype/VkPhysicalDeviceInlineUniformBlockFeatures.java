...
public record VkPhysicalDeviceInlineUniformBlockFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$inlineUniformBlock = PathElement.groupElement(2);
    public static final PathElement PATH$descriptorBindingInlineUniformBlockUpdateAfterBind = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceInlineUniformBlockFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceInlineUniformBlockFeatures> {
        @Override

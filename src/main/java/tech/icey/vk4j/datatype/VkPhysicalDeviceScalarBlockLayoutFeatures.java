...
public record VkPhysicalDeviceScalarBlockLayoutFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$scalarBlockLayout = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceScalarBlockLayoutFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceScalarBlockLayoutFeatures> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceScalarBlockLayoutFeatures.LAYOUT;
        }

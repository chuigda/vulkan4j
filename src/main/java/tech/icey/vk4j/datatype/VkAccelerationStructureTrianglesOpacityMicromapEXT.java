...
public record VkAccelerationStructureTrianglesOpacityMicromapEXT(MemorySegment segment) {
    ...
    public static final class VkAccelerationStructureTrianglesOpacityMicromapEXTFactory implements IDataTypeFactory<VkAccelerationStructureTrianglesOpacityMicromapEXT> {
        @Override

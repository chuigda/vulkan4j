...
public record VkPhysicalDeviceExternalFormatResolvePropertiesANDROID(MemorySegment segment) {
    ...
    public static final PathElement PATH$nullColorAttachmentWithExternalFormatResolve = PathElement.groupElement(2);
    public static final PathElement PATH$externalFormatResolveChromaOffsetX = PathElement.groupElement(3);
    public static final PathElement PATH$externalFormatResolveChromaOffsetY = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceExternalFormatResolvePropertiesANDROIDFactory implements IDataTypeFactory<VkPhysicalDeviceExternalFormatResolvePropertiesANDROID> {
        @Override

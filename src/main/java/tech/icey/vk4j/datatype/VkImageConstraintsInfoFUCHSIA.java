...
public record VkImageConstraintsInfoFUCHSIA(MemorySegment segment) {
    ...
    public static final class VkImageConstraintsInfoFUCHSIAFactory implements IDataTypeFactory<VkImageConstraintsInfoFUCHSIA> {
        @Override
    ...
    public static final VkImageConstraintsInfoFUCHSIAFactory FACTORY = new VkImageConstraintsInfoFUCHSIAFactory();
}

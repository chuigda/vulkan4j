...
public record VkPhysicalDeviceShaderEnqueueFeaturesAMDX(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderEnqueue = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceShaderEnqueueFeaturesAMDXFactory implements IDataTypeFactory<VkPhysicalDeviceShaderEnqueueFeaturesAMDX> {
        @Override

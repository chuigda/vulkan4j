...
public record VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderDemoteToHelperInvocation = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures.LAYOUT;
        }

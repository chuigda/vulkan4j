...
public record VkDeviceGroupPresentCapabilitiesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$presentMask = PathElement.groupElement(2);
    public static final PathElement PATH$modes = PathElement.groupElement(3);
    ...
    public static final class VkDeviceGroupPresentCapabilitiesKHRFactory implements IDataTypeFactory<VkDeviceGroupPresentCapabilitiesKHR> {
        @Override

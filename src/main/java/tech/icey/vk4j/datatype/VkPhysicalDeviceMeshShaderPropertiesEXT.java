...
public record VkPhysicalDeviceMeshShaderPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxTaskWorkGroupTotalCount = PathElement.groupElement(2);
    public static final PathElement PATH$maxTaskWorkGroupCount = PathElement.groupElement(3);
    public static final PathElement PATH$maxTaskWorkGroupInvocations = PathElement.groupElement(4);
    public static final PathElement PATH$maxTaskWorkGroupSize = PathElement.groupElement(5);
    public static final PathElement PATH$maxTaskPayloadSize = PathElement.groupElement(6);
    public static final PathElement PATH$maxTaskSharedMemorySize = PathElement.groupElement(7);
    public static final PathElement PATH$maxTaskPayloadAndSharedMemorySize = PathElement.groupElement(8);
    public static final PathElement PATH$maxMeshWorkGroupTotalCount = PathElement.groupElement(9);
    public static final PathElement PATH$maxMeshWorkGroupCount = PathElement.groupElement(10);
    public static final PathElement PATH$maxMeshWorkGroupInvocations = PathElement.groupElement(11);
    public static final PathElement PATH$maxMeshWorkGroupSize = PathElement.groupElement(12);
    public static final PathElement PATH$maxMeshSharedMemorySize = PathElement.groupElement(13);
    public static final PathElement PATH$maxMeshPayloadAndSharedMemorySize = PathElement.groupElement(14);
    public static final PathElement PATH$maxMeshOutputMemorySize = PathElement.groupElement(15);
    public static final PathElement PATH$maxMeshPayloadAndOutputMemorySize = PathElement.groupElement(16);
    public static final PathElement PATH$maxMeshOutputComponents = PathElement.groupElement(17);
    public static final PathElement PATH$maxMeshOutputVertices = PathElement.groupElement(18);
    public static final PathElement PATH$maxMeshOutputPrimitives = PathElement.groupElement(19);
    public static final PathElement PATH$maxMeshOutputLayers = PathElement.groupElement(20);
    public static final PathElement PATH$maxMeshMultiviewViewCount = PathElement.groupElement(21);
    public static final PathElement PATH$meshOutputPerVertexGranularity = PathElement.groupElement(22);
    public static final PathElement PATH$meshOutputPerPrimitiveGranularity = PathElement.groupElement(23);
    public static final PathElement PATH$maxPreferredTaskWorkGroupInvocations = PathElement.groupElement(24);
    public static final PathElement PATH$maxPreferredMeshWorkGroupInvocations = PathElement.groupElement(25);
    public static final PathElement PATH$prefersLocalInvocationVertexOutput = PathElement.groupElement(26);
    public static final PathElement PATH$prefersLocalInvocationPrimitiveOutput = PathElement.groupElement(27);
    public static final PathElement PATH$prefersCompactVertexOutput = PathElement.groupElement(28);
    public static final PathElement PATH$prefersCompactPrimitiveOutput = PathElement.groupElement(29);
    ...
    public static final class VkPhysicalDeviceMeshShaderPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceMeshShaderPropertiesEXT> {
        @Override

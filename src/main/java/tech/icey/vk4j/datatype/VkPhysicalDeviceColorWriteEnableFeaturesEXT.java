...
public record VkPhysicalDeviceColorWriteEnableFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$colorWriteEnable = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceColorWriteEnableFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceColorWriteEnableFeaturesEXT> {
        @Override

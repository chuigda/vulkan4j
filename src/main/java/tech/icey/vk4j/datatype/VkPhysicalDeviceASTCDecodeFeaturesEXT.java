...
public record VkPhysicalDeviceASTCDecodeFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$decodeModeSharedExponent = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceASTCDecodeFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceASTCDecodeFeaturesEXT> {
        @Override

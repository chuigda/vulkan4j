...
public record VkBindBufferMemoryInfo(MemorySegment segment) {
    ...
    public static final class VkBindBufferMemoryInfoFactory implements IDataTypeFactory<VkBindBufferMemoryInfo> {
        @Override
    ...
    public static final VkBindBufferMemoryInfoFactory FACTORY = new VkBindBufferMemoryInfoFactory();
}

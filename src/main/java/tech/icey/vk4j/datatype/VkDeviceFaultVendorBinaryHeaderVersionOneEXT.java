...
public record VkDeviceFaultVendorBinaryHeaderVersionOneEXT(MemorySegment segment) {
    ...
    public static final class VkDeviceFaultVendorBinaryHeaderVersionOneEXTFactory implements IDataTypeFactory<VkDeviceFaultVendorBinaryHeaderVersionOneEXT> {
        @Override

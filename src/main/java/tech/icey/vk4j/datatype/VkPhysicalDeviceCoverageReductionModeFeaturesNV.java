...
public record VkPhysicalDeviceCoverageReductionModeFeaturesNV(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceCoverageReductionModeFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceCoverageReductionModeFeaturesNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceCoverageReductionModeFeaturesNV.LAYOUT;
        }

...
public record VkPushDescriptorSetWithTemplateInfoKHR(MemorySegment segment) {
    ...
    public static final class VkPushDescriptorSetWithTemplateInfoKHRFactory implements IDataTypeFactory<VkPushDescriptorSetWithTemplateInfoKHR> {
        @Override
    ...
    public static final VkPushDescriptorSetWithTemplateInfoKHRFactory FACTORY = new VkPushDescriptorSetWithTemplateInfoKHRFactory();
}

...
public record VkOpticalFlowExecuteInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$regionCount = PathElement.groupElement(3);
    public static final PathElement PATH$pRegions = PathElement.groupElement(4);
    ...
    public static final class VkOpticalFlowExecuteInfoNVFactory implements IDataTypeFactory<VkOpticalFlowExecuteInfoNV> {
        @Override

...
public record VkImageStencilUsageCreateInfo(MemorySegment segment) {
    ...
    public static final class VkImageStencilUsageCreateInfoFactory implements IDataTypeFactory<VkImageStencilUsageCreateInfo> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkImageStencilUsageCreateInfo.LAYOUT;
        }

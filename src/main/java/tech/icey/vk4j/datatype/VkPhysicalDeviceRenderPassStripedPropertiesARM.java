...
public record VkPhysicalDeviceRenderPassStripedPropertiesARM(MemorySegment segment) {
    ...
    public static final PathElement PATH$renderPassStripeGranularity = PathElement.groupElement(2);
    public static final PathElement PATH$maxRenderPassStripes = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceRenderPassStripedPropertiesARMFactory implements IDataTypeFactory<VkPhysicalDeviceRenderPassStripedPropertiesARM> {
        @Override

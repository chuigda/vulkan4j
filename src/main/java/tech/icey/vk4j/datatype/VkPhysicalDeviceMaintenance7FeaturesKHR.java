...
public record VkPhysicalDeviceMaintenance7FeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$maintenance7 = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceMaintenance7FeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceMaintenance7FeaturesKHR> {
        @Override

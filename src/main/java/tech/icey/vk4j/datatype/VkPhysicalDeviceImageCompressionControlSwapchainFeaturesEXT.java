...
public record VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$imageCompressionControlSwapchain = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT> {
        @Override

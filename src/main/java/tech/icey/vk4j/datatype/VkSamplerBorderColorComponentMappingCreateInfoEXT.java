...
public record VkSamplerBorderColorComponentMappingCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$components = PathElement.groupElement(2);
    public static final PathElement PATH$srgb = PathElement.groupElement(3);
    ...
    public static final class VkSamplerBorderColorComponentMappingCreateInfoEXTFactory implements IDataTypeFactory<VkSamplerBorderColorComponentMappingCreateInfoEXT> {
        @Override

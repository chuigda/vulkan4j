...
public record VkViewportWScalingNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$xcoeff = PathElement.groupElement(0);
    public static final PathElement PATH$ycoeff = PathElement.groupElement(1);
    ...
    public static final class VkViewportWScalingNVFactory implements IDataTypeFactory<VkViewportWScalingNV> {
        @Override

...
public record VkDescriptorSetVariableDescriptorCountAllocateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$descriptorSetCount = PathElement.groupElement(2);
    public static final PathElement PATH$pDescriptorCounts = PathElement.groupElement(3);

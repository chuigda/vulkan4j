...
public record VkRayTracingPipelineCreateInfoKHR(MemorySegment segment) {
    ...
    public void pGroups(VkRayTracingShaderGroupCreateInfoKHR value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pGroupsRaw(s);
    }
    ...
    public void pLibraryInterface(VkRayTracingPipelineInterfaceCreateInfoKHR value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
    ...
    public static final class VkRayTracingPipelineCreateInfoKHRFactory implements IDataTypeFactory<VkRayTracingPipelineCreateInfoKHR> {
        @Override
        public Class<VkRayTracingPipelineCreateInfoKHR> clazz() {
            return VkRayTracingPipelineCreateInfoKHR.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkRayTracingPipelineCreateInfoKHR.LAYOUT;
        }

        @Override
        public VkRayTracingPipelineCreateInfoKHR create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkRayTracingPipelineCreateInfoKHR createUninit(MemorySegment segment) {
            return new VkRayTracingPipelineCreateInfoKHR(segment);
        }
    }

    public static final VkRayTracingPipelineCreateInfoKHRFactory FACTORY = new VkRayTracingPipelineCreateInfoKHRFactory();
}

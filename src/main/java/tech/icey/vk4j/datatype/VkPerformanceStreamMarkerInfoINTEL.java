...
public record VkPerformanceStreamMarkerInfoINTEL(MemorySegment segment) {
    ...
    public static final PathElement PATH$marker = PathElement.groupElement(2);
    ...
    public static final class VkPerformanceStreamMarkerInfoINTELFactory implements IDataTypeFactory<VkPerformanceStreamMarkerInfoINTEL> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPerformanceStreamMarkerInfoINTEL.LAYOUT;
        }

        @Override
        public VkPerformanceStreamMarkerInfoINTEL create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkPerformanceStreamMarkerInfoINTEL createUninit(MemorySegment segment) {
            return new VkPerformanceStreamMarkerInfoINTEL(segment);
        }
    }

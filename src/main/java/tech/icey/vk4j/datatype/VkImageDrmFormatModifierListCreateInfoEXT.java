...
public record VkImageDrmFormatModifierListCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pDrmFormatModifiers = PathElement.groupElement(3);
    ...
    public void pDrmFormatModifiers(@unsigned LongPtr value) {
        pDrmFormatModifiersRaw(value.segment());
    }


    public static final class VkImageDrmFormatModifierListCreateInfoEXTFactory implements IDataTypeFactory<VkImageDrmFormatModifierListCreateInfoEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkImageDrmFormatModifierListCreateInfoEXT.LAYOUT;
        }

        @Override
        public VkImageDrmFormatModifierListCreateInfoEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkImageDrmFormatModifierListCreateInfoEXT createUninit(MemorySegment segment) {
            return new VkImageDrmFormatModifierListCreateInfoEXT(segment);
        }
    }

...
public record VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxFragmentShadingRateInvocationCount = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNVFactory implements IDataTypeFactory<VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV> {
        @Override

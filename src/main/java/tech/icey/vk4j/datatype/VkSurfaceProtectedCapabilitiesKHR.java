...
public record VkSurfaceProtectedCapabilitiesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$supportsProtected = PathElement.groupElement(2);
    ...
    public static final class VkSurfaceProtectedCapabilitiesKHRFactory implements IDataTypeFactory<VkSurfaceProtectedCapabilitiesKHR> {
        @Override

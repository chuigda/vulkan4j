...
public record VkDeviceEventInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$deviceEvent = PathElement.groupElement(2);
    ...
    public static final class VkDeviceEventInfoEXTFactory implements IDataTypeFactory<VkDeviceEventInfoEXT> {
        @Override

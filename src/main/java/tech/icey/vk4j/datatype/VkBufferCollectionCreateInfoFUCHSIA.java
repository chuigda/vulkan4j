...
public record VkBufferCollectionCreateInfoFUCHSIA(MemorySegment segment) {
    ...
    public static final PathElement PATH$collectionToken = PathElement.groupElement(2);
    ...
    public static final class VkBufferCollectionCreateInfoFUCHSIAFactory implements IDataTypeFactory<VkBufferCollectionCreateInfoFUCHSIA> {
        @Override

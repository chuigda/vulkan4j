...
public record VkPhysicalDeviceMemoryDecompressionPropertiesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$decompressionMethods = PathElement.groupElement(2);
    public static final PathElement PATH$maxDecompressionIndirectCount = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceMemoryDecompressionPropertiesNVFactory implements IDataTypeFactory<VkPhysicalDeviceMemoryDecompressionPropertiesNV> {
        @Override

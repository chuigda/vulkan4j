...
public record VkPhysicalDeviceTimelineSemaphoreProperties(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxTimelineSemaphoreValueDifference = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceTimelineSemaphorePropertiesFactory implements IDataTypeFactory<VkPhysicalDeviceTimelineSemaphoreProperties> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceTimelineSemaphoreProperties.LAYOUT;
        }

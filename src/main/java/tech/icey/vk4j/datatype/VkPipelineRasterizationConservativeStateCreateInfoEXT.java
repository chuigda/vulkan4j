...
public record VkPipelineRasterizationConservativeStateCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$conservativeRasterizationMode = PathElement.groupElement(3);
    public static final PathElement PATH$extraPrimitiveOverestimationSize = PathElement.groupElement(4);
    ...
    public static final class VkPipelineRasterizationConservativeStateCreateInfoEXTFactory implements IDataTypeFactory<VkPipelineRasterizationConservativeStateCreateInfoEXT> {
        @Override

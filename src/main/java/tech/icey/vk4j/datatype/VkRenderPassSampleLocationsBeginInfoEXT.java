...
public record VkRenderPassSampleLocationsBeginInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$attachmentInitialSampleLocationsCount = PathElement.groupElement(2);
    public static final PathElement PATH$pAttachmentInitialSampleLocations = PathElement.groupElement(3);
    public static final PathElement PATH$postSubpassSampleLocationsCount = PathElement.groupElement(4);
    public static final PathElement PATH$pPostSubpassSampleLocations = PathElement.groupElement(5);
    ...
    public void pAttachmentInitialSampleLocations(VkAttachmentSampleLocationsEXT value) {
    ...
    public void pPostSubpassSampleLocations(VkSubpassSampleLocationsEXT value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pPostSubpassSampleLocationsRaw(s);
    }


    public static final class VkRenderPassSampleLocationsBeginInfoEXTFactory implements IDataTypeFactory<VkRenderPassSampleLocationsBeginInfoEXT> {
        @Override

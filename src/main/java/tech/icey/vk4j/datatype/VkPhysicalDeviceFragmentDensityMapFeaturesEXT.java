...
public record VkPhysicalDeviceFragmentDensityMapFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$fragmentDensityMap = PathElement.groupElement(2);
    public static final PathElement PATH$fragmentDensityMapDynamic = PathElement.groupElement(3);
    public static final PathElement PATH$fragmentDensityMapNonSubsampledImages = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceFragmentDensityMapFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceFragmentDensityMapFeaturesEXT> {
        @Override

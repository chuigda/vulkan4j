...
public record VkPhysicalDeviceRayTracingValidationFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$rayTracingValidation = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceRayTracingValidationFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceRayTracingValidationFeaturesNV> {
        @Override

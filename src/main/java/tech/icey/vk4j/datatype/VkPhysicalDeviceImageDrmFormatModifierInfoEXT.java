...
public record VkPhysicalDeviceImageDrmFormatModifierInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$sharingMode = PathElement.groupElement(3);
    public static final PathElement PATH$queueFamilyIndexCount = PathElement.groupElement(4);
    public static final PathElement PATH$pQueueFamilyIndices = PathElement.groupElement(5);
    ...
    public static final class VkPhysicalDeviceImageDrmFormatModifierInfoEXTFactory implements IDataTypeFactory<VkPhysicalDeviceImageDrmFormatModifierInfoEXT> {
        @Override

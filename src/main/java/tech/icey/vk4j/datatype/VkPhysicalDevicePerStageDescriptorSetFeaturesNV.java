...
public record VkPhysicalDevicePerStageDescriptorSetFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$perStageDescriptorSet = PathElement.groupElement(2);
    public static final PathElement PATH$dynamicPipelineLayout = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDevicePerStageDescriptorSetFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDevicePerStageDescriptorSetFeaturesNV> {
        @Override

...
public record VkPhysicalDeviceInlineUniformBlockProperties(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceInlineUniformBlockPropertiesFactory implements IDataTypeFactory<VkPhysicalDeviceInlineUniformBlockProperties> {
        @Override
    ...
    public static final VkPhysicalDeviceInlineUniformBlockPropertiesFactory FACTORY = new VkPhysicalDeviceInlineUniformBlockPropertiesFactory();
}

...
public record VkPhysicalDeviceSchedulingControlsFeaturesARM(MemorySegment segment) {
    ...
    public static final PathElement PATH$schedulingControls = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceSchedulingControlsFeaturesARMFactory implements IDataTypeFactory<VkPhysicalDeviceSchedulingControlsFeaturesARM> {
        @Override

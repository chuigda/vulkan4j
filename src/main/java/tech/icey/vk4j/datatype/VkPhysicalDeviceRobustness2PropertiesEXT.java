...
public record VkPhysicalDeviceRobustness2PropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$robustStorageBufferAccessSizeAlignment = PathElement.groupElement(2);
    public static final PathElement PATH$robustUniformBufferAccessSizeAlignment = PathElement.groupElement(3);

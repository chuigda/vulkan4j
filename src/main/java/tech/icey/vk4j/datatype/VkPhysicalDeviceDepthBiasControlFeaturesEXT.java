...
public record VkPhysicalDeviceDepthBiasControlFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$depthBiasControl = PathElement.groupElement(2);
    public static final PathElement PATH$leastRepresentableValueForceUnormRepresentation = PathElement.groupElement(3);
    public static final PathElement PATH$floatRepresentation = PathElement.groupElement(4);
    public static final PathElement PATH$depthBiasExact = PathElement.groupElement(5);
    ...
    public static final class VkPhysicalDeviceDepthBiasControlFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceDepthBiasControlFeaturesEXT> {
        @Override

...
public record VkSamplerBlockMatchWindowCreateInfoQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$windowExtent = PathElement.groupElement(2);
    public static final PathElement PATH$windowCompareMode = PathElement.groupElement(3);

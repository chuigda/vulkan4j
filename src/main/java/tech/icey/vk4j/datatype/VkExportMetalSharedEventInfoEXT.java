...
public record VkExportMetalSharedEventInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$event = PathElement.groupElement(3);
    public static final PathElement PATH$mtlSharedEvent = PathElement.groupElement(4);
    ...
    public static final class VkExportMetalSharedEventInfoEXTFactory implements IDataTypeFactory<VkExportMetalSharedEventInfoEXT> {
        @Override

...
public record VkCopyMicromapInfoEXT(MemorySegment segment) {
    ...
    public static final class VkCopyMicromapInfoEXTFactory implements IDataTypeFactory<VkCopyMicromapInfoEXT> {
        @Override
    ...
    public static final VkCopyMicromapInfoEXTFactory FACTORY = new VkCopyMicromapInfoEXTFactory();
}

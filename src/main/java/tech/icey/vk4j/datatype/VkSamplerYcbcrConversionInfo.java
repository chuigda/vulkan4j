...
public record VkSamplerYcbcrConversionInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$conversion = PathElement.groupElement(2);
    ...
    public static final class VkSamplerYcbcrConversionInfoFactory implements IDataTypeFactory<VkSamplerYcbcrConversionInfo> {
        @Override
    ...
    public static final VkSamplerYcbcrConversionInfoFactory FACTORY = new VkSamplerYcbcrConversionInfoFactory();
}

...
public record VkPipelineRasterizationStateStreamCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$rasterizationStream = PathElement.groupElement(3);
    ...
    public static final class VkPipelineRasterizationStateStreamCreateInfoEXTFactory implements IDataTypeFactory<VkPipelineRasterizationStateStreamCreateInfoEXT> {
        @Override
    ...
    public static final VkPipelineRasterizationStateStreamCreateInfoEXTFactory FACTORY = new VkPipelineRasterizationStateStreamCreateInfoEXTFactory();
}

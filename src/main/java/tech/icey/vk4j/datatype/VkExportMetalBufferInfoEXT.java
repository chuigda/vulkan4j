...
public record VkExportMetalBufferInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$mtlBuffer = PathElement.groupElement(3);
    ...
    public static final class VkExportMetalBufferInfoEXTFactory implements IDataTypeFactory<VkExportMetalBufferInfoEXT> {
        @Override
        public Class<VkExportMetalBufferInfoEXT> clazz() {
            return VkExportMetalBufferInfoEXT.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkExportMetalBufferInfoEXT.LAYOUT;
        }

        @Override
        public VkExportMetalBufferInfoEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkExportMetalBufferInfoEXT createUninit(MemorySegment segment) {
            return new VkExportMetalBufferInfoEXT(segment);
        }
    }

    public static final VkExportMetalBufferInfoEXTFactory FACTORY = new VkExportMetalBufferInfoEXTFactory();
}

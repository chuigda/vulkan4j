...
public record VkDisplayPropertiesKHR(MemorySegment segment) {
    ...
    public static final class VkDisplayPropertiesKHRFactory implements IDataTypeFactory<VkDisplayPropertiesKHR> {
        @Override
    ...
    public static final VkDisplayPropertiesKHRFactory FACTORY = new VkDisplayPropertiesKHRFactory();
}

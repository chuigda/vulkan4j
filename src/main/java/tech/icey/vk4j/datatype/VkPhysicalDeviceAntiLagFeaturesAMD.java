...
public record VkPhysicalDeviceAntiLagFeaturesAMD(MemorySegment segment) {
    ...
    public static final PathElement PATH$antiLag = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceAntiLagFeaturesAMDFactory implements IDataTypeFactory<VkPhysicalDeviceAntiLagFeaturesAMD> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceAntiLagFeaturesAMD.LAYOUT;
        }

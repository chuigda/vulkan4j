...
public record VkPipelineShaderStageModuleIdentifierCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pIdentifier = PathElement.groupElement(3);
    ...
    public static final class VkPipelineShaderStageModuleIdentifierCreateInfoEXTFactory implements IDataTypeFactory<VkPipelineShaderStageModuleIdentifierCreateInfoEXT> {
        @Override

...
public record VkPhysicalDeviceProvokingVertexPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$provokingVertexModePerPipeline = PathElement.groupElement(2);
    public static final PathElement PATH$transformFeedbackPreservesTriangleFanProvokingVertex = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceProvokingVertexPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceProvokingVertexPropertiesEXT> {
        @Override

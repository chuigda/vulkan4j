...
public record VkExternalSemaphoreProperties(MemorySegment segment) {
    ...
    public static final PathElement PATH$exportFromImportedHandleTypes = PathElement.groupElement(2);
    public static final PathElement PATH$compatibleHandleTypes = PathElement.groupElement(3);
    public static final PathElement PATH$externalSemaphoreFeatures = PathElement.groupElement(4);
    ...
    public static final class VkExternalSemaphorePropertiesFactory implements IDataTypeFactory<VkExternalSemaphoreProperties> {
        @Override

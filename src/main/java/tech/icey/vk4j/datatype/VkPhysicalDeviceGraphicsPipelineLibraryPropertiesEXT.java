...
public record VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$graphicsPipelineLibraryFastLinking = PathElement.groupElement(2);
    public static final PathElement PATH$graphicsPipelineLibraryIndependentInterpolationDecoration = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT> {
        @Override

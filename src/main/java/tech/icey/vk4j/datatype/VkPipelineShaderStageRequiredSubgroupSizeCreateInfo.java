...
public record VkPipelineShaderStageRequiredSubgroupSizeCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$requiredSubgroupSize = PathElement.groupElement(2);
    ...
    public static final class VkPipelineShaderStageRequiredSubgroupSizeCreateInfoFactory implements IDataTypeFactory<VkPipelineShaderStageRequiredSubgroupSizeCreateInfo> {
        @Override

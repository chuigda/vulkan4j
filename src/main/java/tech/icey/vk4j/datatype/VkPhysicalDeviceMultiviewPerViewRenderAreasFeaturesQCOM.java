...
public record VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$multiviewPerViewRenderAreas = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOMFactory implements IDataTypeFactory<VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM> {
        @Override

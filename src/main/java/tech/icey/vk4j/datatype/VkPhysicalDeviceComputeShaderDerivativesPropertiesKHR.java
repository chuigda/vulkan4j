...
public record VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$meshAndTaskShaderDerivatives = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceComputeShaderDerivativesPropertiesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR> {
        @Override
    ...
    public static final VkPhysicalDeviceComputeShaderDerivativesPropertiesKHRFactory FACTORY = new VkPhysicalDeviceComputeShaderDerivativesPropertiesKHRFactory();
}

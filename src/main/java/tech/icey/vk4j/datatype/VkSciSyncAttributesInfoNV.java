...
public record VkSciSyncAttributesInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$clientType = PathElement.groupElement(2);
    public static final PathElement PATH$primitiveType = PathElement.groupElement(3);
    ...
    public static final class VkSciSyncAttributesInfoNVFactory implements IDataTypeFactory<VkSciSyncAttributesInfoNV> {
        @Override

...
public record VkFragmentShadingRateAttachmentInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$pFragmentShadingRateAttachment = PathElement.groupElement(2);
    public static final PathElement PATH$shadingRateAttachmentTexelSize = PathElement.groupElement(3);
    ...
    public static final class VkFragmentShadingRateAttachmentInfoKHRFactory implements IDataTypeFactory<VkFragmentShadingRateAttachmentInfoKHR> {
        @Override

...
public record VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderRelaxedExtendedInstruction = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR> {
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR.LAYOUT;
        }

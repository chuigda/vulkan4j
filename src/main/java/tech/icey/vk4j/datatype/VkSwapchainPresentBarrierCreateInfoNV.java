...
public record VkSwapchainPresentBarrierCreateInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$presentBarrierEnable = PathElement.groupElement(2);
    ...
    public static final class VkSwapchainPresentBarrierCreateInfoNVFactory implements IDataTypeFactory<VkSwapchainPresentBarrierCreateInfoNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkSwapchainPresentBarrierCreateInfoNV.LAYOUT;
        }

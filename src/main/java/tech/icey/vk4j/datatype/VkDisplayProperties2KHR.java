...
public record VkDisplayProperties2KHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$displayProperties = PathElement.groupElement(2);
    ...
    public static final class VkDisplayProperties2KHRFactory implements IDataTypeFactory<VkDisplayProperties2KHR> {
        @Override
    ...
    public static final VkDisplayProperties2KHRFactory FACTORY = new VkDisplayProperties2KHRFactory();
}

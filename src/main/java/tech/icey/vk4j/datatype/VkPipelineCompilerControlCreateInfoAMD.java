...
public record VkPipelineCompilerControlCreateInfoAMD(MemorySegment segment) {
    ...
    public static final PathElement PATH$compilerControlFlags = PathElement.groupElement(2);
    ...
    public static final class VkPipelineCompilerControlCreateInfoAMDFactory implements IDataTypeFactory<VkPipelineCompilerControlCreateInfoAMD> {
        @Override

...
public record VkMemoryBarrier2(MemorySegment segment) {
    ...
    public static final class VkMemoryBarrier2Factory implements IDataTypeFactory<VkMemoryBarrier2> {
        @Override
    ...
    public static final VkMemoryBarrier2Factory FACTORY = new VkMemoryBarrier2Factory();
}

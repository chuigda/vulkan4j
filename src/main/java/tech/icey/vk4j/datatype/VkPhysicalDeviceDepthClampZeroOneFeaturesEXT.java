...
public record VkPhysicalDeviceDepthClampZeroOneFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$depthClampZeroOne = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceDepthClampZeroOneFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceDepthClampZeroOneFeaturesEXT> {
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceDepthClampZeroOneFeaturesEXT.LAYOUT;
        }

        @Override
        public VkPhysicalDeviceDepthClampZeroOneFeaturesEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkPhysicalDeviceDepthClampZeroOneFeaturesEXT createUninit(MemorySegment segment) {
            return new VkPhysicalDeviceDepthClampZeroOneFeaturesEXT(segment);
        }
    }

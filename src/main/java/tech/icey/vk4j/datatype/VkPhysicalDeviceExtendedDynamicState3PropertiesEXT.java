...
public record VkPhysicalDeviceExtendedDynamicState3PropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$dynamicPrimitiveTopologyUnrestricted = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceExtendedDynamicState3PropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceExtendedDynamicState3PropertiesEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceExtendedDynamicState3PropertiesEXT.LAYOUT;
        }

        @Override
        public VkPhysicalDeviceExtendedDynamicState3PropertiesEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkPhysicalDeviceExtendedDynamicState3PropertiesEXT createUninit(MemorySegment segment) {
            return new VkPhysicalDeviceExtendedDynamicState3PropertiesEXT(segment);
        }
    }

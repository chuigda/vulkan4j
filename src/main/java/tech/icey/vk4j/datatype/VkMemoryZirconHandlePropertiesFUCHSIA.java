...
public record VkMemoryZirconHandlePropertiesFUCHSIA(MemorySegment segment) {
    ...
    public static final class VkMemoryZirconHandlePropertiesFUCHSIAFactory implements IDataTypeFactory<VkMemoryZirconHandlePropertiesFUCHSIA> {
        @Override
    ...
    public static final VkMemoryZirconHandlePropertiesFUCHSIAFactory FACTORY = new VkMemoryZirconHandlePropertiesFUCHSIAFactory();
}

...
public record VkAccelerationStructureMotionInstanceNV(MemorySegment segment) {
    ...
    public static final class VkAccelerationStructureMotionInstanceNVFactory implements IDataTypeFactory<VkAccelerationStructureMotionInstanceNV> {
        @Override
    ...
    public static final VkAccelerationStructureMotionInstanceNVFactory FACTORY = new VkAccelerationStructureMotionInstanceNVFactory();
}

...
public record VkExportMetalDeviceInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$mtlDevice = PathElement.groupElement(2);
    ...
    public static final class VkExportMetalDeviceInfoEXTFactory implements IDataTypeFactory<VkExportMetalDeviceInfoEXT> {
        @Override

...
public record VkPhysicalDeviceCopyMemoryIndirectPropertiesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$supportedQueues = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceCopyMemoryIndirectPropertiesNVFactory implements IDataTypeFactory<VkPhysicalDeviceCopyMemoryIndirectPropertiesNV> {
        @Override
    ...
    public static final VkPhysicalDeviceCopyMemoryIndirectPropertiesNVFactory FACTORY = new VkPhysicalDeviceCopyMemoryIndirectPropertiesNVFactory();
}

...
public record VkMemoryGetAndroidHardwareBufferInfoANDROID(MemorySegment segment) {
    ...
    public static final class VkMemoryGetAndroidHardwareBufferInfoANDROIDFactory implements IDataTypeFactory<VkMemoryGetAndroidHardwareBufferInfoANDROID> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkMemoryGetAndroidHardwareBufferInfoANDROID.LAYOUT;
        }

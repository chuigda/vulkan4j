...
public record VkPhysicalDeviceLimits(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxImageDimension1D = PathElement.groupElement(0);
    public static final PathElement PATH$maxImageDimension2D = PathElement.groupElement(1);
    public static final PathElement PATH$maxImageDimension3D = PathElement.groupElement(2);
    public static final PathElement PATH$maxImageDimensionCube = PathElement.groupElement(3);
    public static final PathElement PATH$maxImageArrayLayers = PathElement.groupElement(4);
    public static final PathElement PATH$maxTexelBufferElements = PathElement.groupElement(5);
    public static final PathElement PATH$maxUniformBufferRange = PathElement.groupElement(6);
    public static final PathElement PATH$maxStorageBufferRange = PathElement.groupElement(7);
    public static final PathElement PATH$maxPushConstantsSize = PathElement.groupElement(8);
    public static final PathElement PATH$maxMemoryAllocationCount = PathElement.groupElement(9);
    public static final PathElement PATH$maxSamplerAllocationCount = PathElement.groupElement(10);
    public static final PathElement PATH$bufferImageGranularity = PathElement.groupElement(11);
    public static final PathElement PATH$sparseAddressSpaceSize = PathElement.groupElement(12);
    public static final PathElement PATH$maxBoundDescriptorSets = PathElement.groupElement(13);
    public static final PathElement PATH$maxPerStageDescriptorSamplers = PathElement.groupElement(14);
    public static final PathElement PATH$maxPerStageDescriptorUniformBuffers = PathElement.groupElement(15);
    public static final PathElement PATH$maxPerStageDescriptorStorageBuffers = PathElement.groupElement(16);
    public static final PathElement PATH$maxPerStageDescriptorSampledImages = PathElement.groupElement(17);
    public static final PathElement PATH$maxPerStageDescriptorStorageImages = PathElement.groupElement(18);
    public static final PathElement PATH$maxPerStageDescriptorInputAttachments = PathElement.groupElement(19);
    public static final PathElement PATH$maxPerStageResources = PathElement.groupElement(20);
    public static final PathElement PATH$maxDescriptorSetSamplers = PathElement.groupElement(21);
    public static final PathElement PATH$maxDescriptorSetUniformBuffers = PathElement.groupElement(22);
    public static final PathElement PATH$maxDescriptorSetUniformBuffersDynamic = PathElement.groupElement(23);
    public static final PathElement PATH$maxDescriptorSetStorageBuffers = PathElement.groupElement(24);
    public static final PathElement PATH$maxDescriptorSetStorageBuffersDynamic = PathElement.groupElement(25);
    public static final PathElement PATH$maxDescriptorSetSampledImages = PathElement.groupElement(26);
    public static final PathElement PATH$maxDescriptorSetStorageImages = PathElement.groupElement(27);
    public static final PathElement PATH$maxDescriptorSetInputAttachments = PathElement.groupElement(28);
    public static final PathElement PATH$maxVertexInputAttributes = PathElement.groupElement(29);
    public static final PathElement PATH$maxVertexInputBindings = PathElement.groupElement(30);
    public static final PathElement PATH$maxVertexInputAttributeOffset = PathElement.groupElement(31);
    public static final PathElement PATH$maxVertexInputBindingStride = PathElement.groupElement(32);
    public static final PathElement PATH$maxVertexOutputComponents = PathElement.groupElement(33);
    public static final PathElement PATH$maxTessellationGenerationLevel = PathElement.groupElement(34);
    public static final PathElement PATH$maxTessellationPatchSize = PathElement.groupElement(35);
    public static final PathElement PATH$maxTessellationControlPerVertexInputComponents = PathElement.groupElement(36);
    public static final PathElement PATH$maxTessellationControlPerVertexOutputComponents = PathElement.groupElement(37);
    public static final PathElement PATH$maxTessellationControlPerPatchOutputComponents = PathElement.groupElement(38);
    public static final PathElement PATH$maxTessellationControlTotalOutputComponents = PathElement.groupElement(39);
    public static final PathElement PATH$maxTessellationEvaluationInputComponents = PathElement.groupElement(40);
    public static final PathElement PATH$maxTessellationEvaluationOutputComponents = PathElement.groupElement(41);
    public static final PathElement PATH$maxGeometryShaderInvocations = PathElement.groupElement(42);
    public static final PathElement PATH$maxGeometryInputComponents = PathElement.groupElement(43);
    public static final PathElement PATH$maxGeometryOutputComponents = PathElement.groupElement(44);
    public static final PathElement PATH$maxGeometryOutputVertices = PathElement.groupElement(45);
    public static final PathElement PATH$maxGeometryTotalOutputComponents = PathElement.groupElement(46);
    public static final PathElement PATH$maxFragmentInputComponents = PathElement.groupElement(47);
    public static final PathElement PATH$maxFragmentOutputAttachments = PathElement.groupElement(48);
    public static final PathElement PATH$maxFragmentDualSrcAttachments = PathElement.groupElement(49);
    public static final PathElement PATH$maxFragmentCombinedOutputResources = PathElement.groupElement(50);
    public static final PathElement PATH$maxComputeSharedMemorySize = PathElement.groupElement(51);
    public static final PathElement PATH$maxComputeWorkGroupCount = PathElement.groupElement(52);
    public static final PathElement PATH$maxComputeWorkGroupInvocations = PathElement.groupElement(53);
    public static final PathElement PATH$maxComputeWorkGroupSize = PathElement.groupElement(54);
    public static final PathElement PATH$subPixelPrecisionBits = PathElement.groupElement(55);
    public static final PathElement PATH$subTexelPrecisionBits = PathElement.groupElement(56);
    public static final PathElement PATH$mipmapPrecisionBits = PathElement.groupElement(57);
    public static final PathElement PATH$maxDrawIndexedIndexValue = PathElement.groupElement(58);
    public static final PathElement PATH$maxDrawIndirectCount = PathElement.groupElement(59);
    public static final PathElement PATH$maxSamplerLodBias = PathElement.groupElement(60);
    public static final PathElement PATH$maxSamplerAnisotropy = PathElement.groupElement(61);
    public static final PathElement PATH$maxViewports = PathElement.groupElement(62);
    public static final PathElement PATH$maxViewportDimensions = PathElement.groupElement(63);
    public static final PathElement PATH$viewportBoundsRange = PathElement.groupElement(64);
    public static final PathElement PATH$viewportSubPixelBits = PathElement.groupElement(65);
    public static final PathElement PATH$minMemoryMapAlignment = PathElement.groupElement(66);
    public static final PathElement PATH$minTexelBufferOffsetAlignment = PathElement.groupElement(67);
    public static final PathElement PATH$minUniformBufferOffsetAlignment = PathElement.groupElement(68);
    public static final PathElement PATH$minStorageBufferOffsetAlignment = PathElement.groupElement(69);
    public static final PathElement PATH$minTexelOffset = PathElement.groupElement(70);
    public static final PathElement PATH$maxTexelOffset = PathElement.groupElement(71);
    public static final PathElement PATH$minTexelGatherOffset = PathElement.groupElement(72);
    public static final PathElement PATH$maxTexelGatherOffset = PathElement.groupElement(73);
    public static final PathElement PATH$minInterpolationOffset = PathElement.groupElement(74);
    public static final PathElement PATH$maxInterpolationOffset = PathElement.groupElement(75);
    public static final PathElement PATH$subPixelInterpolationOffsetBits = PathElement.groupElement(76);
    public static final PathElement PATH$maxFramebufferWidth = PathElement.groupElement(77);
    public static final PathElement PATH$maxFramebufferHeight = PathElement.groupElement(78);
    public static final PathElement PATH$maxFramebufferLayers = PathElement.groupElement(79);
    public static final PathElement PATH$framebufferColorSampleCounts = PathElement.groupElement(80);
    public static final PathElement PATH$framebufferDepthSampleCounts = PathElement.groupElement(81);
    public static final PathElement PATH$framebufferStencilSampleCounts = PathElement.groupElement(82);
    public static final PathElement PATH$framebufferNoAttachmentsSampleCounts = PathElement.groupElement(83);
    public static final PathElement PATH$maxColorAttachments = PathElement.groupElement(84);
    public static final PathElement PATH$sampledImageColorSampleCounts = PathElement.groupElement(85);
    public static final PathElement PATH$sampledImageIntegerSampleCounts = PathElement.groupElement(86);
    public static final PathElement PATH$sampledImageDepthSampleCounts = PathElement.groupElement(87);
    public static final PathElement PATH$sampledImageStencilSampleCounts = PathElement.groupElement(88);
    public static final PathElement PATH$storageImageSampleCounts = PathElement.groupElement(89);
    public static final PathElement PATH$maxSampleMaskWords = PathElement.groupElement(90);
    public static final PathElement PATH$timestampComputeAndGraphics = PathElement.groupElement(91);
    public static final PathElement PATH$timestampPeriod = PathElement.groupElement(92);
    public static final PathElement PATH$maxClipDistances = PathElement.groupElement(93);
    public static final PathElement PATH$maxCullDistances = PathElement.groupElement(94);
    public static final PathElement PATH$maxCombinedClipAndCullDistances = PathElement.groupElement(95);
    public static final PathElement PATH$discreteQueuePriorities = PathElement.groupElement(96);
    public static final PathElement PATH$pointSizeRange = PathElement.groupElement(97);
    public static final PathElement PATH$lineWidthRange = PathElement.groupElement(98);
    public static final PathElement PATH$pointSizeGranularity = PathElement.groupElement(99);
    public static final PathElement PATH$lineWidthGranularity = PathElement.groupElement(100);
    public static final PathElement PATH$strictLines = PathElement.groupElement(101);
    public static final PathElement PATH$standardSampleLocations = PathElement.groupElement(102);
    public static final PathElement PATH$optimalBufferCopyOffsetAlignment = PathElement.groupElement(103);
    public static final PathElement PATH$optimalBufferCopyRowPitchAlignment = PathElement.groupElement(104);
    public static final PathElement PATH$nonCoherentAtomSize = PathElement.groupElement(105);
    ...
    public static final class VkPhysicalDeviceLimitsFactory implements IDataTypeFactory<VkPhysicalDeviceLimits> {
        @Override

...
public record VkImageViewHandleInfoNVX(MemorySegment segment) {
    ...
    public static final PathElement PATH$sampler = PathElement.groupElement(4);
    ...
    public static final class VkImageViewHandleInfoNVXFactory implements IDataTypeFactory<VkImageViewHandleInfoNVX> {
        @Override

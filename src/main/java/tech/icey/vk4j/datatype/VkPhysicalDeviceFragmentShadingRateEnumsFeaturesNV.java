...
public record VkPhysicalDeviceFragmentShadingRateEnumsFeaturesNV(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceFragmentShadingRateEnumsFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceFragmentShadingRateEnumsFeaturesNV> {
        @Override

...
public record VkPresentTimesInfoGOOGLE(MemorySegment segment) {
    ...
    public static final PathElement PATH$pTimes = PathElement.groupElement(3);
    ...
    public static final class VkPresentTimesInfoGOOGLEFactory implements IDataTypeFactory<VkPresentTimesInfoGOOGLE> {
        @Override
    ...
    public static final VkPresentTimesInfoGOOGLEFactory FACTORY = new VkPresentTimesInfoGOOGLEFactory();
}

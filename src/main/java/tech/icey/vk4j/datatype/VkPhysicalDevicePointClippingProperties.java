...
public record VkPhysicalDevicePointClippingProperties(MemorySegment segment) {
    ...
    public static final PathElement PATH$pointClippingBehavior = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDevicePointClippingPropertiesFactory implements IDataTypeFactory<VkPhysicalDevicePointClippingProperties> {
        @Override

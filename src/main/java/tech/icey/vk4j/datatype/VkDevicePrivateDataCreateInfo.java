...
public record VkDevicePrivateDataCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$privateDataSlotRequestCount = PathElement.groupElement(2);
    ...
    public static final class VkDevicePrivateDataCreateInfoFactory implements IDataTypeFactory<VkDevicePrivateDataCreateInfo> {
        @Override

...
public record VkGeometryNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$geometryType = PathElement.groupElement(2);
    public static final PathElement PATH$geometry = PathElement.groupElement(3);
    ...
    public static final class VkGeometryNVFactory implements IDataTypeFactory<VkGeometryNV> {
        @Override

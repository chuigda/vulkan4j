...
public record VkImportMetalIOSurfaceInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$ioSurface = PathElement.groupElement(2);
    ...
    public static final class VkImportMetalIOSurfaceInfoEXTFactory implements IDataTypeFactory<VkImportMetalIOSurfaceInfoEXT> {
        @Override
    ...
    public static final VkImportMetalIOSurfaceInfoEXTFactory FACTORY = new VkImportMetalIOSurfaceInfoEXTFactory();
}

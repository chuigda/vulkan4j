...
public record VkCopyMemoryToMicromapInfoEXT(MemorySegment segment) {
    ...
    public static final class VkCopyMemoryToMicromapInfoEXTFactory implements IDataTypeFactory<VkCopyMemoryToMicromapInfoEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkCopyMemoryToMicromapInfoEXT.LAYOUT;
        }

        @Override
        public VkCopyMemoryToMicromapInfoEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkCopyMemoryToMicromapInfoEXT createUninit(MemorySegment segment) {
            return new VkCopyMemoryToMicromapInfoEXT(segment);
        }
    }

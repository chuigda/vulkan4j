...
public record VkDescriptorImageInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$sampler = PathElement.groupElement(0);
    public static final PathElement PATH$imageView = PathElement.groupElement(1);
    public static final PathElement PATH$imageLayout = PathElement.groupElement(2);
    ...
    public static final class VkDescriptorImageInfoFactory implements IDataTypeFactory<VkDescriptorImageInfo> {
        @Override

...
public record VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$rayTracingPositionFetch = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceRayTracingPositionFetchFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR> {
        @Override

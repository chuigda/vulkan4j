...
public record VkMemoryOpaqueCaptureAddressAllocateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$opaqueCaptureAddress = PathElement.groupElement(2);
    ...
    public static final class VkMemoryOpaqueCaptureAddressAllocateInfoFactory implements IDataTypeFactory<VkMemoryOpaqueCaptureAddressAllocateInfo> {
        @Override

...
public record VkDeviceGroupRenderPassBeginInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$deviceMask = PathElement.groupElement(2);
    public static final PathElement PATH$deviceRenderAreaCount = PathElement.groupElement(3);
    public static final PathElement PATH$pDeviceRenderAreas = PathElement.groupElement(4);
    ...
    public void pDeviceRenderAreas(VkRect2D value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pDeviceRenderAreasRaw(s);
    }


    public static final class VkDeviceGroupRenderPassBeginInfoFactory implements IDataTypeFactory<VkDeviceGroupRenderPassBeginInfo> {
        @Override

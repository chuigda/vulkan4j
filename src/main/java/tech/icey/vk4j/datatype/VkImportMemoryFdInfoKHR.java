...
public record VkImportMemoryFdInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$fd = PathElement.groupElement(3);
    ...
    public static final class VkImportMemoryFdInfoKHRFactory implements IDataTypeFactory<VkImportMemoryFdInfoKHR> {
        @Override
    ...
    public static final VkImportMemoryFdInfoKHRFactory FACTORY = new VkImportMemoryFdInfoKHRFactory();
}

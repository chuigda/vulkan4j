...
public record VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$vertexInputDynamicState = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceVertexInputDynamicStateFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT.LAYOUT;
        }

...
public record VkCommandBufferInheritanceRenderPassTransformInfoQCOM(MemorySegment segment) {
    ...
    public static final class VkCommandBufferInheritanceRenderPassTransformInfoQCOMFactory implements IDataTypeFactory<VkCommandBufferInheritanceRenderPassTransformInfoQCOM> {
        @Override

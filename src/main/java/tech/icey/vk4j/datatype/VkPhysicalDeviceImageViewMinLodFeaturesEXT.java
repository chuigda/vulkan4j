...
public record VkPhysicalDeviceImageViewMinLodFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$minLod = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceImageViewMinLodFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceImageViewMinLodFeaturesEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceImageViewMinLodFeaturesEXT.LAYOUT;
        }

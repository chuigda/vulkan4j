...
public record VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$advancedBlendCoherentOperations = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceBlendOperationAdvancedFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT> {
        @Override

...
public record VkPhysicalDeviceSparseImageFormatInfo2(MemorySegment segment) {
    ...
    public static final PathElement PATH$tiling = PathElement.groupElement(6);
    ...
    public static final class VkPhysicalDeviceSparseImageFormatInfo2Factory implements IDataTypeFactory<VkPhysicalDeviceSparseImageFormatInfo2> {
        @Override

...
public record VkPhysicalDeviceTimelineSemaphoreFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$timelineSemaphore = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceTimelineSemaphoreFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceTimelineSemaphoreFeatures> {
        @Override

...
public record VkQueryLowLatencySupportNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$pQueriedLowLatencyData = PathElement.groupElement(2);
    ...
    public static final class VkQueryLowLatencySupportNVFactory implements IDataTypeFactory<VkQueryLowLatencySupportNV> {
        @Override

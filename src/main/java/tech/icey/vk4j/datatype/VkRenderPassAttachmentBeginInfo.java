...
public record VkRenderPassAttachmentBeginInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$pAttachments = PathElement.groupElement(3);
    ...
    public static final class VkRenderPassAttachmentBeginInfoFactory implements IDataTypeFactory<VkRenderPassAttachmentBeginInfo> {
        @Override

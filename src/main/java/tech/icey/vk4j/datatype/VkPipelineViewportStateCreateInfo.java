...
public record VkPipelineViewportStateCreateInfo(MemorySegment segment) {
    ...
    public static final class VkPipelineViewportStateCreateInfoFactory implements IDataTypeFactory<VkPipelineViewportStateCreateInfo> {
        @Override
    ...
    public static final VkPipelineViewportStateCreateInfoFactory FACTORY = new VkPipelineViewportStateCreateInfoFactory();
}

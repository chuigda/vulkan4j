...
public record VkComputePipelineCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$layout = PathElement.groupElement(4);
    public static final PathElement PATH$basePipelineHandle = PathElement.groupElement(5);
    public static final PathElement PATH$basePipelineIndex = PathElement.groupElement(6);
    ...
    public static final class VkComputePipelineCreateInfoFactory implements IDataTypeFactory<VkComputePipelineCreateInfo> {
        @Override
    ...
    public static final VkComputePipelineCreateInfoFactory FACTORY = new VkComputePipelineCreateInfoFactory();
}

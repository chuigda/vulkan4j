...
public record VkPhysicalDeviceLegacyVertexAttributesFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$legacyVertexAttributes = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceLegacyVertexAttributesFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceLegacyVertexAttributesFeaturesEXT> {
        @Override

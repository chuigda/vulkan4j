...
public record VkMemoryGetSciBufInfoNV(MemorySegment segment) {
    ...
    public static final class VkMemoryGetSciBufInfoNVFactory implements IDataTypeFactory<VkMemoryGetSciBufInfoNV> {
        @Override
        public Class<VkMemoryGetSciBufInfoNV> clazz() {
            return VkMemoryGetSciBufInfoNV.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkMemoryGetSciBufInfoNV.LAYOUT;
        }

        @Override
        public VkMemoryGetSciBufInfoNV create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkMemoryGetSciBufInfoNV createUninit(MemorySegment segment) {
            return new VkMemoryGetSciBufInfoNV(segment);
        }
    }

    public static final VkMemoryGetSciBufInfoNVFactory FACTORY = new VkMemoryGetSciBufInfoNVFactory();
}

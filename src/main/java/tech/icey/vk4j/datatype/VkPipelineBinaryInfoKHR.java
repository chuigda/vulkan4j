...
public record VkPipelineBinaryInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$binaryCount = PathElement.groupElement(2);
    ...
    public static final class VkPipelineBinaryInfoKHRFactory implements IDataTypeFactory<VkPipelineBinaryInfoKHR> {
        @Override

...
public record VkPhysicalDeviceLineRasterizationPropertiesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$lineSubPixelPrecisionBits = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceLineRasterizationPropertiesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceLineRasterizationPropertiesKHR> {
        @Override

...
public record VkPhysicalDeviceRayQueryFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$rayQuery = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceRayQueryFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceRayQueryFeaturesKHR> {
        @Override
    ...
    public static final VkPhysicalDeviceRayQueryFeaturesKHRFactory FACTORY = new VkPhysicalDeviceRayQueryFeaturesKHRFactory();
}

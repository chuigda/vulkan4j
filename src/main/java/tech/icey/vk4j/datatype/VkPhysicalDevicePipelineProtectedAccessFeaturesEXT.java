...
public record VkPhysicalDevicePipelineProtectedAccessFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pipelineProtectedAccess = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDevicePipelineProtectedAccessFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDevicePipelineProtectedAccessFeaturesEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDevicePipelineProtectedAccessFeaturesEXT.LAYOUT;
        }

        @Override
        public VkPhysicalDevicePipelineProtectedAccessFeaturesEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkPhysicalDevicePipelineProtectedAccessFeaturesEXT createUninit(MemorySegment segment) {
            return new VkPhysicalDevicePipelineProtectedAccessFeaturesEXT(segment);
        }
    }

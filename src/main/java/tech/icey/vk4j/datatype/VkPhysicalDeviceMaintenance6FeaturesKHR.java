...
public record VkPhysicalDeviceMaintenance6FeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$maintenance6 = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceMaintenance6FeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceMaintenance6FeaturesKHR> {
        @Override

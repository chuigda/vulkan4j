...
public record VkPipelineInfoKHR(MemorySegment segment) {
    ...
    public static final class VkPipelineInfoKHRFactory implements IDataTypeFactory<VkPipelineInfoKHR> {
        @Override
    ...
    public static final VkPipelineInfoKHRFactory FACTORY = new VkPipelineInfoKHRFactory();
}

...
public record VkImageViewSlicedCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$sliceOffset = PathElement.groupElement(2);
    public static final PathElement PATH$sliceCount = PathElement.groupElement(3);
    ...
    public static final class VkImageViewSlicedCreateInfoEXTFactory implements IDataTypeFactory<VkImageViewSlicedCreateInfoEXT> {
        @Override

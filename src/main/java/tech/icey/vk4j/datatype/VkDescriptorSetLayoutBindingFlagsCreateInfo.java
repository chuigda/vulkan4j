...
public record VkDescriptorSetLayoutBindingFlagsCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$bindingCount = PathElement.groupElement(2);
    public static final PathElement PATH$pBindingFlags = PathElement.groupElement(3);
    ...
    public static final class VkDescriptorSetLayoutBindingFlagsCreateInfoFactory implements IDataTypeFactory<VkDescriptorSetLayoutBindingFlagsCreateInfo> {
        @Override

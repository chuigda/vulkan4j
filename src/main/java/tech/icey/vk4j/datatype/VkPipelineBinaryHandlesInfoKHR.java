...
public record VkPipelineBinaryHandlesInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$pipelineBinaryCount = PathElement.groupElement(2);
    public static final PathElement PATH$pPipelineBinaries = PathElement.groupElement(3);
    ...
    public static final class VkPipelineBinaryHandlesInfoKHRFactory implements IDataTypeFactory<VkPipelineBinaryHandlesInfoKHR> {
        @Override
    ...
    public static final VkPipelineBinaryHandlesInfoKHRFactory FACTORY = new VkPipelineBinaryHandlesInfoKHRFactory();
}

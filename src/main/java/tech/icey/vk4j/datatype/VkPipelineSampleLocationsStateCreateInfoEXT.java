...
public record VkPipelineSampleLocationsStateCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$sampleLocationsEnable = PathElement.groupElement(2);
    public static final PathElement PATH$sampleLocationsInfo = PathElement.groupElement(3);
    ...
    public static final class VkPipelineSampleLocationsStateCreateInfoEXTFactory implements IDataTypeFactory<VkPipelineSampleLocationsStateCreateInfoEXT> {
        @Override

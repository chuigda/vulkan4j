...
public record VkAttachmentReference2(MemorySegment segment) {
    ...
    public static final PathElement PATH$attachment = PathElement.groupElement(2);
    public static final PathElement PATH$layout = PathElement.groupElement(3);
    public static final PathElement PATH$aspectMask = PathElement.groupElement(4);
    ...
    public static final class VkAttachmentReference2Factory implements IDataTypeFactory<VkAttachmentReference2> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkAttachmentReference2.LAYOUT;
        }

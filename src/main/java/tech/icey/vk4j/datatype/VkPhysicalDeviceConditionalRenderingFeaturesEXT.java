...
public record VkPhysicalDeviceConditionalRenderingFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$conditionalRendering = PathElement.groupElement(2);
    public static final PathElement PATH$inheritedConditionalRendering = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceConditionalRenderingFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceConditionalRenderingFeaturesEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceConditionalRenderingFeaturesEXT.LAYOUT;
        }

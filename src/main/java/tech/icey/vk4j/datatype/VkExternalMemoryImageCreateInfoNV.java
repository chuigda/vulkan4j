...
public record VkExternalMemoryImageCreateInfoNV(MemorySegment segment) {
    ...
    public static final class VkExternalMemoryImageCreateInfoNVFactory implements IDataTypeFactory<VkExternalMemoryImageCreateInfoNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkExternalMemoryImageCreateInfoNV.LAYOUT;
        }

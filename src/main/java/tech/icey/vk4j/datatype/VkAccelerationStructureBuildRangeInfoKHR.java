...
public record VkAccelerationStructureBuildRangeInfoKHR(MemorySegment segment) {
    ...
    public static final class VkAccelerationStructureBuildRangeInfoKHRFactory implements IDataTypeFactory<VkAccelerationStructureBuildRangeInfoKHR> {
        @Override
    ...
    public static final VkAccelerationStructureBuildRangeInfoKHRFactory FACTORY = new VkAccelerationStructureBuildRangeInfoKHRFactory();
}

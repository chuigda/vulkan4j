...
public record VkPerformanceQuerySubmitInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$counterPassIndex = PathElement.groupElement(2);
    ...
    public static final class VkPerformanceQuerySubmitInfoKHRFactory implements IDataTypeFactory<VkPerformanceQuerySubmitInfoKHR> {
        @Override

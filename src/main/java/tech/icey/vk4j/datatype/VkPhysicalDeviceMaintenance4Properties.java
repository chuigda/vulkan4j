...
public record VkPhysicalDeviceMaintenance4Properties(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxBufferSize = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceMaintenance4PropertiesFactory implements IDataTypeFactory<VkPhysicalDeviceMaintenance4Properties> {
        @Override

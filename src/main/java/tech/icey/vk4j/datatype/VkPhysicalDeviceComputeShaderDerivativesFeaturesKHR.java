...
public record VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$computeDerivativeGroupQuads = PathElement.groupElement(2);
    public static final PathElement PATH$computeDerivativeGroupLinear = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceComputeShaderDerivativesFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR.LAYOUT;
        }

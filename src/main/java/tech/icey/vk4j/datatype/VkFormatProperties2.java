...
public record VkFormatProperties2(MemorySegment segment) {
    ...
    public static final PathElement PATH$formatProperties = PathElement.groupElement(2);
    ...
    public static final class VkFormatProperties2Factory implements IDataTypeFactory<VkFormatProperties2> {
        @Override

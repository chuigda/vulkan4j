...
public record VkPhysicalDevicePrivateDataFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$privateData = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDevicePrivateDataFeaturesFactory implements IDataTypeFactory<VkPhysicalDevicePrivateDataFeatures> {
        @Override

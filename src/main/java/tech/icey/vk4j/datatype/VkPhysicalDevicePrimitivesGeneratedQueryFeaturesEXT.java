...
public record VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$primitivesGeneratedQuery = PathElement.groupElement(2);
    public static final PathElement PATH$primitivesGeneratedQueryWithRasterizerDiscard = PathElement.groupElement(3);
    public static final PathElement PATH$primitivesGeneratedQueryWithNonZeroStreams = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT.LAYOUT;
        }

        @Override
        public VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT createUninit(MemorySegment segment) {
            return new VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT(segment);
        }
    }

...
public record VkDisplayPlaneProperties2KHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$displayPlaneProperties = PathElement.groupElement(2);
    ...
    public static final class VkDisplayPlaneProperties2KHRFactory implements IDataTypeFactory<VkDisplayPlaneProperties2KHR> {
        @Override
    ...
    public static final VkDisplayPlaneProperties2KHRFactory FACTORY = new VkDisplayPlaneProperties2KHRFactory();
}

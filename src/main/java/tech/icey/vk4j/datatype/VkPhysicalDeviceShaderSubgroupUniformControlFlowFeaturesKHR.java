...
public record VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderSubgroupUniformControlFlow = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR.LAYOUT;
        }

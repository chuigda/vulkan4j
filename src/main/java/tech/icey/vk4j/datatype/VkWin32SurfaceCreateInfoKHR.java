...
public record VkWin32SurfaceCreateInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$hinstance = PathElement.groupElement(3);
    public static final PathElement PATH$hwnd = PathElement.groupElement(4);
    ...
    public static final class VkWin32SurfaceCreateInfoKHRFactory implements IDataTypeFactory<VkWin32SurfaceCreateInfoKHR> {
        @Override

...
public record VkPipelineViewportDepthClipControlCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$negativeOneToOne = PathElement.groupElement(2);
    ...
    public static final class VkPipelineViewportDepthClipControlCreateInfoEXTFactory implements IDataTypeFactory<VkPipelineViewportDepthClipControlCreateInfoEXT> {
        @Override

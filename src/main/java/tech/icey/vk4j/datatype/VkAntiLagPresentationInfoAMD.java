...
public record VkAntiLagPresentationInfoAMD(MemorySegment segment) {
    ...
    public static final PathElement PATH$frameIndex = PathElement.groupElement(3);
    ...
    public static final class VkAntiLagPresentationInfoAMDFactory implements IDataTypeFactory<VkAntiLagPresentationInfoAMD> {
        @Override

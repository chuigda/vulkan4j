...
public record VkBindImagePlaneMemoryInfo(MemorySegment segment) {
    ...
    public static final class VkBindImagePlaneMemoryInfoFactory implements IDataTypeFactory<VkBindImagePlaneMemoryInfo> {
        @Override
        public Class<VkBindImagePlaneMemoryInfo> clazz() {
            return VkBindImagePlaneMemoryInfo.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkBindImagePlaneMemoryInfo.LAYOUT;
        }
    ...
    public static final VkBindImagePlaneMemoryInfoFactory FACTORY = new VkBindImagePlaneMemoryInfoFactory();
}

...
public record VkQueueFamilyGlobalPriorityPropertiesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$priorityCount = PathElement.groupElement(2);
    public static final PathElement PATH$priorities = PathElement.groupElement(3);
    ...
    public static final class VkQueueFamilyGlobalPriorityPropertiesKHRFactory implements IDataTypeFactory<VkQueueFamilyGlobalPriorityPropertiesKHR> {
        @Override

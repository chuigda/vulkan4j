...
public record VkImageAlignmentControlCreateInfoMESA(MemorySegment segment) {
    ...
    public static final PathElement PATH$maximumRequestedAlignment = PathElement.groupElement(2);
    ...
    public static final class VkImageAlignmentControlCreateInfoMESAFactory implements IDataTypeFactory<VkImageAlignmentControlCreateInfoMESA> {
        @Override

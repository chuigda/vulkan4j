...
public record VkPhysicalDeviceSynchronization2Features(MemorySegment segment) {
    ...
    public static final PathElement PATH$synchronization2 = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceSynchronization2FeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceSynchronization2Features> {
        @Override

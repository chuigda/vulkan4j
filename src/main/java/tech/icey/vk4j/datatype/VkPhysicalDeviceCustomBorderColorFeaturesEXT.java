...
public record VkPhysicalDeviceCustomBorderColorFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$customBorderColors = PathElement.groupElement(2);
    public static final PathElement PATH$customBorderColorWithoutFormat = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceCustomBorderColorFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceCustomBorderColorFeaturesEXT> {
        @Override

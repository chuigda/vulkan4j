...
public record VkPhysicalDeviceFragmentDensityMapPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$minFragmentDensityTexelSize = PathElement.groupElement(2);
    public static final PathElement PATH$maxFragmentDensityTexelSize = PathElement.groupElement(3);
    public static final PathElement PATH$fragmentDensityInvocations = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceFragmentDensityMapPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceFragmentDensityMapPropertiesEXT> {
        @Override
    ...
    public static final VkPhysicalDeviceFragmentDensityMapPropertiesEXTFactory FACTORY = new VkPhysicalDeviceFragmentDensityMapPropertiesEXTFactory();
}

...
public record VkDisplayNativeHdrSurfaceCapabilitiesAMD(MemorySegment segment) {
    ...
    public static final PathElement PATH$localDimmingSupport = PathElement.groupElement(2);
    ...
    public static final class VkDisplayNativeHdrSurfaceCapabilitiesAMDFactory implements IDataTypeFactory<VkDisplayNativeHdrSurfaceCapabilitiesAMD> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkDisplayNativeHdrSurfaceCapabilitiesAMD.LAYOUT;
        }

...
public record VkSubpassResolvePerformanceQueryEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$optimal = PathElement.groupElement(2);
    ...
    public static final class VkSubpassResolvePerformanceQueryEXTFactory implements IDataTypeFactory<VkSubpassResolvePerformanceQueryEXT> {
        @Override

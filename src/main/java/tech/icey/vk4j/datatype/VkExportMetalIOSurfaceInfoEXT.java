...
public record VkExportMetalIOSurfaceInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$ioSurface = PathElement.groupElement(3);
    ...
    public static final class VkExportMetalIOSurfaceInfoEXTFactory implements IDataTypeFactory<VkExportMetalIOSurfaceInfoEXT> {
        @Override

...
public record VkSubpassBeginInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$contents = PathElement.groupElement(2);
    ...
    public static final class VkSubpassBeginInfoFactory implements IDataTypeFactory<VkSubpassBeginInfo> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkSubpassBeginInfo.LAYOUT;
        }

        @Override
        public VkSubpassBeginInfo create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkSubpassBeginInfo createUninit(MemorySegment segment) {
            return new VkSubpassBeginInfo(segment);
        }
    }

...
public record VkPhysicalDeviceDisplacementMicromapFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$displacementMicromap = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceDisplacementMicromapFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceDisplacementMicromapFeaturesNV> {
        @Override
    ...
    public static final VkPhysicalDeviceDisplacementMicromapFeaturesNVFactory FACTORY = new VkPhysicalDeviceDisplacementMicromapFeaturesNVFactory();
}

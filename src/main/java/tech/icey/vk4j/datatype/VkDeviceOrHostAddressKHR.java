...
public record VkDeviceOrHostAddressKHR(MemorySegment segment) {
    ...
    public static final class VkDeviceOrHostAddressKHRFactory implements IDataTypeFactory<VkDeviceOrHostAddressKHR> {
        @Override
    ...
    public static final VkDeviceOrHostAddressKHRFactory FACTORY = new VkDeviceOrHostAddressKHRFactory();
}

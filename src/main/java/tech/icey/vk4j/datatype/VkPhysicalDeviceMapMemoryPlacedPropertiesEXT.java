...
public record VkPhysicalDeviceMapMemoryPlacedPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$minPlacedMemoryMapAlignment = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceMapMemoryPlacedPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceMapMemoryPlacedPropertiesEXT> {
        @Override

...
public record VkPhysicalDeviceExternalFenceInfo(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceExternalFenceInfoFactory implements IDataTypeFactory<VkPhysicalDeviceExternalFenceInfo> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceExternalFenceInfo.LAYOUT;
        }

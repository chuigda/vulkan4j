...
public record VkPhysicalDeviceCooperativeMatrixPropertiesKHR(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceCooperativeMatrixPropertiesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceCooperativeMatrixPropertiesKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceCooperativeMatrixPropertiesKHR.LAYOUT;
        }

...
public record VkImportMemoryBufferCollectionFUCHSIA(MemorySegment segment) {
    ...
    public static final class VkImportMemoryBufferCollectionFUCHSIAFactory implements IDataTypeFactory<VkImportMemoryBufferCollectionFUCHSIA> {
        @Override
        public Class<VkImportMemoryBufferCollectionFUCHSIA> clazz() {
            return VkImportMemoryBufferCollectionFUCHSIA.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkImportMemoryBufferCollectionFUCHSIA.LAYOUT;
        }

        @Override
        public VkImportMemoryBufferCollectionFUCHSIA create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkImportMemoryBufferCollectionFUCHSIA createUninit(MemorySegment segment) {
            return new VkImportMemoryBufferCollectionFUCHSIA(segment);
        }
    }

    public static final VkImportMemoryBufferCollectionFUCHSIAFactory FACTORY = new VkImportMemoryBufferCollectionFUCHSIAFactory();
}

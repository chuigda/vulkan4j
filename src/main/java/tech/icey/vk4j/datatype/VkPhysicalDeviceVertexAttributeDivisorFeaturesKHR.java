...
public record VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$vertexAttributeInstanceRateDivisor = PathElement.groupElement(2);
    public static final PathElement PATH$vertexAttributeInstanceRateZeroDivisor = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceVertexAttributeDivisorFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR> {
        @Override
    ...
    public static final VkPhysicalDeviceVertexAttributeDivisorFeaturesKHRFactory FACTORY = new VkPhysicalDeviceVertexAttributeDivisorFeaturesKHRFactory();
}

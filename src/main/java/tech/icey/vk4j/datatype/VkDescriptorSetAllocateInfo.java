...
public record VkDescriptorSetAllocateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$descriptorPool = PathElement.groupElement(2);
    public static final PathElement PATH$descriptorSetCount = PathElement.groupElement(3);
    ...
    public static final class VkDescriptorSetAllocateInfoFactory implements IDataTypeFactory<VkDescriptorSetAllocateInfo> {
        @Override

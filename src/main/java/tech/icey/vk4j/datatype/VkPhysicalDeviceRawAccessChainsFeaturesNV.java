...
public record VkPhysicalDeviceRawAccessChainsFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderRawAccessChains = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceRawAccessChainsFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceRawAccessChainsFeaturesNV> {
        @Override

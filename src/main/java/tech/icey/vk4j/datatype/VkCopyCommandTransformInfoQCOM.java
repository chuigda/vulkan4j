...
public record VkCopyCommandTransformInfoQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$transform = PathElement.groupElement(2);
    ...
    public static final class VkCopyCommandTransformInfoQCOMFactory implements IDataTypeFactory<VkCopyCommandTransformInfoQCOM> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkCopyCommandTransformInfoQCOM.LAYOUT;
        }

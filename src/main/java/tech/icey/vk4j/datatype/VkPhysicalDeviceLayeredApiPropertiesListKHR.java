...
public record VkPhysicalDeviceLayeredApiPropertiesListKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$layeredApiCount = PathElement.groupElement(2);
    public static final PathElement PATH$pLayeredApis = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceLayeredApiPropertiesListKHRFactory implements IDataTypeFactory<VkPhysicalDeviceLayeredApiPropertiesListKHR> {
        @Override
    ...
    public static final VkPhysicalDeviceLayeredApiPropertiesListKHRFactory FACTORY = new VkPhysicalDeviceLayeredApiPropertiesListKHRFactory();
}

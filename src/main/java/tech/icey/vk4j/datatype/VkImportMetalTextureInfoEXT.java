...
public record VkImportMetalTextureInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$plane = PathElement.groupElement(2);
    public static final PathElement PATH$mtlTexture = PathElement.groupElement(3);
    ...
    public static final class VkImportMetalTextureInfoEXTFactory implements IDataTypeFactory<VkImportMetalTextureInfoEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkImportMetalTextureInfoEXT.LAYOUT;
        }

        @Override
        public VkImportMetalTextureInfoEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkImportMetalTextureInfoEXT createUninit(MemorySegment segment) {
            return new VkImportMetalTextureInfoEXT(segment);
        }
    }

...
public record VkMemoryToImageCopyEXT(MemorySegment segment) {
    ...
    public static final class VkMemoryToImageCopyEXTFactory implements IDataTypeFactory<VkMemoryToImageCopyEXT> {
        @Override
    ...
    public static final VkMemoryToImageCopyEXTFactory FACTORY = new VkMemoryToImageCopyEXTFactory();
}

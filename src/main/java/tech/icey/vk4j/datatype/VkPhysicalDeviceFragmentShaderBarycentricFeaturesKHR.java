...
public record VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$fragmentShaderBarycentric = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.LAYOUT;
        }

        @Override
        public VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR createUninit(MemorySegment segment) {
            return new VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR(segment);
        }
    }

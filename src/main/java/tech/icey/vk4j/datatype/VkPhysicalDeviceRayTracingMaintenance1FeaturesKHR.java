...
public record VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$rayTracingMaintenance1 = PathElement.groupElement(2);
    public static final PathElement PATH$rayTracingPipelineTraceRaysIndirect2 = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceRayTracingMaintenance1FeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR> {
        @Override

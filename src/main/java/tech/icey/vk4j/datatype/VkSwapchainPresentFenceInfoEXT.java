...
public record VkSwapchainPresentFenceInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pFences = PathElement.groupElement(3);
    ...
    public static final class VkSwapchainPresentFenceInfoEXTFactory implements IDataTypeFactory<VkSwapchainPresentFenceInfoEXT> {
        @Override

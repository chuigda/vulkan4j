...
public record VkPhysicalDeviceShaderFloat16Int8Features(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderFloat16 = PathElement.groupElement(2);
    public static final PathElement PATH$shaderInt8 = PathElement.groupElement(3);

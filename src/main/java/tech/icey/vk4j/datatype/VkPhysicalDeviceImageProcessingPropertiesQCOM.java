...
public record VkPhysicalDeviceImageProcessingPropertiesQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxWeightFilterPhases = PathElement.groupElement(2);
    public static final PathElement PATH$maxWeightFilterDimension = PathElement.groupElement(3);
    public static final PathElement PATH$maxBlockMatchRegion = PathElement.groupElement(4);
    public static final PathElement PATH$maxBoxFilterBlockSize = PathElement.groupElement(5);
    ...
    public static final class VkPhysicalDeviceImageProcessingPropertiesQCOMFactory implements IDataTypeFactory<VkPhysicalDeviceImageProcessingPropertiesQCOM> {
        @Override
    ...
    public static final VkPhysicalDeviceImageProcessingPropertiesQCOMFactory FACTORY = new VkPhysicalDeviceImageProcessingPropertiesQCOMFactory();
}

...
public record VkAndroidHardwareBufferFormatPropertiesANDROID(MemorySegment segment) {
    ...
    public VkAndroidHardwareBufferFormatPropertiesANDROID(MemorySegment segment) {
        this.segment = segment;
        this.sType(VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_ANDROID);
    }
    ...
    public static final class VkAndroidHardwareBufferFormatPropertiesANDROIDFactory implements IDataTypeFactory<VkAndroidHardwareBufferFormatPropertiesANDROID> {
        @Override
        public Class<VkAndroidHardwareBufferFormatPropertiesANDROID> clazz() {
            return VkAndroidHardwareBufferFormatPropertiesANDROID.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkAndroidHardwareBufferFormatPropertiesANDROID.LAYOUT;
        }

        @Override
        public VkAndroidHardwareBufferFormatPropertiesANDROID create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkAndroidHardwareBufferFormatPropertiesANDROID createUninit(MemorySegment segment) {
            return new VkAndroidHardwareBufferFormatPropertiesANDROID(segment);
        }
    }

    public static final VkAndroidHardwareBufferFormatPropertiesANDROIDFactory FACTORY = new VkAndroidHardwareBufferFormatPropertiesANDROIDFactory();
}

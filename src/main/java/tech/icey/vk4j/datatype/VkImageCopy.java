...
public record VkImageCopy(MemorySegment segment) {
    ...
    public static final class VkImageCopyFactory implements IDataTypeFactory<VkImageCopy> {
        @Override
        public Class<VkImageCopy> clazz() {
            return VkImageCopy.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkImageCopy.LAYOUT;
        }

        @Override
        public VkImageCopy create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkImageCopy createUninit(MemorySegment segment) {
            return new VkImageCopy(segment);
        }
    }

    public static final VkImageCopyFactory FACTORY = new VkImageCopyFactory();
}

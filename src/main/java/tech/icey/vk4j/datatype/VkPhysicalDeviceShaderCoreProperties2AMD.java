...
public record VkPhysicalDeviceShaderCoreProperties2AMD(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderCoreFeatures = PathElement.groupElement(2);
    public static final PathElement PATH$activeComputeUnitCount = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceShaderCoreProperties2AMDFactory implements IDataTypeFactory<VkPhysicalDeviceShaderCoreProperties2AMD> {
        @Override
    ...
    public static final VkPhysicalDeviceShaderCoreProperties2AMDFactory FACTORY = new VkPhysicalDeviceShaderCoreProperties2AMDFactory();
}

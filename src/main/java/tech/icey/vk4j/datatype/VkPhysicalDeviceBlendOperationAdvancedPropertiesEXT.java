...
public record VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceBlendOperationAdvancedPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT> {
        @Override

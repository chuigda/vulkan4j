...
public record VkPhysicalDeviceImageRobustnessFeatures(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceImageRobustnessFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceImageRobustnessFeatures> {
        @Override
    ...
    public static final VkPhysicalDeviceImageRobustnessFeaturesFactory FACTORY = new VkPhysicalDeviceImageRobustnessFeaturesFactory();
}

...
public record VkCooperativeMatrixPropertiesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$DType = PathElement.groupElement(8);
    public static final PathElement PATH$scope = PathElement.groupElement(9);
    ...
    public static final class VkCooperativeMatrixPropertiesNVFactory implements IDataTypeFactory<VkCooperativeMatrixPropertiesNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkCooperativeMatrixPropertiesNV.LAYOUT;
        }

        @Override
        public VkCooperativeMatrixPropertiesNV create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkCooperativeMatrixPropertiesNV createUninit(MemorySegment segment) {
            return new VkCooperativeMatrixPropertiesNV(segment);
        }
    }

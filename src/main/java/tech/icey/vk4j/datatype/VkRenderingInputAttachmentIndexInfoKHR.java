...
public record VkRenderingInputAttachmentIndexInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$pColorAttachmentInputIndices = PathElement.groupElement(3);
    public static final PathElement PATH$pDepthInputAttachmentIndex = PathElement.groupElement(4);
    public static final PathElement PATH$pStencilInputAttachmentIndex = PathElement.groupElement(5);
    ...
    public static final class VkRenderingInputAttachmentIndexInfoKHRFactory implements IDataTypeFactory<VkRenderingInputAttachmentIndexInfoKHR> {
        @Override

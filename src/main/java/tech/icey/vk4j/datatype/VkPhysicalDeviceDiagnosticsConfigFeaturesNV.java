...
public record VkPhysicalDeviceDiagnosticsConfigFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$diagnosticsConfig = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceDiagnosticsConfigFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceDiagnosticsConfigFeaturesNV> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceDiagnosticsConfigFeaturesNV.LAYOUT;
        }

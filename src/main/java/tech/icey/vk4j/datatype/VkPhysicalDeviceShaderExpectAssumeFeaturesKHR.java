...
public record VkPhysicalDeviceShaderExpectAssumeFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderExpectAssume = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceShaderExpectAssumeFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceShaderExpectAssumeFeaturesKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceShaderExpectAssumeFeaturesKHR.LAYOUT;
        }

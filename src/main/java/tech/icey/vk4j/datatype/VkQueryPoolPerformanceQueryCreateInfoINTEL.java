...
public record VkQueryPoolPerformanceQueryCreateInfoINTEL(MemorySegment segment) {
    ...
    public static final PathElement PATH$performanceCountersSampling = PathElement.groupElement(2);
    ...
    public static final class VkQueryPoolPerformanceQueryCreateInfoINTELFactory implements IDataTypeFactory<VkQueryPoolPerformanceQueryCreateInfoINTEL> {
        @Override

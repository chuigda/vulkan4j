...
public record VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$workgroupMemoryExplicitLayout = PathElement.groupElement(2);
    public static final PathElement PATH$workgroupMemoryExplicitLayoutScalarBlockLayout = PathElement.groupElement(3);
    public static final PathElement PATH$workgroupMemoryExplicitLayout8BitAccess = PathElement.groupElement(4);
    public static final PathElement PATH$workgroupMemoryExplicitLayout16BitAccess = PathElement.groupElement(5);
    ...
    public static final class VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR.LAYOUT;
        }

...
public record VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderIntegerFunctions2 = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTELFactory implements IDataTypeFactory<VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL> {
        @Override

...
public record VkPhysicalDeviceHostQueryResetFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$hostQueryReset = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceHostQueryResetFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceHostQueryResetFeatures> {
        @Override

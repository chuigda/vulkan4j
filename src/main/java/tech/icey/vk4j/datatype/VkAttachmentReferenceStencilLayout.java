...
public record VkAttachmentReferenceStencilLayout(MemorySegment segment) {
    ...
    public static final PathElement PATH$stencilLayout = PathElement.groupElement(2);
    ...
    public static final class VkAttachmentReferenceStencilLayoutFactory implements IDataTypeFactory<VkAttachmentReferenceStencilLayout> {
        @Override

...
public record VkPerformanceQueryReservationInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxPerformanceQueriesPerPool = PathElement.groupElement(2);
    ...
    public VkPerformanceQueryReservationInfoKHR(MemorySegment segment) {
        this.segment = segment;
        this.sType(VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_RESERVATION_INFO_KHR);
    }
    ...
    public static final class VkPerformanceQueryReservationInfoKHRFactory implements IDataTypeFactory<VkPerformanceQueryReservationInfoKHR> {
        @Override
        public Class<VkPerformanceQueryReservationInfoKHR> clazz() {
            return VkPerformanceQueryReservationInfoKHR.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkPerformanceQueryReservationInfoKHR.LAYOUT;
        }
    ...
    public static final VkPerformanceQueryReservationInfoKHRFactory FACTORY = new VkPerformanceQueryReservationInfoKHRFactory();
}

...
public record VkPhysicalDeviceVulkan12Features(MemorySegment segment) {
    ...
    public static final PathElement PATH$samplerMirrorClampToEdge = PathElement.groupElement(2);
    public static final PathElement PATH$drawIndirectCount = PathElement.groupElement(3);
    public static final PathElement PATH$storageBuffer8BitAccess = PathElement.groupElement(4);
    public static final PathElement PATH$uniformAndStorageBuffer8BitAccess = PathElement.groupElement(5);
    public static final PathElement PATH$storagePushConstant8 = PathElement.groupElement(6);
    public static final PathElement PATH$shaderBufferInt64Atomics = PathElement.groupElement(7);
    public static final PathElement PATH$shaderSharedInt64Atomics = PathElement.groupElement(8);
    public static final PathElement PATH$shaderFloat16 = PathElement.groupElement(9);
    public static final PathElement PATH$shaderInt8 = PathElement.groupElement(10);
    public static final PathElement PATH$descriptorIndexing = PathElement.groupElement(11);
    public static final PathElement PATH$shaderInputAttachmentArrayDynamicIndexing = PathElement.groupElement(12);
    public static final PathElement PATH$shaderUniformTexelBufferArrayDynamicIndexing = PathElement.groupElement(13);
    public static final PathElement PATH$shaderStorageTexelBufferArrayDynamicIndexing = PathElement.groupElement(14);
    public static final PathElement PATH$shaderUniformBufferArrayNonUniformIndexing = PathElement.groupElement(15);
    public static final PathElement PATH$shaderSampledImageArrayNonUniformIndexing = PathElement.groupElement(16);
    public static final PathElement PATH$shaderStorageBufferArrayNonUniformIndexing = PathElement.groupElement(17);
    public static final PathElement PATH$shaderStorageImageArrayNonUniformIndexing = PathElement.groupElement(18);
    public static final PathElement PATH$shaderInputAttachmentArrayNonUniformIndexing = PathElement.groupElement(19);
    public static final PathElement PATH$shaderUniformTexelBufferArrayNonUniformIndexing = PathElement.groupElement(20);
    public static final PathElement PATH$shaderStorageTexelBufferArrayNonUniformIndexing = PathElement.groupElement(21);
    public static final PathElement PATH$descriptorBindingUniformBufferUpdateAfterBind = PathElement.groupElement(22);
    public static final PathElement PATH$descriptorBindingSampledImageUpdateAfterBind = PathElement.groupElement(23);
    public static final PathElement PATH$descriptorBindingStorageImageUpdateAfterBind = PathElement.groupElement(24);
    public static final PathElement PATH$descriptorBindingStorageBufferUpdateAfterBind = PathElement.groupElement(25);
    public static final PathElement PATH$descriptorBindingUniformTexelBufferUpdateAfterBind = PathElement.groupElement(26);
    public static final PathElement PATH$descriptorBindingStorageTexelBufferUpdateAfterBind = PathElement.groupElement(27);
    public static final PathElement PATH$descriptorBindingUpdateUnusedWhilePending = PathElement.groupElement(28);
    public static final PathElement PATH$descriptorBindingPartiallyBound = PathElement.groupElement(29);
    public static final PathElement PATH$descriptorBindingVariableDescriptorCount = PathElement.groupElement(30);
    public static final PathElement PATH$runtimeDescriptorArray = PathElement.groupElement(31);
    public static final PathElement PATH$samplerFilterMinmax = PathElement.groupElement(32);
    public static final PathElement PATH$scalarBlockLayout = PathElement.groupElement(33);
    public static final PathElement PATH$imagelessFramebuffer = PathElement.groupElement(34);
    public static final PathElement PATH$uniformBufferStandardLayout = PathElement.groupElement(35);
    public static final PathElement PATH$shaderSubgroupExtendedTypes = PathElement.groupElement(36);
    public static final PathElement PATH$separateDepthStencilLayouts = PathElement.groupElement(37);
    public static final PathElement PATH$hostQueryReset = PathElement.groupElement(38);
    public static final PathElement PATH$timelineSemaphore = PathElement.groupElement(39);
    public static final PathElement PATH$bufferDeviceAddress = PathElement.groupElement(40);
    public static final PathElement PATH$bufferDeviceAddressCaptureReplay = PathElement.groupElement(41);
    public static final PathElement PATH$bufferDeviceAddressMultiDevice = PathElement.groupElement(42);
    public static final PathElement PATH$vulkanMemoryModel = PathElement.groupElement(43);
    public static final PathElement PATH$vulkanMemoryModelDeviceScope = PathElement.groupElement(44);
    public static final PathElement PATH$vulkanMemoryModelAvailabilityVisibilityChains = PathElement.groupElement(45);
    public static final PathElement PATH$shaderOutputViewportIndex = PathElement.groupElement(46);
    public static final PathElement PATH$shaderOutputLayer = PathElement.groupElement(47);
    public static final PathElement PATH$subgroupBroadcastDynamicId = PathElement.groupElement(48);
    ...
    public static final class VkPhysicalDeviceVulkan12FeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceVulkan12Features> {
        @Override
    ...
    public static final VkPhysicalDeviceVulkan12FeaturesFactory FACTORY = new VkPhysicalDeviceVulkan12FeaturesFactory();
}

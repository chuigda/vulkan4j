...
public record VkPipelineShaderStageNodeCreateInfoAMDX(MemorySegment segment) {
    ...
    public static final PathElement PATH$pName = PathElement.groupElement(2);
    ...
    public static final class VkPipelineShaderStageNodeCreateInfoAMDXFactory implements IDataTypeFactory<VkPipelineShaderStageNodeCreateInfoAMDX> {
        @Override

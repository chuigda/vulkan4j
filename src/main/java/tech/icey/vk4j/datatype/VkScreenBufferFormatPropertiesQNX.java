...
public record VkScreenBufferFormatPropertiesQNX(MemorySegment segment) {
    ...
    public static final PathElement PATH$screenUsage = PathElement.groupElement(4);
    public static final PathElement PATH$formatFeatures = PathElement.groupElement(5);
    public static final PathElement PATH$samplerYcbcrConversionComponents = PathElement.groupElement(6);
    public static final PathElement PATH$suggestedYcbcrModel = PathElement.groupElement(7);
    public static final PathElement PATH$suggestedYcbcrRange = PathElement.groupElement(8);
    public static final PathElement PATH$suggestedXChromaOffset = PathElement.groupElement(9);
    public static final PathElement PATH$suggestedYChromaOffset = PathElement.groupElement(10);
    ...
    public static final class VkScreenBufferFormatPropertiesQNXFactory implements IDataTypeFactory<VkScreenBufferFormatPropertiesQNX> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkScreenBufferFormatPropertiesQNX.LAYOUT;
        }

        @Override
        public VkScreenBufferFormatPropertiesQNX create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkScreenBufferFormatPropertiesQNX createUninit(MemorySegment segment) {
            return new VkScreenBufferFormatPropertiesQNX(segment);
        }
    }

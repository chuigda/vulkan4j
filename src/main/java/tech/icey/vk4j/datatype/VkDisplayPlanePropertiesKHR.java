...
public record VkDisplayPlanePropertiesKHR(MemorySegment segment) {
    ...
    public static final class VkDisplayPlanePropertiesKHRFactory implements IDataTypeFactory<VkDisplayPlanePropertiesKHR> {
        @Override
    ...
    public static final VkDisplayPlanePropertiesKHRFactory FACTORY = new VkDisplayPlanePropertiesKHRFactory();
}

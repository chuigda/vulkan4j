...
public record VkPipelineTessellationDomainOriginStateCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$domainOrigin = PathElement.groupElement(2);
    ...
    public static final class VkPipelineTessellationDomainOriginStateCreateInfoFactory implements IDataTypeFactory<VkPipelineTessellationDomainOriginStateCreateInfo> {
        @Override

...
public record VkQueueFamilyProperties2(MemorySegment segment) {
    ...
    public static final PathElement PATH$queueFamilyProperties = PathElement.groupElement(2);
    ...
    public static final class VkQueueFamilyProperties2Factory implements IDataTypeFactory<VkQueueFamilyProperties2> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkQueueFamilyProperties2.LAYOUT;
        }

...
public record VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$graphicsPipelineLibrary = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT> {
        @Override
    ...
    public static final VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXTFactory FACTORY = new VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXTFactory();
}

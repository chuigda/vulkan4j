...
public record VkImportMemoryWin32HandleInfoNV(MemorySegment segment) {
    ...
    public static final class VkImportMemoryWin32HandleInfoNVFactory implements IDataTypeFactory<VkImportMemoryWin32HandleInfoNV> {
        @Override
        public Class<VkImportMemoryWin32HandleInfoNV> clazz() {
            return VkImportMemoryWin32HandleInfoNV.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkImportMemoryWin32HandleInfoNV.LAYOUT;
        }

        @Override
        public VkImportMemoryWin32HandleInfoNV create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkImportMemoryWin32HandleInfoNV createUninit(MemorySegment segment) {
            return new VkImportMemoryWin32HandleInfoNV(segment);
        }
    }

    public static final VkImportMemoryWin32HandleInfoNVFactory FACTORY = new VkImportMemoryWin32HandleInfoNVFactory();
}

...
public record VkPhysicalDeviceLayeredDriverPropertiesMSFT(MemorySegment segment) {
    ...
    public static final PathElement PATH$underlyingAPI = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceLayeredDriverPropertiesMSFTFactory implements IDataTypeFactory<VkPhysicalDeviceLayeredDriverPropertiesMSFT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceLayeredDriverPropertiesMSFT.LAYOUT;
        }

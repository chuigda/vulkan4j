...
public record VkPhysicalDeviceImageFormatInfo2(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceImageFormatInfo2Factory implements IDataTypeFactory<VkPhysicalDeviceImageFormatInfo2> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceImageFormatInfo2.LAYOUT;
        }

...
public record VkPhysicalDeviceExtendedDynamicState2FeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$extendedDynamicState2 = PathElement.groupElement(2);
    public static final PathElement PATH$extendedDynamicState2LogicOp = PathElement.groupElement(3);
    public static final PathElement PATH$extendedDynamicState2PatchControlPoints = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceExtendedDynamicState2FeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceExtendedDynamicState2FeaturesEXT> {
        @Override

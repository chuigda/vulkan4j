...
public record VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$fragmentDensityMapOffset = PathElement.groupElement(2);
    ...
    public static final VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOMFactory FACTORY = new VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOMFactory();
}

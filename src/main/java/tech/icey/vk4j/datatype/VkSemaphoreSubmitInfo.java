...
public record VkSemaphoreSubmitInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$stageMask = PathElement.groupElement(4);
    public static final PathElement PATH$deviceIndex = PathElement.groupElement(5);
    ...
    public static final class VkSemaphoreSubmitInfoFactory implements IDataTypeFactory<VkSemaphoreSubmitInfo> {
        @Override

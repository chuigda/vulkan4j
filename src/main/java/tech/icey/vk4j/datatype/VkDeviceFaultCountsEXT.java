...
public record VkDeviceFaultCountsEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$addressInfoCount = PathElement.groupElement(2);
    public static final PathElement PATH$vendorInfoCount = PathElement.groupElement(3);
    public static final PathElement PATH$vendorBinarySize = PathElement.groupElement(4);
    ...
    public static final class VkDeviceFaultCountsEXTFactory implements IDataTypeFactory<VkDeviceFaultCountsEXT> {
        @Override

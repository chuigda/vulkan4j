...
public record VkImageDrmFormatModifierExplicitCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$drmFormatModifier = PathElement.groupElement(2);
    public static final PathElement PATH$drmFormatModifierPlaneCount = PathElement.groupElement(3);
    public static final PathElement PATH$pPlaneLayouts = PathElement.groupElement(4);
    ...
    public void pPlaneLayouts(VkSubresourceLayout value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pPlaneLayoutsRaw(s);
    }


    public static final class VkImageDrmFormatModifierExplicitCreateInfoEXTFactory implements IDataTypeFactory<VkImageDrmFormatModifierExplicitCreateInfoEXT> {
        @Override
    ...
    public static final VkImageDrmFormatModifierExplicitCreateInfoEXTFactory FACTORY = new VkImageDrmFormatModifierExplicitCreateInfoEXTFactory();
}

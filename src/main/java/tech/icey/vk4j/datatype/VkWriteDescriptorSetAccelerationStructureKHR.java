...
public record VkWriteDescriptorSetAccelerationStructureKHR(MemorySegment segment) {
    ...
    public void pAccelerationStructures(VkAccelerationStructureKHR value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pAccelerationStructuresRaw(s);
    }


    public static final class VkWriteDescriptorSetAccelerationStructureKHRFactory implements IDataTypeFactory<VkWriteDescriptorSetAccelerationStructureKHR> {
        @Override

...
public record VkPhysicalDeviceSubpassShadingPropertiesHUAWEI(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxSubpassShadingWorkgroupSizeAspectRatio = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceSubpassShadingPropertiesHUAWEIFactory implements IDataTypeFactory<VkPhysicalDeviceSubpassShadingPropertiesHUAWEI> {
        @Override

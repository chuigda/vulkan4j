...
public record VkDisplayPowerInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$powerState = PathElement.groupElement(2);
    ...
    public static final class VkDisplayPowerInfoEXTFactory implements IDataTypeFactory<VkDisplayPowerInfoEXT> {
        @Override

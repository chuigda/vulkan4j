...
public record VkRefreshObjectListKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$objectCount = PathElement.groupElement(2);
    public static final PathElement PATH$pObjects = PathElement.groupElement(3);
    ...
    public static final class VkRefreshObjectListKHRFactory implements IDataTypeFactory<VkRefreshObjectListKHR> {
        @Override

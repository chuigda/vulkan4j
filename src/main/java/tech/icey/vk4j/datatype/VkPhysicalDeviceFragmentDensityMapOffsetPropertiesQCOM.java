...
public record VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$fragmentDensityOffsetGranularity = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOMFactory implements IDataTypeFactory<VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM> {
        @Override

...
public record VkPhysicalDevicePipelineCreationCacheControlFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$pipelineCreationCacheControl = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDevicePipelineCreationCacheControlFeaturesFactory implements IDataTypeFactory<VkPhysicalDevicePipelineCreationCacheControlFeatures> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDevicePipelineCreationCacheControlFeatures.LAYOUT;
        }

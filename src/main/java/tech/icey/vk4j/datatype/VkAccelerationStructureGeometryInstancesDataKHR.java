...
public record VkAccelerationStructureGeometryInstancesDataKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$arrayOfPointers = PathElement.groupElement(2);
    ...
    public static final class VkAccelerationStructureGeometryInstancesDataKHRFactory implements IDataTypeFactory<VkAccelerationStructureGeometryInstancesDataKHR> {
        @Override
        public Class<VkAccelerationStructureGeometryInstancesDataKHR> clazz() {
            return VkAccelerationStructureGeometryInstancesDataKHR.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkAccelerationStructureGeometryInstancesDataKHR.LAYOUT;
        }

        @Override
        public VkAccelerationStructureGeometryInstancesDataKHR create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkAccelerationStructureGeometryInstancesDataKHR createUninit(MemorySegment segment) {
            return new VkAccelerationStructureGeometryInstancesDataKHR(segment);
        }
    }

    public static final VkAccelerationStructureGeometryInstancesDataKHRFactory FACTORY = new VkAccelerationStructureGeometryInstancesDataKHRFactory();
}

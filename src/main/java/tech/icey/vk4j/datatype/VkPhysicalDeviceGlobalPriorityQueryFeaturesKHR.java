...
public record VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$globalPriorityQuery = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceGlobalPriorityQueryFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR> {
        @Override

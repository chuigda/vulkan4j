...
public record VkPipelineExecutableInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$executableIndex = PathElement.groupElement(3);
    ...
    public static final class VkPipelineExecutableInfoKHRFactory implements IDataTypeFactory<VkPipelineExecutableInfoKHR> {
        @Override

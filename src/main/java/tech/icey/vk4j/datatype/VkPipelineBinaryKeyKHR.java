...
public record VkPipelineBinaryKeyKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$keySize = PathElement.groupElement(2);
    public static final PathElement PATH$key = PathElement.groupElement(3);
    ...
    public static final class VkPipelineBinaryKeyKHRFactory implements IDataTypeFactory<VkPipelineBinaryKeyKHR> {
        @Override

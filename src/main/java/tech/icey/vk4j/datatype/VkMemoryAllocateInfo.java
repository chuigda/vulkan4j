...
public record VkMemoryAllocateInfo(MemorySegment segment) {
    ...
    public static final class VkMemoryAllocateInfoFactory implements IDataTypeFactory<VkMemoryAllocateInfo> {
        @Override
    ...
    public static final VkMemoryAllocateInfoFactory FACTORY = new VkMemoryAllocateInfoFactory();
}

...
public record VkPhysicalDevicePresentBarrierFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$presentBarrier = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDevicePresentBarrierFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDevicePresentBarrierFeaturesNV> {
        @Override

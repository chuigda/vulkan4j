...
public record VkFenceGetFdInfoKHR(MemorySegment segment) {
    ...
    public static final class VkFenceGetFdInfoKHRFactory implements IDataTypeFactory<VkFenceGetFdInfoKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkFenceGetFdInfoKHR.LAYOUT;
        }

...
public record VkPhysicalDeviceDeviceGeneratedCommandsFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$deviceGeneratedCommands = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceDeviceGeneratedCommandsFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceDeviceGeneratedCommandsFeaturesNV> {
        @Override

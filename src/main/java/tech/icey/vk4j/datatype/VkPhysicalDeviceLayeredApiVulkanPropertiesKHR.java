...
public record VkPhysicalDeviceLayeredApiVulkanPropertiesKHR(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceLayeredApiVulkanPropertiesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceLayeredApiVulkanPropertiesKHR> {
        @Override

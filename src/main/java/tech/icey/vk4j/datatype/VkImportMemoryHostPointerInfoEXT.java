...
public record VkImportMemoryHostPointerInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pHostPointer = PathElement.groupElement(3);
    ...
    public static final class VkImportMemoryHostPointerInfoEXTFactory implements IDataTypeFactory<VkImportMemoryHostPointerInfoEXT> {
        @Override
    ...
    public static final VkImportMemoryHostPointerInfoEXTFactory FACTORY = new VkImportMemoryHostPointerInfoEXTFactory();
}

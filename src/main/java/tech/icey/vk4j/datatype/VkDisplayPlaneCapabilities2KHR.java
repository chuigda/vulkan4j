...
public record VkDisplayPlaneCapabilities2KHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$capabilities = PathElement.groupElement(2);
    ...
    public static final class VkDisplayPlaneCapabilities2KHRFactory implements IDataTypeFactory<VkDisplayPlaneCapabilities2KHR> {
        @Override

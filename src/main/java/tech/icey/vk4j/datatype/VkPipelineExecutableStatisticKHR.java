...
public record VkPipelineExecutableStatisticKHR(MemorySegment segment) {
    ...
    public static final class VkPipelineExecutableStatisticKHRFactory implements IDataTypeFactory<VkPipelineExecutableStatisticKHR> {
        @Override
    ...
    public static final VkPipelineExecutableStatisticKHRFactory FACTORY = new VkPipelineExecutableStatisticKHRFactory();
}

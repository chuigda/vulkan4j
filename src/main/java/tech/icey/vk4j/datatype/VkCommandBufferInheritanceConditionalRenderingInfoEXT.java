...
public record VkCommandBufferInheritanceConditionalRenderingInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$conditionalRenderingEnable = PathElement.groupElement(2);
    ...
    public static final class VkCommandBufferInheritanceConditionalRenderingInfoEXTFactory implements IDataTypeFactory<VkCommandBufferInheritanceConditionalRenderingInfoEXT> {
        @Override

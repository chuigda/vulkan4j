...
public record VkOpaqueCaptureDescriptorDataCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$opaqueCaptureDescriptorData = PathElement.groupElement(2);
    ...
    public static final class VkOpaqueCaptureDescriptorDataCreateInfoEXTFactory implements IDataTypeFactory<VkOpaqueCaptureDescriptorDataCreateInfoEXT> {
        @Override

...
public record VkSemaphoreCreateInfo(MemorySegment segment) {
    ...
    public static final class VkSemaphoreCreateInfoFactory implements IDataTypeFactory<VkSemaphoreCreateInfo> {
        @Override
        public Class<VkSemaphoreCreateInfo> clazz() {
            return VkSemaphoreCreateInfo.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkSemaphoreCreateInfo.LAYOUT;
        }
    ...
    public static final VkSemaphoreCreateInfoFactory FACTORY = new VkSemaphoreCreateInfoFactory();
}

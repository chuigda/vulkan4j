...
public record VkPhysicalDeviceExtendedDynamicState3FeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$extendedDynamicState3TessellationDomainOrigin = PathElement.groupElement(2);
    public static final PathElement PATH$extendedDynamicState3DepthClampEnable = PathElement.groupElement(3);
    public static final PathElement PATH$extendedDynamicState3PolygonMode = PathElement.groupElement(4);
    public static final PathElement PATH$extendedDynamicState3RasterizationSamples = PathElement.groupElement(5);
    public static final PathElement PATH$extendedDynamicState3SampleMask = PathElement.groupElement(6);
    public static final PathElement PATH$extendedDynamicState3AlphaToCoverageEnable = PathElement.groupElement(7);
    public static final PathElement PATH$extendedDynamicState3AlphaToOneEnable = PathElement.groupElement(8);
    public static final PathElement PATH$extendedDynamicState3LogicOpEnable = PathElement.groupElement(9);
    public static final PathElement PATH$extendedDynamicState3ColorBlendEnable = PathElement.groupElement(10);
    public static final PathElement PATH$extendedDynamicState3ColorBlendEquation = PathElement.groupElement(11);
    public static final PathElement PATH$extendedDynamicState3ColorWriteMask = PathElement.groupElement(12);
    public static final PathElement PATH$extendedDynamicState3RasterizationStream = PathElement.groupElement(13);
    public static final PathElement PATH$extendedDynamicState3ConservativeRasterizationMode = PathElement.groupElement(14);
    public static final PathElement PATH$extendedDynamicState3ExtraPrimitiveOverestimationSize = PathElement.groupElement(15);
    public static final PathElement PATH$extendedDynamicState3DepthClipEnable = PathElement.groupElement(16);
    public static final PathElement PATH$extendedDynamicState3SampleLocationsEnable = PathElement.groupElement(17);
    public static final PathElement PATH$extendedDynamicState3ColorBlendAdvanced = PathElement.groupElement(18);
    public static final PathElement PATH$extendedDynamicState3ProvokingVertexMode = PathElement.groupElement(19);
    public static final PathElement PATH$extendedDynamicState3LineRasterizationMode = PathElement.groupElement(20);
    public static final PathElement PATH$extendedDynamicState3LineStippleEnable = PathElement.groupElement(21);
    public static final PathElement PATH$extendedDynamicState3DepthClipNegativeOneToOne = PathElement.groupElement(22);
    public static final PathElement PATH$extendedDynamicState3ViewportWScalingEnable = PathElement.groupElement(23);
    public static final PathElement PATH$extendedDynamicState3ViewportSwizzle = PathElement.groupElement(24);
    public static final PathElement PATH$extendedDynamicState3CoverageToColorEnable = PathElement.groupElement(25);
    public static final PathElement PATH$extendedDynamicState3CoverageToColorLocation = PathElement.groupElement(26);
    public static final PathElement PATH$extendedDynamicState3CoverageModulationMode = PathElement.groupElement(27);
    public static final PathElement PATH$extendedDynamicState3CoverageModulationTableEnable = PathElement.groupElement(28);
    public static final PathElement PATH$extendedDynamicState3CoverageModulationTable = PathElement.groupElement(29);
    public static final PathElement PATH$extendedDynamicState3CoverageReductionMode = PathElement.groupElement(30);
    public static final PathElement PATH$extendedDynamicState3RepresentativeFragmentTestEnable = PathElement.groupElement(31);
    public static final PathElement PATH$extendedDynamicState3ShadingRateImageEnable = PathElement.groupElement(32);
    ...
    public static final class VkPhysicalDeviceExtendedDynamicState3FeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceExtendedDynamicState3FeaturesEXT> {
        @Override
    ...
    public static final VkPhysicalDeviceExtendedDynamicState3FeaturesEXTFactory FACTORY = new VkPhysicalDeviceExtendedDynamicState3FeaturesEXTFactory();
}

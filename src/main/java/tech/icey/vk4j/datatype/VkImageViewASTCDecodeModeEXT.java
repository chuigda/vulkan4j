...
public record VkImageViewASTCDecodeModeEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$decodeMode = PathElement.groupElement(2);
    ...
    public static final class VkImageViewASTCDecodeModeEXTFactory implements IDataTypeFactory<VkImageViewASTCDecodeModeEXT> {
        @Override

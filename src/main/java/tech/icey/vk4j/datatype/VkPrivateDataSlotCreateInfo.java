...
public record VkPrivateDataSlotCreateInfo(MemorySegment segment) {
    ...
    public static final class VkPrivateDataSlotCreateInfoFactory implements IDataTypeFactory<VkPrivateDataSlotCreateInfo> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPrivateDataSlotCreateInfo.LAYOUT;
        }

...
public record VkPhysicalDeviceFragmentShadingRateFeaturesKHR(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceFragmentShadingRateFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceFragmentShadingRateFeaturesKHR> {
        @Override
    ...
    public static final VkPhysicalDeviceFragmentShadingRateFeaturesKHRFactory FACTORY = new VkPhysicalDeviceFragmentShadingRateFeaturesKHRFactory();
}

...
public record VkExportSemaphoreWin32HandleInfoKHR(MemorySegment segment) {
    ...
    public static final class VkExportSemaphoreWin32HandleInfoKHRFactory implements IDataTypeFactory<VkExportSemaphoreWin32HandleInfoKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkExportSemaphoreWin32HandleInfoKHR.LAYOUT;
        }

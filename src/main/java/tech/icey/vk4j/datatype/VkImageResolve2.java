...
public record VkImageResolve2(MemorySegment segment) {
    ...
    public static final class VkImageResolve2Factory implements IDataTypeFactory<VkImageResolve2> {
        @Override
        public Class<VkImageResolve2> clazz() {
            return VkImageResolve2.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkImageResolve2.LAYOUT;
        }

        @Override
        public VkImageResolve2 create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkImageResolve2 createUninit(MemorySegment segment) {
            return new VkImageResolve2(segment);
        }
    }

    public static final VkImageResolve2Factory FACTORY = new VkImageResolve2Factory();
}

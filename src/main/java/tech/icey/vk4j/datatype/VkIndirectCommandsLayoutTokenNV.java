...
public record VkIndirectCommandsLayoutTokenNV(MemorySegment segment) {
    ...
    public static final class VkIndirectCommandsLayoutTokenNVFactory implements IDataTypeFactory<VkIndirectCommandsLayoutTokenNV> {
        @Override
    ...
    public static final VkIndirectCommandsLayoutTokenNVFactory FACTORY = new VkIndirectCommandsLayoutTokenNVFactory();
}

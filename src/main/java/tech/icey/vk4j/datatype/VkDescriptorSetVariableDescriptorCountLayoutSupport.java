...
public record VkDescriptorSetVariableDescriptorCountLayoutSupport(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxVariableDescriptorCount = PathElement.groupElement(2);
    ...
    public static final class VkDescriptorSetVariableDescriptorCountLayoutSupportFactory implements IDataTypeFactory<VkDescriptorSetVariableDescriptorCountLayoutSupport> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkDescriptorSetVariableDescriptorCountLayoutSupport.LAYOUT;
        }

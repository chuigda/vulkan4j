...
public record VkDescriptorSetLayoutSupport(MemorySegment segment) {
    ...
    public static final PathElement PATH$supported = PathElement.groupElement(2);
    ...
    public static final class VkDescriptorSetLayoutSupportFactory implements IDataTypeFactory<VkDescriptorSetLayoutSupport> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkDescriptorSetLayoutSupport.LAYOUT;
        }

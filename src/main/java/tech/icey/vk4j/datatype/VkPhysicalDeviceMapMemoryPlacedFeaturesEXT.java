...
public record VkPhysicalDeviceMapMemoryPlacedFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$memoryMapPlaced = PathElement.groupElement(2);
    public static final PathElement PATH$memoryMapRangePlaced = PathElement.groupElement(3);
    public static final PathElement PATH$memoryUnmapReserve = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceMapMemoryPlacedFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceMapMemoryPlacedFeaturesEXT> {
        @Override
    ...
    public static final VkPhysicalDeviceMapMemoryPlacedFeaturesEXTFactory FACTORY = new VkPhysicalDeviceMapMemoryPlacedFeaturesEXTFactory();
}

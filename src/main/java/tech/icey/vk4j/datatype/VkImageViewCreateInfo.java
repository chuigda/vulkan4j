...
public record VkImageViewCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$image = PathElement.groupElement(3);
    public static final PathElement PATH$viewType = PathElement.groupElement(4);
    public static final PathElement PATH$format = PathElement.groupElement(5);
    public static final PathElement PATH$components = PathElement.groupElement(6);
    public static final PathElement PATH$subresourceRange = PathElement.groupElement(7);
    ...
    public static final class VkImageViewCreateInfoFactory implements IDataTypeFactory<VkImageViewCreateInfo> {
        @Override
    ...
    public static final VkImageViewCreateInfoFactory FACTORY = new VkImageViewCreateInfoFactory();
}

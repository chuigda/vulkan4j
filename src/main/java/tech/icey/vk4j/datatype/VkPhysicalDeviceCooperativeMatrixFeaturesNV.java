...
public record VkPhysicalDeviceCooperativeMatrixFeaturesNV(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceCooperativeMatrixFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceCooperativeMatrixFeaturesNV> {
        @Override
    ...
    public static final VkPhysicalDeviceCooperativeMatrixFeaturesNVFactory FACTORY = new VkPhysicalDeviceCooperativeMatrixFeaturesNVFactory();
}

...
public record VkAccelerationStructureCaptureDescriptorDataInfoEXT(MemorySegment segment) {
    ...
    public static final class VkAccelerationStructureCaptureDescriptorDataInfoEXTFactory implements IDataTypeFactory<VkAccelerationStructureCaptureDescriptorDataInfoEXT> {
        @Override

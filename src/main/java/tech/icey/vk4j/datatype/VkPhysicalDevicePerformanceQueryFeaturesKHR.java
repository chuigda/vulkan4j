...
public record VkPhysicalDevicePerformanceQueryFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$performanceCounterQueryPools = PathElement.groupElement(2);
    public static final PathElement PATH$performanceCounterMultipleQueryPools = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDevicePerformanceQueryFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDevicePerformanceQueryFeaturesKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDevicePerformanceQueryFeaturesKHR.LAYOUT;
        }

        @Override
        public VkPhysicalDevicePerformanceQueryFeaturesKHR create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkPhysicalDevicePerformanceQueryFeaturesKHR createUninit(MemorySegment segment) {
            return new VkPhysicalDevicePerformanceQueryFeaturesKHR(segment);
        }
    }

...
public record VkPhysicalDeviceSubgroupProperties(MemorySegment segment) {
    ...
    public static final PathElement PATH$subgroupSize = PathElement.groupElement(2);
    public static final PathElement PATH$supportedStages = PathElement.groupElement(3);
    public static final PathElement PATH$supportedOperations = PathElement.groupElement(4);
    public static final PathElement PATH$quadOperationsInAllStages = PathElement.groupElement(5);
    ...
    public static final class VkPhysicalDeviceSubgroupPropertiesFactory implements IDataTypeFactory<VkPhysicalDeviceSubgroupProperties> {
        @Override
    ...
    public static final VkPhysicalDeviceSubgroupPropertiesFactory FACTORY = new VkPhysicalDeviceSubgroupPropertiesFactory();
}

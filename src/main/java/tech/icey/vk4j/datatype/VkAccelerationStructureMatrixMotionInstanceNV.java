...
public record VkAccelerationStructureMatrixMotionInstanceNV(MemorySegment segment) {
    ...
    public static final class VkAccelerationStructureMatrixMotionInstanceNVFactory implements IDataTypeFactory<VkAccelerationStructureMatrixMotionInstanceNV> {
        @Override
        public Class<VkAccelerationStructureMatrixMotionInstanceNV> clazz() {
            return VkAccelerationStructureMatrixMotionInstanceNV.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkAccelerationStructureMatrixMotionInstanceNV.LAYOUT;
        }
    ...
    public static final VkAccelerationStructureMatrixMotionInstanceNVFactory FACTORY = new VkAccelerationStructureMatrixMotionInstanceNVFactory();
}

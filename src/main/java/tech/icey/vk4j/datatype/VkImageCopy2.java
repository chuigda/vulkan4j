...
public record VkImageCopy2(MemorySegment segment) {
    ...
    public static final class VkImageCopy2Factory implements IDataTypeFactory<VkImageCopy2> {
        @Override
        public Class<VkImageCopy2> clazz() {
            return VkImageCopy2.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkImageCopy2.LAYOUT;
        }

        @Override
        public VkImageCopy2 create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkImageCopy2 createUninit(MemorySegment segment) {
            return new VkImageCopy2(segment);
        }
    }

    public static final VkImageCopy2Factory FACTORY = new VkImageCopy2Factory();
}

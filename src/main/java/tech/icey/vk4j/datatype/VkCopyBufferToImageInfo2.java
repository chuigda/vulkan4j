...
public record VkCopyBufferToImageInfo2(MemorySegment segment) {
    ...
    public void pRegions(VkBufferImageCopy2 value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pRegionsRaw(s);
    }


    public static final class VkCopyBufferToImageInfo2Factory implements IDataTypeFactory<VkCopyBufferToImageInfo2> {
        @Override

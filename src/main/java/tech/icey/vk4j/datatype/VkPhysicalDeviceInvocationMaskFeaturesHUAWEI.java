...
public record VkPhysicalDeviceInvocationMaskFeaturesHUAWEI(MemorySegment segment) {
    ...
    public static final PathElement PATH$invocationMask = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceInvocationMaskFeaturesHUAWEIFactory implements IDataTypeFactory<VkPhysicalDeviceInvocationMaskFeaturesHUAWEI> {
        @Override

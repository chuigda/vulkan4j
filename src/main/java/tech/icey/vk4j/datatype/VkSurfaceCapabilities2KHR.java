...
public record VkSurfaceCapabilities2KHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$surfaceCapabilities = PathElement.groupElement(2);
    ...
    public static final class VkSurfaceCapabilities2KHRFactory implements IDataTypeFactory<VkSurfaceCapabilities2KHR> {
        @Override

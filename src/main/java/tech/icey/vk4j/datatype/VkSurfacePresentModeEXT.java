...
public record VkSurfacePresentModeEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$presentMode = PathElement.groupElement(2);
    ...
    public static final class VkSurfacePresentModeEXTFactory implements IDataTypeFactory<VkSurfacePresentModeEXT> {
        @Override

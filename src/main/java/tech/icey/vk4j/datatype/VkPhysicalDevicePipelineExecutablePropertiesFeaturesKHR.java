...
public record VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$pipelineExecutableInfo = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.LAYOUT;
        }

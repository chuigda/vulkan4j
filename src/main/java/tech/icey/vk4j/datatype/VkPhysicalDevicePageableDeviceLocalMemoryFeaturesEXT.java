...
public record VkPhysicalDevicePageableDeviceLocalMemoryFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pageableDeviceLocalMemory = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDevicePageableDeviceLocalMemoryFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDevicePageableDeviceLocalMemoryFeaturesEXT> {
        @Override

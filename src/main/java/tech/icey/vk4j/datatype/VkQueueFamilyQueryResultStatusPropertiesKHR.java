...
public record VkQueueFamilyQueryResultStatusPropertiesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$queryResultStatusSupport = PathElement.groupElement(2);
    ...
    public static final class VkQueueFamilyQueryResultStatusPropertiesKHRFactory implements IDataTypeFactory<VkQueueFamilyQueryResultStatusPropertiesKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkQueueFamilyQueryResultStatusPropertiesKHR.LAYOUT;
        }

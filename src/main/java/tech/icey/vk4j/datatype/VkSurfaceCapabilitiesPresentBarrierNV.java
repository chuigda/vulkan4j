...
public record VkSurfaceCapabilitiesPresentBarrierNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$presentBarrierSupported = PathElement.groupElement(2);
    ...
    public static final class VkSurfaceCapabilitiesPresentBarrierNVFactory implements IDataTypeFactory<VkSurfaceCapabilitiesPresentBarrierNV> {
        @Override

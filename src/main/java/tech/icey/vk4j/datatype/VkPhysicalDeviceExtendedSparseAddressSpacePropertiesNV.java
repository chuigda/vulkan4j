...
public record VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$extendedSparseAddressSpaceSize = PathElement.groupElement(2);
    public static final PathElement PATH$extendedSparseImageUsageFlags = PathElement.groupElement(3);
    public static final PathElement PATH$extendedSparseBufferUsageFlags = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNVFactory implements IDataTypeFactory<VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV> {
        @Override

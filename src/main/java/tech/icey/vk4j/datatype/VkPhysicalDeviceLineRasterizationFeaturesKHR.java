...
public record VkPhysicalDeviceLineRasterizationFeaturesKHR(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceLineRasterizationFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceLineRasterizationFeaturesKHR> {
        @Override
    ...
    public static final VkPhysicalDeviceLineRasterizationFeaturesKHRFactory FACTORY = new VkPhysicalDeviceLineRasterizationFeaturesKHRFactory();
}

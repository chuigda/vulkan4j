...
public record VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX(MemorySegment segment) {
    ...
    public static final PathElement PATH$perViewPositionAllComponents = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVXFactory implements IDataTypeFactory<VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX> {
        @Override

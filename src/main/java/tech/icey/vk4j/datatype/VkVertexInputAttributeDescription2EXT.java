...
public record VkVertexInputAttributeDescription2EXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$location = PathElement.groupElement(2);
    public static final PathElement PATH$binding = PathElement.groupElement(3);
    ...
    public static final class VkVertexInputAttributeDescription2EXTFactory implements IDataTypeFactory<VkVertexInputAttributeDescription2EXT> {
        @Override

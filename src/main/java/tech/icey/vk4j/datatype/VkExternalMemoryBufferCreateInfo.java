...
public record VkExternalMemoryBufferCreateInfo(MemorySegment segment) {
    ...
    public static final class VkExternalMemoryBufferCreateInfoFactory implements IDataTypeFactory<VkExternalMemoryBufferCreateInfo> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkExternalMemoryBufferCreateInfo.LAYOUT;
        }

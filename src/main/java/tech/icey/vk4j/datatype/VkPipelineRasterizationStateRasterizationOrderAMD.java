...
public record VkPipelineRasterizationStateRasterizationOrderAMD(MemorySegment segment) {
    ...
    public static final PathElement PATH$rasterizationOrder = PathElement.groupElement(2);
    ...
    public static final class VkPipelineRasterizationStateRasterizationOrderAMDFactory implements IDataTypeFactory<VkPipelineRasterizationStateRasterizationOrderAMD> {
        @Override

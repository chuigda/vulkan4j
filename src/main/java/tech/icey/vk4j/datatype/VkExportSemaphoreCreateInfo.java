...
public record VkExportSemaphoreCreateInfo(MemorySegment segment) {
    ...
    public static final class VkExportSemaphoreCreateInfoFactory implements IDataTypeFactory<VkExportSemaphoreCreateInfo> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkExportSemaphoreCreateInfo.LAYOUT;
        }

        @Override
        public VkExportSemaphoreCreateInfo create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkExportSemaphoreCreateInfo createUninit(MemorySegment segment) {
            return new VkExportSemaphoreCreateInfo(segment);
        }
    }

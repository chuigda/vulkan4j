...
public record VkPhysicalDeviceSubpassShadingFeaturesHUAWEI(MemorySegment segment) {
    ...
    public static final PathElement PATH$subpassShading = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceSubpassShadingFeaturesHUAWEIFactory implements IDataTypeFactory<VkPhysicalDeviceSubpassShadingFeaturesHUAWEI> {
        @Override
    ...
    public static final VkPhysicalDeviceSubpassShadingFeaturesHUAWEIFactory FACTORY = new VkPhysicalDeviceSubpassShadingFeaturesHUAWEIFactory();
}

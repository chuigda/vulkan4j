...
public record VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderImageInt64Atomics = PathElement.groupElement(2);
    public static final PathElement PATH$sparseImageInt64Atomics = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT> {
        @Override

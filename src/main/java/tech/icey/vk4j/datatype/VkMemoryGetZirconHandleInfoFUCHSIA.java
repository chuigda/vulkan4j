...
public record VkMemoryGetZirconHandleInfoFUCHSIA(MemorySegment segment) {
    ...
    public static final class VkMemoryGetZirconHandleInfoFUCHSIAFactory implements IDataTypeFactory<VkMemoryGetZirconHandleInfoFUCHSIA> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkMemoryGetZirconHandleInfoFUCHSIA.LAYOUT;
        }

        @Override
        public VkMemoryGetZirconHandleInfoFUCHSIA create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkMemoryGetZirconHandleInfoFUCHSIA createUninit(MemorySegment segment) {
            return new VkMemoryGetZirconHandleInfoFUCHSIA(segment);
        }
    }

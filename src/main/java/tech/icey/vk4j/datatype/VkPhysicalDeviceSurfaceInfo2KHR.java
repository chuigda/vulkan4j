...
public record VkPhysicalDeviceSurfaceInfo2KHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$surface = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceSurfaceInfo2KHRFactory implements IDataTypeFactory<VkPhysicalDeviceSurfaceInfo2KHR> {
        @Override

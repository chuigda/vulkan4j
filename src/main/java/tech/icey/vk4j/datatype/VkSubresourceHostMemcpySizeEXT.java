...
public record VkSubresourceHostMemcpySizeEXT(MemorySegment segment) {
    ...
    public static final class VkSubresourceHostMemcpySizeEXTFactory implements IDataTypeFactory<VkSubresourceHostMemcpySizeEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkSubresourceHostMemcpySizeEXT.LAYOUT;
        }

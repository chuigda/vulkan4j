...
public record VkSubpassDescription2(MemorySegment segment) {
    ...
    public static final PathElement PATH$viewMask = PathElement.groupElement(4);
    public static final PathElement PATH$inputAttachmentCount = PathElement.groupElement(5);
    public static final PathElement PATH$pInputAttachments = PathElement.groupElement(6);
    public static final PathElement PATH$colorAttachmentCount = PathElement.groupElement(7);
    public static final PathElement PATH$pColorAttachments = PathElement.groupElement(8);
    public static final PathElement PATH$pResolveAttachments = PathElement.groupElement(9);
    public static final PathElement PATH$pDepthStencilAttachment = PathElement.groupElement(10);
    public static final PathElement PATH$preserveAttachmentCount = PathElement.groupElement(11);
    public static final PathElement PATH$pPreserveAttachments = PathElement.groupElement(12);
    ...
    public void pInputAttachments(VkAttachmentReference2 value) {
    ...
    public void pColorAttachments(VkAttachmentReference2 value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
    ...
    public void pResolveAttachments(VkAttachmentReference2 value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
    ...
    public void pDepthStencilAttachment(VkAttachmentReference2 value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
    ...
    public static final class VkSubpassDescription2Factory implements IDataTypeFactory<VkSubpassDescription2> {
        @Override
    ...
    public static final VkSubpassDescription2Factory FACTORY = new VkSubpassDescription2Factory();
}

...
public record VkPhysicalDeviceAddressBindingReportFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$reportAddressBinding = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceAddressBindingReportFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceAddressBindingReportFeaturesEXT> {
        @Override

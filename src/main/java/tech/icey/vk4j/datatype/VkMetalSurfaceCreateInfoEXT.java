...
public record VkMetalSurfaceCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pLayer = PathElement.groupElement(3);
    ...
    public static final class VkMetalSurfaceCreateInfoEXTFactory implements IDataTypeFactory<VkMetalSurfaceCreateInfoEXT> {
        @Override

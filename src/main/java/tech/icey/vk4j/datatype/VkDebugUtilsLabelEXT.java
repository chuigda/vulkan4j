...
public record VkDebugUtilsLabelEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pLabelName = PathElement.groupElement(2);
    ...
    public static final class VkDebugUtilsLabelEXTFactory implements IDataTypeFactory<VkDebugUtilsLabelEXT> {
        @Override

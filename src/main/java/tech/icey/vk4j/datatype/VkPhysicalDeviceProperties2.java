...
public record VkPhysicalDeviceProperties2(MemorySegment segment) {
    ...
    public static final PathElement PATH$properties = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceProperties2Factory implements IDataTypeFactory<VkPhysicalDeviceProperties2> {
        @Override
    ...
    public static final VkPhysicalDeviceProperties2Factory FACTORY = new VkPhysicalDeviceProperties2Factory();
}

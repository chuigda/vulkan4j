...
public record VkPhysicalDeviceUniformBufferStandardLayoutFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$uniformBufferStandardLayout = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceUniformBufferStandardLayoutFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceUniformBufferStandardLayoutFeatures> {
        @Override

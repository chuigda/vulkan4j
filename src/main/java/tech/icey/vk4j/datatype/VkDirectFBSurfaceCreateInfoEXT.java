...
public record VkDirectFBSurfaceCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$dfb = PathElement.groupElement(3);
    ...
    public static final class VkDirectFBSurfaceCreateInfoEXTFactory implements IDataTypeFactory<VkDirectFBSurfaceCreateInfoEXT> {
        @Override

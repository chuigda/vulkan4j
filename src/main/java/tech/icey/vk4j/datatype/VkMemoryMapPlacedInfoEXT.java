...
public record VkMemoryMapPlacedInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pPlacedAddress = PathElement.groupElement(2);
    ...
    public static final class VkMemoryMapPlacedInfoEXTFactory implements IDataTypeFactory<VkMemoryMapPlacedInfoEXT> {
        @Override

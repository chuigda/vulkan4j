...
public record VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$dynamicRenderingUnusedAttachments = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT> {
        @Override

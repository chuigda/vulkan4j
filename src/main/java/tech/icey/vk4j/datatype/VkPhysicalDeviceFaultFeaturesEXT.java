...
public record VkPhysicalDeviceFaultFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$deviceFault = PathElement.groupElement(2);
    public static final PathElement PATH$deviceFaultVendorBinary = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceFaultFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceFaultFeaturesEXT> {
        @Override

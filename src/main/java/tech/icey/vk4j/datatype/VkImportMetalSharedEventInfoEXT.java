...
public record VkImportMetalSharedEventInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$mtlSharedEvent = PathElement.groupElement(2);
    ...
    public static final class VkImportMetalSharedEventInfoEXTFactory implements IDataTypeFactory<VkImportMetalSharedEventInfoEXT> {
        @Override

...
public record VkBindDescriptorBufferEmbeddedSamplersInfoEXT(MemorySegment segment) {
    ...
    public static final class VkBindDescriptorBufferEmbeddedSamplersInfoEXTFactory implements IDataTypeFactory<VkBindDescriptorBufferEmbeddedSamplersInfoEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkBindDescriptorBufferEmbeddedSamplersInfoEXT.LAYOUT;
        }

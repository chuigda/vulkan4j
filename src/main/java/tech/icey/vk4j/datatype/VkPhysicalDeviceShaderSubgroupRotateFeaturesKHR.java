...
public record VkPhysicalDeviceShaderSubgroupRotateFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderSubgroupRotate = PathElement.groupElement(2);
    public static final PathElement PATH$shaderSubgroupRotateClustered = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceShaderSubgroupRotateFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceShaderSubgroupRotateFeaturesKHR> {
        @Override

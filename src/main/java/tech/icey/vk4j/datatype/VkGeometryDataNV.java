...
public record VkGeometryDataNV(MemorySegment segment) {
    ...
    public static final class VkGeometryDataNVFactory implements IDataTypeFactory<VkGeometryDataNV> {
        @Override
    ...
    public static final VkGeometryDataNVFactory FACTORY = new VkGeometryDataNVFactory();
}

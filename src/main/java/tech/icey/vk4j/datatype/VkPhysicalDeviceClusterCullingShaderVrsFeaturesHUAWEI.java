...
public record VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI(MemorySegment segment) {
    ...
    public static final PathElement PATH$clusterShadingRate = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEIFactory implements IDataTypeFactory<VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI> {
        @Override

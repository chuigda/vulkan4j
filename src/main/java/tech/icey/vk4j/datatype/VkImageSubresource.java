...
public record VkImageSubresource(MemorySegment segment) {
    ...
    public static final PathElement PATH$arrayLayer = PathElement.groupElement(2);
    ...
    public static final class VkImageSubresourceFactory implements IDataTypeFactory<VkImageSubresource> {
        @Override
    ...
    public static final VkImageSubresourceFactory FACTORY = new VkImageSubresourceFactory();
}

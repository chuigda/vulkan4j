...
public record VkMutableDescriptorTypeCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$mutableDescriptorTypeListCount = PathElement.groupElement(2);
    public static final PathElement PATH$pMutableDescriptorTypeLists = PathElement.groupElement(3);

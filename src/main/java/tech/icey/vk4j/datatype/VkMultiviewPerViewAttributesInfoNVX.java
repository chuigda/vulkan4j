...
public record VkMultiviewPerViewAttributesInfoNVX(MemorySegment segment) {
    ...
    public static final PathElement PATH$perViewAttributes = PathElement.groupElement(2);
    public static final PathElement PATH$perViewAttributesPositionXOnly = PathElement.groupElement(3);
    ...
    public static final class VkMultiviewPerViewAttributesInfoNVXFactory implements IDataTypeFactory<VkMultiviewPerViewAttributesInfoNVX> {
        @Override

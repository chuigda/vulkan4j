...
public record VkPipelineCoverageToColorStateCreateInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$coverageToColorEnable = PathElement.groupElement(3);
    public static final PathElement PATH$coverageToColorLocation = PathElement.groupElement(4);
    ...
    public static final class VkPipelineCoverageToColorStateCreateInfoNVFactory implements IDataTypeFactory<VkPipelineCoverageToColorStateCreateInfoNV> {
        @Override

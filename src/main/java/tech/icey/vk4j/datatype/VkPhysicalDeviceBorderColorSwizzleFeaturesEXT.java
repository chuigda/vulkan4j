...
public record VkPhysicalDeviceBorderColorSwizzleFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$borderColorSwizzle = PathElement.groupElement(2);
    public static final PathElement PATH$borderColorSwizzleFromImage = PathElement.groupElement(3);

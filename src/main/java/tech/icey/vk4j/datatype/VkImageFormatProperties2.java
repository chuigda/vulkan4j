...
public record VkImageFormatProperties2(MemorySegment segment) {
    ...
    public static final PathElement PATH$imageFormatProperties = PathElement.groupElement(2);
    ...
    public static final class VkImageFormatProperties2Factory implements IDataTypeFactory<VkImageFormatProperties2> {
        @Override

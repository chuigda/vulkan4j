...
public record VkPhysicalDevice4444FormatsFeaturesEXT(MemorySegment segment) {
    ...
    public static final class VkPhysicalDevice4444FormatsFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDevice4444FormatsFeaturesEXT> {
        @Override
    ...
    public static final VkPhysicalDevice4444FormatsFeaturesEXTFactory FACTORY = new VkPhysicalDevice4444FormatsFeaturesEXTFactory();
}

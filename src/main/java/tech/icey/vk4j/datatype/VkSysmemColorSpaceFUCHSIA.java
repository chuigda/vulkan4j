...
public record VkSysmemColorSpaceFUCHSIA(MemorySegment segment) {
    ...
    public static final PathElement PATH$colorSpace = PathElement.groupElement(2);
    ...
    public static final class VkSysmemColorSpaceFUCHSIAFactory implements IDataTypeFactory<VkSysmemColorSpaceFUCHSIA> {
        @Override

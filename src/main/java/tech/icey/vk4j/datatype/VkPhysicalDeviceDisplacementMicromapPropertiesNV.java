...
public record VkPhysicalDeviceDisplacementMicromapPropertiesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxDisplacementMicromapSubdivisionLevel = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceDisplacementMicromapPropertiesNVFactory implements IDataTypeFactory<VkPhysicalDeviceDisplacementMicromapPropertiesNV> {
        @Override

...
public record VkBindDescriptorSetsInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$descriptorSetCount = PathElement.groupElement(5);
    public static final PathElement PATH$pDescriptorSets = PathElement.groupElement(6);
    public static final PathElement PATH$dynamicOffsetCount = PathElement.groupElement(7);
    public static final PathElement PATH$pDynamicOffsets = PathElement.groupElement(8);
    ...
    public static final class VkBindDescriptorSetsInfoKHRFactory implements IDataTypeFactory<VkBindDescriptorSetsInfoKHR> {
        @Override

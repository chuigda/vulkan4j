...
public record VkMemoryUnmapInfoKHR(MemorySegment segment) {
    ...
    public static final class VkMemoryUnmapInfoKHRFactory implements IDataTypeFactory<VkMemoryUnmapInfoKHR> {
        @Override
    ...
    public static final VkMemoryUnmapInfoKHRFactory FACTORY = new VkMemoryUnmapInfoKHRFactory();
}

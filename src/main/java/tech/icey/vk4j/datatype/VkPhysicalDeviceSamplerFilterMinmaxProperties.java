...
public record VkPhysicalDeviceSamplerFilterMinmaxProperties(MemorySegment segment) {
    ...
    public static final PathElement PATH$filterMinmaxSingleComponentFormats = PathElement.groupElement(2);
    public static final PathElement PATH$filterMinmaxImageComponentMapping = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceSamplerFilterMinmaxPropertiesFactory implements IDataTypeFactory<VkPhysicalDeviceSamplerFilterMinmaxProperties> {
        @Override

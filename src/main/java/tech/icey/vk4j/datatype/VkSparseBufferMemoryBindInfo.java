...
public record VkSparseBufferMemoryBindInfo(MemorySegment segment) {
    ...
    public static final class VkSparseBufferMemoryBindInfoFactory implements IDataTypeFactory<VkSparseBufferMemoryBindInfo> {
        @Override
    ...
    public static final VkSparseBufferMemoryBindInfoFactory FACTORY = new VkSparseBufferMemoryBindInfoFactory();
}

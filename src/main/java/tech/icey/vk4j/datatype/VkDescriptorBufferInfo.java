...
public record VkDescriptorBufferInfo(MemorySegment segment) {
    ...
    public static final class VkDescriptorBufferInfoFactory implements IDataTypeFactory<VkDescriptorBufferInfo> {
        @Override
    ...
    public static final VkDescriptorBufferInfoFactory FACTORY = new VkDescriptorBufferInfoFactory();
}

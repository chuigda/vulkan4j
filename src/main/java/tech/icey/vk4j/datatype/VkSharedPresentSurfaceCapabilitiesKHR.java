...
public record VkSharedPresentSurfaceCapabilitiesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$sharedPresentSupportedUsageFlags = PathElement.groupElement(2);
    ...
    public static final class VkSharedPresentSurfaceCapabilitiesKHRFactory implements IDataTypeFactory<VkSharedPresentSurfaceCapabilitiesKHR> {
        @Override

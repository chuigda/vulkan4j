...
public record VkImageMemoryBarrier2(MemorySegment segment) {
    ...
    public static final PathElement PATH$oldLayout = PathElement.groupElement(6);
    public static final PathElement PATH$newLayout = PathElement.groupElement(7);
    public static final PathElement PATH$srcQueueFamilyIndex = PathElement.groupElement(8);
    public static final PathElement PATH$dstQueueFamilyIndex = PathElement.groupElement(9);
    public static final PathElement PATH$image = PathElement.groupElement(10);
    public static final PathElement PATH$subresourceRange = PathElement.groupElement(11);
    ...
    public static final class VkImageMemoryBarrier2Factory implements IDataTypeFactory<VkImageMemoryBarrier2> {
        @Override

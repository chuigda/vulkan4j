...
public record VkPhysicalDeviceProtectedMemoryProperties(MemorySegment segment) {
    ...
    public static final PathElement PATH$protectedNoFault = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceProtectedMemoryPropertiesFactory implements IDataTypeFactory<VkPhysicalDeviceProtectedMemoryProperties> {
        @Override
    ...
    public static final VkPhysicalDeviceProtectedMemoryPropertiesFactory FACTORY = new VkPhysicalDeviceProtectedMemoryPropertiesFactory();
}

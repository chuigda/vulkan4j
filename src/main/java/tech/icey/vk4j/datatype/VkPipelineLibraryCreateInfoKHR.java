...
public record VkPipelineLibraryCreateInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$libraryCount = PathElement.groupElement(2);
    public static final PathElement PATH$pLibraries = PathElement.groupElement(3);
    ...
    public static final class VkPipelineLibraryCreateInfoKHRFactory implements IDataTypeFactory<VkPipelineLibraryCreateInfoKHR> {
        @Override
    ...
    public static final VkPipelineLibraryCreateInfoKHRFactory FACTORY = new VkPipelineLibraryCreateInfoKHRFactory();
}

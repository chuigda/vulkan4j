...
public record VkFormatProperties3(MemorySegment segment) {
    ...
    public static final class VkFormatProperties3Factory implements IDataTypeFactory<VkFormatProperties3> {
        @Override
    ...
    public static final VkFormatProperties3Factory FACTORY = new VkFormatProperties3Factory();
}

...
public record VkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$deviceGeneratedCompute = PathElement.groupElement(2);
    public static final PathElement PATH$deviceGeneratedComputePipelines = PathElement.groupElement(3);
    public static final PathElement PATH$deviceGeneratedComputeCaptureReplay = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV> {
        @Override

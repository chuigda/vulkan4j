...
public record VkPhysicalDeviceCoherentMemoryFeaturesAMD(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceCoherentMemoryFeaturesAMDFactory implements IDataTypeFactory<VkPhysicalDeviceCoherentMemoryFeaturesAMD> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceCoherentMemoryFeaturesAMD.LAYOUT;
        }

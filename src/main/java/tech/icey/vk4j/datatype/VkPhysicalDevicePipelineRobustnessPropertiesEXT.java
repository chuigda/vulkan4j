...
public record VkPhysicalDevicePipelineRobustnessPropertiesEXT(MemorySegment segment) {
    ...
    public static final class VkPhysicalDevicePipelineRobustnessPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDevicePipelineRobustnessPropertiesEXT> {
        @Override
    ...
    public static final VkPhysicalDevicePipelineRobustnessPropertiesEXTFactory FACTORY = new VkPhysicalDevicePipelineRobustnessPropertiesEXTFactory();
}

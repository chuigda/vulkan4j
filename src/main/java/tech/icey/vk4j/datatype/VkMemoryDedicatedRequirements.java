...
public record VkMemoryDedicatedRequirements(MemorySegment segment) {
    ...
    public static final PathElement PATH$prefersDedicatedAllocation = PathElement.groupElement(2);
    public static final PathElement PATH$requiresDedicatedAllocation = PathElement.groupElement(3);
    ...
    public static final class VkMemoryDedicatedRequirementsFactory implements IDataTypeFactory<VkMemoryDedicatedRequirements> {
        @Override
    ...
    public static final VkMemoryDedicatedRequirementsFactory FACTORY = new VkMemoryDedicatedRequirementsFactory();
}

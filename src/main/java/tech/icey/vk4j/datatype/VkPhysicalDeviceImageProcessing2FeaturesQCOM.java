...
public record VkPhysicalDeviceImageProcessing2FeaturesQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$textureBlockMatch2 = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceImageProcessing2FeaturesQCOMFactory implements IDataTypeFactory<VkPhysicalDeviceImageProcessing2FeaturesQCOM> {
        @Override

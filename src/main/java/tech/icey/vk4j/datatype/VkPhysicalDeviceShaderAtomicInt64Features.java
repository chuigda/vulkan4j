...
public record VkPhysicalDeviceShaderAtomicInt64Features(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderBufferInt64Atomics = PathElement.groupElement(2);
    public static final PathElement PATH$shaderSharedInt64Atomics = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceShaderAtomicInt64FeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceShaderAtomicInt64Features> {
        @Override

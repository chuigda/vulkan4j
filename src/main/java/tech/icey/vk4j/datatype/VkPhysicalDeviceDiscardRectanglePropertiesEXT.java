...
public record VkPhysicalDeviceDiscardRectanglePropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxDiscardRectangles = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceDiscardRectanglePropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceDiscardRectanglePropertiesEXT> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkPhysicalDeviceDiscardRectanglePropertiesEXT.LAYOUT;
        }

...
public record VkPhysicalDevice8BitStorageFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$storageBuffer8BitAccess = PathElement.groupElement(2);
    public static final PathElement PATH$uniformAndStorageBuffer8BitAccess = PathElement.groupElement(3);
    public static final PathElement PATH$storagePushConstant8 = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDevice8BitStorageFeaturesFactory implements IDataTypeFactory<VkPhysicalDevice8BitStorageFeatures> {
        @Override

...
public record VkCooperativeMatrixPropertiesKHR(MemorySegment segment) {
    ...
    public static final class VkCooperativeMatrixPropertiesKHRFactory implements IDataTypeFactory<VkCooperativeMatrixPropertiesKHR> {
        @Override
    ...
    public static final VkCooperativeMatrixPropertiesKHRFactory FACTORY = new VkCooperativeMatrixPropertiesKHRFactory();
}

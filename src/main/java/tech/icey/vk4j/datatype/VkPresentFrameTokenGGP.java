...
public record VkPresentFrameTokenGGP(MemorySegment segment) {
    ...
    public static final PathElement PATH$frameToken = PathElement.groupElement(2);
    ...
    public static final class VkPresentFrameTokenGGPFactory implements IDataTypeFactory<VkPresentFrameTokenGGP> {
        @Override

...
public record VkPhysicalDeviceDepthStencilResolveProperties(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceDepthStencilResolvePropertiesFactory implements IDataTypeFactory<VkPhysicalDeviceDepthStencilResolveProperties> {
        @Override

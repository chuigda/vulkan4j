...
public record VkShaderModuleValidationCacheCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$validationCache = PathElement.groupElement(2);
    ...
    public static final class VkShaderModuleValidationCacheCreateInfoEXTFactory implements IDataTypeFactory<VkShaderModuleValidationCacheCreateInfoEXT> {
        @Override

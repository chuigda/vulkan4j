...
public record VkCommandBufferInheritanceRenderingInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$viewMask = PathElement.groupElement(3);
    public static final PathElement PATH$colorAttachmentCount = PathElement.groupElement(4);
    public static final PathElement PATH$pColorAttachmentFormats = PathElement.groupElement(5);
    public static final PathElement PATH$depthAttachmentFormat = PathElement.groupElement(6);
    public static final PathElement PATH$stencilAttachmentFormat = PathElement.groupElement(7);
    public static final PathElement PATH$rasterizationSamples = PathElement.groupElement(8);
    ...
    public static final class VkCommandBufferInheritanceRenderingInfoFactory implements IDataTypeFactory<VkCommandBufferInheritanceRenderingInfo> {
        @Override

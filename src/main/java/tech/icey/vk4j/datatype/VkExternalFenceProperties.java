...
public record VkExternalFenceProperties(MemorySegment segment) {
    ...
    public static final PathElement PATH$externalFenceFeatures = PathElement.groupElement(4);
    ...
    public static final class VkExternalFencePropertiesFactory implements IDataTypeFactory<VkExternalFenceProperties> {
        @Override

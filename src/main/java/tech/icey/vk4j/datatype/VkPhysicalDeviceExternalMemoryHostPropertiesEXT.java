...
public record VkPhysicalDeviceExternalMemoryHostPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$minImportedHostPointerAlignment = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceExternalMemoryHostPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceExternalMemoryHostPropertiesEXT> {
        @Override

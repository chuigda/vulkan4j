...
public record VkMemoryAllocateFlagsInfo(MemorySegment segment) {
    ...
    public static final class VkMemoryAllocateFlagsInfoFactory implements IDataTypeFactory<VkMemoryAllocateFlagsInfo> {
        @Override
    ...
    public static final VkMemoryAllocateFlagsInfoFactory FACTORY = new VkMemoryAllocateFlagsInfoFactory();
}

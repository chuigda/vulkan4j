...
public record VkPhysicalDeviceImageProcessing2PropertiesQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxBlockMatchWindow = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceImageProcessing2PropertiesQCOMFactory implements IDataTypeFactory<VkPhysicalDeviceImageProcessing2PropertiesQCOM> {
        @Override

...
public record VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$multisampledRenderToSingleSampled = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT> {
        @Override

...
public record VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$separateDepthStencilLayouts = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceSeparateDepthStencilLayoutsFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures> {
        @Override

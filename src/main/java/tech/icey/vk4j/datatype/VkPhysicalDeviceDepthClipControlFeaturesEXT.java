...
public record VkPhysicalDeviceDepthClipControlFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$depthClipControl = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceDepthClipControlFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceDepthClipControlFeaturesEXT> {
        @Override

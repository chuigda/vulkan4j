...
public record VkXcbSurfaceCreateInfoKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$connection = PathElement.groupElement(3);
    ...
    public static final class VkXcbSurfaceCreateInfoKHRFactory implements IDataTypeFactory<VkXcbSurfaceCreateInfoKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkXcbSurfaceCreateInfoKHR.LAYOUT;
        }

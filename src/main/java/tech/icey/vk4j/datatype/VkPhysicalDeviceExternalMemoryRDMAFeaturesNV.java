...
public record VkPhysicalDeviceExternalMemoryRDMAFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$externalMemoryRDMA = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceExternalMemoryRDMAFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceExternalMemoryRDMAFeaturesNV> {
        @Override

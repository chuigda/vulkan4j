...
public record VkAttachmentSampleLocationsEXT(MemorySegment segment) {
    ...
    public static final class VkAttachmentSampleLocationsEXTFactory implements IDataTypeFactory<VkAttachmentSampleLocationsEXT> {
        @Override
    ...
    public static final VkAttachmentSampleLocationsEXTFactory FACTORY = new VkAttachmentSampleLocationsEXTFactory();
}

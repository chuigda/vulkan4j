...
public record VkPhysicalDeviceToolProperties(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceToolPropertiesFactory implements IDataTypeFactory<VkPhysicalDeviceToolProperties> {
        @Override
    ...
    public static final VkPhysicalDeviceToolPropertiesFactory FACTORY = new VkPhysicalDeviceToolPropertiesFactory();
}

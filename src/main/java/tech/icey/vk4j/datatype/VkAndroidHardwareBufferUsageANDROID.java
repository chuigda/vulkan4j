...
public record VkAndroidHardwareBufferUsageANDROID(MemorySegment segment) {
    ...
    public static final PathElement PATH$androidHardwareBufferUsage = PathElement.groupElement(2);
    ...
    public static final class VkAndroidHardwareBufferUsageANDROIDFactory implements IDataTypeFactory<VkAndroidHardwareBufferUsageANDROID> {
        ...
        public MemoryLayout layout() {
            return VkAndroidHardwareBufferUsageANDROID.LAYOUT;
        }

        @Override
        public VkAndroidHardwareBufferUsageANDROID create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkAndroidHardwareBufferUsageANDROID createUninit(MemorySegment segment) {
            return new VkAndroidHardwareBufferUsageANDROID(segment);
        }
    }

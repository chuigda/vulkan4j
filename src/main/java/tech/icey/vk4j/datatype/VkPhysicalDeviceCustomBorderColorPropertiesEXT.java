...
public record VkPhysicalDeviceCustomBorderColorPropertiesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxCustomBorderColorSamplers = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceCustomBorderColorPropertiesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceCustomBorderColorPropertiesEXT> {
        @Override
    ...
    public static final VkPhysicalDeviceCustomBorderColorPropertiesEXTFactory FACTORY = new VkPhysicalDeviceCustomBorderColorPropertiesEXTFactory();
}

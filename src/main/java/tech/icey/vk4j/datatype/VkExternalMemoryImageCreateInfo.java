...
public record VkExternalMemoryImageCreateInfo(MemorySegment segment) {
    ...
    public static final class VkExternalMemoryImageCreateInfoFactory implements IDataTypeFactory<VkExternalMemoryImageCreateInfo> {
        @Override
        public Class<VkExternalMemoryImageCreateInfo> clazz() {
            return VkExternalMemoryImageCreateInfo.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkExternalMemoryImageCreateInfo.LAYOUT;
        }

        @Override
        public VkExternalMemoryImageCreateInfo create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkExternalMemoryImageCreateInfo createUninit(MemorySegment segment) {
            return new VkExternalMemoryImageCreateInfo(segment);
        }
    }

    public static final VkExternalMemoryImageCreateInfoFactory FACTORY = new VkExternalMemoryImageCreateInfoFactory();
}

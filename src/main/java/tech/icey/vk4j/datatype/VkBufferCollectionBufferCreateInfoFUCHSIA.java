...
public record VkBufferCollectionBufferCreateInfoFUCHSIA(MemorySegment segment) {
    ...
    public static final class VkBufferCollectionBufferCreateInfoFUCHSIAFactory implements IDataTypeFactory<VkBufferCollectionBufferCreateInfoFUCHSIA> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkBufferCollectionBufferCreateInfoFUCHSIA.LAYOUT;
        }

        @Override
        public VkBufferCollectionBufferCreateInfoFUCHSIA create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkBufferCollectionBufferCreateInfoFUCHSIA createUninit(MemorySegment segment) {
            return new VkBufferCollectionBufferCreateInfoFUCHSIA(segment);
        }
    }

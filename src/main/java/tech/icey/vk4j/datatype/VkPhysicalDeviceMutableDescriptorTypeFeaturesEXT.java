...
public record VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$mutableDescriptorType = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceMutableDescriptorTypeFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT> {
        @Override

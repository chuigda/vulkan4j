...
public record VkClearRect(MemorySegment segment) {
    ...
    public static final class VkClearRectFactory implements IDataTypeFactory<VkClearRect> {
        @Override
    ...
    public static final VkClearRectFactory FACTORY = new VkClearRectFactory();
}

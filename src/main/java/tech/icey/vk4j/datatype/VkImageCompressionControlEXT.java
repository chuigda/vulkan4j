...
public record VkImageCompressionControlEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$compressionControlPlaneCount = PathElement.groupElement(3);
    public static final PathElement PATH$pFixedRateFlags = PathElement.groupElement(4);
    ...
    public static final class VkImageCompressionControlEXTFactory implements IDataTypeFactory<VkImageCompressionControlEXT> {
        @Override
        public Class<VkImageCompressionControlEXT> clazz() {
            return VkImageCompressionControlEXT.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkImageCompressionControlEXT.LAYOUT;
        }

        @Override
        public VkImageCompressionControlEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkImageCompressionControlEXT createUninit(MemorySegment segment) {
            return new VkImageCompressionControlEXT(segment);
        }
    }

    public static final VkImageCompressionControlEXTFactory FACTORY = new VkImageCompressionControlEXTFactory();
}

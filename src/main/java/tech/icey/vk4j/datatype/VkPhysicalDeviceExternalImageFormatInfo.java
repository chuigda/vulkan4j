...
public record VkPhysicalDeviceExternalImageFormatInfo(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceExternalImageFormatInfoFactory implements IDataTypeFactory<VkPhysicalDeviceExternalImageFormatInfo> {
        @Override
        public Class<VkPhysicalDeviceExternalImageFormatInfo> clazz() {
            return VkPhysicalDeviceExternalImageFormatInfo.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkPhysicalDeviceExternalImageFormatInfo.LAYOUT;
        }
    ...
    public static final VkPhysicalDeviceExternalImageFormatInfoFactory FACTORY = new VkPhysicalDeviceExternalImageFormatInfoFactory();
}

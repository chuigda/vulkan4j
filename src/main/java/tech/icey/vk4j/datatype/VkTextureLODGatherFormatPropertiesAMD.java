...
public record VkTextureLODGatherFormatPropertiesAMD(MemorySegment segment) {
    ...
    public static final PathElement PATH$supportsTextureGatherLODBiasAMD = PathElement.groupElement(2);
    ...
    public static final class VkTextureLODGatherFormatPropertiesAMDFactory implements IDataTypeFactory<VkTextureLODGatherFormatPropertiesAMD> {
        @Override

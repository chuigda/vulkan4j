...
public record VkDescriptorSetLayoutHostMappingInfoVALVE(MemorySegment segment) {
    ...
    public static final PathElement PATH$descriptorOffset = PathElement.groupElement(2);
    public static final PathElement PATH$descriptorSize = PathElement.groupElement(3);
    ...
    public static final class VkDescriptorSetLayoutHostMappingInfoVALVEFactory implements IDataTypeFactory<VkDescriptorSetLayoutHostMappingInfoVALVE> {
        @Override

...
public record VkPhysicalDeviceImageProcessingFeaturesQCOM(MemorySegment segment) {
    ...
    public static final PathElement PATH$textureSampleWeighted = PathElement.groupElement(2);
    public static final PathElement PATH$textureBoxFilter = PathElement.groupElement(3);
    public static final PathElement PATH$textureBlockMatch = PathElement.groupElement(4);
    ...
    public static final class VkPhysicalDeviceImageProcessingFeaturesQCOMFactory implements IDataTypeFactory<VkPhysicalDeviceImageProcessingFeaturesQCOM> {
        @Override

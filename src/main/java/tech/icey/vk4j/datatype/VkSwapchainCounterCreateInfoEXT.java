...
public record VkSwapchainCounterCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$surfaceCounters = PathElement.groupElement(2);
    ...
    public static final class VkSwapchainCounterCreateInfoEXTFactory implements IDataTypeFactory<VkSwapchainCounterCreateInfoEXT> {
        @Override

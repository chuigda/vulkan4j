...
public record VkPhysicalDeviceShaderTerminateInvocationFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderTerminateInvocation = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceShaderTerminateInvocationFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceShaderTerminateInvocationFeatures> {
        @Override

...
public record VkAccelerationStructureGeometryMotionTrianglesDataNV(MemorySegment segment) {
    ...
    public static final class VkAccelerationStructureGeometryMotionTrianglesDataNVFactory implements IDataTypeFactory<VkAccelerationStructureGeometryMotionTrianglesDataNV> {
        @Override

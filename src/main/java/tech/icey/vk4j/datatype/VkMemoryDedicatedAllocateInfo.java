...
public record VkMemoryDedicatedAllocateInfo(MemorySegment segment) {
    ...
    public static final class VkMemoryDedicatedAllocateInfoFactory implements IDataTypeFactory<VkMemoryDedicatedAllocateInfo> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkMemoryDedicatedAllocateInfo.LAYOUT;
        }

        @Override
        public VkMemoryDedicatedAllocateInfo create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkMemoryDedicatedAllocateInfo createUninit(MemorySegment segment) {
            return new VkMemoryDedicatedAllocateInfo(segment);
        }
    }

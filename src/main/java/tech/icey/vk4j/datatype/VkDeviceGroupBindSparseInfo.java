...
public record VkDeviceGroupBindSparseInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$resourceDeviceIndex = PathElement.groupElement(2);
    public static final PathElement PATH$memoryDeviceIndex = PathElement.groupElement(3);

...
public record VkExternalFormatQNX(MemorySegment segment) {
    ...
    public static final PathElement PATH$externalFormat = PathElement.groupElement(2);
    ...
    public VkExternalFormatQNX(MemorySegment segment) {
        ...
        this.sType(VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_QNX);
    }
    ...
    public static final class VkExternalFormatQNXFactory implements IDataTypeFactory<VkExternalFormatQNX> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkExternalFormatQNX.LAYOUT;
        }

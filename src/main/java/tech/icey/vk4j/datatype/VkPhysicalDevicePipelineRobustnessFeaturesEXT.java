...
public record VkPhysicalDevicePipelineRobustnessFeaturesEXT(MemorySegment segment) {
    ...
    public static final class VkPhysicalDevicePipelineRobustnessFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDevicePipelineRobustnessFeaturesEXT> {
        @Override

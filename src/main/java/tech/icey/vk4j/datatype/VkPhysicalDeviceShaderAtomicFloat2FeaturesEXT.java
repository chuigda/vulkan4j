...
public record VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT(MemorySegment segment) {
    ...
    public static final class VkPhysicalDeviceShaderAtomicFloat2FeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT> {
        @Override
    ...
    public static final VkPhysicalDeviceShaderAtomicFloat2FeaturesEXTFactory FACTORY = new VkPhysicalDeviceShaderAtomicFloat2FeaturesEXTFactory();
}

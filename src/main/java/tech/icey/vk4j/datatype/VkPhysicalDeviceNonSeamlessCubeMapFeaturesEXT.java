...
public record VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$nonSeamlessCubeMap = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXTFactory implements IDataTypeFactory<VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT> {
        @Override

...
public record VkPipelineViewportSwizzleStateCreateInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$pViewportSwizzles = PathElement.groupElement(4);
    ...
    public static final class VkPipelineViewportSwizzleStateCreateInfoNVFactory implements IDataTypeFactory<VkPipelineViewportSwizzleStateCreateInfoNV> {
        @Override

...
public record VkPhysicalDeviceMultiviewProperties(MemorySegment segment) {
    ...
    public static final PathElement PATH$maxMultiviewViewCount = PathElement.groupElement(2);
    public static final PathElement PATH$maxMultiviewInstanceIndex = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceMultiviewPropertiesFactory implements IDataTypeFactory<VkPhysicalDeviceMultiviewProperties> {
        @Override

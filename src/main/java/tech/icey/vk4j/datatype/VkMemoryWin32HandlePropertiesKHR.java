...
public record VkMemoryWin32HandlePropertiesKHR(MemorySegment segment) {
    ...
    public static final class VkMemoryWin32HandlePropertiesKHRFactory implements IDataTypeFactory<VkMemoryWin32HandlePropertiesKHR> {
        @Override
        ...
        public MemoryLayout layout() {
            return VkMemoryWin32HandlePropertiesKHR.LAYOUT;
        }

        @Override
        public VkMemoryWin32HandlePropertiesKHR create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkMemoryWin32HandlePropertiesKHR createUninit(MemorySegment segment) {
            return new VkMemoryWin32HandlePropertiesKHR(segment);
        }
    }

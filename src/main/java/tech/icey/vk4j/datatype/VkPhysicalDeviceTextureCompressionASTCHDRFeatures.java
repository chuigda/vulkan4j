...
public record VkPhysicalDeviceTextureCompressionASTCHDRFeatures(MemorySegment segment) {
    ...
    public static final PathElement PATH$textureCompressionASTC_HDR = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceTextureCompressionASTCHDRFeaturesFactory implements IDataTypeFactory<VkPhysicalDeviceTextureCompressionASTCHDRFeatures> {
        @Override

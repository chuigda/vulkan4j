...
public record VkRenderPassCreationFeedbackCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pRenderPassFeedback = PathElement.groupElement(2);
    ...
    public static final class VkRenderPassCreationFeedbackCreateInfoEXTFactory implements IDataTypeFactory<VkRenderPassCreationFeedbackCreateInfoEXT> {
        @Override

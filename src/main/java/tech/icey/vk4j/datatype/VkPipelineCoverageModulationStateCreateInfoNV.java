...
public record VkPipelineCoverageModulationStateCreateInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$coverageModulationMode = PathElement.groupElement(3);
    public static final PathElement PATH$coverageModulationTableEnable = PathElement.groupElement(4);
    public static final PathElement PATH$coverageModulationTableCount = PathElement.groupElement(5);
    public static final PathElement PATH$pCoverageModulationTable = PathElement.groupElement(6);
    ...
    public static final class VkPipelineCoverageModulationStateCreateInfoNVFactory implements IDataTypeFactory<VkPipelineCoverageModulationStateCreateInfoNV> {
        @Override
    ...
    public static final VkPipelineCoverageModulationStateCreateInfoNVFactory FACTORY = new VkPipelineCoverageModulationStateCreateInfoNVFactory();
}

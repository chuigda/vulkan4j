...
public record VkSwapchainPresentScalingCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$scalingBehavior = PathElement.groupElement(2);
    public static final PathElement PATH$presentGravityX = PathElement.groupElement(3);
    public static final PathElement PATH$presentGravityY = PathElement.groupElement(4);
    ...
    public static final class VkSwapchainPresentScalingCreateInfoEXTFactory implements IDataTypeFactory<VkSwapchainPresentScalingCreateInfoEXT> {
        @Override

...
public record VkExportMetalObjectCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$exportObjectType = PathElement.groupElement(2);
    ...
    public static final class VkExportMetalObjectCreateInfoEXTFactory implements IDataTypeFactory<VkExportMetalObjectCreateInfoEXT> {
        @Override
        public Class<VkExportMetalObjectCreateInfoEXT> clazz() {
            return VkExportMetalObjectCreateInfoEXT.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkExportMetalObjectCreateInfoEXT.LAYOUT;
        }

        @Override
        public VkExportMetalObjectCreateInfoEXT create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkExportMetalObjectCreateInfoEXT createUninit(MemorySegment segment) {
            return new VkExportMetalObjectCreateInfoEXT(segment);
        }
    }

    public static final VkExportMetalObjectCreateInfoEXTFactory FACTORY = new VkExportMetalObjectCreateInfoEXTFactory();
}

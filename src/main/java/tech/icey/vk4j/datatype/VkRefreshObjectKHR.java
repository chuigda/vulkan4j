...
public record VkRefreshObjectKHR(MemorySegment segment) {
    ...
    public static final class VkRefreshObjectKHRFactory implements IDataTypeFactory<VkRefreshObjectKHR> {
        @Override
    ...
    public static final VkRefreshObjectKHRFactory FACTORY = new VkRefreshObjectKHRFactory();
}

...
public record VkPhysicalDeviceShaderClockFeaturesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$shaderSubgroupClock = PathElement.groupElement(2);
    public static final PathElement PATH$shaderDeviceClock = PathElement.groupElement(3);
    ...
    public static final class VkPhysicalDeviceShaderClockFeaturesKHRFactory implements IDataTypeFactory<VkPhysicalDeviceShaderClockFeaturesKHR> {
        @Override

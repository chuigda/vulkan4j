...
public record VkPhysicalDeviceVertexAttributeDivisorPropertiesKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$supportsNonZeroFirstInstance = PathElement.groupElement(3);
    ...
    public static final VkPhysicalDeviceVertexAttributeDivisorPropertiesKHRFactory FACTORY = new VkPhysicalDeviceVertexAttributeDivisorPropertiesKHRFactory();
}

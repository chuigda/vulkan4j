...
public record VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$representativeFragmentTest = PathElement.groupElement(2);
    ...
    public static final class VkPhysicalDeviceRepresentativeFragmentTestFeaturesNVFactory implements IDataTypeFactory<VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV> {
        @Override

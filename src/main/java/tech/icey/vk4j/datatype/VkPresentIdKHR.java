...
public record VkPresentIdKHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$pPresentIds = PathElement.groupElement(3);
    ...
    public static final class VkPresentIdKHRFactory implements IDataTypeFactory<VkPresentIdKHR> {
        @Override

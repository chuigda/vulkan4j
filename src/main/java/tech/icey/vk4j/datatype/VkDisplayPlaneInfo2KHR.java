...
public record VkDisplayPlaneInfo2KHR(MemorySegment segment) {
    ...
    public static final PathElement PATH$planeIndex = PathElement.groupElement(3);
    ...
    public static final class VkDisplayPlaneInfo2KHRFactory implements IDataTypeFactory<VkDisplayPlaneInfo2KHR> {
        @Override

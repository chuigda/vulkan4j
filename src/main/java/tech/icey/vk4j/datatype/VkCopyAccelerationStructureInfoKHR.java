...
public record VkCopyAccelerationStructureInfoKHR(MemorySegment segment) {
    ...
    public static final class VkCopyAccelerationStructureInfoKHRFactory implements IDataTypeFactory<VkCopyAccelerationStructureInfoKHR> {
        @Override
        public Class<VkCopyAccelerationStructureInfoKHR> clazz() {
            return VkCopyAccelerationStructureInfoKHR.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkCopyAccelerationStructureInfoKHR.LAYOUT;
        }
    ...
    public static final VkCopyAccelerationStructureInfoKHRFactory FACTORY = new VkCopyAccelerationStructureInfoKHRFactory();
}

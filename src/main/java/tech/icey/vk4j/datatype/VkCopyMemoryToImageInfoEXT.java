...
public record VkCopyMemoryToImageInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$dstImage = PathElement.groupElement(3);
    public static final PathElement PATH$dstImageLayout = PathElement.groupElement(4);
    ...
    public void pRegions(VkMemoryToImageCopyEXT value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pRegionsRaw(s);
    }


    public static final class VkCopyMemoryToImageInfoEXTFactory implements IDataTypeFactory<VkCopyMemoryToImageInfoEXT> {
        @Override

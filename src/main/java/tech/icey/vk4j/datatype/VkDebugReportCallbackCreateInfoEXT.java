...
public record VkDebugReportCallbackCreateInfoEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$pfnCallback = PathElement.groupElement(3);
    ...
    public static final class VkDebugReportCallbackCreateInfoEXTFactory implements IDataTypeFactory<VkDebugReportCallbackCreateInfoEXT> {
        @Override

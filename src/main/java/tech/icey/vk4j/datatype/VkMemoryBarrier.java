...
public record VkMemoryBarrier(MemorySegment segment) {
    ...
    public static final class VkMemoryBarrierFactory implements IDataTypeFactory<VkMemoryBarrier> {
        @Override
        public Class<VkMemoryBarrier> clazz() {
            return VkMemoryBarrier.class;
        } 

        @Override
        public MemoryLayout layout() {
            return VkMemoryBarrier.LAYOUT;
        }

        @Override
        public VkMemoryBarrier create(MemorySegment segment) {
            return createUninit(segment);
        }
        
        @Override
        public VkMemoryBarrier createUninit(MemorySegment segment) {
            return new VkMemoryBarrier(segment);
        }
    }

    public static final VkMemoryBarrierFactory FACTORY = new VkMemoryBarrierFactory();
}

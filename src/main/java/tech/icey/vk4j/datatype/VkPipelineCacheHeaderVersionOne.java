...
public record VkPipelineCacheHeaderVersionOne(MemorySegment segment) {
    ...
    public static final PathElement PATH$pipelineCacheUUID = PathElement.groupElement(4);
    ...
    public static final class VkPipelineCacheHeaderVersionOneFactory implements IDataTypeFactory<VkPipelineCacheHeaderVersionOne> {
        @Override

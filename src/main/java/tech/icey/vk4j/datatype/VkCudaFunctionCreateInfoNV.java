...
public record VkCudaFunctionCreateInfoNV(MemorySegment segment) {
    ...
    public static final PathElement PATH$module = PathElement.groupElement(2);
    public static final PathElement PATH$pName = PathElement.groupElement(3);
    ...
    public static final class VkCudaFunctionCreateInfoNVFactory implements IDataTypeFactory<VkCudaFunctionCreateInfoNV> {
        @Override

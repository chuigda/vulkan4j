...
public record VkImageFormatListCreateInfo(MemorySegment segment) {
    ...
    public static final PathElement PATH$viewFormatCount = PathElement.groupElement(2);
    public static final PathElement PATH$pViewFormats = PathElement.groupElement(3);
    ...
    public static final class VkImageFormatListCreateInfoFactory implements IDataTypeFactory<VkImageFormatListCreateInfo> {
        @Override

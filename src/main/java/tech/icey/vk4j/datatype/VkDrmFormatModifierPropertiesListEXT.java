...
public record VkDrmFormatModifierPropertiesListEXT(MemorySegment segment) {
    ...
    public void pDrmFormatModifierProperties(VkDrmFormatModifierPropertiesEXT value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pDrmFormatModifierPropertiesRaw(s);
    }


    public static final class VkDrmFormatModifierPropertiesListEXTFactory implements IDataTypeFactory<VkDrmFormatModifierPropertiesListEXT> {
        @Override

...
public record VkPhysicalDeviceProvokingVertexFeaturesEXT(MemorySegment segment) {
    ...
    public static final PathElement PATH$provokingVertexLast = PathElement.groupElement(2);
    public static final PathElement PATH$transformFeedbackPreservesProvokingVertex = PathElement.groupElement(3);

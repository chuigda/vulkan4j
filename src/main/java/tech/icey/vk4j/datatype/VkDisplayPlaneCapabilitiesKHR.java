...
public record VkDisplayPlaneCapabilitiesKHR(MemorySegment segment) {
    ...
    public static final class VkDisplayPlaneCapabilitiesKHRFactory implements IDataTypeFactory<VkDisplayPlaneCapabilitiesKHR> {
        @Override
    ...
    public static final VkDisplayPlaneCapabilitiesKHRFactory FACTORY = new VkDisplayPlaneCapabilitiesKHRFactory();
}

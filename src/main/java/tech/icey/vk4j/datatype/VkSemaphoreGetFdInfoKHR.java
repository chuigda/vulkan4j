...
public record VkSemaphoreGetFdInfoKHR(MemorySegment segment) {
    ...
    public static final class VkSemaphoreGetFdInfoKHRFactory implements IDataTypeFactory<VkSemaphoreGetFdInfoKHR> {
        @Override
    ...
    public static final VkSemaphoreGetFdInfoKHRFactory FACTORY = new VkSemaphoreGetFdInfoKHRFactory();
}

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkCuModuleNVX.html">VkCuModuleNVX</a>
public record VkCuModuleNVX(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        ...
        public void write(long index, VkCuModuleNVX value) {

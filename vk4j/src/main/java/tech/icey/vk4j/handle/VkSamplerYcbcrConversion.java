...
public record VkSamplerYcbcrConversion(MemorySegment segment) {
    public record Buffer(MemorySegment segment) {
        ...
        public VkSamplerYcbcrConversion read() {
            return new VkSamplerYcbcrConversion(readRaw());
        }

        public VkSamplerYcbcrConversion read(long index) {
            return new VkSamplerYcbcrConversion(readRaw(index));
        }
        ...
        public VkSamplerYcbcrConversion[] readAll() {
            VkSamplerYcbcrConversion[] handles = new VkSamplerYcbcrConversion[(int)size()];
        ...
        public void write(VkSamplerYcbcrConversion value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkSamplerYcbcrConversion value) {

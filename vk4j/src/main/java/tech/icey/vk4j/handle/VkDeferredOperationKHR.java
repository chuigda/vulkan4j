...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkDeferredOperationKHR.html">VkDeferredOperationKHR</a>
public record VkDeferredOperationKHR(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        ...
        public void write(long index, VkDeferredOperationKHR value) {

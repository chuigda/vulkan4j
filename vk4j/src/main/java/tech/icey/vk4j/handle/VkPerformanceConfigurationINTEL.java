...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPerformanceConfigurationINTEL.html">VkPerformanceConfigurationINTEL</a>
public record VkPerformanceConfigurationINTEL(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkPerformanceConfigurationINTEL read() {
            return new VkPerformanceConfigurationINTEL(readRaw());
        }

        public VkPerformanceConfigurationINTEL read(long index) {
            return new VkPerformanceConfigurationINTEL(readRaw(index));
        }
        ...
        public VkPerformanceConfigurationINTEL[] readAll() {
            VkPerformanceConfigurationINTEL[] handles = new VkPerformanceConfigurationINTEL[(int)size()];
        ...
        public void write(VkPerformanceConfigurationINTEL value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkPerformanceConfigurationINTEL value) {

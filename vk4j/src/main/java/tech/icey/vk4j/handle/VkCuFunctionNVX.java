...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkCuFunctionNVX.html">VkCuFunctionNVX</a>
public record VkCuFunctionNVX(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkCuFunctionNVX read() {
            return new VkCuFunctionNVX(readRaw());
        }

        public VkCuFunctionNVX read(long index) {
            return new VkCuFunctionNVX(readRaw(index));
        }
        ...
        public VkCuFunctionNVX[] readAll() {
            VkCuFunctionNVX[] handles = new VkCuFunctionNVX[(int)size()];
        ...
        public void write(VkCuFunctionNVX value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkCuFunctionNVX value) {

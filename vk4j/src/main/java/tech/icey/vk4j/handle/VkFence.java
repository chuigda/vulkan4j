...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkFence.html">VkFence</a>
public record VkFence(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        ...
        public VkFence read() {
            return new VkFence(readRaw());
        }

        public VkFence read(long index) {
            return new VkFence(readRaw(index));
        }
        ...
        public VkFence[] readAll() {
            VkFence[] handles = new VkFence[(int)size()];
        ...
        public void write(VkFence value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkFence value) {

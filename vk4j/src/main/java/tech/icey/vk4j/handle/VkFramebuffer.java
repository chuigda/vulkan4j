...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkFramebuffer.html">VkFramebuffer</a>
public record VkFramebuffer(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        ...
        public VkFramebuffer read(long index) {
            return new VkFramebuffer(readRaw(index));
        }
        ...
        public VkFramebuffer[] readAll() {
            VkFramebuffer[] handles = new VkFramebuffer[(int)size()];
        ...
        public void write(VkFramebuffer value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkFramebuffer value) {

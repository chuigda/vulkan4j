...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkBufferView.html">VkBufferView</a>
public record VkBufferView(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkBufferView read() {
            return new VkBufferView(readRaw());
        }

        public VkBufferView read(long index) {
            return new VkBufferView(readRaw(index));
        }
        ...
        public VkBufferView[] readAll() {
            VkBufferView[] handles = new VkBufferView[(int)size()];
        ...
        public void write(VkBufferView value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkBufferView value) {

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkSurfaceKHR.html">VkSurfaceKHR</a>
public record VkSurfaceKHR(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkSurfaceKHR read() {
            return new VkSurfaceKHR(readRaw());
        }

        public VkSurfaceKHR read(long index) {
            return new VkSurfaceKHR(readRaw(index));
        }
        ...
        public VkSurfaceKHR[] readAll() {
            VkSurfaceKHR[] handles = new VkSurfaceKHR[(int)size()];
        ...
        public void write(VkSurfaceKHR value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkSurfaceKHR value) {

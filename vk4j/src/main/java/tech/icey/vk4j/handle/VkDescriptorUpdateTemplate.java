...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkDescriptorUpdateTemplate.html">VkDescriptorUpdateTemplate</a>
public record VkDescriptorUpdateTemplate(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkDescriptorUpdateTemplate read() {
            return new VkDescriptorUpdateTemplate(readRaw());
        }

        public VkDescriptorUpdateTemplate read(long index) {
            return new VkDescriptorUpdateTemplate(readRaw(index));
        }
        ...
        public VkDescriptorUpdateTemplate[] readAll() {
            VkDescriptorUpdateTemplate[] handles = new VkDescriptorUpdateTemplate[(int)size()];
        ...
        public void write(VkDescriptorUpdateTemplate value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkDescriptorUpdateTemplate value) {

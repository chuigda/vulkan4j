...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkDescriptorSet.html">VkDescriptorSet</a>
public record VkDescriptorSet(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkDescriptorSet read() {
            return new VkDescriptorSet(readRaw());
        }

        public VkDescriptorSet read(long index) {
            return new VkDescriptorSet(readRaw(index));
        }
        ...
        public VkDescriptorSet[] readAll() {
            VkDescriptorSet[] handles = new VkDescriptorSet[(int)size()];
        ...
        public void write(VkDescriptorSet value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkDescriptorSet value) {

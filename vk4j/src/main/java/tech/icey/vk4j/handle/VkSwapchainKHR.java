...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkSwapchainKHR.html">VkSwapchainKHR</a>
public record VkSwapchainKHR(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkSwapchainKHR read() {
            return new VkSwapchainKHR(readRaw());
        }

        public VkSwapchainKHR read(long index) {
            return new VkSwapchainKHR(readRaw(index));
        }
        ...
        public VkSwapchainKHR[] readAll() {
            VkSwapchainKHR[] handles = new VkSwapchainKHR[(int)size()];
        ...
        public void write(VkSwapchainKHR value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkSwapchainKHR value) {

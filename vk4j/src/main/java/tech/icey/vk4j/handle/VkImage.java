...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkImage.html">VkImage</a>
public record VkImage(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        ...
        public VkImage read() {
            return new VkImage(readRaw());
        }

        public VkImage read(long index) {
            return new VkImage(readRaw(index));
        }
        ...
        public VkImage[] readAll() {
            VkImage[] handles = new VkImage[(int)size()];
        ...
        public void write(VkImage value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkImage value) {

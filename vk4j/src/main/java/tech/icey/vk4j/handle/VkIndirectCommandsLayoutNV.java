...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkIndirectCommandsLayoutNV.html">VkIndirectCommandsLayoutNV</a>
public record VkIndirectCommandsLayoutNV(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkIndirectCommandsLayoutNV read() {
            return new VkIndirectCommandsLayoutNV(readRaw());
        }

        public VkIndirectCommandsLayoutNV read(long index) {
            return new VkIndirectCommandsLayoutNV(readRaw(index));
        }
        ...
        public VkIndirectCommandsLayoutNV[] readAll() {
            VkIndirectCommandsLayoutNV[] handles = new VkIndirectCommandsLayoutNV[(int)size()];
        ...
        public void write(VkIndirectCommandsLayoutNV value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkIndirectCommandsLayoutNV value) {

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkQueryPool.html">VkQueryPool</a>
public record VkQueryPool(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        ...
        public void write(long index, VkQueryPool value) {

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPipelineCache.html">VkPipelineCache</a>
public record VkPipelineCache(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkPipelineCache read() {
            return new VkPipelineCache(readRaw());
        }

        public VkPipelineCache read(long index) {
            return new VkPipelineCache(readRaw(index));
        }
        ...
        public VkPipelineCache[] readAll() {
            VkPipelineCache[] handles = new VkPipelineCache[(int)size()];
        ...
        public void write(VkPipelineCache value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkPipelineCache value) {

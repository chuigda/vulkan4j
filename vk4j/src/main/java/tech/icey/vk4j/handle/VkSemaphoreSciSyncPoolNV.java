...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkSemaphoreSciSyncPoolNV.html">VkSemaphoreSciSyncPoolNV</a>
public record VkSemaphoreSciSyncPoolNV(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkSemaphoreSciSyncPoolNV read() {
            return new VkSemaphoreSciSyncPoolNV(readRaw());
        }

        public VkSemaphoreSciSyncPoolNV read(long index) {
            return new VkSemaphoreSciSyncPoolNV(readRaw(index));
        }
        ...
        public VkSemaphoreSciSyncPoolNV[] readAll() {
            VkSemaphoreSciSyncPoolNV[] handles = new VkSemaphoreSciSyncPoolNV[(int)size()];
        ...
        public void write(VkSemaphoreSciSyncPoolNV value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkSemaphoreSciSyncPoolNV value) {

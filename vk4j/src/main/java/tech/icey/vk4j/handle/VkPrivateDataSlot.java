...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPrivateDataSlot.html">VkPrivateDataSlot</a>
public record VkPrivateDataSlot(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkPrivateDataSlot read() {
            return new VkPrivateDataSlot(readRaw());
        }

        public VkPrivateDataSlot read(long index) {
            return new VkPrivateDataSlot(readRaw(index));
        }
        ...
        public VkPrivateDataSlot[] readAll() {
            VkPrivateDataSlot[] handles = new VkPrivateDataSlot[(int)size()];
        ...
        public void write(VkPrivateDataSlot value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkPrivateDataSlot value) {

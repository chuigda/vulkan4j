...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkDisplayKHR.html">VkDisplayKHR</a>
public record VkDisplayKHR(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkDisplayKHR read() {
            return new VkDisplayKHR(readRaw());
        }

        public VkDisplayKHR read(long index) {
            return new VkDisplayKHR(readRaw(index));
        }
        ...
        public VkDisplayKHR[] readAll() {
            VkDisplayKHR[] handles = new VkDisplayKHR[(int)size()];
        ...
        public void write(VkDisplayKHR value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkDisplayKHR value) {

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkCudaModuleNV.html">VkCudaModuleNV</a>
public record VkCudaModuleNV(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkCudaModuleNV read() {
            return new VkCudaModuleNV(readRaw());
        }

        public VkCudaModuleNV read(long index) {
            return new VkCudaModuleNV(readRaw(index));
        }
        ...
        public VkCudaModuleNV[] readAll() {
            VkCudaModuleNV[] handles = new VkCudaModuleNV[(int)size()];
        ...
        public void write(VkCudaModuleNV value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkCudaModuleNV value) {

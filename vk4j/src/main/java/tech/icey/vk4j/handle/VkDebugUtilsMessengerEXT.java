...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkDebugUtilsMessengerEXT.html">VkDebugUtilsMessengerEXT</a>
public record VkDebugUtilsMessengerEXT(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkDebugUtilsMessengerEXT read() {
            return new VkDebugUtilsMessengerEXT(readRaw());
        }

        public VkDebugUtilsMessengerEXT read(long index) {
            return new VkDebugUtilsMessengerEXT(readRaw(index));
        }
        ...
        public VkDebugUtilsMessengerEXT[] readAll() {
            VkDebugUtilsMessengerEXT[] handles = new VkDebugUtilsMessengerEXT[(int)size()];
        ...
        public void write(VkDebugUtilsMessengerEXT value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkDebugUtilsMessengerEXT value) {

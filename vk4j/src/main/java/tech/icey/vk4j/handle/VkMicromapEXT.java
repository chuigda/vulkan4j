...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkMicromapEXT.html">VkMicromapEXT</a>
public record VkMicromapEXT(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkMicromapEXT read() {
            return new VkMicromapEXT(readRaw());
        }

        public VkMicromapEXT read(long index) {
            return new VkMicromapEXT(readRaw(index));
        }
        ...
        public VkMicromapEXT[] readAll() {
            VkMicromapEXT[] handles = new VkMicromapEXT[(int)size()];
        ...
        public void write(VkMicromapEXT value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkMicromapEXT value) {

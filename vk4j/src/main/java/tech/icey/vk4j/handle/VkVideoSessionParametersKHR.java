...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkVideoSessionParametersKHR.html">VkVideoSessionParametersKHR</a>
public record VkVideoSessionParametersKHR(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkVideoSessionParametersKHR read() {
            return new VkVideoSessionParametersKHR(readRaw());
        }

        public VkVideoSessionParametersKHR read(long index) {
            return new VkVideoSessionParametersKHR(readRaw(index));
        }
        ...
        public VkVideoSessionParametersKHR[] readAll() {
            VkVideoSessionParametersKHR[] handles = new VkVideoSessionParametersKHR[(int)size()];
        ...
        public void write(VkVideoSessionParametersKHR value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkVideoSessionParametersKHR value) {

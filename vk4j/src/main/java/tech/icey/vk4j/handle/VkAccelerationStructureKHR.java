...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkAccelerationStructureKHR.html">VkAccelerationStructureKHR</a>
public record VkAccelerationStructureKHR(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkAccelerationStructureKHR read() {
            return new VkAccelerationStructureKHR(readRaw());
        }

        public VkAccelerationStructureKHR read(long index) {
            return new VkAccelerationStructureKHR(readRaw(index));
        }
        ...
        public VkAccelerationStructureKHR[] readAll() {
            VkAccelerationStructureKHR[] handles = new VkAccelerationStructureKHR[(int)size()];
        ...
        public void write(VkAccelerationStructureKHR value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkAccelerationStructureKHR value) {

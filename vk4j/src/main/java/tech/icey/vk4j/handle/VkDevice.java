...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkDevice.html">VkDevice</a>
public record VkDevice(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        ...
        public void write(long index, VkDevice value) {

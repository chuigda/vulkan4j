...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkValidationCacheEXT.html">VkValidationCacheEXT</a>
public record VkValidationCacheEXT(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkValidationCacheEXT read() {
            return new VkValidationCacheEXT(readRaw());
        }

        public VkValidationCacheEXT read(long index) {
            return new VkValidationCacheEXT(readRaw(index));
        }
        ...
        public VkValidationCacheEXT[] readAll() {
            VkValidationCacheEXT[] handles = new VkValidationCacheEXT[(int)size()];
        ...
        public void write(VkValidationCacheEXT value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkValidationCacheEXT value) {

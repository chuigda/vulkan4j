...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkDebugReportCallbackEXT.html">VkDebugReportCallbackEXT</a>
public record VkDebugReportCallbackEXT(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkDebugReportCallbackEXT read() {
            return new VkDebugReportCallbackEXT(readRaw());
        }

        public VkDebugReportCallbackEXT read(long index) {
            return new VkDebugReportCallbackEXT(readRaw(index));
        }
        ...
        public VkDebugReportCallbackEXT[] readAll() {
            VkDebugReportCallbackEXT[] handles = new VkDebugReportCallbackEXT[(int)size()];
        ...
        public void write(VkDebugReportCallbackEXT value) {

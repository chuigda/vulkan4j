...
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkDisplayModeKHR.html">VkDisplayModeKHR</a>
public record VkDisplayModeKHR(MemorySegment segment) implements IPointer {
    public record Buffer(MemorySegment segment) {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public VkDisplayModeKHR read() {
            return new VkDisplayModeKHR(readRaw());
        }

        public VkDisplayModeKHR read(long index) {
            return new VkDisplayModeKHR(readRaw(index));
        }
        ...
        public VkDisplayModeKHR[] readAll() {
            VkDisplayModeKHR[] handles = new VkDisplayModeKHR[(int)size()];
        ...
        public void write(VkDisplayModeKHR value) {
            writeRaw(value.segment());
        }

        public void write(long index, VkDisplayModeKHR value) {

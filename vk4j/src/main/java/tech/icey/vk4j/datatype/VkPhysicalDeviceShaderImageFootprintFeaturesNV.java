...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_FOOTPRINT_FEATURES_NV;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderImageFootprintFeaturesNV.html">VkPhysicalDeviceShaderImageFootprintFeaturesNV</a>
public record VkPhysicalDeviceShaderImageFootprintFeaturesNV(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceShaderImageFootprintFeaturesNV allocate(Arena arena) {
        return new VkPhysicalDeviceShaderImageFootprintFeaturesNV(arena.allocate(LAYOUT));
    }
    ...
    public static VkPhysicalDeviceShaderImageFootprintFeaturesNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPhysicalDeviceShaderImageFootprintFeaturesNV(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

...
import tech.icey.vk4j.enumtype.VkSamplerReductionMode;
...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkSamplerReductionModeCreateInfo.html">VkSamplerReductionModeCreateInfo</a>
public record VkSamplerReductionModeCreateInfo(MemorySegment segment) implements IPointer {
    public VkSamplerReductionModeCreateInfo(MemorySegment segment) {
        this.segment = segment;
        this.sType(VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO);
    }

...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAW_ACCESS_CHAINS_FEATURES_NV;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceRawAccessChainsFeaturesNV.html">VkPhysicalDeviceRawAccessChainsFeaturesNV</a>
public record VkPhysicalDeviceRawAccessChainsFeaturesNV(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceRawAccessChainsFeaturesNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPhysicalDeviceRawAccessChainsFeaturesNV(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

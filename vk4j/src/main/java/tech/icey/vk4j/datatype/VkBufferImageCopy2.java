...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_BUFFER_IMAGE_COPY_2;
...
public record VkBufferImageCopy2(MemorySegment segment) {
    ...
    public static final class Factory implements IFactory<VkBufferImageCopy2> {
        @Override

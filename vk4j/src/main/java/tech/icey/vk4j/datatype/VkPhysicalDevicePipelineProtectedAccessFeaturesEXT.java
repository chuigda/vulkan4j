...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROTECTED_ACCESS_FEATURES_EXT;
...
public record VkPhysicalDevicePipelineProtectedAccessFeaturesEXT(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDevicePipelineProtectedAccessFeaturesEXT clone(Arena arena, VkPhysicalDevicePipelineProtectedAccessFeaturesEXT src) {
        VkPhysicalDevicePipelineProtectedAccessFeaturesEXT ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public static VkPhysicalDevicePipelineProtectedAccessFeaturesEXT[] clone(Arena arena, VkPhysicalDevicePipelineProtectedAccessFeaturesEXT[] src) {
        VkPhysicalDevicePipelineProtectedAccessFeaturesEXT[] ret = allocate(arena, src.length);

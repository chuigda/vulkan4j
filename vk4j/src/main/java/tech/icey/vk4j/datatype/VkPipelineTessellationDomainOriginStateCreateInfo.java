...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPipelineTessellationDomainOriginStateCreateInfo.html">VkPipelineTessellationDomainOriginStateCreateInfo</a>
public record VkPipelineTessellationDomainOriginStateCreateInfo(MemorySegment segment) implements IPointer {
    ...
    public static VkPipelineTessellationDomainOriginStateCreateInfo allocate(Arena arena) {
        return new VkPipelineTessellationDomainOriginStateCreateInfo(arena.allocate(LAYOUT));
    }
    ...
    public static VkPipelineTessellationDomainOriginStateCreateInfo[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPipelineTessellationDomainOriginStateCreateInfo(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

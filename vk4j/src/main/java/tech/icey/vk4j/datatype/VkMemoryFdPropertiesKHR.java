...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHR;
...
public record VkMemoryFdPropertiesKHR(MemorySegment segment) {
    ...
    public static final class Factory implements IFactory<VkMemoryFdPropertiesKHR> {
        @Override

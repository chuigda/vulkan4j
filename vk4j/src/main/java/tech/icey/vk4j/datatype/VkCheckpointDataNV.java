...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_CHECKPOINT_DATA_NV;
...
public record VkCheckpointDataNV(MemorySegment segment) {
    ...
    public static VkCheckpointDataNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkCheckpointDataNV(segment.asSlice(i * LAYOUT.byteSize(), LAYOUT.byteSize()));
        }
        return ret;
    }
}

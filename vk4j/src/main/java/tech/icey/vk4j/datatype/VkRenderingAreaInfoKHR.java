...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_RENDERING_AREA_INFO_KHR;
...
public record VkRenderingAreaInfoKHR(MemorySegment segment) implements IPointer {
    ...
    public static VkRenderingAreaInfoKHR clone(Arena arena, VkRenderingAreaInfoKHR src) {
        VkRenderingAreaInfoKHR ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public static VkRenderingAreaInfoKHR[] clone(Arena arena, VkRenderingAreaInfoKHR[] src) {
        VkRenderingAreaInfoKHR[] ret = allocate(arena, src.length);

...
public record VkMemoryHostPointerPropertiesEXT(MemorySegment segment) {
    ...
    public static VkMemoryHostPointerPropertiesEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkMemoryHostPointerPropertiesEXT(segment.asSlice(i * LAYOUT.byteSize(), LAYOUT.byteSize()));
        }
        return ret;
    }
}

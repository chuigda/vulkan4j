...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_MEMORY_GET_SCI_BUF_INFO_NV;
...
public record VkMemoryGetSciBufInfoNV(MemorySegment segment) {
    ...
    public static final class Factory implements IFactory<VkMemoryGetSciBufInfoNV> {
        @Override

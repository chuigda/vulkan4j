...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_RENDER_PASS_CREATION_CONTROL_EXT;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkRenderPassCreationControlEXT.html">VkRenderPassCreationControlEXT</a>
public record VkRenderPassCreationControlEXT(MemorySegment segment) implements IPointer {
    ...
    public static VkRenderPassCreationControlEXT allocate(Arena arena) {
        return new VkRenderPassCreationControlEXT(arena.allocate(LAYOUT));
    }
    ...
    public static VkRenderPassCreationControlEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkRenderPassCreationControlEXT(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

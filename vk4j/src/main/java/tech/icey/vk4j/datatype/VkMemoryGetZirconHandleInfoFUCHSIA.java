...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_MEMORY_GET_ZIRCON_HANDLE_INFO_FUCHSIA;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkMemoryGetZirconHandleInfoFUCHSIA.html">VkMemoryGetZirconHandleInfoFUCHSIA</a>
public record VkMemoryGetZirconHandleInfoFUCHSIA(MemorySegment segment) implements IPointer {
    public VkMemoryGetZirconHandleInfoFUCHSIA(MemorySegment segment) {
        this.segment = segment;
        this.sType(VK_STRUCTURE_TYPE_MEMORY_GET_ZIRCON_HANDLE_INFO_FUCHSIA);
    }
    ...
    public static VkMemoryGetZirconHandleInfoFUCHSIA allocate(Arena arena) {
        return new VkMemoryGetZirconHandleInfoFUCHSIA(arena.allocate(LAYOUT));
    }

    public static VkMemoryGetZirconHandleInfoFUCHSIA[] allocate(Arena arena, int count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkMemoryGetZirconHandleInfoFUCHSIA[] ret = new VkMemoryGetZirconHandleInfoFUCHSIA[count];
        for (int i = 0; i < count; i++) {
            ret[i] = new VkMemoryGetZirconHandleInfoFUCHSIA(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }
    ...
    public static VkMemoryGetZirconHandleInfoFUCHSIA[] clone(Arena arena, VkMemoryGetZirconHandleInfoFUCHSIA[] src) {
        VkMemoryGetZirconHandleInfoFUCHSIA[] ret = allocate(arena, src.length);

...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_EXPORT_MEMORY_SCI_BUF_INFO_NV;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkExportMemorySciBufInfoNV.html">VkExportMemorySciBufInfoNV</a>
public record VkExportMemorySciBufInfoNV(MemorySegment segment) implements IPointer {
    ...
    public static VkExportMemorySciBufInfoNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkExportMemorySciBufInfoNV(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_BIND_IMAGE_PLANE_MEMORY_INFO;
...
public record VkBindImagePlaneMemoryInfo(MemorySegment segment) {
    ...
    public static final class Factory implements IFactory<VkBindImagePlaneMemoryInfo> {
        @Override

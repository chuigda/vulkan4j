...
public record VkPhysicalDeviceCornerSampledImageFeaturesNV(MemorySegment segment) {
    ...
    public static VkPhysicalDeviceCornerSampledImageFeaturesNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPhysicalDeviceCornerSampledImageFeaturesNV(segment.asSlice(i * LAYOUT.byteSize(), LAYOUT.byteSize()));
        }
        return ret;
    }
}

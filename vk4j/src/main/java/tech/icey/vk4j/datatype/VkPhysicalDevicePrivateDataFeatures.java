...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIVATE_DATA_FEATURES;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDevicePrivateDataFeatures.html">VkPhysicalDevicePrivateDataFeatures</a>
public record VkPhysicalDevicePrivateDataFeatures(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDevicePrivateDataFeatures[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPhysicalDevicePrivateDataFeatures(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

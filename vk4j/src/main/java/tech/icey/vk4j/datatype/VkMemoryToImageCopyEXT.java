...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_MEMORY_TO_IMAGE_COPY_EXT;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkMemoryToImageCopyEXT.html">VkMemoryToImageCopyEXT</a>
public record VkMemoryToImageCopyEXT(MemorySegment segment) implements IPointer {
    ...
    public static VkMemoryToImageCopyEXT clone(Arena arena, VkMemoryToImageCopyEXT src) {
        VkMemoryToImageCopyEXT ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public static VkMemoryToImageCopyEXT[] clone(Arena arena, VkMemoryToImageCopyEXT[] src) {
        VkMemoryToImageCopyEXT[] ret = allocate(arena, src.length);

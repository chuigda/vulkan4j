...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_RELEASE_CAPTURED_PIPELINE_DATA_INFO_KHR;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkReleaseCapturedPipelineDataInfoKHR.html">VkReleaseCapturedPipelineDataInfoKHR</a>
public record VkReleaseCapturedPipelineDataInfoKHR(MemorySegment segment) implements IPointer {
    ...
    public static VkReleaseCapturedPipelineDataInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkReleaseCapturedPipelineDataInfoKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

...
public record VkDescriptorSetVariableDescriptorCountLayoutSupport(MemorySegment segment) {
    ...
    public static VkDescriptorSetVariableDescriptorCountLayoutSupport[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkDescriptorSetVariableDescriptorCountLayoutSupport(segment.asSlice(i * LAYOUT.byteSize(), LAYOUT.byteSize()));
        }
        return ret;
    }
}

...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_EXT;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceDepthClampZeroOneFeaturesEXT.html">VkPhysicalDeviceDepthClampZeroOneFeaturesEXT</a>
public record VkPhysicalDeviceDepthClampZeroOneFeaturesEXT(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceDepthClampZeroOneFeaturesEXT clone(Arena arena, VkPhysicalDeviceDepthClampZeroOneFeaturesEXT src) {
        VkPhysicalDeviceDepthClampZeroOneFeaturesEXT ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public static VkPhysicalDeviceDepthClampZeroOneFeaturesEXT[] clone(Arena arena, VkPhysicalDeviceDepthClampZeroOneFeaturesEXT[] src) {
        VkPhysicalDeviceDepthClampZeroOneFeaturesEXT[] ret = allocate(arena, src.length);

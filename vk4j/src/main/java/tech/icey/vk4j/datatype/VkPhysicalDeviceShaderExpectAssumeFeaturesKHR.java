...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES_KHR;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceShaderExpectAssumeFeaturesKHR.html">VkPhysicalDeviceShaderExpectAssumeFeaturesKHR</a>
public record VkPhysicalDeviceShaderExpectAssumeFeaturesKHR(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceShaderExpectAssumeFeaturesKHR clone(Arena arena, VkPhysicalDeviceShaderExpectAssumeFeaturesKHR src) {
        VkPhysicalDeviceShaderExpectAssumeFeaturesKHR ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public static VkPhysicalDeviceShaderExpectAssumeFeaturesKHR[] clone(Arena arena, VkPhysicalDeviceShaderExpectAssumeFeaturesKHR[] src) {
        VkPhysicalDeviceShaderExpectAssumeFeaturesKHR[] ret = allocate(arena, src.length);

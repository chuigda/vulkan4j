...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2;
...
public record VkSubpassDependency2(MemorySegment segment) {
    ...
    public static final class Factory implements IFactory<VkSubpassDependency2> {
        @Override

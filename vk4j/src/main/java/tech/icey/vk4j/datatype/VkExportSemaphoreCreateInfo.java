...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkExportSemaphoreCreateInfo.html">VkExportSemaphoreCreateInfo</a>
public record VkExportSemaphoreCreateInfo(MemorySegment segment) implements IPointer {
    public VkExportSemaphoreCreateInfo(MemorySegment segment) {
    ...
    public static VkExportSemaphoreCreateInfo allocate(Arena arena) {
        return new VkExportSemaphoreCreateInfo(arena.allocate(LAYOUT));
    }
    ...
    public static VkExportSemaphoreCreateInfo[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkExportSemaphoreCreateInfo(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

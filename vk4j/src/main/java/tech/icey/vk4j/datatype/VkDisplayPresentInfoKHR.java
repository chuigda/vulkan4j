...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_DISPLAY_PRESENT_INFO_KHR;
...
public record VkDisplayPresentInfoKHR(MemorySegment segment) {
    ...
    public static final class Factory implements IFactory<VkDisplayPresentInfoKHR> {
        @Override

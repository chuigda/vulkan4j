...
import tech.icey.vk4j.bitmask.VkAndroidSurfaceCreateFlagsKHR;
...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_ANDROID_SURFACE_CREATE_INFO_KHR;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkAndroidSurfaceCreateInfoKHR.html">VkAndroidSurfaceCreateInfoKHR</a>
public record VkAndroidSurfaceCreateInfoKHR(MemorySegment segment) implements IPointer {
    ...
    public static VkAndroidSurfaceCreateInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkAndroidSurfaceCreateInfoKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }
    ...
    public static VkAndroidSurfaceCreateInfoKHR[] clone(Arena arena, VkAndroidSurfaceCreateInfoKHR[] src) {
        VkAndroidSurfaceCreateInfoKHR[] ret = allocate(arena, src.length);

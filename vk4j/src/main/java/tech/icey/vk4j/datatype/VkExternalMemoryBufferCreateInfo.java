...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkExternalMemoryBufferCreateInfo.html">VkExternalMemoryBufferCreateInfo</a>
public record VkExternalMemoryBufferCreateInfo(MemorySegment segment) implements IPointer {
    public VkExternalMemoryBufferCreateInfo(MemorySegment segment) {
    ...
    public static VkExternalMemoryBufferCreateInfo allocate(Arena arena) {
        return new VkExternalMemoryBufferCreateInfo(arena.allocate(LAYOUT));
    }
    ...
    public static VkExternalMemoryBufferCreateInfo[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkExternalMemoryBufferCreateInfo(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

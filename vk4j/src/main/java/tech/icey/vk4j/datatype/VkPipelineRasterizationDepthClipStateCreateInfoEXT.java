...
import tech.icey.vk4j.bitmask.VkPipelineRasterizationDepthClipStateCreateFlagsEXT;
...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_DEPTH_CLIP_STATE_CREATE_INFO_EXT;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPipelineRasterizationDepthClipStateCreateInfoEXT.html">VkPipelineRasterizationDepthClipStateCreateInfoEXT</a>
public record VkPipelineRasterizationDepthClipStateCreateInfoEXT(MemorySegment segment) implements IPointer {
    ...
    public static VkPipelineRasterizationDepthClipStateCreateInfoEXT allocate(Arena arena) {
        return new VkPipelineRasterizationDepthClipStateCreateInfoEXT(arena.allocate(LAYOUT));
    }

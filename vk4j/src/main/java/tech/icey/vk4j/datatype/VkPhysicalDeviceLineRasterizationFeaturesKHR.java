...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES_KHR;
...
public record VkPhysicalDeviceLineRasterizationFeaturesKHR(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceLineRasterizationFeaturesKHR clone(Arena arena, VkPhysicalDeviceLineRasterizationFeaturesKHR src) {
        VkPhysicalDeviceLineRasterizationFeaturesKHR ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public static VkPhysicalDeviceLineRasterizationFeaturesKHR[] clone(Arena arena, VkPhysicalDeviceLineRasterizationFeaturesKHR[] src) {
        VkPhysicalDeviceLineRasterizationFeaturesKHR[] ret = allocate(arena, src.length);

...
import tech.icey.vk4j.bitmask.VkMemoryAllocateFlags;
...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_FLAGS_INFO;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkMemoryAllocateFlagsInfo.html">VkMemoryAllocateFlagsInfo</a>
public record VkMemoryAllocateFlagsInfo(MemorySegment segment) implements IPointer {
    ...
    public static VkMemoryAllocateFlagsInfo[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkMemoryAllocateFlagsInfo(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

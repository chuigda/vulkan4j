...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_QCOM;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM.html">VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM</a>
public record VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM allocate(Arena arena) {
        return new VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM(arena.allocate(LAYOUT));
    }

    public static VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM[] allocate(Arena arena, int count) {
    ...
    public static VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM clone(Arena arena, VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM src) {
        VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public static VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM[] clone(Arena arena, VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM[] src) {
        VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM[] ret = allocate(arena, src.length);

...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_KHR;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.html">VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR</a>
public record VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

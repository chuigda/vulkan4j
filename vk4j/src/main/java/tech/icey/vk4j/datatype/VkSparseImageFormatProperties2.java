...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkSparseImageFormatProperties2.html">VkSparseImageFormatProperties2</a>
public record VkSparseImageFormatProperties2(MemorySegment segment) implements IPointer {
    ...
    public static VkSparseImageFormatProperties2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkSparseImageFormatProperties2(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

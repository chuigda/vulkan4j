...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_COPY_COMMAND_TRANSFORM_INFO_QCOM;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkCopyCommandTransformInfoQCOM.html">VkCopyCommandTransformInfoQCOM</a>
public record VkCopyCommandTransformInfoQCOM(MemorySegment segment) implements IPointer {
    public VkCopyCommandTransformInfoQCOM(MemorySegment segment) {
        this.segment = segment;
        this.sType(VK_STRUCTURE_TYPE_COPY_COMMAND_TRANSFORM_INFO_QCOM);
    }
    ...
    public static VkCopyCommandTransformInfoQCOM[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkCopyCommandTransformInfoQCOM(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }
    ...
    public static VkCopyCommandTransformInfoQCOM[] clone(Arena arena, VkCopyCommandTransformInfoQCOM[] src) {
        VkCopyCommandTransformInfoQCOM[] ret = allocate(arena, src.length);

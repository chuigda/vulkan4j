...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_MACOS_SURFACE_CREATE_INFO_MVK;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkMacOSSurfaceCreateInfoMVK.html">VkMacOSSurfaceCreateInfoMVK</a>
public record VkMacOSSurfaceCreateInfoMVK(MemorySegment segment) implements IPointer {
    ...
    public static VkMacOSSurfaceCreateInfoMVK allocate(Arena arena) {
        return new VkMacOSSurfaceCreateInfoMVK(arena.allocate(LAYOUT));
    }
    ...
    public static VkMacOSSurfaceCreateInfoMVK[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkMacOSSurfaceCreateInfoMVK(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

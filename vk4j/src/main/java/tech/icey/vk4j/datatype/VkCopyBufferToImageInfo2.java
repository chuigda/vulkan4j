...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_COPY_BUFFER_TO_IMAGE_INFO_2;
...
public record VkCopyBufferToImageInfo2(MemorySegment segment) {
    ...
    public static final class Factory implements IFactory<VkCopyBufferToImageInfo2> {
        @Override

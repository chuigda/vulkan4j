...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBPASS_MERGE_FEEDBACK_FEATURES_EXT;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT.html">VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT</a>
public record VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT allocate(Arena arena) {
        return new VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT(arena.allocate(LAYOUT));
    }
    ...
    public static VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

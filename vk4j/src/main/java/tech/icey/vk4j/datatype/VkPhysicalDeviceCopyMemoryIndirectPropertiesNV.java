...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_PROPERTIES_NV;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceCopyMemoryIndirectPropertiesNV.html">VkPhysicalDeviceCopyMemoryIndirectPropertiesNV</a>
public record VkPhysicalDeviceCopyMemoryIndirectPropertiesNV(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceCopyMemoryIndirectPropertiesNV allocate(Arena arena) {
        return new VkPhysicalDeviceCopyMemoryIndirectPropertiesNV(arena.allocate(LAYOUT));
    }
    ...
    public static VkPhysicalDeviceCopyMemoryIndirectPropertiesNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPhysicalDeviceCopyMemoryIndirectPropertiesNV(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

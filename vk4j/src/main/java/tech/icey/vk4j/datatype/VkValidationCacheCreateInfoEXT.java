...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_VALIDATION_CACHE_CREATE_INFO_EXT;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkValidationCacheCreateInfoEXT.html">VkValidationCacheCreateInfoEXT</a>
public record VkValidationCacheCreateInfoEXT(MemorySegment segment) implements IPointer {
    ...
    public static VkValidationCacheCreateInfoEXT allocate(Arena arena) {
        return new VkValidationCacheCreateInfoEXT(arena.allocate(LAYOUT));
    }

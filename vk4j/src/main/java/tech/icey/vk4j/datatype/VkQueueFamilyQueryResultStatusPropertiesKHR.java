...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_QUEUE_FAMILY_QUERY_RESULT_STATUS_PROPERTIES_KHR;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkQueueFamilyQueryResultStatusPropertiesKHR.html">VkQueueFamilyQueryResultStatusPropertiesKHR</a>
public record VkQueueFamilyQueryResultStatusPropertiesKHR(MemorySegment segment) implements IPointer {
    public VkQueueFamilyQueryResultStatusPropertiesKHR(MemorySegment segment) {
        this.segment = segment;
        this.sType(VK_STRUCTURE_TYPE_QUEUE_FAMILY_QUERY_RESULT_STATUS_PROPERTIES_KHR);
    }
    ...
    public static VkQueueFamilyQueryResultStatusPropertiesKHR allocate(Arena arena) {
        return new VkQueueFamilyQueryResultStatusPropertiesKHR(arena.allocate(LAYOUT));
    }
    ...
    public static VkQueueFamilyQueryResultStatusPropertiesKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkQueueFamilyQueryResultStatusPropertiesKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

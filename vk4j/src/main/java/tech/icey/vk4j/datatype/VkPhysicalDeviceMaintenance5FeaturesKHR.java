...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES_KHR;
...
public record VkPhysicalDeviceMaintenance5FeaturesKHR(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceMaintenance5FeaturesKHR clone(Arena arena, VkPhysicalDeviceMaintenance5FeaturesKHR src) {
        VkPhysicalDeviceMaintenance5FeaturesKHR ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public static VkPhysicalDeviceMaintenance5FeaturesKHR[] clone(Arena arena, VkPhysicalDeviceMaintenance5FeaturesKHR[] src) {
        VkPhysicalDeviceMaintenance5FeaturesKHR[] ret = allocate(arena, src.length);

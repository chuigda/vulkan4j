...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_DESCRIPTOR_BUFFER_BINDING_INFO_EXT;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkDescriptorBufferBindingInfoEXT.html">VkDescriptorBufferBindingInfoEXT</a>
public record VkDescriptorBufferBindingInfoEXT(MemorySegment segment) implements IPointer {
    ...
    public static VkDescriptorBufferBindingInfoEXT allocate(Arena arena) {
        return new VkDescriptorBufferBindingInfoEXT(arena.allocate(LAYOUT));
    }

...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_SUBRESOURCE_LAYOUT_2_KHR;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkSubresourceLayout2KHR.html">VkSubresourceLayout2KHR</a>
public record VkSubresourceLayout2KHR(MemorySegment segment) implements IPointer {
    ...
    public static VkSubresourceLayout2KHR allocate(Arena arena) {
        return new VkSubresourceLayout2KHR(arena.allocate(LAYOUT));
    }

    public static VkSubresourceLayout2KHR[] allocate(Arena arena, int count) {
    ...
    public static VkSubresourceLayout2KHR clone(Arena arena, VkSubresourceLayout2KHR src) {
        VkSubresourceLayout2KHR ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public static VkSubresourceLayout2KHR[] clone(Arena arena, VkSubresourceLayout2KHR[] src) {
        VkSubresourceLayout2KHR[] ret = allocate(arena, src.length);

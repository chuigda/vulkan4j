...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_MEMORY_WIN32_HANDLE_PROPERTIES_KHR;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkMemoryWin32HandlePropertiesKHR.html">VkMemoryWin32HandlePropertiesKHR</a>
public record VkMemoryWin32HandlePropertiesKHR(MemorySegment segment) implements IPointer {
    public VkMemoryWin32HandlePropertiesKHR(MemorySegment segment) {
    ...
    public static VkMemoryWin32HandlePropertiesKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkMemoryWin32HandlePropertiesKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }
    ...
    public static VkMemoryWin32HandlePropertiesKHR[] clone(Arena arena, VkMemoryWin32HandlePropertiesKHR[] src) {
        VkMemoryWin32HandlePropertiesKHR[] ret = allocate(arena, src.length);

...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_RENDER_PASS_STRIPE_INFO_ARM;
...
public record VkRenderPassStripeInfoARM(MemorySegment segment) {
    ...
    public static final class Factory implements IFactory<VkRenderPassStripeInfoARM> {
        @Override

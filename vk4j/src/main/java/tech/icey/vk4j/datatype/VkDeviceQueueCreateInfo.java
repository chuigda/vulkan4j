...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_DEVICE_QUEUE_CREATE_INFO;
...
public record VkDeviceQueueCreateInfo(MemorySegment segment) {
    ...
    public static final class Factory implements IFactory<VkDeviceQueueCreateInfo> {
        @Override

...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_SUBMIT_INFO_KHR;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPerformanceQuerySubmitInfoKHR.html">VkPerformanceQuerySubmitInfoKHR</a>
public record VkPerformanceQuerySubmitInfoKHR(MemorySegment segment) implements IPointer {
    ...
    public static VkPerformanceQuerySubmitInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPerformanceQuerySubmitInfoKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

...
public record VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT(MemorySegment segment) {
    ...
    public static VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT(segment.asSlice(i * LAYOUT.byteSize(), LAYOUT.byteSize()));
        }
        return ret;
    }
}

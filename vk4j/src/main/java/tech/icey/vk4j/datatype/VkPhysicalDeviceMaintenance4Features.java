...
import static tech.icey.vk4j.enumtype.VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES;
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceMaintenance4Features.html">VkPhysicalDeviceMaintenance4Features</a>
public record VkPhysicalDeviceMaintenance4Features(MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceMaintenance4Features allocate(Arena arena) {
        return new VkPhysicalDeviceMaintenance4Features(arena.allocate(LAYOUT));
    }
    ...
    public static VkPhysicalDeviceMaintenance4Features[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkPhysicalDeviceMaintenance4Features(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkAndroidHardwareBufferFormatPropertiesANDROID.html">VkAndroidHardwareBufferFormatPropertiesANDROID</a>
public record VkAndroidHardwareBufferFormatPropertiesANDROID(MemorySegment segment) implements IPointer {
    ...
    public static VkAndroidHardwareBufferFormatPropertiesANDROID[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ret[i] = new VkAndroidHardwareBufferFormatPropertiesANDROID(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

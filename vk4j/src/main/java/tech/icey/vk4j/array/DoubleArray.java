...
public final class DoubleArray extends DoublePtr {
    private final long size;

    @unsafe(alt = "DoubleArray::allocate")
    public DoubleArray(MemorySegment segment, long size) {
        super(segment);
        this.size = size;
    }
    ...
    public static DoubleArray ofPtr(DoublePtr ptr, long size) {
        MemorySegment transmuted = ptr.segment().reinterpret(size * ValueLayout.JAVA_DOUBLE.byteSize());

...
public final class DeviceCommands {
    ...
    public DeviceCommands(RawFunctionLoader loader, RawFunctionLoader instanceLoader) {
        ...
        HANDLE$vkDestroyDevice = RawFunctionLoader.link(SEGMENTvkDestroyDevice, DESCRIPTOR$vkDestroyDevice);
        SEGMENT$vkGetDeviceQueue = loader.apply("vkGetDeviceQueue");
        HANDLE$vkGetDeviceQueue = RawFunctionLoader.link(SEGMENTvkGetDeviceQueue, DESCRIPTOR$vkGetDeviceQueue);
        SEGMENT$vkQueueSubmit = loader.apply("vkQueueSubmit");
        HANDLE$vkQueueSubmit = RawFunctionLoader.link(SEGMENTvkQueueSubmit, DESCRIPTOR$vkQueueSubmit);
        SEGMENT$vkQueueWaitIdle = loader.apply("vkQueueWaitIdle");
        HANDLE$vkQueueWaitIdle = RawFunctionLoader.link(SEGMENTvkQueueWaitIdle, DESCRIPTOR$vkQueueWaitIdle);
        SEGMENT$vkDeviceWaitIdle = loader.apply("vkDeviceWaitIdle");
        HANDLE$vkDeviceWaitIdle = RawFunctionLoader.link(SEGMENTvkDeviceWaitIdle, DESCRIPTOR$vkDeviceWaitIdle);
        SEGMENT$vkAllocateMemory = loader.apply("vkAllocateMemory");
        HANDLE$vkAllocateMemory = RawFunctionLoader.link(SEGMENTvkAllocateMemory, DESCRIPTOR$vkAllocateMemory);
        SEGMENT$vkFreeMemory = loader.apply("vkFreeMemory");
        HANDLE$vkFreeMemory = RawFunctionLoader.link(SEGMENTvkFreeMemory, DESCRIPTOR$vkFreeMemory);
        SEGMENT$vkMapMemory = loader.apply("vkMapMemory");
        HANDLE$vkMapMemory = RawFunctionLoader.link(SEGMENTvkMapMemory, DESCRIPTOR$vkMapMemory);
        SEGMENT$vkUnmapMemory = loader.apply("vkUnmapMemory");
        HANDLE$vkUnmapMemory = RawFunctionLoader.link(SEGMENTvkUnmapMemory, DESCRIPTOR$vkUnmapMemory);
        SEGMENT$vkFlushMappedMemoryRanges = loader.apply("vkFlushMappedMemoryRanges");
        HANDLE$vkFlushMappedMemoryRanges = RawFunctionLoader.link(SEGMENTvkFlushMappedMemoryRanges, DESCRIPTOR$vkFlushMappedMemoryRanges);
        SEGMENT$vkInvalidateMappedMemoryRanges = loader.apply("vkInvalidateMappedMemoryRanges");
        HANDLE$vkInvalidateMappedMemoryRanges = RawFunctionLoader.link(SEGMENTvkInvalidateMappedMemoryRanges, DESCRIPTOR$vkInvalidateMappedMemoryRanges);
        SEGMENT$vkGetDeviceMemoryCommitment = loader.apply("vkGetDeviceMemoryCommitment");
        HANDLE$vkGetDeviceMemoryCommitment = RawFunctionLoader.link(SEGMENTvkGetDeviceMemoryCommitment, DESCRIPTOR$vkGetDeviceMemoryCommitment);
        SEGMENT$vkGetBufferMemoryRequirements = loader.apply("vkGetBufferMemoryRequirements");
        HANDLE$vkGetBufferMemoryRequirements = RawFunctionLoader.link(SEGMENTvkGetBufferMemoryRequirements, DESCRIPTOR$vkGetBufferMemoryRequirements);
        SEGMENT$vkBindBufferMemory = loader.apply("vkBindBufferMemory");
        HANDLE$vkBindBufferMemory = RawFunctionLoader.link(SEGMENTvkBindBufferMemory, DESCRIPTOR$vkBindBufferMemory);
        SEGMENT$vkGetImageMemoryRequirements = loader.apply("vkGetImageMemoryRequirements");
        HANDLE$vkGetImageMemoryRequirements = RawFunctionLoader.link(SEGMENTvkGetImageMemoryRequirements, DESCRIPTOR$vkGetImageMemoryRequirements);
        SEGMENT$vkBindImageMemory = loader.apply("vkBindImageMemory");
        HANDLE$vkBindImageMemory = RawFunctionLoader.link(SEGMENTvkBindImageMemory, DESCRIPTOR$vkBindImageMemory);
        SEGMENT$vkGetImageSparseMemoryRequirements = loader.apply("vkGetImageSparseMemoryRequirements");
        HANDLE$vkGetImageSparseMemoryRequirements = RawFunctionLoader.link(SEGMENTvkGetImageSparseMemoryRequirements, DESCRIPTOR$vkGetImageSparseMemoryRequirements);
        SEGMENT$vkQueueBindSparse = loader.apply("vkQueueBindSparse");
        HANDLE$vkQueueBindSparse = RawFunctionLoader.link(SEGMENTvkQueueBindSparse, DESCRIPTOR$vkQueueBindSparse);
        SEGMENT$vkCreateFence = loader.apply("vkCreateFence");
        HANDLE$vkCreateFence = RawFunctionLoader.link(SEGMENTvkCreateFence, DESCRIPTOR$vkCreateFence);
        SEGMENT$vkDestroyFence = loader.apply("vkDestroyFence");
        HANDLE$vkDestroyFence = RawFunctionLoader.link(SEGMENTvkDestroyFence, DESCRIPTOR$vkDestroyFence);
        SEGMENT$vkResetFences = loader.apply("vkResetFences");
        HANDLE$vkResetFences = RawFunctionLoader.link(SEGMENTvkResetFences, DESCRIPTOR$vkResetFences);
        SEGMENT$vkGetFenceStatus = loader.apply("vkGetFenceStatus");
        HANDLE$vkGetFenceStatus = RawFunctionLoader.link(SEGMENTvkGetFenceStatus, DESCRIPTOR$vkGetFenceStatus);
        SEGMENT$vkWaitForFences = loader.apply("vkWaitForFences");
        HANDLE$vkWaitForFences = RawFunctionLoader.link(SEGMENTvkWaitForFences, DESCRIPTOR$vkWaitForFences);
        SEGMENT$vkCreateSemaphore = loader.apply("vkCreateSemaphore");
        HANDLE$vkCreateSemaphore = RawFunctionLoader.link(SEGMENTvkCreateSemaphore, DESCRIPTOR$vkCreateSemaphore);
        SEGMENT$vkDestroySemaphore = loader.apply("vkDestroySemaphore");
        HANDLE$vkDestroySemaphore = RawFunctionLoader.link(SEGMENTvkDestroySemaphore, DESCRIPTOR$vkDestroySemaphore);
        SEGMENT$vkCreateEvent = loader.apply("vkCreateEvent");
        HANDLE$vkCreateEvent = RawFunctionLoader.link(SEGMENTvkCreateEvent, DESCRIPTOR$vkCreateEvent);
        SEGMENT$vkDestroyEvent = loader.apply("vkDestroyEvent");
        HANDLE$vkDestroyEvent = RawFunctionLoader.link(SEGMENTvkDestroyEvent, DESCRIPTOR$vkDestroyEvent);
        SEGMENT$vkGetEventStatus = loader.apply("vkGetEventStatus");
        HANDLE$vkGetEventStatus = RawFunctionLoader.link(SEGMENTvkGetEventStatus, DESCRIPTOR$vkGetEventStatus);
        SEGMENT$vkSetEvent = loader.apply("vkSetEvent");
        HANDLE$vkSetEvent = RawFunctionLoader.link(SEGMENTvkSetEvent, DESCRIPTOR$vkSetEvent);
        SEGMENT$vkResetEvent = loader.apply("vkResetEvent");
        HANDLE$vkResetEvent = RawFunctionLoader.link(SEGMENTvkResetEvent, DESCRIPTOR$vkResetEvent);
        SEGMENT$vkCreateQueryPool = loader.apply("vkCreateQueryPool");
        HANDLE$vkCreateQueryPool = RawFunctionLoader.link(SEGMENTvkCreateQueryPool, DESCRIPTOR$vkCreateQueryPool);
        SEGMENT$vkDestroyQueryPool = loader.apply("vkDestroyQueryPool");
        HANDLE$vkDestroyQueryPool = RawFunctionLoader.link(SEGMENTvkDestroyQueryPool, DESCRIPTOR$vkDestroyQueryPool);
        SEGMENT$vkGetQueryPoolResults = loader.apply("vkGetQueryPoolResults");
        HANDLE$vkGetQueryPoolResults = RawFunctionLoader.link(SEGMENTvkGetQueryPoolResults, DESCRIPTOR$vkGetQueryPoolResults);
        SEGMENT$vkResetQueryPool = loader.apply("vkResetQueryPool");
        HANDLE$vkResetQueryPool = RawFunctionLoader.link(SEGMENTvkResetQueryPool, DESCRIPTOR$vkResetQueryPool);
        SEGMENT$vkCreateBuffer = loader.apply("vkCreateBuffer");
        HANDLE$vkCreateBuffer = RawFunctionLoader.link(SEGMENTvkCreateBuffer, DESCRIPTOR$vkCreateBuffer);
        SEGMENT$vkDestroyBuffer = loader.apply("vkDestroyBuffer");
        HANDLE$vkDestroyBuffer = RawFunctionLoader.link(SEGMENTvkDestroyBuffer, DESCRIPTOR$vkDestroyBuffer);
        SEGMENT$vkCreateBufferView = loader.apply("vkCreateBufferView");
        HANDLE$vkCreateBufferView = RawFunctionLoader.link(SEGMENTvkCreateBufferView, DESCRIPTOR$vkCreateBufferView);
        SEGMENT$vkDestroyBufferView = loader.apply("vkDestroyBufferView");
        HANDLE$vkDestroyBufferView = RawFunctionLoader.link(SEGMENTvkDestroyBufferView, DESCRIPTOR$vkDestroyBufferView);
        SEGMENT$vkCreateImage = loader.apply("vkCreateImage");
        HANDLE$vkCreateImage = RawFunctionLoader.link(SEGMENTvkCreateImage, DESCRIPTOR$vkCreateImage);
        SEGMENT$vkDestroyImage = loader.apply("vkDestroyImage");
        HANDLE$vkDestroyImage = RawFunctionLoader.link(SEGMENTvkDestroyImage, DESCRIPTOR$vkDestroyImage);
        SEGMENT$vkGetImageSubresourceLayout = loader.apply("vkGetImageSubresourceLayout");
        HANDLE$vkGetImageSubresourceLayout = RawFunctionLoader.link(SEGMENTvkGetImageSubresourceLayout, DESCRIPTOR$vkGetImageSubresourceLayout);
        SEGMENT$vkCreateImageView = loader.apply("vkCreateImageView");
        HANDLE$vkCreateImageView = RawFunctionLoader.link(SEGMENTvkCreateImageView, DESCRIPTOR$vkCreateImageView);
        SEGMENT$vkDestroyImageView = loader.apply("vkDestroyImageView");
        HANDLE$vkDestroyImageView = RawFunctionLoader.link(SEGMENTvkDestroyImageView, DESCRIPTOR$vkDestroyImageView);
        SEGMENT$vkCreateShaderModule = loader.apply("vkCreateShaderModule");
        HANDLE$vkCreateShaderModule = RawFunctionLoader.link(SEGMENTvkCreateShaderModule, DESCRIPTOR$vkCreateShaderModule);
        SEGMENT$vkDestroyShaderModule = loader.apply("vkDestroyShaderModule");
        HANDLE$vkDestroyShaderModule = RawFunctionLoader.link(SEGMENTvkDestroyShaderModule, DESCRIPTOR$vkDestroyShaderModule);
        SEGMENT$vkCreatePipelineCache = loader.apply("vkCreatePipelineCache");
        HANDLE$vkCreatePipelineCache = RawFunctionLoader.link(SEGMENTvkCreatePipelineCache, DESCRIPTOR$vkCreatePipelineCache);
        SEGMENT$vkDestroyPipelineCache = loader.apply("vkDestroyPipelineCache");
        HANDLE$vkDestroyPipelineCache = RawFunctionLoader.link(SEGMENTvkDestroyPipelineCache, DESCRIPTOR$vkDestroyPipelineCache);
        SEGMENT$vkGetPipelineCacheData = loader.apply("vkGetPipelineCacheData");
        HANDLE$vkGetPipelineCacheData = RawFunctionLoader.link(SEGMENTvkGetPipelineCacheData, DESCRIPTOR$vkGetPipelineCacheData);
        SEGMENT$vkMergePipelineCaches = loader.apply("vkMergePipelineCaches");
        HANDLE$vkMergePipelineCaches = RawFunctionLoader.link(SEGMENTvkMergePipelineCaches, DESCRIPTOR$vkMergePipelineCaches);
        SEGMENT$vkCreatePipelineBinariesKHR = loader.apply("vkCreatePipelineBinariesKHR");
        HANDLE$vkCreatePipelineBinariesKHR = RawFunctionLoader.link(SEGMENTvkCreatePipelineBinariesKHR, DESCRIPTOR$vkCreatePipelineBinariesKHR);
        SEGMENT$vkDestroyPipelineBinaryKHR = loader.apply("vkDestroyPipelineBinaryKHR");
        HANDLE$vkDestroyPipelineBinaryKHR = RawFunctionLoader.link(SEGMENTvkDestroyPipelineBinaryKHR, DESCRIPTOR$vkDestroyPipelineBinaryKHR);
        SEGMENT$vkGetPipelineKeyKHR = loader.apply("vkGetPipelineKeyKHR");
        HANDLE$vkGetPipelineKeyKHR = RawFunctionLoader.link(SEGMENTvkGetPipelineKeyKHR, DESCRIPTOR$vkGetPipelineKeyKHR);
        SEGMENT$vkGetPipelineBinaryDataKHR = loader.apply("vkGetPipelineBinaryDataKHR");
        HANDLE$vkGetPipelineBinaryDataKHR = RawFunctionLoader.link(SEGMENTvkGetPipelineBinaryDataKHR, DESCRIPTOR$vkGetPipelineBinaryDataKHR);
        SEGMENT$vkReleaseCapturedPipelineDataKHR = loader.apply("vkReleaseCapturedPipelineDataKHR");
        HANDLE$vkReleaseCapturedPipelineDataKHR = RawFunctionLoader.link(SEGMENTvkReleaseCapturedPipelineDataKHR, DESCRIPTOR$vkReleaseCapturedPipelineDataKHR);
        SEGMENT$vkCreateGraphicsPipelines = loader.apply("vkCreateGraphicsPipelines");
        HANDLE$vkCreateGraphicsPipelines = RawFunctionLoader.link(SEGMENTvkCreateGraphicsPipelines, DESCRIPTOR$vkCreateGraphicsPipelines);
        SEGMENT$vkCreateComputePipelines = loader.apply("vkCreateComputePipelines");
        HANDLE$vkCreateComputePipelines = RawFunctionLoader.link(SEGMENTvkCreateComputePipelines, DESCRIPTOR$vkCreateComputePipelines);
        SEGMENT$vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI = loader.apply("vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI");
        HANDLE$vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI = RawFunctionLoader.link(SEGMENTvkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI, DESCRIPTOR$vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI);
        SEGMENT$vkDestroyPipeline = loader.apply("vkDestroyPipeline");
        HANDLE$vkDestroyPipeline = RawFunctionLoader.link(SEGMENTvkDestroyPipeline, DESCRIPTOR$vkDestroyPipeline);
        SEGMENT$vkCreatePipelineLayout = loader.apply("vkCreatePipelineLayout");
        HANDLE$vkCreatePipelineLayout = RawFunctionLoader.link(SEGMENTvkCreatePipelineLayout, DESCRIPTOR$vkCreatePipelineLayout);
        SEGMENT$vkDestroyPipelineLayout = loader.apply("vkDestroyPipelineLayout");
        HANDLE$vkDestroyPipelineLayout = RawFunctionLoader.link(SEGMENTvkDestroyPipelineLayout, DESCRIPTOR$vkDestroyPipelineLayout);
        SEGMENT$vkCreateSampler = loader.apply("vkCreateSampler");
        HANDLE$vkCreateSampler = RawFunctionLoader.link(SEGMENTvkCreateSampler, DESCRIPTOR$vkCreateSampler);
        SEGMENT$vkDestroySampler = loader.apply("vkDestroySampler");
        HANDLE$vkDestroySampler = RawFunctionLoader.link(SEGMENTvkDestroySampler, DESCRIPTOR$vkDestroySampler);
        SEGMENT$vkCreateDescriptorSetLayout = loader.apply("vkCreateDescriptorSetLayout");
        HANDLE$vkCreateDescriptorSetLayout = RawFunctionLoader.link(SEGMENTvkCreateDescriptorSetLayout, DESCRIPTOR$vkCreateDescriptorSetLayout);
        SEGMENT$vkDestroyDescriptorSetLayout = loader.apply("vkDestroyDescriptorSetLayout");
        HANDLE$vkDestroyDescriptorSetLayout = RawFunctionLoader.link(SEGMENTvkDestroyDescriptorSetLayout, DESCRIPTOR$vkDestroyDescriptorSetLayout);
        SEGMENT$vkCreateDescriptorPool = loader.apply("vkCreateDescriptorPool");
        HANDLE$vkCreateDescriptorPool = RawFunctionLoader.link(SEGMENTvkCreateDescriptorPool, DESCRIPTOR$vkCreateDescriptorPool);
        SEGMENT$vkDestroyDescriptorPool = loader.apply("vkDestroyDescriptorPool");
        HANDLE$vkDestroyDescriptorPool = RawFunctionLoader.link(SEGMENTvkDestroyDescriptorPool, DESCRIPTOR$vkDestroyDescriptorPool);
        SEGMENT$vkResetDescriptorPool = loader.apply("vkResetDescriptorPool");
        HANDLE$vkResetDescriptorPool = RawFunctionLoader.link(SEGMENTvkResetDescriptorPool, DESCRIPTOR$vkResetDescriptorPool);
        SEGMENT$vkAllocateDescriptorSets = loader.apply("vkAllocateDescriptorSets");
        HANDLE$vkAllocateDescriptorSets = RawFunctionLoader.link(SEGMENTvkAllocateDescriptorSets, DESCRIPTOR$vkAllocateDescriptorSets);
        SEGMENT$vkFreeDescriptorSets = loader.apply("vkFreeDescriptorSets");
        HANDLE$vkFreeDescriptorSets = RawFunctionLoader.link(SEGMENTvkFreeDescriptorSets, DESCRIPTOR$vkFreeDescriptorSets);
        SEGMENT$vkUpdateDescriptorSets = loader.apply("vkUpdateDescriptorSets");
        HANDLE$vkUpdateDescriptorSets = RawFunctionLoader.link(SEGMENTvkUpdateDescriptorSets, DESCRIPTOR$vkUpdateDescriptorSets);
        SEGMENT$vkCreateFramebuffer = loader.apply("vkCreateFramebuffer");
        HANDLE$vkCreateFramebuffer = RawFunctionLoader.link(SEGMENTvkCreateFramebuffer, DESCRIPTOR$vkCreateFramebuffer);
        SEGMENT$vkDestroyFramebuffer = loader.apply("vkDestroyFramebuffer");
        HANDLE$vkDestroyFramebuffer = RawFunctionLoader.link(SEGMENTvkDestroyFramebuffer, DESCRIPTOR$vkDestroyFramebuffer);
        SEGMENT$vkCreateRenderPass = loader.apply("vkCreateRenderPass");
        HANDLE$vkCreateRenderPass = RawFunctionLoader.link(SEGMENTvkCreateRenderPass, DESCRIPTOR$vkCreateRenderPass);
        SEGMENT$vkDestroyRenderPass = loader.apply("vkDestroyRenderPass");
        HANDLE$vkDestroyRenderPass = RawFunctionLoader.link(SEGMENTvkDestroyRenderPass, DESCRIPTOR$vkDestroyRenderPass);
        SEGMENT$vkGetRenderAreaGranularity = loader.apply("vkGetRenderAreaGranularity");
        HANDLE$vkGetRenderAreaGranularity = RawFunctionLoader.link(SEGMENTvkGetRenderAreaGranularity, DESCRIPTOR$vkGetRenderAreaGranularity);
        SEGMENT$vkGetRenderingAreaGranularityKHR = loader.apply("vkGetRenderingAreaGranularityKHR");
        HANDLE$vkGetRenderingAreaGranularityKHR = RawFunctionLoader.link(SEGMENTvkGetRenderingAreaGranularityKHR, DESCRIPTOR$vkGetRenderingAreaGranularityKHR);
        SEGMENT$vkCreateCommandPool = loader.apply("vkCreateCommandPool");
        HANDLE$vkCreateCommandPool = RawFunctionLoader.link(SEGMENTvkCreateCommandPool, DESCRIPTOR$vkCreateCommandPool);
        SEGMENT$vkDestroyCommandPool = loader.apply("vkDestroyCommandPool");
        HANDLE$vkDestroyCommandPool = RawFunctionLoader.link(SEGMENTvkDestroyCommandPool, DESCRIPTOR$vkDestroyCommandPool);
        SEGMENT$vkResetCommandPool = loader.apply("vkResetCommandPool");
        HANDLE$vkResetCommandPool = RawFunctionLoader.link(SEGMENTvkResetCommandPool, DESCRIPTOR$vkResetCommandPool);
        SEGMENT$vkAllocateCommandBuffers = loader.apply("vkAllocateCommandBuffers");
        HANDLE$vkAllocateCommandBuffers = RawFunctionLoader.link(SEGMENTvkAllocateCommandBuffers, DESCRIPTOR$vkAllocateCommandBuffers);
        SEGMENT$vkFreeCommandBuffers = loader.apply("vkFreeCommandBuffers");
        HANDLE$vkFreeCommandBuffers = RawFunctionLoader.link(SEGMENTvkFreeCommandBuffers, DESCRIPTOR$vkFreeCommandBuffers);
        SEGMENT$vkBeginCommandBuffer = loader.apply("vkBeginCommandBuffer");
        HANDLE$vkBeginCommandBuffer = RawFunctionLoader.link(SEGMENTvkBeginCommandBuffer, DESCRIPTOR$vkBeginCommandBuffer);
        SEGMENT$vkEndCommandBuffer = loader.apply("vkEndCommandBuffer");
        HANDLE$vkEndCommandBuffer = RawFunctionLoader.link(SEGMENTvkEndCommandBuffer, DESCRIPTOR$vkEndCommandBuffer);
        SEGMENT$vkResetCommandBuffer = loader.apply("vkResetCommandBuffer");
        HANDLE$vkResetCommandBuffer = RawFunctionLoader.link(SEGMENTvkResetCommandBuffer, DESCRIPTOR$vkResetCommandBuffer);
        SEGMENT$vkCmdBindPipeline = loader.apply("vkCmdBindPipeline");
        HANDLE$vkCmdBindPipeline = RawFunctionLoader.link(SEGMENTvkCmdBindPipeline, DESCRIPTOR$vkCmdBindPipeline);
        SEGMENT$vkCmdSetAttachmentFeedbackLoopEnableEXT = loader.apply("vkCmdSetAttachmentFeedbackLoopEnableEXT");
        HANDLE$vkCmdSetAttachmentFeedbackLoopEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetAttachmentFeedbackLoopEnableEXT, DESCRIPTOR$vkCmdSetAttachmentFeedbackLoopEnableEXT);
        SEGMENT$vkCmdSetViewport = loader.apply("vkCmdSetViewport");
        HANDLE$vkCmdSetViewport = RawFunctionLoader.link(SEGMENTvkCmdSetViewport, DESCRIPTOR$vkCmdSetViewport);
        SEGMENT$vkCmdSetScissor = loader.apply("vkCmdSetScissor");
        HANDLE$vkCmdSetScissor = RawFunctionLoader.link(SEGMENTvkCmdSetScissor, DESCRIPTOR$vkCmdSetScissor);
        SEGMENT$vkCmdSetLineWidth = loader.apply("vkCmdSetLineWidth");
        HANDLE$vkCmdSetLineWidth = RawFunctionLoader.link(SEGMENTvkCmdSetLineWidth, DESCRIPTOR$vkCmdSetLineWidth);
        SEGMENT$vkCmdSetDepthBias = loader.apply("vkCmdSetDepthBias");
        HANDLE$vkCmdSetDepthBias = RawFunctionLoader.link(SEGMENTvkCmdSetDepthBias, DESCRIPTOR$vkCmdSetDepthBias);
        SEGMENT$vkCmdSetBlendConstants = loader.apply("vkCmdSetBlendConstants");
        HANDLE$vkCmdSetBlendConstants = RawFunctionLoader.link(SEGMENTvkCmdSetBlendConstants, DESCRIPTOR$vkCmdSetBlendConstants);
        SEGMENT$vkCmdSetDepthBounds = loader.apply("vkCmdSetDepthBounds");
        HANDLE$vkCmdSetDepthBounds = RawFunctionLoader.link(SEGMENTvkCmdSetDepthBounds, DESCRIPTOR$vkCmdSetDepthBounds);
        SEGMENT$vkCmdSetStencilCompareMask = loader.apply("vkCmdSetStencilCompareMask");
        HANDLE$vkCmdSetStencilCompareMask = RawFunctionLoader.link(SEGMENTvkCmdSetStencilCompareMask, DESCRIPTOR$vkCmdSetStencilCompareMask);
        SEGMENT$vkCmdSetStencilWriteMask = loader.apply("vkCmdSetStencilWriteMask");
        HANDLE$vkCmdSetStencilWriteMask = RawFunctionLoader.link(SEGMENTvkCmdSetStencilWriteMask, DESCRIPTOR$vkCmdSetStencilWriteMask);
        SEGMENT$vkCmdSetStencilReference = loader.apply("vkCmdSetStencilReference");
        HANDLE$vkCmdSetStencilReference = RawFunctionLoader.link(SEGMENTvkCmdSetStencilReference, DESCRIPTOR$vkCmdSetStencilReference);
        SEGMENT$vkCmdBindDescriptorSets = loader.apply("vkCmdBindDescriptorSets");
        HANDLE$vkCmdBindDescriptorSets = RawFunctionLoader.link(SEGMENTvkCmdBindDescriptorSets, DESCRIPTOR$vkCmdBindDescriptorSets);
        SEGMENT$vkCmdBindIndexBuffer = loader.apply("vkCmdBindIndexBuffer");
        HANDLE$vkCmdBindIndexBuffer = RawFunctionLoader.link(SEGMENTvkCmdBindIndexBuffer, DESCRIPTOR$vkCmdBindIndexBuffer);
        SEGMENT$vkCmdBindVertexBuffers = loader.apply("vkCmdBindVertexBuffers");
        HANDLE$vkCmdBindVertexBuffers = RawFunctionLoader.link(SEGMENTvkCmdBindVertexBuffers, DESCRIPTOR$vkCmdBindVertexBuffers);
        SEGMENT$vkCmdDraw = loader.apply("vkCmdDraw");
        HANDLE$vkCmdDraw = RawFunctionLoader.link(SEGMENTvkCmdDraw, DESCRIPTOR$vkCmdDraw);
        SEGMENT$vkCmdDrawIndexed = loader.apply("vkCmdDrawIndexed");
        HANDLE$vkCmdDrawIndexed = RawFunctionLoader.link(SEGMENTvkCmdDrawIndexed, DESCRIPTOR$vkCmdDrawIndexed);
        SEGMENT$vkCmdDrawMultiEXT = loader.apply("vkCmdDrawMultiEXT");
        HANDLE$vkCmdDrawMultiEXT = RawFunctionLoader.link(SEGMENTvkCmdDrawMultiEXT, DESCRIPTOR$vkCmdDrawMultiEXT);
        SEGMENT$vkCmdDrawMultiIndexedEXT = loader.apply("vkCmdDrawMultiIndexedEXT");
        HANDLE$vkCmdDrawMultiIndexedEXT = RawFunctionLoader.link(SEGMENTvkCmdDrawMultiIndexedEXT, DESCRIPTOR$vkCmdDrawMultiIndexedEXT);
        SEGMENT$vkCmdDrawIndirect = loader.apply("vkCmdDrawIndirect");
        HANDLE$vkCmdDrawIndirect = RawFunctionLoader.link(SEGMENTvkCmdDrawIndirect, DESCRIPTOR$vkCmdDrawIndirect);
        SEGMENT$vkCmdDrawIndexedIndirect = loader.apply("vkCmdDrawIndexedIndirect");
        HANDLE$vkCmdDrawIndexedIndirect = RawFunctionLoader.link(SEGMENTvkCmdDrawIndexedIndirect, DESCRIPTOR$vkCmdDrawIndexedIndirect);
        SEGMENT$vkCmdDispatch = loader.apply("vkCmdDispatch");
        HANDLE$vkCmdDispatch = RawFunctionLoader.link(SEGMENTvkCmdDispatch, DESCRIPTOR$vkCmdDispatch);
        SEGMENT$vkCmdDispatchIndirect = loader.apply("vkCmdDispatchIndirect");
        HANDLE$vkCmdDispatchIndirect = RawFunctionLoader.link(SEGMENTvkCmdDispatchIndirect, DESCRIPTOR$vkCmdDispatchIndirect);
        SEGMENT$vkCmdSubpassShadingHUAWEI = loader.apply("vkCmdSubpassShadingHUAWEI");
        HANDLE$vkCmdSubpassShadingHUAWEI = RawFunctionLoader.link(SEGMENTvkCmdSubpassShadingHUAWEI, DESCRIPTOR$vkCmdSubpassShadingHUAWEI);
        SEGMENT$vkCmdDrawClusterHUAWEI = loader.apply("vkCmdDrawClusterHUAWEI");
        HANDLE$vkCmdDrawClusterHUAWEI = RawFunctionLoader.link(SEGMENTvkCmdDrawClusterHUAWEI, DESCRIPTOR$vkCmdDrawClusterHUAWEI);
        SEGMENT$vkCmdDrawClusterIndirectHUAWEI = loader.apply("vkCmdDrawClusterIndirectHUAWEI");
        HANDLE$vkCmdDrawClusterIndirectHUAWEI = RawFunctionLoader.link(SEGMENTvkCmdDrawClusterIndirectHUAWEI, DESCRIPTOR$vkCmdDrawClusterIndirectHUAWEI);
        SEGMENT$vkCmdUpdatePipelineIndirectBufferNV = loader.apply("vkCmdUpdatePipelineIndirectBufferNV");
        HANDLE$vkCmdUpdatePipelineIndirectBufferNV = RawFunctionLoader.link(SEGMENTvkCmdUpdatePipelineIndirectBufferNV, DESCRIPTOR$vkCmdUpdatePipelineIndirectBufferNV);
        SEGMENT$vkCmdCopyBuffer = loader.apply("vkCmdCopyBuffer");
        HANDLE$vkCmdCopyBuffer = RawFunctionLoader.link(SEGMENTvkCmdCopyBuffer, DESCRIPTOR$vkCmdCopyBuffer);
        SEGMENT$vkCmdCopyImage = loader.apply("vkCmdCopyImage");
        HANDLE$vkCmdCopyImage = RawFunctionLoader.link(SEGMENTvkCmdCopyImage, DESCRIPTOR$vkCmdCopyImage);
        SEGMENT$vkCmdBlitImage = loader.apply("vkCmdBlitImage");
        HANDLE$vkCmdBlitImage = RawFunctionLoader.link(SEGMENTvkCmdBlitImage, DESCRIPTOR$vkCmdBlitImage);
        SEGMENT$vkCmdCopyBufferToImage = loader.apply("vkCmdCopyBufferToImage");
        HANDLE$vkCmdCopyBufferToImage = RawFunctionLoader.link(SEGMENTvkCmdCopyBufferToImage, DESCRIPTOR$vkCmdCopyBufferToImage);
        SEGMENT$vkCmdCopyImageToBuffer = loader.apply("vkCmdCopyImageToBuffer");
        HANDLE$vkCmdCopyImageToBuffer = RawFunctionLoader.link(SEGMENTvkCmdCopyImageToBuffer, DESCRIPTOR$vkCmdCopyImageToBuffer);
        SEGMENT$vkCmdCopyMemoryIndirectNV = loader.apply("vkCmdCopyMemoryIndirectNV");
        HANDLE$vkCmdCopyMemoryIndirectNV = RawFunctionLoader.link(SEGMENTvkCmdCopyMemoryIndirectNV, DESCRIPTOR$vkCmdCopyMemoryIndirectNV);
        SEGMENT$vkCmdCopyMemoryToImageIndirectNV = loader.apply("vkCmdCopyMemoryToImageIndirectNV");
        HANDLE$vkCmdCopyMemoryToImageIndirectNV = RawFunctionLoader.link(SEGMENTvkCmdCopyMemoryToImageIndirectNV, DESCRIPTOR$vkCmdCopyMemoryToImageIndirectNV);
        SEGMENT$vkCmdUpdateBuffer = loader.apply("vkCmdUpdateBuffer");
        HANDLE$vkCmdUpdateBuffer = RawFunctionLoader.link(SEGMENTvkCmdUpdateBuffer, DESCRIPTOR$vkCmdUpdateBuffer);
        SEGMENT$vkCmdFillBuffer = loader.apply("vkCmdFillBuffer");
        HANDLE$vkCmdFillBuffer = RawFunctionLoader.link(SEGMENTvkCmdFillBuffer, DESCRIPTOR$vkCmdFillBuffer);
        SEGMENT$vkCmdClearColorImage = loader.apply("vkCmdClearColorImage");
        HANDLE$vkCmdClearColorImage = RawFunctionLoader.link(SEGMENTvkCmdClearColorImage, DESCRIPTOR$vkCmdClearColorImage);
        SEGMENT$vkCmdClearDepthStencilImage = loader.apply("vkCmdClearDepthStencilImage");
        HANDLE$vkCmdClearDepthStencilImage = RawFunctionLoader.link(SEGMENTvkCmdClearDepthStencilImage, DESCRIPTOR$vkCmdClearDepthStencilImage);
        SEGMENT$vkCmdClearAttachments = loader.apply("vkCmdClearAttachments");
        HANDLE$vkCmdClearAttachments = RawFunctionLoader.link(SEGMENTvkCmdClearAttachments, DESCRIPTOR$vkCmdClearAttachments);
        SEGMENT$vkCmdResolveImage = loader.apply("vkCmdResolveImage");
        HANDLE$vkCmdResolveImage = RawFunctionLoader.link(SEGMENTvkCmdResolveImage, DESCRIPTOR$vkCmdResolveImage);
        SEGMENT$vkCmdSetEvent = loader.apply("vkCmdSetEvent");
        HANDLE$vkCmdSetEvent = RawFunctionLoader.link(SEGMENTvkCmdSetEvent, DESCRIPTOR$vkCmdSetEvent);
        SEGMENT$vkCmdResetEvent = loader.apply("vkCmdResetEvent");
        HANDLE$vkCmdResetEvent = RawFunctionLoader.link(SEGMENTvkCmdResetEvent, DESCRIPTOR$vkCmdResetEvent);
        SEGMENT$vkCmdWaitEvents = loader.apply("vkCmdWaitEvents");
        HANDLE$vkCmdWaitEvents = RawFunctionLoader.link(SEGMENTvkCmdWaitEvents, DESCRIPTOR$vkCmdWaitEvents);
        SEGMENT$vkCmdPipelineBarrier = loader.apply("vkCmdPipelineBarrier");
        HANDLE$vkCmdPipelineBarrier = RawFunctionLoader.link(SEGMENTvkCmdPipelineBarrier, DESCRIPTOR$vkCmdPipelineBarrier);
        SEGMENT$vkCmdBeginQuery = loader.apply("vkCmdBeginQuery");
        HANDLE$vkCmdBeginQuery = RawFunctionLoader.link(SEGMENTvkCmdBeginQuery, DESCRIPTOR$vkCmdBeginQuery);
        SEGMENT$vkCmdEndQuery = loader.apply("vkCmdEndQuery");
        HANDLE$vkCmdEndQuery = RawFunctionLoader.link(SEGMENTvkCmdEndQuery, DESCRIPTOR$vkCmdEndQuery);
        SEGMENT$vkCmdBeginConditionalRenderingEXT = loader.apply("vkCmdBeginConditionalRenderingEXT");
        HANDLE$vkCmdBeginConditionalRenderingEXT = RawFunctionLoader.link(SEGMENTvkCmdBeginConditionalRenderingEXT, DESCRIPTOR$vkCmdBeginConditionalRenderingEXT);
        SEGMENT$vkCmdEndConditionalRenderingEXT = loader.apply("vkCmdEndConditionalRenderingEXT");
        HANDLE$vkCmdEndConditionalRenderingEXT = RawFunctionLoader.link(SEGMENTvkCmdEndConditionalRenderingEXT, DESCRIPTOR$vkCmdEndConditionalRenderingEXT);
        SEGMENT$vkCmdResetQueryPool = loader.apply("vkCmdResetQueryPool");
        HANDLE$vkCmdResetQueryPool = RawFunctionLoader.link(SEGMENTvkCmdResetQueryPool, DESCRIPTOR$vkCmdResetQueryPool);
        SEGMENT$vkCmdWriteTimestamp = loader.apply("vkCmdWriteTimestamp");
        HANDLE$vkCmdWriteTimestamp = RawFunctionLoader.link(SEGMENTvkCmdWriteTimestamp, DESCRIPTOR$vkCmdWriteTimestamp);
        SEGMENT$vkCmdCopyQueryPoolResults = loader.apply("vkCmdCopyQueryPoolResults");
        HANDLE$vkCmdCopyQueryPoolResults = RawFunctionLoader.link(SEGMENTvkCmdCopyQueryPoolResults, DESCRIPTOR$vkCmdCopyQueryPoolResults);
        SEGMENT$vkCmdPushConstants = loader.apply("vkCmdPushConstants");
        HANDLE$vkCmdPushConstants = RawFunctionLoader.link(SEGMENTvkCmdPushConstants, DESCRIPTOR$vkCmdPushConstants);
        SEGMENT$vkCmdBeginRenderPass = loader.apply("vkCmdBeginRenderPass");
        HANDLE$vkCmdBeginRenderPass = RawFunctionLoader.link(SEGMENTvkCmdBeginRenderPass, DESCRIPTOR$vkCmdBeginRenderPass);
        SEGMENT$vkCmdNextSubpass = loader.apply("vkCmdNextSubpass");
        HANDLE$vkCmdNextSubpass = RawFunctionLoader.link(SEGMENTvkCmdNextSubpass, DESCRIPTOR$vkCmdNextSubpass);
        SEGMENT$vkCmdEndRenderPass = loader.apply("vkCmdEndRenderPass");
        HANDLE$vkCmdEndRenderPass = RawFunctionLoader.link(SEGMENTvkCmdEndRenderPass, DESCRIPTOR$vkCmdEndRenderPass);
        SEGMENT$vkCmdExecuteCommands = loader.apply("vkCmdExecuteCommands");
        HANDLE$vkCmdExecuteCommands = RawFunctionLoader.link(SEGMENTvkCmdExecuteCommands, DESCRIPTOR$vkCmdExecuteCommands);
        SEGMENT$vkCreateSharedSwapchainsKHR = loader.apply("vkCreateSharedSwapchainsKHR");
        HANDLE$vkCreateSharedSwapchainsKHR = RawFunctionLoader.link(SEGMENTvkCreateSharedSwapchainsKHR, DESCRIPTOR$vkCreateSharedSwapchainsKHR);
        SEGMENT$vkCreateSwapchainKHR = loader.apply("vkCreateSwapchainKHR");
        HANDLE$vkCreateSwapchainKHR = RawFunctionLoader.link(SEGMENTvkCreateSwapchainKHR, DESCRIPTOR$vkCreateSwapchainKHR);
        SEGMENT$vkDestroySwapchainKHR = loader.apply("vkDestroySwapchainKHR");
        HANDLE$vkDestroySwapchainKHR = RawFunctionLoader.link(SEGMENTvkDestroySwapchainKHR, DESCRIPTOR$vkDestroySwapchainKHR);
        SEGMENT$vkGetSwapchainImagesKHR = loader.apply("vkGetSwapchainImagesKHR");
        HANDLE$vkGetSwapchainImagesKHR = RawFunctionLoader.link(SEGMENTvkGetSwapchainImagesKHR, DESCRIPTOR$vkGetSwapchainImagesKHR);
        SEGMENT$vkAcquireNextImageKHR = loader.apply("vkAcquireNextImageKHR");
        HANDLE$vkAcquireNextImageKHR = RawFunctionLoader.link(SEGMENTvkAcquireNextImageKHR, DESCRIPTOR$vkAcquireNextImageKHR);
        SEGMENT$vkQueuePresentKHR = loader.apply("vkQueuePresentKHR");
        HANDLE$vkQueuePresentKHR = RawFunctionLoader.link(SEGMENTvkQueuePresentKHR, DESCRIPTOR$vkQueuePresentKHR);
        SEGMENT$vkDebugMarkerSetObjectNameEXT = loader.apply("vkDebugMarkerSetObjectNameEXT");
        HANDLE$vkDebugMarkerSetObjectNameEXT = RawFunctionLoader.link(SEGMENTvkDebugMarkerSetObjectNameEXT, DESCRIPTOR$vkDebugMarkerSetObjectNameEXT);
        SEGMENT$vkDebugMarkerSetObjectTagEXT = loader.apply("vkDebugMarkerSetObjectTagEXT");
        HANDLE$vkDebugMarkerSetObjectTagEXT = RawFunctionLoader.link(SEGMENTvkDebugMarkerSetObjectTagEXT, DESCRIPTOR$vkDebugMarkerSetObjectTagEXT);
        SEGMENT$vkCmdDebugMarkerBeginEXT = loader.apply("vkCmdDebugMarkerBeginEXT");
        HANDLE$vkCmdDebugMarkerBeginEXT = RawFunctionLoader.link(SEGMENTvkCmdDebugMarkerBeginEXT, DESCRIPTOR$vkCmdDebugMarkerBeginEXT);
        SEGMENT$vkCmdDebugMarkerEndEXT = loader.apply("vkCmdDebugMarkerEndEXT");
        HANDLE$vkCmdDebugMarkerEndEXT = RawFunctionLoader.link(SEGMENTvkCmdDebugMarkerEndEXT, DESCRIPTOR$vkCmdDebugMarkerEndEXT);
        SEGMENT$vkCmdDebugMarkerInsertEXT = loader.apply("vkCmdDebugMarkerInsertEXT");
        HANDLE$vkCmdDebugMarkerInsertEXT = RawFunctionLoader.link(SEGMENTvkCmdDebugMarkerInsertEXT, DESCRIPTOR$vkCmdDebugMarkerInsertEXT);
        SEGMENT$vkGetMemoryWin32HandleNV = loader.apply("vkGetMemoryWin32HandleNV");
        HANDLE$vkGetMemoryWin32HandleNV = RawFunctionLoader.link(SEGMENTvkGetMemoryWin32HandleNV, DESCRIPTOR$vkGetMemoryWin32HandleNV);
        SEGMENT$vkCmdExecuteGeneratedCommandsNV = loader.apply("vkCmdExecuteGeneratedCommandsNV");
        HANDLE$vkCmdExecuteGeneratedCommandsNV = RawFunctionLoader.link(SEGMENTvkCmdExecuteGeneratedCommandsNV, DESCRIPTOR$vkCmdExecuteGeneratedCommandsNV);
        SEGMENT$vkCmdPreprocessGeneratedCommandsNV = loader.apply("vkCmdPreprocessGeneratedCommandsNV");
        HANDLE$vkCmdPreprocessGeneratedCommandsNV = RawFunctionLoader.link(SEGMENTvkCmdPreprocessGeneratedCommandsNV, DESCRIPTOR$vkCmdPreprocessGeneratedCommandsNV);
        SEGMENT$vkCmdBindPipelineShaderGroupNV = loader.apply("vkCmdBindPipelineShaderGroupNV");
        HANDLE$vkCmdBindPipelineShaderGroupNV = RawFunctionLoader.link(SEGMENTvkCmdBindPipelineShaderGroupNV, DESCRIPTOR$vkCmdBindPipelineShaderGroupNV);
        SEGMENT$vkGetGeneratedCommandsMemoryRequirementsNV = loader.apply("vkGetGeneratedCommandsMemoryRequirementsNV");
        HANDLE$vkGetGeneratedCommandsMemoryRequirementsNV = RawFunctionLoader.link(SEGMENTvkGetGeneratedCommandsMemoryRequirementsNV, DESCRIPTOR$vkGetGeneratedCommandsMemoryRequirementsNV);
        SEGMENT$vkCreateIndirectCommandsLayoutNV = loader.apply("vkCreateIndirectCommandsLayoutNV");
        HANDLE$vkCreateIndirectCommandsLayoutNV = RawFunctionLoader.link(SEGMENTvkCreateIndirectCommandsLayoutNV, DESCRIPTOR$vkCreateIndirectCommandsLayoutNV);
        SEGMENT$vkDestroyIndirectCommandsLayoutNV = loader.apply("vkDestroyIndirectCommandsLayoutNV");
        HANDLE$vkDestroyIndirectCommandsLayoutNV = RawFunctionLoader.link(SEGMENTvkDestroyIndirectCommandsLayoutNV, DESCRIPTOR$vkDestroyIndirectCommandsLayoutNV);
        SEGMENT$vkCmdPushDescriptorSetKHR = loader.apply("vkCmdPushDescriptorSetKHR");
        HANDLE$vkCmdPushDescriptorSetKHR = RawFunctionLoader.link(SEGMENTvkCmdPushDescriptorSetKHR, DESCRIPTOR$vkCmdPushDescriptorSetKHR);
        SEGMENT$vkTrimCommandPool = loader.apply("vkTrimCommandPool");
        HANDLE$vkTrimCommandPool = RawFunctionLoader.link(SEGMENTvkTrimCommandPool, DESCRIPTOR$vkTrimCommandPool);
        SEGMENT$vkGetMemoryWin32HandleKHR = loader.apply("vkGetMemoryWin32HandleKHR");
        HANDLE$vkGetMemoryWin32HandleKHR = RawFunctionLoader.link(SEGMENTvkGetMemoryWin32HandleKHR, DESCRIPTOR$vkGetMemoryWin32HandleKHR);
        SEGMENT$vkGetMemoryWin32HandlePropertiesKHR = loader.apply("vkGetMemoryWin32HandlePropertiesKHR");
        HANDLE$vkGetMemoryWin32HandlePropertiesKHR = RawFunctionLoader.link(SEGMENTvkGetMemoryWin32HandlePropertiesKHR, DESCRIPTOR$vkGetMemoryWin32HandlePropertiesKHR);
        SEGMENT$vkGetMemoryFdKHR = loader.apply("vkGetMemoryFdKHR");
        HANDLE$vkGetMemoryFdKHR = RawFunctionLoader.link(SEGMENTvkGetMemoryFdKHR, DESCRIPTOR$vkGetMemoryFdKHR);
        SEGMENT$vkGetMemoryFdPropertiesKHR = loader.apply("vkGetMemoryFdPropertiesKHR");
        HANDLE$vkGetMemoryFdPropertiesKHR = RawFunctionLoader.link(SEGMENTvkGetMemoryFdPropertiesKHR, DESCRIPTOR$vkGetMemoryFdPropertiesKHR);
        SEGMENT$vkGetMemoryZirconHandleFUCHSIA = loader.apply("vkGetMemoryZirconHandleFUCHSIA");
        HANDLE$vkGetMemoryZirconHandleFUCHSIA = RawFunctionLoader.link(SEGMENTvkGetMemoryZirconHandleFUCHSIA, DESCRIPTOR$vkGetMemoryZirconHandleFUCHSIA);
        SEGMENT$vkGetMemoryZirconHandlePropertiesFUCHSIA = loader.apply("vkGetMemoryZirconHandlePropertiesFUCHSIA");
        HANDLE$vkGetMemoryZirconHandlePropertiesFUCHSIA = RawFunctionLoader.link(SEGMENTvkGetMemoryZirconHandlePropertiesFUCHSIA, DESCRIPTOR$vkGetMemoryZirconHandlePropertiesFUCHSIA);
        SEGMENT$vkGetMemoryRemoteAddressNV = loader.apply("vkGetMemoryRemoteAddressNV");
        HANDLE$vkGetMemoryRemoteAddressNV = RawFunctionLoader.link(SEGMENTvkGetMemoryRemoteAddressNV, DESCRIPTOR$vkGetMemoryRemoteAddressNV);
        SEGMENT$vkGetMemorySciBufNV = loader.apply("vkGetMemorySciBufNV");
        HANDLE$vkGetMemorySciBufNV = RawFunctionLoader.link(SEGMENTvkGetMemorySciBufNV, DESCRIPTOR$vkGetMemorySciBufNV);
        ...
        HANDLE$vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceExternalMemorySciBufPropertiesNV, DESCRIPTOR$vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV);
        SEGMENT$vkGetPhysicalDeviceSciBufAttributesNV = loader.apply("vkGetPhysicalDeviceSciBufAttributesNV");
        HANDLE$vkGetPhysicalDeviceSciBufAttributesNV = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSciBufAttributesNV, DESCRIPTOR$vkGetPhysicalDeviceSciBufAttributesNV);
        SEGMENT$vkGetSemaphoreWin32HandleKHR = loader.apply("vkGetSemaphoreWin32HandleKHR");
        HANDLE$vkGetSemaphoreWin32HandleKHR = RawFunctionLoader.link(SEGMENTvkGetSemaphoreWin32HandleKHR, DESCRIPTOR$vkGetSemaphoreWin32HandleKHR);
        SEGMENT$vkImportSemaphoreWin32HandleKHR = loader.apply("vkImportSemaphoreWin32HandleKHR");
        HANDLE$vkImportSemaphoreWin32HandleKHR = RawFunctionLoader.link(SEGMENTvkImportSemaphoreWin32HandleKHR, DESCRIPTOR$vkImportSemaphoreWin32HandleKHR);
        SEGMENT$vkGetSemaphoreFdKHR = loader.apply("vkGetSemaphoreFdKHR");
        HANDLE$vkGetSemaphoreFdKHR = RawFunctionLoader.link(SEGMENTvkGetSemaphoreFdKHR, DESCRIPTOR$vkGetSemaphoreFdKHR);
        SEGMENT$vkImportSemaphoreFdKHR = loader.apply("vkImportSemaphoreFdKHR");
        HANDLE$vkImportSemaphoreFdKHR = RawFunctionLoader.link(SEGMENTvkImportSemaphoreFdKHR, DESCRIPTOR$vkImportSemaphoreFdKHR);
        SEGMENT$vkGetSemaphoreZirconHandleFUCHSIA = loader.apply("vkGetSemaphoreZirconHandleFUCHSIA");
        HANDLE$vkGetSemaphoreZirconHandleFUCHSIA = RawFunctionLoader.link(SEGMENTvkGetSemaphoreZirconHandleFUCHSIA, DESCRIPTOR$vkGetSemaphoreZirconHandleFUCHSIA);
        SEGMENT$vkImportSemaphoreZirconHandleFUCHSIA = loader.apply("vkImportSemaphoreZirconHandleFUCHSIA");
        HANDLE$vkImportSemaphoreZirconHandleFUCHSIA = RawFunctionLoader.link(SEGMENTvkImportSemaphoreZirconHandleFUCHSIA, DESCRIPTOR$vkImportSemaphoreZirconHandleFUCHSIA);
        SEGMENT$vkGetFenceWin32HandleKHR = loader.apply("vkGetFenceWin32HandleKHR");
        HANDLE$vkGetFenceWin32HandleKHR = RawFunctionLoader.link(SEGMENTvkGetFenceWin32HandleKHR, DESCRIPTOR$vkGetFenceWin32HandleKHR);
        SEGMENT$vkImportFenceWin32HandleKHR = loader.apply("vkImportFenceWin32HandleKHR");
        HANDLE$vkImportFenceWin32HandleKHR = RawFunctionLoader.link(SEGMENTvkImportFenceWin32HandleKHR, DESCRIPTOR$vkImportFenceWin32HandleKHR);
        SEGMENT$vkGetFenceFdKHR = loader.apply("vkGetFenceFdKHR");
        HANDLE$vkGetFenceFdKHR = RawFunctionLoader.link(SEGMENTvkGetFenceFdKHR, DESCRIPTOR$vkGetFenceFdKHR);
        SEGMENT$vkImportFenceFdKHR = loader.apply("vkImportFenceFdKHR");
        HANDLE$vkImportFenceFdKHR = RawFunctionLoader.link(SEGMENTvkImportFenceFdKHR, DESCRIPTOR$vkImportFenceFdKHR);
        SEGMENT$vkGetFenceSciSyncFenceNV = loader.apply("vkGetFenceSciSyncFenceNV");
        HANDLE$vkGetFenceSciSyncFenceNV = RawFunctionLoader.link(SEGMENTvkGetFenceSciSyncFenceNV, DESCRIPTOR$vkGetFenceSciSyncFenceNV);
        SEGMENT$vkGetFenceSciSyncObjNV = loader.apply("vkGetFenceSciSyncObjNV");
        HANDLE$vkGetFenceSciSyncObjNV = RawFunctionLoader.link(SEGMENTvkGetFenceSciSyncObjNV, DESCRIPTOR$vkGetFenceSciSyncObjNV);
        SEGMENT$vkImportFenceSciSyncFenceNV = loader.apply("vkImportFenceSciSyncFenceNV");
        HANDLE$vkImportFenceSciSyncFenceNV = RawFunctionLoader.link(SEGMENTvkImportFenceSciSyncFenceNV, DESCRIPTOR$vkImportFenceSciSyncFenceNV);
        SEGMENT$vkImportFenceSciSyncObjNV = loader.apply("vkImportFenceSciSyncObjNV");
        HANDLE$vkImportFenceSciSyncObjNV = RawFunctionLoader.link(SEGMENTvkImportFenceSciSyncObjNV, DESCRIPTOR$vkImportFenceSciSyncObjNV);
        SEGMENT$vkGetSemaphoreSciSyncObjNV = loader.apply("vkGetSemaphoreSciSyncObjNV");
        HANDLE$vkGetSemaphoreSciSyncObjNV = RawFunctionLoader.link(SEGMENTvkGetSemaphoreSciSyncObjNV, DESCRIPTOR$vkGetSemaphoreSciSyncObjNV);
        SEGMENT$vkImportSemaphoreSciSyncObjNV = loader.apply("vkImportSemaphoreSciSyncObjNV");
        HANDLE$vkImportSemaphoreSciSyncObjNV = RawFunctionLoader.link(SEGMENTvkImportSemaphoreSciSyncObjNV, DESCRIPTOR$vkImportSemaphoreSciSyncObjNV);
        SEGMENT$vkGetPhysicalDeviceSciSyncAttributesNV = loader.apply("vkGetPhysicalDeviceSciSyncAttributesNV");
        HANDLE$vkGetPhysicalDeviceSciSyncAttributesNV = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSciSyncAttributesNV, DESCRIPTOR$vkGetPhysicalDeviceSciSyncAttributesNV);
        SEGMENT$vkCreateSemaphoreSciSyncPoolNV = loader.apply("vkCreateSemaphoreSciSyncPoolNV");
        HANDLE$vkCreateSemaphoreSciSyncPoolNV = RawFunctionLoader.link(SEGMENTvkCreateSemaphoreSciSyncPoolNV, DESCRIPTOR$vkCreateSemaphoreSciSyncPoolNV);
        SEGMENT$vkDestroySemaphoreSciSyncPoolNV = loader.apply("vkDestroySemaphoreSciSyncPoolNV");
        HANDLE$vkDestroySemaphoreSciSyncPoolNV = RawFunctionLoader.link(SEGMENTvkDestroySemaphoreSciSyncPoolNV, DESCRIPTOR$vkDestroySemaphoreSciSyncPoolNV);
        SEGMENT$vkAcquireWinrtDisplayNV = loader.apply("vkAcquireWinrtDisplayNV");
        HANDLE$vkAcquireWinrtDisplayNV = RawFunctionLoader.link(SEGMENTvkAcquireWinrtDisplayNV, DESCRIPTOR$vkAcquireWinrtDisplayNV);
        SEGMENT$vkGetWinrtDisplayNV = loader.apply("vkGetWinrtDisplayNV");
        HANDLE$vkGetWinrtDisplayNV = RawFunctionLoader.link(SEGMENTvkGetWinrtDisplayNV, DESCRIPTOR$vkGetWinrtDisplayNV);
        SEGMENT$vkDisplayPowerControlEXT = loader.apply("vkDisplayPowerControlEXT");
        HANDLE$vkDisplayPowerControlEXT = RawFunctionLoader.link(SEGMENTvkDisplayPowerControlEXT, DESCRIPTOR$vkDisplayPowerControlEXT);
        SEGMENT$vkRegisterDeviceEventEXT = loader.apply("vkRegisterDeviceEventEXT");
        HANDLE$vkRegisterDeviceEventEXT = RawFunctionLoader.link(SEGMENTvkRegisterDeviceEventEXT, DESCRIPTOR$vkRegisterDeviceEventEXT);
        SEGMENT$vkRegisterDisplayEventEXT = loader.apply("vkRegisterDisplayEventEXT");
        HANDLE$vkRegisterDisplayEventEXT = RawFunctionLoader.link(SEGMENTvkRegisterDisplayEventEXT, DESCRIPTOR$vkRegisterDisplayEventEXT);
        SEGMENT$vkGetSwapchainCounterEXT = loader.apply("vkGetSwapchainCounterEXT");
        HANDLE$vkGetSwapchainCounterEXT = RawFunctionLoader.link(SEGMENTvkGetSwapchainCounterEXT, DESCRIPTOR$vkGetSwapchainCounterEXT);
        SEGMENT$vkGetDeviceGroupPeerMemoryFeatures = loader.apply("vkGetDeviceGroupPeerMemoryFeatures");
        HANDLE$vkGetDeviceGroupPeerMemoryFeatures = RawFunctionLoader.link(SEGMENTvkGetDeviceGroupPeerMemoryFeatures, DESCRIPTOR$vkGetDeviceGroupPeerMemoryFeatures);
        SEGMENT$vkBindBufferMemory2 = loader.apply("vkBindBufferMemory2");
        HANDLE$vkBindBufferMemory2 = RawFunctionLoader.link(SEGMENTvkBindBufferMemory2, DESCRIPTOR$vkBindBufferMemory2);
        SEGMENT$vkBindImageMemory2 = loader.apply("vkBindImageMemory2");
        HANDLE$vkBindImageMemory2 = RawFunctionLoader.link(SEGMENTvkBindImageMemory2, DESCRIPTOR$vkBindImageMemory2);
        SEGMENT$vkCmdSetDeviceMask = loader.apply("vkCmdSetDeviceMask");
        HANDLE$vkCmdSetDeviceMask = RawFunctionLoader.link(SEGMENTvkCmdSetDeviceMask, DESCRIPTOR$vkCmdSetDeviceMask);
        SEGMENT$vkGetDeviceGroupPresentCapabilitiesKHR = loader.apply("vkGetDeviceGroupPresentCapabilitiesKHR");
        HANDLE$vkGetDeviceGroupPresentCapabilitiesKHR = RawFunctionLoader.link(SEGMENTvkGetDeviceGroupPresentCapabilitiesKHR, DESCRIPTOR$vkGetDeviceGroupPresentCapabilitiesKHR);
        SEGMENT$vkGetDeviceGroupSurfacePresentModesKHR = loader.apply("vkGetDeviceGroupSurfacePresentModesKHR");
        HANDLE$vkGetDeviceGroupSurfacePresentModesKHR = RawFunctionLoader.link(SEGMENTvkGetDeviceGroupSurfacePresentModesKHR, DESCRIPTOR$vkGetDeviceGroupSurfacePresentModesKHR);
        SEGMENT$vkAcquireNextImage2KHR = loader.apply("vkAcquireNextImage2KHR");
        HANDLE$vkAcquireNextImage2KHR = RawFunctionLoader.link(SEGMENTvkAcquireNextImage2KHR, DESCRIPTOR$vkAcquireNextImage2KHR);
        SEGMENT$vkCmdDispatchBase = loader.apply("vkCmdDispatchBase");
        HANDLE$vkCmdDispatchBase = RawFunctionLoader.link(SEGMENTvkCmdDispatchBase, DESCRIPTOR$vkCmdDispatchBase);
        SEGMENT$vkGetPhysicalDevicePresentRectanglesKHR = loader.apply("vkGetPhysicalDevicePresentRectanglesKHR");
        HANDLE$vkGetPhysicalDevicePresentRectanglesKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDevicePresentRectanglesKHR, DESCRIPTOR$vkGetPhysicalDevicePresentRectanglesKHR);
        SEGMENT$vkCreateDescriptorUpdateTemplate = loader.apply("vkCreateDescriptorUpdateTemplate");
        HANDLE$vkCreateDescriptorUpdateTemplate = RawFunctionLoader.link(SEGMENTvkCreateDescriptorUpdateTemplate, DESCRIPTOR$vkCreateDescriptorUpdateTemplate);
        SEGMENT$vkDestroyDescriptorUpdateTemplate = loader.apply("vkDestroyDescriptorUpdateTemplate");
        HANDLE$vkDestroyDescriptorUpdateTemplate = RawFunctionLoader.link(SEGMENTvkDestroyDescriptorUpdateTemplate, DESCRIPTOR$vkDestroyDescriptorUpdateTemplate);
        SEGMENT$vkUpdateDescriptorSetWithTemplate = loader.apply("vkUpdateDescriptorSetWithTemplate");
        HANDLE$vkUpdateDescriptorSetWithTemplate = RawFunctionLoader.link(SEGMENTvkUpdateDescriptorSetWithTemplate, DESCRIPTOR$vkUpdateDescriptorSetWithTemplate);
        SEGMENT$vkCmdPushDescriptorSetWithTemplateKHR = loader.apply("vkCmdPushDescriptorSetWithTemplateKHR");
        HANDLE$vkCmdPushDescriptorSetWithTemplateKHR = RawFunctionLoader.link(SEGMENTvkCmdPushDescriptorSetWithTemplateKHR, DESCRIPTOR$vkCmdPushDescriptorSetWithTemplateKHR);
        SEGMENT$vkSetHdrMetadataEXT = loader.apply("vkSetHdrMetadataEXT");
        HANDLE$vkSetHdrMetadataEXT = RawFunctionLoader.link(SEGMENTvkSetHdrMetadataEXT, DESCRIPTOR$vkSetHdrMetadataEXT);
        SEGMENT$vkGetSwapchainStatusKHR = loader.apply("vkGetSwapchainStatusKHR");
        HANDLE$vkGetSwapchainStatusKHR = RawFunctionLoader.link(SEGMENTvkGetSwapchainStatusKHR, DESCRIPTOR$vkGetSwapchainStatusKHR);
        SEGMENT$vkGetRefreshCycleDurationGOOGLE = loader.apply("vkGetRefreshCycleDurationGOOGLE");
        HANDLE$vkGetRefreshCycleDurationGOOGLE = RawFunctionLoader.link(SEGMENTvkGetRefreshCycleDurationGOOGLE, DESCRIPTOR$vkGetRefreshCycleDurationGOOGLE);
        SEGMENT$vkGetPastPresentationTimingGOOGLE = loader.apply("vkGetPastPresentationTimingGOOGLE");
        HANDLE$vkGetPastPresentationTimingGOOGLE = RawFunctionLoader.link(SEGMENTvkGetPastPresentationTimingGOOGLE, DESCRIPTOR$vkGetPastPresentationTimingGOOGLE);
        SEGMENT$vkCmdSetViewportWScalingNV = loader.apply("vkCmdSetViewportWScalingNV");
        HANDLE$vkCmdSetViewportWScalingNV = RawFunctionLoader.link(SEGMENTvkCmdSetViewportWScalingNV, DESCRIPTOR$vkCmdSetViewportWScalingNV);
        SEGMENT$vkCmdSetDiscardRectangleEXT = loader.apply("vkCmdSetDiscardRectangleEXT");
        HANDLE$vkCmdSetDiscardRectangleEXT = RawFunctionLoader.link(SEGMENTvkCmdSetDiscardRectangleEXT, DESCRIPTOR$vkCmdSetDiscardRectangleEXT);
        SEGMENT$vkCmdSetDiscardRectangleEnableEXT = loader.apply("vkCmdSetDiscardRectangleEnableEXT");
        HANDLE$vkCmdSetDiscardRectangleEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetDiscardRectangleEnableEXT, DESCRIPTOR$vkCmdSetDiscardRectangleEnableEXT);
        SEGMENT$vkCmdSetDiscardRectangleModeEXT = loader.apply("vkCmdSetDiscardRectangleModeEXT");
        HANDLE$vkCmdSetDiscardRectangleModeEXT = RawFunctionLoader.link(SEGMENTvkCmdSetDiscardRectangleModeEXT, DESCRIPTOR$vkCmdSetDiscardRectangleModeEXT);
        SEGMENT$vkCmdSetSampleLocationsEXT = loader.apply("vkCmdSetSampleLocationsEXT");
        HANDLE$vkCmdSetSampleLocationsEXT = RawFunctionLoader.link(SEGMENTvkCmdSetSampleLocationsEXT, DESCRIPTOR$vkCmdSetSampleLocationsEXT);
        SEGMENT$vkGetPhysicalDeviceMultisamplePropertiesEXT = loader.apply("vkGetPhysicalDeviceMultisamplePropertiesEXT");
        HANDLE$vkGetPhysicalDeviceMultisamplePropertiesEXT = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceMultisamplePropertiesEXT, DESCRIPTOR$vkGetPhysicalDeviceMultisamplePropertiesEXT);
        SEGMENT$vkGetBufferMemoryRequirements2 = loader.apply("vkGetBufferMemoryRequirements2");
        HANDLE$vkGetBufferMemoryRequirements2 = RawFunctionLoader.link(SEGMENTvkGetBufferMemoryRequirements2, DESCRIPTOR$vkGetBufferMemoryRequirements2);
        SEGMENT$vkGetImageMemoryRequirements2 = loader.apply("vkGetImageMemoryRequirements2");
        HANDLE$vkGetImageMemoryRequirements2 = RawFunctionLoader.link(SEGMENTvkGetImageMemoryRequirements2, DESCRIPTOR$vkGetImageMemoryRequirements2);
        SEGMENT$vkGetImageSparseMemoryRequirements2 = loader.apply("vkGetImageSparseMemoryRequirements2");
        HANDLE$vkGetImageSparseMemoryRequirements2 = RawFunctionLoader.link(SEGMENTvkGetImageSparseMemoryRequirements2, DESCRIPTOR$vkGetImageSparseMemoryRequirements2);
        SEGMENT$vkGetDeviceBufferMemoryRequirements = loader.apply("vkGetDeviceBufferMemoryRequirements");
        HANDLE$vkGetDeviceBufferMemoryRequirements = RawFunctionLoader.link(SEGMENTvkGetDeviceBufferMemoryRequirements, DESCRIPTOR$vkGetDeviceBufferMemoryRequirements);
        SEGMENT$vkGetDeviceImageMemoryRequirements = loader.apply("vkGetDeviceImageMemoryRequirements");
        HANDLE$vkGetDeviceImageMemoryRequirements = RawFunctionLoader.link(SEGMENTvkGetDeviceImageMemoryRequirements, DESCRIPTOR$vkGetDeviceImageMemoryRequirements);
        SEGMENT$vkGetDeviceImageSparseMemoryRequirements = loader.apply("vkGetDeviceImageSparseMemoryRequirements");
        HANDLE$vkGetDeviceImageSparseMemoryRequirements = RawFunctionLoader.link(SEGMENTvkGetDeviceImageSparseMemoryRequirements, DESCRIPTOR$vkGetDeviceImageSparseMemoryRequirements);
        SEGMENT$vkCreateSamplerYcbcrConversion = loader.apply("vkCreateSamplerYcbcrConversion");
        HANDLE$vkCreateSamplerYcbcrConversion = RawFunctionLoader.link(SEGMENTvkCreateSamplerYcbcrConversion, DESCRIPTOR$vkCreateSamplerYcbcrConversion);
        SEGMENT$vkDestroySamplerYcbcrConversion = loader.apply("vkDestroySamplerYcbcrConversion");
        HANDLE$vkDestroySamplerYcbcrConversion = RawFunctionLoader.link(SEGMENTvkDestroySamplerYcbcrConversion, DESCRIPTOR$vkDestroySamplerYcbcrConversion);
        SEGMENT$vkGetDeviceQueue2 = loader.apply("vkGetDeviceQueue2");
        HANDLE$vkGetDeviceQueue2 = RawFunctionLoader.link(SEGMENTvkGetDeviceQueue2, DESCRIPTOR$vkGetDeviceQueue2);
        SEGMENT$vkCreateValidationCacheEXT = loader.apply("vkCreateValidationCacheEXT");
        HANDLE$vkCreateValidationCacheEXT = RawFunctionLoader.link(SEGMENTvkCreateValidationCacheEXT, DESCRIPTOR$vkCreateValidationCacheEXT);
        SEGMENT$vkDestroyValidationCacheEXT = loader.apply("vkDestroyValidationCacheEXT");
        HANDLE$vkDestroyValidationCacheEXT = RawFunctionLoader.link(SEGMENTvkDestroyValidationCacheEXT, DESCRIPTOR$vkDestroyValidationCacheEXT);
        SEGMENT$vkGetValidationCacheDataEXT = loader.apply("vkGetValidationCacheDataEXT");
        HANDLE$vkGetValidationCacheDataEXT = RawFunctionLoader.link(SEGMENTvkGetValidationCacheDataEXT, DESCRIPTOR$vkGetValidationCacheDataEXT);
        SEGMENT$vkMergeValidationCachesEXT = loader.apply("vkMergeValidationCachesEXT");
        HANDLE$vkMergeValidationCachesEXT = RawFunctionLoader.link(SEGMENTvkMergeValidationCachesEXT, DESCRIPTOR$vkMergeValidationCachesEXT);
        SEGMENT$vkGetDescriptorSetLayoutSupport = loader.apply("vkGetDescriptorSetLayoutSupport");
        HANDLE$vkGetDescriptorSetLayoutSupport = RawFunctionLoader.link(SEGMENTvkGetDescriptorSetLayoutSupport, DESCRIPTOR$vkGetDescriptorSetLayoutSupport);
        SEGMENT$vkGetShaderInfoAMD = loader.apply("vkGetShaderInfoAMD");
        HANDLE$vkGetShaderInfoAMD = RawFunctionLoader.link(SEGMENTvkGetShaderInfoAMD, DESCRIPTOR$vkGetShaderInfoAMD);
        SEGMENT$vkSetLocalDimmingAMD = loader.apply("vkSetLocalDimmingAMD");
        HANDLE$vkSetLocalDimmingAMD = RawFunctionLoader.link(SEGMENTvkSetLocalDimmingAMD, DESCRIPTOR$vkSetLocalDimmingAMD);
        SEGMENT$vkGetPhysicalDeviceCalibrateableTimeDomainsKHR = loader.apply("vkGetPhysicalDeviceCalibrateableTimeDomainsKHR");
        HANDLE$vkGetPhysicalDeviceCalibrateableTimeDomainsKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceCalibrateableTimeDomainsKHR, DESCRIPTOR$vkGetPhysicalDeviceCalibrateableTimeDomainsKHR);
        SEGMENT$vkGetCalibratedTimestampsKHR = loader.apply("vkGetCalibratedTimestampsKHR");
        HANDLE$vkGetCalibratedTimestampsKHR = RawFunctionLoader.link(SEGMENTvkGetCalibratedTimestampsKHR, DESCRIPTOR$vkGetCalibratedTimestampsKHR);
        SEGMENT$vkGetMemoryHostPointerPropertiesEXT = loader.apply("vkGetMemoryHostPointerPropertiesEXT");
        HANDLE$vkGetMemoryHostPointerPropertiesEXT = RawFunctionLoader.link(SEGMENTvkGetMemoryHostPointerPropertiesEXT, DESCRIPTOR$vkGetMemoryHostPointerPropertiesEXT);
        SEGMENT$vkCmdWriteBufferMarkerAMD = loader.apply("vkCmdWriteBufferMarkerAMD");
        HANDLE$vkCmdWriteBufferMarkerAMD = RawFunctionLoader.link(SEGMENTvkCmdWriteBufferMarkerAMD, DESCRIPTOR$vkCmdWriteBufferMarkerAMD);
        SEGMENT$vkCreateRenderPass2 = loader.apply("vkCreateRenderPass2");
        HANDLE$vkCreateRenderPass2 = RawFunctionLoader.link(SEGMENTvkCreateRenderPass2, DESCRIPTOR$vkCreateRenderPass2);
        SEGMENT$vkCmdBeginRenderPass2 = loader.apply("vkCmdBeginRenderPass2");
        HANDLE$vkCmdBeginRenderPass2 = RawFunctionLoader.link(SEGMENTvkCmdBeginRenderPass2, DESCRIPTOR$vkCmdBeginRenderPass2);
        SEGMENT$vkCmdNextSubpass2 = loader.apply("vkCmdNextSubpass2");
        HANDLE$vkCmdNextSubpass2 = RawFunctionLoader.link(SEGMENTvkCmdNextSubpass2, DESCRIPTOR$vkCmdNextSubpass2);
        SEGMENT$vkCmdEndRenderPass2 = loader.apply("vkCmdEndRenderPass2");
        HANDLE$vkCmdEndRenderPass2 = RawFunctionLoader.link(SEGMENTvkCmdEndRenderPass2, DESCRIPTOR$vkCmdEndRenderPass2);
        SEGMENT$vkGetSemaphoreCounterValue = loader.apply("vkGetSemaphoreCounterValue");
        HANDLE$vkGetSemaphoreCounterValue = RawFunctionLoader.link(SEGMENTvkGetSemaphoreCounterValue, DESCRIPTOR$vkGetSemaphoreCounterValue);
        SEGMENT$vkWaitSemaphores = loader.apply("vkWaitSemaphores");
        HANDLE$vkWaitSemaphores = RawFunctionLoader.link(SEGMENTvkWaitSemaphores, DESCRIPTOR$vkWaitSemaphores);
        SEGMENT$vkSignalSemaphore = loader.apply("vkSignalSemaphore");
        HANDLE$vkSignalSemaphore = RawFunctionLoader.link(SEGMENTvkSignalSemaphore, DESCRIPTOR$vkSignalSemaphore);
        SEGMENT$vkGetAndroidHardwareBufferPropertiesANDROID = loader.apply("vkGetAndroidHardwareBufferPropertiesANDROID");
        HANDLE$vkGetAndroidHardwareBufferPropertiesANDROID = RawFunctionLoader.link(SEGMENTvkGetAndroidHardwareBufferPropertiesANDROID, DESCRIPTOR$vkGetAndroidHardwareBufferPropertiesANDROID);
        SEGMENT$vkGetMemoryAndroidHardwareBufferANDROID = loader.apply("vkGetMemoryAndroidHardwareBufferANDROID");
        HANDLE$vkGetMemoryAndroidHardwareBufferANDROID = RawFunctionLoader.link(SEGMENTvkGetMemoryAndroidHardwareBufferANDROID, DESCRIPTOR$vkGetMemoryAndroidHardwareBufferANDROID);
        SEGMENT$vkCmdDrawIndirectCount = loader.apply("vkCmdDrawIndirectCount");
        HANDLE$vkCmdDrawIndirectCount = RawFunctionLoader.link(SEGMENTvkCmdDrawIndirectCount, DESCRIPTOR$vkCmdDrawIndirectCount);
        SEGMENT$vkCmdDrawIndexedIndirectCount = loader.apply("vkCmdDrawIndexedIndirectCount");
        HANDLE$vkCmdDrawIndexedIndirectCount = RawFunctionLoader.link(SEGMENTvkCmdDrawIndexedIndirectCount, DESCRIPTOR$vkCmdDrawIndexedIndirectCount);
        SEGMENT$vkCmdSetCheckpointNV = loader.apply("vkCmdSetCheckpointNV");
        HANDLE$vkCmdSetCheckpointNV = RawFunctionLoader.link(SEGMENTvkCmdSetCheckpointNV, DESCRIPTOR$vkCmdSetCheckpointNV);
        SEGMENT$vkGetQueueCheckpointDataNV = loader.apply("vkGetQueueCheckpointDataNV");
        HANDLE$vkGetQueueCheckpointDataNV = RawFunctionLoader.link(SEGMENTvkGetQueueCheckpointDataNV, DESCRIPTOR$vkGetQueueCheckpointDataNV);
        SEGMENT$vkCmdBindTransformFeedbackBuffersEXT = loader.apply("vkCmdBindTransformFeedbackBuffersEXT");
        HANDLE$vkCmdBindTransformFeedbackBuffersEXT = RawFunctionLoader.link(SEGMENTvkCmdBindTransformFeedbackBuffersEXT, DESCRIPTOR$vkCmdBindTransformFeedbackBuffersEXT);
        SEGMENT$vkCmdBeginTransformFeedbackEXT = loader.apply("vkCmdBeginTransformFeedbackEXT");
        HANDLE$vkCmdBeginTransformFeedbackEXT = RawFunctionLoader.link(SEGMENTvkCmdBeginTransformFeedbackEXT, DESCRIPTOR$vkCmdBeginTransformFeedbackEXT);
        SEGMENT$vkCmdEndTransformFeedbackEXT = loader.apply("vkCmdEndTransformFeedbackEXT");
        HANDLE$vkCmdEndTransformFeedbackEXT = RawFunctionLoader.link(SEGMENTvkCmdEndTransformFeedbackEXT, DESCRIPTOR$vkCmdEndTransformFeedbackEXT);
        SEGMENT$vkCmdBeginQueryIndexedEXT = loader.apply("vkCmdBeginQueryIndexedEXT");
        HANDLE$vkCmdBeginQueryIndexedEXT = RawFunctionLoader.link(SEGMENTvkCmdBeginQueryIndexedEXT, DESCRIPTOR$vkCmdBeginQueryIndexedEXT);
        SEGMENT$vkCmdEndQueryIndexedEXT = loader.apply("vkCmdEndQueryIndexedEXT");
        HANDLE$vkCmdEndQueryIndexedEXT = RawFunctionLoader.link(SEGMENTvkCmdEndQueryIndexedEXT, DESCRIPTOR$vkCmdEndQueryIndexedEXT);
        SEGMENT$vkCmdDrawIndirectByteCountEXT = loader.apply("vkCmdDrawIndirectByteCountEXT");
        HANDLE$vkCmdDrawIndirectByteCountEXT = RawFunctionLoader.link(SEGMENTvkCmdDrawIndirectByteCountEXT, DESCRIPTOR$vkCmdDrawIndirectByteCountEXT);
        SEGMENT$vkCmdSetExclusiveScissorNV = loader.apply("vkCmdSetExclusiveScissorNV");
        HANDLE$vkCmdSetExclusiveScissorNV = RawFunctionLoader.link(SEGMENTvkCmdSetExclusiveScissorNV, DESCRIPTOR$vkCmdSetExclusiveScissorNV);
        SEGMENT$vkCmdSetExclusiveScissorEnableNV = loader.apply("vkCmdSetExclusiveScissorEnableNV");
        HANDLE$vkCmdSetExclusiveScissorEnableNV = RawFunctionLoader.link(SEGMENTvkCmdSetExclusiveScissorEnableNV, DESCRIPTOR$vkCmdSetExclusiveScissorEnableNV);
        SEGMENT$vkCmdBindShadingRateImageNV = loader.apply("vkCmdBindShadingRateImageNV");
        HANDLE$vkCmdBindShadingRateImageNV = RawFunctionLoader.link(SEGMENTvkCmdBindShadingRateImageNV, DESCRIPTOR$vkCmdBindShadingRateImageNV);
        SEGMENT$vkCmdSetViewportShadingRatePaletteNV = loader.apply("vkCmdSetViewportShadingRatePaletteNV");
        HANDLE$vkCmdSetViewportShadingRatePaletteNV = RawFunctionLoader.link(SEGMENTvkCmdSetViewportShadingRatePaletteNV, DESCRIPTOR$vkCmdSetViewportShadingRatePaletteNV);
        SEGMENT$vkCmdSetCoarseSampleOrderNV = loader.apply("vkCmdSetCoarseSampleOrderNV");
        HANDLE$vkCmdSetCoarseSampleOrderNV = RawFunctionLoader.link(SEGMENTvkCmdSetCoarseSampleOrderNV, DESCRIPTOR$vkCmdSetCoarseSampleOrderNV);
        SEGMENT$vkCmdDrawMeshTasksNV = loader.apply("vkCmdDrawMeshTasksNV");
        HANDLE$vkCmdDrawMeshTasksNV = RawFunctionLoader.link(SEGMENTvkCmdDrawMeshTasksNV, DESCRIPTOR$vkCmdDrawMeshTasksNV);
        SEGMENT$vkCmdDrawMeshTasksIndirectNV = loader.apply("vkCmdDrawMeshTasksIndirectNV");
        HANDLE$vkCmdDrawMeshTasksIndirectNV = RawFunctionLoader.link(SEGMENTvkCmdDrawMeshTasksIndirectNV, DESCRIPTOR$vkCmdDrawMeshTasksIndirectNV);
        SEGMENT$vkCmdDrawMeshTasksIndirectCountNV = loader.apply("vkCmdDrawMeshTasksIndirectCountNV");
        HANDLE$vkCmdDrawMeshTasksIndirectCountNV = RawFunctionLoader.link(SEGMENTvkCmdDrawMeshTasksIndirectCountNV, DESCRIPTOR$vkCmdDrawMeshTasksIndirectCountNV);
        SEGMENT$vkCmdDrawMeshTasksEXT = loader.apply("vkCmdDrawMeshTasksEXT");
        HANDLE$vkCmdDrawMeshTasksEXT = RawFunctionLoader.link(SEGMENTvkCmdDrawMeshTasksEXT, DESCRIPTOR$vkCmdDrawMeshTasksEXT);
        SEGMENT$vkCmdDrawMeshTasksIndirectEXT = loader.apply("vkCmdDrawMeshTasksIndirectEXT");
        HANDLE$vkCmdDrawMeshTasksIndirectEXT = RawFunctionLoader.link(SEGMENTvkCmdDrawMeshTasksIndirectEXT, DESCRIPTOR$vkCmdDrawMeshTasksIndirectEXT);
        SEGMENT$vkCmdDrawMeshTasksIndirectCountEXT = loader.apply("vkCmdDrawMeshTasksIndirectCountEXT");
        HANDLE$vkCmdDrawMeshTasksIndirectCountEXT = RawFunctionLoader.link(SEGMENTvkCmdDrawMeshTasksIndirectCountEXT, DESCRIPTOR$vkCmdDrawMeshTasksIndirectCountEXT);
        SEGMENT$vkCompileDeferredNV = loader.apply("vkCompileDeferredNV");
        HANDLE$vkCompileDeferredNV = RawFunctionLoader.link(SEGMENTvkCompileDeferredNV, DESCRIPTOR$vkCompileDeferredNV);
        SEGMENT$vkCreateAccelerationStructureNV = loader.apply("vkCreateAccelerationStructureNV");
        HANDLE$vkCreateAccelerationStructureNV = RawFunctionLoader.link(SEGMENTvkCreateAccelerationStructureNV, DESCRIPTOR$vkCreateAccelerationStructureNV);
        SEGMENT$vkCmdBindInvocationMaskHUAWEI = loader.apply("vkCmdBindInvocationMaskHUAWEI");
        HANDLE$vkCmdBindInvocationMaskHUAWEI = RawFunctionLoader.link(SEGMENTvkCmdBindInvocationMaskHUAWEI, DESCRIPTOR$vkCmdBindInvocationMaskHUAWEI);
        SEGMENT$vkDestroyAccelerationStructureKHR = loader.apply("vkDestroyAccelerationStructureKHR");
        HANDLE$vkDestroyAccelerationStructureKHR = RawFunctionLoader.link(SEGMENTvkDestroyAccelerationStructureKHR, DESCRIPTOR$vkDestroyAccelerationStructureKHR);
        SEGMENT$vkDestroyAccelerationStructureNV = loader.apply("vkDestroyAccelerationStructureNV");
        HANDLE$vkDestroyAccelerationStructureNV = RawFunctionLoader.link(SEGMENTvkDestroyAccelerationStructureNV, DESCRIPTOR$vkDestroyAccelerationStructureNV);
        SEGMENT$vkGetAccelerationStructureMemoryRequirementsNV = loader.apply("vkGetAccelerationStructureMemoryRequirementsNV");
        HANDLE$vkGetAccelerationStructureMemoryRequirementsNV = RawFunctionLoader.link(SEGMENTvkGetAccelerationStructureMemoryRequirementsNV, DESCRIPTOR$vkGetAccelerationStructureMemoryRequirementsNV);
        SEGMENT$vkBindAccelerationStructureMemoryNV = loader.apply("vkBindAccelerationStructureMemoryNV");
        HANDLE$vkBindAccelerationStructureMemoryNV = RawFunctionLoader.link(SEGMENTvkBindAccelerationStructureMemoryNV, DESCRIPTOR$vkBindAccelerationStructureMemoryNV);
        SEGMENT$vkCmdCopyAccelerationStructureNV = loader.apply("vkCmdCopyAccelerationStructureNV");
        HANDLE$vkCmdCopyAccelerationStructureNV = RawFunctionLoader.link(SEGMENTvkCmdCopyAccelerationStructureNV, DESCRIPTOR$vkCmdCopyAccelerationStructureNV);
        SEGMENT$vkCmdCopyAccelerationStructureKHR = loader.apply("vkCmdCopyAccelerationStructureKHR");
        HANDLE$vkCmdCopyAccelerationStructureKHR = RawFunctionLoader.link(SEGMENTvkCmdCopyAccelerationStructureKHR, DESCRIPTOR$vkCmdCopyAccelerationStructureKHR);
        SEGMENT$vkCopyAccelerationStructureKHR = loader.apply("vkCopyAccelerationStructureKHR");
        HANDLE$vkCopyAccelerationStructureKHR = RawFunctionLoader.link(SEGMENTvkCopyAccelerationStructureKHR, DESCRIPTOR$vkCopyAccelerationStructureKHR);
        SEGMENT$vkCmdCopyAccelerationStructureToMemoryKHR = loader.apply("vkCmdCopyAccelerationStructureToMemoryKHR");
        HANDLE$vkCmdCopyAccelerationStructureToMemoryKHR = RawFunctionLoader.link(SEGMENTvkCmdCopyAccelerationStructureToMemoryKHR, DESCRIPTOR$vkCmdCopyAccelerationStructureToMemoryKHR);
        SEGMENT$vkCopyAccelerationStructureToMemoryKHR = loader.apply("vkCopyAccelerationStructureToMemoryKHR");
        HANDLE$vkCopyAccelerationStructureToMemoryKHR = RawFunctionLoader.link(SEGMENTvkCopyAccelerationStructureToMemoryKHR, DESCRIPTOR$vkCopyAccelerationStructureToMemoryKHR);
        SEGMENT$vkCmdCopyMemoryToAccelerationStructureKHR = loader.apply("vkCmdCopyMemoryToAccelerationStructureKHR");
        HANDLE$vkCmdCopyMemoryToAccelerationStructureKHR = RawFunctionLoader.link(SEGMENTvkCmdCopyMemoryToAccelerationStructureKHR, DESCRIPTOR$vkCmdCopyMemoryToAccelerationStructureKHR);
        SEGMENT$vkCopyMemoryToAccelerationStructureKHR = loader.apply("vkCopyMemoryToAccelerationStructureKHR");
        HANDLE$vkCopyMemoryToAccelerationStructureKHR = RawFunctionLoader.link(SEGMENTvkCopyMemoryToAccelerationStructureKHR, DESCRIPTOR$vkCopyMemoryToAccelerationStructureKHR);
        SEGMENT$vkCmdWriteAccelerationStructuresPropertiesKHR = loader.apply("vkCmdWriteAccelerationStructuresPropertiesKHR");
        HANDLE$vkCmdWriteAccelerationStructuresPropertiesKHR = RawFunctionLoader.link(SEGMENTvkCmdWriteAccelerationStructuresPropertiesKHR, DESCRIPTOR$vkCmdWriteAccelerationStructuresPropertiesKHR);
        SEGMENT$vkCmdWriteAccelerationStructuresPropertiesNV = loader.apply("vkCmdWriteAccelerationStructuresPropertiesNV");
        HANDLE$vkCmdWriteAccelerationStructuresPropertiesNV = RawFunctionLoader.link(SEGMENTvkCmdWriteAccelerationStructuresPropertiesNV, DESCRIPTOR$vkCmdWriteAccelerationStructuresPropertiesNV);
        SEGMENT$vkCmdBuildAccelerationStructureNV = loader.apply("vkCmdBuildAccelerationStructureNV");
        HANDLE$vkCmdBuildAccelerationStructureNV = RawFunctionLoader.link(SEGMENTvkCmdBuildAccelerationStructureNV, DESCRIPTOR$vkCmdBuildAccelerationStructureNV);
        SEGMENT$vkWriteAccelerationStructuresPropertiesKHR = loader.apply("vkWriteAccelerationStructuresPropertiesKHR");
        HANDLE$vkWriteAccelerationStructuresPropertiesKHR = RawFunctionLoader.link(SEGMENTvkWriteAccelerationStructuresPropertiesKHR, DESCRIPTOR$vkWriteAccelerationStructuresPropertiesKHR);
        SEGMENT$vkCmdTraceRaysKHR = loader.apply("vkCmdTraceRaysKHR");
        HANDLE$vkCmdTraceRaysKHR = RawFunctionLoader.link(SEGMENTvkCmdTraceRaysKHR, DESCRIPTOR$vkCmdTraceRaysKHR);
        SEGMENT$vkCmdTraceRaysNV = loader.apply("vkCmdTraceRaysNV");
        HANDLE$vkCmdTraceRaysNV = RawFunctionLoader.link(SEGMENTvkCmdTraceRaysNV, DESCRIPTOR$vkCmdTraceRaysNV);
        SEGMENT$vkGetRayTracingShaderGroupHandlesKHR = loader.apply("vkGetRayTracingShaderGroupHandlesKHR");
        HANDLE$vkGetRayTracingShaderGroupHandlesKHR = RawFunctionLoader.link(SEGMENTvkGetRayTracingShaderGroupHandlesKHR, DESCRIPTOR$vkGetRayTracingShaderGroupHandlesKHR);
        SEGMENT$vkGetRayTracingCaptureReplayShaderGroupHandlesKHR = loader.apply("vkGetRayTracingCaptureReplayShaderGroupHandlesKHR");
        HANDLE$vkGetRayTracingCaptureReplayShaderGroupHandlesKHR = RawFunctionLoader.link(SEGMENTvkGetRayTracingCaptureReplayShaderGroupHandlesKHR, DESCRIPTOR$vkGetRayTracingCaptureReplayShaderGroupHandlesKHR);
        SEGMENT$vkGetAccelerationStructureHandleNV = loader.apply("vkGetAccelerationStructureHandleNV");
        HANDLE$vkGetAccelerationStructureHandleNV = RawFunctionLoader.link(SEGMENTvkGetAccelerationStructureHandleNV, DESCRIPTOR$vkGetAccelerationStructureHandleNV);
        SEGMENT$vkCreateRayTracingPipelinesNV = loader.apply("vkCreateRayTracingPipelinesNV");
        HANDLE$vkCreateRayTracingPipelinesNV = RawFunctionLoader.link(SEGMENTvkCreateRayTracingPipelinesNV, DESCRIPTOR$vkCreateRayTracingPipelinesNV);
        SEGMENT$vkCreateRayTracingPipelinesKHR = loader.apply("vkCreateRayTracingPipelinesKHR");
        HANDLE$vkCreateRayTracingPipelinesKHR = RawFunctionLoader.link(SEGMENTvkCreateRayTracingPipelinesKHR, DESCRIPTOR$vkCreateRayTracingPipelinesKHR);
        SEGMENT$vkGetPhysicalDeviceCooperativeMatrixPropertiesNV = loader.apply("vkGetPhysicalDeviceCooperativeMatrixPropertiesNV");
        HANDLE$vkGetPhysicalDeviceCooperativeMatrixPropertiesNV = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceCooperativeMatrixPropertiesNV, DESCRIPTOR$vkGetPhysicalDeviceCooperativeMatrixPropertiesNV);
        SEGMENT$vkCmdTraceRaysIndirectKHR = loader.apply("vkCmdTraceRaysIndirectKHR");
        HANDLE$vkCmdTraceRaysIndirectKHR = RawFunctionLoader.link(SEGMENTvkCmdTraceRaysIndirectKHR, DESCRIPTOR$vkCmdTraceRaysIndirectKHR);
        SEGMENT$vkCmdTraceRaysIndirect2KHR = loader.apply("vkCmdTraceRaysIndirect2KHR");
        HANDLE$vkCmdTraceRaysIndirect2KHR = RawFunctionLoader.link(SEGMENTvkCmdTraceRaysIndirect2KHR, DESCRIPTOR$vkCmdTraceRaysIndirect2KHR);
        SEGMENT$vkGetDeviceAccelerationStructureCompatibilityKHR = loader.apply("vkGetDeviceAccelerationStructureCompatibilityKHR");
        HANDLE$vkGetDeviceAccelerationStructureCompatibilityKHR = RawFunctionLoader.link(SEGMENTvkGetDeviceAccelerationStructureCompatibilityKHR, DESCRIPTOR$vkGetDeviceAccelerationStructureCompatibilityKHR);
        SEGMENT$vkGetRayTracingShaderGroupStackSizeKHR = loader.apply("vkGetRayTracingShaderGroupStackSizeKHR");
        HANDLE$vkGetRayTracingShaderGroupStackSizeKHR = RawFunctionLoader.link(SEGMENTvkGetRayTracingShaderGroupStackSizeKHR, DESCRIPTOR$vkGetRayTracingShaderGroupStackSizeKHR);
        SEGMENT$vkCmdSetRayTracingPipelineStackSizeKHR = loader.apply("vkCmdSetRayTracingPipelineStackSizeKHR");
        HANDLE$vkCmdSetRayTracingPipelineStackSizeKHR = RawFunctionLoader.link(SEGMENTvkCmdSetRayTracingPipelineStackSizeKHR, DESCRIPTOR$vkCmdSetRayTracingPipelineStackSizeKHR);
        SEGMENT$vkGetImageViewHandleNVX = loader.apply("vkGetImageViewHandleNVX");
        HANDLE$vkGetImageViewHandleNVX = RawFunctionLoader.link(SEGMENTvkGetImageViewHandleNVX, DESCRIPTOR$vkGetImageViewHandleNVX);
        SEGMENT$vkGetImageViewAddressNVX = loader.apply("vkGetImageViewAddressNVX");
        HANDLE$vkGetImageViewAddressNVX = RawFunctionLoader.link(SEGMENTvkGetImageViewAddressNVX, DESCRIPTOR$vkGetImageViewAddressNVX);
        SEGMENT$vkGetPhysicalDeviceSurfacePresentModes2EXT = loader.apply("vkGetPhysicalDeviceSurfacePresentModes2EXT");
        HANDLE$vkGetPhysicalDeviceSurfacePresentModes2EXT = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSurfacePresentModes2EXT, DESCRIPTOR$vkGetPhysicalDeviceSurfacePresentModes2EXT);
        SEGMENT$vkGetDeviceGroupSurfacePresentModes2EXT = loader.apply("vkGetDeviceGroupSurfacePresentModes2EXT");
        HANDLE$vkGetDeviceGroupSurfacePresentModes2EXT = RawFunctionLoader.link(SEGMENTvkGetDeviceGroupSurfacePresentModes2EXT, DESCRIPTOR$vkGetDeviceGroupSurfacePresentModes2EXT);
        SEGMENT$vkAcquireFullScreenExclusiveModeEXT = loader.apply("vkAcquireFullScreenExclusiveModeEXT");
        HANDLE$vkAcquireFullScreenExclusiveModeEXT = RawFunctionLoader.link(SEGMENTvkAcquireFullScreenExclusiveModeEXT, DESCRIPTOR$vkAcquireFullScreenExclusiveModeEXT);
        SEGMENT$vkReleaseFullScreenExclusiveModeEXT = loader.apply("vkReleaseFullScreenExclusiveModeEXT");
        HANDLE$vkReleaseFullScreenExclusiveModeEXT = RawFunctionLoader.link(SEGMENTvkReleaseFullScreenExclusiveModeEXT, DESCRIPTOR$vkReleaseFullScreenExclusiveModeEXT);
        ...
        HANDLE$vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR = RawFunctionLoader.link(SEGMENTvkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR, DESCRIPTOR$vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR);
        ...
        HANDLE$vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR, DESCRIPTOR$vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR);
        SEGMENT$vkAcquireProfilingLockKHR = loader.apply("vkAcquireProfilingLockKHR");
        HANDLE$vkAcquireProfilingLockKHR = RawFunctionLoader.link(SEGMENTvkAcquireProfilingLockKHR, DESCRIPTOR$vkAcquireProfilingLockKHR);
        SEGMENT$vkReleaseProfilingLockKHR = loader.apply("vkReleaseProfilingLockKHR");
        HANDLE$vkReleaseProfilingLockKHR = RawFunctionLoader.link(SEGMENTvkReleaseProfilingLockKHR, DESCRIPTOR$vkReleaseProfilingLockKHR);
        SEGMENT$vkGetImageDrmFormatModifierPropertiesEXT = loader.apply("vkGetImageDrmFormatModifierPropertiesEXT");
        HANDLE$vkGetImageDrmFormatModifierPropertiesEXT = RawFunctionLoader.link(SEGMENTvkGetImageDrmFormatModifierPropertiesEXT, DESCRIPTOR$vkGetImageDrmFormatModifierPropertiesEXT);
        SEGMENT$vkGetBufferOpaqueCaptureAddress = loader.apply("vkGetBufferOpaqueCaptureAddress");
        HANDLE$vkGetBufferOpaqueCaptureAddress = RawFunctionLoader.link(SEGMENTvkGetBufferOpaqueCaptureAddress, DESCRIPTOR$vkGetBufferOpaqueCaptureAddress);
        SEGMENT$vkGetBufferDeviceAddress = loader.apply("vkGetBufferDeviceAddress");
        HANDLE$vkGetBufferDeviceAddress = RawFunctionLoader.link(SEGMENTvkGetBufferDeviceAddress, DESCRIPTOR$vkGetBufferDeviceAddress);
        ...
        HANDLE$vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV, DESCRIPTOR$vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV);
        SEGMENT$vkInitializePerformanceApiINTEL = loader.apply("vkInitializePerformanceApiINTEL");
        HANDLE$vkInitializePerformanceApiINTEL = RawFunctionLoader.link(SEGMENTvkInitializePerformanceApiINTEL, DESCRIPTOR$vkInitializePerformanceApiINTEL);
        SEGMENT$vkUninitializePerformanceApiINTEL = loader.apply("vkUninitializePerformanceApiINTEL");
        HANDLE$vkUninitializePerformanceApiINTEL = RawFunctionLoader.link(SEGMENTvkUninitializePerformanceApiINTEL, DESCRIPTOR$vkUninitializePerformanceApiINTEL);
        SEGMENT$vkCmdSetPerformanceMarkerINTEL = loader.apply("vkCmdSetPerformanceMarkerINTEL");
        HANDLE$vkCmdSetPerformanceMarkerINTEL = RawFunctionLoader.link(SEGMENTvkCmdSetPerformanceMarkerINTEL, DESCRIPTOR$vkCmdSetPerformanceMarkerINTEL);
        SEGMENT$vkCmdSetPerformanceStreamMarkerINTEL = loader.apply("vkCmdSetPerformanceStreamMarkerINTEL");
        HANDLE$vkCmdSetPerformanceStreamMarkerINTEL = RawFunctionLoader.link(SEGMENTvkCmdSetPerformanceStreamMarkerINTEL, DESCRIPTOR$vkCmdSetPerformanceStreamMarkerINTEL);
        SEGMENT$vkCmdSetPerformanceOverrideINTEL = loader.apply("vkCmdSetPerformanceOverrideINTEL");
        HANDLE$vkCmdSetPerformanceOverrideINTEL = RawFunctionLoader.link(SEGMENTvkCmdSetPerformanceOverrideINTEL, DESCRIPTOR$vkCmdSetPerformanceOverrideINTEL);
        SEGMENT$vkAcquirePerformanceConfigurationINTEL = loader.apply("vkAcquirePerformanceConfigurationINTEL");
        HANDLE$vkAcquirePerformanceConfigurationINTEL = RawFunctionLoader.link(SEGMENTvkAcquirePerformanceConfigurationINTEL, DESCRIPTOR$vkAcquirePerformanceConfigurationINTEL);
        SEGMENT$vkReleasePerformanceConfigurationINTEL = loader.apply("vkReleasePerformanceConfigurationINTEL");
        HANDLE$vkReleasePerformanceConfigurationINTEL = RawFunctionLoader.link(SEGMENTvkReleasePerformanceConfigurationINTEL, DESCRIPTOR$vkReleasePerformanceConfigurationINTEL);
        SEGMENT$vkQueueSetPerformanceConfigurationINTEL = loader.apply("vkQueueSetPerformanceConfigurationINTEL");
        HANDLE$vkQueueSetPerformanceConfigurationINTEL = RawFunctionLoader.link(SEGMENTvkQueueSetPerformanceConfigurationINTEL, DESCRIPTOR$vkQueueSetPerformanceConfigurationINTEL);
        SEGMENT$vkGetPerformanceParameterINTEL = loader.apply("vkGetPerformanceParameterINTEL");
        HANDLE$vkGetPerformanceParameterINTEL = RawFunctionLoader.link(SEGMENTvkGetPerformanceParameterINTEL, DESCRIPTOR$vkGetPerformanceParameterINTEL);
        SEGMENT$vkGetDeviceMemoryOpaqueCaptureAddress = loader.apply("vkGetDeviceMemoryOpaqueCaptureAddress");
        HANDLE$vkGetDeviceMemoryOpaqueCaptureAddress = RawFunctionLoader.link(SEGMENTvkGetDeviceMemoryOpaqueCaptureAddress, DESCRIPTOR$vkGetDeviceMemoryOpaqueCaptureAddress);
        SEGMENT$vkGetPipelineExecutablePropertiesKHR = loader.apply("vkGetPipelineExecutablePropertiesKHR");
        HANDLE$vkGetPipelineExecutablePropertiesKHR = RawFunctionLoader.link(SEGMENTvkGetPipelineExecutablePropertiesKHR, DESCRIPTOR$vkGetPipelineExecutablePropertiesKHR);
        SEGMENT$vkGetPipelineExecutableStatisticsKHR = loader.apply("vkGetPipelineExecutableStatisticsKHR");
        HANDLE$vkGetPipelineExecutableStatisticsKHR = RawFunctionLoader.link(SEGMENTvkGetPipelineExecutableStatisticsKHR, DESCRIPTOR$vkGetPipelineExecutableStatisticsKHR);
        SEGMENT$vkGetPipelineExecutableInternalRepresentationsKHR = loader.apply("vkGetPipelineExecutableInternalRepresentationsKHR");
        HANDLE$vkGetPipelineExecutableInternalRepresentationsKHR = RawFunctionLoader.link(SEGMENTvkGetPipelineExecutableInternalRepresentationsKHR, DESCRIPTOR$vkGetPipelineExecutableInternalRepresentationsKHR);
        SEGMENT$vkCmdSetLineStippleKHR = loader.apply("vkCmdSetLineStippleKHR");
        HANDLE$vkCmdSetLineStippleKHR = RawFunctionLoader.link(SEGMENTvkCmdSetLineStippleKHR, DESCRIPTOR$vkCmdSetLineStippleKHR);
        SEGMENT$vkCreateAccelerationStructureKHR = loader.apply("vkCreateAccelerationStructureKHR");
        HANDLE$vkCreateAccelerationStructureKHR = RawFunctionLoader.link(SEGMENTvkCreateAccelerationStructureKHR, DESCRIPTOR$vkCreateAccelerationStructureKHR);
        SEGMENT$vkCmdBuildAccelerationStructuresKHR = loader.apply("vkCmdBuildAccelerationStructuresKHR");
        HANDLE$vkCmdBuildAccelerationStructuresKHR = RawFunctionLoader.link(SEGMENTvkCmdBuildAccelerationStructuresKHR, DESCRIPTOR$vkCmdBuildAccelerationStructuresKHR);
        SEGMENT$vkCmdBuildAccelerationStructuresIndirectKHR = loader.apply("vkCmdBuildAccelerationStructuresIndirectKHR");
        HANDLE$vkCmdBuildAccelerationStructuresIndirectKHR = RawFunctionLoader.link(SEGMENTvkCmdBuildAccelerationStructuresIndirectKHR, DESCRIPTOR$vkCmdBuildAccelerationStructuresIndirectKHR);
        SEGMENT$vkBuildAccelerationStructuresKHR = loader.apply("vkBuildAccelerationStructuresKHR");
        HANDLE$vkBuildAccelerationStructuresKHR = RawFunctionLoader.link(SEGMENTvkBuildAccelerationStructuresKHR, DESCRIPTOR$vkBuildAccelerationStructuresKHR);
        SEGMENT$vkGetAccelerationStructureDeviceAddressKHR = loader.apply("vkGetAccelerationStructureDeviceAddressKHR");
        HANDLE$vkGetAccelerationStructureDeviceAddressKHR = RawFunctionLoader.link(SEGMENTvkGetAccelerationStructureDeviceAddressKHR, DESCRIPTOR$vkGetAccelerationStructureDeviceAddressKHR);
        SEGMENT$vkCreateDeferredOperationKHR = loader.apply("vkCreateDeferredOperationKHR");
        HANDLE$vkCreateDeferredOperationKHR = RawFunctionLoader.link(SEGMENTvkCreateDeferredOperationKHR, DESCRIPTOR$vkCreateDeferredOperationKHR);
        SEGMENT$vkDestroyDeferredOperationKHR = loader.apply("vkDestroyDeferredOperationKHR");
        HANDLE$vkDestroyDeferredOperationKHR = RawFunctionLoader.link(SEGMENTvkDestroyDeferredOperationKHR, DESCRIPTOR$vkDestroyDeferredOperationKHR);
        SEGMENT$vkGetDeferredOperationMaxConcurrencyKHR = loader.apply("vkGetDeferredOperationMaxConcurrencyKHR");
        HANDLE$vkGetDeferredOperationMaxConcurrencyKHR = RawFunctionLoader.link(SEGMENTvkGetDeferredOperationMaxConcurrencyKHR, DESCRIPTOR$vkGetDeferredOperationMaxConcurrencyKHR);
        SEGMENT$vkGetDeferredOperationResultKHR = loader.apply("vkGetDeferredOperationResultKHR");
        HANDLE$vkGetDeferredOperationResultKHR = RawFunctionLoader.link(SEGMENTvkGetDeferredOperationResultKHR, DESCRIPTOR$vkGetDeferredOperationResultKHR);
        SEGMENT$vkDeferredOperationJoinKHR = loader.apply("vkDeferredOperationJoinKHR");
        HANDLE$vkDeferredOperationJoinKHR = RawFunctionLoader.link(SEGMENTvkDeferredOperationJoinKHR, DESCRIPTOR$vkDeferredOperationJoinKHR);
        SEGMENT$vkGetPipelineIndirectMemoryRequirementsNV = loader.apply("vkGetPipelineIndirectMemoryRequirementsNV");
        HANDLE$vkGetPipelineIndirectMemoryRequirementsNV = RawFunctionLoader.link(SEGMENTvkGetPipelineIndirectMemoryRequirementsNV, DESCRIPTOR$vkGetPipelineIndirectMemoryRequirementsNV);
        SEGMENT$vkGetPipelineIndirectDeviceAddressNV = loader.apply("vkGetPipelineIndirectDeviceAddressNV");
        HANDLE$vkGetPipelineIndirectDeviceAddressNV = RawFunctionLoader.link(SEGMENTvkGetPipelineIndirectDeviceAddressNV, DESCRIPTOR$vkGetPipelineIndirectDeviceAddressNV);
        SEGMENT$vkAntiLagUpdateAMD = loader.apply("vkAntiLagUpdateAMD");
        HANDLE$vkAntiLagUpdateAMD = RawFunctionLoader.link(SEGMENTvkAntiLagUpdateAMD, DESCRIPTOR$vkAntiLagUpdateAMD);
        SEGMENT$vkCmdSetCullMode = loader.apply("vkCmdSetCullMode");
        HANDLE$vkCmdSetCullMode = RawFunctionLoader.link(SEGMENTvkCmdSetCullMode, DESCRIPTOR$vkCmdSetCullMode);
        SEGMENT$vkCmdSetFrontFace = loader.apply("vkCmdSetFrontFace");
        HANDLE$vkCmdSetFrontFace = RawFunctionLoader.link(SEGMENTvkCmdSetFrontFace, DESCRIPTOR$vkCmdSetFrontFace);
        SEGMENT$vkCmdSetPrimitiveTopology = loader.apply("vkCmdSetPrimitiveTopology");
        HANDLE$vkCmdSetPrimitiveTopology = RawFunctionLoader.link(SEGMENTvkCmdSetPrimitiveTopology, DESCRIPTOR$vkCmdSetPrimitiveTopology);
        SEGMENT$vkCmdSetViewportWithCount = loader.apply("vkCmdSetViewportWithCount");
        HANDLE$vkCmdSetViewportWithCount = RawFunctionLoader.link(SEGMENTvkCmdSetViewportWithCount, DESCRIPTOR$vkCmdSetViewportWithCount);
        SEGMENT$vkCmdSetScissorWithCount = loader.apply("vkCmdSetScissorWithCount");
        HANDLE$vkCmdSetScissorWithCount = RawFunctionLoader.link(SEGMENTvkCmdSetScissorWithCount, DESCRIPTOR$vkCmdSetScissorWithCount);
        SEGMENT$vkCmdBindIndexBuffer2KHR = loader.apply("vkCmdBindIndexBuffer2KHR");
        HANDLE$vkCmdBindIndexBuffer2KHR = RawFunctionLoader.link(SEGMENTvkCmdBindIndexBuffer2KHR, DESCRIPTOR$vkCmdBindIndexBuffer2KHR);
        SEGMENT$vkCmdBindVertexBuffers2 = loader.apply("vkCmdBindVertexBuffers2");
        HANDLE$vkCmdBindVertexBuffers2 = RawFunctionLoader.link(SEGMENTvkCmdBindVertexBuffers2, DESCRIPTOR$vkCmdBindVertexBuffers2);
        SEGMENT$vkCmdSetDepthTestEnable = loader.apply("vkCmdSetDepthTestEnable");
        HANDLE$vkCmdSetDepthTestEnable = RawFunctionLoader.link(SEGMENTvkCmdSetDepthTestEnable, DESCRIPTOR$vkCmdSetDepthTestEnable);
        SEGMENT$vkCmdSetDepthWriteEnable = loader.apply("vkCmdSetDepthWriteEnable");
        HANDLE$vkCmdSetDepthWriteEnable = RawFunctionLoader.link(SEGMENTvkCmdSetDepthWriteEnable, DESCRIPTOR$vkCmdSetDepthWriteEnable);
        SEGMENT$vkCmdSetDepthCompareOp = loader.apply("vkCmdSetDepthCompareOp");
        HANDLE$vkCmdSetDepthCompareOp = RawFunctionLoader.link(SEGMENTvkCmdSetDepthCompareOp, DESCRIPTOR$vkCmdSetDepthCompareOp);
        SEGMENT$vkCmdSetDepthBoundsTestEnable = loader.apply("vkCmdSetDepthBoundsTestEnable");
        HANDLE$vkCmdSetDepthBoundsTestEnable = RawFunctionLoader.link(SEGMENTvkCmdSetDepthBoundsTestEnable, DESCRIPTOR$vkCmdSetDepthBoundsTestEnable);
        SEGMENT$vkCmdSetStencilTestEnable = loader.apply("vkCmdSetStencilTestEnable");
        HANDLE$vkCmdSetStencilTestEnable = RawFunctionLoader.link(SEGMENTvkCmdSetStencilTestEnable, DESCRIPTOR$vkCmdSetStencilTestEnable);
        SEGMENT$vkCmdSetStencilOp = loader.apply("vkCmdSetStencilOp");
        HANDLE$vkCmdSetStencilOp = RawFunctionLoader.link(SEGMENTvkCmdSetStencilOp, DESCRIPTOR$vkCmdSetStencilOp);
        SEGMENT$vkCmdSetPatchControlPointsEXT = loader.apply("vkCmdSetPatchControlPointsEXT");
        HANDLE$vkCmdSetPatchControlPointsEXT = RawFunctionLoader.link(SEGMENTvkCmdSetPatchControlPointsEXT, DESCRIPTOR$vkCmdSetPatchControlPointsEXT);
        SEGMENT$vkCmdSetRasterizerDiscardEnable = loader.apply("vkCmdSetRasterizerDiscardEnable");
        HANDLE$vkCmdSetRasterizerDiscardEnable = RawFunctionLoader.link(SEGMENTvkCmdSetRasterizerDiscardEnable, DESCRIPTOR$vkCmdSetRasterizerDiscardEnable);
        SEGMENT$vkCmdSetDepthBiasEnable = loader.apply("vkCmdSetDepthBiasEnable");
        HANDLE$vkCmdSetDepthBiasEnable = RawFunctionLoader.link(SEGMENTvkCmdSetDepthBiasEnable, DESCRIPTOR$vkCmdSetDepthBiasEnable);
        SEGMENT$vkCmdSetLogicOpEXT = loader.apply("vkCmdSetLogicOpEXT");
        HANDLE$vkCmdSetLogicOpEXT = RawFunctionLoader.link(SEGMENTvkCmdSetLogicOpEXT, DESCRIPTOR$vkCmdSetLogicOpEXT);
        SEGMENT$vkCmdSetPrimitiveRestartEnable = loader.apply("vkCmdSetPrimitiveRestartEnable");
        HANDLE$vkCmdSetPrimitiveRestartEnable = RawFunctionLoader.link(SEGMENTvkCmdSetPrimitiveRestartEnable, DESCRIPTOR$vkCmdSetPrimitiveRestartEnable);
        SEGMENT$vkCmdSetTessellationDomainOriginEXT = loader.apply("vkCmdSetTessellationDomainOriginEXT");
        HANDLE$vkCmdSetTessellationDomainOriginEXT = RawFunctionLoader.link(SEGMENTvkCmdSetTessellationDomainOriginEXT, DESCRIPTOR$vkCmdSetTessellationDomainOriginEXT);
        SEGMENT$vkCmdSetDepthClampEnableEXT = loader.apply("vkCmdSetDepthClampEnableEXT");
        HANDLE$vkCmdSetDepthClampEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetDepthClampEnableEXT, DESCRIPTOR$vkCmdSetDepthClampEnableEXT);
        SEGMENT$vkCmdSetPolygonModeEXT = loader.apply("vkCmdSetPolygonModeEXT");
        HANDLE$vkCmdSetPolygonModeEXT = RawFunctionLoader.link(SEGMENTvkCmdSetPolygonModeEXT, DESCRIPTOR$vkCmdSetPolygonModeEXT);
        SEGMENT$vkCmdSetRasterizationSamplesEXT = loader.apply("vkCmdSetRasterizationSamplesEXT");
        HANDLE$vkCmdSetRasterizationSamplesEXT = RawFunctionLoader.link(SEGMENTvkCmdSetRasterizationSamplesEXT, DESCRIPTOR$vkCmdSetRasterizationSamplesEXT);
        SEGMENT$vkCmdSetSampleMaskEXT = loader.apply("vkCmdSetSampleMaskEXT");
        HANDLE$vkCmdSetSampleMaskEXT = RawFunctionLoader.link(SEGMENTvkCmdSetSampleMaskEXT, DESCRIPTOR$vkCmdSetSampleMaskEXT);
        SEGMENT$vkCmdSetAlphaToCoverageEnableEXT = loader.apply("vkCmdSetAlphaToCoverageEnableEXT");
        HANDLE$vkCmdSetAlphaToCoverageEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetAlphaToCoverageEnableEXT, DESCRIPTOR$vkCmdSetAlphaToCoverageEnableEXT);
        SEGMENT$vkCmdSetAlphaToOneEnableEXT = loader.apply("vkCmdSetAlphaToOneEnableEXT");
        HANDLE$vkCmdSetAlphaToOneEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetAlphaToOneEnableEXT, DESCRIPTOR$vkCmdSetAlphaToOneEnableEXT);
        SEGMENT$vkCmdSetLogicOpEnableEXT = loader.apply("vkCmdSetLogicOpEnableEXT");
        HANDLE$vkCmdSetLogicOpEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetLogicOpEnableEXT, DESCRIPTOR$vkCmdSetLogicOpEnableEXT);
        SEGMENT$vkCmdSetColorBlendEnableEXT = loader.apply("vkCmdSetColorBlendEnableEXT");
        HANDLE$vkCmdSetColorBlendEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetColorBlendEnableEXT, DESCRIPTOR$vkCmdSetColorBlendEnableEXT);
        SEGMENT$vkCmdSetColorBlendEquationEXT = loader.apply("vkCmdSetColorBlendEquationEXT");
        HANDLE$vkCmdSetColorBlendEquationEXT = RawFunctionLoader.link(SEGMENTvkCmdSetColorBlendEquationEXT, DESCRIPTOR$vkCmdSetColorBlendEquationEXT);
        SEGMENT$vkCmdSetColorWriteMaskEXT = loader.apply("vkCmdSetColorWriteMaskEXT");
        HANDLE$vkCmdSetColorWriteMaskEXT = RawFunctionLoader.link(SEGMENTvkCmdSetColorWriteMaskEXT, DESCRIPTOR$vkCmdSetColorWriteMaskEXT);
        SEGMENT$vkCmdSetRasterizationStreamEXT = loader.apply("vkCmdSetRasterizationStreamEXT");
        HANDLE$vkCmdSetRasterizationStreamEXT = RawFunctionLoader.link(SEGMENTvkCmdSetRasterizationStreamEXT, DESCRIPTOR$vkCmdSetRasterizationStreamEXT);
        SEGMENT$vkCmdSetConservativeRasterizationModeEXT = loader.apply("vkCmdSetConservativeRasterizationModeEXT");
        HANDLE$vkCmdSetConservativeRasterizationModeEXT = RawFunctionLoader.link(SEGMENTvkCmdSetConservativeRasterizationModeEXT, DESCRIPTOR$vkCmdSetConservativeRasterizationModeEXT);
        SEGMENT$vkCmdSetExtraPrimitiveOverestimationSizeEXT = loader.apply("vkCmdSetExtraPrimitiveOverestimationSizeEXT");
        HANDLE$vkCmdSetExtraPrimitiveOverestimationSizeEXT = RawFunctionLoader.link(SEGMENTvkCmdSetExtraPrimitiveOverestimationSizeEXT, DESCRIPTOR$vkCmdSetExtraPrimitiveOverestimationSizeEXT);
        SEGMENT$vkCmdSetDepthClipEnableEXT = loader.apply("vkCmdSetDepthClipEnableEXT");
        HANDLE$vkCmdSetDepthClipEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetDepthClipEnableEXT, DESCRIPTOR$vkCmdSetDepthClipEnableEXT);
        SEGMENT$vkCmdSetSampleLocationsEnableEXT = loader.apply("vkCmdSetSampleLocationsEnableEXT");
        HANDLE$vkCmdSetSampleLocationsEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetSampleLocationsEnableEXT, DESCRIPTOR$vkCmdSetSampleLocationsEnableEXT);
        SEGMENT$vkCmdSetColorBlendAdvancedEXT = loader.apply("vkCmdSetColorBlendAdvancedEXT");
        HANDLE$vkCmdSetColorBlendAdvancedEXT = RawFunctionLoader.link(SEGMENTvkCmdSetColorBlendAdvancedEXT, DESCRIPTOR$vkCmdSetColorBlendAdvancedEXT);
        SEGMENT$vkCmdSetProvokingVertexModeEXT = loader.apply("vkCmdSetProvokingVertexModeEXT");
        HANDLE$vkCmdSetProvokingVertexModeEXT = RawFunctionLoader.link(SEGMENTvkCmdSetProvokingVertexModeEXT, DESCRIPTOR$vkCmdSetProvokingVertexModeEXT);
        SEGMENT$vkCmdSetLineRasterizationModeEXT = loader.apply("vkCmdSetLineRasterizationModeEXT");
        HANDLE$vkCmdSetLineRasterizationModeEXT = RawFunctionLoader.link(SEGMENTvkCmdSetLineRasterizationModeEXT, DESCRIPTOR$vkCmdSetLineRasterizationModeEXT);
        SEGMENT$vkCmdSetLineStippleEnableEXT = loader.apply("vkCmdSetLineStippleEnableEXT");
        HANDLE$vkCmdSetLineStippleEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetLineStippleEnableEXT, DESCRIPTOR$vkCmdSetLineStippleEnableEXT);
        SEGMENT$vkCmdSetDepthClipNegativeOneToOneEXT = loader.apply("vkCmdSetDepthClipNegativeOneToOneEXT");
        HANDLE$vkCmdSetDepthClipNegativeOneToOneEXT = RawFunctionLoader.link(SEGMENTvkCmdSetDepthClipNegativeOneToOneEXT, DESCRIPTOR$vkCmdSetDepthClipNegativeOneToOneEXT);
        SEGMENT$vkCmdSetViewportWScalingEnableNV = loader.apply("vkCmdSetViewportWScalingEnableNV");
        HANDLE$vkCmdSetViewportWScalingEnableNV = RawFunctionLoader.link(SEGMENTvkCmdSetViewportWScalingEnableNV, DESCRIPTOR$vkCmdSetViewportWScalingEnableNV);
        SEGMENT$vkCmdSetViewportSwizzleNV = loader.apply("vkCmdSetViewportSwizzleNV");
        HANDLE$vkCmdSetViewportSwizzleNV = RawFunctionLoader.link(SEGMENTvkCmdSetViewportSwizzleNV, DESCRIPTOR$vkCmdSetViewportSwizzleNV);
        SEGMENT$vkCmdSetCoverageToColorEnableNV = loader.apply("vkCmdSetCoverageToColorEnableNV");
        HANDLE$vkCmdSetCoverageToColorEnableNV = RawFunctionLoader.link(SEGMENTvkCmdSetCoverageToColorEnableNV, DESCRIPTOR$vkCmdSetCoverageToColorEnableNV);
        SEGMENT$vkCmdSetCoverageToColorLocationNV = loader.apply("vkCmdSetCoverageToColorLocationNV");
        HANDLE$vkCmdSetCoverageToColorLocationNV = RawFunctionLoader.link(SEGMENTvkCmdSetCoverageToColorLocationNV, DESCRIPTOR$vkCmdSetCoverageToColorLocationNV);
        SEGMENT$vkCmdSetCoverageModulationModeNV = loader.apply("vkCmdSetCoverageModulationModeNV");
        HANDLE$vkCmdSetCoverageModulationModeNV = RawFunctionLoader.link(SEGMENTvkCmdSetCoverageModulationModeNV, DESCRIPTOR$vkCmdSetCoverageModulationModeNV);
        SEGMENT$vkCmdSetCoverageModulationTableEnableNV = loader.apply("vkCmdSetCoverageModulationTableEnableNV");
        HANDLE$vkCmdSetCoverageModulationTableEnableNV = RawFunctionLoader.link(SEGMENTvkCmdSetCoverageModulationTableEnableNV, DESCRIPTOR$vkCmdSetCoverageModulationTableEnableNV);
        SEGMENT$vkCmdSetCoverageModulationTableNV = loader.apply("vkCmdSetCoverageModulationTableNV");
        HANDLE$vkCmdSetCoverageModulationTableNV = RawFunctionLoader.link(SEGMENTvkCmdSetCoverageModulationTableNV, DESCRIPTOR$vkCmdSetCoverageModulationTableNV);
        SEGMENT$vkCmdSetShadingRateImageEnableNV = loader.apply("vkCmdSetShadingRateImageEnableNV");
        HANDLE$vkCmdSetShadingRateImageEnableNV = RawFunctionLoader.link(SEGMENTvkCmdSetShadingRateImageEnableNV, DESCRIPTOR$vkCmdSetShadingRateImageEnableNV);
        SEGMENT$vkCmdSetCoverageReductionModeNV = loader.apply("vkCmdSetCoverageReductionModeNV");
        HANDLE$vkCmdSetCoverageReductionModeNV = RawFunctionLoader.link(SEGMENTvkCmdSetCoverageReductionModeNV, DESCRIPTOR$vkCmdSetCoverageReductionModeNV);
        SEGMENT$vkCmdSetRepresentativeFragmentTestEnableNV = loader.apply("vkCmdSetRepresentativeFragmentTestEnableNV");
        HANDLE$vkCmdSetRepresentativeFragmentTestEnableNV = RawFunctionLoader.link(SEGMENTvkCmdSetRepresentativeFragmentTestEnableNV, DESCRIPTOR$vkCmdSetRepresentativeFragmentTestEnableNV);
        SEGMENT$vkCreatePrivateDataSlot = loader.apply("vkCreatePrivateDataSlot");
        HANDLE$vkCreatePrivateDataSlot = RawFunctionLoader.link(SEGMENTvkCreatePrivateDataSlot, DESCRIPTOR$vkCreatePrivateDataSlot);
        SEGMENT$vkDestroyPrivateDataSlot = loader.apply("vkDestroyPrivateDataSlot");
        HANDLE$vkDestroyPrivateDataSlot = RawFunctionLoader.link(SEGMENTvkDestroyPrivateDataSlot, DESCRIPTOR$vkDestroyPrivateDataSlot);
        SEGMENT$vkSetPrivateData = loader.apply("vkSetPrivateData");
        HANDLE$vkSetPrivateData = RawFunctionLoader.link(SEGMENTvkSetPrivateData, DESCRIPTOR$vkSetPrivateData);
        SEGMENT$vkGetPrivateData = loader.apply("vkGetPrivateData");
        HANDLE$vkGetPrivateData = RawFunctionLoader.link(SEGMENTvkGetPrivateData, DESCRIPTOR$vkGetPrivateData);
        SEGMENT$vkCmdCopyBuffer2 = loader.apply("vkCmdCopyBuffer2");
        HANDLE$vkCmdCopyBuffer2 = RawFunctionLoader.link(SEGMENTvkCmdCopyBuffer2, DESCRIPTOR$vkCmdCopyBuffer2);
        SEGMENT$vkCmdCopyImage2 = loader.apply("vkCmdCopyImage2");
        HANDLE$vkCmdCopyImage2 = RawFunctionLoader.link(SEGMENTvkCmdCopyImage2, DESCRIPTOR$vkCmdCopyImage2);
        SEGMENT$vkCmdBlitImage2 = loader.apply("vkCmdBlitImage2");
        HANDLE$vkCmdBlitImage2 = RawFunctionLoader.link(SEGMENTvkCmdBlitImage2, DESCRIPTOR$vkCmdBlitImage2);
        SEGMENT$vkCmdCopyBufferToImage2 = loader.apply("vkCmdCopyBufferToImage2");
        HANDLE$vkCmdCopyBufferToImage2 = RawFunctionLoader.link(SEGMENTvkCmdCopyBufferToImage2, DESCRIPTOR$vkCmdCopyBufferToImage2);
        SEGMENT$vkCmdCopyImageToBuffer2 = loader.apply("vkCmdCopyImageToBuffer2");
        HANDLE$vkCmdCopyImageToBuffer2 = RawFunctionLoader.link(SEGMENTvkCmdCopyImageToBuffer2, DESCRIPTOR$vkCmdCopyImageToBuffer2);
        SEGMENT$vkCmdResolveImage2 = loader.apply("vkCmdResolveImage2");
        HANDLE$vkCmdResolveImage2 = RawFunctionLoader.link(SEGMENTvkCmdResolveImage2, DESCRIPTOR$vkCmdResolveImage2);
        SEGMENT$vkCmdRefreshObjectsKHR = loader.apply("vkCmdRefreshObjectsKHR");
        HANDLE$vkCmdRefreshObjectsKHR = RawFunctionLoader.link(SEGMENTvkCmdRefreshObjectsKHR, DESCRIPTOR$vkCmdRefreshObjectsKHR);
        SEGMENT$vkGetPhysicalDeviceRefreshableObjectTypesKHR = loader.apply("vkGetPhysicalDeviceRefreshableObjectTypesKHR");
        HANDLE$vkGetPhysicalDeviceRefreshableObjectTypesKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceRefreshableObjectTypesKHR, DESCRIPTOR$vkGetPhysicalDeviceRefreshableObjectTypesKHR);
        SEGMENT$vkCmdSetFragmentShadingRateKHR = loader.apply("vkCmdSetFragmentShadingRateKHR");
        HANDLE$vkCmdSetFragmentShadingRateKHR = RawFunctionLoader.link(SEGMENTvkCmdSetFragmentShadingRateKHR, DESCRIPTOR$vkCmdSetFragmentShadingRateKHR);
        SEGMENT$vkGetPhysicalDeviceFragmentShadingRatesKHR = loader.apply("vkGetPhysicalDeviceFragmentShadingRatesKHR");
        HANDLE$vkGetPhysicalDeviceFragmentShadingRatesKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceFragmentShadingRatesKHR, DESCRIPTOR$vkGetPhysicalDeviceFragmentShadingRatesKHR);
        SEGMENT$vkCmdSetFragmentShadingRateEnumNV = loader.apply("vkCmdSetFragmentShadingRateEnumNV");
        HANDLE$vkCmdSetFragmentShadingRateEnumNV = RawFunctionLoader.link(SEGMENTvkCmdSetFragmentShadingRateEnumNV, DESCRIPTOR$vkCmdSetFragmentShadingRateEnumNV);
        SEGMENT$vkGetAccelerationStructureBuildSizesKHR = loader.apply("vkGetAccelerationStructureBuildSizesKHR");
        HANDLE$vkGetAccelerationStructureBuildSizesKHR = RawFunctionLoader.link(SEGMENTvkGetAccelerationStructureBuildSizesKHR, DESCRIPTOR$vkGetAccelerationStructureBuildSizesKHR);
        SEGMENT$vkCmdSetVertexInputEXT = loader.apply("vkCmdSetVertexInputEXT");
        HANDLE$vkCmdSetVertexInputEXT = RawFunctionLoader.link(SEGMENTvkCmdSetVertexInputEXT, DESCRIPTOR$vkCmdSetVertexInputEXT);
        SEGMENT$vkCmdSetColorWriteEnableEXT = loader.apply("vkCmdSetColorWriteEnableEXT");
        HANDLE$vkCmdSetColorWriteEnableEXT = RawFunctionLoader.link(SEGMENTvkCmdSetColorWriteEnableEXT, DESCRIPTOR$vkCmdSetColorWriteEnableEXT);
        SEGMENT$vkCmdSetEvent2 = loader.apply("vkCmdSetEvent2");
        HANDLE$vkCmdSetEvent2 = RawFunctionLoader.link(SEGMENTvkCmdSetEvent2, DESCRIPTOR$vkCmdSetEvent2);
        SEGMENT$vkCmdResetEvent2 = loader.apply("vkCmdResetEvent2");
        HANDLE$vkCmdResetEvent2 = RawFunctionLoader.link(SEGMENTvkCmdResetEvent2, DESCRIPTOR$vkCmdResetEvent2);
        SEGMENT$vkCmdWaitEvents2 = loader.apply("vkCmdWaitEvents2");
        HANDLE$vkCmdWaitEvents2 = RawFunctionLoader.link(SEGMENTvkCmdWaitEvents2, DESCRIPTOR$vkCmdWaitEvents2);
        SEGMENT$vkCmdPipelineBarrier2 = loader.apply("vkCmdPipelineBarrier2");
        HANDLE$vkCmdPipelineBarrier2 = RawFunctionLoader.link(SEGMENTvkCmdPipelineBarrier2, DESCRIPTOR$vkCmdPipelineBarrier2);
        SEGMENT$vkQueueSubmit2 = loader.apply("vkQueueSubmit2");
        HANDLE$vkQueueSubmit2 = RawFunctionLoader.link(SEGMENTvkQueueSubmit2, DESCRIPTOR$vkQueueSubmit2);
        SEGMENT$vkCmdWriteTimestamp2 = loader.apply("vkCmdWriteTimestamp2");
        HANDLE$vkCmdWriteTimestamp2 = RawFunctionLoader.link(SEGMENTvkCmdWriteTimestamp2, DESCRIPTOR$vkCmdWriteTimestamp2);
        SEGMENT$vkCmdWriteBufferMarker2AMD = loader.apply("vkCmdWriteBufferMarker2AMD");
        HANDLE$vkCmdWriteBufferMarker2AMD = RawFunctionLoader.link(SEGMENTvkCmdWriteBufferMarker2AMD, DESCRIPTOR$vkCmdWriteBufferMarker2AMD);
        SEGMENT$vkGetQueueCheckpointData2NV = loader.apply("vkGetQueueCheckpointData2NV");
        HANDLE$vkGetQueueCheckpointData2NV = RawFunctionLoader.link(SEGMENTvkGetQueueCheckpointData2NV, DESCRIPTOR$vkGetQueueCheckpointData2NV);
        SEGMENT$vkCopyMemoryToImageEXT = loader.apply("vkCopyMemoryToImageEXT");
        HANDLE$vkCopyMemoryToImageEXT = RawFunctionLoader.link(SEGMENTvkCopyMemoryToImageEXT, DESCRIPTOR$vkCopyMemoryToImageEXT);
        SEGMENT$vkCopyImageToMemoryEXT = loader.apply("vkCopyImageToMemoryEXT");
        HANDLE$vkCopyImageToMemoryEXT = RawFunctionLoader.link(SEGMENTvkCopyImageToMemoryEXT, DESCRIPTOR$vkCopyImageToMemoryEXT);
        SEGMENT$vkCopyImageToImageEXT = loader.apply("vkCopyImageToImageEXT");
        HANDLE$vkCopyImageToImageEXT = RawFunctionLoader.link(SEGMENTvkCopyImageToImageEXT, DESCRIPTOR$vkCopyImageToImageEXT);
        SEGMENT$vkTransitionImageLayoutEXT = loader.apply("vkTransitionImageLayoutEXT");
        HANDLE$vkTransitionImageLayoutEXT = RawFunctionLoader.link(SEGMENTvkTransitionImageLayoutEXT, DESCRIPTOR$vkTransitionImageLayoutEXT);
        SEGMENT$vkCmdDecompressMemoryNV = loader.apply("vkCmdDecompressMemoryNV");
        HANDLE$vkCmdDecompressMemoryNV = RawFunctionLoader.link(SEGMENTvkCmdDecompressMemoryNV, DESCRIPTOR$vkCmdDecompressMemoryNV);
        SEGMENT$vkCmdDecompressMemoryIndirectCountNV = loader.apply("vkCmdDecompressMemoryIndirectCountNV");
        HANDLE$vkCmdDecompressMemoryIndirectCountNV = RawFunctionLoader.link(SEGMENTvkCmdDecompressMemoryIndirectCountNV, DESCRIPTOR$vkCmdDecompressMemoryIndirectCountNV);
        SEGMENT$vkCreateCuModuleNVX = loader.apply("vkCreateCuModuleNVX");
        HANDLE$vkCreateCuModuleNVX = RawFunctionLoader.link(SEGMENTvkCreateCuModuleNVX, DESCRIPTOR$vkCreateCuModuleNVX);
        SEGMENT$vkCreateCuFunctionNVX = loader.apply("vkCreateCuFunctionNVX");
        HANDLE$vkCreateCuFunctionNVX = RawFunctionLoader.link(SEGMENTvkCreateCuFunctionNVX, DESCRIPTOR$vkCreateCuFunctionNVX);
        SEGMENT$vkDestroyCuModuleNVX = loader.apply("vkDestroyCuModuleNVX");
        HANDLE$vkDestroyCuModuleNVX = RawFunctionLoader.link(SEGMENTvkDestroyCuModuleNVX, DESCRIPTOR$vkDestroyCuModuleNVX);
        SEGMENT$vkDestroyCuFunctionNVX = loader.apply("vkDestroyCuFunctionNVX");
        HANDLE$vkDestroyCuFunctionNVX = RawFunctionLoader.link(SEGMENTvkDestroyCuFunctionNVX, DESCRIPTOR$vkDestroyCuFunctionNVX);
        SEGMENT$vkCmdCuLaunchKernelNVX = loader.apply("vkCmdCuLaunchKernelNVX");
        HANDLE$vkCmdCuLaunchKernelNVX = RawFunctionLoader.link(SEGMENTvkCmdCuLaunchKernelNVX, DESCRIPTOR$vkCmdCuLaunchKernelNVX);
        SEGMENT$vkGetDescriptorSetLayoutSizeEXT = loader.apply("vkGetDescriptorSetLayoutSizeEXT");
        HANDLE$vkGetDescriptorSetLayoutSizeEXT = RawFunctionLoader.link(SEGMENTvkGetDescriptorSetLayoutSizeEXT, DESCRIPTOR$vkGetDescriptorSetLayoutSizeEXT);
        SEGMENT$vkGetDescriptorSetLayoutBindingOffsetEXT = loader.apply("vkGetDescriptorSetLayoutBindingOffsetEXT");
        HANDLE$vkGetDescriptorSetLayoutBindingOffsetEXT = RawFunctionLoader.link(SEGMENTvkGetDescriptorSetLayoutBindingOffsetEXT, DESCRIPTOR$vkGetDescriptorSetLayoutBindingOffsetEXT);
        SEGMENT$vkGetDescriptorEXT = loader.apply("vkGetDescriptorEXT");
        HANDLE$vkGetDescriptorEXT = RawFunctionLoader.link(SEGMENTvkGetDescriptorEXT, DESCRIPTOR$vkGetDescriptorEXT);
        SEGMENT$vkCmdBindDescriptorBuffersEXT = loader.apply("vkCmdBindDescriptorBuffersEXT");
        HANDLE$vkCmdBindDescriptorBuffersEXT = RawFunctionLoader.link(SEGMENTvkCmdBindDescriptorBuffersEXT, DESCRIPTOR$vkCmdBindDescriptorBuffersEXT);
        SEGMENT$vkCmdSetDescriptorBufferOffsetsEXT = loader.apply("vkCmdSetDescriptorBufferOffsetsEXT");
        HANDLE$vkCmdSetDescriptorBufferOffsetsEXT = RawFunctionLoader.link(SEGMENTvkCmdSetDescriptorBufferOffsetsEXT, DESCRIPTOR$vkCmdSetDescriptorBufferOffsetsEXT);
        SEGMENT$vkCmdBindDescriptorBufferEmbeddedSamplersEXT = loader.apply("vkCmdBindDescriptorBufferEmbeddedSamplersEXT");
        HANDLE$vkCmdBindDescriptorBufferEmbeddedSamplersEXT = RawFunctionLoader.link(SEGMENTvkCmdBindDescriptorBufferEmbeddedSamplersEXT, DESCRIPTOR$vkCmdBindDescriptorBufferEmbeddedSamplersEXT);
        SEGMENT$vkGetBufferOpaqueCaptureDescriptorDataEXT = loader.apply("vkGetBufferOpaqueCaptureDescriptorDataEXT");
        HANDLE$vkGetBufferOpaqueCaptureDescriptorDataEXT = RawFunctionLoader.link(SEGMENTvkGetBufferOpaqueCaptureDescriptorDataEXT, DESCRIPTOR$vkGetBufferOpaqueCaptureDescriptorDataEXT);
        SEGMENT$vkGetImageOpaqueCaptureDescriptorDataEXT = loader.apply("vkGetImageOpaqueCaptureDescriptorDataEXT");
        HANDLE$vkGetImageOpaqueCaptureDescriptorDataEXT = RawFunctionLoader.link(SEGMENTvkGetImageOpaqueCaptureDescriptorDataEXT, DESCRIPTOR$vkGetImageOpaqueCaptureDescriptorDataEXT);
        SEGMENT$vkGetImageViewOpaqueCaptureDescriptorDataEXT = loader.apply("vkGetImageViewOpaqueCaptureDescriptorDataEXT");
        HANDLE$vkGetImageViewOpaqueCaptureDescriptorDataEXT = RawFunctionLoader.link(SEGMENTvkGetImageViewOpaqueCaptureDescriptorDataEXT, DESCRIPTOR$vkGetImageViewOpaqueCaptureDescriptorDataEXT);
        SEGMENT$vkGetSamplerOpaqueCaptureDescriptorDataEXT = loader.apply("vkGetSamplerOpaqueCaptureDescriptorDataEXT");
        HANDLE$vkGetSamplerOpaqueCaptureDescriptorDataEXT = RawFunctionLoader.link(SEGMENTvkGetSamplerOpaqueCaptureDescriptorDataEXT, DESCRIPTOR$vkGetSamplerOpaqueCaptureDescriptorDataEXT);
        ...
        HANDLE$vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT = RawFunctionLoader.link(SEGMENTvkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT, DESCRIPTOR$vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT);
        SEGMENT$vkSetDeviceMemoryPriorityEXT = loader.apply("vkSetDeviceMemoryPriorityEXT");
        HANDLE$vkSetDeviceMemoryPriorityEXT = RawFunctionLoader.link(SEGMENTvkSetDeviceMemoryPriorityEXT, DESCRIPTOR$vkSetDeviceMemoryPriorityEXT);
        SEGMENT$vkWaitForPresentKHR = loader.apply("vkWaitForPresentKHR");
        HANDLE$vkWaitForPresentKHR = RawFunctionLoader.link(SEGMENTvkWaitForPresentKHR, DESCRIPTOR$vkWaitForPresentKHR);
        SEGMENT$vkCreateBufferCollectionFUCHSIA = loader.apply("vkCreateBufferCollectionFUCHSIA");
        HANDLE$vkCreateBufferCollectionFUCHSIA = RawFunctionLoader.link(SEGMENTvkCreateBufferCollectionFUCHSIA, DESCRIPTOR$vkCreateBufferCollectionFUCHSIA);
        SEGMENT$vkSetBufferCollectionBufferConstraintsFUCHSIA = loader.apply("vkSetBufferCollectionBufferConstraintsFUCHSIA");
        HANDLE$vkSetBufferCollectionBufferConstraintsFUCHSIA = RawFunctionLoader.link(SEGMENTvkSetBufferCollectionBufferConstraintsFUCHSIA, DESCRIPTOR$vkSetBufferCollectionBufferConstraintsFUCHSIA);
        SEGMENT$vkSetBufferCollectionImageConstraintsFUCHSIA = loader.apply("vkSetBufferCollectionImageConstraintsFUCHSIA");
        HANDLE$vkSetBufferCollectionImageConstraintsFUCHSIA = RawFunctionLoader.link(SEGMENTvkSetBufferCollectionImageConstraintsFUCHSIA, DESCRIPTOR$vkSetBufferCollectionImageConstraintsFUCHSIA);
        SEGMENT$vkDestroyBufferCollectionFUCHSIA = loader.apply("vkDestroyBufferCollectionFUCHSIA");
        HANDLE$vkDestroyBufferCollectionFUCHSIA = RawFunctionLoader.link(SEGMENTvkDestroyBufferCollectionFUCHSIA, DESCRIPTOR$vkDestroyBufferCollectionFUCHSIA);
        SEGMENT$vkGetBufferCollectionPropertiesFUCHSIA = loader.apply("vkGetBufferCollectionPropertiesFUCHSIA");
        HANDLE$vkGetBufferCollectionPropertiesFUCHSIA = RawFunctionLoader.link(SEGMENTvkGetBufferCollectionPropertiesFUCHSIA, DESCRIPTOR$vkGetBufferCollectionPropertiesFUCHSIA);
        SEGMENT$vkCreateCudaModuleNV = loader.apply("vkCreateCudaModuleNV");
        HANDLE$vkCreateCudaModuleNV = RawFunctionLoader.link(SEGMENTvkCreateCudaModuleNV, DESCRIPTOR$vkCreateCudaModuleNV);
        SEGMENT$vkGetCudaModuleCacheNV = loader.apply("vkGetCudaModuleCacheNV");
        HANDLE$vkGetCudaModuleCacheNV = RawFunctionLoader.link(SEGMENTvkGetCudaModuleCacheNV, DESCRIPTOR$vkGetCudaModuleCacheNV);
        SEGMENT$vkCreateCudaFunctionNV = loader.apply("vkCreateCudaFunctionNV");
        HANDLE$vkCreateCudaFunctionNV = RawFunctionLoader.link(SEGMENTvkCreateCudaFunctionNV, DESCRIPTOR$vkCreateCudaFunctionNV);
        SEGMENT$vkDestroyCudaModuleNV = loader.apply("vkDestroyCudaModuleNV");
        HANDLE$vkDestroyCudaModuleNV = RawFunctionLoader.link(SEGMENTvkDestroyCudaModuleNV, DESCRIPTOR$vkDestroyCudaModuleNV);
        SEGMENT$vkDestroyCudaFunctionNV = loader.apply("vkDestroyCudaFunctionNV");
        HANDLE$vkDestroyCudaFunctionNV = RawFunctionLoader.link(SEGMENTvkDestroyCudaFunctionNV, DESCRIPTOR$vkDestroyCudaFunctionNV);
        SEGMENT$vkCmdCudaLaunchKernelNV = loader.apply("vkCmdCudaLaunchKernelNV");
        HANDLE$vkCmdCudaLaunchKernelNV = RawFunctionLoader.link(SEGMENTvkCmdCudaLaunchKernelNV, DESCRIPTOR$vkCmdCudaLaunchKernelNV);
        SEGMENT$vkCmdBeginRendering = loader.apply("vkCmdBeginRendering");
        HANDLE$vkCmdBeginRendering = RawFunctionLoader.link(SEGMENTvkCmdBeginRendering, DESCRIPTOR$vkCmdBeginRendering);
        SEGMENT$vkCmdEndRendering = loader.apply("vkCmdEndRendering");
        HANDLE$vkCmdEndRendering = RawFunctionLoader.link(SEGMENTvkCmdEndRendering, DESCRIPTOR$vkCmdEndRendering);
        SEGMENT$vkGetDescriptorSetLayoutHostMappingInfoVALVE = loader.apply("vkGetDescriptorSetLayoutHostMappingInfoVALVE");
        HANDLE$vkGetDescriptorSetLayoutHostMappingInfoVALVE = RawFunctionLoader.link(SEGMENTvkGetDescriptorSetLayoutHostMappingInfoVALVE, DESCRIPTOR$vkGetDescriptorSetLayoutHostMappingInfoVALVE);
        SEGMENT$vkGetDescriptorSetHostMappingVALVE = loader.apply("vkGetDescriptorSetHostMappingVALVE");
        HANDLE$vkGetDescriptorSetHostMappingVALVE = RawFunctionLoader.link(SEGMENTvkGetDescriptorSetHostMappingVALVE, DESCRIPTOR$vkGetDescriptorSetHostMappingVALVE);
        SEGMENT$vkCreateMicromapEXT = loader.apply("vkCreateMicromapEXT");
        HANDLE$vkCreateMicromapEXT = RawFunctionLoader.link(SEGMENTvkCreateMicromapEXT, DESCRIPTOR$vkCreateMicromapEXT);
        SEGMENT$vkCmdBuildMicromapsEXT = loader.apply("vkCmdBuildMicromapsEXT");
        HANDLE$vkCmdBuildMicromapsEXT = RawFunctionLoader.link(SEGMENTvkCmdBuildMicromapsEXT, DESCRIPTOR$vkCmdBuildMicromapsEXT);
        SEGMENT$vkBuildMicromapsEXT = loader.apply("vkBuildMicromapsEXT");
        HANDLE$vkBuildMicromapsEXT = RawFunctionLoader.link(SEGMENTvkBuildMicromapsEXT, DESCRIPTOR$vkBuildMicromapsEXT);
        SEGMENT$vkDestroyMicromapEXT = loader.apply("vkDestroyMicromapEXT");
        HANDLE$vkDestroyMicromapEXT = RawFunctionLoader.link(SEGMENTvkDestroyMicromapEXT, DESCRIPTOR$vkDestroyMicromapEXT);
        SEGMENT$vkCmdCopyMicromapEXT = loader.apply("vkCmdCopyMicromapEXT");
        HANDLE$vkCmdCopyMicromapEXT = RawFunctionLoader.link(SEGMENTvkCmdCopyMicromapEXT, DESCRIPTOR$vkCmdCopyMicromapEXT);
        SEGMENT$vkCopyMicromapEXT = loader.apply("vkCopyMicromapEXT");
        HANDLE$vkCopyMicromapEXT = RawFunctionLoader.link(SEGMENTvkCopyMicromapEXT, DESCRIPTOR$vkCopyMicromapEXT);
        SEGMENT$vkCmdCopyMicromapToMemoryEXT = loader.apply("vkCmdCopyMicromapToMemoryEXT");
        HANDLE$vkCmdCopyMicromapToMemoryEXT = RawFunctionLoader.link(SEGMENTvkCmdCopyMicromapToMemoryEXT, DESCRIPTOR$vkCmdCopyMicromapToMemoryEXT);
        SEGMENT$vkCopyMicromapToMemoryEXT = loader.apply("vkCopyMicromapToMemoryEXT");
        HANDLE$vkCopyMicromapToMemoryEXT = RawFunctionLoader.link(SEGMENTvkCopyMicromapToMemoryEXT, DESCRIPTOR$vkCopyMicromapToMemoryEXT);
        SEGMENT$vkCmdCopyMemoryToMicromapEXT = loader.apply("vkCmdCopyMemoryToMicromapEXT");
        HANDLE$vkCmdCopyMemoryToMicromapEXT = RawFunctionLoader.link(SEGMENTvkCmdCopyMemoryToMicromapEXT, DESCRIPTOR$vkCmdCopyMemoryToMicromapEXT);
        SEGMENT$vkCopyMemoryToMicromapEXT = loader.apply("vkCopyMemoryToMicromapEXT");
        HANDLE$vkCopyMemoryToMicromapEXT = RawFunctionLoader.link(SEGMENTvkCopyMemoryToMicromapEXT, DESCRIPTOR$vkCopyMemoryToMicromapEXT);
        SEGMENT$vkCmdWriteMicromapsPropertiesEXT = loader.apply("vkCmdWriteMicromapsPropertiesEXT");
        HANDLE$vkCmdWriteMicromapsPropertiesEXT = RawFunctionLoader.link(SEGMENTvkCmdWriteMicromapsPropertiesEXT, DESCRIPTOR$vkCmdWriteMicromapsPropertiesEXT);
        SEGMENT$vkWriteMicromapsPropertiesEXT = loader.apply("vkWriteMicromapsPropertiesEXT");
        HANDLE$vkWriteMicromapsPropertiesEXT = RawFunctionLoader.link(SEGMENTvkWriteMicromapsPropertiesEXT, DESCRIPTOR$vkWriteMicromapsPropertiesEXT);
        SEGMENT$vkGetDeviceMicromapCompatibilityEXT = loader.apply("vkGetDeviceMicromapCompatibilityEXT");
        HANDLE$vkGetDeviceMicromapCompatibilityEXT = RawFunctionLoader.link(SEGMENTvkGetDeviceMicromapCompatibilityEXT, DESCRIPTOR$vkGetDeviceMicromapCompatibilityEXT);
        SEGMENT$vkGetMicromapBuildSizesEXT = loader.apply("vkGetMicromapBuildSizesEXT");
        HANDLE$vkGetMicromapBuildSizesEXT = RawFunctionLoader.link(SEGMENTvkGetMicromapBuildSizesEXT, DESCRIPTOR$vkGetMicromapBuildSizesEXT);
        SEGMENT$vkGetShaderModuleIdentifierEXT = loader.apply("vkGetShaderModuleIdentifierEXT");
        HANDLE$vkGetShaderModuleIdentifierEXT = RawFunctionLoader.link(SEGMENTvkGetShaderModuleIdentifierEXT, DESCRIPTOR$vkGetShaderModuleIdentifierEXT);
        SEGMENT$vkGetShaderModuleCreateInfoIdentifierEXT = loader.apply("vkGetShaderModuleCreateInfoIdentifierEXT");
        HANDLE$vkGetShaderModuleCreateInfoIdentifierEXT = RawFunctionLoader.link(SEGMENTvkGetShaderModuleCreateInfoIdentifierEXT, DESCRIPTOR$vkGetShaderModuleCreateInfoIdentifierEXT);
        SEGMENT$vkGetImageSubresourceLayout2KHR = loader.apply("vkGetImageSubresourceLayout2KHR");
        HANDLE$vkGetImageSubresourceLayout2KHR = RawFunctionLoader.link(SEGMENTvkGetImageSubresourceLayout2KHR, DESCRIPTOR$vkGetImageSubresourceLayout2KHR);
        SEGMENT$vkGetPipelinePropertiesEXT = loader.apply("vkGetPipelinePropertiesEXT");
        HANDLE$vkGetPipelinePropertiesEXT = RawFunctionLoader.link(SEGMENTvkGetPipelinePropertiesEXT, DESCRIPTOR$vkGetPipelinePropertiesEXT);
        SEGMENT$vkExportMetalObjectsEXT = loader.apply("vkExportMetalObjectsEXT");
        HANDLE$vkExportMetalObjectsEXT = RawFunctionLoader.link(SEGMENTvkExportMetalObjectsEXT, DESCRIPTOR$vkExportMetalObjectsEXT);
        SEGMENT$vkGetFramebufferTilePropertiesQCOM = loader.apply("vkGetFramebufferTilePropertiesQCOM");
        HANDLE$vkGetFramebufferTilePropertiesQCOM = RawFunctionLoader.link(SEGMENTvkGetFramebufferTilePropertiesQCOM, DESCRIPTOR$vkGetFramebufferTilePropertiesQCOM);
        SEGMENT$vkGetDynamicRenderingTilePropertiesQCOM = loader.apply("vkGetDynamicRenderingTilePropertiesQCOM");
        HANDLE$vkGetDynamicRenderingTilePropertiesQCOM = RawFunctionLoader.link(SEGMENTvkGetDynamicRenderingTilePropertiesQCOM, DESCRIPTOR$vkGetDynamicRenderingTilePropertiesQCOM);
        SEGMENT$vkGetPhysicalDeviceOpticalFlowImageFormatsNV = loader.apply("vkGetPhysicalDeviceOpticalFlowImageFormatsNV");
        HANDLE$vkGetPhysicalDeviceOpticalFlowImageFormatsNV = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceOpticalFlowImageFormatsNV, DESCRIPTOR$vkGetPhysicalDeviceOpticalFlowImageFormatsNV);
        SEGMENT$vkCreateOpticalFlowSessionNV = loader.apply("vkCreateOpticalFlowSessionNV");
        HANDLE$vkCreateOpticalFlowSessionNV = RawFunctionLoader.link(SEGMENTvkCreateOpticalFlowSessionNV, DESCRIPTOR$vkCreateOpticalFlowSessionNV);
        SEGMENT$vkDestroyOpticalFlowSessionNV = loader.apply("vkDestroyOpticalFlowSessionNV");
        HANDLE$vkDestroyOpticalFlowSessionNV = RawFunctionLoader.link(SEGMENTvkDestroyOpticalFlowSessionNV, DESCRIPTOR$vkDestroyOpticalFlowSessionNV);
        SEGMENT$vkBindOpticalFlowSessionImageNV = loader.apply("vkBindOpticalFlowSessionImageNV");
        HANDLE$vkBindOpticalFlowSessionImageNV = RawFunctionLoader.link(SEGMENTvkBindOpticalFlowSessionImageNV, DESCRIPTOR$vkBindOpticalFlowSessionImageNV);
        SEGMENT$vkCmdOpticalFlowExecuteNV = loader.apply("vkCmdOpticalFlowExecuteNV");
        HANDLE$vkCmdOpticalFlowExecuteNV = RawFunctionLoader.link(SEGMENTvkCmdOpticalFlowExecuteNV, DESCRIPTOR$vkCmdOpticalFlowExecuteNV);
        SEGMENT$vkGetDeviceFaultInfoEXT = loader.apply("vkGetDeviceFaultInfoEXT");
        HANDLE$vkGetDeviceFaultInfoEXT = RawFunctionLoader.link(SEGMENTvkGetDeviceFaultInfoEXT, DESCRIPTOR$vkGetDeviceFaultInfoEXT);
        SEGMENT$vkCmdSetDepthBias2EXT = loader.apply("vkCmdSetDepthBias2EXT");
        HANDLE$vkCmdSetDepthBias2EXT = RawFunctionLoader.link(SEGMENTvkCmdSetDepthBias2EXT, DESCRIPTOR$vkCmdSetDepthBias2EXT);
        SEGMENT$vkReleaseSwapchainImagesEXT = loader.apply("vkReleaseSwapchainImagesEXT");
        HANDLE$vkReleaseSwapchainImagesEXT = RawFunctionLoader.link(SEGMENTvkReleaseSwapchainImagesEXT, DESCRIPTOR$vkReleaseSwapchainImagesEXT);
        SEGMENT$vkGetDeviceImageSubresourceLayoutKHR = loader.apply("vkGetDeviceImageSubresourceLayoutKHR");
        HANDLE$vkGetDeviceImageSubresourceLayoutKHR = RawFunctionLoader.link(SEGMENTvkGetDeviceImageSubresourceLayoutKHR, DESCRIPTOR$vkGetDeviceImageSubresourceLayoutKHR);
        SEGMENT$vkMapMemory2KHR = loader.apply("vkMapMemory2KHR");
        HANDLE$vkMapMemory2KHR = RawFunctionLoader.link(SEGMENTvkMapMemory2KHR, DESCRIPTOR$vkMapMemory2KHR);
        SEGMENT$vkUnmapMemory2KHR = loader.apply("vkUnmapMemory2KHR");
        HANDLE$vkUnmapMemory2KHR = RawFunctionLoader.link(SEGMENTvkUnmapMemory2KHR, DESCRIPTOR$vkUnmapMemory2KHR);
        SEGMENT$vkCreateShadersEXT = loader.apply("vkCreateShadersEXT");
        HANDLE$vkCreateShadersEXT = RawFunctionLoader.link(SEGMENTvkCreateShadersEXT, DESCRIPTOR$vkCreateShadersEXT);
        SEGMENT$vkDestroyShaderEXT = loader.apply("vkDestroyShaderEXT");
        HANDLE$vkDestroyShaderEXT = RawFunctionLoader.link(SEGMENTvkDestroyShaderEXT, DESCRIPTOR$vkDestroyShaderEXT);
        SEGMENT$vkGetShaderBinaryDataEXT = loader.apply("vkGetShaderBinaryDataEXT");
        HANDLE$vkGetShaderBinaryDataEXT = RawFunctionLoader.link(SEGMENTvkGetShaderBinaryDataEXT, DESCRIPTOR$vkGetShaderBinaryDataEXT);
        SEGMENT$vkCmdBindShadersEXT = loader.apply("vkCmdBindShadersEXT");
        HANDLE$vkCmdBindShadersEXT = RawFunctionLoader.link(SEGMENTvkCmdBindShadersEXT, DESCRIPTOR$vkCmdBindShadersEXT);
        SEGMENT$vkGetScreenBufferPropertiesQNX = loader.apply("vkGetScreenBufferPropertiesQNX");
        HANDLE$vkGetScreenBufferPropertiesQNX = RawFunctionLoader.link(SEGMENTvkGetScreenBufferPropertiesQNX, DESCRIPTOR$vkGetScreenBufferPropertiesQNX);
        SEGMENT$vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR = loader.apply("vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR");
        HANDLE$vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceCooperativeMatrixPropertiesKHR, DESCRIPTOR$vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR);
        SEGMENT$vkGetExecutionGraphPipelineScratchSizeAMDX = loader.apply("vkGetExecutionGraphPipelineScratchSizeAMDX");
        HANDLE$vkGetExecutionGraphPipelineScratchSizeAMDX = RawFunctionLoader.link(SEGMENTvkGetExecutionGraphPipelineScratchSizeAMDX, DESCRIPTOR$vkGetExecutionGraphPipelineScratchSizeAMDX);
        SEGMENT$vkGetExecutionGraphPipelineNodeIndexAMDX = loader.apply("vkGetExecutionGraphPipelineNodeIndexAMDX");
        HANDLE$vkGetExecutionGraphPipelineNodeIndexAMDX = RawFunctionLoader.link(SEGMENTvkGetExecutionGraphPipelineNodeIndexAMDX, DESCRIPTOR$vkGetExecutionGraphPipelineNodeIndexAMDX);
        SEGMENT$vkCreateExecutionGraphPipelinesAMDX = loader.apply("vkCreateExecutionGraphPipelinesAMDX");
        HANDLE$vkCreateExecutionGraphPipelinesAMDX = RawFunctionLoader.link(SEGMENTvkCreateExecutionGraphPipelinesAMDX, DESCRIPTOR$vkCreateExecutionGraphPipelinesAMDX);
        SEGMENT$vkCmdInitializeGraphScratchMemoryAMDX = loader.apply("vkCmdInitializeGraphScratchMemoryAMDX");
        HANDLE$vkCmdInitializeGraphScratchMemoryAMDX = RawFunctionLoader.link(SEGMENTvkCmdInitializeGraphScratchMemoryAMDX, DESCRIPTOR$vkCmdInitializeGraphScratchMemoryAMDX);
        SEGMENT$vkCmdDispatchGraphAMDX = loader.apply("vkCmdDispatchGraphAMDX");
        HANDLE$vkCmdDispatchGraphAMDX = RawFunctionLoader.link(SEGMENTvkCmdDispatchGraphAMDX, DESCRIPTOR$vkCmdDispatchGraphAMDX);
        SEGMENT$vkCmdDispatchGraphIndirectAMDX = loader.apply("vkCmdDispatchGraphIndirectAMDX");
        HANDLE$vkCmdDispatchGraphIndirectAMDX = RawFunctionLoader.link(SEGMENTvkCmdDispatchGraphIndirectAMDX, DESCRIPTOR$vkCmdDispatchGraphIndirectAMDX);
        SEGMENT$vkCmdDispatchGraphIndirectCountAMDX = loader.apply("vkCmdDispatchGraphIndirectCountAMDX");
        HANDLE$vkCmdDispatchGraphIndirectCountAMDX = RawFunctionLoader.link(SEGMENTvkCmdDispatchGraphIndirectCountAMDX, DESCRIPTOR$vkCmdDispatchGraphIndirectCountAMDX);
        SEGMENT$vkCmdBindDescriptorSets2KHR = loader.apply("vkCmdBindDescriptorSets2KHR");
        HANDLE$vkCmdBindDescriptorSets2KHR = RawFunctionLoader.link(SEGMENTvkCmdBindDescriptorSets2KHR, DESCRIPTOR$vkCmdBindDescriptorSets2KHR);
        SEGMENT$vkCmdPushConstants2KHR = loader.apply("vkCmdPushConstants2KHR");
        HANDLE$vkCmdPushConstants2KHR = RawFunctionLoader.link(SEGMENTvkCmdPushConstants2KHR, DESCRIPTOR$vkCmdPushConstants2KHR);
        SEGMENT$vkCmdPushDescriptorSet2KHR = loader.apply("vkCmdPushDescriptorSet2KHR");
        HANDLE$vkCmdPushDescriptorSet2KHR = RawFunctionLoader.link(SEGMENTvkCmdPushDescriptorSet2KHR, DESCRIPTOR$vkCmdPushDescriptorSet2KHR);
        SEGMENT$vkCmdPushDescriptorSetWithTemplate2KHR = loader.apply("vkCmdPushDescriptorSetWithTemplate2KHR");
        HANDLE$vkCmdPushDescriptorSetWithTemplate2KHR = RawFunctionLoader.link(SEGMENTvkCmdPushDescriptorSetWithTemplate2KHR, DESCRIPTOR$vkCmdPushDescriptorSetWithTemplate2KHR);
        SEGMENT$vkCmdSetDescriptorBufferOffsets2EXT = loader.apply("vkCmdSetDescriptorBufferOffsets2EXT");
        HANDLE$vkCmdSetDescriptorBufferOffsets2EXT = RawFunctionLoader.link(SEGMENTvkCmdSetDescriptorBufferOffsets2EXT, DESCRIPTOR$vkCmdSetDescriptorBufferOffsets2EXT);
        SEGMENT$vkCmdBindDescriptorBufferEmbeddedSamplers2EXT = loader.apply("vkCmdBindDescriptorBufferEmbeddedSamplers2EXT");
        HANDLE$vkCmdBindDescriptorBufferEmbeddedSamplers2EXT = RawFunctionLoader.link(SEGMENTvkCmdBindDescriptorBufferEmbeddedSamplers2EXT, DESCRIPTOR$vkCmdBindDescriptorBufferEmbeddedSamplers2EXT);
        SEGMENT$vkSetLatencySleepModeNV = loader.apply("vkSetLatencySleepModeNV");
        HANDLE$vkSetLatencySleepModeNV = RawFunctionLoader.link(SEGMENTvkSetLatencySleepModeNV, DESCRIPTOR$vkSetLatencySleepModeNV);
        SEGMENT$vkLatencySleepNV = loader.apply("vkLatencySleepNV");
        HANDLE$vkLatencySleepNV = RawFunctionLoader.link(SEGMENTvkLatencySleepNV, DESCRIPTOR$vkLatencySleepNV);
        SEGMENT$vkSetLatencyMarkerNV = loader.apply("vkSetLatencyMarkerNV");
        HANDLE$vkSetLatencyMarkerNV = RawFunctionLoader.link(SEGMENTvkSetLatencyMarkerNV, DESCRIPTOR$vkSetLatencyMarkerNV);
        SEGMENT$vkGetLatencyTimingsNV = loader.apply("vkGetLatencyTimingsNV");
        HANDLE$vkGetLatencyTimingsNV = RawFunctionLoader.link(SEGMENTvkGetLatencyTimingsNV, DESCRIPTOR$vkGetLatencyTimingsNV);
        SEGMENT$vkQueueNotifyOutOfBandNV = loader.apply("vkQueueNotifyOutOfBandNV");
        HANDLE$vkQueueNotifyOutOfBandNV = RawFunctionLoader.link(SEGMENTvkQueueNotifyOutOfBandNV, DESCRIPTOR$vkQueueNotifyOutOfBandNV);
        SEGMENT$vkCmdSetRenderingAttachmentLocationsKHR = loader.apply("vkCmdSetRenderingAttachmentLocationsKHR");
        HANDLE$vkCmdSetRenderingAttachmentLocationsKHR = RawFunctionLoader.link(SEGMENTvkCmdSetRenderingAttachmentLocationsKHR, DESCRIPTOR$vkCmdSetRenderingAttachmentLocationsKHR);
        SEGMENT$vkCmdSetRenderingInputAttachmentIndicesKHR = loader.apply("vkCmdSetRenderingInputAttachmentIndicesKHR");
        HANDLE$vkCmdSetRenderingInputAttachmentIndicesKHR = RawFunctionLoader.link(SEGMENTvkCmdSetRenderingInputAttachmentIndicesKHR, DESCRIPTOR$vkCmdSetRenderingInputAttachmentIndicesKHR);
    }

...
public final class InstanceCommands {
    ...
    public InstanceCommands(RawFunctionLoader loader) {
        ...
        HANDLE$vkDestroyInstance = RawFunctionLoader.link(SEGMENTvkDestroyInstance, DESCRIPTOR$vkDestroyInstance);
        SEGMENT$vkEnumeratePhysicalDevices = loader.apply("vkEnumeratePhysicalDevices");
        HANDLE$vkEnumeratePhysicalDevices = RawFunctionLoader.link(SEGMENTvkEnumeratePhysicalDevices, DESCRIPTOR$vkEnumeratePhysicalDevices);
        SEGMENT$vkGetPhysicalDeviceProperties = loader.apply("vkGetPhysicalDeviceProperties");
        HANDLE$vkGetPhysicalDeviceProperties = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceProperties, DESCRIPTOR$vkGetPhysicalDeviceProperties);
        SEGMENT$vkGetPhysicalDeviceQueueFamilyProperties = loader.apply("vkGetPhysicalDeviceQueueFamilyProperties");
        HANDLE$vkGetPhysicalDeviceQueueFamilyProperties = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceQueueFamilyProperties, DESCRIPTOR$vkGetPhysicalDeviceQueueFamilyProperties);
        SEGMENT$vkGetPhysicalDeviceMemoryProperties = loader.apply("vkGetPhysicalDeviceMemoryProperties");
        HANDLE$vkGetPhysicalDeviceMemoryProperties = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceMemoryProperties, DESCRIPTOR$vkGetPhysicalDeviceMemoryProperties);
        SEGMENT$vkGetPhysicalDeviceFeatures = loader.apply("vkGetPhysicalDeviceFeatures");
        HANDLE$vkGetPhysicalDeviceFeatures = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceFeatures, DESCRIPTOR$vkGetPhysicalDeviceFeatures);
        SEGMENT$vkGetPhysicalDeviceFormatProperties = loader.apply("vkGetPhysicalDeviceFormatProperties");
        HANDLE$vkGetPhysicalDeviceFormatProperties = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceFormatProperties, DESCRIPTOR$vkGetPhysicalDeviceFormatProperties);
        SEGMENT$vkGetPhysicalDeviceImageFormatProperties = loader.apply("vkGetPhysicalDeviceImageFormatProperties");
        HANDLE$vkGetPhysicalDeviceImageFormatProperties = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceImageFormatProperties, DESCRIPTOR$vkGetPhysicalDeviceImageFormatProperties);
        SEGMENT$vkCreateDevice = loader.apply("vkCreateDevice");
        HANDLE$vkCreateDevice = RawFunctionLoader.link(SEGMENTvkCreateDevice, DESCRIPTOR$vkCreateDevice);
        SEGMENT$vkEnumerateDeviceLayerProperties = loader.apply("vkEnumerateDeviceLayerProperties");
        HANDLE$vkEnumerateDeviceLayerProperties = RawFunctionLoader.link(SEGMENTvkEnumerateDeviceLayerProperties, DESCRIPTOR$vkEnumerateDeviceLayerProperties);
        SEGMENT$vkEnumerateDeviceExtensionProperties = loader.apply("vkEnumerateDeviceExtensionProperties");
        HANDLE$vkEnumerateDeviceExtensionProperties = RawFunctionLoader.link(SEGMENTvkEnumerateDeviceExtensionProperties, DESCRIPTOR$vkEnumerateDeviceExtensionProperties);
        SEGMENT$vkGetPhysicalDeviceSparseImageFormatProperties = loader.apply("vkGetPhysicalDeviceSparseImageFormatProperties");
        HANDLE$vkGetPhysicalDeviceSparseImageFormatProperties = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSparseImageFormatProperties, DESCRIPTOR$vkGetPhysicalDeviceSparseImageFormatProperties);
        SEGMENT$vkCreateAndroidSurfaceKHR = loader.apply("vkCreateAndroidSurfaceKHR");
        HANDLE$vkCreateAndroidSurfaceKHR = RawFunctionLoader.link(SEGMENTvkCreateAndroidSurfaceKHR, DESCRIPTOR$vkCreateAndroidSurfaceKHR);
        SEGMENT$vkGetPhysicalDeviceDisplayPropertiesKHR = loader.apply("vkGetPhysicalDeviceDisplayPropertiesKHR");
        HANDLE$vkGetPhysicalDeviceDisplayPropertiesKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceDisplayPropertiesKHR, DESCRIPTOR$vkGetPhysicalDeviceDisplayPropertiesKHR);
        SEGMENT$vkGetPhysicalDeviceDisplayPlanePropertiesKHR = loader.apply("vkGetPhysicalDeviceDisplayPlanePropertiesKHR");
        HANDLE$vkGetPhysicalDeviceDisplayPlanePropertiesKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceDisplayPlanePropertiesKHR, DESCRIPTOR$vkGetPhysicalDeviceDisplayPlanePropertiesKHR);
        SEGMENT$vkGetDisplayPlaneSupportedDisplaysKHR = loader.apply("vkGetDisplayPlaneSupportedDisplaysKHR");
        HANDLE$vkGetDisplayPlaneSupportedDisplaysKHR = RawFunctionLoader.link(SEGMENTvkGetDisplayPlaneSupportedDisplaysKHR, DESCRIPTOR$vkGetDisplayPlaneSupportedDisplaysKHR);
        SEGMENT$vkGetDisplayModePropertiesKHR = loader.apply("vkGetDisplayModePropertiesKHR");
        HANDLE$vkGetDisplayModePropertiesKHR = RawFunctionLoader.link(SEGMENTvkGetDisplayModePropertiesKHR, DESCRIPTOR$vkGetDisplayModePropertiesKHR);
        SEGMENT$vkCreateDisplayModeKHR = loader.apply("vkCreateDisplayModeKHR");
        HANDLE$vkCreateDisplayModeKHR = RawFunctionLoader.link(SEGMENTvkCreateDisplayModeKHR, DESCRIPTOR$vkCreateDisplayModeKHR);
        SEGMENT$vkGetDisplayPlaneCapabilitiesKHR = loader.apply("vkGetDisplayPlaneCapabilitiesKHR");
        HANDLE$vkGetDisplayPlaneCapabilitiesKHR = RawFunctionLoader.link(SEGMENTvkGetDisplayPlaneCapabilitiesKHR, DESCRIPTOR$vkGetDisplayPlaneCapabilitiesKHR);
        SEGMENT$vkCreateDisplayPlaneSurfaceKHR = loader.apply("vkCreateDisplayPlaneSurfaceKHR");
        HANDLE$vkCreateDisplayPlaneSurfaceKHR = RawFunctionLoader.link(SEGMENTvkCreateDisplayPlaneSurfaceKHR, DESCRIPTOR$vkCreateDisplayPlaneSurfaceKHR);
        SEGMENT$vkDestroySurfaceKHR = loader.apply("vkDestroySurfaceKHR");
        HANDLE$vkDestroySurfaceKHR = RawFunctionLoader.link(SEGMENTvkDestroySurfaceKHR, DESCRIPTOR$vkDestroySurfaceKHR);
        SEGMENT$vkGetPhysicalDeviceSurfaceSupportKHR = loader.apply("vkGetPhysicalDeviceSurfaceSupportKHR");
        HANDLE$vkGetPhysicalDeviceSurfaceSupportKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSurfaceSupportKHR, DESCRIPTOR$vkGetPhysicalDeviceSurfaceSupportKHR);
        SEGMENT$vkGetPhysicalDeviceSurfaceCapabilitiesKHR = loader.apply("vkGetPhysicalDeviceSurfaceCapabilitiesKHR");
        HANDLE$vkGetPhysicalDeviceSurfaceCapabilitiesKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSurfaceCapabilitiesKHR, DESCRIPTOR$vkGetPhysicalDeviceSurfaceCapabilitiesKHR);
        SEGMENT$vkGetPhysicalDeviceSurfaceFormatsKHR = loader.apply("vkGetPhysicalDeviceSurfaceFormatsKHR");
        HANDLE$vkGetPhysicalDeviceSurfaceFormatsKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSurfaceFormatsKHR, DESCRIPTOR$vkGetPhysicalDeviceSurfaceFormatsKHR);
        SEGMENT$vkGetPhysicalDeviceSurfacePresentModesKHR = loader.apply("vkGetPhysicalDeviceSurfacePresentModesKHR");
        HANDLE$vkGetPhysicalDeviceSurfacePresentModesKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSurfacePresentModesKHR, DESCRIPTOR$vkGetPhysicalDeviceSurfacePresentModesKHR);
        SEGMENT$vkCreateViSurfaceNN = loader.apply("vkCreateViSurfaceNN");
        HANDLE$vkCreateViSurfaceNN = RawFunctionLoader.link(SEGMENTvkCreateViSurfaceNN, DESCRIPTOR$vkCreateViSurfaceNN);
        SEGMENT$vkCreateWaylandSurfaceKHR = loader.apply("vkCreateWaylandSurfaceKHR");
        HANDLE$vkCreateWaylandSurfaceKHR = RawFunctionLoader.link(SEGMENTvkCreateWaylandSurfaceKHR, DESCRIPTOR$vkCreateWaylandSurfaceKHR);
        SEGMENT$vkGetPhysicalDeviceWaylandPresentationSupportKHR = loader.apply("vkGetPhysicalDeviceWaylandPresentationSupportKHR");
        HANDLE$vkGetPhysicalDeviceWaylandPresentationSupportKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceWaylandPresentationSupportKHR, DESCRIPTOR$vkGetPhysicalDeviceWaylandPresentationSupportKHR);
        SEGMENT$vkCreateWin32SurfaceKHR = loader.apply("vkCreateWin32SurfaceKHR");
        HANDLE$vkCreateWin32SurfaceKHR = RawFunctionLoader.link(SEGMENTvkCreateWin32SurfaceKHR, DESCRIPTOR$vkCreateWin32SurfaceKHR);
        SEGMENT$vkGetPhysicalDeviceWin32PresentationSupportKHR = loader.apply("vkGetPhysicalDeviceWin32PresentationSupportKHR");
        HANDLE$vkGetPhysicalDeviceWin32PresentationSupportKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceWin32PresentationSupportKHR, DESCRIPTOR$vkGetPhysicalDeviceWin32PresentationSupportKHR);
        SEGMENT$vkCreateXlibSurfaceKHR = loader.apply("vkCreateXlibSurfaceKHR");
        HANDLE$vkCreateXlibSurfaceKHR = RawFunctionLoader.link(SEGMENTvkCreateXlibSurfaceKHR, DESCRIPTOR$vkCreateXlibSurfaceKHR);
        SEGMENT$vkGetPhysicalDeviceXlibPresentationSupportKHR = loader.apply("vkGetPhysicalDeviceXlibPresentationSupportKHR");
        HANDLE$vkGetPhysicalDeviceXlibPresentationSupportKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceXlibPresentationSupportKHR, DESCRIPTOR$vkGetPhysicalDeviceXlibPresentationSupportKHR);
        SEGMENT$vkCreateXcbSurfaceKHR = loader.apply("vkCreateXcbSurfaceKHR");
        HANDLE$vkCreateXcbSurfaceKHR = RawFunctionLoader.link(SEGMENTvkCreateXcbSurfaceKHR, DESCRIPTOR$vkCreateXcbSurfaceKHR);
        SEGMENT$vkGetPhysicalDeviceXcbPresentationSupportKHR = loader.apply("vkGetPhysicalDeviceXcbPresentationSupportKHR");
        HANDLE$vkGetPhysicalDeviceXcbPresentationSupportKHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceXcbPresentationSupportKHR, DESCRIPTOR$vkGetPhysicalDeviceXcbPresentationSupportKHR);
        SEGMENT$vkCreateDirectFBSurfaceEXT = loader.apply("vkCreateDirectFBSurfaceEXT");
        HANDLE$vkCreateDirectFBSurfaceEXT = RawFunctionLoader.link(SEGMENTvkCreateDirectFBSurfaceEXT, DESCRIPTOR$vkCreateDirectFBSurfaceEXT);
        SEGMENT$vkGetPhysicalDeviceDirectFBPresentationSupportEXT = loader.apply("vkGetPhysicalDeviceDirectFBPresentationSupportEXT");
        HANDLE$vkGetPhysicalDeviceDirectFBPresentationSupportEXT = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceDirectFBPresentationSupportEXT, DESCRIPTOR$vkGetPhysicalDeviceDirectFBPresentationSupportEXT);
        SEGMENT$vkCreateImagePipeSurfaceFUCHSIA = loader.apply("vkCreateImagePipeSurfaceFUCHSIA");
        HANDLE$vkCreateImagePipeSurfaceFUCHSIA = RawFunctionLoader.link(SEGMENTvkCreateImagePipeSurfaceFUCHSIA, DESCRIPTOR$vkCreateImagePipeSurfaceFUCHSIA);
        SEGMENT$vkCreateStreamDescriptorSurfaceGGP = loader.apply("vkCreateStreamDescriptorSurfaceGGP");
        HANDLE$vkCreateStreamDescriptorSurfaceGGP = RawFunctionLoader.link(SEGMENTvkCreateStreamDescriptorSurfaceGGP, DESCRIPTOR$vkCreateStreamDescriptorSurfaceGGP);
        SEGMENT$vkCreateScreenSurfaceQNX = loader.apply("vkCreateScreenSurfaceQNX");
        HANDLE$vkCreateScreenSurfaceQNX = RawFunctionLoader.link(SEGMENTvkCreateScreenSurfaceQNX, DESCRIPTOR$vkCreateScreenSurfaceQNX);
        SEGMENT$vkGetPhysicalDeviceScreenPresentationSupportQNX = loader.apply("vkGetPhysicalDeviceScreenPresentationSupportQNX");
        HANDLE$vkGetPhysicalDeviceScreenPresentationSupportQNX = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceScreenPresentationSupportQNX, DESCRIPTOR$vkGetPhysicalDeviceScreenPresentationSupportQNX);
        SEGMENT$vkCreateDebugReportCallbackEXT = loader.apply("vkCreateDebugReportCallbackEXT");
        HANDLE$vkCreateDebugReportCallbackEXT = RawFunctionLoader.link(SEGMENTvkCreateDebugReportCallbackEXT, DESCRIPTOR$vkCreateDebugReportCallbackEXT);
        SEGMENT$vkDestroyDebugReportCallbackEXT = loader.apply("vkDestroyDebugReportCallbackEXT");
        HANDLE$vkDestroyDebugReportCallbackEXT = RawFunctionLoader.link(SEGMENTvkDestroyDebugReportCallbackEXT, DESCRIPTOR$vkDestroyDebugReportCallbackEXT);
        SEGMENT$vkDebugReportMessageEXT = loader.apply("vkDebugReportMessageEXT");
        HANDLE$vkDebugReportMessageEXT = RawFunctionLoader.link(SEGMENTvkDebugReportMessageEXT, DESCRIPTOR$vkDebugReportMessageEXT);
        ...
        HANDLE$vkGetPhysicalDeviceExternalImageFormatPropertiesNV = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceExternalImageFormatPropertiesNV, DESCRIPTOR$vkGetPhysicalDeviceExternalImageFormatPropertiesNV);
        SEGMENT$vkGetPhysicalDeviceFeatures2 = loader.apply("vkGetPhysicalDeviceFeatures2");
        HANDLE$vkGetPhysicalDeviceFeatures2 = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceFeatures2, DESCRIPTOR$vkGetPhysicalDeviceFeatures2);
        SEGMENT$vkGetPhysicalDeviceProperties2 = loader.apply("vkGetPhysicalDeviceProperties2");
        HANDLE$vkGetPhysicalDeviceProperties2 = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceProperties2, DESCRIPTOR$vkGetPhysicalDeviceProperties2);
        SEGMENT$vkGetPhysicalDeviceFormatProperties2 = loader.apply("vkGetPhysicalDeviceFormatProperties2");
        HANDLE$vkGetPhysicalDeviceFormatProperties2 = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceFormatProperties2, DESCRIPTOR$vkGetPhysicalDeviceFormatProperties2);
        SEGMENT$vkGetPhysicalDeviceImageFormatProperties2 = loader.apply("vkGetPhysicalDeviceImageFormatProperties2");
        HANDLE$vkGetPhysicalDeviceImageFormatProperties2 = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceImageFormatProperties2, DESCRIPTOR$vkGetPhysicalDeviceImageFormatProperties2);
        SEGMENT$vkGetPhysicalDeviceQueueFamilyProperties2 = loader.apply("vkGetPhysicalDeviceQueueFamilyProperties2");
        HANDLE$vkGetPhysicalDeviceQueueFamilyProperties2 = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceQueueFamilyProperties2, DESCRIPTOR$vkGetPhysicalDeviceQueueFamilyProperties2);
        SEGMENT$vkGetPhysicalDeviceMemoryProperties2 = loader.apply("vkGetPhysicalDeviceMemoryProperties2");
        HANDLE$vkGetPhysicalDeviceMemoryProperties2 = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceMemoryProperties2, DESCRIPTOR$vkGetPhysicalDeviceMemoryProperties2);
        SEGMENT$vkGetPhysicalDeviceSparseImageFormatProperties2 = loader.apply("vkGetPhysicalDeviceSparseImageFormatProperties2");
        HANDLE$vkGetPhysicalDeviceSparseImageFormatProperties2 = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSparseImageFormatProperties2, DESCRIPTOR$vkGetPhysicalDeviceSparseImageFormatProperties2);
        SEGMENT$vkGetPhysicalDeviceExternalBufferProperties = loader.apply("vkGetPhysicalDeviceExternalBufferProperties");
        HANDLE$vkGetPhysicalDeviceExternalBufferProperties = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceExternalBufferProperties, DESCRIPTOR$vkGetPhysicalDeviceExternalBufferProperties);
        SEGMENT$vkGetPhysicalDeviceExternalSemaphoreProperties = loader.apply("vkGetPhysicalDeviceExternalSemaphoreProperties");
        HANDLE$vkGetPhysicalDeviceExternalSemaphoreProperties = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceExternalSemaphoreProperties, DESCRIPTOR$vkGetPhysicalDeviceExternalSemaphoreProperties);
        SEGMENT$vkGetPhysicalDeviceExternalFenceProperties = loader.apply("vkGetPhysicalDeviceExternalFenceProperties");
        HANDLE$vkGetPhysicalDeviceExternalFenceProperties = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceExternalFenceProperties, DESCRIPTOR$vkGetPhysicalDeviceExternalFenceProperties);
        SEGMENT$vkReleaseDisplayEXT = loader.apply("vkReleaseDisplayEXT");
        HANDLE$vkReleaseDisplayEXT = RawFunctionLoader.link(SEGMENTvkReleaseDisplayEXT, DESCRIPTOR$vkReleaseDisplayEXT);
        SEGMENT$vkAcquireXlibDisplayEXT = loader.apply("vkAcquireXlibDisplayEXT");
        HANDLE$vkAcquireXlibDisplayEXT = RawFunctionLoader.link(SEGMENTvkAcquireXlibDisplayEXT, DESCRIPTOR$vkAcquireXlibDisplayEXT);
        SEGMENT$vkGetRandROutputDisplayEXT = loader.apply("vkGetRandROutputDisplayEXT");
        HANDLE$vkGetRandROutputDisplayEXT = RawFunctionLoader.link(SEGMENTvkGetRandROutputDisplayEXT, DESCRIPTOR$vkGetRandROutputDisplayEXT);
        SEGMENT$vkGetPhysicalDeviceSurfaceCapabilities2EXT = loader.apply("vkGetPhysicalDeviceSurfaceCapabilities2EXT");
        HANDLE$vkGetPhysicalDeviceSurfaceCapabilities2EXT = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSurfaceCapabilities2EXT, DESCRIPTOR$vkGetPhysicalDeviceSurfaceCapabilities2EXT);
        SEGMENT$vkEnumeratePhysicalDeviceGroups = loader.apply("vkEnumeratePhysicalDeviceGroups");
        HANDLE$vkEnumeratePhysicalDeviceGroups = RawFunctionLoader.link(SEGMENTvkEnumeratePhysicalDeviceGroups, DESCRIPTOR$vkEnumeratePhysicalDeviceGroups);
        SEGMENT$vkCreateIOSSurfaceMVK = loader.apply("vkCreateIOSSurfaceMVK");
        HANDLE$vkCreateIOSSurfaceMVK = RawFunctionLoader.link(SEGMENTvkCreateIOSSurfaceMVK, DESCRIPTOR$vkCreateIOSSurfaceMVK);
        SEGMENT$vkCreateMacOSSurfaceMVK = loader.apply("vkCreateMacOSSurfaceMVK");
        HANDLE$vkCreateMacOSSurfaceMVK = RawFunctionLoader.link(SEGMENTvkCreateMacOSSurfaceMVK, DESCRIPTOR$vkCreateMacOSSurfaceMVK);
        SEGMENT$vkCreateMetalSurfaceEXT = loader.apply("vkCreateMetalSurfaceEXT");
        HANDLE$vkCreateMetalSurfaceEXT = RawFunctionLoader.link(SEGMENTvkCreateMetalSurfaceEXT, DESCRIPTOR$vkCreateMetalSurfaceEXT);
        SEGMENT$vkGetPhysicalDeviceSurfaceCapabilities2KHR = loader.apply("vkGetPhysicalDeviceSurfaceCapabilities2KHR");
        HANDLE$vkGetPhysicalDeviceSurfaceCapabilities2KHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSurfaceCapabilities2KHR, DESCRIPTOR$vkGetPhysicalDeviceSurfaceCapabilities2KHR);
        SEGMENT$vkGetPhysicalDeviceSurfaceFormats2KHR = loader.apply("vkGetPhysicalDeviceSurfaceFormats2KHR");
        HANDLE$vkGetPhysicalDeviceSurfaceFormats2KHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceSurfaceFormats2KHR, DESCRIPTOR$vkGetPhysicalDeviceSurfaceFormats2KHR);
        SEGMENT$vkGetPhysicalDeviceDisplayProperties2KHR = loader.apply("vkGetPhysicalDeviceDisplayProperties2KHR");
        HANDLE$vkGetPhysicalDeviceDisplayProperties2KHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceDisplayProperties2KHR, DESCRIPTOR$vkGetPhysicalDeviceDisplayProperties2KHR);
        SEGMENT$vkGetPhysicalDeviceDisplayPlaneProperties2KHR = loader.apply("vkGetPhysicalDeviceDisplayPlaneProperties2KHR");
        HANDLE$vkGetPhysicalDeviceDisplayPlaneProperties2KHR = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceDisplayPlaneProperties2KHR, DESCRIPTOR$vkGetPhysicalDeviceDisplayPlaneProperties2KHR);
        SEGMENT$vkGetDisplayModeProperties2KHR = loader.apply("vkGetDisplayModeProperties2KHR");
        HANDLE$vkGetDisplayModeProperties2KHR = RawFunctionLoader.link(SEGMENTvkGetDisplayModeProperties2KHR, DESCRIPTOR$vkGetDisplayModeProperties2KHR);
        SEGMENT$vkGetDisplayPlaneCapabilities2KHR = loader.apply("vkGetDisplayPlaneCapabilities2KHR");
        HANDLE$vkGetDisplayPlaneCapabilities2KHR = RawFunctionLoader.link(SEGMENTvkGetDisplayPlaneCapabilities2KHR, DESCRIPTOR$vkGetDisplayPlaneCapabilities2KHR);
        SEGMENT$vkSetDebugUtilsObjectNameEXT = loader.apply("vkSetDebugUtilsObjectNameEXT");
        HANDLE$vkSetDebugUtilsObjectNameEXT = RawFunctionLoader.link(SEGMENTvkSetDebugUtilsObjectNameEXT, DESCRIPTOR$vkSetDebugUtilsObjectNameEXT);
        SEGMENT$vkSetDebugUtilsObjectTagEXT = loader.apply("vkSetDebugUtilsObjectTagEXT");
        HANDLE$vkSetDebugUtilsObjectTagEXT = RawFunctionLoader.link(SEGMENTvkSetDebugUtilsObjectTagEXT, DESCRIPTOR$vkSetDebugUtilsObjectTagEXT);
        SEGMENT$vkQueueBeginDebugUtilsLabelEXT = loader.apply("vkQueueBeginDebugUtilsLabelEXT");
        HANDLE$vkQueueBeginDebugUtilsLabelEXT = RawFunctionLoader.link(SEGMENTvkQueueBeginDebugUtilsLabelEXT, DESCRIPTOR$vkQueueBeginDebugUtilsLabelEXT);
        SEGMENT$vkQueueEndDebugUtilsLabelEXT = loader.apply("vkQueueEndDebugUtilsLabelEXT");
        HANDLE$vkQueueEndDebugUtilsLabelEXT = RawFunctionLoader.link(SEGMENTvkQueueEndDebugUtilsLabelEXT, DESCRIPTOR$vkQueueEndDebugUtilsLabelEXT);
        SEGMENT$vkQueueInsertDebugUtilsLabelEXT = loader.apply("vkQueueInsertDebugUtilsLabelEXT");
        HANDLE$vkQueueInsertDebugUtilsLabelEXT = RawFunctionLoader.link(SEGMENTvkQueueInsertDebugUtilsLabelEXT, DESCRIPTOR$vkQueueInsertDebugUtilsLabelEXT);
        SEGMENT$vkCmdBeginDebugUtilsLabelEXT = loader.apply("vkCmdBeginDebugUtilsLabelEXT");
        HANDLE$vkCmdBeginDebugUtilsLabelEXT = RawFunctionLoader.link(SEGMENTvkCmdBeginDebugUtilsLabelEXT, DESCRIPTOR$vkCmdBeginDebugUtilsLabelEXT);
        SEGMENT$vkCmdEndDebugUtilsLabelEXT = loader.apply("vkCmdEndDebugUtilsLabelEXT");
        HANDLE$vkCmdEndDebugUtilsLabelEXT = RawFunctionLoader.link(SEGMENTvkCmdEndDebugUtilsLabelEXT, DESCRIPTOR$vkCmdEndDebugUtilsLabelEXT);
        SEGMENT$vkCmdInsertDebugUtilsLabelEXT = loader.apply("vkCmdInsertDebugUtilsLabelEXT");
        HANDLE$vkCmdInsertDebugUtilsLabelEXT = RawFunctionLoader.link(SEGMENTvkCmdInsertDebugUtilsLabelEXT, DESCRIPTOR$vkCmdInsertDebugUtilsLabelEXT);
        SEGMENT$vkCreateDebugUtilsMessengerEXT = loader.apply("vkCreateDebugUtilsMessengerEXT");
        HANDLE$vkCreateDebugUtilsMessengerEXT = RawFunctionLoader.link(SEGMENTvkCreateDebugUtilsMessengerEXT, DESCRIPTOR$vkCreateDebugUtilsMessengerEXT);
        SEGMENT$vkDestroyDebugUtilsMessengerEXT = loader.apply("vkDestroyDebugUtilsMessengerEXT");
        HANDLE$vkDestroyDebugUtilsMessengerEXT = RawFunctionLoader.link(SEGMENTvkDestroyDebugUtilsMessengerEXT, DESCRIPTOR$vkDestroyDebugUtilsMessengerEXT);
        SEGMENT$vkSubmitDebugUtilsMessageEXT = loader.apply("vkSubmitDebugUtilsMessageEXT");
        HANDLE$vkSubmitDebugUtilsMessageEXT = RawFunctionLoader.link(SEGMENTvkSubmitDebugUtilsMessageEXT, DESCRIPTOR$vkSubmitDebugUtilsMessageEXT);
        SEGMENT$vkCreateHeadlessSurfaceEXT = loader.apply("vkCreateHeadlessSurfaceEXT");
        HANDLE$vkCreateHeadlessSurfaceEXT = RawFunctionLoader.link(SEGMENTvkCreateHeadlessSurfaceEXT, DESCRIPTOR$vkCreateHeadlessSurfaceEXT);
        SEGMENT$vkGetPhysicalDeviceToolProperties = loader.apply("vkGetPhysicalDeviceToolProperties");
        HANDLE$vkGetPhysicalDeviceToolProperties = RawFunctionLoader.link(SEGMENTvkGetPhysicalDeviceToolProperties, DESCRIPTOR$vkGetPhysicalDeviceToolProperties);
        SEGMENT$vkAcquireDrmDisplayEXT = loader.apply("vkAcquireDrmDisplayEXT");
        HANDLE$vkAcquireDrmDisplayEXT = RawFunctionLoader.link(SEGMENTvkAcquireDrmDisplayEXT, DESCRIPTOR$vkAcquireDrmDisplayEXT);
        SEGMENT$vkGetDrmDisplayEXT = loader.apply("vkGetDrmDisplayEXT");
        HANDLE$vkGetDrmDisplayEXT = RawFunctionLoader.link(SEGMENTvkGetDrmDisplayEXT, DESCRIPTOR$vkGetDrmDisplayEXT);
    }

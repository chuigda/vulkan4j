...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrDebugUtilsMessengerEXT.html"><code>XrDebugUtilsMessengerEXT</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrDebugUtilsMessengerEXT.html"><code>XrDebugUtilsMessengerEXT</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrDebugUtilsMessengerEXT(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrDebugUtilsMessengerEXT.html"><code>XrDebugUtilsMessengerEXT</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrDebugUtilsMessengerEXT> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrDebugUtilsMessengerEXT read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new XrDebugUtilsMessengerEXT(s);
        }

        public void write(@Nullable XrDebugUtilsMessengerEXT value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrDebugUtilsMessengerEXT read(long index) {
        ...
        public void write(long index, @Nullable XrDebugUtilsMessengerEXT value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrDebugUtilsMessengerEXT[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrDebugUtilsMessengerEXT value0, @Nullable XrDebugUtilsMessengerEXT ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrDebugUtilsMessengerEXT value0, @Nullable XrDebugUtilsMessengerEXT ...values) {
        ...
        @Override
        public @NotNull Iterator<XrDebugUtilsMessengerEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrDebugUtilsMessengerEXT> {
            ...
            @Override
            public @Nullable XrDebugUtilsMessengerEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new XrDebugUtilsMessengerEXT(s);
            }

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSenseDataProviderBD.html"><code>XrSenseDataProviderBD</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSenseDataProviderBD.html"><code>XrSenseDataProviderBD</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrSenseDataProviderBD(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSenseDataProviderBD.html"><code>XrSenseDataProviderBD</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrSenseDataProviderBD> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrSenseDataProviderBD read() {
        ...
        public void write(@Nullable XrSenseDataProviderBD value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrSenseDataProviderBD read(long index) {
        ...
        public void write(long index, @Nullable XrSenseDataProviderBD value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrSenseDataProviderBD[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrSenseDataProviderBD value0, @Nullable XrSenseDataProviderBD ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrSenseDataProviderBD @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrSenseDataProviderBD> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrSenseDataProviderBD value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrSenseDataProviderBD value0, @Nullable XrSenseDataProviderBD ...values) {
        ...
        @Override
        public @NotNull Iterator<XrSenseDataProviderBD> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrSenseDataProviderBD> {
            ...
            @Override
            public @Nullable XrSenseDataProviderBD next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new XrSenseDataProviderBD(s);
            }

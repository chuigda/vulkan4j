...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrMarkerDetectorML.html"><code>XrMarkerDetectorML</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrMarkerDetectorML.html"><code>XrMarkerDetectorML</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrMarkerDetectorML(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrMarkerDetectorML.html"><code>XrMarkerDetectorML</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrMarkerDetectorML> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrMarkerDetectorML read() {
        ...
        public void write(@Nullable XrMarkerDetectorML value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrMarkerDetectorML read(long index) {
        ...
        public void write(long index, @Nullable XrMarkerDetectorML value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrMarkerDetectorML[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrMarkerDetectorML value0, @Nullable XrMarkerDetectorML ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrMarkerDetectorML @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrMarkerDetectorML> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrMarkerDetectorML value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrMarkerDetectorML value0, @Nullable XrMarkerDetectorML ...values) {
        ...
        @Override
        public @NotNull Iterator<XrMarkerDetectorML> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrMarkerDetectorML> {

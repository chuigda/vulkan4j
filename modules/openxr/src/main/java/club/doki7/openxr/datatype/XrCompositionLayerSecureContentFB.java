...
public record XrCompositionLayerSecureContentFB(@NotNull MemorySegment segment) implements IXrCompositionLayerSecureContentFB {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IXrCompositionLayerSecureContentFB, Iterable<XrCompositionLayerSecureContentFB> {
        ...
        public void at(long index, @NotNull Consumer<@NotNull XrCompositionLayerSecureContentFB> consumer) {
    ...
    public static XrCompositionLayerSecureContentFB allocate(Arena arena) {
        ...
        ret.type(XrStructureType.COMPOSITION_LAYER_SECURE_CONTENT_FB);
        return ret;
    }
    ...
    public static XrCompositionLayerSecureContentFB.Ptr allocate(Arena arena, long count) {
        ...
        for (long i = 0; i < count; i++) {
            ret.at(i).type(XrStructureType.COMPOSITION_LAYER_SECURE_CONTENT_FB);
        }
        return ret;
    }
    ...
    public void autoInit() {
        type(XrStructureType.COMPOSITION_LAYER_SECURE_CONTENT_FB);
    }
    ...
    public @Bitmask(XrCompositionLayerSecureContentFlagsFB.class) long flags() {
        return segment.get(LAYOUT$flags, OFFSET$flags);
    }

    public XrCompositionLayerSecureContentFB flags(@Bitmask(XrCompositionLayerSecureContentFlagsFB.class) long value) {

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrRenderModelAssetEXT.html"><code>XrRenderModelAssetEXT</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrRenderModelAssetEXT.html"><code>XrRenderModelAssetEXT</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrRenderModelAssetEXT(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrRenderModelAssetEXT.html"><code>XrRenderModelAssetEXT</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrRenderModelAssetEXT> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrRenderModelAssetEXT read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new XrRenderModelAssetEXT(s);
        }

        public void write(@Nullable XrRenderModelAssetEXT value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrRenderModelAssetEXT read(long index) {
        ...
        public void write(long index, @Nullable XrRenderModelAssetEXT value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrRenderModelAssetEXT[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrRenderModelAssetEXT value0, @Nullable XrRenderModelAssetEXT ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrRenderModelAssetEXT @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrRenderModelAssetEXT> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrRenderModelAssetEXT value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrRenderModelAssetEXT value0, @Nullable XrRenderModelAssetEXT ...values) {
        ...
        @Override
        public @NotNull Iterator<XrRenderModelAssetEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrRenderModelAssetEXT> {
            ...
            @Override
            public @Nullable XrRenderModelAssetEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new XrRenderModelAssetEXT(s);
            }

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrPassthroughHTC.html"><code>XrPassthroughHTC</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrPassthroughHTC.html"><code>XrPassthroughHTC</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrPassthroughHTC(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrPassthroughHTC.html"><code>XrPassthroughHTC</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrPassthroughHTC> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrPassthroughHTC read() {
        ...
        public void write(@Nullable XrPassthroughHTC value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrPassthroughHTC read(long index) {
        ...
        public void write(long index, @Nullable XrPassthroughHTC value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrPassthroughHTC[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrPassthroughHTC value0, @Nullable XrPassthroughHTC ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrPassthroughHTC @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrPassthroughHTC> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrPassthroughHTC value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrPassthroughHTC value0, @Nullable XrPassthroughHTC ...values) {
        ...
        @Override
        public @NotNull Iterator<XrPassthroughHTC> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrPassthroughHTC> {

...
public record XrSpatialGraphNodeBindingPropertiesMSFT(@NotNull MemorySegment segment) implements IXrSpatialGraphNodeBindingPropertiesMSFT {
    ...
    public static XrSpatialGraphNodeBindingPropertiesMSFT allocate(Arena arena) {
        ...
        ret.type(XrStructureType.XR_TYPE_SPATIAL_GRAPH_NODE_BINDING_PROPERTIES_MSFT);
        return ret;
    }
    ...
    public static XrSpatialGraphNodeBindingPropertiesMSFT.Ptr allocate(Arena arena, long count) {
        ...
        for (long i = 0; i < count; i++) {
            ret.at(i).type(XrStructureType.XR_TYPE_SPATIAL_GRAPH_NODE_BINDING_PROPERTIES_MSFT);
        }
        return ret;
    }
    ...
    public void autoInit() {
        type(XrStructureType.XR_TYPE_SPATIAL_GRAPH_NODE_BINDING_PROPERTIES_MSFT);
    }
    ...
    public XrSpatialGraphNodeBindingPropertiesMSFT nodeId(@Unsigned byte value) {

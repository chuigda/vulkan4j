...
public final class XrSpatialMeshConfigFlagsBD {
    ...
    public static final int ALIGN_SEMANTIC_WITH_VERTEX = 0x1;
    ...
    public static final int SEMANTIC = 0x0;

    public static String explain(@Bitmask(XrSpatialMeshConfigFlagsBD.class) int flags) {

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrVirtualKeyboardMETA.html"><code>XrVirtualKeyboardMETA</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrVirtualKeyboardMETA.html"><code>XrVirtualKeyboardMETA</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrVirtualKeyboardMETA(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrVirtualKeyboardMETA.html"><code>XrVirtualKeyboardMETA</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrVirtualKeyboardMETA> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrVirtualKeyboardMETA read() {
        ...
        public void write(@Nullable XrVirtualKeyboardMETA value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrVirtualKeyboardMETA read(long index) {
        ...
        public void write(long index, @Nullable XrVirtualKeyboardMETA value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrVirtualKeyboardMETA[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrVirtualKeyboardMETA value0, @Nullable XrVirtualKeyboardMETA ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrVirtualKeyboardMETA @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrVirtualKeyboardMETA> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrVirtualKeyboardMETA value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrVirtualKeyboardMETA value0, @Nullable XrVirtualKeyboardMETA ...values) {
        ...
        @Override
        public @NotNull Iterator<XrVirtualKeyboardMETA> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrVirtualKeyboardMETA> {
            ...
            @Override
            public @Nullable XrVirtualKeyboardMETA next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new XrVirtualKeyboardMETA(s);
            }

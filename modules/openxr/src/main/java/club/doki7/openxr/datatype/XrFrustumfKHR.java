...
/// Represents a pointer to a <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrFrustumfKHR.html"><code>XrFrustumfKHR</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
/// typedef struct XrFrustumfKHR {
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrFrustumfKHR.html"><code>XrFrustumfKHR</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrFrustumfKHR(@NotNull MemorySegment segment) implements IXrFrustumfKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrFrustumfKHR.html"><code>XrFrustumfKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link XrFrustumfKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IXrFrustumfKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code XrFrustumfKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IXrFrustumfKHR, Iterable<XrFrustumfKHR> {
        public long size() {
            return segment.byteSize() / XrFrustumfKHR.BYTES;
        }
        ...
        public @NotNull XrFrustumfKHR at(long index) {
            return new XrFrustumfKHR(segment.asSlice(index * XrFrustumfKHR.BYTES, XrFrustumfKHR.BYTES));
        }

        public XrFrustumfKHR.Ptr at(long index, @NotNull Consumer<@NotNull XrFrustumfKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * XrFrustumfKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * XrFrustumfKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * XrFrustumfKHR.BYTES,
                (end - start) * XrFrustumfKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * XrFrustumfKHR.BYTES));
        }

        public XrFrustumfKHR[] toArray() {
            XrFrustumfKHR[] ret = new XrFrustumfKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<XrFrustumfKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<XrFrustumfKHR> {
            ...
            @Override
            public XrFrustumfKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                XrFrustumfKHR ret = new XrFrustumfKHR(segment.asSlice(0, XrFrustumfKHR.BYTES));
                segment = segment.asSlice(XrFrustumfKHR.BYTES);
                return ret;
            }
    ...
    public static XrFrustumfKHR allocate(Arena arena) {
        return new XrFrustumfKHR(arena.allocate(LAYOUT));
    }

    public static XrFrustumfKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        return new XrFrustumfKHR.Ptr(segment);
    }

    public static XrFrustumfKHR clone(Arena arena, XrFrustumfKHR src) {
        XrFrustumfKHR ret = allocate(arena);
    ...
    public XrFrustumfKHR pose(@NotNull XrPosef value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$pose, SIZE$pose);
        return this;
    }

    public XrFrustumfKHR pose(Consumer<@NotNull XrPosef> consumer) {
    ...
    public XrFrustumfKHR fov(@NotNull XrFovf value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$fov, SIZE$fov);
        return this;
    }

    public XrFrustumfKHR fov(Consumer<@NotNull XrFovf> consumer) {
        consumer.accept(fov());
        return this;
    }

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpatialContextEXT.html"><code>XrSpatialContextEXT</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpatialContextEXT.html"><code>XrSpatialContextEXT</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrSpatialContextEXT(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpatialContextEXT.html"><code>XrSpatialContextEXT</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrSpatialContextEXT> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrSpatialContextEXT read() {
        ...
        public void write(@Nullable XrSpatialContextEXT value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrSpatialContextEXT read(long index) {
        ...
        public void write(long index, @Nullable XrSpatialContextEXT value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrSpatialContextEXT[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrSpatialContextEXT value0, @Nullable XrSpatialContextEXT ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrSpatialContextEXT @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrSpatialContextEXT> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrSpatialContextEXT value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrSpatialContextEXT value0, @Nullable XrSpatialContextEXT ...values) {
        ...
        @Override
        public @NotNull Iterator<XrSpatialContextEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrSpatialContextEXT> {

...
public record XrEnvironmentDepthProviderCreateInfoMETA(@NotNull MemorySegment segment) implements IXrEnvironmentDepthProviderCreateInfoMETA {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IXrEnvironmentDepthProviderCreateInfoMETA, Iterable<XrEnvironmentDepthProviderCreateInfoMETA> {
        ...
        public void at(long index, @NotNull Consumer<@NotNull XrEnvironmentDepthProviderCreateInfoMETA> consumer) {
    ...
    public static XrEnvironmentDepthProviderCreateInfoMETA allocate(Arena arena) {
        ...
        ret.type(XrStructureType.ENVIRONMENT_DEPTH_PROVIDER_CREATE_INFO_META);
        return ret;
    }
    ...
    public static XrEnvironmentDepthProviderCreateInfoMETA.Ptr allocate(Arena arena, long count) {
        ...
        for (long i = 0; i < count; i++) {
            ret.at(i).type(XrStructureType.ENVIRONMENT_DEPTH_PROVIDER_CREATE_INFO_META);
        }
        return ret;
    }
    ...
    public void autoInit() {
        type(XrStructureType.ENVIRONMENT_DEPTH_PROVIDER_CREATE_INFO_META);
    }
    ...
    public @Bitmask(XrEnvironmentDepthProviderCreateFlagsMETA.class) long createFlags() {
        return segment.get(LAYOUT$createFlags, OFFSET$createFlags);
    }

    public XrEnvironmentDepthProviderCreateInfoMETA createFlags(@Bitmask(XrEnvironmentDepthProviderCreateFlagsMETA.class) long value) {

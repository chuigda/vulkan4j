...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSceneObserverMSFT.html"><code>XrSceneObserverMSFT</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSceneObserverMSFT.html"><code>XrSceneObserverMSFT</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrSceneObserverMSFT(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSceneObserverMSFT.html"><code>XrSceneObserverMSFT</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrSceneObserverMSFT> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrSceneObserverMSFT read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new XrSceneObserverMSFT(s);
        }

        public void write(@Nullable XrSceneObserverMSFT value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrSceneObserverMSFT read(long index) {
        ...
        public void write(long index, @Nullable XrSceneObserverMSFT value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrSceneObserverMSFT[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrSceneObserverMSFT value0, @Nullable XrSceneObserverMSFT ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrSceneObserverMSFT @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrSceneObserverMSFT> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrSceneObserverMSFT value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrSceneObserverMSFT value0, @Nullable XrSceneObserverMSFT ...values) {
        ...
        @Override
        public @NotNull Iterator<XrSceneObserverMSFT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrSceneObserverMSFT> {

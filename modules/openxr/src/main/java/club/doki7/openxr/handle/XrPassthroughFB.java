...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrPassthroughFB.html"><code>XrPassthroughFB</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrPassthroughFB.html"><code>XrPassthroughFB</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrPassthroughFB(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrPassthroughFB.html"><code>XrPassthroughFB</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrPassthroughFB> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrPassthroughFB read() {
        ...
        public void write(@Nullable XrPassthroughFB value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrPassthroughFB read(long index) {
        ...
        public void write(long index, @Nullable XrPassthroughFB value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrPassthroughFB[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrPassthroughFB value0, @Nullable XrPassthroughFB ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrPassthroughFB @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrPassthroughFB> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrPassthroughFB value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrPassthroughFB value0, @Nullable XrPassthroughFB ...values) {
        ...
        @Override
        public @NotNull Iterator<XrPassthroughFB> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrPassthroughFB> {

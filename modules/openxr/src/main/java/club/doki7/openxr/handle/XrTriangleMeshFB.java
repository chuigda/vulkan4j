...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrTriangleMeshFB.html"><code>XrTriangleMeshFB</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrTriangleMeshFB.html"><code>XrTriangleMeshFB</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrTriangleMeshFB(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrTriangleMeshFB.html"><code>XrTriangleMeshFB</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrTriangleMeshFB> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrTriangleMeshFB read() {
        ...
        public void write(@Nullable XrTriangleMeshFB value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrTriangleMeshFB read(long index) {
        ...
        public void write(long index, @Nullable XrTriangleMeshFB value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrTriangleMeshFB[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrTriangleMeshFB value0, @Nullable XrTriangleMeshFB ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrTriangleMeshFB @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrTriangleMeshFB> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrTriangleMeshFB value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrTriangleMeshFB value0, @Nullable XrTriangleMeshFB ...values) {
        ...
        @Override
        public @NotNull Iterator<XrTriangleMeshFB> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrTriangleMeshFB> {

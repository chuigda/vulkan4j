...
public final class XrPassthroughCapabilityFlagsFB {
    ...
    public static final int BIT = 0x0;
    ...
    public static final int LAYER_DEPTH = 0x2;

    public static String explain(@Bitmask(XrPassthroughCapabilityFlagsFB.class) int flags) {

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpatialAnchorMSFT.html"><code>XrSpatialAnchorMSFT</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpatialAnchorMSFT.html"><code>XrSpatialAnchorMSFT</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrSpatialAnchorMSFT(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpatialAnchorMSFT.html"><code>XrSpatialAnchorMSFT</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrSpatialAnchorMSFT> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrSpatialAnchorMSFT read() {
        ...
        public void write(@Nullable XrSpatialAnchorMSFT value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrSpatialAnchorMSFT read(long index) {
        ...
        public void write(long index, @Nullable XrSpatialAnchorMSFT value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrSpatialAnchorMSFT[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrSpatialAnchorMSFT value0, @Nullable XrSpatialAnchorMSFT ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrSpatialAnchorMSFT @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrSpatialAnchorMSFT> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrSpatialAnchorMSFT value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrSpatialAnchorMSFT value0, @Nullable XrSpatialAnchorMSFT ...values) {
        ...
        @Override
        public @NotNull Iterator<XrSpatialAnchorMSFT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrSpatialAnchorMSFT> {

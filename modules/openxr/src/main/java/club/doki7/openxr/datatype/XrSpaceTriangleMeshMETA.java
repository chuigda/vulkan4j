...
/// Represents a pointer to a <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpaceTriangleMeshMETA.html"><code>XrSpaceTriangleMeshMETA</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
///
/// The {@code allocate} ({@link XrSpaceTriangleMeshMETA#allocate(Arena)}, {@link XrSpaceTriangleMeshMETA#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link XrSpaceTriangleMeshMETA#autoInit}
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpaceTriangleMeshMETA.html"><code>XrSpaceTriangleMeshMETA</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrSpaceTriangleMeshMETA(@NotNull MemorySegment segment) implements IXrSpaceTriangleMeshMETA {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpaceTriangleMeshMETA.html"><code>XrSpaceTriangleMeshMETA</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link XrSpaceTriangleMeshMETA}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IXrSpaceTriangleMeshMETA to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code XrSpaceTriangleMeshMETA.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IXrSpaceTriangleMeshMETA, Iterable<XrSpaceTriangleMeshMETA> {
        public long size() {
            return segment.byteSize() / XrSpaceTriangleMeshMETA.BYTES;
        }
        ...
        public @NotNull XrSpaceTriangleMeshMETA at(long index) {
            return new XrSpaceTriangleMeshMETA(segment.asSlice(index * XrSpaceTriangleMeshMETA.BYTES, XrSpaceTriangleMeshMETA.BYTES));
        }

        public void at(long index, @NotNull Consumer<@NotNull XrSpaceTriangleMeshMETA> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * XrSpaceTriangleMeshMETA.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * XrSpaceTriangleMeshMETA.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * XrSpaceTriangleMeshMETA.BYTES,
                (end - start) * XrSpaceTriangleMeshMETA.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * XrSpaceTriangleMeshMETA.BYTES));
        }

        public XrSpaceTriangleMeshMETA[] toArray() {
            XrSpaceTriangleMeshMETA[] ret = new XrSpaceTriangleMeshMETA[(int) size()];
        ...
        @Override
        public @NotNull Iterator<XrSpaceTriangleMeshMETA> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<XrSpaceTriangleMeshMETA> {
            ...
            @Override
            public XrSpaceTriangleMeshMETA next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                XrSpaceTriangleMeshMETA ret = new XrSpaceTriangleMeshMETA(segment.asSlice(0, XrSpaceTriangleMeshMETA.BYTES));
                segment = segment.asSlice(XrSpaceTriangleMeshMETA.BYTES);
                return ret;
            }
    ...
    public static XrSpaceTriangleMeshMETA.Ptr allocate(Arena arena, long count) {
    ...
    public static XrSpaceTriangleMeshMETA clone(Arena arena, XrSpaceTriangleMeshMETA src) {
        XrSpaceTriangleMeshMETA ret = allocate(arena);
    ...
    public XrSpaceTriangleMeshMETA type(@EnumType(XrStructureType.class) int value) {
    ...
    public XrSpaceTriangleMeshMETA next(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$next, OFFSET$next, value);
        return this;
    }

    public XrSpaceTriangleMeshMETA next(@Nullable IPointer pointer) {
    ...
    public XrSpaceTriangleMeshMETA vertexCapacityInput(@Unsigned int value) {
    ...
    public XrSpaceTriangleMeshMETA vertexCountOutput(@Unsigned int value) {
        segment.set(LAYOUT$vertexCountOutput, OFFSET$vertexCountOutput, value);
        return this;
    }

    public XrSpaceTriangleMeshMETA vertices(@Nullable IXrVector3f value) {
    ...
    public XrSpaceTriangleMeshMETA indexCapacityInput(@Unsigned int value) {
    ...
    public XrSpaceTriangleMeshMETA indexCountOutput(@Unsigned int value) {
    ...
    public XrSpaceTriangleMeshMETA indices(@Nullable @Unsigned IntPtr value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        indicesRaw(s);
        return this;
    }

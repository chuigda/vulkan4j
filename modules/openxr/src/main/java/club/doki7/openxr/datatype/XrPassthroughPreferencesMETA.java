...
public record XrPassthroughPreferencesMETA(@NotNull MemorySegment segment) implements IXrPassthroughPreferencesMETA {
    ...
    public static XrPassthroughPreferencesMETA allocate(Arena arena) {
        ...
        ret.type(XrStructureType.XR_TYPE_PASSTHROUGH_PREFERENCES_META);
        return ret;
    }
    ...
    public static XrPassthroughPreferencesMETA.Ptr allocate(Arena arena, long count) {
        ...
        for (long i = 0; i < count; i++) {
            ret.at(i).type(XrStructureType.XR_TYPE_PASSTHROUGH_PREFERENCES_META);
        }
        return ret;
    }
    ...
    public void autoInit() {
        type(XrStructureType.XR_TYPE_PASSTHROUGH_PREFERENCES_META);
    }
    ...
    public @Bitmask(XrPassthroughPreferenceFlagsMETA.class) int flags() {
        return segment.get(LAYOUT$flags, OFFSET$flags);
    }

    public XrPassthroughPreferencesMETA flags(@Bitmask(XrPassthroughPreferenceFlagsMETA.class) int value) {

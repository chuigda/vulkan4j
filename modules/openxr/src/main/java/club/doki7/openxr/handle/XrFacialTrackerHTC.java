...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrFacialTrackerHTC.html"><code>XrFacialTrackerHTC</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrFacialTrackerHTC.html"><code>XrFacialTrackerHTC</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrFacialTrackerHTC(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrFacialTrackerHTC.html"><code>XrFacialTrackerHTC</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrFacialTrackerHTC> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrFacialTrackerHTC read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new XrFacialTrackerHTC(s);
        }

        public void write(@Nullable XrFacialTrackerHTC value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrFacialTrackerHTC read(long index) {
        ...
        public void write(long index, @Nullable XrFacialTrackerHTC value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrFacialTrackerHTC[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrFacialTrackerHTC value0, @Nullable XrFacialTrackerHTC ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrFacialTrackerHTC @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrFacialTrackerHTC> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrFacialTrackerHTC value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrFacialTrackerHTC value0, @Nullable XrFacialTrackerHTC ...values) {
        ...
        @Override
        public @NotNull Iterator<XrFacialTrackerHTC> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrFacialTrackerHTC> {

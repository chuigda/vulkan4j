...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSenseDataSnapshotBD.html"><code>XrSenseDataSnapshotBD</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSenseDataSnapshotBD.html"><code>XrSenseDataSnapshotBD</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrSenseDataSnapshotBD(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSenseDataSnapshotBD.html"><code>XrSenseDataSnapshotBD</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrSenseDataSnapshotBD> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrSenseDataSnapshotBD read() {
        ...
        public void write(@Nullable XrSenseDataSnapshotBD value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrSenseDataSnapshotBD read(long index) {
        ...
        public void write(long index, @Nullable XrSenseDataSnapshotBD value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrSenseDataSnapshotBD[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrSenseDataSnapshotBD value0, @Nullable XrSenseDataSnapshotBD ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrSenseDataSnapshotBD @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrSenseDataSnapshotBD> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrSenseDataSnapshotBD value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrSenseDataSnapshotBD value0, @Nullable XrSenseDataSnapshotBD ...values) {
        ...
        @Override
        public @NotNull Iterator<XrSenseDataSnapshotBD> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrSenseDataSnapshotBD> {
            ...
            @Override
            public @Nullable XrSenseDataSnapshotBD next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new XrSenseDataSnapshotBD(s);
            }

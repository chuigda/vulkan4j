...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrFaceTracker2FB.html"><code>XrFaceTracker2FB</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrFaceTracker2FB.html"><code>XrFaceTracker2FB</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrFaceTracker2FB(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrFaceTracker2FB.html"><code>XrFaceTracker2FB</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrFaceTracker2FB> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrFaceTracker2FB read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new XrFaceTracker2FB(s);
        }

        public void write(@Nullable XrFaceTracker2FB value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrFaceTracker2FB read(long index) {
        ...
        public void write(long index, @Nullable XrFaceTracker2FB value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrFaceTracker2FB[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrFaceTracker2FB value0, @Nullable XrFaceTracker2FB ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrFaceTracker2FB @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrFaceTracker2FB> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrFaceTracker2FB value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrFaceTracker2FB value0, @Nullable XrFaceTracker2FB ...values) {
        ...
        @Override
        public @NotNull Iterator<XrFaceTracker2FB> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrFaceTracker2FB> {

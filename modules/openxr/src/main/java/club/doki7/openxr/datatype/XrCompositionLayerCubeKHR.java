...
public record XrCompositionLayerCubeKHR(@NotNull MemorySegment segment) implements IXrCompositionLayerCubeKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IXrCompositionLayerCubeKHR, Iterable<XrCompositionLayerCubeKHR> {
        ...
        public XrCompositionLayerCubeKHR.Ptr at(long index, @NotNull Consumer<@NotNull XrCompositionLayerCubeKHR> consumer) {
    ...
    public static XrCompositionLayerCubeKHR allocate(Arena arena) {
        ...
        ret.type(XrStructureType.COMPOSITION_LAYER_CUBE_KHR);
        return ret;
    }
    ...
    public static XrCompositionLayerCubeKHR.Ptr allocate(Arena arena, long count) {
        ...
        for (long i = 0; i < count; i++) {
            ret.at(i).type(XrStructureType.COMPOSITION_LAYER_CUBE_KHR);
        }
        return ret;
    }
    ...
    public void autoInit() {
        type(XrStructureType.COMPOSITION_LAYER_CUBE_KHR);
    }
    ...
    public XrCompositionLayerCubeKHR layerFlags(@Bitmask(XrCompositionLayerFlags.class) long value) {

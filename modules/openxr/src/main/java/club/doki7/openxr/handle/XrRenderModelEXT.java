...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrRenderModelEXT.html"><code>XrRenderModelEXT</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrRenderModelEXT.html"><code>XrRenderModelEXT</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrRenderModelEXT(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrRenderModelEXT.html"><code>XrRenderModelEXT</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrRenderModelEXT> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrRenderModelEXT read() {
        ...
        public void write(@Nullable XrRenderModelEXT value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrRenderModelEXT read(long index) {
        ...
        public void write(long index, @Nullable XrRenderModelEXT value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrRenderModelEXT[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrRenderModelEXT value0, @Nullable XrRenderModelEXT ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrRenderModelEXT @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrRenderModelEXT> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrRenderModelEXT value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrRenderModelEXT value0, @Nullable XrRenderModelEXT ...values) {
        ...
        @Override
        public @NotNull Iterator<XrRenderModelEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrRenderModelEXT> {

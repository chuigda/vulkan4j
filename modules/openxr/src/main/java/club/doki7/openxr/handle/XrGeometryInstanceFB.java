...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrGeometryInstanceFB.html"><code>XrGeometryInstanceFB</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrGeometryInstanceFB.html"><code>XrGeometryInstanceFB</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrGeometryInstanceFB(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrGeometryInstanceFB.html"><code>XrGeometryInstanceFB</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrGeometryInstanceFB> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrGeometryInstanceFB read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new XrGeometryInstanceFB(s);
        }

        public void write(@Nullable XrGeometryInstanceFB value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrGeometryInstanceFB read(long index) {
        ...
        public void write(long index, @Nullable XrGeometryInstanceFB value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrGeometryInstanceFB[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrGeometryInstanceFB value0, @Nullable XrGeometryInstanceFB ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrGeometryInstanceFB @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrGeometryInstanceFB> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrGeometryInstanceFB value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrGeometryInstanceFB value0, @Nullable XrGeometryInstanceFB ...values) {
        ...
        @Override
        public @NotNull Iterator<XrGeometryInstanceFB> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrGeometryInstanceFB> {
            ...
            @Override
            public @Nullable XrGeometryInstanceFB next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new XrGeometryInstanceFB(s);
            }

...
public record XrCompositionLayerEquirect2KHR(@NotNull MemorySegment segment) implements IXrCompositionLayerEquirect2KHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IXrCompositionLayerEquirect2KHR, Iterable<XrCompositionLayerEquirect2KHR> {
        ...
        public XrCompositionLayerEquirect2KHR.Ptr at(long index, @NotNull Consumer<@NotNull XrCompositionLayerEquirect2KHR> consumer) {
    ...
    public static XrCompositionLayerEquirect2KHR allocate(Arena arena) {
        ...
        ret.type(XrStructureType.COMPOSITION_LAYER_EQUIRECT2_KHR);
        return ret;
    }
    ...
    public static XrCompositionLayerEquirect2KHR.Ptr allocate(Arena arena, long count) {
        ...
        for (long i = 0; i < count; i++) {
            ret.at(i).type(XrStructureType.COMPOSITION_LAYER_EQUIRECT2_KHR);
        }
        return ret;
    }
    ...
    public void autoInit() {
        type(XrStructureType.COMPOSITION_LAYER_EQUIRECT2_KHR);
    }
    ...
    public XrCompositionLayerEquirect2KHR layerFlags(@Bitmask(XrCompositionLayerFlags.class) long value) {

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrAnchorBD.html"><code>XrAnchorBD</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrAnchorBD.html"><code>XrAnchorBD</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrAnchorBD(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrAnchorBD.html"><code>XrAnchorBD</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrAnchorBD> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrAnchorBD read() {
        ...
        public void write(@Nullable XrAnchorBD value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrAnchorBD read(long index) {
        ...
        public void write(long index, @Nullable XrAnchorBD value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrAnchorBD[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrAnchorBD value0, @Nullable XrAnchorBD ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrAnchorBD @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrAnchorBD> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrAnchorBD value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrAnchorBD value0, @Nullable XrAnchorBD ...values) {
        ...
        @Override
        public @NotNull Iterator<XrAnchorBD> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrAnchorBD> {

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpatialSnapshotEXT.html"><code>XrSpatialSnapshotEXT</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpatialSnapshotEXT.html"><code>XrSpatialSnapshotEXT</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrSpatialSnapshotEXT(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrSpatialSnapshotEXT.html"><code>XrSpatialSnapshotEXT</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrSpatialSnapshotEXT> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrSpatialSnapshotEXT read() {
        ...
        public void write(@Nullable XrSpatialSnapshotEXT value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrSpatialSnapshotEXT read(long index) {
        ...
        public void write(long index, @Nullable XrSpatialSnapshotEXT value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrSpatialSnapshotEXT[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrSpatialSnapshotEXT value0, @Nullable XrSpatialSnapshotEXT ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrSpatialSnapshotEXT @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrSpatialSnapshotEXT> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrSpatialSnapshotEXT value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrSpatialSnapshotEXT value0, @Nullable XrSpatialSnapshotEXT ...values) {
        ...
        @Override
        public @NotNull Iterator<XrSpatialSnapshotEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrSpatialSnapshotEXT> {
            ...
            @Override
            public @Nullable XrSpatialSnapshotEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new XrSpatialSnapshotEXT(s);
            }

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrEyeTrackerFB.html"><code>XrEyeTrackerFB</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrEyeTrackerFB.html"><code>XrEyeTrackerFB</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrEyeTrackerFB(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrEyeTrackerFB.html"><code>XrEyeTrackerFB</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrEyeTrackerFB> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrEyeTrackerFB read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new XrEyeTrackerFB(s);
        }

        public void write(@Nullable XrEyeTrackerFB value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrEyeTrackerFB read(long index) {
        ...
        public void write(long index, @Nullable XrEyeTrackerFB value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrEyeTrackerFB[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrEyeTrackerFB value0, @Nullable XrEyeTrackerFB ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrEyeTrackerFB @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrEyeTrackerFB> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrEyeTrackerFB value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrEyeTrackerFB value0, @Nullable XrEyeTrackerFB ...values) {
        ...
        @Override
        public @NotNull Iterator<XrEyeTrackerFB> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrEyeTrackerFB> {

...
/// Represents a pointer to a <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrVisibilityMaskKHR.html"><code>XrVisibilityMaskKHR</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
///
/// The {@code allocate} ({@link XrVisibilityMaskKHR#allocate(Arena)}, {@link XrVisibilityMaskKHR#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link XrVisibilityMaskKHR#autoInit}
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrVisibilityMaskKHR.html"><code>XrVisibilityMaskKHR</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrVisibilityMaskKHR(@NotNull MemorySegment segment) implements IXrVisibilityMaskKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrVisibilityMaskKHR.html"><code>XrVisibilityMaskKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link XrVisibilityMaskKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IXrVisibilityMaskKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code XrVisibilityMaskKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IXrVisibilityMaskKHR, Iterable<XrVisibilityMaskKHR> {
        public long size() {
            return segment.byteSize() / XrVisibilityMaskKHR.BYTES;
        }
        ...
        public @NotNull XrVisibilityMaskKHR at(long index) {
        ...
        public void write(long index, @NotNull XrVisibilityMaskKHR value) {
            MemorySegment s = segment.asSlice(index * XrVisibilityMaskKHR.BYTES, XrVisibilityMaskKHR.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * XrVisibilityMaskKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * XrVisibilityMaskKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * XrVisibilityMaskKHR.BYTES,
                (end - start) * XrVisibilityMaskKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * XrVisibilityMaskKHR.BYTES));
        }

        public XrVisibilityMaskKHR[] toArray() {
            XrVisibilityMaskKHR[] ret = new XrVisibilityMaskKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<XrVisibilityMaskKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<XrVisibilityMaskKHR> {
            ...
            @Override
            public XrVisibilityMaskKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                XrVisibilityMaskKHR ret = new XrVisibilityMaskKHR(segment.asSlice(0, XrVisibilityMaskKHR.BYTES));
                segment = segment.asSlice(XrVisibilityMaskKHR.BYTES);
                return ret;
            }
    ...
    public static XrVisibilityMaskKHR.Ptr allocate(Arena arena, long count) {
    ...
    public static XrVisibilityMaskKHR clone(Arena arena, XrVisibilityMaskKHR src) {
        XrVisibilityMaskKHR ret = allocate(arena);
    ...
    public XrVisibilityMaskKHR type(@EnumType(XrStructureType.class) int value) {
    ...
    public XrVisibilityMaskKHR next(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$next, OFFSET$next, value);
        return this;
    }

    public XrVisibilityMaskKHR next(@Nullable IPointer pointer) {
    ...
    public XrVisibilityMaskKHR vertexCapacityInput(@Unsigned int value) {
    ...
    public XrVisibilityMaskKHR vertexCountOutput(@Unsigned int value) {
        segment.set(LAYOUT$vertexCountOutput, OFFSET$vertexCountOutput, value);
        return this;
    }

    public XrVisibilityMaskKHR vertices(@Nullable IXrVector2f value) {
    ...
    public XrVisibilityMaskKHR indexCapacityInput(@Unsigned int value) {
    ...
    public XrVisibilityMaskKHR indexCountOutput(@Unsigned int value) {
    ...
    public XrVisibilityMaskKHR indices(@Nullable @Unsigned IntPtr value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        indicesRaw(s);
        return this;
    }

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrBodyTrackerHTC.html"><code>XrBodyTrackerHTC</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrBodyTrackerHTC.html"><code>XrBodyTrackerHTC</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record XrBodyTrackerHTC(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenXR/specs/1.1/man/html/XrBodyTrackerHTC.html"><code>XrBodyTrackerHTC</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<XrBodyTrackerHTC> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable XrBodyTrackerHTC read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new XrBodyTrackerHTC(s);
        }

        public void write(@Nullable XrBodyTrackerHTC value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable XrBodyTrackerHTC read(long index) {
        ...
        public void write(long index, @Nullable XrBodyTrackerHTC value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable XrBodyTrackerHTC[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable XrBodyTrackerHTC value0, @Nullable XrBodyTrackerHTC ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable XrBodyTrackerHTC @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable XrBodyTrackerHTC> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable XrBodyTrackerHTC value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable XrBodyTrackerHTC value0, @Nullable XrBodyTrackerHTC ...values) {
        ...
        @Override
        public @NotNull Iterator<XrBodyTrackerHTC> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<XrBodyTrackerHTC> {

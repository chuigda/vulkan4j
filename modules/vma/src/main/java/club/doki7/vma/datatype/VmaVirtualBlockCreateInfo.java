...
public record VmaVirtualBlockCreateInfo(@NotNull MemorySegment segment) implements IVmaVirtualBlockCreateInfo {
    ...
    public @MagicConstant(valuesFromClass = VmaVirtualBlockCreateFlags.class) int flags() {
        return segment.get(LAYOUT$flags, OFFSET$flags);
    }

    public VmaVirtualBlockCreateInfo flags(@MagicConstant(valuesFromClass = VmaVirtualBlockCreateFlags.class) int value) {

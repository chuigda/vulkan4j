...
public record VmaAllocationInfo(@NotNull MemorySegment segment) implements IVmaAllocationInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVmaAllocationInfo, Iterable<VmaAllocationInfo> {
        ...
        public VmaAllocationInfo.Ptr at(long index, @NotNull Consumer<@NotNull VmaAllocationInfo> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VmaAllocationInfo.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VmaAllocationInfo> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VmaAllocationInfo> {

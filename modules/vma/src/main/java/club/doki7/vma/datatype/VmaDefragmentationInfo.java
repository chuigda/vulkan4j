...
///     PFN_vmaCheckDefragmentationBreakFunction pfnBreakCallback; // optional // @link substring="PFN_vmaCheckDefragmentationBreakFunction" target="IPFN_vmaCheckDefragmentationBreakFunction" @link substring="pfnBreakCallback" target="#pfnBreakCallback"
...
public record VmaDefragmentationInfo(@NotNull MemorySegment segment) implements IVmaDefragmentationInfo {
    ...
    public @Bitmask(VmaDefragmentationFlags.class) int flags() {
        return segment.get(LAYOUT$flags, OFFSET$flags);
    }

    public VmaDefragmentationInfo flags(@Bitmask(VmaDefragmentationFlags.class) int value) {

...
public final class SDL_GLContextFlag {
    public static final int DEBUG_FLAG = 0x1;
    public static final int FORWARD_COMPATIBLE_FLAG = 0x2;
    public static final int RESET_ISOLATION_FLAG = 0x8;
    public static final int ROBUST_ACCESS_FLAG = 0x4;

...
public final class SDL_AudioFormat {
    public static final int SDL_AUDIO_UNKNOWN = 0x0;
    public static final int SDL_AUDIO_U8 = 0x8;
    ...
    public static String explain(@EnumType(SDL_AudioFormat.class) int value) {
        return switch (value) {
            case SDL_AudioFormat.SDL_AUDIO_F32BE -> "SDL_AUDIO_F32BE";
            case SDL_AudioFormat.SDL_AUDIO_F32LE -> "SDL_AUDIO_F32LE";
            case SDL_AudioFormat.SDL_AUDIO_S16BE -> "SDL_AUDIO_S16BE";
            case SDL_AudioFormat.SDL_AUDIO_S16LE -> "SDL_AUDIO_S16LE";
            case SDL_AudioFormat.SDL_AUDIO_S32BE -> "SDL_AUDIO_S32BE";
            case SDL_AudioFormat.SDL_AUDIO_S32LE -> "SDL_AUDIO_S32LE";
            case SDL_AudioFormat.SDL_AUDIO_S8 -> "SDL_AUDIO_S8";
            case SDL_AudioFormat.SDL_AUDIO_U8 -> "SDL_AUDIO_U8";
            case SDL_AudioFormat.SDL_AUDIO_UNKNOWN -> "SDL_AUDIO_UNKNOWN";

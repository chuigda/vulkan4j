...
///     Sint16 level; // optional // @link substring="level" target="#level"
...
@ValueBasedCandidate
@UnsafeConstructor
public record SDL_HapticConstant(@NotNull MemorySegment segment) implements ISDL_HapticConstant {
    /// Represents a pointer to / an array of null structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link SDL_HapticConstant}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// ISDL_HapticConstant to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code SDL_HapticConstant.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements ISDL_HapticConstant, Iterable<SDL_HapticConstant> {
        public long size() {
            return segment.byteSize() / SDL_HapticConstant.BYTES;
        }
        ...
        public @NotNull SDL_HapticConstant at(long index) {
            return new SDL_HapticConstant(segment.asSlice(index * SDL_HapticConstant.BYTES, SDL_HapticConstant.BYTES));
        }

        public void write(long index, @NotNull SDL_HapticConstant value) {
            MemorySegment s = segment.asSlice(index * SDL_HapticConstant.BYTES, SDL_HapticConstant.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * SDL_HapticConstant.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * SDL_HapticConstant.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * SDL_HapticConstant.BYTES,
                (end - start) * SDL_HapticConstant.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * SDL_HapticConstant.BYTES));
        }

        public SDL_HapticConstant[] toArray() {
            SDL_HapticConstant[] ret = new SDL_HapticConstant[(int) size()];
        ...
        @Override
        public @NotNull Iterator<SDL_HapticConstant> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<SDL_HapticConstant> {
            ...
            @Override
            public SDL_HapticConstant next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                SDL_HapticConstant ret = new SDL_HapticConstant(segment.asSlice(0, SDL_HapticConstant.BYTES));
                segment = segment.asSlice(SDL_HapticConstant.BYTES);
                return ret;
            }
    ...
    public static SDL_HapticConstant allocate(Arena arena) {
        return new SDL_HapticConstant(arena.allocate(LAYOUT));
    }

    public static SDL_HapticConstant.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        return new SDL_HapticConstant.Ptr(segment);
    }

    public static SDL_HapticConstant clone(Arena arena, SDL_HapticConstant src) {
        SDL_HapticConstant ret = allocate(arena);
    ...
    public SDL_HapticConstant type(@NativeType("Uint16") @Unsigned short value) {
    ...
    public SDL_HapticConstant direction(@NotNull SDL_HapticDirection value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$direction, SIZE$direction);
        return this;
    }

    public SDL_HapticConstant direction(Consumer<@NotNull SDL_HapticDirection> consumer) {
    ...
    public SDL_HapticConstant length(@NativeType("Uint32") @Unsigned int value) {
    ...
    public SDL_HapticConstant delay(@NativeType("Uint16") @Unsigned short value) {
    ...
    public SDL_HapticConstant button(@NativeType("Uint16") @Unsigned short value) {
    ...
    public SDL_HapticConstant interval(@NativeType("Uint16") @Unsigned short value) {
        segment.set(LAYOUT$interval, OFFSET$interval, value);
        return this;
    }

    public @NativeType("Sint16") short level() {
        return segment.get(LAYOUT$level, OFFSET$level);
    }

    public SDL_HapticConstant level(@NativeType("Sint16") short value) {
    ...
    public SDL_HapticConstant attack_length(@NativeType("Uint16") @Unsigned short value) {
    ...
    public SDL_HapticConstant attack_level(@NativeType("Uint16") @Unsigned short value) {
    ...
    public SDL_HapticConstant fade_length(@NativeType("Uint16") @Unsigned short value) {
    ...
    public SDL_HapticConstant fade_level(@NativeType("Uint16") @Unsigned short value) {
    ...
    public static final OfShort LAYOUT$level = (OfShort) LAYOUT.select(PATH$level);

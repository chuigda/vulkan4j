...
@ValueBasedCandidate
@UnsafeConstructor
public record SDL_JoyAxisEvent(@NotNull MemorySegment segment) implements ISDL_JoyAxisEvent {
    /// Represents a pointer to / an array of null structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link SDL_JoyAxisEvent}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// ISDL_JoyAxisEvent to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code SDL_JoyAxisEvent.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements ISDL_JoyAxisEvent, Iterable<SDL_JoyAxisEvent> {
        public long size() {
            return segment.byteSize() / SDL_JoyAxisEvent.BYTES;
        }
        ...
        public @NotNull SDL_JoyAxisEvent at(long index) {
            return new SDL_JoyAxisEvent(segment.asSlice(index * SDL_JoyAxisEvent.BYTES, SDL_JoyAxisEvent.BYTES));
        }

        public void write(long index, @NotNull SDL_JoyAxisEvent value) {
            MemorySegment s = segment.asSlice(index * SDL_JoyAxisEvent.BYTES, SDL_JoyAxisEvent.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * SDL_JoyAxisEvent.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * SDL_JoyAxisEvent.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * SDL_JoyAxisEvent.BYTES,
                (end - start) * SDL_JoyAxisEvent.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * SDL_JoyAxisEvent.BYTES));
        }

        public SDL_JoyAxisEvent[] toArray() {
            SDL_JoyAxisEvent[] ret = new SDL_JoyAxisEvent[(int) size()];
        ...
        @Override
        public @NotNull Iterator<SDL_JoyAxisEvent> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<SDL_JoyAxisEvent> {
            ...
            @Override
            public SDL_JoyAxisEvent next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                SDL_JoyAxisEvent ret = new SDL_JoyAxisEvent(segment.asSlice(0, SDL_JoyAxisEvent.BYTES));
                segment = segment.asSlice(SDL_JoyAxisEvent.BYTES);
                return ret;
            }
    ...
    public static SDL_JoyAxisEvent allocate(Arena arena) {
        return new SDL_JoyAxisEvent(arena.allocate(LAYOUT));
    }

    public static SDL_JoyAxisEvent.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        return new SDL_JoyAxisEvent.Ptr(segment);
    }

    public static SDL_JoyAxisEvent clone(Arena arena, SDL_JoyAxisEvent src) {
        SDL_JoyAxisEvent ret = allocate(arena);
    ...
    public SDL_JoyAxisEvent type(@EnumType(SDL_EventType.class) int value) {
    ...
    public SDL_JoyAxisEvent timestamp(@NativeType("Uint64") @Unsigned long value) {
    ...
    public SDL_JoyAxisEvent which(@NativeType("SDL_JoystickID") @Unsigned int value) {
    ...
    public SDL_JoyAxisEvent axis(@NativeType("Uint8") @Unsigned byte value) {
    ...
    public SDL_JoyAxisEvent padding1(@NativeType("Uint8") @Unsigned byte value) {
    ...
    public SDL_JoyAxisEvent padding2(@NativeType("Uint8") @Unsigned byte value) {
    ...
    public SDL_JoyAxisEvent padding3(@NativeType("Uint8") @Unsigned byte value) {
    ...
    public SDL_JoyAxisEvent value(@NativeType("Sint16") short value) {
    ...
    public SDL_JoyAxisEvent padding4(@NativeType("Uint16") @Unsigned short value) {

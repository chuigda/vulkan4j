...
@ValueBasedCandidate
@UnsafeConstructor
public record SDL_JoyHatEvent(@NotNull MemorySegment segment) implements ISDL_JoyHatEvent {
    /// Represents a pointer to / an array of null structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link SDL_JoyHatEvent}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// ISDL_JoyHatEvent to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code SDL_JoyHatEvent.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements ISDL_JoyHatEvent, Iterable<SDL_JoyHatEvent> {
        public long size() {
            return segment.byteSize() / SDL_JoyHatEvent.BYTES;
        }
        ...
        public @NotNull SDL_JoyHatEvent at(long index) {
            return new SDL_JoyHatEvent(segment.asSlice(index * SDL_JoyHatEvent.BYTES, SDL_JoyHatEvent.BYTES));
        }

        public void write(long index, @NotNull SDL_JoyHatEvent value) {
            MemorySegment s = segment.asSlice(index * SDL_JoyHatEvent.BYTES, SDL_JoyHatEvent.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * SDL_JoyHatEvent.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * SDL_JoyHatEvent.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * SDL_JoyHatEvent.BYTES,
                (end - start) * SDL_JoyHatEvent.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * SDL_JoyHatEvent.BYTES));
        }

        public SDL_JoyHatEvent[] toArray() {
            SDL_JoyHatEvent[] ret = new SDL_JoyHatEvent[(int) size()];
        ...
        @Override
        public @NotNull Iterator<SDL_JoyHatEvent> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<SDL_JoyHatEvent> {
            ...
            @Override
            public SDL_JoyHatEvent next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                SDL_JoyHatEvent ret = new SDL_JoyHatEvent(segment.asSlice(0, SDL_JoyHatEvent.BYTES));
                segment = segment.asSlice(SDL_JoyHatEvent.BYTES);
                return ret;
            }
    ...
    public static SDL_JoyHatEvent allocate(Arena arena) {
        return new SDL_JoyHatEvent(arena.allocate(LAYOUT));
    }

    public static SDL_JoyHatEvent.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        return new SDL_JoyHatEvent.Ptr(segment);
    }

    public static SDL_JoyHatEvent clone(Arena arena, SDL_JoyHatEvent src) {
        SDL_JoyHatEvent ret = allocate(arena);
    ...
    public SDL_JoyHatEvent type(@EnumType(SDL_EventType.class) int value) {
    ...
    public SDL_JoyHatEvent timestamp(@NativeType("Uint64") @Unsigned long value) {
    ...
    public SDL_JoyHatEvent which(@NativeType("SDL_JoystickID") @Unsigned int value) {
        segment.set(LAYOUT$which, OFFSET$which, value);
        return this;
    }

    public @NativeType("Uint8") @Unsigned byte hat() {
        return segment.get(LAYOUT$hat, OFFSET$hat);
    }

    public SDL_JoyHatEvent hat(@NativeType("Uint8") @Unsigned byte value) {
        segment.set(LAYOUT$hat, OFFSET$hat, value);
        return this;
    }

    public @NativeType("Uint8") @Unsigned byte value() {
        return segment.get(LAYOUT$value, OFFSET$value);
    }

    public SDL_JoyHatEvent value(@NativeType("Uint8") @Unsigned byte value) {
    ...
    public SDL_JoyHatEvent padding1(@NativeType("Uint8") @Unsigned byte value) {
    ...
    public SDL_JoyHatEvent padding2(@NativeType("Uint8") @Unsigned byte value) {
    ...
    public static final OfByte LAYOUT$hat = (OfByte) LAYOUT.select(PATH$hat);
    public static final OfByte LAYOUT$value = (OfByte) LAYOUT.select(PATH$value);

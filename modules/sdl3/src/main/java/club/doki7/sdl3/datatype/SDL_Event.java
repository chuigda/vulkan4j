...
///     SDL_CommonEvent common; // optional // @link substring="SDL_CommonEvent" target="SDL_CommonEvent" @link substring="common" target="#common"
///     SDL_DisplayEvent display; // optional // @link substring="SDL_DisplayEvent" target="SDL_DisplayEvent" @link substring="display" target="#display"
///     SDL_WindowEvent window; // optional // @link substring="SDL_WindowEvent" target="SDL_WindowEvent" @link substring="window" target="#window"
///     SDL_KeyboardDeviceEvent kdevice; // optional // @link substring="SDL_KeyboardDeviceEvent" target="SDL_KeyboardDeviceEvent" @link substring="kdevice" target="#kdevice"
///     SDL_KeyboardEvent key; // optional // @link substring="SDL_KeyboardEvent" target="SDL_KeyboardEvent" @link substring="key" target="#key"
///     SDL_TextEditingEvent edit; // optional // @link substring="SDL_TextEditingEvent" target="SDL_TextEditingEvent" @link substring="edit" target="#edit"
///     SDL_TextEditingCandidatesEvent edit_candidates; // optional // @link substring="SDL_TextEditingCandidatesEvent" target="SDL_TextEditingCandidatesEvent" @link substring="edit_candidates" target="#edit_candidates"
///     SDL_TextInputEvent text; // optional // @link substring="SDL_TextInputEvent" target="SDL_TextInputEvent" @link substring="text" target="#text"
///     SDL_MouseDeviceEvent mdevice; // optional // @link substring="SDL_MouseDeviceEvent" target="SDL_MouseDeviceEvent" @link substring="mdevice" target="#mdevice"
///     SDL_MouseMotionEvent motion; // optional // @link substring="SDL_MouseMotionEvent" target="SDL_MouseMotionEvent" @link substring="motion" target="#motion"
///     SDL_MouseButtonEvent button; // optional // @link substring="SDL_MouseButtonEvent" target="SDL_MouseButtonEvent" @link substring="button" target="#button"
///     SDL_MouseWheelEvent wheel; // optional // @link substring="SDL_MouseWheelEvent" target="SDL_MouseWheelEvent" @link substring="wheel" target="#wheel"
///     SDL_JoyDeviceEvent jdevice; // optional // @link substring="SDL_JoyDeviceEvent" target="SDL_JoyDeviceEvent" @link substring="jdevice" target="#jdevice"
///     SDL_JoyAxisEvent jaxis; // optional // @link substring="SDL_JoyAxisEvent" target="SDL_JoyAxisEvent" @link substring="jaxis" target="#jaxis"
///     SDL_JoyBallEvent jball; // optional // @link substring="SDL_JoyBallEvent" target="SDL_JoyBallEvent" @link substring="jball" target="#jball"
///     SDL_JoyHatEvent jhat; // optional // @link substring="SDL_JoyHatEvent" target="SDL_JoyHatEvent" @link substring="jhat" target="#jhat"
///     SDL_JoyButtonEvent jbutton; // optional // @link substring="SDL_JoyButtonEvent" target="SDL_JoyButtonEvent" @link substring="jbutton" target="#jbutton"
///     SDL_JoyBatteryEvent jbattery; // optional // @link substring="SDL_JoyBatteryEvent" target="SDL_JoyBatteryEvent" @link substring="jbattery" target="#jbattery"
///     SDL_GamepadDeviceEvent gdevice; // optional // @link substring="SDL_GamepadDeviceEvent" target="SDL_GamepadDeviceEvent" @link substring="gdevice" target="#gdevice"
///     SDL_GamepadAxisEvent gaxis; // optional // @link substring="SDL_GamepadAxisEvent" target="SDL_GamepadAxisEvent" @link substring="gaxis" target="#gaxis"
///     SDL_GamepadButtonEvent gbutton; // optional // @link substring="SDL_GamepadButtonEvent" target="SDL_GamepadButtonEvent" @link substring="gbutton" target="#gbutton"
///     SDL_GamepadTouchpadEvent gtouchpad; // optional // @link substring="SDL_GamepadTouchpadEvent" target="SDL_GamepadTouchpadEvent" @link substring="gtouchpad" target="#gtouchpad"
///     SDL_GamepadSensorEvent gsensor; // optional // @link substring="SDL_GamepadSensorEvent" target="SDL_GamepadSensorEvent" @link substring="gsensor" target="#gsensor"
///     SDL_AudioDeviceEvent adevice; // optional // @link substring="SDL_AudioDeviceEvent" target="SDL_AudioDeviceEvent" @link substring="adevice" target="#adevice"
///     SDL_CameraDeviceEvent cdevice; // optional // @link substring="SDL_CameraDeviceEvent" target="SDL_CameraDeviceEvent" @link substring="cdevice" target="#cdevice"
///     SDL_SensorEvent sensor; // optional // @link substring="SDL_SensorEvent" target="SDL_SensorEvent" @link substring="sensor" target="#sensor"
///     SDL_QuitEvent quit; // optional // @link substring="SDL_QuitEvent" target="SDL_QuitEvent" @link substring="quit" target="#quit"
///     SDL_UserEvent user; // optional // @link substring="SDL_UserEvent" target="SDL_UserEvent" @link substring="user" target="#user"
///     SDL_TouchFingerEvent tfinger; // optional // @link substring="SDL_TouchFingerEvent" target="SDL_TouchFingerEvent" @link substring="tfinger" target="#tfinger"
///     SDL_PenProximityEvent pproximity; // optional // @link substring="SDL_PenProximityEvent" target="SDL_PenProximityEvent" @link substring="pproximity" target="#pproximity"
///     SDL_PenTouchEvent ptouch; // optional // @link substring="SDL_PenTouchEvent" target="SDL_PenTouchEvent" @link substring="ptouch" target="#ptouch"
///     SDL_PenMotionEvent pmotion; // optional // @link substring="SDL_PenMotionEvent" target="SDL_PenMotionEvent" @link substring="pmotion" target="#pmotion"
///     SDL_PenButtonEvent pbutton; // optional // @link substring="SDL_PenButtonEvent" target="SDL_PenButtonEvent" @link substring="pbutton" target="#pbutton"
///     SDL_PenAxisEvent paxis; // optional // @link substring="SDL_PenAxisEvent" target="SDL_PenAxisEvent" @link substring="paxis" target="#paxis"
///     SDL_RenderEvent render; // optional // @link substring="SDL_RenderEvent" target="SDL_RenderEvent" @link substring="render" target="#render"
///     SDL_DropEvent drop; // optional // @link substring="SDL_DropEvent" target="SDL_DropEvent" @link substring="drop" target="#drop"
///     SDL_ClipboardEvent clipboard; // optional // @link substring="SDL_ClipboardEvent" target="SDL_ClipboardEvent" @link substring="clipboard" target="#clipboard"
///     Uint8[128] padding; // optional // @link substring="padding" target="#padding"
/// } SDL_Event;
/// }
///
/// ## Contracts

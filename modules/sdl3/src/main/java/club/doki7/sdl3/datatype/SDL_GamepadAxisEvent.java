...
///     Uint8 axis; // optional // @link substring="axis" target="#axis"
...
///     Sint16 value; // optional // @link substring="value" target="#value"
///     Uint16 padding4; // optional // @link substring="padding4" target="#padding4"
...
@ValueBasedCandidate
@UnsafeConstructor
public record SDL_GamepadAxisEvent(@NotNull MemorySegment segment) implements ISDL_GamepadAxisEvent {
    /// Represents a pointer to / an array of null structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link SDL_GamepadAxisEvent}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// ISDL_GamepadAxisEvent to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code SDL_GamepadAxisEvent.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements ISDL_GamepadAxisEvent, Iterable<SDL_GamepadAxisEvent> {
        public long size() {
            return segment.byteSize() / SDL_GamepadAxisEvent.BYTES;
        }
        ...
        public @NotNull SDL_GamepadAxisEvent at(long index) {
            return new SDL_GamepadAxisEvent(segment.asSlice(index * SDL_GamepadAxisEvent.BYTES, SDL_GamepadAxisEvent.BYTES));
        }

        public void write(long index, @NotNull SDL_GamepadAxisEvent value) {
            MemorySegment s = segment.asSlice(index * SDL_GamepadAxisEvent.BYTES, SDL_GamepadAxisEvent.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * SDL_GamepadAxisEvent.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * SDL_GamepadAxisEvent.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * SDL_GamepadAxisEvent.BYTES,
                (end - start) * SDL_GamepadAxisEvent.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * SDL_GamepadAxisEvent.BYTES));
        }

        public SDL_GamepadAxisEvent[] toArray() {
            SDL_GamepadAxisEvent[] ret = new SDL_GamepadAxisEvent[(int) size()];
        ...
        @Override
        public @NotNull Iterator<SDL_GamepadAxisEvent> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<SDL_GamepadAxisEvent> {
            ...
            @Override
            public SDL_GamepadAxisEvent next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                SDL_GamepadAxisEvent ret = new SDL_GamepadAxisEvent(segment.asSlice(0, SDL_GamepadAxisEvent.BYTES));
                segment = segment.asSlice(SDL_GamepadAxisEvent.BYTES);
                return ret;
            }
    ...
    public static SDL_GamepadAxisEvent allocate(Arena arena) {
        return new SDL_GamepadAxisEvent(arena.allocate(LAYOUT));
    }

    public static SDL_GamepadAxisEvent.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        return new SDL_GamepadAxisEvent.Ptr(segment);
    }

    public static SDL_GamepadAxisEvent clone(Arena arena, SDL_GamepadAxisEvent src) {
        SDL_GamepadAxisEvent ret = allocate(arena);
    ...
    public SDL_GamepadAxisEvent type(@EnumType(SDL_EventType.class) int value) {
    ...
    public SDL_GamepadAxisEvent timestamp(@NativeType("Uint64") @Unsigned long value) {
    ...
    public SDL_GamepadAxisEvent which(@NativeType("SDL_JoystickID") @Unsigned int value) {
        segment.set(LAYOUT$which, OFFSET$which, value);
        return this;
    }

    public @NativeType("Uint8") @Unsigned byte axis() {
        return segment.get(LAYOUT$axis, OFFSET$axis);
    }

    public SDL_GamepadAxisEvent axis(@NativeType("Uint8") @Unsigned byte value) {
    ...
    public SDL_GamepadAxisEvent padding1(@NativeType("Uint8") @Unsigned byte value) {
    ...
    public SDL_GamepadAxisEvent padding2(@NativeType("Uint8") @Unsigned byte value) {
    ...
    public SDL_GamepadAxisEvent padding3(@NativeType("Uint8") @Unsigned byte value) {
        segment.set(LAYOUT$padding3, OFFSET$padding3, value);
        return this;
    }

    public @NativeType("Sint16") short value() {
        return segment.get(LAYOUT$value, OFFSET$value);
    }

    public SDL_GamepadAxisEvent value(@NativeType("Sint16") short value) {
        segment.set(LAYOUT$value, OFFSET$value, value);
        return this;
    }

    public @NativeType("Uint16") @Unsigned short padding4() {
        return segment.get(LAYOUT$padding4, OFFSET$padding4);
    }

    public SDL_GamepadAxisEvent padding4(@NativeType("Uint16") @Unsigned short value) {
        segment.set(LAYOUT$padding4, OFFSET$padding4, value);
        return this;
    }
    ...
    public static final PathElement PATH$padding4 = PathElement.groupElement("padding4");
    ...
    public static final OfByte LAYOUT$axis = (OfByte) LAYOUT.select(PATH$axis);
    ...
    public static final OfShort LAYOUT$value = (OfShort) LAYOUT.select(PATH$value);
    public static final OfShort LAYOUT$padding4 = (OfShort) LAYOUT.select(PATH$padding4);
    ...
    public static final long SIZE$padding4 = LAYOUT$padding4.byteSize();
    ...
    public static final long OFFSET$padding4 = LAYOUT.byteOffset(PATH$padding4);
}

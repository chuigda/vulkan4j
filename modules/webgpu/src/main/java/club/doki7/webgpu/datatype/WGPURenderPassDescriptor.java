...
@ValueBasedCandidate
@UnsafeConstructor
public record WGPURenderPassDescriptor(@NotNull MemorySegment segment) implements IWGPURenderPassDescriptor {
    /// Represents a pointer to / an array of null structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link WGPURenderPassDescriptor}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IWGPURenderPassDescriptor to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code WGPURenderPassDescriptor.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IWGPURenderPassDescriptor, Iterable<WGPURenderPassDescriptor> {
        public long size() {
            return segment.byteSize() / WGPURenderPassDescriptor.BYTES;
        }
        ...
        public @NotNull WGPURenderPassDescriptor at(long index) {
            return new WGPURenderPassDescriptor(segment.asSlice(index * WGPURenderPassDescriptor.BYTES, WGPURenderPassDescriptor.BYTES));
        }

        public WGPURenderPassDescriptor.Ptr at(long index, @NotNull Consumer<@NotNull WGPURenderPassDescriptor> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull WGPURenderPassDescriptor value) {
            MemorySegment s = segment.asSlice(index * WGPURenderPassDescriptor.BYTES, WGPURenderPassDescriptor.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * WGPURenderPassDescriptor.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * WGPURenderPassDescriptor.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * WGPURenderPassDescriptor.BYTES,
                (end - start) * WGPURenderPassDescriptor.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * WGPURenderPassDescriptor.BYTES));
        }

        public WGPURenderPassDescriptor[] toArray() {
            WGPURenderPassDescriptor[] ret = new WGPURenderPassDescriptor[(int) size()];
        ...
        @Override
        public @NotNull Iterator<WGPURenderPassDescriptor> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<WGPURenderPassDescriptor> {
            ...
            @Override
            public WGPURenderPassDescriptor next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                WGPURenderPassDescriptor ret = new WGPURenderPassDescriptor(segment.asSlice(0, WGPURenderPassDescriptor.BYTES));
                segment = segment.asSlice(WGPURenderPassDescriptor.BYTES);
                return ret;
            }
    ...
    public static WGPURenderPassDescriptor allocate(Arena arena) {
        return new WGPURenderPassDescriptor(arena.allocate(LAYOUT));
    }

    public static WGPURenderPassDescriptor.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        return new WGPURenderPassDescriptor.Ptr(segment);
    }

    public static WGPURenderPassDescriptor clone(Arena arena, WGPURenderPassDescriptor src) {
        WGPURenderPassDescriptor ret = allocate(arena);
    ...
    public WGPURenderPassDescriptor label(@NotNull WGPUStringView value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$label, SIZE$label);
        return this;
    }

    public WGPURenderPassDescriptor label(Consumer<@NotNull WGPUStringView> consumer) {
    ...
    @Unsafe public @Nullable WGPURenderPassColorAttachment.Ptr colorAttachments(int assumedCount) {
        MemorySegment s = colorAttachmentsRaw();
        if (s.equals(MemorySegment.NULL)) {
            return null;
        }

        s = s.reinterpret(assumedCount * WGPURenderPassColorAttachment.BYTES);
        return new WGPURenderPassColorAttachment.Ptr(s);
    }

    public @Nullable WGPURenderPassColorAttachment colorAttachments() {
        MemorySegment s = colorAttachmentsRaw();
        if (s.equals(MemorySegment.NULL)) {
            return null;
        }
        return new WGPURenderPassColorAttachment(s);
    }

    public @Pointer(target=WGPURenderPassColorAttachment.class) @NotNull MemorySegment colorAttachmentsRaw() {
        return segment.get(LAYOUT$colorAttachments, OFFSET$colorAttachments);
    }

    public void colorAttachmentsRaw(@Pointer(target=WGPURenderPassColorAttachment.class) @NotNull MemorySegment value) {
    ...
    public WGPURenderPassDescriptor occlusionQuerySet(@Nullable WGPUQuerySet value) {

...
///     WGPUPopErrorScopeCallback callback; // optional // @link substring="WGPUPopErrorScopeCallback" target="IWGPUPopErrorScopeCallback" @link substring="callback" target="#callback"
...
@ValueBasedCandidate
@UnsafeConstructor
public record WGPUPopErrorScopeCallbackInfo(@NotNull MemorySegment segment) implements IWGPUPopErrorScopeCallbackInfo {
    /// Represents a pointer to / an array of null structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link WGPUPopErrorScopeCallbackInfo}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IWGPUPopErrorScopeCallbackInfo to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code WGPUPopErrorScopeCallbackInfo.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IWGPUPopErrorScopeCallbackInfo, Iterable<WGPUPopErrorScopeCallbackInfo> {
        public long size() {
            return segment.byteSize() / WGPUPopErrorScopeCallbackInfo.BYTES;
        }
        ...
        public @NotNull WGPUPopErrorScopeCallbackInfo at(long index) {
            return new WGPUPopErrorScopeCallbackInfo(segment.asSlice(index * WGPUPopErrorScopeCallbackInfo.BYTES, WGPUPopErrorScopeCallbackInfo.BYTES));
        }

        public WGPUPopErrorScopeCallbackInfo.Ptr at(long index, @NotNull Consumer<@NotNull WGPUPopErrorScopeCallbackInfo> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull WGPUPopErrorScopeCallbackInfo value) {
            MemorySegment s = segment.asSlice(index * WGPUPopErrorScopeCallbackInfo.BYTES, WGPUPopErrorScopeCallbackInfo.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * WGPUPopErrorScopeCallbackInfo.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * WGPUPopErrorScopeCallbackInfo.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * WGPUPopErrorScopeCallbackInfo.BYTES,
                (end - start) * WGPUPopErrorScopeCallbackInfo.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * WGPUPopErrorScopeCallbackInfo.BYTES));
        }

        public WGPUPopErrorScopeCallbackInfo[] toArray() {
            WGPUPopErrorScopeCallbackInfo[] ret = new WGPUPopErrorScopeCallbackInfo[(int) size()];
        ...
        @Override
        public @NotNull Iterator<WGPUPopErrorScopeCallbackInfo> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<WGPUPopErrorScopeCallbackInfo> {
            ...
            @Override
            public WGPUPopErrorScopeCallbackInfo next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                WGPUPopErrorScopeCallbackInfo ret = new WGPUPopErrorScopeCallbackInfo(segment.asSlice(0, WGPUPopErrorScopeCallbackInfo.BYTES));
                segment = segment.asSlice(WGPUPopErrorScopeCallbackInfo.BYTES);
                return ret;
            }
    ...
    public static WGPUPopErrorScopeCallbackInfo allocate(Arena arena) {
        return new WGPUPopErrorScopeCallbackInfo(arena.allocate(LAYOUT));
    }

    public static WGPUPopErrorScopeCallbackInfo.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        return new WGPUPopErrorScopeCallbackInfo.Ptr(segment);
    }

    public static WGPUPopErrorScopeCallbackInfo clone(Arena arena, WGPUPopErrorScopeCallbackInfo src) {
        WGPUPopErrorScopeCallbackInfo ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public WGPUPopErrorScopeCallbackInfo nextInChain(@Nullable IWGPUChainedStruct value) {
    ...
    public WGPUPopErrorScopeCallbackInfo mode(@EnumType(WGPUCallbackMode.class) int value) {
        segment.set(LAYOUT$mode, OFFSET$mode, value);
        return this;
    }

    public @Pointer(comment="WGPUPopErrorScopeCallback") @NotNull MemorySegment callback() {
    ...
    public WGPUPopErrorScopeCallbackInfo userdata1(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$userdata1, OFFSET$userdata1, value);
        return this;
    }

    public WGPUPopErrorScopeCallbackInfo userdata1(@Nullable IPointer pointer) {
    ...
    public WGPUPopErrorScopeCallbackInfo userdata2(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$userdata2, OFFSET$userdata2, value);
        return this;
    }

    public WGPUPopErrorScopeCallbackInfo userdata2(@Nullable IPointer pointer) {

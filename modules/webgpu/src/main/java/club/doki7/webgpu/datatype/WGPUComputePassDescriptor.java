...
@ValueBasedCandidate
@UnsafeConstructor
public record WGPUComputePassDescriptor(@NotNull MemorySegment segment) implements IWGPUComputePassDescriptor {
    /// Represents a pointer to / an array of null structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link WGPUComputePassDescriptor}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IWGPUComputePassDescriptor to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code WGPUComputePassDescriptor.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IWGPUComputePassDescriptor, Iterable<WGPUComputePassDescriptor> {
        public long size() {
            return segment.byteSize() / WGPUComputePassDescriptor.BYTES;
        }
        ...
        public @NotNull WGPUComputePassDescriptor at(long index) {
            return new WGPUComputePassDescriptor(segment.asSlice(index * WGPUComputePassDescriptor.BYTES, WGPUComputePassDescriptor.BYTES));
        }

        public WGPUComputePassDescriptor.Ptr at(long index, @NotNull Consumer<@NotNull WGPUComputePassDescriptor> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull WGPUComputePassDescriptor value) {
            MemorySegment s = segment.asSlice(index * WGPUComputePassDescriptor.BYTES, WGPUComputePassDescriptor.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * WGPUComputePassDescriptor.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * WGPUComputePassDescriptor.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * WGPUComputePassDescriptor.BYTES,
                (end - start) * WGPUComputePassDescriptor.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * WGPUComputePassDescriptor.BYTES));
        }

        public WGPUComputePassDescriptor[] toArray() {
            WGPUComputePassDescriptor[] ret = new WGPUComputePassDescriptor[(int) size()];
        ...
        @Override
        public @NotNull Iterator<WGPUComputePassDescriptor> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<WGPUComputePassDescriptor> {
            ...
            @Override
            public WGPUComputePassDescriptor next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                WGPUComputePassDescriptor ret = new WGPUComputePassDescriptor(segment.asSlice(0, WGPUComputePassDescriptor.BYTES));
                segment = segment.asSlice(WGPUComputePassDescriptor.BYTES);
                return ret;
            }
    ...
    public static WGPUComputePassDescriptor allocate(Arena arena) {
        return new WGPUComputePassDescriptor(arena.allocate(LAYOUT));
    }

    public static WGPUComputePassDescriptor.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        return new WGPUComputePassDescriptor.Ptr(segment);
    }

    public static WGPUComputePassDescriptor clone(Arena arena, WGPUComputePassDescriptor src) {
        WGPUComputePassDescriptor ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public WGPUComputePassDescriptor nextInChain(@Nullable IWGPUChainedStruct value) {
    ...
    public WGPUComputePassDescriptor label(@NotNull WGPUStringView value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$label, SIZE$label);
        return this;
    }

    public WGPUComputePassDescriptor label(Consumer<@NotNull WGPUStringView> consumer) {

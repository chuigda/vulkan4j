...
///     uint32_t maxImmediateSize; // @link substring="maxImmediateSize" target="#maxImmediateSize"
/// } Limits;
/// }
///
/// ## Contracts
...
@ValueBasedCandidate
@UnsafeConstructor
public record Limits(@NotNull MemorySegment segment) implements ILimits {
    /// Represents a pointer to / an array of null structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link Limits}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// ILimits to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code Limits.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements ILimits, Iterable<Limits> {
        public long size() {
            return segment.byteSize() / Limits.BYTES;
        }
        ...
        public @NotNull Limits at(long index) {
            return new Limits(segment.asSlice(index * Limits.BYTES, Limits.BYTES));
        }

        public void write(long index, @NotNull Limits value) {
            MemorySegment s = segment.asSlice(index * Limits.BYTES, Limits.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * Limits.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * Limits.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * Limits.BYTES,
                (end - start) * Limits.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * Limits.BYTES));
        }

        public Limits[] toArray() {
            Limits[] ret = new Limits[(int) size()];
        ...
        @Override
        public @NotNull Iterator<Limits> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<Limits> {
            ...
            public Limits next() {
                ...
                Limits ret = new Limits(segment.asSlice(0, Limits.BYTES));
                segment = segment.asSlice(Limits.BYTES);
                return ret;
            }
    ...
    public static Limits allocate(Arena arena) {
        return new Limits(arena.allocate(LAYOUT));
    }

    public static Limits.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        return new Limits.Ptr(segment);
    }

    public static Limits clone(Arena arena, Limits src) {
        Limits ret = allocate(arena);
        ret.segment.copyFrom(src.segment);
        return ret;
    }

    public Limits nextInChain(@Nullable IChainedStruct value) {
    ...
    public Limits maxTextureDimension1d(@Unsigned int value) {
    ...
    public Limits maxTextureDimension2d(@Unsigned int value) {
    ...
    public Limits maxTextureDimension3d(@Unsigned int value) {
    ...
    public Limits maxTextureArrayLayers(@Unsigned int value) {
    ...
    public Limits maxBindGroups(@Unsigned int value) {
    ...
    public Limits maxBindGroupsPlusVertexBuffers(@Unsigned int value) {
    ...
    public Limits maxBindingsPerBindGroup(@Unsigned int value) {
    ...
    public Limits maxDynamicUniformBuffersPerPipelineLayout(@Unsigned int value) {
    ...
    public Limits maxDynamicStorageBuffersPerPipelineLayout(@Unsigned int value) {
    ...
    public Limits maxSampledTexturesPerShaderStage(@Unsigned int value) {
    ...
    public Limits maxSamplersPerShaderStage(@Unsigned int value) {
    ...
    public Limits maxStorageBuffersPerShaderStage(@Unsigned int value) {
    ...
    public Limits maxStorageTexturesPerShaderStage(@Unsigned int value) {
    ...
    public Limits maxUniformBuffersPerShaderStage(@Unsigned int value) {
    ...
    public Limits maxUniformBufferBindingSize(@Unsigned long value) {
    ...
    public Limits maxStorageBufferBindingSize(@Unsigned long value) {
    ...
    public Limits minUniformBufferOffsetAlignment(@Unsigned int value) {
    ...
    public Limits minStorageBufferOffsetAlignment(@Unsigned int value) {
    ...
    public Limits maxBufferSize(@Unsigned long value) {
    ...
    public Limits maxVertexBufferArrayStride(@Unsigned int value) {
    ...
    public Limits maxInterStageShaderVariables(@Unsigned int value) {
    ...
    public Limits maxColorAttachments(@Unsigned int value) {
    ...
    public Limits maxColorAttachmentBytesPerSample(@Unsigned int value) {
    ...
    public Limits maxComputeWorkgroupStorageSize(@Unsigned int value) {
    ...
    public Limits maxComputeInvocationsPerWorkgroup(@Unsigned int value) {
    ...
    public Limits maxComputeWorkgroupSizeX(@Unsigned int value) {
    ...
    public Limits maxComputeWorkgroupSizeY(@Unsigned int value) {
    ...
    public Limits maxComputeWorkgroupSizeZ(@Unsigned int value) {
    ...
    public Limits maxComputeWorkgroupsPerDimension(@Unsigned int value) {
        segment.set(LAYOUT$maxComputeWorkgroupsPerDimension, OFFSET$maxComputeWorkgroupsPerDimension, value);
        return this;
    }

    public @Unsigned int maxImmediateSize() {
        return segment.get(LAYOUT$maxImmediateSize, OFFSET$maxImmediateSize);
    }

    public Limits maxImmediateSize(@Unsigned int value) {
        segment.set(LAYOUT$maxImmediateSize, OFFSET$maxImmediateSize, value);
        return this;
    }
    ...
    public static final PathElement PATH$maxImmediateSize = PathElement.groupElement("maxImmediateSize");
    ...
    public static final OfInt LAYOUT$maxImmediateSize = (OfInt) LAYOUT.select(PATH$maxImmediateSize);
    ...
    public static final long SIZE$maxImmediateSize = LAYOUT$maxImmediateSize.byteSize();
    ...
    public static final long OFFSET$maxImmediateSize = LAYOUT.byteOffset(PATH$maxImmediateSize);
}

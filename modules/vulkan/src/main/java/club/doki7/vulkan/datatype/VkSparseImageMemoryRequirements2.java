...
public record VkSparseImageMemoryRequirements2(@NotNull MemorySegment segment) implements IVkSparseImageMemoryRequirements2 {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSparseImageMemoryRequirements2, Iterable<VkSparseImageMemoryRequirements2> {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkSparseImageMemoryRequirements2> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSparseImageMemoryRequirements2.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkSparseImageMemoryRequirements2> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSparseImageMemoryRequirements2> {
    ...
    public VkSparseImageMemoryRequirements2 sType(@EnumType(VkStructureType.class) int value) {

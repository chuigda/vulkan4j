...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDebugReportCallbackEXT.html"><code>VkDebugReportCallbackEXT</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDebugReportCallbackEXT.html"><code>VkDebugReportCallbackEXT</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkDebugReportCallbackEXT(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDebugReportCallbackEXT.html"><code>VkDebugReportCallbackEXT</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkDebugReportCallbackEXT> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkDebugReportCallbackEXT read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new VkDebugReportCallbackEXT(s);
        }

        public void write(@Nullable VkDebugReportCallbackEXT value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkDebugReportCallbackEXT read(long index) {
        ...
        public void write(long index, @Nullable VkDebugReportCallbackEXT value) {
        ...
        public static Ptr allocate(Arena arena, @Nullable VkDebugReportCallbackEXT @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkDebugReportCallbackEXT> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkDebugReportCallbackEXT value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        @Override
        public @NotNull Iterator<VkDebugReportCallbackEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkDebugReportCallbackEXT> {
            ...
            @Override
            public @Nullable VkDebugReportCallbackEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new VkDebugReportCallbackEXT(s);
            }

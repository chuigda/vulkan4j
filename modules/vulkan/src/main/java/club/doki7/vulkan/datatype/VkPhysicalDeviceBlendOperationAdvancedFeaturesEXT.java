...
public record VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceBlendOperationAdvancedFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceBlendOperationAdvancedFeaturesEXT, Iterable<VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT.BYTES,
                (end - start) * VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT.BYTES));
        }

        public VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT[] toArray() {
            VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT[] ret = new VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT> {
            ...
            @Override
            public VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT ret = new VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT(segment.asSlice(0, VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public @NativeType("VkBool32") @Unsigned int advancedBlendCoherentOperations() {
        return segment.get(LAYOUT$advancedBlendCoherentOperations, OFFSET$advancedBlendCoherentOperations);
    }

    public VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT advancedBlendCoherentOperations(@NativeType("VkBool32") @Unsigned int value) {

...
public record VkVideoCapabilitiesKHR(@NotNull MemorySegment segment) implements IVkVideoCapabilitiesKHR {
    ...
    public VkVideoCapabilitiesKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public @MagicConstant(valuesFromClass = VkVideoCapabilityFlagsKHR.class) int flags() {
        return segment.get(LAYOUT$flags, OFFSET$flags);
    }

    public VkVideoCapabilitiesKHR flags(@MagicConstant(valuesFromClass = VkVideoCapabilityFlagsKHR.class) int value) {

...
public record StdVideoDecodeH264PictureInfoFlags(@NotNull MemorySegment segment) implements IStdVideoDecodeH264PictureInfoFlags {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoDecodeH264PictureInfoFlags, Iterable<StdVideoDecodeH264PictureInfoFlags> {
        public long size() {
        ...
        public StdVideoDecodeH264PictureInfoFlags.Ptr at(long index, @NotNull Consumer<@NotNull StdVideoDecodeH264PictureInfoFlags> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * StdVideoDecodeH264PictureInfoFlags.BYTES));
        }
        ...
        public StdVideoDecodeH264PictureInfoFlags[] toArray() {
            StdVideoDecodeH264PictureInfoFlags[] ret = new StdVideoDecodeH264PictureInfoFlags[(int) size()];
        ...
        @Override
        public @NotNull Iterator<StdVideoDecodeH264PictureInfoFlags> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoDecodeH264PictureInfoFlags> {
            ...
            @Override
            public StdVideoDecodeH264PictureInfoFlags next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                StdVideoDecodeH264PictureInfoFlags ret = new StdVideoDecodeH264PictureInfoFlags(segment.asSlice(0, StdVideoDecodeH264PictureInfoFlags.BYTES));
                segment = segment.asSlice(StdVideoDecodeH264PictureInfoFlags.BYTES);
                return ret;
            }

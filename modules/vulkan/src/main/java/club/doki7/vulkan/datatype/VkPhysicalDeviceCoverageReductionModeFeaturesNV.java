...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCoverageReductionModeFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceCoverageReductionModeFeaturesNV#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceCoverageReductionModeFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCoverageReductionModeFeaturesNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceCoverageReductionModeFeaturesNV.html"><code>VkPhysicalDeviceCoverageReductionModeFeaturesNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceCoverageReductionModeFeaturesNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceCoverageReductionModeFeaturesNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceCoverageReductionModeFeaturesNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCoverageReductionModeFeaturesNV, Iterable<VkPhysicalDeviceCoverageReductionModeFeaturesNV> {
        ...
        public @NotNull VkPhysicalDeviceCoverageReductionModeFeaturesNV at(long index) {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceCoverageReductionModeFeaturesNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceCoverageReductionModeFeaturesNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceCoverageReductionModeFeaturesNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceCoverageReductionModeFeaturesNV.BYTES,
                (end - start) * VkPhysicalDeviceCoverageReductionModeFeaturesNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceCoverageReductionModeFeaturesNV.BYTES));
        }

        public VkPhysicalDeviceCoverageReductionModeFeaturesNV[] toArray() {
            VkPhysicalDeviceCoverageReductionModeFeaturesNV[] ret = new VkPhysicalDeviceCoverageReductionModeFeaturesNV[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceCoverageReductionModeFeaturesNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceCoverageReductionModeFeaturesNV> {
    ...
    public static VkPhysicalDeviceCoverageReductionModeFeaturesNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceCoverageReductionModeFeaturesNV.Ptr ret = new VkPhysicalDeviceCoverageReductionModeFeaturesNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_COVERAGE_REDUCTION_MODE_FEATURES_NV);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceCoverageReductionModeFeaturesNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

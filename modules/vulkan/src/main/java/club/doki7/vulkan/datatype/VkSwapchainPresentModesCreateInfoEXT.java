...
public record VkSwapchainPresentModesCreateInfoEXT(@NotNull MemorySegment segment) implements IVkSwapchainPresentModesCreateInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSwapchainPresentModesCreateInfoEXT, Iterable<VkSwapchainPresentModesCreateInfoEXT> {
        public long size() {
        ...
        public VkSwapchainPresentModesCreateInfoEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkSwapchainPresentModesCreateInfoEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSwapchainPresentModesCreateInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkSwapchainPresentModesCreateInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkSwapchainPresentModesCreateInfoEXT.BYTES,
                (end - start) * VkSwapchainPresentModesCreateInfoEXT.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkSwapchainPresentModesCreateInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSwapchainPresentModesCreateInfoEXT> {
            ...
            @Override
            public VkSwapchainPresentModesCreateInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkSwapchainPresentModesCreateInfoEXT ret = new VkSwapchainPresentModesCreateInfoEXT(segment.asSlice(0, VkSwapchainPresentModesCreateInfoEXT.BYTES));
                segment = segment.asSlice(VkSwapchainPresentModesCreateInfoEXT.BYTES);
                return ret;
            }
    ...
    public VkSwapchainPresentModesCreateInfoEXT sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkSwapchainPresentModesCreateInfoEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkSwapchainPresentModesCreateInfoEXT pNext(@Nullable IPointer pointer) {
    ...
    public VkSwapchainPresentModesCreateInfoEXT presentModeCount(@Unsigned int value) {
    ...
    public VkSwapchainPresentModesCreateInfoEXT pPresentModes(@Nullable @EnumType(VkPresentModeKHR.class) IntPtr value) {

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFragmentDensityMapFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceFragmentDensityMapFeaturesEXT#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkPhysicalDeviceFragmentDensityMapFeaturesEXT#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceFragmentDensityMapFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentDensityMapFeaturesEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceFragmentDensityMapFeaturesEXT.html"><code>VkPhysicalDeviceFragmentDensityMapFeaturesEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceFragmentDensityMapFeaturesEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceFragmentDensityMapFeaturesEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceFragmentDensityMapFeaturesEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentDensityMapFeaturesEXT, Iterable<VkPhysicalDeviceFragmentDensityMapFeaturesEXT> {
        public long size() {
            return segment.byteSize() / VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES;
        }
        ...
        public @NotNull VkPhysicalDeviceFragmentDensityMapFeaturesEXT at(long index) {
            return new VkPhysicalDeviceFragmentDensityMapFeaturesEXT(segment.asSlice(index * VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES, VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES));
        }

        public VkPhysicalDeviceFragmentDensityMapFeaturesEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceFragmentDensityMapFeaturesEXT> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull VkPhysicalDeviceFragmentDensityMapFeaturesEXT value) {
            MemorySegment s = segment.asSlice(index * VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES, VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES,
                (end - start) * VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES));
        }

        public VkPhysicalDeviceFragmentDensityMapFeaturesEXT[] toArray() {
            VkPhysicalDeviceFragmentDensityMapFeaturesEXT[] ret = new VkPhysicalDeviceFragmentDensityMapFeaturesEXT[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceFragmentDensityMapFeaturesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceFragmentDensityMapFeaturesEXT> {
            ...
            @Override
            public VkPhysicalDeviceFragmentDensityMapFeaturesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceFragmentDensityMapFeaturesEXT ret = new VkPhysicalDeviceFragmentDensityMapFeaturesEXT(segment.asSlice(0, VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceFragmentDensityMapFeaturesEXT.BYTES);
                return ret;
            }
    ...
    public static VkPhysicalDeviceFragmentDensityMapFeaturesEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceFragmentDensityMapFeaturesEXT.Ptr ret = new VkPhysicalDeviceFragmentDensityMapFeaturesEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_FEATURES_EXT);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceFragmentDensityMapFeaturesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

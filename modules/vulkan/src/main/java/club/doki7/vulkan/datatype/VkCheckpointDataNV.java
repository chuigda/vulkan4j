...
///     VkPipelineStageFlags stage; // @link substring="VkPipelineStageFlags" target="VkPipelineStageFlags" @link substring="stage" target="#stage"
...
///
/// The {@code allocate} ({@link VkCheckpointDataNV#allocate(Arena)}, {@link VkCheckpointDataNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkCheckpointDataNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkCheckpointDataNV(@NotNull MemorySegment segment) implements IVkCheckpointDataNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCheckpointDataNV.html"><code>VkCheckpointDataNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkCheckpointDataNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkCheckpointDataNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkCheckpointDataNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCheckpointDataNV, Iterable<VkCheckpointDataNV> {
        public long size() {
        ...
        public @NotNull VkCheckpointDataNV at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkCheckpointDataNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkCheckpointDataNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkCheckpointDataNV.BYTES,
                (end - start) * VkCheckpointDataNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkCheckpointDataNV.BYTES));
        }

        public VkCheckpointDataNV[] toArray() {
            VkCheckpointDataNV[] ret = new VkCheckpointDataNV[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkCheckpointDataNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkCheckpointDataNV> {
            ...
            @Override
            public VkCheckpointDataNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkCheckpointDataNV ret = new VkCheckpointDataNV(segment.asSlice(0, VkCheckpointDataNV.BYTES));
                segment = segment.asSlice(VkCheckpointDataNV.BYTES);
                return ret;
            }
    ...
    public static VkCheckpointDataNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkCheckpointDataNV.Ptr ret = new VkCheckpointDataNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.CHECKPOINT_DATA_NV);
        }
        return ret;
    }
    ...
    public VkCheckpointDataNV sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public @MagicConstant(valuesFromClass = VkPipelineStageFlags.class) int stage() {
        return segment.get(LAYOUT$stage, OFFSET$stage);
    }

    public VkCheckpointDataNV stage(@MagicConstant(valuesFromClass = VkPipelineStageFlags.class) int value) {

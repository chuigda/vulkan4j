...
public record VkImageFormatProperties2(@NotNull MemorySegment segment) implements IVkImageFormatProperties2 {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageFormatProperties2, Iterable<VkImageFormatProperties2> {
        public long size() {
        ...
        public VkImageFormatProperties2.Ptr at(long index, @NotNull Consumer<@NotNull VkImageFormatProperties2> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkImageFormatProperties2.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkImageFormatProperties2.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkImageFormatProperties2.BYTES,
                (end - start) * VkImageFormatProperties2.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkImageFormatProperties2.BYTES));
        }

        public VkImageFormatProperties2[] toArray() {
            VkImageFormatProperties2[] ret = new VkImageFormatProperties2[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkImageFormatProperties2> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkImageFormatProperties2> {
            ...
            @Override
            public VkImageFormatProperties2 next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkImageFormatProperties2 ret = new VkImageFormatProperties2(segment.asSlice(0, VkImageFormatProperties2.BYTES));
                segment = segment.asSlice(VkImageFormatProperties2.BYTES);
                return ret;
            }
    ...
    public VkImageFormatProperties2 pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkImageFormatProperties2 pNext(@Nullable IPointer pointer) {
    ...
    public VkImageFormatProperties2 imageFormatProperties(@NotNull VkImageFormatProperties value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$imageFormatProperties, SIZE$imageFormatProperties);
        return this;
    }

    public VkImageFormatProperties2 imageFormatProperties(Consumer<@NotNull VkImageFormatProperties> consumer) {

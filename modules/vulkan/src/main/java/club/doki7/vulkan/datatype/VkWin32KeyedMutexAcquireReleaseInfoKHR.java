...
public record VkWin32KeyedMutexAcquireReleaseInfoKHR(@NotNull MemorySegment segment) implements IVkWin32KeyedMutexAcquireReleaseInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkWin32KeyedMutexAcquireReleaseInfoKHR, Iterable<VkWin32KeyedMutexAcquireReleaseInfoKHR> {
        ...
        public VkWin32KeyedMutexAcquireReleaseInfoKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkWin32KeyedMutexAcquireReleaseInfoKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkWin32KeyedMutexAcquireReleaseInfoKHR.BYTES));
        }
    ...
    public VkWin32KeyedMutexAcquireReleaseInfoKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkWin32KeyedMutexAcquireReleaseInfoKHR pNext(@Nullable IPointer pointer) {
    ...
    public VkWin32KeyedMutexAcquireReleaseInfoKHR acquireCount(@Unsigned int value) {
    ...
    public VkWin32KeyedMutexAcquireReleaseInfoKHR pAcquireSyncs(@Nullable VkDeviceMemory.Ptr value) {
    ...
    public VkWin32KeyedMutexAcquireReleaseInfoKHR pAcquireKeys(@Nullable @Unsigned LongPtr value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pAcquireKeysRaw(s);
        return this;
    }
    ...
    public VkWin32KeyedMutexAcquireReleaseInfoKHR pAcquireTimeouts(@Nullable @Unsigned IntPtr value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pAcquireTimeoutsRaw(s);
        return this;
    }

    public @Pointer(comment="uint32_t*") @NotNull MemorySegment pAcquireTimeoutsRaw() {
        return segment.get(LAYOUT$pAcquireTimeouts, OFFSET$pAcquireTimeouts);
    }

    public void pAcquireTimeoutsRaw(@Pointer(comment="uint32_t*") @NotNull MemorySegment value) {
    ...
    public VkWin32KeyedMutexAcquireReleaseInfoKHR releaseCount(@Unsigned int value) {
    ...
    public VkWin32KeyedMutexAcquireReleaseInfoKHR pReleaseSyncs(@Nullable VkDeviceMemory.Ptr value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pReleaseSyncsRaw(s);
        return this;
    }
    ...
    public VkWin32KeyedMutexAcquireReleaseInfoKHR pReleaseKeys(@Nullable @Unsigned LongPtr value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pReleaseKeysRaw(s);
        return this;
    }

...
public record VkCopyMicromapToMemoryInfoEXT(@NotNull MemorySegment segment) implements IVkCopyMicromapToMemoryInfoEXT {
    ...
    public VkCopyMicromapToMemoryInfoEXT sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkCopyMicromapToMemoryInfoEXT mode(@MagicConstant(valuesFromClass = VkCopyMicromapModeEXT.class) int value) {

...
///
/// The {@code allocate} ({@link VkVideoEncodeH264SessionParametersGetInfoKHR#allocate(Arena)}, {@link VkVideoEncodeH264SessionParametersGetInfoKHR#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkVideoEncodeH264SessionParametersGetInfoKHR#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkVideoEncodeH264SessionParametersGetInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH264SessionParametersGetInfoKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeH264SessionParametersGetInfoKHR.html"><code>VkVideoEncodeH264SessionParametersGetInfoKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkVideoEncodeH264SessionParametersGetInfoKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkVideoEncodeH264SessionParametersGetInfoKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkVideoEncodeH264SessionParametersGetInfoKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH264SessionParametersGetInfoKHR, Iterable<VkVideoEncodeH264SessionParametersGetInfoKHR> {
        public long size() {
            return segment.byteSize() / VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES;
        }
        ...
        public @NotNull VkVideoEncodeH264SessionParametersGetInfoKHR at(long index) {
            return new VkVideoEncodeH264SessionParametersGetInfoKHR(segment.asSlice(index * VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES, VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES));
        }

        public VkVideoEncodeH264SessionParametersGetInfoKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkVideoEncodeH264SessionParametersGetInfoKHR> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull VkVideoEncodeH264SessionParametersGetInfoKHR value) {
            MemorySegment s = segment.asSlice(index * VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES, VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES,
                (end - start) * VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES));
        }

        public VkVideoEncodeH264SessionParametersGetInfoKHR[] toArray() {
            VkVideoEncodeH264SessionParametersGetInfoKHR[] ret = new VkVideoEncodeH264SessionParametersGetInfoKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkVideoEncodeH264SessionParametersGetInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkVideoEncodeH264SessionParametersGetInfoKHR> {
            ...
            @Override
            public VkVideoEncodeH264SessionParametersGetInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVideoEncodeH264SessionParametersGetInfoKHR ret = new VkVideoEncodeH264SessionParametersGetInfoKHR(segment.asSlice(0, VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES));
                segment = segment.asSlice(VkVideoEncodeH264SessionParametersGetInfoKHR.BYTES);
                return ret;
            }
    ...
    public static VkVideoEncodeH264SessionParametersGetInfoKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkVideoEncodeH264SessionParametersGetInfoKHR.Ptr ret = new VkVideoEncodeH264SessionParametersGetInfoKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.VIDEO_ENCODE_H264_SESSION_PARAMETERS_GET_INFO_KHR);
        }
        return ret;
    }
    ...
    public VkVideoEncodeH264SessionParametersGetInfoKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

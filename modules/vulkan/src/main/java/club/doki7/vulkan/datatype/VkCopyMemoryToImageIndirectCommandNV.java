...
public record VkCopyMemoryToImageIndirectCommandNV(@NotNull MemorySegment segment) implements IVkCopyMemoryToImageIndirectCommandNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyMemoryToImageIndirectCommandNV, Iterable<VkCopyMemoryToImageIndirectCommandNV> {
        public long size() {
        ...
        public VkCopyMemoryToImageIndirectCommandNV.Ptr at(long index, @NotNull Consumer<@NotNull VkCopyMemoryToImageIndirectCommandNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkCopyMemoryToImageIndirectCommandNV.BYTES));
        }
        ...
        public VkCopyMemoryToImageIndirectCommandNV[] toArray() {
            VkCopyMemoryToImageIndirectCommandNV[] ret = new VkCopyMemoryToImageIndirectCommandNV[(int) size()];
        ...
        private static final class Iter implements Iterator<VkCopyMemoryToImageIndirectCommandNV> {
            ...
            @Override
            public VkCopyMemoryToImageIndirectCommandNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkCopyMemoryToImageIndirectCommandNV ret = new VkCopyMemoryToImageIndirectCommandNV(segment.asSlice(0, VkCopyMemoryToImageIndirectCommandNV.BYTES));
                segment = segment.asSlice(VkCopyMemoryToImageIndirectCommandNV.BYTES);
                return ret;
            }
    ...
    public static VkCopyMemoryToImageIndirectCommandNV.Ptr allocate(Arena arena, long count) {
        ...
        return new VkCopyMemoryToImageIndirectCommandNV.Ptr(segment);
    }
    ...
    public VkCopyMemoryToImageIndirectCommandNV imageSubresource(Consumer<@NotNull VkImageSubresourceLayers> consumer) {
    ...
    public VkCopyMemoryToImageIndirectCommandNV imageOffset(Consumer<@NotNull VkOffset3D> consumer) {
    ...
    public VkCopyMemoryToImageIndirectCommandNV imageExtent(Consumer<@NotNull VkExtent3D> consumer) {

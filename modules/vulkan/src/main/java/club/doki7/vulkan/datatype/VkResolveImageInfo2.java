...
public record VkResolveImageInfo2(@NotNull MemorySegment segment) implements IVkResolveImageInfo2 {
    ...
    public VkResolveImageInfo2 sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkResolveImageInfo2 srcImageLayout(@MagicConstant(valuesFromClass = VkImageLayout.class) int value) {
    ...
    public VkResolveImageInfo2 dstImageLayout(@MagicConstant(valuesFromClass = VkImageLayout.class) int value) {

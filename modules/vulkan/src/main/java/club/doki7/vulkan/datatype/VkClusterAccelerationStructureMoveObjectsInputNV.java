...
public record VkClusterAccelerationStructureMoveObjectsInputNV(@NotNull MemorySegment segment) implements IVkClusterAccelerationStructureMoveObjectsInputNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkClusterAccelerationStructureMoveObjectsInputNV, Iterable<VkClusterAccelerationStructureMoveObjectsInputNV> {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkClusterAccelerationStructureMoveObjectsInputNV.BYTES));
        }
    ...
    public VkClusterAccelerationStructureMoveObjectsInputNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

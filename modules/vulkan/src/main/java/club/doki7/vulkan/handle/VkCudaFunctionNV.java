...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCudaFunctionNV.html"><code>VkCudaFunctionNV</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCudaFunctionNV.html"><code>VkCudaFunctionNV</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkCudaFunctionNV(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCudaFunctionNV.html"><code>VkCudaFunctionNV</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkCudaFunctionNV> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkCudaFunctionNV read() {
        ...
        public void write(@Nullable VkCudaFunctionNV value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkCudaFunctionNV read(long index) {
        ...
        public void write(long index, @Nullable VkCudaFunctionNV value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkCudaFunctionNV[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkCudaFunctionNV value0, @Nullable VkCudaFunctionNV ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkCudaFunctionNV @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkCudaFunctionNV> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkCudaFunctionNV value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkCudaFunctionNV value0, @Nullable VkCudaFunctionNV ...values) {
        ...
        @Override
        public @NotNull Iterator<VkCudaFunctionNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkCudaFunctionNV> {

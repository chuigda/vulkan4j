...
///
/// The {@code allocate} ({@link VkPipelineBinaryInfoKHR#allocate(Arena)}, {@link VkPipelineBinaryInfoKHR#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPipelineBinaryInfoKHR(@NotNull MemorySegment segment) implements IVkPipelineBinaryInfoKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineBinaryInfoKHR.html"><code>VkPipelineBinaryInfoKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPipelineBinaryInfoKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPipelineBinaryInfoKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPipelineBinaryInfoKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineBinaryInfoKHR, Iterable<VkPipelineBinaryInfoKHR> {
        public long size() {
            return segment.byteSize() / VkPipelineBinaryInfoKHR.BYTES;
        }
        ...
        public void write(long index, @NotNull VkPipelineBinaryInfoKHR value) {
            MemorySegment s = segment.asSlice(index * VkPipelineBinaryInfoKHR.BYTES, VkPipelineBinaryInfoKHR.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPipelineBinaryInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPipelineBinaryInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPipelineBinaryInfoKHR.BYTES,
                (end - start) * VkPipelineBinaryInfoKHR.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkPipelineBinaryInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPipelineBinaryInfoKHR> {
            ...
            @Override
            public VkPipelineBinaryInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPipelineBinaryInfoKHR ret = new VkPipelineBinaryInfoKHR(segment.asSlice(0, VkPipelineBinaryInfoKHR.BYTES));
                segment = segment.asSlice(VkPipelineBinaryInfoKHR.BYTES);
                return ret;
            }
    ...
    public static VkPipelineBinaryInfoKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPipelineBinaryInfoKHR.Ptr ret = new VkPipelineBinaryInfoKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PIPELINE_BINARY_INFO_KHR);
        }
        return ret;
    }
    ...
    public VkPipelineBinaryInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

...
public record VkPipelineColorBlendAdvancedStateCreateInfoEXT(@NotNull MemorySegment segment) implements IVkPipelineColorBlendAdvancedStateCreateInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineColorBlendAdvancedStateCreateInfoEXT, Iterable<VkPipelineColorBlendAdvancedStateCreateInfoEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPipelineColorBlendAdvancedStateCreateInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPipelineColorBlendAdvancedStateCreateInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPipelineColorBlendAdvancedStateCreateInfoEXT.BYTES,
                (end - start) * VkPipelineColorBlendAdvancedStateCreateInfoEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPipelineColorBlendAdvancedStateCreateInfoEXT.BYTES));
        }

        public VkPipelineColorBlendAdvancedStateCreateInfoEXT[] toArray() {
            VkPipelineColorBlendAdvancedStateCreateInfoEXT[] ret = new VkPipelineColorBlendAdvancedStateCreateInfoEXT[(int) size()];
        ...
        private static final class Iter implements Iterator<VkPipelineColorBlendAdvancedStateCreateInfoEXT> {
            ...
            @Override
            public VkPipelineColorBlendAdvancedStateCreateInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPipelineColorBlendAdvancedStateCreateInfoEXT ret = new VkPipelineColorBlendAdvancedStateCreateInfoEXT(segment.asSlice(0, VkPipelineColorBlendAdvancedStateCreateInfoEXT.BYTES));
                segment = segment.asSlice(VkPipelineColorBlendAdvancedStateCreateInfoEXT.BYTES);
                return ret;
            }
    ...
    public VkPipelineColorBlendAdvancedStateCreateInfoEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPipelineColorBlendAdvancedStateCreateInfoEXT pNext(@Nullable IPointer pointer) {
    ...
    public VkPipelineColorBlendAdvancedStateCreateInfoEXT srcPremultiplied(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public VkPipelineColorBlendAdvancedStateCreateInfoEXT dstPremultiplied(@NativeType("VkBool32") @Unsigned int value) {

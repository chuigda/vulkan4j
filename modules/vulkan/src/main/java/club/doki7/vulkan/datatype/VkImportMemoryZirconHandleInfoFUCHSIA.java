...
public record VkImportMemoryZirconHandleInfoFUCHSIA(@NotNull MemorySegment segment) implements IVkImportMemoryZirconHandleInfoFUCHSIA {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportMemoryZirconHandleInfoFUCHSIA, Iterable<VkImportMemoryZirconHandleInfoFUCHSIA> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkImportMemoryZirconHandleInfoFUCHSIA> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkImportMemoryZirconHandleInfoFUCHSIA.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkImportMemoryZirconHandleInfoFUCHSIA> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkImportMemoryZirconHandleInfoFUCHSIA> {
            ...
            @Override
            public VkImportMemoryZirconHandleInfoFUCHSIA next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkImportMemoryZirconHandleInfoFUCHSIA ret = new VkImportMemoryZirconHandleInfoFUCHSIA(segment.asSlice(0, VkImportMemoryZirconHandleInfoFUCHSIA.BYTES));
                segment = segment.asSlice(VkImportMemoryZirconHandleInfoFUCHSIA.BYTES);
                return ret;
            }
    ...
    public @NativeType("zx_handle_t") @Unsigned int handle() {
        return segment.get(LAYOUT$handle, OFFSET$handle);
    }

    public VkImportMemoryZirconHandleInfoFUCHSIA handle(@NativeType("zx_handle_t") @Unsigned int value) {

...
///
/// The {@code allocate} ({@link VkRenderPassSubpassFeedbackCreateInfoEXT#allocate(Arena)}, {@link VkRenderPassSubpassFeedbackCreateInfoEXT#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkRenderPassSubpassFeedbackCreateInfoEXT#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkRenderPassSubpassFeedbackCreateInfoEXT(@NotNull MemorySegment segment) implements IVkRenderPassSubpassFeedbackCreateInfoEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkRenderPassSubpassFeedbackCreateInfoEXT.html"><code>VkRenderPassSubpassFeedbackCreateInfoEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkRenderPassSubpassFeedbackCreateInfoEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkRenderPassSubpassFeedbackCreateInfoEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkRenderPassSubpassFeedbackCreateInfoEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderPassSubpassFeedbackCreateInfoEXT, Iterable<VkRenderPassSubpassFeedbackCreateInfoEXT> {
        public long size() {
            return segment.byteSize() / VkRenderPassSubpassFeedbackCreateInfoEXT.BYTES;
        }
        ...
        public @NotNull VkRenderPassSubpassFeedbackCreateInfoEXT at(long index) {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkRenderPassSubpassFeedbackCreateInfoEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkRenderPassSubpassFeedbackCreateInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkRenderPassSubpassFeedbackCreateInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkRenderPassSubpassFeedbackCreateInfoEXT.BYTES,
                (end - start) * VkRenderPassSubpassFeedbackCreateInfoEXT.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkRenderPassSubpassFeedbackCreateInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkRenderPassSubpassFeedbackCreateInfoEXT> {
            ...
            @Override
            public VkRenderPassSubpassFeedbackCreateInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkRenderPassSubpassFeedbackCreateInfoEXT ret = new VkRenderPassSubpassFeedbackCreateInfoEXT(segment.asSlice(0, VkRenderPassSubpassFeedbackCreateInfoEXT.BYTES));
                segment = segment.asSlice(VkRenderPassSubpassFeedbackCreateInfoEXT.BYTES);
                return ret;
            }
    ...
    public static VkRenderPassSubpassFeedbackCreateInfoEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkRenderPassSubpassFeedbackCreateInfoEXT.Ptr ret = new VkRenderPassSubpassFeedbackCreateInfoEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.RENDER_PASS_SUBPASS_FEEDBACK_CREATE_INFO_EXT);
        }
        return ret;
    }
    ...
    public VkRenderPassSubpassFeedbackCreateInfoEXT sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkRenderPassSubpassFeedbackCreateInfoEXT pSubpassFeedback(@Nullable IVkRenderPassSubpassFeedbackInfoEXT value) {

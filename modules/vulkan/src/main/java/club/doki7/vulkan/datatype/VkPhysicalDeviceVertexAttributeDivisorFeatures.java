...
///
/// The {@code allocate} ({@link VkPhysicalDeviceVertexAttributeDivisorFeatures#allocate(Arena)}, {@link VkPhysicalDeviceVertexAttributeDivisorFeatures#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceVertexAttributeDivisorFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVertexAttributeDivisorFeatures {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceVertexAttributeDivisorFeatures.html"><code>VkPhysicalDeviceVertexAttributeDivisorFeatures</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceVertexAttributeDivisorFeatures}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceVertexAttributeDivisorFeatures to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceVertexAttributeDivisorFeatures.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVertexAttributeDivisorFeatures, Iterable<VkPhysicalDeviceVertexAttributeDivisorFeatures> {
        public long size() {
            return segment.byteSize() / VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES;
        }
        ...
        public @NotNull VkPhysicalDeviceVertexAttributeDivisorFeatures at(long index) {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceVertexAttributeDivisorFeatures> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES,
                (end - start) * VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES));
        }

        public VkPhysicalDeviceVertexAttributeDivisorFeatures[] toArray() {
            VkPhysicalDeviceVertexAttributeDivisorFeatures[] ret = new VkPhysicalDeviceVertexAttributeDivisorFeatures[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceVertexAttributeDivisorFeatures> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceVertexAttributeDivisorFeatures> {
            ...
            @Override
            public VkPhysicalDeviceVertexAttributeDivisorFeatures next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceVertexAttributeDivisorFeatures ret = new VkPhysicalDeviceVertexAttributeDivisorFeatures(segment.asSlice(0, VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES);
                return ret;
            }
    ...
    public static VkPhysicalDeviceVertexAttributeDivisorFeatures.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceVertexAttributeDivisorFeatures.Ptr ret = new VkPhysicalDeviceVertexAttributeDivisorFeatures.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceVertexAttributeDivisorFeatures sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceVertexAttributeDivisorFeatures vertexAttributeInstanceRateDivisor(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public VkPhysicalDeviceVertexAttributeDivisorFeatures vertexAttributeInstanceRateZeroDivisor(@NativeType("VkBool32") @Unsigned int value) {

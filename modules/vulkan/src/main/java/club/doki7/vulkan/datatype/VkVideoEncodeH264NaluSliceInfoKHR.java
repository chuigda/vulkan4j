...
public record VkVideoEncodeH264NaluSliceInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH264NaluSliceInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH264NaluSliceInfoKHR, Iterable<VkVideoEncodeH264NaluSliceInfoKHR> {
        ...
        @Override
        public @NotNull Iterator<VkVideoEncodeH264NaluSliceInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkVideoEncodeH264NaluSliceInfoKHR> {
    ...
    public VkVideoEncodeH264NaluSliceInfoKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
    ...
    public @Pointer(target=StdVideoEncodeH264SliceHeader.class) @NotNull MemorySegment pStdSliceHeaderRaw() {
        return segment.get(LAYOUT$pStdSliceHeader, OFFSET$pStdSliceHeader);
    }

    public void pStdSliceHeaderRaw(@Pointer(target=StdVideoEncodeH264SliceHeader.class) @NotNull MemorySegment value) {

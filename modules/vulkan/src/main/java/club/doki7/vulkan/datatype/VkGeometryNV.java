...
/// Represents a pointer to a <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkGeometryNV.html"><code>VkGeometryNV</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkGeometryNV.html"><code>VkGeometryNV</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkGeometryNV(@NotNull MemorySegment segment) implements IVkGeometryNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkGeometryNV.html"><code>VkGeometryNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkGeometryNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkGeometryNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkGeometryNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkGeometryNV, Iterable<VkGeometryNV> {
        public long size() {
            return segment.byteSize() / VkGeometryNV.BYTES;
        }
        ...
        public @NotNull VkGeometryNV at(long index) {
            return new VkGeometryNV(segment.asSlice(index * VkGeometryNV.BYTES, VkGeometryNV.BYTES));
        }

        public void at(long index, @NotNull Consumer<@NotNull VkGeometryNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkGeometryNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkGeometryNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkGeometryNV.BYTES,
                (end - start) * VkGeometryNV.BYTES
            ));
        }
        ...
        private static final class Iter implements Iterator<VkGeometryNV> {
            ...
            @Override
            public VkGeometryNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkGeometryNV ret = new VkGeometryNV(segment.asSlice(0, VkGeometryNV.BYTES));
                segment = segment.asSlice(VkGeometryNV.BYTES);
                return ret;
            }
    ...
    public static VkGeometryNV.Ptr allocate(Arena arena, long count) {

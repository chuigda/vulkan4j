...
///     VkBool32 perStageDescriptorSet; // @link substring="perStageDescriptorSet" target="#perStageDescriptorSet"
///     VkBool32 dynamicPipelineLayout; // @link substring="dynamicPipelineLayout" target="#dynamicPipelineLayout"
...
///
/// The {@code allocate} ({@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#allocate(Arena)}, {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDevicePerStageDescriptorSetFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDevicePerStageDescriptorSetFeaturesNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevicePerStageDescriptorSetFeaturesNV.html"><code>VkPhysicalDevicePerStageDescriptorSetFeaturesNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDevicePerStageDescriptorSetFeaturesNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDevicePerStageDescriptorSetFeaturesNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePerStageDescriptorSetFeaturesNV, Iterable<VkPhysicalDevicePerStageDescriptorSetFeaturesNV> {
        public long size() {
            return segment.byteSize() / VkPhysicalDevicePerStageDescriptorSetFeaturesNV.BYTES;
        }
        ...
        public @NotNull VkPhysicalDevicePerStageDescriptorSetFeaturesNV at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDevicePerStageDescriptorSetFeaturesNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDevicePerStageDescriptorSetFeaturesNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDevicePerStageDescriptorSetFeaturesNV.BYTES,
                (end - start) * VkPhysicalDevicePerStageDescriptorSetFeaturesNV.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDevicePerStageDescriptorSetFeaturesNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDevicePerStageDescriptorSetFeaturesNV> {
            ...
            @Override
            public VkPhysicalDevicePerStageDescriptorSetFeaturesNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDevicePerStageDescriptorSetFeaturesNV ret = new VkPhysicalDevicePerStageDescriptorSetFeaturesNV(segment.asSlice(0, VkPhysicalDevicePerStageDescriptorSetFeaturesNV.BYTES));
                segment = segment.asSlice(VkPhysicalDevicePerStageDescriptorSetFeaturesNV.BYTES);
                return ret;
            }
    ...
    public static VkPhysicalDevicePerStageDescriptorSetFeaturesNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDevicePerStageDescriptorSetFeaturesNV.Ptr ret = new VkPhysicalDevicePerStageDescriptorSetFeaturesNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_PER_STAGE_DESCRIPTOR_SET_FEATURES_NV);
        }
        return ret;
    }
    ...
    public VkPhysicalDevicePerStageDescriptorSetFeaturesNV sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkPhysicalDevicePerStageDescriptorSetFeaturesNV perStageDescriptorSet(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public VkPhysicalDevicePerStageDescriptorSetFeaturesNV dynamicPipelineLayout(@NativeType("VkBool32") @Unsigned int value) {

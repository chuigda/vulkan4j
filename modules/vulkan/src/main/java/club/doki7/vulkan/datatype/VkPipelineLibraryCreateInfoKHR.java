...
public record VkPipelineLibraryCreateInfoKHR(@NotNull MemorySegment segment) implements IVkPipelineLibraryCreateInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineLibraryCreateInfoKHR, Iterable<VkPipelineLibraryCreateInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPipelineLibraryCreateInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPipelineLibraryCreateInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPipelineLibraryCreateInfoKHR.BYTES,
                (end - start) * VkPipelineLibraryCreateInfoKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPipelineLibraryCreateInfoKHR.BYTES));
        }

        public VkPipelineLibraryCreateInfoKHR[] toArray() {
            VkPipelineLibraryCreateInfoKHR[] ret = new VkPipelineLibraryCreateInfoKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPipelineLibraryCreateInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPipelineLibraryCreateInfoKHR> {
    ...
    public VkPipelineLibraryCreateInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

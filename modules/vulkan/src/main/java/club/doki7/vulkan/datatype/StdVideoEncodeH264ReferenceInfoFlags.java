...
public record StdVideoEncodeH264ReferenceInfoFlags(@NotNull MemorySegment segment) implements IStdVideoEncodeH264ReferenceInfoFlags {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeH264ReferenceInfoFlags, Iterable<StdVideoEncodeH264ReferenceInfoFlags> {
        public long size() {
        ...
        public StdVideoEncodeH264ReferenceInfoFlags.Ptr at(long index, @NotNull Consumer<@NotNull StdVideoEncodeH264ReferenceInfoFlags> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * StdVideoEncodeH264ReferenceInfoFlags.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<StdVideoEncodeH264ReferenceInfoFlags> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoEncodeH264ReferenceInfoFlags> {
            ...
            @Override
            public StdVideoEncodeH264ReferenceInfoFlags next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                StdVideoEncodeH264ReferenceInfoFlags ret = new StdVideoEncodeH264ReferenceInfoFlags(segment.asSlice(0, StdVideoEncodeH264ReferenceInfoFlags.BYTES));
                segment = segment.asSlice(StdVideoEncodeH264ReferenceInfoFlags.BYTES);
                return ret;
            }

...
public record VkCopyImageInfo2(@NotNull MemorySegment segment) implements IVkCopyImageInfo2 {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyImageInfo2, Iterable<VkCopyImageInfo2> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkCopyImageInfo2> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkCopyImageInfo2.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkCopyImageInfo2> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkCopyImageInfo2> {
            ...
            @Override
            public VkCopyImageInfo2 next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkCopyImageInfo2 ret = new VkCopyImageInfo2(segment.asSlice(0, VkCopyImageInfo2.BYTES));
                segment = segment.asSlice(VkCopyImageInfo2.BYTES);
                return ret;
            }
    ...
    public VkCopyImageInfo2 sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkCopyImageInfo2 srcImage(@Nullable VkImage value) {
    ...
    public VkCopyImageInfo2 srcImageLayout(@EnumType(VkImageLayout.class) int value) {
    ...
    public VkCopyImageInfo2 dstImage(@Nullable VkImage value) {
    ...
    public VkCopyImageInfo2 dstImageLayout(@EnumType(VkImageLayout.class) int value) {
    ...
    public VkCopyImageInfo2 regionCount(@Unsigned int value) {
        segment.set(LAYOUT$regionCount, OFFSET$regionCount, value);
        return this;
    }

    public VkCopyImageInfo2 pRegions(@Nullable IVkImageCopy2 value) {

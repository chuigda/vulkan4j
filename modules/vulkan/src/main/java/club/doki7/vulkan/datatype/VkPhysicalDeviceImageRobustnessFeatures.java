...
///
/// The {@code allocate} ({@link VkPhysicalDeviceImageRobustnessFeatures#allocate(Arena)}, {@link VkPhysicalDeviceImageRobustnessFeatures#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkPhysicalDeviceImageRobustnessFeatures#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceImageRobustnessFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageRobustnessFeatures {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceImageRobustnessFeatures.html"><code>VkPhysicalDeviceImageRobustnessFeatures</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceImageRobustnessFeatures}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceImageRobustnessFeatures to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceImageRobustnessFeatures.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageRobustnessFeatures, Iterable<VkPhysicalDeviceImageRobustnessFeatures> {
        public long size() {
            return segment.byteSize() / VkPhysicalDeviceImageRobustnessFeatures.BYTES;
        }
        ...
        public @NotNull VkPhysicalDeviceImageRobustnessFeatures at(long index) {
        ...
        public void write(long index, @NotNull VkPhysicalDeviceImageRobustnessFeatures value) {
            MemorySegment s = segment.asSlice(index * VkPhysicalDeviceImageRobustnessFeatures.BYTES, VkPhysicalDeviceImageRobustnessFeatures.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceImageRobustnessFeatures.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceImageRobustnessFeatures.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceImageRobustnessFeatures.BYTES,
                (end - start) * VkPhysicalDeviceImageRobustnessFeatures.BYTES
            ));
        }
        ...
        private static final class Iter implements Iterator<VkPhysicalDeviceImageRobustnessFeatures> {
            ...
            @Override
            public VkPhysicalDeviceImageRobustnessFeatures next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceImageRobustnessFeatures ret = new VkPhysicalDeviceImageRobustnessFeatures(segment.asSlice(0, VkPhysicalDeviceImageRobustnessFeatures.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceImageRobustnessFeatures.BYTES);
                return ret;
            }
    ...
    public static VkPhysicalDeviceImageRobustnessFeatures.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceImageRobustnessFeatures.Ptr ret = new VkPhysicalDeviceImageRobustnessFeatures.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceImageRobustnessFeatures sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

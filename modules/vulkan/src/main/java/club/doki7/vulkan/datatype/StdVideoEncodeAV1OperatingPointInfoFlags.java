...
public record StdVideoEncodeAV1OperatingPointInfoFlags(@NotNull MemorySegment segment) implements IStdVideoEncodeAV1OperatingPointInfoFlags {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeAV1OperatingPointInfoFlags, Iterable<StdVideoEncodeAV1OperatingPointInfoFlags> {
        public long size() {
        ...
        public StdVideoEncodeAV1OperatingPointInfoFlags.Ptr at(long index, @NotNull Consumer<@NotNull StdVideoEncodeAV1OperatingPointInfoFlags> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * StdVideoEncodeAV1OperatingPointInfoFlags.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<StdVideoEncodeAV1OperatingPointInfoFlags> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoEncodeAV1OperatingPointInfoFlags> {
            ...
            @Override
            public StdVideoEncodeAV1OperatingPointInfoFlags next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                StdVideoEncodeAV1OperatingPointInfoFlags ret = new StdVideoEncodeAV1OperatingPointInfoFlags(segment.asSlice(0, StdVideoEncodeAV1OperatingPointInfoFlags.BYTES));
                segment = segment.asSlice(StdVideoEncodeAV1OperatingPointInfoFlags.BYTES);
                return ret;
            }

...
public record VkVertexInputBindingDivisorDescription(@NotNull MemorySegment segment) implements IVkVertexInputBindingDivisorDescription {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVertexInputBindingDivisorDescription, Iterable<VkVertexInputBindingDivisorDescription> {
        public long size() {
        ...
        public VkVertexInputBindingDivisorDescription.Ptr at(long index, @NotNull Consumer<@NotNull VkVertexInputBindingDivisorDescription> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVertexInputBindingDivisorDescription.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkVertexInputBindingDivisorDescription.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkVertexInputBindingDivisorDescription.BYTES,
                (end - start) * VkVertexInputBindingDivisorDescription.BYTES
            ));
        }
        ...
        private static final class Iter implements Iterator<VkVertexInputBindingDivisorDescription> {
            ...
            @Override
            public VkVertexInputBindingDivisorDescription next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVertexInputBindingDivisorDescription ret = new VkVertexInputBindingDivisorDescription(segment.asSlice(0, VkVertexInputBindingDivisorDescription.BYTES));
                segment = segment.asSlice(VkVertexInputBindingDivisorDescription.BYTES);
                return ret;
            }

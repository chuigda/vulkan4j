...
///     VkDeviceSize micromapSize; // @link substring="micromapSize" target="#micromapSize"
///     VkDeviceSize buildScratchSize; // @link substring="buildScratchSize" target="#buildScratchSize"
///     VkBool32 discardable; // @link substring="discardable" target="#discardable"
...
///
/// The {@code allocate} ({@link VkMicromapBuildSizesInfoEXT#allocate(Arena)}, {@link VkMicromapBuildSizesInfoEXT#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkMicromapBuildSizesInfoEXT#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkMicromapBuildSizesInfoEXT(@NotNull MemorySegment segment) implements IVkMicromapBuildSizesInfoEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkMicromapBuildSizesInfoEXT.html"><code>VkMicromapBuildSizesInfoEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkMicromapBuildSizesInfoEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkMicromapBuildSizesInfoEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkMicromapBuildSizesInfoEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkMicromapBuildSizesInfoEXT, Iterable<VkMicromapBuildSizesInfoEXT> {
        public long size() {
            return segment.byteSize() / VkMicromapBuildSizesInfoEXT.BYTES;
        }
        ...
        public @NotNull VkMicromapBuildSizesInfoEXT at(long index) {
        ...
        public VkMicromapBuildSizesInfoEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkMicromapBuildSizesInfoEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkMicromapBuildSizesInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkMicromapBuildSizesInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkMicromapBuildSizesInfoEXT.BYTES,
                (end - start) * VkMicromapBuildSizesInfoEXT.BYTES
            ));
        }
        ...
        private static final class Iter implements Iterator<VkMicromapBuildSizesInfoEXT> {
            ...
            @Override
            public VkMicromapBuildSizesInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkMicromapBuildSizesInfoEXT ret = new VkMicromapBuildSizesInfoEXT(segment.asSlice(0, VkMicromapBuildSizesInfoEXT.BYTES));
                segment = segment.asSlice(VkMicromapBuildSizesInfoEXT.BYTES);
                return ret;
            }
    ...
    public static VkMicromapBuildSizesInfoEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkMicromapBuildSizesInfoEXT.Ptr ret = new VkMicromapBuildSizesInfoEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.MICROMAP_BUILD_SIZES_INFO_EXT);
        }
        return ret;
    }
    ...
    public VkMicromapBuildSizesInfoEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

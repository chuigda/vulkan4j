...
///
/// The {@code allocate} ({@link VkCopyAccelerationStructureInfoKHR#allocate(Arena)}, {@link VkCopyAccelerationStructureInfoKHR#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkCopyAccelerationStructureInfoKHR#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkCopyAccelerationStructureInfoKHR(@NotNull MemorySegment segment) implements IVkCopyAccelerationStructureInfoKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCopyAccelerationStructureInfoKHR.html"><code>VkCopyAccelerationStructureInfoKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkCopyAccelerationStructureInfoKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkCopyAccelerationStructureInfoKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkCopyAccelerationStructureInfoKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyAccelerationStructureInfoKHR, Iterable<VkCopyAccelerationStructureInfoKHR> {
        public long size() {
            return segment.byteSize() / VkCopyAccelerationStructureInfoKHR.BYTES;
        }
        ...
        public @NotNull VkCopyAccelerationStructureInfoKHR at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkCopyAccelerationStructureInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkCopyAccelerationStructureInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkCopyAccelerationStructureInfoKHR.BYTES,
                (end - start) * VkCopyAccelerationStructureInfoKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkCopyAccelerationStructureInfoKHR.BYTES));
        }

        public VkCopyAccelerationStructureInfoKHR[] toArray() {
            VkCopyAccelerationStructureInfoKHR[] ret = new VkCopyAccelerationStructureInfoKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkCopyAccelerationStructureInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkCopyAccelerationStructureInfoKHR> {
            ...
            @Override
            public VkCopyAccelerationStructureInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkCopyAccelerationStructureInfoKHR ret = new VkCopyAccelerationStructureInfoKHR(segment.asSlice(0, VkCopyAccelerationStructureInfoKHR.BYTES));
                segment = segment.asSlice(VkCopyAccelerationStructureInfoKHR.BYTES);
                return ret;
            }
    ...
    public static VkCopyAccelerationStructureInfoKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkCopyAccelerationStructureInfoKHR.Ptr ret = new VkCopyAccelerationStructureInfoKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.COPY_ACCELERATION_STRUCTURE_INFO_KHR);
        }
        return ret;
    }
    ...
    public VkCopyAccelerationStructureInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkCopyAccelerationStructureInfoKHR mode(@MagicConstant(valuesFromClass = VkCopyAccelerationStructureModeKHR.class) int value) {

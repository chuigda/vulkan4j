...
public record VkDeviceQueueShaderCoreControlCreateInfoARM(@NotNull MemorySegment segment) implements IVkDeviceQueueShaderCoreControlCreateInfoARM {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDeviceQueueShaderCoreControlCreateInfoARM, Iterable<VkDeviceQueueShaderCoreControlCreateInfoARM> {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkDeviceQueueShaderCoreControlCreateInfoARM.BYTES));
        }
    ...
    public VkDeviceQueueShaderCoreControlCreateInfoARM pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

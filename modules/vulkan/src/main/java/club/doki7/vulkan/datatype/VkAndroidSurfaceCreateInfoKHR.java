...
///
/// The {@code allocate} ({@link VkAndroidSurfaceCreateInfoKHR#allocate(Arena)}, {@link VkAndroidSurfaceCreateInfoKHR#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkAndroidSurfaceCreateInfoKHR#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkAndroidSurfaceCreateInfoKHR(@NotNull MemorySegment segment) implements IVkAndroidSurfaceCreateInfoKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkAndroidSurfaceCreateInfoKHR.html"><code>VkAndroidSurfaceCreateInfoKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkAndroidSurfaceCreateInfoKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkAndroidSurfaceCreateInfoKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkAndroidSurfaceCreateInfoKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAndroidSurfaceCreateInfoKHR, Iterable<VkAndroidSurfaceCreateInfoKHR> {
        public long size() {
            return segment.byteSize() / VkAndroidSurfaceCreateInfoKHR.BYTES;
        }
        ...
        public @NotNull VkAndroidSurfaceCreateInfoKHR at(long index) {
        ...
        public void write(long index, @NotNull VkAndroidSurfaceCreateInfoKHR value) {
            MemorySegment s = segment.asSlice(index * VkAndroidSurfaceCreateInfoKHR.BYTES, VkAndroidSurfaceCreateInfoKHR.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkAndroidSurfaceCreateInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkAndroidSurfaceCreateInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkAndroidSurfaceCreateInfoKHR.BYTES,
                (end - start) * VkAndroidSurfaceCreateInfoKHR.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkAndroidSurfaceCreateInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkAndroidSurfaceCreateInfoKHR> {
            ...
            @Override
            public VkAndroidSurfaceCreateInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkAndroidSurfaceCreateInfoKHR ret = new VkAndroidSurfaceCreateInfoKHR(segment.asSlice(0, VkAndroidSurfaceCreateInfoKHR.BYTES));
                segment = segment.asSlice(VkAndroidSurfaceCreateInfoKHR.BYTES);
                return ret;
            }
    ...
    public static VkAndroidSurfaceCreateInfoKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkAndroidSurfaceCreateInfoKHR.Ptr ret = new VkAndroidSurfaceCreateInfoKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.ANDROID_SURFACE_CREATE_INFO_KHR);
        }
        return ret;
    }

    public static VkAndroidSurfaceCreateInfoKHR clone(Arena arena, VkAndroidSurfaceCreateInfoKHR src) {
        VkAndroidSurfaceCreateInfoKHR ret = allocate(arena);
    ...
    public VkAndroidSurfaceCreateInfoKHR window(@Nullable PointerPtr value) {

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkValidationCacheEXT.html"><code>VkValidationCacheEXT</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkValidationCacheEXT.html"><code>VkValidationCacheEXT</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkValidationCacheEXT(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkValidationCacheEXT.html"><code>VkValidationCacheEXT</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkValidationCacheEXT> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkValidationCacheEXT read() {
        ...
        public void write(@Nullable VkValidationCacheEXT value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkValidationCacheEXT read(long index) {
        ...
        public void write(long index, @Nullable VkValidationCacheEXT value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkValidationCacheEXT[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkValidationCacheEXT value0, @Nullable VkValidationCacheEXT ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkValidationCacheEXT @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkValidationCacheEXT> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkValidationCacheEXT value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkValidationCacheEXT value0, @Nullable VkValidationCacheEXT ...values) {
        ...
        @Override
        public @NotNull Iterator<VkValidationCacheEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkValidationCacheEXT> {

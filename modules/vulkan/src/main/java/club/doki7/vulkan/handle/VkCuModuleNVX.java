...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCuModuleNVX.html"><code>VkCuModuleNVX</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCuModuleNVX.html"><code>VkCuModuleNVX</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkCuModuleNVX(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCuModuleNVX.html"><code>VkCuModuleNVX</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkCuModuleNVX> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkCuModuleNVX read() {
        ...
        public void write(@Nullable VkCuModuleNVX value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkCuModuleNVX read(long index) {
        ...
        public void write(long index, @Nullable VkCuModuleNVX value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkCuModuleNVX[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkCuModuleNVX value0, @Nullable VkCuModuleNVX ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkCuModuleNVX @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkCuModuleNVX> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkCuModuleNVX value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkCuModuleNVX value0, @Nullable VkCuModuleNVX ...values) {
        ...
        @Override
        public @NotNull Iterator<VkCuModuleNVX> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkCuModuleNVX> {

...
///     PFN_vkGetInstanceProcAddrLUNARG pfnGetInstanceProcAddr; // @link substring="PFN_vkGetInstanceProcAddrLUNARG" target="IPFN_vkGetInstanceProcAddrLUNARG" @link substring="pfnGetInstanceProcAddr" target="#pfnGetInstanceProcAddr"
...
public record VkDirectDriverLoadingInfoLUNARG(@NotNull MemorySegment segment) implements IVkDirectDriverLoadingInfoLUNARG {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDirectDriverLoadingInfoLUNARG, Iterable<VkDirectDriverLoadingInfoLUNARG> {
        ...
        public VkDirectDriverLoadingInfoLUNARG.Ptr at(long index, @NotNull Consumer<@NotNull VkDirectDriverLoadingInfoLUNARG> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkDirectDriverLoadingInfoLUNARG.BYTES));
        }

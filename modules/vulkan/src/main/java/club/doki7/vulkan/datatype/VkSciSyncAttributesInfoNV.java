...
///
/// The {@code allocate} ({@link VkSciSyncAttributesInfoNV#allocate(Arena)}, {@link VkSciSyncAttributesInfoNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkSciSyncAttributesInfoNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkSciSyncAttributesInfoNV(@NotNull MemorySegment segment) implements IVkSciSyncAttributesInfoNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSciSyncAttributesInfoNV.html"><code>VkSciSyncAttributesInfoNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkSciSyncAttributesInfoNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkSciSyncAttributesInfoNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkSciSyncAttributesInfoNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSciSyncAttributesInfoNV, Iterable<VkSciSyncAttributesInfoNV> {
        public long size() {
            return segment.byteSize() / VkSciSyncAttributesInfoNV.BYTES;
        }
        ...
        public @NotNull VkSciSyncAttributesInfoNV at(long index) {
        ...
        public void write(long index, @NotNull VkSciSyncAttributesInfoNV value) {
            MemorySegment s = segment.asSlice(index * VkSciSyncAttributesInfoNV.BYTES, VkSciSyncAttributesInfoNV.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSciSyncAttributesInfoNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkSciSyncAttributesInfoNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkSciSyncAttributesInfoNV.BYTES,
                (end - start) * VkSciSyncAttributesInfoNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkSciSyncAttributesInfoNV.BYTES));
        }

        public VkSciSyncAttributesInfoNV[] toArray() {
            VkSciSyncAttributesInfoNV[] ret = new VkSciSyncAttributesInfoNV[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkSciSyncAttributesInfoNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSciSyncAttributesInfoNV> {
            ...
            @Override
            public VkSciSyncAttributesInfoNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkSciSyncAttributesInfoNV ret = new VkSciSyncAttributesInfoNV(segment.asSlice(0, VkSciSyncAttributesInfoNV.BYTES));
                segment = segment.asSlice(VkSciSyncAttributesInfoNV.BYTES);
                return ret;
            }
    ...
    public static VkSciSyncAttributesInfoNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkSciSyncAttributesInfoNV.Ptr ret = new VkSciSyncAttributesInfoNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.SCI_SYNC_ATTRIBUTES_INFO_NV);
        }
        return ret;
    }
    ...
    public VkSciSyncAttributesInfoNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

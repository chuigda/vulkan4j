...
public record VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT, Iterable<VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT> {
        ...
        public VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT> {
    ...
    public VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT fragmentDensityOffsetGranularity(@NotNull VkExtent2D value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$fragmentDensityOffsetGranularity, SIZE$fragmentDensityOffsetGranularity);
        return this;
    }

    public VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT fragmentDensityOffsetGranularity(Consumer<@NotNull VkExtent2D> consumer) {
        consumer.accept(fragmentDensityOffsetGranularity());
        return this;
    }

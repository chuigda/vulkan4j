...
///
/// The {@code allocate} ({@link VkPipelineRasterizationStateStreamCreateInfoEXT#allocate(Arena)}, {@link VkPipelineRasterizationStateStreamCreateInfoEXT#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPipelineRasterizationStateStreamCreateInfoEXT(@NotNull MemorySegment segment) implements IVkPipelineRasterizationStateStreamCreateInfoEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineRasterizationStateStreamCreateInfoEXT.html"><code>VkPipelineRasterizationStateStreamCreateInfoEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPipelineRasterizationStateStreamCreateInfoEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPipelineRasterizationStateStreamCreateInfoEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPipelineRasterizationStateStreamCreateInfoEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineRasterizationStateStreamCreateInfoEXT, Iterable<VkPipelineRasterizationStateStreamCreateInfoEXT> {
        public long size() {
            return segment.byteSize() / VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES;
        }
        ...
        public @NotNull VkPipelineRasterizationStateStreamCreateInfoEXT at(long index) {
        ...
        public VkPipelineRasterizationStateStreamCreateInfoEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkPipelineRasterizationStateStreamCreateInfoEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES,
                (end - start) * VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES));
        }

        public VkPipelineRasterizationStateStreamCreateInfoEXT[] toArray() {
            VkPipelineRasterizationStateStreamCreateInfoEXT[] ret = new VkPipelineRasterizationStateStreamCreateInfoEXT[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPipelineRasterizationStateStreamCreateInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPipelineRasterizationStateStreamCreateInfoEXT> {
            ...
            @Override
            public VkPipelineRasterizationStateStreamCreateInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPipelineRasterizationStateStreamCreateInfoEXT ret = new VkPipelineRasterizationStateStreamCreateInfoEXT(segment.asSlice(0, VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES));
                segment = segment.asSlice(VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES);
                return ret;
            }
    ...
    public static VkPipelineRasterizationStateStreamCreateInfoEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPipelineRasterizationStateStreamCreateInfoEXT.Ptr ret = new VkPipelineRasterizationStateStreamCreateInfoEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PIPELINE_RASTERIZATION_STATE_STREAM_CREATE_INFO_EXT);
        }
        return ret;
    }

...
public record VkSubpassDescription2(@NotNull MemorySegment segment) implements IVkSubpassDescription2 {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSubpassDescription2, Iterable<VkSubpassDescription2> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSubpassDescription2.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkSubpassDescription2> {
            ...
            @Override
            public VkSubpassDescription2 next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkSubpassDescription2 ret = new VkSubpassDescription2(segment.asSlice(0, VkSubpassDescription2.BYTES));
                segment = segment.asSlice(VkSubpassDescription2.BYTES);
                return ret;
            }
    ...
    public VkSubpassDescription2 pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkSubpassDescription2 pNext(@Nullable IPointer pointer) {
    ...
    public VkSubpassDescription2 viewMask(@Unsigned int value) {
    ...
    public VkSubpassDescription2 inputAttachmentCount(@Unsigned int value) {
        segment.set(LAYOUT$inputAttachmentCount, OFFSET$inputAttachmentCount, value);
        return this;
    }

    public VkSubpassDescription2 pInputAttachments(@Nullable IVkAttachmentReference2 value) {
    ...
    public @Pointer(target=VkAttachmentReference2.class) @NotNull MemorySegment pInputAttachmentsRaw() {
        return segment.get(LAYOUT$pInputAttachments, OFFSET$pInputAttachments);
    }

    public void pInputAttachmentsRaw(@Pointer(target=VkAttachmentReference2.class) @NotNull MemorySegment value) {
    ...
    public VkSubpassDescription2 colorAttachmentCount(@Unsigned int value) {
        segment.set(LAYOUT$colorAttachmentCount, OFFSET$colorAttachmentCount, value);
        return this;
    }

    public VkSubpassDescription2 pColorAttachments(@Nullable IVkAttachmentReference2 value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
    ...
    public @Pointer(target=VkAttachmentReference2.class) @NotNull MemorySegment pColorAttachmentsRaw() {
        return segment.get(LAYOUT$pColorAttachments, OFFSET$pColorAttachments);
    }

    public void pColorAttachmentsRaw(@Pointer(target=VkAttachmentReference2.class) @NotNull MemorySegment value) {
        segment.set(LAYOUT$pColorAttachments, OFFSET$pColorAttachments, value);
    }

    public VkSubpassDescription2 pResolveAttachments(@Nullable IVkAttachmentReference2 value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
    ...
    public @Pointer(target=VkAttachmentReference2.class) @NotNull MemorySegment pResolveAttachmentsRaw() {
        return segment.get(LAYOUT$pResolveAttachments, OFFSET$pResolveAttachments);
    }

    public void pResolveAttachmentsRaw(@Pointer(target=VkAttachmentReference2.class) @NotNull MemorySegment value) {
        segment.set(LAYOUT$pResolveAttachments, OFFSET$pResolveAttachments, value);
    }

    public VkSubpassDescription2 pDepthStencilAttachment(@Nullable IVkAttachmentReference2 value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
    ...
    public @Pointer(target=VkAttachmentReference2.class) @NotNull MemorySegment pDepthStencilAttachmentRaw() {
        return segment.get(LAYOUT$pDepthStencilAttachment, OFFSET$pDepthStencilAttachment);
    }

    public void pDepthStencilAttachmentRaw(@Pointer(target=VkAttachmentReference2.class) @NotNull MemorySegment value) {
    ...
    public VkSubpassDescription2 preserveAttachmentCount(@Unsigned int value) {
    ...
    public VkSubpassDescription2 pPreserveAttachments(@Nullable @Unsigned IntPtr value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();

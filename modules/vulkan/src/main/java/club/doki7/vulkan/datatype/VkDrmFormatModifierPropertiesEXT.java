...
public record VkDrmFormatModifierPropertiesEXT(@NotNull MemorySegment segment) implements IVkDrmFormatModifierPropertiesEXT {
    ...
    public @MagicConstant(valuesFromClass = VkFormatFeatureFlags.class) int drmFormatModifierTilingFeatures() {
        return segment.get(LAYOUT$drmFormatModifierTilingFeatures, OFFSET$drmFormatModifierTilingFeatures);
    }

    public VkDrmFormatModifierPropertiesEXT drmFormatModifierTilingFeatures(@MagicConstant(valuesFromClass = VkFormatFeatureFlags.class) int value) {

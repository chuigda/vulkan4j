...
public record VkOpticalFlowImageFormatPropertiesNV(@NotNull MemorySegment segment) implements IVkOpticalFlowImageFormatPropertiesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkOpticalFlowImageFormatPropertiesNV, Iterable<VkOpticalFlowImageFormatPropertiesNV> {
        public long size() {
        ...
        public VkOpticalFlowImageFormatPropertiesNV.Ptr at(long index, @NotNull Consumer<@NotNull VkOpticalFlowImageFormatPropertiesNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkOpticalFlowImageFormatPropertiesNV.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkOpticalFlowImageFormatPropertiesNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkOpticalFlowImageFormatPropertiesNV> {
            ...
            @Override
            public VkOpticalFlowImageFormatPropertiesNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkOpticalFlowImageFormatPropertiesNV ret = new VkOpticalFlowImageFormatPropertiesNV(segment.asSlice(0, VkOpticalFlowImageFormatPropertiesNV.BYTES));
                segment = segment.asSlice(VkOpticalFlowImageFormatPropertiesNV.BYTES);
                return ret;
            }
    ...
    public VkOpticalFlowImageFormatPropertiesNV sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkOpticalFlowImageFormatPropertiesNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkOpticalFlowImageFormatPropertiesNV pNext(@Nullable IPointer pointer) {
    ...
    public VkOpticalFlowImageFormatPropertiesNV format(@EnumType(VkFormat.class) int value) {

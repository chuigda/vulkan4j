...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSemaphoreSciSyncPoolNV.html"><code>VkSemaphoreSciSyncPoolNV</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSemaphoreSciSyncPoolNV.html"><code>VkSemaphoreSciSyncPoolNV</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkSemaphoreSciSyncPoolNV(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSemaphoreSciSyncPoolNV.html"><code>VkSemaphoreSciSyncPoolNV</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkSemaphoreSciSyncPoolNV> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkSemaphoreSciSyncPoolNV read() {
        ...
        public void write(@Nullable VkSemaphoreSciSyncPoolNV value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkSemaphoreSciSyncPoolNV read(long index) {
        ...
        public void write(long index, @Nullable VkSemaphoreSciSyncPoolNV value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkSemaphoreSciSyncPoolNV[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkSemaphoreSciSyncPoolNV value0, @Nullable VkSemaphoreSciSyncPoolNV ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkSemaphoreSciSyncPoolNV @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkSemaphoreSciSyncPoolNV> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkSemaphoreSciSyncPoolNV value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;

...
public record VkDrawMeshTasksIndirectCommandNV(@NotNull MemorySegment segment) implements IVkDrawMeshTasksIndirectCommandNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDrawMeshTasksIndirectCommandNV, Iterable<VkDrawMeshTasksIndirectCommandNV> {
        public long size() {
        ...
        public VkDrawMeshTasksIndirectCommandNV.Ptr at(long index, @NotNull Consumer<@NotNull VkDrawMeshTasksIndirectCommandNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkDrawMeshTasksIndirectCommandNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkDrawMeshTasksIndirectCommandNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkDrawMeshTasksIndirectCommandNV.BYTES,
                (end - start) * VkDrawMeshTasksIndirectCommandNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkDrawMeshTasksIndirectCommandNV.BYTES));
        }

        public VkDrawMeshTasksIndirectCommandNV[] toArray() {
            VkDrawMeshTasksIndirectCommandNV[] ret = new VkDrawMeshTasksIndirectCommandNV[(int) size()];
        ...
        private static final class Iter implements Iterator<VkDrawMeshTasksIndirectCommandNV> {
            ...
            @Override
            public VkDrawMeshTasksIndirectCommandNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkDrawMeshTasksIndirectCommandNV ret = new VkDrawMeshTasksIndirectCommandNV(segment.asSlice(0, VkDrawMeshTasksIndirectCommandNV.BYTES));
                segment = segment.asSlice(VkDrawMeshTasksIndirectCommandNV.BYTES);
                return ret;
            }
    ...
    public static VkDrawMeshTasksIndirectCommandNV.Ptr allocate(Arena arena, long count) {
        ...
        return new VkDrawMeshTasksIndirectCommandNV.Ptr(segment);
    }

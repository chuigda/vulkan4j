...
public record StdVideoEncodeH264SliceHeaderFlags(@NotNull MemorySegment segment) implements IStdVideoEncodeH264SliceHeaderFlags {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeH264SliceHeaderFlags, Iterable<StdVideoEncodeH264SliceHeaderFlags> {
        public long size() {
        ...
        public StdVideoEncodeH264SliceHeaderFlags.Ptr at(long index, @NotNull Consumer<@NotNull StdVideoEncodeH264SliceHeaderFlags> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * StdVideoEncodeH264SliceHeaderFlags.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * StdVideoEncodeH264SliceHeaderFlags.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * StdVideoEncodeH264SliceHeaderFlags.BYTES,
                (end - start) * StdVideoEncodeH264SliceHeaderFlags.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<StdVideoEncodeH264SliceHeaderFlags> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoEncodeH264SliceHeaderFlags> {
            ...
            @Override
            public StdVideoEncodeH264SliceHeaderFlags next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                StdVideoEncodeH264SliceHeaderFlags ret = new StdVideoEncodeH264SliceHeaderFlags(segment.asSlice(0, StdVideoEncodeH264SliceHeaderFlags.BYTES));
                segment = segment.asSlice(StdVideoEncodeH264SliceHeaderFlags.BYTES);
                return ret;
            }
    ...
    public static StdVideoEncodeH264SliceHeaderFlags.Ptr allocate(Arena arena, long count) {
        ...
        return new StdVideoEncodeH264SliceHeaderFlags.Ptr(segment);
    }

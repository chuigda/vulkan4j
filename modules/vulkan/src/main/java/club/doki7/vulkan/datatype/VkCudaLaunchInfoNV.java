...
public record VkCudaLaunchInfoNV(@NotNull MemorySegment segment) implements IVkCudaLaunchInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCudaLaunchInfoNV, Iterable<VkCudaLaunchInfoNV> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkCudaLaunchInfoNV.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkCudaLaunchInfoNV> {
            ...
            @Override
            public VkCudaLaunchInfoNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkCudaLaunchInfoNV ret = new VkCudaLaunchInfoNV(segment.asSlice(0, VkCudaLaunchInfoNV.BYTES));
                segment = segment.asSlice(VkCudaLaunchInfoNV.BYTES);
                return ret;
            }
    ...
    public VkCudaLaunchInfoNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
    ...
    public VkCudaLaunchInfoNV pParams(@Pointer(comment="void*") @NotNull MemorySegment value) {
    ...
    public VkCudaLaunchInfoNV pExtras(@Pointer(comment="void*") @NotNull MemorySegment value) {

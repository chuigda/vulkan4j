...
public record VkVideoProfileListInfoKHR(@NotNull MemorySegment segment) implements IVkVideoProfileListInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoProfileListInfoKHR, Iterable<VkVideoProfileListInfoKHR> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVideoProfileListInfoKHR.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkVideoProfileListInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkVideoProfileListInfoKHR> {
            ...
            @Override
            public VkVideoProfileListInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVideoProfileListInfoKHR ret = new VkVideoProfileListInfoKHR(segment.asSlice(0, VkVideoProfileListInfoKHR.BYTES));
                segment = segment.asSlice(VkVideoProfileListInfoKHR.BYTES);
                return ret;
            }
    ...
    public VkVideoProfileListInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceProvokingVertexFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceProvokingVertexFeaturesEXT#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceProvokingVertexFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceProvokingVertexFeaturesEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceProvokingVertexFeaturesEXT.html"><code>VkPhysicalDeviceProvokingVertexFeaturesEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceProvokingVertexFeaturesEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceProvokingVertexFeaturesEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceProvokingVertexFeaturesEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceProvokingVertexFeaturesEXT, Iterable<VkPhysicalDeviceProvokingVertexFeaturesEXT> {
        public long size() {
            return segment.byteSize() / VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES;
        }
        ...
        public @NotNull VkPhysicalDeviceProvokingVertexFeaturesEXT at(long index) {
            return new VkPhysicalDeviceProvokingVertexFeaturesEXT(segment.asSlice(index * VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES, VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES));
        }

        public VkPhysicalDeviceProvokingVertexFeaturesEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceProvokingVertexFeaturesEXT> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull VkPhysicalDeviceProvokingVertexFeaturesEXT value) {
            MemorySegment s = segment.asSlice(index * VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES, VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES,
                (end - start) * VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES));
        }

        public VkPhysicalDeviceProvokingVertexFeaturesEXT[] toArray() {
            VkPhysicalDeviceProvokingVertexFeaturesEXT[] ret = new VkPhysicalDeviceProvokingVertexFeaturesEXT[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceProvokingVertexFeaturesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceProvokingVertexFeaturesEXT> {
            ...
            @Override
            public VkPhysicalDeviceProvokingVertexFeaturesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceProvokingVertexFeaturesEXT ret = new VkPhysicalDeviceProvokingVertexFeaturesEXT(segment.asSlice(0, VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES);
                return ret;
            }
    ...
    public static VkPhysicalDeviceProvokingVertexFeaturesEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceProvokingVertexFeaturesEXT.Ptr ret = new VkPhysicalDeviceProvokingVertexFeaturesEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_PROVOKING_VERTEX_FEATURES_EXT);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceProvokingVertexFeaturesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

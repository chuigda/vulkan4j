...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSamplerYcbcrConversion.html"><code>VkSamplerYcbcrConversion</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSamplerYcbcrConversion.html"><code>VkSamplerYcbcrConversion</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkSamplerYcbcrConversion(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSamplerYcbcrConversion.html"><code>VkSamplerYcbcrConversion</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkSamplerYcbcrConversion> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkSamplerYcbcrConversion read() {
        ...
        public void write(@Nullable VkSamplerYcbcrConversion value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkSamplerYcbcrConversion read(long index) {
        ...
        public void write(long index, @Nullable VkSamplerYcbcrConversion value) {
        ...
        public static Ptr allocate(Arena arena, @Nullable VkSamplerYcbcrConversion @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkSamplerYcbcrConversion> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkSamplerYcbcrConversion value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        private static class Iter implements Iterator<VkSamplerYcbcrConversion> {
            ...
            @Override
            public @Nullable VkSamplerYcbcrConversion next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new VkSamplerYcbcrConversion(s);
            }

...
public record VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR, Iterable<VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.BYTES,
                (end - start) * VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR> {
            ...
            @Override
            public VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR ret = new VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR(segment.asSlice(0, VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR triStripVertexOrderIndependentOfProvokingVertex(@NativeType("VkBool32") @Unsigned int value) {

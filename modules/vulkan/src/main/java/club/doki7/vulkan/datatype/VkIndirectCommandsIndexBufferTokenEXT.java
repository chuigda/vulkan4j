...
public record VkIndirectCommandsIndexBufferTokenEXT(@NotNull MemorySegment segment) implements IVkIndirectCommandsIndexBufferTokenEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkIndirectCommandsIndexBufferTokenEXT, Iterable<VkIndirectCommandsIndexBufferTokenEXT> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkIndirectCommandsIndexBufferTokenEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkIndirectCommandsIndexBufferTokenEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkIndirectCommandsIndexBufferTokenEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkIndirectCommandsIndexBufferTokenEXT.BYTES,
                (end - start) * VkIndirectCommandsIndexBufferTokenEXT.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkIndirectCommandsIndexBufferTokenEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkIndirectCommandsIndexBufferTokenEXT> {
            ...
            @Override
            public VkIndirectCommandsIndexBufferTokenEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkIndirectCommandsIndexBufferTokenEXT ret = new VkIndirectCommandsIndexBufferTokenEXT(segment.asSlice(0, VkIndirectCommandsIndexBufferTokenEXT.BYTES));
                segment = segment.asSlice(VkIndirectCommandsIndexBufferTokenEXT.BYTES);
                return ret;
            }
    ...
    public static VkIndirectCommandsIndexBufferTokenEXT.Ptr allocate(Arena arena, long count) {
        ...
        return new VkIndirectCommandsIndexBufferTokenEXT.Ptr(segment);
    }

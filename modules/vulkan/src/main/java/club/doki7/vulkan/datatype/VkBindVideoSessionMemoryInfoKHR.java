...
public record VkBindVideoSessionMemoryInfoKHR(@NotNull MemorySegment segment) implements IVkBindVideoSessionMemoryInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBindVideoSessionMemoryInfoKHR, Iterable<VkBindVideoSessionMemoryInfoKHR> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkBindVideoSessionMemoryInfoKHR.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkBindVideoSessionMemoryInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkBindVideoSessionMemoryInfoKHR> {
            ...
            @Override
            public VkBindVideoSessionMemoryInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkBindVideoSessionMemoryInfoKHR ret = new VkBindVideoSessionMemoryInfoKHR(segment.asSlice(0, VkBindVideoSessionMemoryInfoKHR.BYTES));
                segment = segment.asSlice(VkBindVideoSessionMemoryInfoKHR.BYTES);
                return ret;
            }
    ...
    public VkBindVideoSessionMemoryInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

...
public record VkVideoEncodeQuantizationMapCapabilitiesKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeQuantizationMapCapabilitiesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeQuantizationMapCapabilitiesKHR, Iterable<VkVideoEncodeQuantizationMapCapabilitiesKHR> {
        public long size() {
        ...
        public VkVideoEncodeQuantizationMapCapabilitiesKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkVideoEncodeQuantizationMapCapabilitiesKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVideoEncodeQuantizationMapCapabilitiesKHR.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkVideoEncodeQuantizationMapCapabilitiesKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkVideoEncodeQuantizationMapCapabilitiesKHR> {
            ...
            @Override
            public VkVideoEncodeQuantizationMapCapabilitiesKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVideoEncodeQuantizationMapCapabilitiesKHR ret = new VkVideoEncodeQuantizationMapCapabilitiesKHR(segment.asSlice(0, VkVideoEncodeQuantizationMapCapabilitiesKHR.BYTES));
                segment = segment.asSlice(VkVideoEncodeQuantizationMapCapabilitiesKHR.BYTES);
                return ret;
            }
    ...
    public VkVideoEncodeQuantizationMapCapabilitiesKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkVideoEncodeQuantizationMapCapabilitiesKHR pNext(@Nullable IPointer pointer) {
    ...
    public VkVideoEncodeQuantizationMapCapabilitiesKHR maxQuantizationMapExtent(@NotNull VkExtent2D value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$maxQuantizationMapExtent, SIZE$maxQuantizationMapExtent);
        return this;
    }

    public VkVideoEncodeQuantizationMapCapabilitiesKHR maxQuantizationMapExtent(Consumer<@NotNull VkExtent2D> consumer) {
        consumer.accept(maxQuantizationMapExtent());
        return this;
    }

...
public record VkBlitImageCubicWeightsInfoQCOM(@NotNull MemorySegment segment) implements IVkBlitImageCubicWeightsInfoQCOM {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBlitImageCubicWeightsInfoQCOM, Iterable<VkBlitImageCubicWeightsInfoQCOM> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkBlitImageCubicWeightsInfoQCOM.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkBlitImageCubicWeightsInfoQCOM.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkBlitImageCubicWeightsInfoQCOM.BYTES,
                (end - start) * VkBlitImageCubicWeightsInfoQCOM.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkBlitImageCubicWeightsInfoQCOM.BYTES));
        }

        public VkBlitImageCubicWeightsInfoQCOM[] toArray() {
            VkBlitImageCubicWeightsInfoQCOM[] ret = new VkBlitImageCubicWeightsInfoQCOM[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkBlitImageCubicWeightsInfoQCOM> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkBlitImageCubicWeightsInfoQCOM> {
            ...
            @Override
            public VkBlitImageCubicWeightsInfoQCOM next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkBlitImageCubicWeightsInfoQCOM ret = new VkBlitImageCubicWeightsInfoQCOM(segment.asSlice(0, VkBlitImageCubicWeightsInfoQCOM.BYTES));
                segment = segment.asSlice(VkBlitImageCubicWeightsInfoQCOM.BYTES);
                return ret;
            }
    ...
    public VkBlitImageCubicWeightsInfoQCOM pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkBlitImageCubicWeightsInfoQCOM pNext(@Nullable IPointer pointer) {

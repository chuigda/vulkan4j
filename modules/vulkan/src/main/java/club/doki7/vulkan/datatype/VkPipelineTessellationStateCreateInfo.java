...
public record VkPipelineTessellationStateCreateInfo(@NotNull MemorySegment segment) implements IVkPipelineTessellationStateCreateInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineTessellationStateCreateInfo, Iterable<VkPipelineTessellationStateCreateInfo> {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPipelineTessellationStateCreateInfo.BYTES));
        }
    ...
    public VkPipelineTessellationStateCreateInfo pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

...
///
/// The {@code allocate} ({@link VkSparseImageFormatProperties2#allocate(Arena)}, {@link VkSparseImageFormatProperties2#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkSparseImageFormatProperties2#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkSparseImageFormatProperties2(@NotNull MemorySegment segment) implements IVkSparseImageFormatProperties2 {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSparseImageFormatProperties2.html"><code>VkSparseImageFormatProperties2</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkSparseImageFormatProperties2}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkSparseImageFormatProperties2 to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkSparseImageFormatProperties2.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSparseImageFormatProperties2, Iterable<VkSparseImageFormatProperties2> {
        ...
        public @NotNull VkSparseImageFormatProperties2 at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSparseImageFormatProperties2.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkSparseImageFormatProperties2.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkSparseImageFormatProperties2.BYTES,
                (end - start) * VkSparseImageFormatProperties2.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkSparseImageFormatProperties2.BYTES));
        }

        public VkSparseImageFormatProperties2[] toArray() {
            VkSparseImageFormatProperties2[] ret = new VkSparseImageFormatProperties2[(int) size()];
    ...
    public static VkSparseImageFormatProperties2.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkSparseImageFormatProperties2.Ptr ret = new VkSparseImageFormatProperties2.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.SPARSE_IMAGE_FORMAT_PROPERTIES_2);
        }
        return ret;
    }
    ...
    public VkSparseImageFormatProperties2 sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkSparseImageFormatProperties2 properties(Consumer<@NotNull VkSparseImageFormatProperties> consumer) {

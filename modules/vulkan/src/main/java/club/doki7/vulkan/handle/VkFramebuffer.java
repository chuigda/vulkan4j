...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkFramebuffer.html"><code>VkFramebuffer</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkFramebuffer.html"><code>VkFramebuffer</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkFramebuffer(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkFramebuffer.html"><code>VkFramebuffer</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkFramebuffer> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkFramebuffer read() {
        ...
        public void write(@Nullable VkFramebuffer value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkFramebuffer read(long index) {
        ...
        public void write(long index, @Nullable VkFramebuffer value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkFramebuffer[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkFramebuffer value0, @Nullable VkFramebuffer ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkFramebuffer @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkFramebuffer> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkFramebuffer value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkFramebuffer value0, @Nullable VkFramebuffer ...values) {
        ...
        @Override
        public @NotNull Iterator<VkFramebuffer> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkFramebuffer> {

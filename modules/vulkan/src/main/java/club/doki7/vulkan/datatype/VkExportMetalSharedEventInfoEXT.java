...
///
/// The {@code allocate} ({@link VkExportMetalSharedEventInfoEXT#allocate(Arena)}, {@link VkExportMetalSharedEventInfoEXT#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkExportMetalSharedEventInfoEXT#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkExportMetalSharedEventInfoEXT(@NotNull MemorySegment segment) implements IVkExportMetalSharedEventInfoEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkExportMetalSharedEventInfoEXT.html"><code>VkExportMetalSharedEventInfoEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkExportMetalSharedEventInfoEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkExportMetalSharedEventInfoEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkExportMetalSharedEventInfoEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkExportMetalSharedEventInfoEXT, Iterable<VkExportMetalSharedEventInfoEXT> {
        public long size() {
            return segment.byteSize() / VkExportMetalSharedEventInfoEXT.BYTES;
        }
        ...
        public @NotNull VkExportMetalSharedEventInfoEXT at(long index) {
        ...
        public VkExportMetalSharedEventInfoEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkExportMetalSharedEventInfoEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkExportMetalSharedEventInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkExportMetalSharedEventInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkExportMetalSharedEventInfoEXT.BYTES,
                (end - start) * VkExportMetalSharedEventInfoEXT.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkExportMetalSharedEventInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkExportMetalSharedEventInfoEXT> {
            ...
            @Override
            public VkExportMetalSharedEventInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkExportMetalSharedEventInfoEXT ret = new VkExportMetalSharedEventInfoEXT(segment.asSlice(0, VkExportMetalSharedEventInfoEXT.BYTES));
                segment = segment.asSlice(VkExportMetalSharedEventInfoEXT.BYTES);
                return ret;
            }
    ...
    public static VkExportMetalSharedEventInfoEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkExportMetalSharedEventInfoEXT.Ptr ret = new VkExportMetalSharedEventInfoEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.EXPORT_METAL_SHARED_EVENT_INFO_EXT);
        }
        return ret;
    }
    ...
    public VkExportMetalSharedEventInfoEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
    ...
    public VkExportMetalSharedEventInfoEXT mtlSharedEvent(@Pointer(comment="MTLSharedEvent_id") @NotNull MemorySegment value) {

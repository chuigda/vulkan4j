...
public record VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT, Iterable<VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT> {
        ...
        public VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT> consumer) {
    ...
    public VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

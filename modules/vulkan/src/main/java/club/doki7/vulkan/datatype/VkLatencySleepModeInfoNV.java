...
///
/// The {@code allocate} ({@link VkLatencySleepModeInfoNV#allocate(Arena)}, {@link VkLatencySleepModeInfoNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkLatencySleepModeInfoNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkLatencySleepModeInfoNV(@NotNull MemorySegment segment) implements IVkLatencySleepModeInfoNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkLatencySleepModeInfoNV.html"><code>VkLatencySleepModeInfoNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkLatencySleepModeInfoNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkLatencySleepModeInfoNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkLatencySleepModeInfoNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkLatencySleepModeInfoNV, Iterable<VkLatencySleepModeInfoNV> {
        public long size() {
        ...
        public @NotNull VkLatencySleepModeInfoNV at(long index) {
            return new VkLatencySleepModeInfoNV(segment.asSlice(index * VkLatencySleepModeInfoNV.BYTES, VkLatencySleepModeInfoNV.BYTES));
        }

        public void at(long index, @NotNull Consumer<@NotNull VkLatencySleepModeInfoNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkLatencySleepModeInfoNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkLatencySleepModeInfoNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkLatencySleepModeInfoNV.BYTES,
                (end - start) * VkLatencySleepModeInfoNV.BYTES
            ));
        }
        ...
        private static final class Iter implements Iterator<VkLatencySleepModeInfoNV> {
            ...
            @Override
            public VkLatencySleepModeInfoNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkLatencySleepModeInfoNV ret = new VkLatencySleepModeInfoNV(segment.asSlice(0, VkLatencySleepModeInfoNV.BYTES));
                segment = segment.asSlice(VkLatencySleepModeInfoNV.BYTES);
                return ret;
            }
    ...
    public static VkLatencySleepModeInfoNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkLatencySleepModeInfoNV.Ptr ret = new VkLatencySleepModeInfoNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.LATENCY_SLEEP_MODE_INFO_NV);
        }
        return ret;
    }
    ...
    public VkLatencySleepModeInfoNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

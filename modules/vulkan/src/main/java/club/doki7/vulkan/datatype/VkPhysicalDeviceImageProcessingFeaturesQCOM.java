...
///     VkBool32 textureSampleWeighted; // @link substring="textureSampleWeighted" target="#textureSampleWeighted"
///     VkBool32 textureBoxFilter; // @link substring="textureBoxFilter" target="#textureBoxFilter"
///     VkBool32 textureBlockMatch; // @link substring="textureBlockMatch" target="#textureBlockMatch"
...
///
/// The {@code allocate} ({@link VkPhysicalDeviceImageProcessingFeaturesQCOM#allocate(Arena)}, {@link VkPhysicalDeviceImageProcessingFeaturesQCOM#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkPhysicalDeviceImageProcessingFeaturesQCOM#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceImageProcessingFeaturesQCOM(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageProcessingFeaturesQCOM {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceImageProcessingFeaturesQCOM.html"><code>VkPhysicalDeviceImageProcessingFeaturesQCOM</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceImageProcessingFeaturesQCOM}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceImageProcessingFeaturesQCOM to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceImageProcessingFeaturesQCOM.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageProcessingFeaturesQCOM, Iterable<VkPhysicalDeviceImageProcessingFeaturesQCOM> {
        public long size() {
            return segment.byteSize() / VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES;
        }
        ...
        public @NotNull VkPhysicalDeviceImageProcessingFeaturesQCOM at(long index) {
            return new VkPhysicalDeviceImageProcessingFeaturesQCOM(segment.asSlice(index * VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES, VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES));
        }

        public VkPhysicalDeviceImageProcessingFeaturesQCOM.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceImageProcessingFeaturesQCOM> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull VkPhysicalDeviceImageProcessingFeaturesQCOM value) {
            MemorySegment s = segment.asSlice(index * VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES, VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES,
                (end - start) * VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES));
        }

        public VkPhysicalDeviceImageProcessingFeaturesQCOM[] toArray() {
            VkPhysicalDeviceImageProcessingFeaturesQCOM[] ret = new VkPhysicalDeviceImageProcessingFeaturesQCOM[(int) size()];
        ...
        private static final class Iter implements Iterator<VkPhysicalDeviceImageProcessingFeaturesQCOM> {
            ...
            @Override
            public VkPhysicalDeviceImageProcessingFeaturesQCOM next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceImageProcessingFeaturesQCOM ret = new VkPhysicalDeviceImageProcessingFeaturesQCOM(segment.asSlice(0, VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceImageProcessingFeaturesQCOM.BYTES);
                return ret;
            }
    ...
    public static VkPhysicalDeviceImageProcessingFeaturesQCOM.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceImageProcessingFeaturesQCOM.Ptr ret = new VkPhysicalDeviceImageProcessingFeaturesQCOM.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_IMAGE_PROCESSING_FEATURES_QCOM);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceImageProcessingFeaturesQCOM pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

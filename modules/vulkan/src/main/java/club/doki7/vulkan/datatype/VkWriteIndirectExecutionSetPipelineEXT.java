...
public record VkWriteIndirectExecutionSetPipelineEXT(@NotNull MemorySegment segment) implements IVkWriteIndirectExecutionSetPipelineEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkWriteIndirectExecutionSetPipelineEXT, Iterable<VkWriteIndirectExecutionSetPipelineEXT> {
        ...
        public VkWriteIndirectExecutionSetPipelineEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkWriteIndirectExecutionSetPipelineEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkWriteIndirectExecutionSetPipelineEXT.BYTES));
        }
        ...
        public VkWriteIndirectExecutionSetPipelineEXT[] toArray() {
            VkWriteIndirectExecutionSetPipelineEXT[] ret = new VkWriteIndirectExecutionSetPipelineEXT[(int) size()];
    ...
    public VkWriteIndirectExecutionSetPipelineEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

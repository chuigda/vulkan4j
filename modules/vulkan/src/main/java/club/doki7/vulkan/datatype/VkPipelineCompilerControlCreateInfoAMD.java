...
/// Represents a pointer to a <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineCompilerControlCreateInfoAMD.html"><code>VkPipelineCompilerControlCreateInfoAMD</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
///     VkPipelineCompilerControlFlagsAMD compilerControlFlags; // optional // @link substring="VkPipelineCompilerControlFlagsAMD" target="VkPipelineCompilerControlFlagsAMD" @link substring="compilerControlFlags" target="#compilerControlFlags"
...
public record VkPipelineCompilerControlCreateInfoAMD(@NotNull MemorySegment segment) implements IVkPipelineCompilerControlCreateInfoAMD {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineCompilerControlCreateInfoAMD, Iterable<VkPipelineCompilerControlCreateInfoAMD> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPipelineCompilerControlCreateInfoAMD.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPipelineCompilerControlCreateInfoAMD.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPipelineCompilerControlCreateInfoAMD.BYTES,
                (end - start) * VkPipelineCompilerControlCreateInfoAMD.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPipelineCompilerControlCreateInfoAMD.BYTES));
        }

        public VkPipelineCompilerControlCreateInfoAMD[] toArray() {
            VkPipelineCompilerControlCreateInfoAMD[] ret = new VkPipelineCompilerControlCreateInfoAMD[(int) size()];
        ...
        private static final class Iter implements Iterator<VkPipelineCompilerControlCreateInfoAMD> {
            ...
            @Override
            public VkPipelineCompilerControlCreateInfoAMD next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPipelineCompilerControlCreateInfoAMD ret = new VkPipelineCompilerControlCreateInfoAMD(segment.asSlice(0, VkPipelineCompilerControlCreateInfoAMD.BYTES));
                segment = segment.asSlice(VkPipelineCompilerControlCreateInfoAMD.BYTES);
                return ret;
            }
    ...
    public VkPipelineCompilerControlCreateInfoAMD pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPipelineCompilerControlCreateInfoAMD pNext(@Nullable IPointer pointer) {

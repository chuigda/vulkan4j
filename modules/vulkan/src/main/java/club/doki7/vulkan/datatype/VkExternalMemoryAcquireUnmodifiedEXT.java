...
///
/// The {@code allocate} ({@link VkExternalMemoryAcquireUnmodifiedEXT#allocate(Arena)}, {@link VkExternalMemoryAcquireUnmodifiedEXT#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkExternalMemoryAcquireUnmodifiedEXT(@NotNull MemorySegment segment) implements IVkExternalMemoryAcquireUnmodifiedEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkExternalMemoryAcquireUnmodifiedEXT.html"><code>VkExternalMemoryAcquireUnmodifiedEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkExternalMemoryAcquireUnmodifiedEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkExternalMemoryAcquireUnmodifiedEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkExternalMemoryAcquireUnmodifiedEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkExternalMemoryAcquireUnmodifiedEXT, Iterable<VkExternalMemoryAcquireUnmodifiedEXT> {
        public long size() {
            return segment.byteSize() / VkExternalMemoryAcquireUnmodifiedEXT.BYTES;
        }
        ...
        public @NotNull VkExternalMemoryAcquireUnmodifiedEXT at(long index) {
        ...
        public VkExternalMemoryAcquireUnmodifiedEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkExternalMemoryAcquireUnmodifiedEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkExternalMemoryAcquireUnmodifiedEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkExternalMemoryAcquireUnmodifiedEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkExternalMemoryAcquireUnmodifiedEXT.BYTES,
                (end - start) * VkExternalMemoryAcquireUnmodifiedEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkExternalMemoryAcquireUnmodifiedEXT.BYTES));
        }

        public VkExternalMemoryAcquireUnmodifiedEXT[] toArray() {
            VkExternalMemoryAcquireUnmodifiedEXT[] ret = new VkExternalMemoryAcquireUnmodifiedEXT[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkExternalMemoryAcquireUnmodifiedEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkExternalMemoryAcquireUnmodifiedEXT> {
            ...
            @Override
            public VkExternalMemoryAcquireUnmodifiedEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkExternalMemoryAcquireUnmodifiedEXT ret = new VkExternalMemoryAcquireUnmodifiedEXT(segment.asSlice(0, VkExternalMemoryAcquireUnmodifiedEXT.BYTES));
                segment = segment.asSlice(VkExternalMemoryAcquireUnmodifiedEXT.BYTES);
                return ret;
            }
    ...
    public static VkExternalMemoryAcquireUnmodifiedEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkExternalMemoryAcquireUnmodifiedEXT.Ptr ret = new VkExternalMemoryAcquireUnmodifiedEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_EXT);
        }
        return ret;
    }
    ...
    public VkExternalMemoryAcquireUnmodifiedEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

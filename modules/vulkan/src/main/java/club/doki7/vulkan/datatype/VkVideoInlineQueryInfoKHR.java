...
///
/// The {@code allocate} ({@link VkVideoInlineQueryInfoKHR#allocate(Arena)}, {@link VkVideoInlineQueryInfoKHR#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkVideoInlineQueryInfoKHR(@NotNull MemorySegment segment) implements IVkVideoInlineQueryInfoKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoInlineQueryInfoKHR.html"><code>VkVideoInlineQueryInfoKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkVideoInlineQueryInfoKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkVideoInlineQueryInfoKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkVideoInlineQueryInfoKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoInlineQueryInfoKHR, Iterable<VkVideoInlineQueryInfoKHR> {
        public long size() {
            return segment.byteSize() / VkVideoInlineQueryInfoKHR.BYTES;
        }
        ...
        public @NotNull VkVideoInlineQueryInfoKHR at(long index) {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkVideoInlineQueryInfoKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVideoInlineQueryInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkVideoInlineQueryInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkVideoInlineQueryInfoKHR.BYTES,
                (end - start) * VkVideoInlineQueryInfoKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkVideoInlineQueryInfoKHR.BYTES));
        }

        public VkVideoInlineQueryInfoKHR[] toArray() {
            VkVideoInlineQueryInfoKHR[] ret = new VkVideoInlineQueryInfoKHR[(int) size()];
        ...
        private static final class Iter implements Iterator<VkVideoInlineQueryInfoKHR> {
            ...
            @Override
            public VkVideoInlineQueryInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVideoInlineQueryInfoKHR ret = new VkVideoInlineQueryInfoKHR(segment.asSlice(0, VkVideoInlineQueryInfoKHR.BYTES));
                segment = segment.asSlice(VkVideoInlineQueryInfoKHR.BYTES);
                return ret;
            }
    ...
    public static VkVideoInlineQueryInfoKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkVideoInlineQueryInfoKHR.Ptr ret = new VkVideoInlineQueryInfoKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.VIDEO_INLINE_QUERY_INFO_KHR);
        }
        return ret;
    }
    ...
    public static final PathElement PATH$queryPool = PathElement.groupElement("queryPool");
    public static final PathElement PATH$firstQuery = PathElement.groupElement("firstQuery");

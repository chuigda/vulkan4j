...
///
/// The {@code allocate} ({@link VkRenderPassFragmentDensityMapCreateInfoEXT#allocate(Arena)}, {@link VkRenderPassFragmentDensityMapCreateInfoEXT#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkRenderPassFragmentDensityMapCreateInfoEXT(@NotNull MemorySegment segment) implements IVkRenderPassFragmentDensityMapCreateInfoEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkRenderPassFragmentDensityMapCreateInfoEXT.html"><code>VkRenderPassFragmentDensityMapCreateInfoEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkRenderPassFragmentDensityMapCreateInfoEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkRenderPassFragmentDensityMapCreateInfoEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkRenderPassFragmentDensityMapCreateInfoEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderPassFragmentDensityMapCreateInfoEXT, Iterable<VkRenderPassFragmentDensityMapCreateInfoEXT> {
        public long size() {
            return segment.byteSize() / VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES;
        }
        ...
        public @NotNull VkRenderPassFragmentDensityMapCreateInfoEXT at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES,
                (end - start) * VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES));
        }

        public VkRenderPassFragmentDensityMapCreateInfoEXT[] toArray() {
            VkRenderPassFragmentDensityMapCreateInfoEXT[] ret = new VkRenderPassFragmentDensityMapCreateInfoEXT[(int) size()];
        ...
        private static final class Iter implements Iterator<VkRenderPassFragmentDensityMapCreateInfoEXT> {
            ...
            @Override
            public VkRenderPassFragmentDensityMapCreateInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkRenderPassFragmentDensityMapCreateInfoEXT ret = new VkRenderPassFragmentDensityMapCreateInfoEXT(segment.asSlice(0, VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES));
                segment = segment.asSlice(VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES);
                return ret;
            }
    ...
    public static VkRenderPassFragmentDensityMapCreateInfoEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkRenderPassFragmentDensityMapCreateInfoEXT.Ptr ret = new VkRenderPassFragmentDensityMapCreateInfoEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.RENDER_PASS_FRAGMENT_DENSITY_MAP_CREATE_INFO_EXT);
        }
        return ret;
    }
    ...
    public VkRenderPassFragmentDensityMapCreateInfoEXT sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkRenderPassFragmentDensityMapCreateInfoEXT fragmentDensityMapAttachment(@NotNull VkAttachmentReference value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$fragmentDensityMapAttachment, SIZE$fragmentDensityMapAttachment);
        return this;
    }

    public VkRenderPassFragmentDensityMapCreateInfoEXT fragmentDensityMapAttachment(Consumer<@NotNull VkAttachmentReference> consumer) {
        consumer.accept(fragmentDensityMapAttachment());
        return this;
    }

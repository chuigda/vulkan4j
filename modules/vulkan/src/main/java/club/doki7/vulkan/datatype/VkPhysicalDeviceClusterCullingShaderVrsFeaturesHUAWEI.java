...
public record VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI(@NotNull MemorySegment segment) implements IVkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI, Iterable<VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI> {
        ...
        public VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI.BYTES,
                (end - start) * VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI> {
    ...
    public VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI clusterShadingRate(@NativeType("VkBool32") @Unsigned int value) {

...
/// Represents a pointer to a <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkFilterCubicImageViewImageFormatPropertiesEXT.html"><code>VkFilterCubicImageViewImageFormatPropertiesEXT</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
///     VkBool32 filterCubic; // @link substring="filterCubic" target="#filterCubic"
///     VkBool32 filterCubicMinmax; // @link substring="filterCubicMinmax" target="#filterCubicMinmax"
...
public record VkFilterCubicImageViewImageFormatPropertiesEXT(@NotNull MemorySegment segment) implements IVkFilterCubicImageViewImageFormatPropertiesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkFilterCubicImageViewImageFormatPropertiesEXT, Iterable<VkFilterCubicImageViewImageFormatPropertiesEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkFilterCubicImageViewImageFormatPropertiesEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkFilterCubicImageViewImageFormatPropertiesEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkFilterCubicImageViewImageFormatPropertiesEXT.BYTES,
                (end - start) * VkFilterCubicImageViewImageFormatPropertiesEXT.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkFilterCubicImageViewImageFormatPropertiesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkFilterCubicImageViewImageFormatPropertiesEXT> {
            ...
            @Override
            public VkFilterCubicImageViewImageFormatPropertiesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkFilterCubicImageViewImageFormatPropertiesEXT ret = new VkFilterCubicImageViewImageFormatPropertiesEXT(segment.asSlice(0, VkFilterCubicImageViewImageFormatPropertiesEXT.BYTES));
                segment = segment.asSlice(VkFilterCubicImageViewImageFormatPropertiesEXT.BYTES);
                return ret;
            }
    ...
    public VkFilterCubicImageViewImageFormatPropertiesEXT sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

...
/// Represents a pointer to a <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoSessionMemoryRequirementsKHR.html"><code>VkVideoSessionMemoryRequirementsKHR</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
///
/// The {@code allocate} ({@link VkVideoSessionMemoryRequirementsKHR#allocate(Arena)}, {@link VkVideoSessionMemoryRequirementsKHR#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkVideoSessionMemoryRequirementsKHR#autoInit}
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoSessionMemoryRequirementsKHR.html"><code>VkVideoSessionMemoryRequirementsKHR</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkVideoSessionMemoryRequirementsKHR(@NotNull MemorySegment segment) implements IVkVideoSessionMemoryRequirementsKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoSessionMemoryRequirementsKHR.html"><code>VkVideoSessionMemoryRequirementsKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkVideoSessionMemoryRequirementsKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkVideoSessionMemoryRequirementsKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkVideoSessionMemoryRequirementsKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoSessionMemoryRequirementsKHR, Iterable<VkVideoSessionMemoryRequirementsKHR> {
        public long size() {
            return segment.byteSize() / VkVideoSessionMemoryRequirementsKHR.BYTES;
        }
        ...
        public @NotNull VkVideoSessionMemoryRequirementsKHR at(long index) {
        ...
        public VkVideoSessionMemoryRequirementsKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkVideoSessionMemoryRequirementsKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVideoSessionMemoryRequirementsKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkVideoSessionMemoryRequirementsKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkVideoSessionMemoryRequirementsKHR.BYTES,
                (end - start) * VkVideoSessionMemoryRequirementsKHR.BYTES
            ));
        }
        ...
        private static final class Iter implements Iterator<VkVideoSessionMemoryRequirementsKHR> {
            ...
            @Override
            public VkVideoSessionMemoryRequirementsKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVideoSessionMemoryRequirementsKHR ret = new VkVideoSessionMemoryRequirementsKHR(segment.asSlice(0, VkVideoSessionMemoryRequirementsKHR.BYTES));
                segment = segment.asSlice(VkVideoSessionMemoryRequirementsKHR.BYTES);
                return ret;
            }
    ...
    public static VkVideoSessionMemoryRequirementsKHR allocate(Arena arena) {
        VkVideoSessionMemoryRequirementsKHR ret = new VkVideoSessionMemoryRequirementsKHR(arena.allocate(LAYOUT));
        ret.sType(VkStructureType.VIDEO_SESSION_MEMORY_REQUIREMENTS_KHR);
        return ret;
    }

    public static VkVideoSessionMemoryRequirementsKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkVideoSessionMemoryRequirementsKHR.Ptr ret = new VkVideoSessionMemoryRequirementsKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.VIDEO_SESSION_MEMORY_REQUIREMENTS_KHR);
        }
        return ret;
    }
    ...
    public VkVideoSessionMemoryRequirementsKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

...
public record VkMultiDrawIndexedInfoEXT(@NotNull MemorySegment segment) implements IVkMultiDrawIndexedInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkMultiDrawIndexedInfoEXT, Iterable<VkMultiDrawIndexedInfoEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkMultiDrawIndexedInfoEXT.BYTES));
        }
        ...
        public VkMultiDrawIndexedInfoEXT[] toArray() {
            VkMultiDrawIndexedInfoEXT[] ret = new VkMultiDrawIndexedInfoEXT[(int) size()];
        ...
        private static final class Iter implements Iterator<VkMultiDrawIndexedInfoEXT> {
            ...
            @Override
            public VkMultiDrawIndexedInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkMultiDrawIndexedInfoEXT ret = new VkMultiDrawIndexedInfoEXT(segment.asSlice(0, VkMultiDrawIndexedInfoEXT.BYTES));
                segment = segment.asSlice(VkMultiDrawIndexedInfoEXT.BYTES);
                return ret;
            }

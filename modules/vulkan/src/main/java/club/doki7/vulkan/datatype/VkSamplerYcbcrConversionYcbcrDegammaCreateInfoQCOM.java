...
///
/// The {@code allocate} ({@link VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM#allocate(Arena)}, {@link VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM(@NotNull MemorySegment segment) implements IVkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.html"><code>VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM, Iterable<VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM> {
        public long size() {
            return segment.byteSize() / VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.BYTES;
        }
        ...
        public @NotNull VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM at(long index) {
        ...
        public void write(long index, @NotNull VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM value) {
            MemorySegment s = segment.asSlice(index * VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.BYTES, VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.BYTES,
                (end - start) * VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM> {
            ...
            @Override
            public VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM ret = new VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM(segment.asSlice(0, VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.BYTES));
                segment = segment.asSlice(VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.BYTES);
                return ret;
            }
    ...
    public static VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.Ptr ret = new VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.SAMPLER_YCBCR_CONVERSION_YCBCR_DEGAMMA_CREATE_INFO_QCOM);
        }
        return ret;
    }
    ...
    public VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

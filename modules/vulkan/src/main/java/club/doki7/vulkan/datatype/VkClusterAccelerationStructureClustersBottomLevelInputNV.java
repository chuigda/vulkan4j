...
///
/// The {@code allocate} ({@link VkClusterAccelerationStructureClustersBottomLevelInputNV#allocate(Arena)}, {@link VkClusterAccelerationStructureClustersBottomLevelInputNV#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkClusterAccelerationStructureClustersBottomLevelInputNV(@NotNull MemorySegment segment) implements IVkClusterAccelerationStructureClustersBottomLevelInputNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkClusterAccelerationStructureClustersBottomLevelInputNV.html"><code>VkClusterAccelerationStructureClustersBottomLevelInputNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkClusterAccelerationStructureClustersBottomLevelInputNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkClusterAccelerationStructureClustersBottomLevelInputNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkClusterAccelerationStructureClustersBottomLevelInputNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkClusterAccelerationStructureClustersBottomLevelInputNV, Iterable<VkClusterAccelerationStructureClustersBottomLevelInputNV> {
        ...
        public @NotNull VkClusterAccelerationStructureClustersBottomLevelInputNV at(long index) {
        ...
        public VkClusterAccelerationStructureClustersBottomLevelInputNV.Ptr at(long index, @NotNull Consumer<@NotNull VkClusterAccelerationStructureClustersBottomLevelInputNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkClusterAccelerationStructureClustersBottomLevelInputNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkClusterAccelerationStructureClustersBottomLevelInputNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkClusterAccelerationStructureClustersBottomLevelInputNV.BYTES,
                (end - start) * VkClusterAccelerationStructureClustersBottomLevelInputNV.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkClusterAccelerationStructureClustersBottomLevelInputNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkClusterAccelerationStructureClustersBottomLevelInputNV> {
    ...
    public static VkClusterAccelerationStructureClustersBottomLevelInputNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkClusterAccelerationStructureClustersBottomLevelInputNV.Ptr ret = new VkClusterAccelerationStructureClustersBottomLevelInputNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.CLUSTER_ACCELERATION_STRUCTURE_CLUSTERS_BOTTOM_LEVEL_INPUT_NV);
        }
        return ret;
    }
    ...
    public VkClusterAccelerationStructureClustersBottomLevelInputNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

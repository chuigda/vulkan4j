...
public record VkBufferCollectionConstraintsInfoFUCHSIA(@NotNull MemorySegment segment) implements IVkBufferCollectionConstraintsInfoFUCHSIA {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBufferCollectionConstraintsInfoFUCHSIA, Iterable<VkBufferCollectionConstraintsInfoFUCHSIA> {
        public long size() {
        ...
        public VkBufferCollectionConstraintsInfoFUCHSIA.Ptr at(long index, @NotNull Consumer<@NotNull VkBufferCollectionConstraintsInfoFUCHSIA> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkBufferCollectionConstraintsInfoFUCHSIA.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkBufferCollectionConstraintsInfoFUCHSIA> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkBufferCollectionConstraintsInfoFUCHSIA> {
            ...
            @Override
            public VkBufferCollectionConstraintsInfoFUCHSIA next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkBufferCollectionConstraintsInfoFUCHSIA ret = new VkBufferCollectionConstraintsInfoFUCHSIA(segment.asSlice(0, VkBufferCollectionConstraintsInfoFUCHSIA.BYTES));
                segment = segment.asSlice(VkBufferCollectionConstraintsInfoFUCHSIA.BYTES);
                return ret;
            }
    ...
    public VkBufferCollectionConstraintsInfoFUCHSIA pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

...
public record VkMemoryType(@NotNull MemorySegment segment) implements IVkMemoryType {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryType, Iterable<VkMemoryType> {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkMemoryType.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkMemoryType.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkMemoryType.BYTES,
                (end - start) * VkMemoryType.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkMemoryType> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkMemoryType> {
    ...
    public @MagicConstant(valuesFromClass = VkMemoryPropertyFlags.class) int propertyFlags() {
        return segment.get(LAYOUT$propertyFlags, OFFSET$propertyFlags);
    }

    public VkMemoryType propertyFlags(@MagicConstant(valuesFromClass = VkMemoryPropertyFlags.class) int value) {

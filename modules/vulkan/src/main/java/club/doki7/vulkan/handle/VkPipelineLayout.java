...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineLayout.html"><code>VkPipelineLayout</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineLayout.html"><code>VkPipelineLayout</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkPipelineLayout(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineLayout.html"><code>VkPipelineLayout</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkPipelineLayout> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkPipelineLayout read() {
        ...
        public void write(@Nullable VkPipelineLayout value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkPipelineLayout read(long index) {
        ...
        public void write(long index, @Nullable VkPipelineLayout value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkPipelineLayout[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkPipelineLayout value0, @Nullable VkPipelineLayout ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkPipelineLayout @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkPipelineLayout> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkPipelineLayout value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkPipelineLayout value0, @Nullable VkPipelineLayout ...values) {

...
public record VkMemoryGetFdInfoKHR(@NotNull MemorySegment segment) implements IVkMemoryGetFdInfoKHR {
    ...
    public VkMemoryGetFdInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkMemoryGetFdInfoKHR handleType(@MagicConstant(valuesFromClass = VkExternalMemoryHandleTypeFlags.class) int value) {

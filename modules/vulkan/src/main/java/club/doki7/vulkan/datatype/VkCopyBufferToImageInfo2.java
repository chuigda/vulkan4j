...
///
/// The {@code allocate} ({@link VkCopyBufferToImageInfo2#allocate(Arena)}, {@link VkCopyBufferToImageInfo2#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkCopyBufferToImageInfo2(@NotNull MemorySegment segment) implements IVkCopyBufferToImageInfo2 {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCopyBufferToImageInfo2.html"><code>VkCopyBufferToImageInfo2</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkCopyBufferToImageInfo2}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkCopyBufferToImageInfo2 to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkCopyBufferToImageInfo2.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyBufferToImageInfo2, Iterable<VkCopyBufferToImageInfo2> {
        public long size() {
            return segment.byteSize() / VkCopyBufferToImageInfo2.BYTES;
        }
        ...
        public @NotNull VkCopyBufferToImageInfo2 at(long index) {
            return new VkCopyBufferToImageInfo2(segment.asSlice(index * VkCopyBufferToImageInfo2.BYTES, VkCopyBufferToImageInfo2.BYTES));
        }

        public VkCopyBufferToImageInfo2.Ptr at(long index, @NotNull Consumer<@NotNull VkCopyBufferToImageInfo2> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull VkCopyBufferToImageInfo2 value) {
            MemorySegment s = segment.asSlice(index * VkCopyBufferToImageInfo2.BYTES, VkCopyBufferToImageInfo2.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkCopyBufferToImageInfo2.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkCopyBufferToImageInfo2.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkCopyBufferToImageInfo2.BYTES,
                (end - start) * VkCopyBufferToImageInfo2.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkCopyBufferToImageInfo2.BYTES));
        }

        public VkCopyBufferToImageInfo2[] toArray() {
            VkCopyBufferToImageInfo2[] ret = new VkCopyBufferToImageInfo2[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkCopyBufferToImageInfo2> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkCopyBufferToImageInfo2> {
            ...
            @Override
            public VkCopyBufferToImageInfo2 next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkCopyBufferToImageInfo2 ret = new VkCopyBufferToImageInfo2(segment.asSlice(0, VkCopyBufferToImageInfo2.BYTES));
                segment = segment.asSlice(VkCopyBufferToImageInfo2.BYTES);
                return ret;
            }
    ...
    public static VkCopyBufferToImageInfo2.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkCopyBufferToImageInfo2.Ptr ret = new VkCopyBufferToImageInfo2.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.COPY_BUFFER_TO_IMAGE_INFO_2);
        }
        return ret;
    }
    ...
    public VkCopyBufferToImageInfo2 pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
    ...
    public @Pointer(target=VkBufferImageCopy2.class) @NotNull MemorySegment pRegionsRaw() {
        return segment.get(LAYOUT$pRegions, OFFSET$pRegions);
    }

    public void pRegionsRaw(@Pointer(target=VkBufferImageCopy2.class) @NotNull MemorySegment value) {

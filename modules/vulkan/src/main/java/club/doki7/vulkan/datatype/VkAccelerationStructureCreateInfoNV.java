...
@ValueBasedCandidate
@UnsafeConstructor
public record VkAccelerationStructureCreateInfoNV(@NotNull MemorySegment segment) implements IVkAccelerationStructureCreateInfoNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkAccelerationStructureCreateInfoNV.html"><code>VkAccelerationStructureCreateInfoNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkAccelerationStructureCreateInfoNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkAccelerationStructureCreateInfoNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkAccelerationStructureCreateInfoNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureCreateInfoNV, Iterable<VkAccelerationStructureCreateInfoNV> {
        public long size() {
            return segment.byteSize() / VkAccelerationStructureCreateInfoNV.BYTES;
        }
        ...
        public @NotNull VkAccelerationStructureCreateInfoNV at(long index) {
        ...
        public void write(long index, @NotNull VkAccelerationStructureCreateInfoNV value) {
            MemorySegment s = segment.asSlice(index * VkAccelerationStructureCreateInfoNV.BYTES, VkAccelerationStructureCreateInfoNV.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkAccelerationStructureCreateInfoNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkAccelerationStructureCreateInfoNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkAccelerationStructureCreateInfoNV.BYTES,
                (end - start) * VkAccelerationStructureCreateInfoNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkAccelerationStructureCreateInfoNV.BYTES));
        }

        public VkAccelerationStructureCreateInfoNV[] toArray() {
            VkAccelerationStructureCreateInfoNV[] ret = new VkAccelerationStructureCreateInfoNV[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkAccelerationStructureCreateInfoNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkAccelerationStructureCreateInfoNV> {
            ...
            @Override
            public VkAccelerationStructureCreateInfoNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkAccelerationStructureCreateInfoNV ret = new VkAccelerationStructureCreateInfoNV(segment.asSlice(0, VkAccelerationStructureCreateInfoNV.BYTES));
                segment = segment.asSlice(VkAccelerationStructureCreateInfoNV.BYTES);
                return ret;
            }
    ...
    public static VkAccelerationStructureCreateInfoNV.Ptr allocate(Arena arena, long count) {
    ...
    public VkAccelerationStructureCreateInfoNV sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkAccelerationStructureCreateInfoNV info(Consumer<@NotNull VkAccelerationStructureInfoNV> consumer) {

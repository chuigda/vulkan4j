...
public record VkCommandBufferBeginInfo(@NotNull MemorySegment segment) implements IVkCommandBufferBeginInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCommandBufferBeginInfo, Iterable<VkCommandBufferBeginInfo> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkCommandBufferBeginInfo> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkCommandBufferBeginInfo.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkCommandBufferBeginInfo.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkCommandBufferBeginInfo.BYTES,
                (end - start) * VkCommandBufferBeginInfo.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkCommandBufferBeginInfo> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkCommandBufferBeginInfo> {
            ...
            @Override
            public VkCommandBufferBeginInfo next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkCommandBufferBeginInfo ret = new VkCommandBufferBeginInfo(segment.asSlice(0, VkCommandBufferBeginInfo.BYTES));
                segment = segment.asSlice(VkCommandBufferBeginInfo.BYTES);
                return ret;
            }
    ...
    public VkCommandBufferBeginInfo pInheritanceInfo(@Nullable IVkCommandBufferInheritanceInfo value) {

...
public record StdVideoAV1LoopFilterFlags(@NotNull MemorySegment segment) implements IStdVideoAV1LoopFilterFlags {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoAV1LoopFilterFlags, Iterable<StdVideoAV1LoopFilterFlags> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull StdVideoAV1LoopFilterFlags> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * StdVideoAV1LoopFilterFlags.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<StdVideoAV1LoopFilterFlags> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoAV1LoopFilterFlags> {
            ...
            @Override
            public StdVideoAV1LoopFilterFlags next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                StdVideoAV1LoopFilterFlags ret = new StdVideoAV1LoopFilterFlags(segment.asSlice(0, StdVideoAV1LoopFilterFlags.BYTES));
                segment = segment.asSlice(StdVideoAV1LoopFilterFlags.BYTES);
                return ret;
            }

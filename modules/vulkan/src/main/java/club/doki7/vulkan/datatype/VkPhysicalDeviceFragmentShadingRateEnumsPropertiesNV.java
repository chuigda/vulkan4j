...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.html"><code>VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV, Iterable<VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV> {
        public long size() {
        ...
        public @NotNull VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV at(long index) {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.BYTES,
                (end - start) * VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.BYTES));
        }

        public VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV[] toArray() {
            VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV[] ret = new VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV> {
            ...
            @Override
            public VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV ret = new VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV(segment.asSlice(0, VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.BYTES);
                return ret;
            }
    ...
    public static VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.Ptr ret = new VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_PROPERTIES_NV);
        }
        return ret;
    }

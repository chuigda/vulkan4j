...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkBufferCollectionFUCHSIA.html"><code>VkBufferCollectionFUCHSIA</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkBufferCollectionFUCHSIA.html"><code>VkBufferCollectionFUCHSIA</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkBufferCollectionFUCHSIA(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkBufferCollectionFUCHSIA.html"><code>VkBufferCollectionFUCHSIA</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkBufferCollectionFUCHSIA> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkBufferCollectionFUCHSIA read() {
        ...
        public void write(@Nullable VkBufferCollectionFUCHSIA value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkBufferCollectionFUCHSIA read(long index) {
        ...
        public void write(long index, @Nullable VkBufferCollectionFUCHSIA value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkBufferCollectionFUCHSIA[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkBufferCollectionFUCHSIA value0, @Nullable VkBufferCollectionFUCHSIA ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkBufferCollectionFUCHSIA @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkBufferCollectionFUCHSIA> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkBufferCollectionFUCHSIA value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        @Override
        public @NotNull Iterator<VkBufferCollectionFUCHSIA> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkBufferCollectionFUCHSIA> {
            ...
            @Override
            public @Nullable VkBufferCollectionFUCHSIA next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new VkBufferCollectionFUCHSIA(s);
            }

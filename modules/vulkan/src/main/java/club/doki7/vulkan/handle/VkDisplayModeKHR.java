...
public record VkDisplayModeKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkDisplayModeKHR> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkDisplayModeKHR read() {
        ...
        public void write(@Nullable VkDisplayModeKHR value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkDisplayModeKHR read(long index) {
        ...
        public void write(long index, @Nullable VkDisplayModeKHR value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkDisplayModeKHR[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkDisplayModeKHR value0, @Nullable VkDisplayModeKHR ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkDisplayModeKHR @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkDisplayModeKHR> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkDisplayModeKHR value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkDisplayModeKHR value0, @Nullable VkDisplayModeKHR ...values) {
        ...
        @Override
        public @NotNull Iterator<VkDisplayModeKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkDisplayModeKHR> {

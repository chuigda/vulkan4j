...
public record VkExportMetalTextureInfoEXT(@NotNull MemorySegment segment) implements IVkExportMetalTextureInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkExportMetalTextureInfoEXT, Iterable<VkExportMetalTextureInfoEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkExportMetalTextureInfoEXT.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkExportMetalTextureInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkExportMetalTextureInfoEXT> {
            ...
            @Override
            public VkExportMetalTextureInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkExportMetalTextureInfoEXT ret = new VkExportMetalTextureInfoEXT(segment.asSlice(0, VkExportMetalTextureInfoEXT.BYTES));
                segment = segment.asSlice(VkExportMetalTextureInfoEXT.BYTES);
                return ret;
            }
    ...
    public VkExportMetalTextureInfoEXT sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkExportMetalTextureInfoEXT plane(@MagicConstant(valuesFromClass = VkImageAspectFlags.class) int value) {

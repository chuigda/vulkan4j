...
public record VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT, Iterable<VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT> {
            ...
            @Override
            public VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT ret = new VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT(segment.asSlice(0, VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int attachmentFeedbackLoopLayout() {
        return segment.get(LAYOUT$attachmentFeedbackLoopLayout, OFFSET$attachmentFeedbackLoopLayout);
    }

    public VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT attachmentFeedbackLoopLayout(@NativeType("VkBool32") @Unsigned int value) {

...
public record VkDescriptorGetInfoEXT(@NotNull MemorySegment segment) implements IVkDescriptorGetInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDescriptorGetInfoEXT, Iterable<VkDescriptorGetInfoEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkDescriptorGetInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkDescriptorGetInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkDescriptorGetInfoEXT.BYTES,
                (end - start) * VkDescriptorGetInfoEXT.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkDescriptorGetInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkDescriptorGetInfoEXT> {
            ...
            @Override
            public VkDescriptorGetInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkDescriptorGetInfoEXT ret = new VkDescriptorGetInfoEXT(segment.asSlice(0, VkDescriptorGetInfoEXT.BYTES));
                segment = segment.asSlice(VkDescriptorGetInfoEXT.BYTES);
                return ret;
            }
    ...
    public VkDescriptorGetInfoEXT sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkDescriptorGetInfoEXT type(@MagicConstant(valuesFromClass = VkDescriptorType.class) int value) {
    ...
    public VkDescriptorGetInfoEXT data(Consumer<@NotNull VkDescriptorDataEXT> consumer) {

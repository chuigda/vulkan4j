...
public record VkPhysicalDeviceShaderQuadControlFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderQuadControlFeaturesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderQuadControlFeaturesKHR, Iterable<VkPhysicalDeviceShaderQuadControlFeaturesKHR> {
        ...
        public VkPhysicalDeviceShaderQuadControlFeaturesKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceShaderQuadControlFeaturesKHR> consumer) {
    ...
    public VkPhysicalDeviceShaderQuadControlFeaturesKHR sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceShaderQuadControlFeaturesKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

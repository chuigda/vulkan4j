...
public record VkPhysicalDeviceLineRasterizationProperties(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLineRasterizationProperties {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLineRasterizationProperties, Iterable<VkPhysicalDeviceLineRasterizationProperties> {
        public long size() {
        ...
        public VkPhysicalDeviceLineRasterizationProperties.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceLineRasterizationProperties> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceLineRasterizationProperties.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceLineRasterizationProperties.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceLineRasterizationProperties.BYTES,
                (end - start) * VkPhysicalDeviceLineRasterizationProperties.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceLineRasterizationProperties.BYTES));
        }

        public VkPhysicalDeviceLineRasterizationProperties[] toArray() {
            VkPhysicalDeviceLineRasterizationProperties[] ret = new VkPhysicalDeviceLineRasterizationProperties[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceLineRasterizationProperties> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceLineRasterizationProperties> {
            ...
            @Override
            public VkPhysicalDeviceLineRasterizationProperties next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceLineRasterizationProperties ret = new VkPhysicalDeviceLineRasterizationProperties(segment.asSlice(0, VkPhysicalDeviceLineRasterizationProperties.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceLineRasterizationProperties.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceLineRasterizationProperties sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceLineRasterizationProperties pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceLineRasterizationProperties pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDeviceLineRasterizationProperties lineSubPixelPrecisionBits(@Unsigned int value) {

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkIndirectCommandsLayoutNV.html"><code>VkIndirectCommandsLayoutNV</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkIndirectCommandsLayoutNV.html"><code>VkIndirectCommandsLayoutNV</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkIndirectCommandsLayoutNV(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkIndirectCommandsLayoutNV.html"><code>VkIndirectCommandsLayoutNV</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkIndirectCommandsLayoutNV> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkIndirectCommandsLayoutNV read() {
        ...
        public void write(@Nullable VkIndirectCommandsLayoutNV value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkIndirectCommandsLayoutNV read(long index) {
        ...
        public void write(long index, @Nullable VkIndirectCommandsLayoutNV value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkIndirectCommandsLayoutNV[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkIndirectCommandsLayoutNV value0, @Nullable VkIndirectCommandsLayoutNV ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkIndirectCommandsLayoutNV @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkIndirectCommandsLayoutNV> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkIndirectCommandsLayoutNV value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        @Override
        public @NotNull Iterator<VkIndirectCommandsLayoutNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkIndirectCommandsLayoutNV> {

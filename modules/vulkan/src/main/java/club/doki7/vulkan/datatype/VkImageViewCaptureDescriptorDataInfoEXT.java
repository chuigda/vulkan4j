...
public record VkImageViewCaptureDescriptorDataInfoEXT(@NotNull MemorySegment segment) implements IVkImageViewCaptureDescriptorDataInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageViewCaptureDescriptorDataInfoEXT, Iterable<VkImageViewCaptureDescriptorDataInfoEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkImageViewCaptureDescriptorDataInfoEXT.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkImageViewCaptureDescriptorDataInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkImageViewCaptureDescriptorDataInfoEXT> {
            ...
            @Override
            public VkImageViewCaptureDescriptorDataInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkImageViewCaptureDescriptorDataInfoEXT ret = new VkImageViewCaptureDescriptorDataInfoEXT(segment.asSlice(0, VkImageViewCaptureDescriptorDataInfoEXT.BYTES));
                segment = segment.asSlice(VkImageViewCaptureDescriptorDataInfoEXT.BYTES);
                return ret;
            }
    ...
    public VkImageViewCaptureDescriptorDataInfoEXT imageView(@Nullable VkImageView value) {

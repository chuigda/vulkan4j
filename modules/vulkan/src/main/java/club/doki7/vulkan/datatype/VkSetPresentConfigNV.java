...
///
/// The {@code allocate} ({@link VkSetPresentConfigNV#allocate(Arena)}, {@link VkSetPresentConfigNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkSetPresentConfigNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkSetPresentConfigNV(@NotNull MemorySegment segment) implements IVkSetPresentConfigNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSetPresentConfigNV.html"><code>VkSetPresentConfigNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkSetPresentConfigNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkSetPresentConfigNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkSetPresentConfigNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSetPresentConfigNV, Iterable<VkSetPresentConfigNV> {
        public long size() {
            return segment.byteSize() / VkSetPresentConfigNV.BYTES;
        }
        ...
        public @NotNull VkSetPresentConfigNV at(long index) {
            return new VkSetPresentConfigNV(segment.asSlice(index * VkSetPresentConfigNV.BYTES, VkSetPresentConfigNV.BYTES));
        }

        public void at(long index, @NotNull Consumer<@NotNull VkSetPresentConfigNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSetPresentConfigNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkSetPresentConfigNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkSetPresentConfigNV.BYTES,
                (end - start) * VkSetPresentConfigNV.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkSetPresentConfigNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSetPresentConfigNV> {
            ...
            @Override
            public VkSetPresentConfigNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkSetPresentConfigNV ret = new VkSetPresentConfigNV(segment.asSlice(0, VkSetPresentConfigNV.BYTES));
                segment = segment.asSlice(VkSetPresentConfigNV.BYTES);
                return ret;
            }
    ...
    public static VkSetPresentConfigNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkSetPresentConfigNV.Ptr ret = new VkSetPresentConfigNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.SET_PRESENT_CONFIG_NV);
        }
        return ret;
    }

    public static VkSetPresentConfigNV clone(Arena arena, VkSetPresentConfigNV src) {
        VkSetPresentConfigNV ret = allocate(arena);
    ...
    public VkSetPresentConfigNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

...
public record VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceComputeShaderDerivativesPropertiesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceComputeShaderDerivativesPropertiesKHR, Iterable<VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.BYTES,
                (end - start) * VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.BYTES));
        }

        public VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR[] toArray() {
            VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR[] ret = new VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR> {
            ...
            @Override
            public VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR ret = new VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR(segment.asSlice(0, VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int meshAndTaskShaderDerivatives() {
        return segment.get(LAYOUT$meshAndTaskShaderDerivatives, OFFSET$meshAndTaskShaderDerivatives);
    }

    public VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR meshAndTaskShaderDerivatives(@NativeType("VkBool32") @Unsigned int value) {

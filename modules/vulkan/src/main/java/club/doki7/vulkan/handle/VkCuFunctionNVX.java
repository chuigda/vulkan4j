...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCuFunctionNVX.html"><code>VkCuFunctionNVX</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCuFunctionNVX.html"><code>VkCuFunctionNVX</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkCuFunctionNVX(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCuFunctionNVX.html"><code>VkCuFunctionNVX</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkCuFunctionNVX> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkCuFunctionNVX read() {
        ...
        public void write(@Nullable VkCuFunctionNVX value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkCuFunctionNVX read(long index) {
        ...
        public void write(long index, @Nullable VkCuFunctionNVX value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkCuFunctionNVX[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkCuFunctionNVX value0, @Nullable VkCuFunctionNVX ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkCuFunctionNVX @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkCuFunctionNVX> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkCuFunctionNVX value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;

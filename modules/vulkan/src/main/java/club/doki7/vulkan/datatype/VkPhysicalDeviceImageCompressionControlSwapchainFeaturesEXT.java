...
public record VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT, Iterable<VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT> {
        ...
        public VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT> consumer) {
    ...
    public VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

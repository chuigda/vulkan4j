...
public record VkExternalImageFormatPropertiesNV(@NotNull MemorySegment segment) implements IVkExternalImageFormatPropertiesNV {
    ...
    public @MagicConstant(valuesFromClass = VkExternalMemoryFeatureFlagsNV.class) int externalMemoryFeatures() {
        return segment.get(LAYOUT$externalMemoryFeatures, OFFSET$externalMemoryFeatures);
    }

    public VkExternalImageFormatPropertiesNV externalMemoryFeatures(@MagicConstant(valuesFromClass = VkExternalMemoryFeatureFlagsNV.class) int value) {
        segment.set(LAYOUT$externalMemoryFeatures, OFFSET$externalMemoryFeatures, value);
        return this;
    }

    public @MagicConstant(valuesFromClass = VkExternalMemoryHandleTypeFlagsNV.class) int exportFromImportedHandleTypes() {
        return segment.get(LAYOUT$exportFromImportedHandleTypes, OFFSET$exportFromImportedHandleTypes);
    }

    public VkExternalImageFormatPropertiesNV exportFromImportedHandleTypes(@MagicConstant(valuesFromClass = VkExternalMemoryHandleTypeFlagsNV.class) int value) {
        segment.set(LAYOUT$exportFromImportedHandleTypes, OFFSET$exportFromImportedHandleTypes, value);
        return this;
    }

    public @MagicConstant(valuesFromClass = VkExternalMemoryHandleTypeFlagsNV.class) int compatibleHandleTypes() {
        return segment.get(LAYOUT$compatibleHandleTypes, OFFSET$compatibleHandleTypes);
    }

    public VkExternalImageFormatPropertiesNV compatibleHandleTypes(@MagicConstant(valuesFromClass = VkExternalMemoryHandleTypeFlagsNV.class) int value) {

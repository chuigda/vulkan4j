...
public record VkExportFenceWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IVkExportFenceWin32HandleInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkExportFenceWin32HandleInfoKHR, Iterable<VkExportFenceWin32HandleInfoKHR> {
        public long size() {
        ...
        public VkExportFenceWin32HandleInfoKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkExportFenceWin32HandleInfoKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkExportFenceWin32HandleInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkExportFenceWin32HandleInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkExportFenceWin32HandleInfoKHR.BYTES,
                (end - start) * VkExportFenceWin32HandleInfoKHR.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkExportFenceWin32HandleInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkExportFenceWin32HandleInfoKHR> {
            ...
            @Override
            public VkExportFenceWin32HandleInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkExportFenceWin32HandleInfoKHR ret = new VkExportFenceWin32HandleInfoKHR(segment.asSlice(0, VkExportFenceWin32HandleInfoKHR.BYTES));
                segment = segment.asSlice(VkExportFenceWin32HandleInfoKHR.BYTES);
                return ret;
            }
    ...
    public VkExportFenceWin32HandleInfoKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkExportFenceWin32HandleInfoKHR pNext(@Nullable IPointer pointer) {
    ...
    public VkExportFenceWin32HandleInfoKHR pAttributes(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pAttributes, OFFSET$pAttributes, value);
        return this;
    }

    public VkExportFenceWin32HandleInfoKHR pAttributes(@Nullable IPointer pointer) {
    ...
    public VkExportFenceWin32HandleInfoKHR dwAccess(@NativeType("DWORD") @Unsigned int value) {
    ...
    public VkExportFenceWin32HandleInfoKHR name(@Nullable @Unsigned ShortPtr value) {

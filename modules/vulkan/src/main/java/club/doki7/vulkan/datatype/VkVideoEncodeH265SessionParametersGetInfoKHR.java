...
///
/// The {@code allocate} ({@link VkVideoEncodeH265SessionParametersGetInfoKHR#allocate(Arena)}, {@link VkVideoEncodeH265SessionParametersGetInfoKHR#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkVideoEncodeH265SessionParametersGetInfoKHR#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkVideoEncodeH265SessionParametersGetInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH265SessionParametersGetInfoKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeH265SessionParametersGetInfoKHR.html"><code>VkVideoEncodeH265SessionParametersGetInfoKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkVideoEncodeH265SessionParametersGetInfoKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkVideoEncodeH265SessionParametersGetInfoKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkVideoEncodeH265SessionParametersGetInfoKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH265SessionParametersGetInfoKHR, Iterable<VkVideoEncodeH265SessionParametersGetInfoKHR> {
        public long size() {
        ...
        public @NotNull VkVideoEncodeH265SessionParametersGetInfoKHR at(long index) {
            return new VkVideoEncodeH265SessionParametersGetInfoKHR(segment.asSlice(index * VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES, VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES));
        }

        public VkVideoEncodeH265SessionParametersGetInfoKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkVideoEncodeH265SessionParametersGetInfoKHR> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull VkVideoEncodeH265SessionParametersGetInfoKHR value) {
            MemorySegment s = segment.asSlice(index * VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES, VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES,
                (end - start) * VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES));
        }

        public VkVideoEncodeH265SessionParametersGetInfoKHR[] toArray() {
            VkVideoEncodeH265SessionParametersGetInfoKHR[] ret = new VkVideoEncodeH265SessionParametersGetInfoKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkVideoEncodeH265SessionParametersGetInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkVideoEncodeH265SessionParametersGetInfoKHR> {
            ...
            @Override
            public VkVideoEncodeH265SessionParametersGetInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVideoEncodeH265SessionParametersGetInfoKHR ret = new VkVideoEncodeH265SessionParametersGetInfoKHR(segment.asSlice(0, VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES));
                segment = segment.asSlice(VkVideoEncodeH265SessionParametersGetInfoKHR.BYTES);
                return ret;
            }
    ...
    public static VkVideoEncodeH265SessionParametersGetInfoKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkVideoEncodeH265SessionParametersGetInfoKHR.Ptr ret = new VkVideoEncodeH265SessionParametersGetInfoKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.VIDEO_ENCODE_H265_SESSION_PARAMETERS_GET_INFO_KHR);
        }
        return ret;
    }
    ...
    public VkVideoEncodeH265SessionParametersGetInfoKHR sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkVideoEncodeH265SessionParametersGetInfoKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkVideoEncodeH265SessionParametersGetInfoKHR pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int writeStdVPS() {
        return segment.get(LAYOUT$writeStdVPS, OFFSET$writeStdVPS);
    }

    public VkVideoEncodeH265SessionParametersGetInfoKHR writeStdVPS(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public VkVideoEncodeH265SessionParametersGetInfoKHR writeStdSPS(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public VkVideoEncodeH265SessionParametersGetInfoKHR writeStdPPS(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public VkVideoEncodeH265SessionParametersGetInfoKHR stdVPSId(@Unsigned int value) {
    ...
    public VkVideoEncodeH265SessionParametersGetInfoKHR stdSPSId(@Unsigned int value) {
    ...
    public VkVideoEncodeH265SessionParametersGetInfoKHR stdPPSId(@Unsigned int value) {

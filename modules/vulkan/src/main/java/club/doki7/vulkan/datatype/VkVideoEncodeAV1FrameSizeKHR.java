...
@ValueBasedCandidate
@UnsafeConstructor
public record VkVideoEncodeAV1FrameSizeKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1FrameSizeKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeAV1FrameSizeKHR.html"><code>VkVideoEncodeAV1FrameSizeKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkVideoEncodeAV1FrameSizeKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkVideoEncodeAV1FrameSizeKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkVideoEncodeAV1FrameSizeKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1FrameSizeKHR, Iterable<VkVideoEncodeAV1FrameSizeKHR> {
        public long size() {
            return segment.byteSize() / VkVideoEncodeAV1FrameSizeKHR.BYTES;
        }
        ...
        public @NotNull VkVideoEncodeAV1FrameSizeKHR at(long index) {
        ...
        public VkVideoEncodeAV1FrameSizeKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkVideoEncodeAV1FrameSizeKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVideoEncodeAV1FrameSizeKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkVideoEncodeAV1FrameSizeKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkVideoEncodeAV1FrameSizeKHR.BYTES,
                (end - start) * VkVideoEncodeAV1FrameSizeKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkVideoEncodeAV1FrameSizeKHR.BYTES));
        }

        public VkVideoEncodeAV1FrameSizeKHR[] toArray() {
            VkVideoEncodeAV1FrameSizeKHR[] ret = new VkVideoEncodeAV1FrameSizeKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkVideoEncodeAV1FrameSizeKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkVideoEncodeAV1FrameSizeKHR> {
            ...
            @Override
            public VkVideoEncodeAV1FrameSizeKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVideoEncodeAV1FrameSizeKHR ret = new VkVideoEncodeAV1FrameSizeKHR(segment.asSlice(0, VkVideoEncodeAV1FrameSizeKHR.BYTES));
                segment = segment.asSlice(VkVideoEncodeAV1FrameSizeKHR.BYTES);
                return ret;
            }

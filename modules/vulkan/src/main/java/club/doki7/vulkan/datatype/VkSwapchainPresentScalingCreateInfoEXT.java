...
public record VkSwapchainPresentScalingCreateInfoEXT(@NotNull MemorySegment segment) implements IVkSwapchainPresentScalingCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSwapchainPresentScalingCreateInfoEXT, Iterable<VkSwapchainPresentScalingCreateInfoEXT> {
        ...
        public VkSwapchainPresentScalingCreateInfoEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkSwapchainPresentScalingCreateInfoEXT> consumer) {
        ...
        @Override
        public @NotNull Iterator<VkSwapchainPresentScalingCreateInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSwapchainPresentScalingCreateInfoEXT> {
    ...
    public VkSwapchainPresentScalingCreateInfoEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

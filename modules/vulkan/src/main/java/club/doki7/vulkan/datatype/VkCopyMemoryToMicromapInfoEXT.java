...
public record VkCopyMemoryToMicromapInfoEXT(@NotNull MemorySegment segment) implements IVkCopyMemoryToMicromapInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyMemoryToMicromapInfoEXT, Iterable<VkCopyMemoryToMicromapInfoEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkCopyMemoryToMicromapInfoEXT.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkCopyMemoryToMicromapInfoEXT> {
            ...
            @Override
            public VkCopyMemoryToMicromapInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkCopyMemoryToMicromapInfoEXT ret = new VkCopyMemoryToMicromapInfoEXT(segment.asSlice(0, VkCopyMemoryToMicromapInfoEXT.BYTES));
                segment = segment.asSlice(VkCopyMemoryToMicromapInfoEXT.BYTES);
                return ret;
            }
    ...
    public VkCopyMemoryToMicromapInfoEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkCopyMemoryToMicromapInfoEXT pNext(@Nullable IPointer pointer) {
    ...
    public VkCopyMemoryToMicromapInfoEXT src(@NotNull VkDeviceOrHostAddressConstKHR value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$src, SIZE$src);
        return this;
    }

    public VkCopyMemoryToMicromapInfoEXT src(Consumer<@NotNull VkDeviceOrHostAddressConstKHR> consumer) {
        consumer.accept(src());
        return this;
    }
    ...
    public VkCopyMemoryToMicromapInfoEXT dst(@Nullable VkMicromapEXT value) {

...
public record VkImportMetalTextureInfoEXT(@NotNull MemorySegment segment) implements IVkImportMetalTextureInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportMetalTextureInfoEXT, Iterable<VkImportMetalTextureInfoEXT> {
        public long size() {
        ...
        public VkImportMetalTextureInfoEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkImportMetalTextureInfoEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkImportMetalTextureInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkImportMetalTextureInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkImportMetalTextureInfoEXT.BYTES,
                (end - start) * VkImportMetalTextureInfoEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkImportMetalTextureInfoEXT.BYTES));
        }

        public VkImportMetalTextureInfoEXT[] toArray() {
            VkImportMetalTextureInfoEXT[] ret = new VkImportMetalTextureInfoEXT[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkImportMetalTextureInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkImportMetalTextureInfoEXT> {
            ...
            @Override
            public VkImportMetalTextureInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkImportMetalTextureInfoEXT ret = new VkImportMetalTextureInfoEXT(segment.asSlice(0, VkImportMetalTextureInfoEXT.BYTES));
                segment = segment.asSlice(VkImportMetalTextureInfoEXT.BYTES);
                return ret;
            }
    ...
    public VkImportMetalTextureInfoEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
    ...
    public VkImportMetalTextureInfoEXT mtlTexture(@Pointer(comment="MTLTexture_id") @NotNull MemorySegment value) {

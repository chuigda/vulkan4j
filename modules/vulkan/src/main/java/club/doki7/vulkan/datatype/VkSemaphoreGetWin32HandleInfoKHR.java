...
public record VkSemaphoreGetWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IVkSemaphoreGetWin32HandleInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSemaphoreGetWin32HandleInfoKHR, Iterable<VkSemaphoreGetWin32HandleInfoKHR> {
        ...
        @Override
        public @NotNull Iterator<VkSemaphoreGetWin32HandleInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSemaphoreGetWin32HandleInfoKHR> {
    ...
    public VkSemaphoreGetWin32HandleInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkSemaphoreGetWin32HandleInfoKHR handleType(@MagicConstant(valuesFromClass = VkExternalSemaphoreHandleTypeFlags.class) int value) {

...
///
/// The {@code allocate} ({@link VkQueryLowLatencySupportNV#allocate(Arena)}, {@link VkQueryLowLatencySupportNV#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkQueryLowLatencySupportNV(@NotNull MemorySegment segment) implements IVkQueryLowLatencySupportNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkQueryLowLatencySupportNV.html"><code>VkQueryLowLatencySupportNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkQueryLowLatencySupportNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkQueryLowLatencySupportNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkQueryLowLatencySupportNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkQueryLowLatencySupportNV, Iterable<VkQueryLowLatencySupportNV> {
        public long size() {
            return segment.byteSize() / VkQueryLowLatencySupportNV.BYTES;
        }
        ...
        public @NotNull VkQueryLowLatencySupportNV at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkQueryLowLatencySupportNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkQueryLowLatencySupportNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkQueryLowLatencySupportNV.BYTES,
                (end - start) * VkQueryLowLatencySupportNV.BYTES
            ));
        }
        ...
        private static final class Iter implements Iterator<VkQueryLowLatencySupportNV> {
            ...
            @Override
            public VkQueryLowLatencySupportNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkQueryLowLatencySupportNV ret = new VkQueryLowLatencySupportNV(segment.asSlice(0, VkQueryLowLatencySupportNV.BYTES));
                segment = segment.asSlice(VkQueryLowLatencySupportNV.BYTES);
                return ret;
            }
    ...
    public static VkQueryLowLatencySupportNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkQueryLowLatencySupportNV.Ptr ret = new VkQueryLowLatencySupportNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.QUERY_LOW_LATENCY_SUPPORT_NV);
        }
        return ret;
    }
    ...
    public VkQueryLowLatencySupportNV sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

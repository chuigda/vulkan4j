...
///
/// The {@code allocate} ({@link VkPipelineShaderStageRequiredSubgroupSizeCreateInfo#allocate(Arena)}, {@link VkPipelineShaderStageRequiredSubgroupSizeCreateInfo#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPipelineShaderStageRequiredSubgroupSizeCreateInfo(@NotNull MemorySegment segment) implements IVkPipelineShaderStageRequiredSubgroupSizeCreateInfo {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.html"><code>VkPipelineShaderStageRequiredSubgroupSizeCreateInfo</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPipelineShaderStageRequiredSubgroupSizeCreateInfo}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPipelineShaderStageRequiredSubgroupSizeCreateInfo to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineShaderStageRequiredSubgroupSizeCreateInfo, Iterable<VkPipelineShaderStageRequiredSubgroupSizeCreateInfo> {
        public long size() {
            return segment.byteSize() / VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.BYTES;
        }
        ...
        public @NotNull VkPipelineShaderStageRequiredSubgroupSizeCreateInfo at(long index) {
        ...
        public void write(long index, @NotNull VkPipelineShaderStageRequiredSubgroupSizeCreateInfo value) {
            MemorySegment s = segment.asSlice(index * VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.BYTES, VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.BYTES);
        ...
        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.BYTES,
                (end - start) * VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkPipelineShaderStageRequiredSubgroupSizeCreateInfo> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPipelineShaderStageRequiredSubgroupSizeCreateInfo> {
            ...
            @Override
            public VkPipelineShaderStageRequiredSubgroupSizeCreateInfo next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPipelineShaderStageRequiredSubgroupSizeCreateInfo ret = new VkPipelineShaderStageRequiredSubgroupSizeCreateInfo(segment.asSlice(0, VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.BYTES));
                segment = segment.asSlice(VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.BYTES);
                return ret;
            }
    ...
    public static VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.Ptr ret = new VkPipelineShaderStageRequiredSubgroupSizeCreateInfo.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO);
        }
        return ret;
    }
    ...
    public VkPipelineShaderStageRequiredSubgroupSizeCreateInfo pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPipelineShaderStageRequiredSubgroupSizeCreateInfo pNext(@Nullable IPointer pointer) {
    ...
    public VkPipelineShaderStageRequiredSubgroupSizeCreateInfo requiredSubgroupSize(@Unsigned int value) {

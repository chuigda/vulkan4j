...
public record VkDescriptorPoolCreateInfo(@NotNull MemorySegment segment) implements IVkDescriptorPoolCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDescriptorPoolCreateInfo, Iterable<VkDescriptorPoolCreateInfo> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkDescriptorPoolCreateInfo.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkDescriptorPoolCreateInfo> {
            ...
            @Override
            public VkDescriptorPoolCreateInfo next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkDescriptorPoolCreateInfo ret = new VkDescriptorPoolCreateInfo(segment.asSlice(0, VkDescriptorPoolCreateInfo.BYTES));
                segment = segment.asSlice(VkDescriptorPoolCreateInfo.BYTES);
                return ret;
            }
    ...
    public VkDescriptorPoolCreateInfo sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public @MagicConstant(valuesFromClass = VkDescriptorPoolCreateFlags.class) int flags() {
        return segment.get(LAYOUT$flags, OFFSET$flags);
    }

    public VkDescriptorPoolCreateInfo flags(@MagicConstant(valuesFromClass = VkDescriptorPoolCreateFlags.class) int value) {

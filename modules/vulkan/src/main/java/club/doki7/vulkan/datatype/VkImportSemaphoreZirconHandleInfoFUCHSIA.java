...
public record VkImportSemaphoreZirconHandleInfoFUCHSIA(@NotNull MemorySegment segment) implements IVkImportSemaphoreZirconHandleInfoFUCHSIA {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportSemaphoreZirconHandleInfoFUCHSIA, Iterable<VkImportSemaphoreZirconHandleInfoFUCHSIA> {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkImportSemaphoreZirconHandleInfoFUCHSIA.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkImportSemaphoreZirconHandleInfoFUCHSIA> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkImportSemaphoreZirconHandleInfoFUCHSIA> {

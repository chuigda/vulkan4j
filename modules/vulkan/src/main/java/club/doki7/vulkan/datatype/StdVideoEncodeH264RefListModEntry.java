...
public record StdVideoEncodeH264RefListModEntry(@NotNull MemorySegment segment) implements IStdVideoEncodeH264RefListModEntry {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeH264RefListModEntry, Iterable<StdVideoEncodeH264RefListModEntry> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull StdVideoEncodeH264RefListModEntry> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * StdVideoEncodeH264RefListModEntry.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<StdVideoEncodeH264RefListModEntry> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoEncodeH264RefListModEntry> {
            ...
            @Override
            public StdVideoEncodeH264RefListModEntry next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                StdVideoEncodeH264RefListModEntry ret = new StdVideoEncodeH264RefListModEntry(segment.asSlice(0, StdVideoEncodeH264RefListModEntry.BYTES));
                segment = segment.asSlice(StdVideoEncodeH264RefListModEntry.BYTES);
                return ret;
            }

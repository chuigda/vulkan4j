...
public record VkPushDescriptorSetInfo(@NotNull MemorySegment segment) implements IVkPushDescriptorSetInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPushDescriptorSetInfo, Iterable<VkPushDescriptorSetInfo> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPushDescriptorSetInfo> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPushDescriptorSetInfo.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkPushDescriptorSetInfo> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPushDescriptorSetInfo> {
            ...
            @Override
            public VkPushDescriptorSetInfo next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPushDescriptorSetInfo ret = new VkPushDescriptorSetInfo(segment.asSlice(0, VkPushDescriptorSetInfo.BYTES));
                segment = segment.asSlice(VkPushDescriptorSetInfo.BYTES);
                return ret;
            }

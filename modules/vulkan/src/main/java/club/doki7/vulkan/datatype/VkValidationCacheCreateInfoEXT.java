...
public record VkValidationCacheCreateInfoEXT(@NotNull MemorySegment segment) implements IVkValidationCacheCreateInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkValidationCacheCreateInfoEXT, Iterable<VkValidationCacheCreateInfoEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkValidationCacheCreateInfoEXT.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkValidationCacheCreateInfoEXT> {
            ...
            @Override
            public VkValidationCacheCreateInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkValidationCacheCreateInfoEXT ret = new VkValidationCacheCreateInfoEXT(segment.asSlice(0, VkValidationCacheCreateInfoEXT.BYTES));
                segment = segment.asSlice(VkValidationCacheCreateInfoEXT.BYTES);
                return ret;
            }

...
public record VkVideoEncodeAV1QIndexKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1QIndexKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1QIndexKHR, Iterable<VkVideoEncodeAV1QIndexKHR> {
        public long size() {
        ...
        public VkVideoEncodeAV1QIndexKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkVideoEncodeAV1QIndexKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVideoEncodeAV1QIndexKHR.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkVideoEncodeAV1QIndexKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkVideoEncodeAV1QIndexKHR> {
            ...
            @Override
            public VkVideoEncodeAV1QIndexKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVideoEncodeAV1QIndexKHR ret = new VkVideoEncodeAV1QIndexKHR(segment.asSlice(0, VkVideoEncodeAV1QIndexKHR.BYTES));
                segment = segment.asSlice(VkVideoEncodeAV1QIndexKHR.BYTES);
                return ret;
            }

...
public record VkPhysicalDevicePresentBarrierFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDevicePresentBarrierFeaturesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePresentBarrierFeaturesNV, Iterable<VkPhysicalDevicePresentBarrierFeaturesNV> {
        ...
        public VkPhysicalDevicePresentBarrierFeaturesNV.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDevicePresentBarrierFeaturesNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDevicePresentBarrierFeaturesNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDevicePresentBarrierFeaturesNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDevicePresentBarrierFeaturesNV.BYTES,
                (end - start) * VkPhysicalDevicePresentBarrierFeaturesNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDevicePresentBarrierFeaturesNV.BYTES));
        }

        public VkPhysicalDevicePresentBarrierFeaturesNV[] toArray() {
            VkPhysicalDevicePresentBarrierFeaturesNV[] ret = new VkPhysicalDevicePresentBarrierFeaturesNV[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDevicePresentBarrierFeaturesNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDevicePresentBarrierFeaturesNV> {
    ...
    public VkPhysicalDevicePresentBarrierFeaturesNV sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDevicePresentBarrierFeaturesNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDevicePresentBarrierFeaturesNV pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int presentBarrier() {
        return segment.get(LAYOUT$presentBarrier, OFFSET$presentBarrier);
    }

    public VkPhysicalDevicePresentBarrierFeaturesNV presentBarrier(@NativeType("VkBool32") @Unsigned int value) {

...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSwapchainKHR.html"><code>VkSwapchainKHR</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSwapchainKHR.html"><code>VkSwapchainKHR</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkSwapchainKHR(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSwapchainKHR.html"><code>VkSwapchainKHR</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkSwapchainKHR> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkSwapchainKHR read() {
        ...
        public void write(@Nullable VkSwapchainKHR value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkSwapchainKHR read(long index) {
        ...
        public void write(long index, @Nullable VkSwapchainKHR value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkSwapchainKHR[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkSwapchainKHR value0, @Nullable VkSwapchainKHR ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkSwapchainKHR @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkSwapchainKHR> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkSwapchainKHR value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkSwapchainKHR value0, @Nullable VkSwapchainKHR ...values) {
        ...
        @Override
        public @NotNull Iterator<VkSwapchainKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkSwapchainKHR> {

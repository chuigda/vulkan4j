...
public record VkPhysicalDeviceAntiLagFeaturesAMD(@NotNull MemorySegment segment) implements IVkPhysicalDeviceAntiLagFeaturesAMD {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceAntiLagFeaturesAMD, Iterable<VkPhysicalDeviceAntiLagFeaturesAMD> {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceAntiLagFeaturesAMD.BYTES));
        }
    ...
    public VkPhysicalDeviceAntiLagFeaturesAMD pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceAntiLagFeaturesAMD pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int antiLag() {
        return segment.get(LAYOUT$antiLag, OFFSET$antiLag);
    }

    public VkPhysicalDeviceAntiLagFeaturesAMD antiLag(@NativeType("VkBool32") @Unsigned int value) {

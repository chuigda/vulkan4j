...
public record VkPhysicalDeviceVideoMaintenance2FeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVideoMaintenance2FeaturesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVideoMaintenance2FeaturesKHR, Iterable<VkPhysicalDeviceVideoMaintenance2FeaturesKHR> {
        public long size() {
        ...
        public VkPhysicalDeviceVideoMaintenance2FeaturesKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceVideoMaintenance2FeaturesKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceVideoMaintenance2FeaturesKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceVideoMaintenance2FeaturesKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceVideoMaintenance2FeaturesKHR.BYTES,
                (end - start) * VkPhysicalDeviceVideoMaintenance2FeaturesKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceVideoMaintenance2FeaturesKHR.BYTES));
        }

        public VkPhysicalDeviceVideoMaintenance2FeaturesKHR[] toArray() {
            VkPhysicalDeviceVideoMaintenance2FeaturesKHR[] ret = new VkPhysicalDeviceVideoMaintenance2FeaturesKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceVideoMaintenance2FeaturesKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceVideoMaintenance2FeaturesKHR> {
            ...
            @Override
            public VkPhysicalDeviceVideoMaintenance2FeaturesKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceVideoMaintenance2FeaturesKHR ret = new VkPhysicalDeviceVideoMaintenance2FeaturesKHR(segment.asSlice(0, VkPhysicalDeviceVideoMaintenance2FeaturesKHR.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceVideoMaintenance2FeaturesKHR.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceVideoMaintenance2FeaturesKHR sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceVideoMaintenance2FeaturesKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceVideoMaintenance2FeaturesKHR pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int videoMaintenance2() {
        return segment.get(LAYOUT$videoMaintenance2, OFFSET$videoMaintenance2);
    }

    public VkPhysicalDeviceVideoMaintenance2FeaturesKHR videoMaintenance2(@NativeType("VkBool32") @Unsigned int value) {

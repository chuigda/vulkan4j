...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDescriptorSet.html"><code>VkDescriptorSet</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDescriptorSet.html"><code>VkDescriptorSet</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkDescriptorSet(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDescriptorSet.html"><code>VkDescriptorSet</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkDescriptorSet> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkDescriptorSet read() {
        ...
        public void write(@Nullable VkDescriptorSet value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkDescriptorSet read(long index) {
        ...
        public void write(long index, @Nullable VkDescriptorSet value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkDescriptorSet[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkDescriptorSet value0, @Nullable VkDescriptorSet ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkDescriptorSet @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkDescriptorSet> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkDescriptorSet value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkDescriptorSet value0, @Nullable VkDescriptorSet ...values) {
        ...
        @Override
        public @NotNull Iterator<VkDescriptorSet> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkDescriptorSet> {

...
public record VkIndirectExecutionSetShaderInfoEXT(@NotNull MemorySegment segment) implements IVkIndirectExecutionSetShaderInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkIndirectExecutionSetShaderInfoEXT, Iterable<VkIndirectExecutionSetShaderInfoEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkIndirectExecutionSetShaderInfoEXT.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkIndirectExecutionSetShaderInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkIndirectExecutionSetShaderInfoEXT> {
            ...
            @Override
            public VkIndirectExecutionSetShaderInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkIndirectExecutionSetShaderInfoEXT ret = new VkIndirectExecutionSetShaderInfoEXT(segment.asSlice(0, VkIndirectExecutionSetShaderInfoEXT.BYTES));
                segment = segment.asSlice(VkIndirectExecutionSetShaderInfoEXT.BYTES);
                return ret;
            }
    ...
    public VkIndirectExecutionSetShaderInfoEXT sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkIndirectExecutionSetShaderInfoEXT shaderCount(@Unsigned int value) {
    ...
    public VkIndirectExecutionSetShaderInfoEXT pInitialShaders(@Nullable VkShaderEXT.Ptr value) {
    ...
    public VkIndirectExecutionSetShaderInfoEXT pSetLayoutInfos(@Nullable IVkIndirectExecutionSetShaderLayoutInfoEXT value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
    ...
    public VkIndirectExecutionSetShaderInfoEXT maxShaderCount(@Unsigned int value) {
    ...
    public VkIndirectExecutionSetShaderInfoEXT pushConstantRangeCount(@Unsigned int value) {
        segment.set(LAYOUT$pushConstantRangeCount, OFFSET$pushConstantRangeCount, value);
        return this;
    }

    public VkIndirectExecutionSetShaderInfoEXT pPushConstantRanges(@Nullable IVkPushConstantRange value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();

...
public record VkSamplerBlockMatchWindowCreateInfoQCOM(@NotNull MemorySegment segment) implements IVkSamplerBlockMatchWindowCreateInfoQCOM {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSamplerBlockMatchWindowCreateInfoQCOM, Iterable<VkSamplerBlockMatchWindowCreateInfoQCOM> {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSamplerBlockMatchWindowCreateInfoQCOM.BYTES));
        }
    ...
    public VkSamplerBlockMatchWindowCreateInfoQCOM pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

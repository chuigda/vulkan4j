...
public record VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR, Iterable<VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.BYTES,
                (end - start) * VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.BYTES));
        }

        public VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR[] toArray() {
            VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR[] ret = new VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR> {
            ...
            @Override
            public VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR ret = new VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR(segment.asSlice(0, VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.BYTES));
                segment = segment.asSlice(VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int pipelineExecutableInfo() {
        return segment.get(LAYOUT$pipelineExecutableInfo, OFFSET$pipelineExecutableInfo);
    }

    public VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR pipelineExecutableInfo(@NativeType("VkBool32") @Unsigned int value) {

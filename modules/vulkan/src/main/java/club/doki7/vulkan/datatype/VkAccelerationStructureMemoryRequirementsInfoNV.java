...
public record VkAccelerationStructureMemoryRequirementsInfoNV(@NotNull MemorySegment segment) implements IVkAccelerationStructureMemoryRequirementsInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureMemoryRequirementsInfoNV, Iterable<VkAccelerationStructureMemoryRequirementsInfoNV> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkAccelerationStructureMemoryRequirementsInfoNV.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkAccelerationStructureMemoryRequirementsInfoNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkAccelerationStructureMemoryRequirementsInfoNV> {
            ...
            @Override
            public VkAccelerationStructureMemoryRequirementsInfoNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkAccelerationStructureMemoryRequirementsInfoNV ret = new VkAccelerationStructureMemoryRequirementsInfoNV(segment.asSlice(0, VkAccelerationStructureMemoryRequirementsInfoNV.BYTES));
                segment = segment.asSlice(VkAccelerationStructureMemoryRequirementsInfoNV.BYTES);
                return ret;
            }
    ...
    public VkAccelerationStructureMemoryRequirementsInfoNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

...
public record VkImportMemoryBufferCollectionFUCHSIA(@NotNull MemorySegment segment) implements IVkImportMemoryBufferCollectionFUCHSIA {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportMemoryBufferCollectionFUCHSIA, Iterable<VkImportMemoryBufferCollectionFUCHSIA> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkImportMemoryBufferCollectionFUCHSIA> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkImportMemoryBufferCollectionFUCHSIA.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkImportMemoryBufferCollectionFUCHSIA> {
            ...
            @Override
            public VkImportMemoryBufferCollectionFUCHSIA next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkImportMemoryBufferCollectionFUCHSIA ret = new VkImportMemoryBufferCollectionFUCHSIA(segment.asSlice(0, VkImportMemoryBufferCollectionFUCHSIA.BYTES));
                segment = segment.asSlice(VkImportMemoryBufferCollectionFUCHSIA.BYTES);
                return ret;
            }
    ...
    public VkImportMemoryBufferCollectionFUCHSIA sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkImportMemoryBufferCollectionFUCHSIA collection(@Nullable VkBufferCollectionFUCHSIA value) {
    ...
    public VkImportMemoryBufferCollectionFUCHSIA index(@Unsigned int value) {

...
/// Represents a pointer to a <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures.html"><code>VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
public record VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderDemoteToHelperInvocationFeatures {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderDemoteToHelperInvocationFeatures, Iterable<VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures> {
            ...
            @Override
            public VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures ret = new VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures(segment.asSlice(0, VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures shaderDemoteToHelperInvocation(@NativeType("VkBool32") @Unsigned int value) {

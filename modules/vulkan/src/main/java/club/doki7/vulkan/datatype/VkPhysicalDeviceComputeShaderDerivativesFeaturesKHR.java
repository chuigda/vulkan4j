...
public record VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceComputeShaderDerivativesFeaturesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceComputeShaderDerivativesFeaturesKHR, Iterable<VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR> {
        public long size() {
        ...
        public VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR> {
            ...
            @Override
            public VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR ret = new VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR(segment.asSlice(0, VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int computeDerivativeGroupQuads() {
        return segment.get(LAYOUT$computeDerivativeGroupQuads, OFFSET$computeDerivativeGroupQuads);
    }

    public VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR computeDerivativeGroupQuads(@NativeType("VkBool32") @Unsigned int value) {
        segment.set(LAYOUT$computeDerivativeGroupQuads, OFFSET$computeDerivativeGroupQuads, value);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int computeDerivativeGroupLinear() {
        return segment.get(LAYOUT$computeDerivativeGroupLinear, OFFSET$computeDerivativeGroupLinear);
    }

    public VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR computeDerivativeGroupLinear(@NativeType("VkBool32") @Unsigned int value) {

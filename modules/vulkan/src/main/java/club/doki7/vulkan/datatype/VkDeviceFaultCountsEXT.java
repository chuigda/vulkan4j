...
public record VkDeviceFaultCountsEXT(@NotNull MemorySegment segment) implements IVkDeviceFaultCountsEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDeviceFaultCountsEXT, Iterable<VkDeviceFaultCountsEXT> {
        public long size() {
        ...
        public VkDeviceFaultCountsEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkDeviceFaultCountsEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkDeviceFaultCountsEXT.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkDeviceFaultCountsEXT> {
            ...
            @Override
            public VkDeviceFaultCountsEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkDeviceFaultCountsEXT ret = new VkDeviceFaultCountsEXT(segment.asSlice(0, VkDeviceFaultCountsEXT.BYTES));
                segment = segment.asSlice(VkDeviceFaultCountsEXT.BYTES);
                return ret;
            }
    ...
    public VkDeviceFaultCountsEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

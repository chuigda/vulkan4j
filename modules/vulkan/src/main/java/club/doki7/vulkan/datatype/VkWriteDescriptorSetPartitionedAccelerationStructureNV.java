...
///
/// The {@code allocate} ({@link VkWriteDescriptorSetPartitionedAccelerationStructureNV#allocate(Arena)}, {@link VkWriteDescriptorSetPartitionedAccelerationStructureNV#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkWriteDescriptorSetPartitionedAccelerationStructureNV(@NotNull MemorySegment segment) implements IVkWriteDescriptorSetPartitionedAccelerationStructureNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkWriteDescriptorSetPartitionedAccelerationStructureNV.html"><code>VkWriteDescriptorSetPartitionedAccelerationStructureNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkWriteDescriptorSetPartitionedAccelerationStructureNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkWriteDescriptorSetPartitionedAccelerationStructureNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkWriteDescriptorSetPartitionedAccelerationStructureNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkWriteDescriptorSetPartitionedAccelerationStructureNV, Iterable<VkWriteDescriptorSetPartitionedAccelerationStructureNV> {
        public long size() {
            return segment.byteSize() / VkWriteDescriptorSetPartitionedAccelerationStructureNV.BYTES;
        }
        ...
        public @NotNull VkWriteDescriptorSetPartitionedAccelerationStructureNV at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkWriteDescriptorSetPartitionedAccelerationStructureNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkWriteDescriptorSetPartitionedAccelerationStructureNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkWriteDescriptorSetPartitionedAccelerationStructureNV.BYTES,
                (end - start) * VkWriteDescriptorSetPartitionedAccelerationStructureNV.BYTES
            ));
        }
        ...
        private static final class Iter implements Iterator<VkWriteDescriptorSetPartitionedAccelerationStructureNV> {
            ...
            @Override
            public VkWriteDescriptorSetPartitionedAccelerationStructureNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkWriteDescriptorSetPartitionedAccelerationStructureNV ret = new VkWriteDescriptorSetPartitionedAccelerationStructureNV(segment.asSlice(0, VkWriteDescriptorSetPartitionedAccelerationStructureNV.BYTES));
                segment = segment.asSlice(VkWriteDescriptorSetPartitionedAccelerationStructureNV.BYTES);
                return ret;
            }
    ...
    public static VkWriteDescriptorSetPartitionedAccelerationStructureNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkWriteDescriptorSetPartitionedAccelerationStructureNV.Ptr ret = new VkWriteDescriptorSetPartitionedAccelerationStructureNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.WRITE_DESCRIPTOR_SET_PARTITIONED_ACCELERATION_STRUCTURE_NV);
        }
        return ret;
    }
    ...
    public VkWriteDescriptorSetPartitionedAccelerationStructureNV sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

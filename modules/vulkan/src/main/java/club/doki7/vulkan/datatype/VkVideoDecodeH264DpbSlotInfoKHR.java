...
public record VkVideoDecodeH264DpbSlotInfoKHR(@NotNull MemorySegment segment) implements IVkVideoDecodeH264DpbSlotInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoDecodeH264DpbSlotInfoKHR, Iterable<VkVideoDecodeH264DpbSlotInfoKHR> {
        public long size() {
        ...
        public VkVideoDecodeH264DpbSlotInfoKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkVideoDecodeH264DpbSlotInfoKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVideoDecodeH264DpbSlotInfoKHR.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkVideoDecodeH264DpbSlotInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkVideoDecodeH264DpbSlotInfoKHR> {
            ...
            @Override
            public VkVideoDecodeH264DpbSlotInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVideoDecodeH264DpbSlotInfoKHR ret = new VkVideoDecodeH264DpbSlotInfoKHR(segment.asSlice(0, VkVideoDecodeH264DpbSlotInfoKHR.BYTES));
                segment = segment.asSlice(VkVideoDecodeH264DpbSlotInfoKHR.BYTES);
                return ret;
            }
    ...
    public VkVideoDecodeH264DpbSlotInfoKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkVideoDecodeH264DpbSlotInfoKHR pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public VkVideoDecodeH264DpbSlotInfoKHR pStdReferenceInfo(@Nullable IStdVideoDecodeH264ReferenceInfo value) {
    ...
    public @Pointer(target=StdVideoDecodeH264ReferenceInfo.class) @NotNull MemorySegment pStdReferenceInfoRaw() {
        return segment.get(LAYOUT$pStdReferenceInfo, OFFSET$pStdReferenceInfo);
    }

    public void pStdReferenceInfoRaw(@Pointer(target=StdVideoDecodeH264ReferenceInfo.class) @NotNull MemorySegment value) {

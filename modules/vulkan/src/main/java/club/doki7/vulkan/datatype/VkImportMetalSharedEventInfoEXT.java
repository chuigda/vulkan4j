...
///
/// The {@code allocate} ({@link VkImportMetalSharedEventInfoEXT#allocate(Arena)}, {@link VkImportMetalSharedEventInfoEXT#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkImportMetalSharedEventInfoEXT#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkImportMetalSharedEventInfoEXT(@NotNull MemorySegment segment) implements IVkImportMetalSharedEventInfoEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkImportMetalSharedEventInfoEXT.html"><code>VkImportMetalSharedEventInfoEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkImportMetalSharedEventInfoEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkImportMetalSharedEventInfoEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkImportMetalSharedEventInfoEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportMetalSharedEventInfoEXT, Iterable<VkImportMetalSharedEventInfoEXT> {
        public long size() {
            return segment.byteSize() / VkImportMetalSharedEventInfoEXT.BYTES;
        }
        ...
        public @NotNull VkImportMetalSharedEventInfoEXT at(long index) {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkImportMetalSharedEventInfoEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkImportMetalSharedEventInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkImportMetalSharedEventInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkImportMetalSharedEventInfoEXT.BYTES,
                (end - start) * VkImportMetalSharedEventInfoEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkImportMetalSharedEventInfoEXT.BYTES));
        }

        public VkImportMetalSharedEventInfoEXT[] toArray() {
            VkImportMetalSharedEventInfoEXT[] ret = new VkImportMetalSharedEventInfoEXT[(int) size()];
        ...
        private static final class Iter implements Iterator<VkImportMetalSharedEventInfoEXT> {
            ...
            @Override
            public VkImportMetalSharedEventInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkImportMetalSharedEventInfoEXT ret = new VkImportMetalSharedEventInfoEXT(segment.asSlice(0, VkImportMetalSharedEventInfoEXT.BYTES));
                segment = segment.asSlice(VkImportMetalSharedEventInfoEXT.BYTES);
                return ret;
            }
    ...
    public static VkImportMetalSharedEventInfoEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkImportMetalSharedEventInfoEXT.Ptr ret = new VkImportMetalSharedEventInfoEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.IMPORT_METAL_SHARED_EVENT_INFO_EXT);
        }
        return ret;
    }
    ...
    public VkImportMetalSharedEventInfoEXT sType(@EnumType(VkStructureType.class) int value) {

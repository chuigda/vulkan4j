...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkOpticalFlowSessionNV.html"><code>VkOpticalFlowSessionNV</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkOpticalFlowSessionNV.html"><code>VkOpticalFlowSessionNV</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkOpticalFlowSessionNV(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkOpticalFlowSessionNV.html"><code>VkOpticalFlowSessionNV</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkOpticalFlowSessionNV> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkOpticalFlowSessionNV read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new VkOpticalFlowSessionNV(s);
        }

        public void write(@Nullable VkOpticalFlowSessionNV value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkOpticalFlowSessionNV read(long index) {
        ...
        public void write(long index, @Nullable VkOpticalFlowSessionNV value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkOpticalFlowSessionNV[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkOpticalFlowSessionNV value0, @Nullable VkOpticalFlowSessionNV ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkOpticalFlowSessionNV @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkOpticalFlowSessionNV> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkOpticalFlowSessionNV value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkOpticalFlowSessionNV value0, @Nullable VkOpticalFlowSessionNV ...values) {
        ...
        private static class Iter implements Iterator<VkOpticalFlowSessionNV> {
            ...
            @Override
            public @Nullable VkOpticalFlowSessionNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new VkOpticalFlowSessionNV(s);
            }

...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceLayeredApiVulkanPropertiesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLayeredApiVulkanPropertiesKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.html"><code>VkPhysicalDeviceLayeredApiVulkanPropertiesKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceLayeredApiVulkanPropertiesKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceLayeredApiVulkanPropertiesKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLayeredApiVulkanPropertiesKHR, Iterable<VkPhysicalDeviceLayeredApiVulkanPropertiesKHR> {
        public long size() {
            return segment.byteSize() / VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.BYTES;
        }
        ...
        public @NotNull VkPhysicalDeviceLayeredApiVulkanPropertiesKHR at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.BYTES,
                (end - start) * VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceLayeredApiVulkanPropertiesKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceLayeredApiVulkanPropertiesKHR> {
            ...
            @Override
            public VkPhysicalDeviceLayeredApiVulkanPropertiesKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceLayeredApiVulkanPropertiesKHR ret = new VkPhysicalDeviceLayeredApiVulkanPropertiesKHR(segment.asSlice(0, VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.BYTES);
                return ret;
            }
    ...
    public static VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.Ptr allocate(Arena arena, long count) {
    ...
    public VkPhysicalDeviceLayeredApiVulkanPropertiesKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceLayeredApiVulkanPropertiesKHR properties(@NotNull VkPhysicalDeviceProperties2 value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$properties, SIZE$properties);
        return this;
    }

    public VkPhysicalDeviceLayeredApiVulkanPropertiesKHR properties(Consumer<@NotNull VkPhysicalDeviceProperties2> consumer) {

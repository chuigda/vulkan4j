...
public record VkSemaphoreGetFdInfoKHR(@NotNull MemorySegment segment) implements IVkSemaphoreGetFdInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSemaphoreGetFdInfoKHR, Iterable<VkSemaphoreGetFdInfoKHR> {
        public long size() {
        ...
        public VkSemaphoreGetFdInfoKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkSemaphoreGetFdInfoKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSemaphoreGetFdInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkSemaphoreGetFdInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkSemaphoreGetFdInfoKHR.BYTES,
                (end - start) * VkSemaphoreGetFdInfoKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkSemaphoreGetFdInfoKHR.BYTES));
        }

        public VkSemaphoreGetFdInfoKHR[] toArray() {
            VkSemaphoreGetFdInfoKHR[] ret = new VkSemaphoreGetFdInfoKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkSemaphoreGetFdInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSemaphoreGetFdInfoKHR> {
            ...
            @Override
            public VkSemaphoreGetFdInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkSemaphoreGetFdInfoKHR ret = new VkSemaphoreGetFdInfoKHR(segment.asSlice(0, VkSemaphoreGetFdInfoKHR.BYTES));
                segment = segment.asSlice(VkSemaphoreGetFdInfoKHR.BYTES);
                return ret;
            }
    ...
    public VkSemaphoreGetFdInfoKHR sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkSemaphoreGetFdInfoKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkSemaphoreGetFdInfoKHR pNext(@Nullable IPointer pointer) {
    ...
    public VkSemaphoreGetFdInfoKHR semaphore(@Nullable VkSemaphore value) {

...
public record VkSemaphoreGetFdInfoKHR(@NotNull MemorySegment segment) implements IVkSemaphoreGetFdInfoKHR {
    ...
    public VkSemaphoreGetFdInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkSemaphoreGetFdInfoKHR handleType(@MagicConstant(valuesFromClass = VkExternalSemaphoreHandleTypeFlags.class) int value) {

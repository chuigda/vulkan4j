...
public record VkPhysicalDeviceImageViewMinLodFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageViewMinLodFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageViewMinLodFeaturesEXT, Iterable<VkPhysicalDeviceImageViewMinLodFeaturesEXT> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceImageViewMinLodFeaturesEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceImageViewMinLodFeaturesEXT.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceImageViewMinLodFeaturesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceImageViewMinLodFeaturesEXT> {
            ...
            @Override
            public VkPhysicalDeviceImageViewMinLodFeaturesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceImageViewMinLodFeaturesEXT ret = new VkPhysicalDeviceImageViewMinLodFeaturesEXT(segment.asSlice(0, VkPhysicalDeviceImageViewMinLodFeaturesEXT.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceImageViewMinLodFeaturesEXT.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceImageViewMinLodFeaturesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceImageViewMinLodFeaturesEXT pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int minLod() {
        return segment.get(LAYOUT$minLod, OFFSET$minLod);
    }

    public VkPhysicalDeviceImageViewMinLodFeaturesEXT minLod(@NativeType("VkBool32") @Unsigned int value) {

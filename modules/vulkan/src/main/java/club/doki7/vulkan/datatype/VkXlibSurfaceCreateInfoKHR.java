...
///
/// The {@code allocate} ({@link VkXlibSurfaceCreateInfoKHR#allocate(Arena)}, {@link VkXlibSurfaceCreateInfoKHR#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkXlibSurfaceCreateInfoKHR#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkXlibSurfaceCreateInfoKHR(@NotNull MemorySegment segment) implements IVkXlibSurfaceCreateInfoKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkXlibSurfaceCreateInfoKHR.html"><code>VkXlibSurfaceCreateInfoKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkXlibSurfaceCreateInfoKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkXlibSurfaceCreateInfoKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkXlibSurfaceCreateInfoKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkXlibSurfaceCreateInfoKHR, Iterable<VkXlibSurfaceCreateInfoKHR> {
        public long size() {
            return segment.byteSize() / VkXlibSurfaceCreateInfoKHR.BYTES;
        }
        ...
        public @NotNull VkXlibSurfaceCreateInfoKHR at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkXlibSurfaceCreateInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkXlibSurfaceCreateInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkXlibSurfaceCreateInfoKHR.BYTES,
                (end - start) * VkXlibSurfaceCreateInfoKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkXlibSurfaceCreateInfoKHR.BYTES));
        }

        public VkXlibSurfaceCreateInfoKHR[] toArray() {
            VkXlibSurfaceCreateInfoKHR[] ret = new VkXlibSurfaceCreateInfoKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkXlibSurfaceCreateInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkXlibSurfaceCreateInfoKHR> {
            ...
            @Override
            public VkXlibSurfaceCreateInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkXlibSurfaceCreateInfoKHR ret = new VkXlibSurfaceCreateInfoKHR(segment.asSlice(0, VkXlibSurfaceCreateInfoKHR.BYTES));
                segment = segment.asSlice(VkXlibSurfaceCreateInfoKHR.BYTES);
                return ret;
            }
    ...
    public static VkXlibSurfaceCreateInfoKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkXlibSurfaceCreateInfoKHR.Ptr ret = new VkXlibSurfaceCreateInfoKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.XLIB_SURFACE_CREATE_INFO_KHR);
        }
        return ret;
    }
    ...
    public VkXlibSurfaceCreateInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public @MagicConstant(valuesFromClass = VkXlibSurfaceCreateFlagsKHR.class) int flags() {
        return segment.get(LAYOUT$flags, OFFSET$flags);
    }

    public VkXlibSurfaceCreateInfoKHR flags(@MagicConstant(valuesFromClass = VkXlibSurfaceCreateFlagsKHR.class) int value) {

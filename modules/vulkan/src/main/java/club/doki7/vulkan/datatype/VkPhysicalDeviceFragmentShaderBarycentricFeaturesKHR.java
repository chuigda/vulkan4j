...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.html"><code>VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR, Iterable<VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR> {
        public long size() {
            return segment.byteSize() / VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.BYTES;
        }
        ...
        public @NotNull VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR at(long index) {
        ...
        public VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.BYTES,
                (end - start) * VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.BYTES));
        }

        public VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR[] toArray() {
            VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR[] ret = new VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR[(int) size()];
        ...
        private static final class Iter implements Iterator<VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR> {
            ...
            @Override
            public VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR ret = new VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR(segment.asSlice(0, VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.BYTES);
                return ret;
            }
    ...
    public static VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.Ptr ret = new VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_KHR);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

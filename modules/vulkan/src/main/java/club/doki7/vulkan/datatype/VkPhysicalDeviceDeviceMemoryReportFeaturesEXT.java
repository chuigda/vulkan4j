...
public record VkPhysicalDeviceDeviceMemoryReportFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceDeviceMemoryReportFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceDeviceMemoryReportFeaturesEXT, Iterable<VkPhysicalDeviceDeviceMemoryReportFeaturesEXT> {
        public long size() {
        ...
        public VkPhysicalDeviceDeviceMemoryReportFeaturesEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceDeviceMemoryReportFeaturesEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceDeviceMemoryReportFeaturesEXT.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceDeviceMemoryReportFeaturesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceDeviceMemoryReportFeaturesEXT> {
            ...
            @Override
            public VkPhysicalDeviceDeviceMemoryReportFeaturesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceDeviceMemoryReportFeaturesEXT ret = new VkPhysicalDeviceDeviceMemoryReportFeaturesEXT(segment.asSlice(0, VkPhysicalDeviceDeviceMemoryReportFeaturesEXT.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceDeviceMemoryReportFeaturesEXT.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceDeviceMemoryReportFeaturesEXT sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceDeviceMemoryReportFeaturesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceDeviceMemoryReportFeaturesEXT pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDeviceDeviceMemoryReportFeaturesEXT deviceMemoryReport(@NativeType("VkBool32") @Unsigned int value) {

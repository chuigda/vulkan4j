...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineCache.html"><code>VkPipelineCache</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineCache.html"><code>VkPipelineCache</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkPipelineCache(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineCache.html"><code>VkPipelineCache</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkPipelineCache> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkPipelineCache read() {
        ...
        public void write(@Nullable VkPipelineCache value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkPipelineCache read(long index) {
        ...
        public void write(long index, @Nullable VkPipelineCache value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkPipelineCache[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkPipelineCache value0, @Nullable VkPipelineCache ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkPipelineCache @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkPipelineCache> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkPipelineCache value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkPipelineCache value0, @Nullable VkPipelineCache ...values) {
        ...
        @Override
        public @NotNull Iterator<VkPipelineCache> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkPipelineCache> {

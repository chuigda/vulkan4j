...
public record VkAccelerationStructureMotionInstanceNV(@NotNull MemorySegment segment) implements IVkAccelerationStructureMotionInstanceNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureMotionInstanceNV, Iterable<VkAccelerationStructureMotionInstanceNV> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkAccelerationStructureMotionInstanceNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkAccelerationStructureMotionInstanceNV.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkAccelerationStructureMotionInstanceNV> {
            ...
            @Override
            public VkAccelerationStructureMotionInstanceNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkAccelerationStructureMotionInstanceNV ret = new VkAccelerationStructureMotionInstanceNV(segment.asSlice(0, VkAccelerationStructureMotionInstanceNV.BYTES));
                segment = segment.asSlice(VkAccelerationStructureMotionInstanceNV.BYTES);
                return ret;
            }
    ...
    public VkAccelerationStructureMotionInstanceNV data(Consumer<@NotNull VkAccelerationStructureMotionInstanceDataNV> consumer) {

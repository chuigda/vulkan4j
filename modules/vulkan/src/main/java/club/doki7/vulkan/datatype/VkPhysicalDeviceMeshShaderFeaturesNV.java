...
///
/// The {@code allocate} ({@link VkPhysicalDeviceMeshShaderFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceMeshShaderFeaturesNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkPhysicalDeviceMeshShaderFeaturesNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceMeshShaderFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMeshShaderFeaturesNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceMeshShaderFeaturesNV.html"><code>VkPhysicalDeviceMeshShaderFeaturesNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceMeshShaderFeaturesNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceMeshShaderFeaturesNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceMeshShaderFeaturesNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMeshShaderFeaturesNV, Iterable<VkPhysicalDeviceMeshShaderFeaturesNV> {
        ...
        public @NotNull VkPhysicalDeviceMeshShaderFeaturesNV at(long index) {
        ...
        public VkPhysicalDeviceMeshShaderFeaturesNV.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceMeshShaderFeaturesNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceMeshShaderFeaturesNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceMeshShaderFeaturesNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceMeshShaderFeaturesNV.BYTES,
                (end - start) * VkPhysicalDeviceMeshShaderFeaturesNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceMeshShaderFeaturesNV.BYTES));
        }

        public VkPhysicalDeviceMeshShaderFeaturesNV[] toArray() {
            VkPhysicalDeviceMeshShaderFeaturesNV[] ret = new VkPhysicalDeviceMeshShaderFeaturesNV[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceMeshShaderFeaturesNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceMeshShaderFeaturesNV> {
    ...
    public static VkPhysicalDeviceMeshShaderFeaturesNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceMeshShaderFeaturesNV.Ptr ret = new VkPhysicalDeviceMeshShaderFeaturesNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_MESH_SHADER_FEATURES_NV);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceMeshShaderFeaturesNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

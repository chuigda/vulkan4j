...
///
/// The {@code allocate} ({@link VkVideoEncodeAV1SessionParametersCreateInfoKHR#allocate(Arena)}, {@link VkVideoEncodeAV1SessionParametersCreateInfoKHR#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkVideoEncodeAV1SessionParametersCreateInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1SessionParametersCreateInfoKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeAV1SessionParametersCreateInfoKHR.html"><code>VkVideoEncodeAV1SessionParametersCreateInfoKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkVideoEncodeAV1SessionParametersCreateInfoKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkVideoEncodeAV1SessionParametersCreateInfoKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkVideoEncodeAV1SessionParametersCreateInfoKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1SessionParametersCreateInfoKHR, Iterable<VkVideoEncodeAV1SessionParametersCreateInfoKHR> {
        public long size() {
            return segment.byteSize() / VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES;
        }
        ...
        public @NotNull VkVideoEncodeAV1SessionParametersCreateInfoKHR at(long index) {
            return new VkVideoEncodeAV1SessionParametersCreateInfoKHR(segment.asSlice(index * VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES, VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES));
        }

        public VkVideoEncodeAV1SessionParametersCreateInfoKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkVideoEncodeAV1SessionParametersCreateInfoKHR> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull VkVideoEncodeAV1SessionParametersCreateInfoKHR value) {
            MemorySegment s = segment.asSlice(index * VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES, VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES,
                (end - start) * VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES));
        }

        public VkVideoEncodeAV1SessionParametersCreateInfoKHR[] toArray() {
            VkVideoEncodeAV1SessionParametersCreateInfoKHR[] ret = new VkVideoEncodeAV1SessionParametersCreateInfoKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkVideoEncodeAV1SessionParametersCreateInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkVideoEncodeAV1SessionParametersCreateInfoKHR> {
            ...
            @Override
            public VkVideoEncodeAV1SessionParametersCreateInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkVideoEncodeAV1SessionParametersCreateInfoKHR ret = new VkVideoEncodeAV1SessionParametersCreateInfoKHR(segment.asSlice(0, VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES));
                segment = segment.asSlice(VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES);
                return ret;
            }
    ...
    public static VkVideoEncodeAV1SessionParametersCreateInfoKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkVideoEncodeAV1SessionParametersCreateInfoKHR.Ptr ret = new VkVideoEncodeAV1SessionParametersCreateInfoKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.VIDEO_ENCODE_AV1_SESSION_PARAMETERS_CREATE_INFO_KHR);
        }
        return ret;
    }
    ...
    public VkVideoEncodeAV1SessionParametersCreateInfoKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
    ...
    public @Pointer(target=StdVideoEncodeAV1DecoderModelInfo.class) @NotNull MemorySegment pStdDecoderModelInfoRaw() {
        return segment.get(LAYOUT$pStdDecoderModelInfo, OFFSET$pStdDecoderModelInfo);
    }

    public void pStdDecoderModelInfoRaw(@Pointer(target=StdVideoEncodeAV1DecoderModelInfo.class) @NotNull MemorySegment value) {
    ...
    public @Pointer(target=StdVideoEncodeAV1OperatingPointInfo.class) @NotNull MemorySegment pStdOperatingPointsRaw() {
        return segment.get(LAYOUT$pStdOperatingPoints, OFFSET$pStdOperatingPoints);
    }

    public void pStdOperatingPointsRaw(@Pointer(target=StdVideoEncodeAV1OperatingPointInfo.class) @NotNull MemorySegment value) {

...
public record VkMemoryRequirements2(@NotNull MemorySegment segment) implements IVkMemoryRequirements2 {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryRequirements2, Iterable<VkMemoryRequirements2> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkMemoryRequirements2.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkMemoryRequirements2.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkMemoryRequirements2.BYTES,
                (end - start) * VkMemoryRequirements2.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkMemoryRequirements2> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkMemoryRequirements2> {
            ...
            @Override
            public VkMemoryRequirements2 next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkMemoryRequirements2 ret = new VkMemoryRequirements2(segment.asSlice(0, VkMemoryRequirements2.BYTES));
                segment = segment.asSlice(VkMemoryRequirements2.BYTES);
                return ret;
            }
    ...
    public VkMemoryRequirements2 sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkMemoryRequirements2 pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkMemoryRequirements2 pNext(@Nullable IPointer pointer) {

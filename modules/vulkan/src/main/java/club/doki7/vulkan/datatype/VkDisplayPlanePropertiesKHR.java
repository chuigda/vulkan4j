...
@ValueBasedCandidate
@UnsafeConstructor
public record VkDisplayPlanePropertiesKHR(@NotNull MemorySegment segment) implements IVkDisplayPlanePropertiesKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDisplayPlanePropertiesKHR.html"><code>VkDisplayPlanePropertiesKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkDisplayPlanePropertiesKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkDisplayPlanePropertiesKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkDisplayPlanePropertiesKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDisplayPlanePropertiesKHR, Iterable<VkDisplayPlanePropertiesKHR> {
        public long size() {
            return segment.byteSize() / VkDisplayPlanePropertiesKHR.BYTES;
        }
        ...
        public @NotNull VkDisplayPlanePropertiesKHR at(long index) {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkDisplayPlanePropertiesKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkDisplayPlanePropertiesKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkDisplayPlanePropertiesKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkDisplayPlanePropertiesKHR.BYTES,
                (end - start) * VkDisplayPlanePropertiesKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkDisplayPlanePropertiesKHR.BYTES));
        }

        public VkDisplayPlanePropertiesKHR[] toArray() {
            VkDisplayPlanePropertiesKHR[] ret = new VkDisplayPlanePropertiesKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkDisplayPlanePropertiesKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkDisplayPlanePropertiesKHR> {
            ...
            @Override
            public VkDisplayPlanePropertiesKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkDisplayPlanePropertiesKHR ret = new VkDisplayPlanePropertiesKHR(segment.asSlice(0, VkDisplayPlanePropertiesKHR.BYTES));
                segment = segment.asSlice(VkDisplayPlanePropertiesKHR.BYTES);
                return ret;
            }

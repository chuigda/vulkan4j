...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoSessionKHR.html"><code>VkVideoSessionKHR</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoSessionKHR.html"><code>VkVideoSessionKHR</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkVideoSessionKHR(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoSessionKHR.html"><code>VkVideoSessionKHR</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkVideoSessionKHR> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkVideoSessionKHR read() {
        ...
        public void write(@Nullable VkVideoSessionKHR value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkVideoSessionKHR read(long index) {
        ...
        public void write(long index, @Nullable VkVideoSessionKHR value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkVideoSessionKHR[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkVideoSessionKHR value0, @Nullable VkVideoSessionKHR ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkVideoSessionKHR @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkVideoSessionKHR> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkVideoSessionKHR value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkVideoSessionKHR value0, @Nullable VkVideoSessionKHR ...values) {
        ...
        @Override
        public @NotNull Iterator<VkVideoSessionKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkVideoSessionKHR> {

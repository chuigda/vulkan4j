...
public record VkAccelerationStructureInfoNV(@NotNull MemorySegment segment) implements IVkAccelerationStructureInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureInfoNV, Iterable<VkAccelerationStructureInfoNV> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkAccelerationStructureInfoNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkAccelerationStructureInfoNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkAccelerationStructureInfoNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkAccelerationStructureInfoNV.BYTES,
                (end - start) * VkAccelerationStructureInfoNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkAccelerationStructureInfoNV.BYTES));
        }

        public VkAccelerationStructureInfoNV[] toArray() {
            VkAccelerationStructureInfoNV[] ret = new VkAccelerationStructureInfoNV[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkAccelerationStructureInfoNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkAccelerationStructureInfoNV> {
            ...
            @Override
            public VkAccelerationStructureInfoNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkAccelerationStructureInfoNV ret = new VkAccelerationStructureInfoNV(segment.asSlice(0, VkAccelerationStructureInfoNV.BYTES));
                segment = segment.asSlice(VkAccelerationStructureInfoNV.BYTES);
                return ret;
            }

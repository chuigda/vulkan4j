...
public record StdVideoDecodeH264ReferenceInfoFlags(@NotNull MemorySegment segment) implements IStdVideoDecodeH264ReferenceInfoFlags {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoDecodeH264ReferenceInfoFlags, Iterable<StdVideoDecodeH264ReferenceInfoFlags> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull StdVideoDecodeH264ReferenceInfoFlags> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * StdVideoDecodeH264ReferenceInfoFlags.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<StdVideoDecodeH264ReferenceInfoFlags> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoDecodeH264ReferenceInfoFlags> {
            ...
            @Override
            public StdVideoDecodeH264ReferenceInfoFlags next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                StdVideoDecodeH264ReferenceInfoFlags ret = new StdVideoDecodeH264ReferenceInfoFlags(segment.asSlice(0, StdVideoDecodeH264ReferenceInfoFlags.BYTES));
                segment = segment.asSlice(StdVideoDecodeH264ReferenceInfoFlags.BYTES);
                return ret;
            }

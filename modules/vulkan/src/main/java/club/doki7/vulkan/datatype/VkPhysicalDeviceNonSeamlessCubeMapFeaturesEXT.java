...
public record VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT, Iterable<VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT> {
        public long size() {
        ...
        public VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT.BYTES,
                (end - start) * VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT.BYTES
            ));
        }
        ...
        private static final class Iter implements Iterator<VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT> {
            ...
            @Override
            public VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT ret = new VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT(segment.asSlice(0, VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int nonSeamlessCubeMap() {

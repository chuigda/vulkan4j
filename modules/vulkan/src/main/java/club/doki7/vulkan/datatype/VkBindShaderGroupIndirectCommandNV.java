...
public record VkBindShaderGroupIndirectCommandNV(@NotNull MemorySegment segment) implements IVkBindShaderGroupIndirectCommandNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBindShaderGroupIndirectCommandNV, Iterable<VkBindShaderGroupIndirectCommandNV> {
        public long size() {
        ...
        public VkBindShaderGroupIndirectCommandNV.Ptr at(long index, @NotNull Consumer<@NotNull VkBindShaderGroupIndirectCommandNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkBindShaderGroupIndirectCommandNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkBindShaderGroupIndirectCommandNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkBindShaderGroupIndirectCommandNV.BYTES,
                (end - start) * VkBindShaderGroupIndirectCommandNV.BYTES
            ));
        }
        ...
        private static final class Iter implements Iterator<VkBindShaderGroupIndirectCommandNV> {
            ...
            @Override
            public VkBindShaderGroupIndirectCommandNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkBindShaderGroupIndirectCommandNV ret = new VkBindShaderGroupIndirectCommandNV(segment.asSlice(0, VkBindShaderGroupIndirectCommandNV.BYTES));
                segment = segment.asSlice(VkBindShaderGroupIndirectCommandNV.BYTES);
                return ret;
            }

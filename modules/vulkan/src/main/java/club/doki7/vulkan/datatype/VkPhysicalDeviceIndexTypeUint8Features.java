...
public record VkPhysicalDeviceIndexTypeUint8Features(@NotNull MemorySegment segment) implements IVkPhysicalDeviceIndexTypeUint8Features {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceIndexTypeUint8Features, Iterable<VkPhysicalDeviceIndexTypeUint8Features> {
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceIndexTypeUint8Features> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceIndexTypeUint8Features> {
    ...
    public VkPhysicalDeviceIndexTypeUint8Features sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

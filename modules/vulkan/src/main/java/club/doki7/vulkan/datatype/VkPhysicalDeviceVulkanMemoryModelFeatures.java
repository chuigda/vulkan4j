...
///
/// The {@code allocate} ({@link VkPhysicalDeviceVulkanMemoryModelFeatures#allocate(Arena)}, {@link VkPhysicalDeviceVulkanMemoryModelFeatures#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkPhysicalDeviceVulkanMemoryModelFeatures#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceVulkanMemoryModelFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVulkanMemoryModelFeatures {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceVulkanMemoryModelFeatures.html"><code>VkPhysicalDeviceVulkanMemoryModelFeatures</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceVulkanMemoryModelFeatures}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceVulkanMemoryModelFeatures to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceVulkanMemoryModelFeatures.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVulkanMemoryModelFeatures, Iterable<VkPhysicalDeviceVulkanMemoryModelFeatures> {
        public long size() {
            return segment.byteSize() / VkPhysicalDeviceVulkanMemoryModelFeatures.BYTES;
        }
        ...
        public @NotNull VkPhysicalDeviceVulkanMemoryModelFeatures at(long index) {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceVulkanMemoryModelFeatures> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceVulkanMemoryModelFeatures.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceVulkanMemoryModelFeatures.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceVulkanMemoryModelFeatures.BYTES,
                (end - start) * VkPhysicalDeviceVulkanMemoryModelFeatures.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceVulkanMemoryModelFeatures.BYTES));
        }

        public VkPhysicalDeviceVulkanMemoryModelFeatures[] toArray() {
            VkPhysicalDeviceVulkanMemoryModelFeatures[] ret = new VkPhysicalDeviceVulkanMemoryModelFeatures[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceVulkanMemoryModelFeatures> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceVulkanMemoryModelFeatures> {
            ...
            @Override
            public VkPhysicalDeviceVulkanMemoryModelFeatures next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceVulkanMemoryModelFeatures ret = new VkPhysicalDeviceVulkanMemoryModelFeatures(segment.asSlice(0, VkPhysicalDeviceVulkanMemoryModelFeatures.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceVulkanMemoryModelFeatures.BYTES);
                return ret;
            }
    ...
    public static VkPhysicalDeviceVulkanMemoryModelFeatures.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceVulkanMemoryModelFeatures.Ptr ret = new VkPhysicalDeviceVulkanMemoryModelFeatures.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceVulkanMemoryModelFeatures sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceVulkanMemoryModelFeatures vulkanMemoryModel(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public VkPhysicalDeviceVulkanMemoryModelFeatures vulkanMemoryModelDeviceScope(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public VkPhysicalDeviceVulkanMemoryModelFeatures vulkanMemoryModelAvailabilityVisibilityChains(@NativeType("VkBool32") @Unsigned int value) {

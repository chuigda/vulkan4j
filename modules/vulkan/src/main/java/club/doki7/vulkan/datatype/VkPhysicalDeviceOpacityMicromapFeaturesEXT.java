...
public record VkPhysicalDeviceOpacityMicromapFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceOpacityMicromapFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceOpacityMicromapFeaturesEXT, Iterable<VkPhysicalDeviceOpacityMicromapFeaturesEXT> {
        public long size() {
        ...
        public VkPhysicalDeviceOpacityMicromapFeaturesEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceOpacityMicromapFeaturesEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceOpacityMicromapFeaturesEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceOpacityMicromapFeaturesEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceOpacityMicromapFeaturesEXT.BYTES,
                (end - start) * VkPhysicalDeviceOpacityMicromapFeaturesEXT.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceOpacityMicromapFeaturesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceOpacityMicromapFeaturesEXT> {
            ...
            @Override
            public VkPhysicalDeviceOpacityMicromapFeaturesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceOpacityMicromapFeaturesEXT ret = new VkPhysicalDeviceOpacityMicromapFeaturesEXT(segment.asSlice(0, VkPhysicalDeviceOpacityMicromapFeaturesEXT.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceOpacityMicromapFeaturesEXT.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceOpacityMicromapFeaturesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

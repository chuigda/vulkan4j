...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineBinaryKHR.html"><code>VkPipelineBinaryKHR</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineBinaryKHR.html"><code>VkPipelineBinaryKHR</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkPipelineBinaryKHR(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineBinaryKHR.html"><code>VkPipelineBinaryKHR</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkPipelineBinaryKHR> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkPipelineBinaryKHR read() {
        ...
        public void write(@Nullable VkPipelineBinaryKHR value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkPipelineBinaryKHR read(long index) {
        ...
        public void write(long index, @Nullable VkPipelineBinaryKHR value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkPipelineBinaryKHR[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkPipelineBinaryKHR value0, @Nullable VkPipelineBinaryKHR ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkPipelineBinaryKHR @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkPipelineBinaryKHR> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkPipelineBinaryKHR value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkPipelineBinaryKHR value0, @Nullable VkPipelineBinaryKHR ...values) {
        ...
        @Override
        public @NotNull Iterator<VkPipelineBinaryKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkPipelineBinaryKHR> {

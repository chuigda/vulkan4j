...
public record VkSurfaceCapabilitiesFullScreenExclusiveEXT(@NotNull MemorySegment segment) implements IVkSurfaceCapabilitiesFullScreenExclusiveEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSurfaceCapabilitiesFullScreenExclusiveEXT, Iterable<VkSurfaceCapabilitiesFullScreenExclusiveEXT> {
        public long size() {
        ...
        public VkSurfaceCapabilitiesFullScreenExclusiveEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkSurfaceCapabilitiesFullScreenExclusiveEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSurfaceCapabilitiesFullScreenExclusiveEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkSurfaceCapabilitiesFullScreenExclusiveEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkSurfaceCapabilitiesFullScreenExclusiveEXT.BYTES,
                (end - start) * VkSurfaceCapabilitiesFullScreenExclusiveEXT.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkSurfaceCapabilitiesFullScreenExclusiveEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSurfaceCapabilitiesFullScreenExclusiveEXT> {
            ...
            @Override
            public VkSurfaceCapabilitiesFullScreenExclusiveEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkSurfaceCapabilitiesFullScreenExclusiveEXT ret = new VkSurfaceCapabilitiesFullScreenExclusiveEXT(segment.asSlice(0, VkSurfaceCapabilitiesFullScreenExclusiveEXT.BYTES));
                segment = segment.asSlice(VkSurfaceCapabilitiesFullScreenExclusiveEXT.BYTES);
                return ret;
            }
    ...
    public VkSurfaceCapabilitiesFullScreenExclusiveEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkSurfaceCapabilitiesFullScreenExclusiveEXT pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @NativeType("VkBool32") @Unsigned int fullScreenExclusiveSupported() {
        return segment.get(LAYOUT$fullScreenExclusiveSupported, OFFSET$fullScreenExclusiveSupported);
    }

    public VkSurfaceCapabilitiesFullScreenExclusiveEXT fullScreenExclusiveSupported(@NativeType("VkBool32") @Unsigned int value) {

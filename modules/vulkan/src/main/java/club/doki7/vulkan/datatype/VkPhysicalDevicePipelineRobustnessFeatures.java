...
public record VkPhysicalDevicePipelineRobustnessFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDevicePipelineRobustnessFeatures {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePipelineRobustnessFeatures, Iterable<VkPhysicalDevicePipelineRobustnessFeatures> {
        public long size() {
        ...
        public VkPhysicalDevicePipelineRobustnessFeatures.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDevicePipelineRobustnessFeatures> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDevicePipelineRobustnessFeatures.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDevicePipelineRobustnessFeatures> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDevicePipelineRobustnessFeatures> {
            ...
            @Override
            public VkPhysicalDevicePipelineRobustnessFeatures next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDevicePipelineRobustnessFeatures ret = new VkPhysicalDevicePipelineRobustnessFeatures(segment.asSlice(0, VkPhysicalDevicePipelineRobustnessFeatures.BYTES));
                segment = segment.asSlice(VkPhysicalDevicePipelineRobustnessFeatures.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDevicePipelineRobustnessFeatures sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDevicePipelineRobustnessFeatures pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDevicePipelineRobustnessFeatures pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDevicePipelineRobustnessFeatures pipelineRobustness(@NativeType("VkBool32") @Unsigned int value) {

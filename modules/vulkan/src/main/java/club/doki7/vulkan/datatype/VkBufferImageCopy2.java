...
///
/// The {@code allocate} ({@link VkBufferImageCopy2#allocate(Arena)}, {@link VkBufferImageCopy2#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkBufferImageCopy2#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkBufferImageCopy2(@NotNull MemorySegment segment) implements IVkBufferImageCopy2 {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkBufferImageCopy2.html"><code>VkBufferImageCopy2</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkBufferImageCopy2}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkBufferImageCopy2 to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkBufferImageCopy2.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBufferImageCopy2, Iterable<VkBufferImageCopy2> {
        public long size() {
            return segment.byteSize() / VkBufferImageCopy2.BYTES;
        }
        ...
        public @NotNull VkBufferImageCopy2 at(long index) {
            return new VkBufferImageCopy2(segment.asSlice(index * VkBufferImageCopy2.BYTES, VkBufferImageCopy2.BYTES));
        }

        public void at(long index, @NotNull Consumer<@NotNull VkBufferImageCopy2> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkBufferImageCopy2.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkBufferImageCopy2.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkBufferImageCopy2.BYTES,
                (end - start) * VkBufferImageCopy2.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkBufferImageCopy2> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkBufferImageCopy2> {
            ...
            @Override
            public VkBufferImageCopy2 next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkBufferImageCopy2 ret = new VkBufferImageCopy2(segment.asSlice(0, VkBufferImageCopy2.BYTES));
                segment = segment.asSlice(VkBufferImageCopy2.BYTES);
                return ret;
            }
    ...
    public static VkBufferImageCopy2.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkBufferImageCopy2.Ptr ret = new VkBufferImageCopy2.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.BUFFER_IMAGE_COPY_2);
        }
        return ret;
    }
    ...
    public VkBufferImageCopy2 pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

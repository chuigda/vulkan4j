...
public record VkPhysicalDeviceCornerSampledImageFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCornerSampledImageFeaturesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCornerSampledImageFeaturesNV, Iterable<VkPhysicalDeviceCornerSampledImageFeaturesNV> {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceCornerSampledImageFeaturesNV> consumer) {
    ...
    public VkPhysicalDeviceCornerSampledImageFeaturesNV sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceCornerSampledImageFeaturesNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

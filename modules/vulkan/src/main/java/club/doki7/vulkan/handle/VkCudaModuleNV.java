...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCudaModuleNV.html"><code>VkCudaModuleNV</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCudaModuleNV.html"><code>VkCudaModuleNV</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkCudaModuleNV(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCudaModuleNV.html"><code>VkCudaModuleNV</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkCudaModuleNV> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkCudaModuleNV read() {
        ...
        public void write(@Nullable VkCudaModuleNV value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkCudaModuleNV read(long index) {
        ...
        public void write(long index, @Nullable VkCudaModuleNV value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkCudaModuleNV[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkCudaModuleNV value0, @Nullable VkCudaModuleNV ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkCudaModuleNV @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkCudaModuleNV> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkCudaModuleNV value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkCudaModuleNV value0, @Nullable VkCudaModuleNV ...values) {
        ...
        @Override
        public @NotNull Iterator<VkCudaModuleNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkCudaModuleNV> {

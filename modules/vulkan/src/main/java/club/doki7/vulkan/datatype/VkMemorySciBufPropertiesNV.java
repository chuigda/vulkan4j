...
public record VkMemorySciBufPropertiesNV(@NotNull MemorySegment segment) implements IVkMemorySciBufPropertiesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemorySciBufPropertiesNV, Iterable<VkMemorySciBufPropertiesNV> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkMemorySciBufPropertiesNV> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkMemorySciBufPropertiesNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkMemorySciBufPropertiesNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkMemorySciBufPropertiesNV.BYTES,
                (end - start) * VkMemorySciBufPropertiesNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkMemorySciBufPropertiesNV.BYTES));
        }

        public VkMemorySciBufPropertiesNV[] toArray() {
            VkMemorySciBufPropertiesNV[] ret = new VkMemorySciBufPropertiesNV[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkMemorySciBufPropertiesNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkMemorySciBufPropertiesNV> {
            ...
            @Override
            public VkMemorySciBufPropertiesNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkMemorySciBufPropertiesNV ret = new VkMemorySciBufPropertiesNV(segment.asSlice(0, VkMemorySciBufPropertiesNV.BYTES));
                segment = segment.asSlice(VkMemorySciBufPropertiesNV.BYTES);
                return ret;
            }
    ...
    public VkMemorySciBufPropertiesNV sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkMemorySciBufPropertiesNV memoryTypeBits(@Unsigned int value) {

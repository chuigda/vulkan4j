...
public record VkAccelerationStructureGeometryMotionTrianglesDataNV(@NotNull MemorySegment segment) implements IVkAccelerationStructureGeometryMotionTrianglesDataNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureGeometryMotionTrianglesDataNV, Iterable<VkAccelerationStructureGeometryMotionTrianglesDataNV> {
        ...
        public VkAccelerationStructureGeometryMotionTrianglesDataNV.Ptr at(long index, @NotNull Consumer<@NotNull VkAccelerationStructureGeometryMotionTrianglesDataNV> consumer) {
        ...
        @Override
        public @NotNull Iterator<VkAccelerationStructureGeometryMotionTrianglesDataNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkAccelerationStructureGeometryMotionTrianglesDataNV> {
    ...
    public VkAccelerationStructureGeometryMotionTrianglesDataNV sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkAccelerationStructureGeometryMotionTrianglesDataNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkAccelerationStructureGeometryMotionTrianglesDataNV pNext(@Nullable IPointer pointer) {
    ...
    public VkAccelerationStructureGeometryMotionTrianglesDataNV vertexData(@NotNull VkDeviceOrHostAddressConstKHR value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$vertexData, SIZE$vertexData);
        return this;
    }

    public VkAccelerationStructureGeometryMotionTrianglesDataNV vertexData(Consumer<@NotNull VkDeviceOrHostAddressConstKHR> consumer) {

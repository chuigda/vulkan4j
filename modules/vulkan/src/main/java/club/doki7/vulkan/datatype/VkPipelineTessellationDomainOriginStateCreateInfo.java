...
public record VkPipelineTessellationDomainOriginStateCreateInfo(@NotNull MemorySegment segment) implements IVkPipelineTessellationDomainOriginStateCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineTessellationDomainOriginStateCreateInfo, Iterable<VkPipelineTessellationDomainOriginStateCreateInfo> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPipelineTessellationDomainOriginStateCreateInfo> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPipelineTessellationDomainOriginStateCreateInfo.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPipelineTessellationDomainOriginStateCreateInfo.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPipelineTessellationDomainOriginStateCreateInfo.BYTES,
                (end - start) * VkPipelineTessellationDomainOriginStateCreateInfo.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPipelineTessellationDomainOriginStateCreateInfo.BYTES));
        }

        public VkPipelineTessellationDomainOriginStateCreateInfo[] toArray() {
            VkPipelineTessellationDomainOriginStateCreateInfo[] ret = new VkPipelineTessellationDomainOriginStateCreateInfo[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPipelineTessellationDomainOriginStateCreateInfo> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPipelineTessellationDomainOriginStateCreateInfo> {
            ...
            @Override
            public VkPipelineTessellationDomainOriginStateCreateInfo next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPipelineTessellationDomainOriginStateCreateInfo ret = new VkPipelineTessellationDomainOriginStateCreateInfo(segment.asSlice(0, VkPipelineTessellationDomainOriginStateCreateInfo.BYTES));
                segment = segment.asSlice(VkPipelineTessellationDomainOriginStateCreateInfo.BYTES);
                return ret;
            }
    ...
    public VkPipelineTessellationDomainOriginStateCreateInfo pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPipelineTessellationDomainOriginStateCreateInfo pNext(@Nullable IPointer pointer) {

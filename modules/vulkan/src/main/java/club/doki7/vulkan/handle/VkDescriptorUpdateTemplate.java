...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDescriptorUpdateTemplate.html"><code>VkDescriptorUpdateTemplate</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDescriptorUpdateTemplate.html"><code>VkDescriptorUpdateTemplate</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkDescriptorUpdateTemplate(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDescriptorUpdateTemplate.html"><code>VkDescriptorUpdateTemplate</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkDescriptorUpdateTemplate> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkDescriptorUpdateTemplate read() {
        ...
        public void write(@Nullable VkDescriptorUpdateTemplate value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkDescriptorUpdateTemplate read(long index) {
        ...
        public void write(long index, @Nullable VkDescriptorUpdateTemplate value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkDescriptorUpdateTemplate[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkDescriptorUpdateTemplate value0, @Nullable VkDescriptorUpdateTemplate ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkDescriptorUpdateTemplate @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkDescriptorUpdateTemplate> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkDescriptorUpdateTemplate value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        @Override
        public @NotNull Iterator<VkDescriptorUpdateTemplate> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkDescriptorUpdateTemplate> {

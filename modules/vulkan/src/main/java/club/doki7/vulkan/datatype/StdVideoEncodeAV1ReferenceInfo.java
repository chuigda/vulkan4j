...
public record StdVideoEncodeAV1ReferenceInfo(@NotNull MemorySegment segment) implements IStdVideoEncodeAV1ReferenceInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeAV1ReferenceInfo, Iterable<StdVideoEncodeAV1ReferenceInfo> {
        ...
        public StdVideoEncodeAV1ReferenceInfo.Ptr at(long index, @NotNull Consumer<@NotNull StdVideoEncodeAV1ReferenceInfo> consumer) {
        ...
        @Override
        public @NotNull Iterator<StdVideoEncodeAV1ReferenceInfo> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoEncodeAV1ReferenceInfo> {

...
/// Represents a pointer to a <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSemaphoreGetZirconHandleInfoFUCHSIA.html"><code>VkSemaphoreGetZirconHandleInfoFUCHSIA</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
public record VkSemaphoreGetZirconHandleInfoFUCHSIA(@NotNull MemorySegment segment) implements IVkSemaphoreGetZirconHandleInfoFUCHSIA {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSemaphoreGetZirconHandleInfoFUCHSIA, Iterable<VkSemaphoreGetZirconHandleInfoFUCHSIA> {
        public long size() {
        ...
        public VkSemaphoreGetZirconHandleInfoFUCHSIA.Ptr at(long index, @NotNull Consumer<@NotNull VkSemaphoreGetZirconHandleInfoFUCHSIA> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSemaphoreGetZirconHandleInfoFUCHSIA.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkSemaphoreGetZirconHandleInfoFUCHSIA.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkSemaphoreGetZirconHandleInfoFUCHSIA.BYTES,
                (end - start) * VkSemaphoreGetZirconHandleInfoFUCHSIA.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkSemaphoreGetZirconHandleInfoFUCHSIA.BYTES));
        }

        public VkSemaphoreGetZirconHandleInfoFUCHSIA[] toArray() {
            VkSemaphoreGetZirconHandleInfoFUCHSIA[] ret = new VkSemaphoreGetZirconHandleInfoFUCHSIA[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkSemaphoreGetZirconHandleInfoFUCHSIA> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSemaphoreGetZirconHandleInfoFUCHSIA> {
            ...
            @Override
            public VkSemaphoreGetZirconHandleInfoFUCHSIA next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkSemaphoreGetZirconHandleInfoFUCHSIA ret = new VkSemaphoreGetZirconHandleInfoFUCHSIA(segment.asSlice(0, VkSemaphoreGetZirconHandleInfoFUCHSIA.BYTES));
                segment = segment.asSlice(VkSemaphoreGetZirconHandleInfoFUCHSIA.BYTES);
                return ret;
            }
    ...
    public VkSemaphoreGetZirconHandleInfoFUCHSIA sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkSemaphoreGetZirconHandleInfoFUCHSIA pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkSemaphoreGetZirconHandleInfoFUCHSIA pNext(@Nullable IPointer pointer) {
    ...
    public VkSemaphoreGetZirconHandleInfoFUCHSIA semaphore(@Nullable VkSemaphore value) {

...
public record VkXYColorEXT(@NotNull MemorySegment segment) implements IVkXYColorEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkXYColorEXT, Iterable<VkXYColorEXT> {
        ...
        public VkXYColorEXT.Ptr at(long index, @NotNull Consumer<@NotNull VkXYColorEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkXYColorEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkXYColorEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkXYColorEXT.BYTES,
                (end - start) * VkXYColorEXT.BYTES
            ));
        }

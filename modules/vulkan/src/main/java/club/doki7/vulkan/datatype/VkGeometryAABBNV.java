...
///
/// The {@code allocate} ({@link VkGeometryAABBNV#allocate(Arena)}, {@link VkGeometryAABBNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkGeometryAABBNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkGeometryAABBNV(@NotNull MemorySegment segment) implements IVkGeometryAABBNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkGeometryAABBNV.html"><code>VkGeometryAABBNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkGeometryAABBNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkGeometryAABBNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkGeometryAABBNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkGeometryAABBNV, Iterable<VkGeometryAABBNV> {
        ...
        public @NotNull VkGeometryAABBNV at(long index) {
        ...
        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkGeometryAABBNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkGeometryAABBNV.BYTES,
                (end - start) * VkGeometryAABBNV.BYTES
            ));
        }
    ...
    public static VkGeometryAABBNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkGeometryAABBNV.Ptr ret = new VkGeometryAABBNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.GEOMETRY_AABB_NV);
        }
        return ret;
    }
    ...
    public VkGeometryAABBNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

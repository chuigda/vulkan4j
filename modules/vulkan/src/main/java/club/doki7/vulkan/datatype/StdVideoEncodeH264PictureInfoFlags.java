...
@ValueBasedCandidate
@UnsafeConstructor
public record StdVideoEncodeH264PictureInfoFlags(@NotNull MemorySegment segment) implements IStdVideoEncodeH264PictureInfoFlags {
    /// Represents a pointer to / an array of null structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link StdVideoEncodeH264PictureInfoFlags}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IStdVideoEncodeH264PictureInfoFlags to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code StdVideoEncodeH264PictureInfoFlags.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeH264PictureInfoFlags, Iterable<StdVideoEncodeH264PictureInfoFlags> {
        public long size() {
            return segment.byteSize() / StdVideoEncodeH264PictureInfoFlags.BYTES;
        }
        ...
        public @NotNull StdVideoEncodeH264PictureInfoFlags at(long index) {
            return new StdVideoEncodeH264PictureInfoFlags(segment.asSlice(index * StdVideoEncodeH264PictureInfoFlags.BYTES, StdVideoEncodeH264PictureInfoFlags.BYTES));
        }

        public StdVideoEncodeH264PictureInfoFlags.Ptr at(long index, @NotNull Consumer<@NotNull StdVideoEncodeH264PictureInfoFlags> consumer) {
            consumer.accept(at(index));
            return this;
        }

        public void write(long index, @NotNull StdVideoEncodeH264PictureInfoFlags value) {
            MemorySegment s = segment.asSlice(index * StdVideoEncodeH264PictureInfoFlags.BYTES, StdVideoEncodeH264PictureInfoFlags.BYTES);
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * StdVideoEncodeH264PictureInfoFlags.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * StdVideoEncodeH264PictureInfoFlags.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * StdVideoEncodeH264PictureInfoFlags.BYTES,
                (end - start) * StdVideoEncodeH264PictureInfoFlags.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * StdVideoEncodeH264PictureInfoFlags.BYTES));
        }

        public StdVideoEncodeH264PictureInfoFlags[] toArray() {
            StdVideoEncodeH264PictureInfoFlags[] ret = new StdVideoEncodeH264PictureInfoFlags[(int) size()];
        ...
        @Override
        public @NotNull Iterator<StdVideoEncodeH264PictureInfoFlags> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoEncodeH264PictureInfoFlags> {
            ...
            @Override
            public StdVideoEncodeH264PictureInfoFlags next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                StdVideoEncodeH264PictureInfoFlags ret = new StdVideoEncodeH264PictureInfoFlags(segment.asSlice(0, StdVideoEncodeH264PictureInfoFlags.BYTES));
                segment = segment.asSlice(StdVideoEncodeH264PictureInfoFlags.BYTES);
                return ret;
            }

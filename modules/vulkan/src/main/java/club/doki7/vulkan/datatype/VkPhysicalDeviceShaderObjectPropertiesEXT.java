...
public record VkPhysicalDeviceShaderObjectPropertiesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderObjectPropertiesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderObjectPropertiesEXT, Iterable<VkPhysicalDeviceShaderObjectPropertiesEXT> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceShaderObjectPropertiesEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceShaderObjectPropertiesEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceShaderObjectPropertiesEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceShaderObjectPropertiesEXT.BYTES,
                (end - start) * VkPhysicalDeviceShaderObjectPropertiesEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceShaderObjectPropertiesEXT.BYTES));
        }

        public VkPhysicalDeviceShaderObjectPropertiesEXT[] toArray() {
            VkPhysicalDeviceShaderObjectPropertiesEXT[] ret = new VkPhysicalDeviceShaderObjectPropertiesEXT[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceShaderObjectPropertiesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceShaderObjectPropertiesEXT> {
            ...
            @Override
            public VkPhysicalDeviceShaderObjectPropertiesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceShaderObjectPropertiesEXT ret = new VkPhysicalDeviceShaderObjectPropertiesEXT(segment.asSlice(0, VkPhysicalDeviceShaderObjectPropertiesEXT.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceShaderObjectPropertiesEXT.BYTES);
                return ret;
            }

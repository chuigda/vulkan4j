...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevice.html"><code>VkPhysicalDevice</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevice.html"><code>VkPhysicalDevice</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDevice(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevice.html"><code>VkPhysicalDevice</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkPhysicalDevice> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkPhysicalDevice read() {
        ...
        public void write(@Nullable VkPhysicalDevice value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkPhysicalDevice read(long index) {
        ...
        public void write(long index, @Nullable VkPhysicalDevice value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkPhysicalDevice[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkPhysicalDevice value0, @Nullable VkPhysicalDevice ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkPhysicalDevice @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkPhysicalDevice> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkPhysicalDevice value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkPhysicalDevice value0, @Nullable VkPhysicalDevice ...values) {
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDevice> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkPhysicalDevice> {

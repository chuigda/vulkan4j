...
public record VkVideoEncodeRateControlLayerInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeRateControlLayerInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeRateControlLayerInfoKHR, Iterable<VkVideoEncodeRateControlLayerInfoKHR> {
        ...
        public VkVideoEncodeRateControlLayerInfoKHR.Ptr at(long index, @NotNull Consumer<@NotNull VkVideoEncodeRateControlLayerInfoKHR> consumer) {
        ...
        @Override
        public @NotNull Iterator<VkVideoEncodeRateControlLayerInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkVideoEncodeRateControlLayerInfoKHR> {
    ...
    public VkVideoEncodeRateControlLayerInfoKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

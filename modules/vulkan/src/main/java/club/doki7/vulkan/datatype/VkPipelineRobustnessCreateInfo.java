...
public record VkPipelineRobustnessCreateInfo(@NotNull MemorySegment segment) implements IVkPipelineRobustnessCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineRobustnessCreateInfo, Iterable<VkPipelineRobustnessCreateInfo> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPipelineRobustnessCreateInfo> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPipelineRobustnessCreateInfo.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkPipelineRobustnessCreateInfo> {
            ...
            @Override
            public VkPipelineRobustnessCreateInfo next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPipelineRobustnessCreateInfo ret = new VkPipelineRobustnessCreateInfo(segment.asSlice(0, VkPipelineRobustnessCreateInfo.BYTES));
                segment = segment.asSlice(VkPipelineRobustnessCreateInfo.BYTES);
                return ret;
            }
    ...
    public VkPipelineRobustnessCreateInfo pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

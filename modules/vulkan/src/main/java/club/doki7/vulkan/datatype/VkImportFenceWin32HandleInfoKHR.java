...
public record VkImportFenceWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IVkImportFenceWin32HandleInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportFenceWin32HandleInfoKHR, Iterable<VkImportFenceWin32HandleInfoKHR> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkImportFenceWin32HandleInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkImportFenceWin32HandleInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkImportFenceWin32HandleInfoKHR.BYTES,
                (end - start) * VkImportFenceWin32HandleInfoKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkImportFenceWin32HandleInfoKHR.BYTES));
        }

        public VkImportFenceWin32HandleInfoKHR[] toArray() {
            VkImportFenceWin32HandleInfoKHR[] ret = new VkImportFenceWin32HandleInfoKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkImportFenceWin32HandleInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkImportFenceWin32HandleInfoKHR> {
            ...
            @Override
            public VkImportFenceWin32HandleInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkImportFenceWin32HandleInfoKHR ret = new VkImportFenceWin32HandleInfoKHR(segment.asSlice(0, VkImportFenceWin32HandleInfoKHR.BYTES));
                segment = segment.asSlice(VkImportFenceWin32HandleInfoKHR.BYTES);
                return ret;
            }
    ...
    public VkImportFenceWin32HandleInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkImportFenceWin32HandleInfoKHR flags(@MagicConstant(valuesFromClass = VkFenceImportFlags.class) int value) {
    ...
    public VkImportFenceWin32HandleInfoKHR handleType(@MagicConstant(valuesFromClass = VkExternalFenceHandleTypeFlags.class) int value) {

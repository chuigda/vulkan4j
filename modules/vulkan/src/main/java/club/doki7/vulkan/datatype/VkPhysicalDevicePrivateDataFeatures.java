...
public record VkPhysicalDevicePrivateDataFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDevicePrivateDataFeatures {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePrivateDataFeatures, Iterable<VkPhysicalDevicePrivateDataFeatures> {
        ...
        public VkPhysicalDevicePrivateDataFeatures.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDevicePrivateDataFeatures> consumer) {
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDevicePrivateDataFeatures> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDevicePrivateDataFeatures> {
    ...
    public VkPhysicalDevicePrivateDataFeatures sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDevicePrivateDataFeatures pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDevicePrivateDataFeatures pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDevicePrivateDataFeatures privateData(@NativeType("VkBool32") @Unsigned int value) {

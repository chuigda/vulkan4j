...
public record VkAcquireProfilingLockInfoKHR(@NotNull MemorySegment segment) implements IVkAcquireProfilingLockInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkAcquireProfilingLockInfoKHR, Iterable<VkAcquireProfilingLockInfoKHR> {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkAcquireProfilingLockInfoKHR> consumer) {
    ...
    public VkAcquireProfilingLockInfoKHR sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkAcquireProfilingLockInfoKHR pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

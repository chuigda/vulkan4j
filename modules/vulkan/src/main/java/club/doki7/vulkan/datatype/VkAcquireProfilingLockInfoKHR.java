...
public record VkAcquireProfilingLockInfoKHR(@NotNull MemorySegment segment) implements IVkAcquireProfilingLockInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAcquireProfilingLockInfoKHR, Iterable<VkAcquireProfilingLockInfoKHR> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkAcquireProfilingLockInfoKHR.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkAcquireProfilingLockInfoKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkAcquireProfilingLockInfoKHR> {
            ...
            @Override
            public VkAcquireProfilingLockInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkAcquireProfilingLockInfoKHR ret = new VkAcquireProfilingLockInfoKHR(segment.asSlice(0, VkAcquireProfilingLockInfoKHR.BYTES));
                segment = segment.asSlice(VkAcquireProfilingLockInfoKHR.BYTES);
                return ret;
            }
    ...
    public VkAcquireProfilingLockInfoKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkAcquireProfilingLockInfoKHR pNext(@Nullable IPointer pointer) {
        pNext(pointer != null ? pointer.segment() : MemorySegment.NULL);
        return this;
    }

    public @MagicConstant(valuesFromClass = VkAcquireProfilingLockFlagsKHR.class) int flags() {
        return segment.get(LAYOUT$flags, OFFSET$flags);
    }

    public VkAcquireProfilingLockInfoKHR flags(@MagicConstant(valuesFromClass = VkAcquireProfilingLockFlagsKHR.class) int value) {
    ...
    public VkAcquireProfilingLockInfoKHR timeout(@Unsigned long value) {

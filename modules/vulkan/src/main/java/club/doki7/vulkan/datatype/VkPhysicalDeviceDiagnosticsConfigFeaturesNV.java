...
public record VkPhysicalDeviceDiagnosticsConfigFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceDiagnosticsConfigFeaturesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceDiagnosticsConfigFeaturesNV, Iterable<VkPhysicalDeviceDiagnosticsConfigFeaturesNV> {
        ...
        public VkPhysicalDeviceDiagnosticsConfigFeaturesNV.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceDiagnosticsConfigFeaturesNV> consumer) {
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceDiagnosticsConfigFeaturesNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceDiagnosticsConfigFeaturesNV> {
    ...
    public VkPhysicalDeviceDiagnosticsConfigFeaturesNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceDiagnosticsConfigFeaturesNV pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDeviceDiagnosticsConfigFeaturesNV diagnosticsConfig(@NativeType("VkBool32") @Unsigned int value) {

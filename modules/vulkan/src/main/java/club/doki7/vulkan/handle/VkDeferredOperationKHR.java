...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDeferredOperationKHR.html"><code>VkDeferredOperationKHR</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDeferredOperationKHR.html"><code>VkDeferredOperationKHR</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkDeferredOperationKHR(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDeferredOperationKHR.html"><code>VkDeferredOperationKHR</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkDeferredOperationKHR> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkDeferredOperationKHR read() {
            MemorySegment s = readRaw();
            if (s.equals(MemorySegment.NULL)) {
                return null;
            }
            return new VkDeferredOperationKHR(s);
        }

        public void write(@Nullable VkDeferredOperationKHR value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkDeferredOperationKHR read(long index) {
        ...
        public void write(long index, @Nullable VkDeferredOperationKHR value) {
        ...
        public static Ptr allocate(Arena arena, @Nullable VkDeferredOperationKHR @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkDeferredOperationKHR> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkDeferredOperationKHR value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        private static class Iter implements Iterator<VkDeferredOperationKHR> {
            ...
            @Override
            public @Nullable VkDeferredOperationKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                MemorySegment s = segment.get(ValueLayout.ADDRESS, 0);
                segment = segment.asSlice(ValueLayout.ADDRESS.byteSize());
                return s.equals(MemorySegment.NULL) ? null : new VkDeferredOperationKHR(s);
            }

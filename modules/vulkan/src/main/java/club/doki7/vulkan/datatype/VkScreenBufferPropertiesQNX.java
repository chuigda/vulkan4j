...
public record VkScreenBufferPropertiesQNX(@NotNull MemorySegment segment) implements IVkScreenBufferPropertiesQNX {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkScreenBufferPropertiesQNX, Iterable<VkScreenBufferPropertiesQNX> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkScreenBufferPropertiesQNX.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkScreenBufferPropertiesQNX.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkScreenBufferPropertiesQNX.BYTES,
                (end - start) * VkScreenBufferPropertiesQNX.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkScreenBufferPropertiesQNX.BYTES));
        }

        public VkScreenBufferPropertiesQNX[] toArray() {
            VkScreenBufferPropertiesQNX[] ret = new VkScreenBufferPropertiesQNX[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkScreenBufferPropertiesQNX> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkScreenBufferPropertiesQNX> {
            ...
            @Override
            public VkScreenBufferPropertiesQNX next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkScreenBufferPropertiesQNX ret = new VkScreenBufferPropertiesQNX(segment.asSlice(0, VkScreenBufferPropertiesQNX.BYTES));
                segment = segment.asSlice(VkScreenBufferPropertiesQNX.BYTES);
                return ret;
            }
    ...
    public VkScreenBufferPropertiesQNX allocationSize(@NativeType("VkDeviceSize") @Unsigned long value) {
    ...
    public VkScreenBufferPropertiesQNX memoryTypeBits(@Unsigned int value) {

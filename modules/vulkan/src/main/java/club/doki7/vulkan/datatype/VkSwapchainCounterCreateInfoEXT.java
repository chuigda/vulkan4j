...
/// Represents a pointer to a <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSwapchainCounterCreateInfoEXT.html"><code>VkSwapchainCounterCreateInfoEXT</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
///     VkSurfaceCounterFlagsEXT surfaceCounters; // optional // @link substring="VkSurfaceCounterFlagsEXT" target="VkSurfaceCounterFlagsEXT" @link substring="surfaceCounters" target="#surfaceCounters"
...
public record VkSwapchainCounterCreateInfoEXT(@NotNull MemorySegment segment) implements IVkSwapchainCounterCreateInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSwapchainCounterCreateInfoEXT, Iterable<VkSwapchainCounterCreateInfoEXT> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkSwapchainCounterCreateInfoEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkSwapchainCounterCreateInfoEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkSwapchainCounterCreateInfoEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkSwapchainCounterCreateInfoEXT.BYTES,
                (end - start) * VkSwapchainCounterCreateInfoEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkSwapchainCounterCreateInfoEXT.BYTES));
        }

        public VkSwapchainCounterCreateInfoEXT[] toArray() {
            VkSwapchainCounterCreateInfoEXT[] ret = new VkSwapchainCounterCreateInfoEXT[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkSwapchainCounterCreateInfoEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkSwapchainCounterCreateInfoEXT> {
            ...
            @Override
            public VkSwapchainCounterCreateInfoEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkSwapchainCounterCreateInfoEXT ret = new VkSwapchainCounterCreateInfoEXT(segment.asSlice(0, VkSwapchainCounterCreateInfoEXT.BYTES));
                segment = segment.asSlice(VkSwapchainCounterCreateInfoEXT.BYTES);
                return ret;
            }
    ...
    public VkSwapchainCounterCreateInfoEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkSwapchainCounterCreateInfoEXT pNext(@Nullable IPointer pointer) {

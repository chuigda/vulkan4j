...
public record VkCooperativeMatrixPropertiesNV(@NotNull MemorySegment segment) implements IVkCooperativeMatrixPropertiesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkCooperativeMatrixPropertiesNV, Iterable<VkCooperativeMatrixPropertiesNV> {
        ...
        public VkCooperativeMatrixPropertiesNV.Ptr at(long index, @NotNull Consumer<@NotNull VkCooperativeMatrixPropertiesNV> consumer) {
    ...
    public VkCooperativeMatrixPropertiesNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

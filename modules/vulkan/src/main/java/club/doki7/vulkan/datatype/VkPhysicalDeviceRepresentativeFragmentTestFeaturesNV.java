...
public record VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRepresentativeFragmentTestFeaturesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRepresentativeFragmentTestFeaturesNV, Iterable<VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV> {
            ...
            @Override
            public VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV ret = new VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV(segment.asSlice(0, VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV representativeFragmentTest(@NativeType("VkBool32") @Unsigned int value) {

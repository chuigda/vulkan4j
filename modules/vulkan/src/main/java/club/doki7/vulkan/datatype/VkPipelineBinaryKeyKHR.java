...
///
/// The {@code allocate} ({@link VkPipelineBinaryKeyKHR#allocate(Arena)}, {@link VkPipelineBinaryKeyKHR#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkPipelineBinaryKeyKHR#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPipelineBinaryKeyKHR(@NotNull MemorySegment segment) implements IVkPipelineBinaryKeyKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineBinaryKeyKHR.html"><code>VkPipelineBinaryKeyKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPipelineBinaryKeyKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPipelineBinaryKeyKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPipelineBinaryKeyKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineBinaryKeyKHR, Iterable<VkPipelineBinaryKeyKHR> {
        ...
        public @NotNull VkPipelineBinaryKeyKHR at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPipelineBinaryKeyKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPipelineBinaryKeyKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPipelineBinaryKeyKHR.BYTES,
                (end - start) * VkPipelineBinaryKeyKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPipelineBinaryKeyKHR.BYTES));
        }

        public VkPipelineBinaryKeyKHR[] toArray() {
            VkPipelineBinaryKeyKHR[] ret = new VkPipelineBinaryKeyKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPipelineBinaryKeyKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPipelineBinaryKeyKHR> {
    ...
    public static VkPipelineBinaryKeyKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPipelineBinaryKeyKHR.Ptr ret = new VkPipelineBinaryKeyKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PIPELINE_BINARY_KEY_KHR);
        }
        return ret;
    }
    ...
    public VkPipelineBinaryKeyKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

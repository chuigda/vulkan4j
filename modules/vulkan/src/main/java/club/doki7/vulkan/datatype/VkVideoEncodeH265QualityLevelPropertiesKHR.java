...
public record VkVideoEncodeH265QualityLevelPropertiesKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH265QualityLevelPropertiesKHR {
    ...
    public VkVideoEncodeH265QualityLevelPropertiesKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public @MagicConstant(valuesFromClass = VkVideoEncodeH265RateControlFlagsKHR.class) int preferredRateControlFlags() {
        return segment.get(LAYOUT$preferredRateControlFlags, OFFSET$preferredRateControlFlags);
    }

    public VkVideoEncodeH265QualityLevelPropertiesKHR preferredRateControlFlags(@MagicConstant(valuesFromClass = VkVideoEncodeH265RateControlFlagsKHR.class) int value) {

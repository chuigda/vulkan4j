...
public record VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI(@NotNull MemorySegment segment) implements IVkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI, Iterable<VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI> {
        public long size() {
        ...
        public VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.Ptr at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.BYTES,
                (end - start) * VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.BYTES));
        }

        public VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI[] toArray() {
            VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI[] ret = new VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI[(int) size()];
        ...
        private static final class Iter implements Iterator<VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI> {
            ...
            @Override
            public VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI ret = new VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI(segment.asSlice(0, VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {

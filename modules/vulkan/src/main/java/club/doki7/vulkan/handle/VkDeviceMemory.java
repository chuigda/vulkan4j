...
/// Represents an opaque handle type <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDeviceMemory.html"><code>VkDeviceMemory</code></a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDeviceMemory.html"><code>VkDeviceMemory</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkDeviceMemory(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDeviceMemory.html"><code>VkDeviceMemory</code></a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkDeviceMemory> {
        public long size() {
            return segment.byteSize() / ValueLayout.ADDRESS.byteSize();
        }

        public @Nullable VkDeviceMemory read() {
        ...
        public void write(@Nullable VkDeviceMemory value) {
            writeRaw(value == null ? MemorySegment.NULL : value.segment());
        }

        public @Nullable VkDeviceMemory read(long index) {
        ...
        public void write(long index, @Nullable VkDeviceMemory value) {
            writeRaw(index, value == null ? MemorySegment.NULL : value.segment());
        }

        public void write(@Nullable VkDeviceMemory[] values) {
            for (int i = 0; i < values.length; i++) {
                write(i, values[i]);
            }
        }

        public void writeV(@Nullable VkDeviceMemory value0, @Nullable VkDeviceMemory ...values) {
            write(value0);
            for (int i = 0; i < values.length; i++) {
                write(i + 1, values[i]);
            }
        ...
        public static Ptr allocate(Arena arena, @Nullable VkDeviceMemory @NotNull [] values) {
        ...
        public static Ptr allocate(Arena arena, @NotNull Collection<@Nullable VkDeviceMemory> values) {
            Ptr ret = allocate(arena, values.size());
            int i = 0;
            for (@Nullable VkDeviceMemory value : values) {
                ret.write(i, value);
                i += 1;
            }
            return ret;
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkDeviceMemory value0, @Nullable VkDeviceMemory ...values) {
        ...
        @Override
        public @NotNull Iterator<VkDeviceMemory> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<VkDeviceMemory> {

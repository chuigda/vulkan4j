...
public record VkAndroidHardwareBufferFormatProperties2ANDROID(@NotNull MemorySegment segment) implements IVkAndroidHardwareBufferFormatProperties2ANDROID {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkAndroidHardwareBufferFormatProperties2ANDROID, Iterable<VkAndroidHardwareBufferFormatProperties2ANDROID> {
        ...
        public VkAndroidHardwareBufferFormatProperties2ANDROID.Ptr at(long index, @NotNull Consumer<@NotNull VkAndroidHardwareBufferFormatProperties2ANDROID> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkAndroidHardwareBufferFormatProperties2ANDROID.BYTES));
        }
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkAndroidHardwareBufferFormatProperties2ANDROID pNext(@Nullable IPointer pointer) {
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID externalFormat(@Unsigned long value) {
        segment.set(LAYOUT$externalFormat, OFFSET$externalFormat, value);
        return this;
    }

    public @Bitmask(VkFormatFeatureFlags2.class) long formatFeatures() {
        return segment.get(LAYOUT$formatFeatures, OFFSET$formatFeatures);
    }

    public VkAndroidHardwareBufferFormatProperties2ANDROID formatFeatures(@Bitmask(VkFormatFeatureFlags2.class) long value) {
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID samplerYcbcrConversionComponents(@NotNull VkComponentMapping value) {
        MemorySegment.copy(value.segment(), 0, segment, OFFSET$samplerYcbcrConversionComponents, SIZE$samplerYcbcrConversionComponents);
        return this;
    }

    public VkAndroidHardwareBufferFormatProperties2ANDROID samplerYcbcrConversionComponents(Consumer<@NotNull VkComponentMapping> consumer) {

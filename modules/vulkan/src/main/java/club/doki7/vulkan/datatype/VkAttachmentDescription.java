...
public record VkAttachmentDescription(@NotNull MemorySegment segment) implements IVkAttachmentDescription {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAttachmentDescription, Iterable<VkAttachmentDescription> {
        public long size() {
        ...
        public VkAttachmentDescription.Ptr at(long index, @NotNull Consumer<@NotNull VkAttachmentDescription> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkAttachmentDescription.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkAttachmentDescription> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkAttachmentDescription> {
            ...
            @Override
            public VkAttachmentDescription next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkAttachmentDescription ret = new VkAttachmentDescription(segment.asSlice(0, VkAttachmentDescription.BYTES));
                segment = segment.asSlice(VkAttachmentDescription.BYTES);
                return ret;
            }

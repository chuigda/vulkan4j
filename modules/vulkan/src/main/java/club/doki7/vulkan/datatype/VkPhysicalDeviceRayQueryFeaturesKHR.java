...
///
/// The {@code allocate} ({@link VkPhysicalDeviceRayQueryFeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceRayQueryFeaturesKHR#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceRayQueryFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRayQueryFeaturesKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceRayQueryFeaturesKHR.html"><code>VkPhysicalDeviceRayQueryFeaturesKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceRayQueryFeaturesKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceRayQueryFeaturesKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceRayQueryFeaturesKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRayQueryFeaturesKHR, Iterable<VkPhysicalDeviceRayQueryFeaturesKHR> {
        ...
        public @NotNull VkPhysicalDeviceRayQueryFeaturesKHR at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceRayQueryFeaturesKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceRayQueryFeaturesKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceRayQueryFeaturesKHR.BYTES,
                (end - start) * VkPhysicalDeviceRayQueryFeaturesKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceRayQueryFeaturesKHR.BYTES));
        }

        public VkPhysicalDeviceRayQueryFeaturesKHR[] toArray() {
            VkPhysicalDeviceRayQueryFeaturesKHR[] ret = new VkPhysicalDeviceRayQueryFeaturesKHR[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceRayQueryFeaturesKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceRayQueryFeaturesKHR> {
    ...
    public static VkPhysicalDeviceRayQueryFeaturesKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceRayQueryFeaturesKHR.Ptr ret = new VkPhysicalDeviceRayQueryFeaturesKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceRayQueryFeaturesKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

...
public record VkAndroidHardwareBufferFormatPropertiesANDROID(@NotNull MemorySegment segment) implements IVkAndroidHardwareBufferFormatPropertiesANDROID {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAndroidHardwareBufferFormatPropertiesANDROID, Iterable<VkAndroidHardwareBufferFormatPropertiesANDROID> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkAndroidHardwareBufferFormatPropertiesANDROID.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkAndroidHardwareBufferFormatPropertiesANDROID> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkAndroidHardwareBufferFormatPropertiesANDROID> {
            ...
            @Override
            public VkAndroidHardwareBufferFormatPropertiesANDROID next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkAndroidHardwareBufferFormatPropertiesANDROID ret = new VkAndroidHardwareBufferFormatPropertiesANDROID(segment.asSlice(0, VkAndroidHardwareBufferFormatPropertiesANDROID.BYTES));
                segment = segment.asSlice(VkAndroidHardwareBufferFormatPropertiesANDROID.BYTES);
                return ret;
            }
    ...
    public VkAndroidHardwareBufferFormatPropertiesANDROID sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkAndroidHardwareBufferFormatPropertiesANDROID format(@MagicConstant(valuesFromClass = VkFormat.class) int value) {
    ...
    public VkAndroidHardwareBufferFormatPropertiesANDROID externalFormat(@Unsigned long value) {
    ...
    public VkAndroidHardwareBufferFormatPropertiesANDROID formatFeatures(@MagicConstant(valuesFromClass = VkFormatFeatureFlags.class) int value) {
    ...
    public VkAndroidHardwareBufferFormatPropertiesANDROID suggestedYcbcrModel(@MagicConstant(valuesFromClass = VkSamplerYcbcrModelConversion.class) int value) {
    ...
    public VkAndroidHardwareBufferFormatPropertiesANDROID suggestedYcbcrRange(@MagicConstant(valuesFromClass = VkSamplerYcbcrRange.class) int value) {
    ...
    public VkAndroidHardwareBufferFormatPropertiesANDROID suggestedXChromaOffset(@MagicConstant(valuesFromClass = VkChromaLocation.class) int value) {
    ...
    public VkAndroidHardwareBufferFormatPropertiesANDROID suggestedYChromaOffset(@MagicConstant(valuesFromClass = VkChromaLocation.class) int value) {

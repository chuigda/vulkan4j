...
///
/// The {@code allocate} ({@link VkDevicePipelineBinaryInternalCacheControlKHR#allocate(Arena)}, {@link VkDevicePipelineBinaryInternalCacheControlKHR#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkDevicePipelineBinaryInternalCacheControlKHR(@NotNull MemorySegment segment) implements IVkDevicePipelineBinaryInternalCacheControlKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDevicePipelineBinaryInternalCacheControlKHR.html"><code>VkDevicePipelineBinaryInternalCacheControlKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkDevicePipelineBinaryInternalCacheControlKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkDevicePipelineBinaryInternalCacheControlKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkDevicePipelineBinaryInternalCacheControlKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDevicePipelineBinaryInternalCacheControlKHR, Iterable<VkDevicePipelineBinaryInternalCacheControlKHR> {
        public long size() {
            return segment.byteSize() / VkDevicePipelineBinaryInternalCacheControlKHR.BYTES;
        }
        ...
        public @NotNull VkDevicePipelineBinaryInternalCacheControlKHR at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkDevicePipelineBinaryInternalCacheControlKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkDevicePipelineBinaryInternalCacheControlKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkDevicePipelineBinaryInternalCacheControlKHR.BYTES,
                (end - start) * VkDevicePipelineBinaryInternalCacheControlKHR.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkDevicePipelineBinaryInternalCacheControlKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkDevicePipelineBinaryInternalCacheControlKHR> {
            ...
            @Override
            public VkDevicePipelineBinaryInternalCacheControlKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkDevicePipelineBinaryInternalCacheControlKHR ret = new VkDevicePipelineBinaryInternalCacheControlKHR(segment.asSlice(0, VkDevicePipelineBinaryInternalCacheControlKHR.BYTES));
                segment = segment.asSlice(VkDevicePipelineBinaryInternalCacheControlKHR.BYTES);
                return ret;
            }
    ...
    public static VkDevicePipelineBinaryInternalCacheControlKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkDevicePipelineBinaryInternalCacheControlKHR.Ptr ret = new VkDevicePipelineBinaryInternalCacheControlKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.DEVICE_PIPELINE_BINARY_INTERNAL_CACHE_CONTROL_KHR);
        }
        return ret;
    }
    ...
    public VkDevicePipelineBinaryInternalCacheControlKHR sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {

...
public record VkPhysicalDeviceVertexAttributeDivisorProperties(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVertexAttributeDivisorProperties {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVertexAttributeDivisorProperties, Iterable<VkPhysicalDeviceVertexAttributeDivisorProperties> {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceVertexAttributeDivisorProperties.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceVertexAttributeDivisorProperties> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceVertexAttributeDivisorProperties> {

...
public record VkDescriptorUpdateTemplateEntry(@NotNull MemorySegment segment) implements IVkDescriptorUpdateTemplateEntry {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDescriptorUpdateTemplateEntry, Iterable<VkDescriptorUpdateTemplateEntry> {
        public long size() {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkDescriptorUpdateTemplateEntry> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkDescriptorUpdateTemplateEntry.BYTES));
        }
        ...
        private static final class Iter implements Iterator<VkDescriptorUpdateTemplateEntry> {
            ...
            @Override
            public VkDescriptorUpdateTemplateEntry next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkDescriptorUpdateTemplateEntry ret = new VkDescriptorUpdateTemplateEntry(segment.asSlice(0, VkDescriptorUpdateTemplateEntry.BYTES));
                segment = segment.asSlice(VkDescriptorUpdateTemplateEntry.BYTES);
                return ret;
            }

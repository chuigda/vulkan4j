...
public record StdVideoDecodeAV1ReferenceInfoFlags(@NotNull MemorySegment segment) implements IStdVideoDecodeAV1ReferenceInfoFlags {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoDecodeAV1ReferenceInfoFlags, Iterable<StdVideoDecodeAV1ReferenceInfoFlags> {
        public long size() {
        ...
        public StdVideoDecodeAV1ReferenceInfoFlags.Ptr at(long index, @NotNull Consumer<@NotNull StdVideoDecodeAV1ReferenceInfoFlags> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * StdVideoDecodeAV1ReferenceInfoFlags.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<StdVideoDecodeAV1ReferenceInfoFlags> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoDecodeAV1ReferenceInfoFlags> {
            ...
            @Override
            public StdVideoDecodeAV1ReferenceInfoFlags next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                StdVideoDecodeAV1ReferenceInfoFlags ret = new StdVideoDecodeAV1ReferenceInfoFlags(segment.asSlice(0, StdVideoDecodeAV1ReferenceInfoFlags.BYTES));
                segment = segment.asSlice(StdVideoDecodeAV1ReferenceInfoFlags.BYTES);
                return ret;
            }
    ...
    public StdVideoDecodeAV1ReferenceInfoFlags disable_frame_end_update_cdf(boolean value) {
        MemorySegment s = segment.asSlice(OFFSET$bitfield$disable_frame_end_update_cdf$reserved, LAYOUT$bitfield$disable_frame_end_update_cdf$reserved);
    ...
    public StdVideoDecodeAV1ReferenceInfoFlags segmentation_enabled(boolean value) {
        MemorySegment s = segment.asSlice(OFFSET$bitfield$disable_frame_end_update_cdf$reserved, LAYOUT$bitfield$disable_frame_end_update_cdf$reserved);

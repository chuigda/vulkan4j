...
public record VkPhysicalDeviceCooperativeMatrixPropertiesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCooperativeMatrixPropertiesNV {
    ...
    public VkPhysicalDeviceCooperativeMatrixPropertiesNV sType(@MagicConstant(valuesFromClass = VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceCooperativeMatrixPropertiesNV cooperativeMatrixSupportedStages(@MagicConstant(valuesFromClass = VkShaderStageFlags.class) int value) {

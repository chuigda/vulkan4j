...
///
/// The {@code allocate} ({@link VkPhysicalDeviceExternalMemoryHostPropertiesEXT#allocate(Arena)}, {@link VkPhysicalDeviceExternalMemoryHostPropertiesEXT#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceExternalMemoryHostPropertiesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalMemoryHostPropertiesEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceExternalMemoryHostPropertiesEXT.html"><code>VkPhysicalDeviceExternalMemoryHostPropertiesEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceExternalMemoryHostPropertiesEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceExternalMemoryHostPropertiesEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceExternalMemoryHostPropertiesEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalMemoryHostPropertiesEXT, Iterable<VkPhysicalDeviceExternalMemoryHostPropertiesEXT> {
        ...
        public @NotNull VkPhysicalDeviceExternalMemoryHostPropertiesEXT at(long index) {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceExternalMemoryHostPropertiesEXT> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceExternalMemoryHostPropertiesEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceExternalMemoryHostPropertiesEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceExternalMemoryHostPropertiesEXT.BYTES,
                (end - start) * VkPhysicalDeviceExternalMemoryHostPropertiesEXT.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceExternalMemoryHostPropertiesEXT> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceExternalMemoryHostPropertiesEXT> {
    ...
    public static VkPhysicalDeviceExternalMemoryHostPropertiesEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceExternalMemoryHostPropertiesEXT.Ptr ret = new VkPhysicalDeviceExternalMemoryHostPropertiesEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_EXTERNAL_MEMORY_HOST_PROPERTIES_EXT);
        }
        return ret;
    }
    ...
    public VkPhysicalDeviceExternalMemoryHostPropertiesEXT sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceExternalMemoryHostPropertiesEXT pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceExternalMemoryHostPropertiesEXT pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDeviceExternalMemoryHostPropertiesEXT minImportedHostPointerAlignment(@NativeType("VkDeviceSize") @Unsigned long value) {

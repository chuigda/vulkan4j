...
public record VkPhysicalDeviceShaderDrawParametersFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderDrawParametersFeatures {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderDrawParametersFeatures, Iterable<VkPhysicalDeviceShaderDrawParametersFeatures> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceShaderDrawParametersFeatures.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceShaderDrawParametersFeatures.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceShaderDrawParametersFeatures.BYTES,
                (end - start) * VkPhysicalDeviceShaderDrawParametersFeatures.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceShaderDrawParametersFeatures.BYTES));
        }

        public VkPhysicalDeviceShaderDrawParametersFeatures[] toArray() {
            VkPhysicalDeviceShaderDrawParametersFeatures[] ret = new VkPhysicalDeviceShaderDrawParametersFeatures[(int) size()];
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceShaderDrawParametersFeatures> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceShaderDrawParametersFeatures> {
            ...
            @Override
            public VkPhysicalDeviceShaderDrawParametersFeatures next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceShaderDrawParametersFeatures ret = new VkPhysicalDeviceShaderDrawParametersFeatures(segment.asSlice(0, VkPhysicalDeviceShaderDrawParametersFeatures.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceShaderDrawParametersFeatures.BYTES);
                return ret;
            }
    ...
    public VkPhysicalDeviceShaderDrawParametersFeatures sType(@EnumType(VkStructureType.class) int value) {
    ...
    public VkPhysicalDeviceShaderDrawParametersFeatures pNext(@Pointer(comment="void*") @NotNull MemorySegment value) {
        segment.set(LAYOUT$pNext, OFFSET$pNext, value);
        return this;
    }

    public VkPhysicalDeviceShaderDrawParametersFeatures pNext(@Nullable IPointer pointer) {
    ...
    public VkPhysicalDeviceShaderDrawParametersFeatures shaderDrawParameters(@NativeType("VkBool32") @Unsigned int value) {

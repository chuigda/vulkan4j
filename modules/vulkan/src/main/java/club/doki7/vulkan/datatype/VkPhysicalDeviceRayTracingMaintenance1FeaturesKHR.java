...
public record VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRayTracingMaintenance1FeaturesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRayTracingMaintenance1FeaturesKHR, Iterable<VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR> {
        ...
        public void at(long index, @NotNull Consumer<@NotNull VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR> consumer) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR> {

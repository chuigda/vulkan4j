...
public final class GLFWConstants {
    ...
    public static final int DONT_CARE = -1; // alias for -1
    public static final int GAMEPAD_AXIS_LAST = GAMEPAD_AXIS_RIGHT_TRIGGER; // alias for GAMEPAD_AXIS_RIGHT_TRIGGER
    public static final int GAMEPAD_BUTTON_CIRCLE = GAMEPAD_BUTTON_B; // alias for GAMEPAD_BUTTON_B
    public static final int GAMEPAD_BUTTON_CROSS = GAMEPAD_BUTTON_A; // alias for GAMEPAD_BUTTON_A
    public static final int GAMEPAD_BUTTON_LAST = GAMEPAD_BUTTON_DPAD_LEFT; // alias for GAMEPAD_BUTTON_DPAD_LEFT
    public static final int GAMEPAD_BUTTON_SQUARE = GAMEPAD_BUTTON_X; // alias for GAMEPAD_BUTTON_X
    public static final int GAMEPAD_BUTTON_TRIANGLE = GAMEPAD_BUTTON_Y; // alias for GAMEPAD_BUTTON_Y
    public static final int HAND_CURSOR = POINTING_HAND_CURSOR; // alias for POINTING_HAND_CURSOR
    public static final int HAT_LEFT_DOWN = (HAT_LEFT  | HAT_DOWN); // alias for (HAT_LEFT  | HAT_DOWN)
    public static final int HAT_LEFT_UP = (HAT_LEFT  | HAT_UP); // alias for (HAT_LEFT  | HAT_UP)
    public static final int HAT_RIGHT_DOWN = (HAT_RIGHT | HAT_DOWN); // alias for (HAT_RIGHT | HAT_DOWN)
    public static final int HAT_RIGHT_UP = (HAT_RIGHT | HAT_UP); // alias for (HAT_RIGHT | HAT_UP)
    public static final int HRESIZE_CURSOR = RESIZE_EW_CURSOR; // alias for RESIZE_EW_CURSOR
    public static final int JOYSTICK_LAST = JOYSTICK_16; // alias for JOYSTICK_16
    public static final int KEY_APOSTROPHE = 39  /* ' */; // alias for 39  /* ' */
    public static final int KEY_BACKSLASH = 92  /* \ */; // alias for 92  /* \ */
    public static final int KEY_COMMA = 44  /* , */; // alias for 44  /* , */
    public static final int KEY_EQUAL = 61  /* = */; // alias for 61  /* = */
    public static final int KEY_GRAVE_ACCENT = 96  /* ` */; // alias for 96  /* ` */
    public static final int KEY_LAST = KEY_MENU; // alias for KEY_MENU
    public static final int KEY_LEFT_BRACKET = 91  /* [ */; // alias for 91  /* [ */
    public static final int KEY_MINUS = 45  /* - */; // alias for 45  /* - */
    public static final int KEY_PERIOD = 46  /* . */; // alias for 46  /* . */
    public static final int KEY_RIGHT_BRACKET = 93  /* ] */; // alias for 93  /* ] */
    public static final int KEY_SEMICOLON = 59  /* ; */; // alias for 59  /* ; */
    public static final int KEY_SLASH = 47  /* / */; // alias for 47  /* / */
    public static final int KEY_UNKNOWN = -1; // alias for -1
    public static final int KEY_WORLD_1 = 161 /* non-US #1 */; // alias for 161 /* non-US #1 */
    public static final int KEY_WORLD_2 = 162 /* non-US #2 */; // alias for 162 /* non-US #2 */
    public static final int MOUSE_BUTTON_LAST = MOUSE_BUTTON_8; // alias for MOUSE_BUTTON_8
    public static final int MOUSE_BUTTON_LEFT = MOUSE_BUTTON_1; // alias for MOUSE_BUTTON_1
    public static final int MOUSE_BUTTON_MIDDLE = MOUSE_BUTTON_3; // alias for MOUSE_BUTTON_3
    public static final int MOUSE_BUTTON_RIGHT = MOUSE_BUTTON_2; // alias for MOUSE_BUTTON_2
    public static final int OPENGL_DEBUG_CONTEXT = CONTEXT_DEBUG; // alias for CONTEXT_DEBUG
    public static final int VRESIZE_CURSOR = RESIZE_NS_CURSOR; // alias for RESIZE_NS_CURSOR

...
public record VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$descriptorSetHostMapping = ValueLayout.JAVA_INT.withName("descriptorSetHostMapping");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$descriptorSetHostMapping);

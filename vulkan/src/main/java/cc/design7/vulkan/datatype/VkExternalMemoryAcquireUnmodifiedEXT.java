...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkExternalMemoryAcquireUnmodifiedEXT.html">VkExternalMemoryAcquireUnmodifiedEXT</a>
@ValueBasedCandidate
public record VkExternalMemoryAcquireUnmodifiedEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$acquireUnmodifiedMemory = ValueLayout.JAVA_INT.withName("acquireUnmodifiedMemory");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$acquireUnmodifiedMemory);

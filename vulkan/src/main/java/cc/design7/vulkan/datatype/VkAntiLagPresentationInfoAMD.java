...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkAntiLagPresentationInfoAMD.html">VkAntiLagPresentationInfoAMD</a>
@ValueBasedCandidate
public record VkAntiLagPresentationInfoAMD(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfLong LAYOUT$frameIndex = ValueLayout.JAVA_LONG.withName("frameIndex");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$stage, LAYOUT$frameIndex);

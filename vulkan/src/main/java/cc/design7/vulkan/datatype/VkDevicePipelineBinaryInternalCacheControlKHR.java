...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDevicePipelineBinaryInternalCacheControlKHR.html">VkDevicePipelineBinaryInternalCacheControlKHR</a>
@ValueBasedCandidate
public record VkDevicePipelineBinaryInternalCacheControlKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$disableInternalCache = ValueLayout.JAVA_INT.withName("disableInternalCache");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$disableInternalCache);

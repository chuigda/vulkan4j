...
public record VkPhysicalDeviceShaderClockFeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$shaderSubgroupClock = ValueLayout.JAVA_INT.withName("shaderSubgroupClock");
    public static final OfInt LAYOUT$shaderDeviceClock = ValueLayout.JAVA_INT.withName("shaderDeviceClock");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$shaderSubgroupClock, LAYOUT$shaderDeviceClock);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCheckpointDataNV.html">VkCheckpointDataNV</a>
@ValueBasedCandidate
public record VkCheckpointDataNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$pCheckpointMarker = ValueLayout.ADDRESS.withName("pCheckpointMarker");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$stage, LAYOUT$pCheckpointMarker);

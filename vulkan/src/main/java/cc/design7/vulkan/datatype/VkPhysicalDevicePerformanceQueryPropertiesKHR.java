...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevicePerformanceQueryPropertiesKHR.html">VkPhysicalDevicePerformanceQueryPropertiesKHR</a>
@ValueBasedCandidate
public record VkPhysicalDevicePerformanceQueryPropertiesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$allowCommandBufferQueryCopies = ValueLayout.JAVA_INT.withName("allowCommandBufferQueryCopies");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$allowCommandBufferQueryCopies);
    ...
    public static final PathElement PATH$allowCommandBufferQueryCopies = PathElement.groupElement("PATH$allowCommandBufferQueryCopies");

...
///
/// The {@link VkBufferCollectionPropertiesFUCHSIA#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkBufferCollectionPropertiesFUCHSIA#autoInit} to initialize these fields manually for
...
public record VkBufferCollectionPropertiesFUCHSIA(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final PathElement PATH$createInfoIndex = PathElement.groupElement("PATH$createInfoIndex");
    ...
    public static final PathElement PATH$sysmemColorSpaceIndex = PathElement.groupElement("PATH$sysmemColorSpaceIndex");

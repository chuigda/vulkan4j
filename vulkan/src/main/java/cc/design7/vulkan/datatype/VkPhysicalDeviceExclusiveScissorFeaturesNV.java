...
public record VkPhysicalDeviceExclusiveScissorFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$exclusiveScissor = ValueLayout.JAVA_INT.withName("exclusiveScissor");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$exclusiveScissor);

...
public record VkPipelineShaderStageModuleIdentifierCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$pIdentifier = ValueLayout.ADDRESS.withTargetLayout(ValueLayout.JAVA_BYTE).withName("pIdentifier");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$identifierSize, LAYOUT$pIdentifier);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT.html">VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfByte LAYOUT$shaderModuleIdentifierAlgorithmUUID = ValueLayout.JAVA_BYTE.withName("shaderModuleIdentifierAlgorithmUUID");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$shaderModuleIdentifierAlgorithmUUID);

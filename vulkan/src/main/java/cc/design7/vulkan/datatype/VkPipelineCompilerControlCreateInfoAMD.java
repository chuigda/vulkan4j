...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineCompilerControlCreateInfoAMD.html">VkPipelineCompilerControlCreateInfoAMD</a>
@ValueBasedCandidate
public record VkPipelineCompilerControlCreateInfoAMD(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$compilerControlFlags = ValueLayout.JAVA_INT.withName("compilerControlFlags");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$compilerControlFlags);

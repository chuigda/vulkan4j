...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPerformanceStreamMarkerInfoINTEL.html">VkPerformanceStreamMarkerInfoINTEL</a>
@ValueBasedCandidate
public record VkPerformanceStreamMarkerInfoINTEL(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$marker = ValueLayout.JAVA_INT.withName("marker");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$marker);

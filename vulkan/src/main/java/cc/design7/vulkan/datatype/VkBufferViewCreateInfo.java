...
public record VkBufferViewCreateInfo(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$flags, LAYOUT$buffer, LAYOUT$format, LAYOUT$offset, LAYOUT$range);

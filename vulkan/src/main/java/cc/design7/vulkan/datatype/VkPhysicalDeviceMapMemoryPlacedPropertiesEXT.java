...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceMapMemoryPlacedPropertiesEXT.html">VkPhysicalDeviceMapMemoryPlacedPropertiesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceMapMemoryPlacedPropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    public static final OfInt LAYOUT$sType = ValueLayout.JAVA_INT.withName("sType");
    public static final AddressLayout LAYOUT$pNext = ValueLayout.ADDRESS.withName("pNext");
    public static final OfLong LAYOUT$minPlacedMemoryMapAlignment = ValueLayout.JAVA_LONG.withName("minPlacedMemoryMapAlignment");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$minPlacedMemoryMapAlignment);
    ...
    public static VkPhysicalDeviceMapMemoryPlacedPropertiesEXT[] clone(Arena arena, VkPhysicalDeviceMapMemoryPlacedPropertiesEXT[] src) {
        VkPhysicalDeviceMapMemoryPlacedPropertiesEXT[] ret = allocate(arena, src.length);
    ...
    public static final PathElement PATH$minPlacedMemoryMapAlignment = PathElement.groupElement("PATH$minPlacedMemoryMapAlignment");

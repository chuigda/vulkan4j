...
public record VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$triStripVertexOrderIndependentOfProvokingVertex = ValueLayout.JAVA_INT.withName("triStripVertexOrderIndependentOfProvokingVertex");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$triStripVertexOrderIndependentOfProvokingVertex);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkMetalSurfaceCreateInfoEXT.html">VkMetalSurfaceCreateInfoEXT</a>
@ValueBasedCandidate
public record VkMetalSurfaceCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$pLayer = ValueLayout.ADDRESS.withTargetLayout(ValueLayout.ADDRESS).withName("pLayer");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$flags, LAYOUT$pLayer);

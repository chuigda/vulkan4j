...
///
/// The {@link VkMetalSurfaceCreateInfoEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkMetalSurfaceCreateInfoEXT#autoInit} to initialize these fields manually for
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkMetalSurfaceCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkMetalSurfaceCreateInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkMetalSurfaceCreateInfoEXT(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.METAL_SURFACE_CREATE_INFO_EXT);
        }
        return ret;
    }
    ...
    public @Nullable PointerBuffer pLayer() {
    ...
    public void pLayer(@Nullable PointerBuffer value) {
    ...
    public static final PathElement PATH$pLayer = PathElement.groupElement("PATH$pLayer");

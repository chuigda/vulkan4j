...
public record VkPhysicalDeviceHdrVividFeaturesHUAWEI(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$hdrVivid = ValueLayout.JAVA_INT.withName("hdrVivid");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$hdrVivid);

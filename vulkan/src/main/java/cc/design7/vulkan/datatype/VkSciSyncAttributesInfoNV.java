...
public record VkSciSyncAttributesInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$clientType = ValueLayout.JAVA_INT.withName("clientType");
    public static final OfInt LAYOUT$primitiveType = ValueLayout.JAVA_INT.withName("primitiveType");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$clientType, LAYOUT$primitiveType);

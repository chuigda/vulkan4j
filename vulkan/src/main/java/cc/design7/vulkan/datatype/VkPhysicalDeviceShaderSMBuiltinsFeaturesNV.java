...
public record VkPhysicalDeviceShaderSMBuiltinsFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$shaderSMBuiltins = ValueLayout.JAVA_INT.withName("shaderSMBuiltins");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$shaderSMBuiltins);

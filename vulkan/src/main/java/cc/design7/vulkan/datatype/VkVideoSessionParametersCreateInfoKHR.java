...
public record VkVideoSessionParametersCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$videoSessionParametersTemplate = ValueLayout.ADDRESS.withName("videoSessionParametersTemplate");
    public static final AddressLayout LAYOUT$videoSession = ValueLayout.ADDRESS.withName("videoSession");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$flags, LAYOUT$videoSessionParametersTemplate, LAYOUT$videoSession);
    ...
    public void videoSessionParametersTemplate() {

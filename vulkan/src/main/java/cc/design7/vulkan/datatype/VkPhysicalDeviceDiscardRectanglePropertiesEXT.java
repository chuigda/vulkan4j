...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceDiscardRectanglePropertiesEXT.html">VkPhysicalDeviceDiscardRectanglePropertiesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceDiscardRectanglePropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$maxDiscardRectangles = ValueLayout.JAVA_INT.withName("maxDiscardRectangles");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maxDiscardRectangles);

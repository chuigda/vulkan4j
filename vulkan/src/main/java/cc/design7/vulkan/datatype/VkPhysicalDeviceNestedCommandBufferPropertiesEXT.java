...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceNestedCommandBufferPropertiesEXT.html">VkPhysicalDeviceNestedCommandBufferPropertiesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceNestedCommandBufferPropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$maxCommandBufferNestingLevel = ValueLayout.JAVA_INT.withName("maxCommandBufferNestingLevel");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maxCommandBufferNestingLevel);

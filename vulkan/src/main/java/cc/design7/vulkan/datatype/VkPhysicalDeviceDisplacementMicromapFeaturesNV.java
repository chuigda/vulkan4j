...
public record VkPhysicalDeviceDisplacementMicromapFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$displacementMicromap = ValueLayout.JAVA_INT.withName("displacementMicromap");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$displacementMicromap);

...
///     VkMemoryToImageCopy const* pRegions;
...
///
/// The {@link VkCopyMemoryToImageInfo#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkCopyMemoryToImageInfo#autoInit} to initialize these fields manually for
...
public record VkCopyMemoryToImageInfo(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkCopyMemoryToImageInfo[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.COPY_MEMORY_TO_IMAGE_INFO);
        }
        return ret;
    }

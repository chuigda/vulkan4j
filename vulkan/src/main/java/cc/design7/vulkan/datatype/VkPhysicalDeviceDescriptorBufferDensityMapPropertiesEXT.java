...
public record VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final ValueLayout LAYOUT$combinedImageSamplerDensityMapDescriptorSize = NativeLayout.C_SIZE_T.withName("combinedImageSamplerDensityMapDescriptorSize");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$combinedImageSamplerDensityMapDescriptorSize);

...
///
/// The {@link VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_DENSITY_MAP_PROPERTIES_EXT);
        }
        return ret;
    }

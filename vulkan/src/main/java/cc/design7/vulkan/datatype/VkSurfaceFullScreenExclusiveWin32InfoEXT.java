...
public record VkSurfaceFullScreenExclusiveWin32InfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$hmonitor = ValueLayout.ADDRESS.withName("hmonitor");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$hmonitor);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT.html">VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$primitiveTopologyListRestart = ValueLayout.JAVA_INT.withName("primitiveTopologyListRestart");
    public static final OfInt LAYOUT$primitiveTopologyPatchListRestart = ValueLayout.JAVA_INT.withName("primitiveTopologyPatchListRestart");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$primitiveTopologyListRestart, LAYOUT$primitiveTopologyPatchListRestart);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkViSurfaceCreateInfoNN.html">VkViSurfaceCreateInfoNN</a>
@ValueBasedCandidate
public record VkViSurfaceCreateInfoNN(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$window = ValueLayout.ADDRESS.withName("window");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$flags, LAYOUT$window);

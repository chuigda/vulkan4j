...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkExternalComputeQueueDataParamsNV.html">VkExternalComputeQueueDataParamsNV</a>
@ValueBasedCandidate
public record VkExternalComputeQueueDataParamsNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$deviceIndex);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkExternalComputeQueueDataParamsNV allocate(Arena arena) {
        return new VkExternalComputeQueueDataParamsNV(arena.allocate(LAYOUT));
    }
    ...
    public static VkExternalComputeQueueDataParamsNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkExternalComputeQueueDataParamsNV(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkIndirectExecutionSetCreateInfoEXT.html">VkIndirectExecutionSetCreateInfoEXT</a>
@ValueBasedCandidate
public record VkIndirectExecutionSetCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final StructLayout LAYOUT$info = VkIndirectExecutionSetInfoEXT.LAYOUT.withName("info");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$type, LAYOUT$info);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkIndirectExecutionSetCreateInfoEXT allocate(Arena arena) {
        return new VkIndirectExecutionSetCreateInfoEXT(arena.allocate(LAYOUT));
    }
    ...
    public static VkIndirectExecutionSetCreateInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkIndirectExecutionSetCreateInfoEXT(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

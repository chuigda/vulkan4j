...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSurfaceCapabilitiesFullScreenExclusiveEXT.html">VkSurfaceCapabilitiesFullScreenExclusiveEXT</a>
@ValueBasedCandidate
public record VkSurfaceCapabilitiesFullScreenExclusiveEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$fullScreenExclusiveSupported = ValueLayout.JAVA_INT.withName("fullScreenExclusiveSupported");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$fullScreenExclusiveSupported);

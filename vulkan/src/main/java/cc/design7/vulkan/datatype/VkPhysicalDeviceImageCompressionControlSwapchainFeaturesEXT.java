...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT.html">VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$imageCompressionControlSwapchain = ValueLayout.JAVA_INT.withName("imageCompressionControlSwapchain");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$imageCompressionControlSwapchain);

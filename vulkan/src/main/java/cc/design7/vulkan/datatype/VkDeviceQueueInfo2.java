...
///
/// The {@link VkDeviceQueueInfo2#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkDeviceQueueInfo2#autoInit} to initialize these fields manually for
...
public record VkDeviceQueueInfo2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkDeviceQueueInfo2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkDeviceQueueInfo2(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.DEVICE_QUEUE_INFO_2);
        }
        return ret;
    }

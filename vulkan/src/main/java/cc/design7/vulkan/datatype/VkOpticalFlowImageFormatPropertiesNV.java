...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkOpticalFlowImageFormatPropertiesNV.html">VkOpticalFlowImageFormatPropertiesNV</a>
@ValueBasedCandidate
public record VkOpticalFlowImageFormatPropertiesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$format);

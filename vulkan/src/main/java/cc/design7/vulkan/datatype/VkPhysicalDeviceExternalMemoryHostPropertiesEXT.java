...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceExternalMemoryHostPropertiesEXT.html">VkPhysicalDeviceExternalMemoryHostPropertiesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceExternalMemoryHostPropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfLong LAYOUT$minImportedHostPointerAlignment = ValueLayout.JAVA_LONG.withName("minImportedHostPointerAlignment");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$minImportedHostPointerAlignment);
    ...
    public static final PathElement PATH$minImportedHostPointerAlignment = PathElement.groupElement("PATH$minImportedHostPointerAlignment");

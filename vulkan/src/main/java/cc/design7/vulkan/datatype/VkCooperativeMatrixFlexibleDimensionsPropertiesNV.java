...
///
/// The {@link VkCooperativeMatrixFlexibleDimensionsPropertiesNV#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkCooperativeMatrixFlexibleDimensionsPropertiesNV#autoInit} to initialize these fields manually for
...
public record VkCooperativeMatrixFlexibleDimensionsPropertiesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkCooperativeMatrixFlexibleDimensionsPropertiesNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.COOPERATIVE_MATRIX_FLEXIBLE_DIMENSIONS_PROPERTIES_NV);
        }
        return ret;
    }

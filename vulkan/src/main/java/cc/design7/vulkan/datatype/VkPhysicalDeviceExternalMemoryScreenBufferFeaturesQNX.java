...
public record VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$screenBufferImport = ValueLayout.JAVA_INT.withName("screenBufferImport");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$screenBufferImport);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCuModuleTexturingModeCreateInfoNVX.html">VkCuModuleTexturingModeCreateInfoNVX</a>
@ValueBasedCandidate
public record VkCuModuleTexturingModeCreateInfoNVX(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$use64bitTexturing = ValueLayout.JAVA_INT.withName("use64bitTexturing");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$use64bitTexturing);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkCuModuleTexturingModeCreateInfoNVX allocate(Arena arena) {
        return new VkCuModuleTexturingModeCreateInfoNVX(arena.allocate(LAYOUT));
    }
    ...
    public static VkCuModuleTexturingModeCreateInfoNVX[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkCuModuleTexturingModeCreateInfoNVX(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

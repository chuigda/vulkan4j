...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceImageProcessing2PropertiesQCOM.html">VkPhysicalDeviceImageProcessing2PropertiesQCOM</a>
@ValueBasedCandidate
public record VkPhysicalDeviceImageProcessing2PropertiesQCOM(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final StructLayout LAYOUT$maxBlockMatchWindow = VkExtent2D.LAYOUT.withName("maxBlockMatchWindow");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maxBlockMatchWindow);

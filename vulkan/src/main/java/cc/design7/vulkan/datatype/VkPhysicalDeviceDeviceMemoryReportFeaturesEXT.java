...
public record VkPhysicalDeviceDeviceMemoryReportFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$deviceMemoryReport = ValueLayout.JAVA_INT.withName("deviceMemoryReport");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$deviceMemoryReport);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceRenderPassStripedPropertiesARM.html">VkPhysicalDeviceRenderPassStripedPropertiesARM</a>
@ValueBasedCandidate
public record VkPhysicalDeviceRenderPassStripedPropertiesARM(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final StructLayout LAYOUT$renderPassStripeGranularity = VkExtent2D.LAYOUT.withName("renderPassStripeGranularity");
    public static final OfInt LAYOUT$maxRenderPassStripes = ValueLayout.JAVA_INT.withName("maxRenderPassStripes");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$renderPassStripeGranularity, LAYOUT$maxRenderPassStripes);

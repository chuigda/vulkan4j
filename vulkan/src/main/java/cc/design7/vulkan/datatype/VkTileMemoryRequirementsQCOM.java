...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkTileMemoryRequirementsQCOM.html">VkTileMemoryRequirementsQCOM</a>
@ValueBasedCandidate
public record VkTileMemoryRequirementsQCOM(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$size, LAYOUT$alignment);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkTileMemoryRequirementsQCOM allocate(Arena arena) {
        return new VkTileMemoryRequirementsQCOM(arena.allocate(LAYOUT));
    }
    ...
    public static VkTileMemoryRequirementsQCOM[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkTileMemoryRequirementsQCOM(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

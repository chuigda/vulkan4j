...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeH265SessionParametersFeedbackInfoKHR.html">VkVideoEncodeH265SessionParametersFeedbackInfoKHR</a>
@ValueBasedCandidate
public record VkVideoEncodeH265SessionParametersFeedbackInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$hasStdVPSOverrides = ValueLayout.JAVA_INT.withName("hasStdVPSOverrides");
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$hasStdVPSOverrides, LAYOUT$hasStdSPSOverrides, LAYOUT$hasStdPPSOverrides);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkVideoEncodeH265SessionParametersFeedbackInfoKHR allocate(Arena arena) {
        return new VkVideoEncodeH265SessionParametersFeedbackInfoKHR(arena.allocate(LAYOUT));
    }
    ...
    public static VkVideoEncodeH265SessionParametersFeedbackInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoEncodeH265SessionParametersFeedbackInfoKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

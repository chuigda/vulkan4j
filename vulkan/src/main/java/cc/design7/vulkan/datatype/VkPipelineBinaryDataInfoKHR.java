...
public record VkPipelineBinaryDataInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$pipelineBinary = ValueLayout.ADDRESS.withName("pipelineBinary");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$pipelineBinary);
    ...
    public static final PathElement PATH$pipelineBinary = PathElement.groupElement("PATH$pipelineBinary");

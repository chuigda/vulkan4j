...
public record VkPhysicalDeviceRawAccessChainsFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$shaderRawAccessChains = ValueLayout.JAVA_INT.withName("shaderRawAccessChains");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$shaderRawAccessChains);

...
///
/// The {@link VkPhysicalDeviceShaderDrawParametersFeatures#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceShaderDrawParametersFeatures#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceShaderDrawParametersFeatures(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceShaderDrawParametersFeatures[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_SHADER_DRAW_PARAMETERS_FEATURES);
        }
        return ret;
    }

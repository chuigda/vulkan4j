...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceShaderDrawParametersFeatures.html">VkPhysicalDeviceShaderDrawParametersFeatures</a>
@ValueBasedCandidate
public record VkPhysicalDeviceShaderDrawParametersFeatures(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$shaderDrawParameters);

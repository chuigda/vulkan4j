...
public record VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$multiviewPerViewRenderAreas = ValueLayout.JAVA_INT.withName("multiviewPerViewRenderAreas");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$multiviewPerViewRenderAreas);

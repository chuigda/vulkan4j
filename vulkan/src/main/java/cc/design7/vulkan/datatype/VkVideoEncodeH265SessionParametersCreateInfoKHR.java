...
///     VkVideoEncodeH265SessionParametersAddInfoKHR const* pParametersAddInfo; // optional
...
///
/// The {@link VkVideoEncodeH265SessionParametersCreateInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkVideoEncodeH265SessionParametersCreateInfoKHR#autoInit} to initialize these fields manually for
...
public record VkVideoEncodeH265SessionParametersCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeH265SessionParametersCreateInfoKHR[] allocate(Arena arena, int count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkVideoEncodeH265SessionParametersCreateInfoKHR[] ret = new VkVideoEncodeH265SessionParametersCreateInfoKHR[count];
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoEncodeH265SessionParametersCreateInfoKHR(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.VIDEO_ENCODE_H265_SESSION_PARAMETERS_CREATE_INFO_KHR);
        }
        return ret;
    }
    ...
    public static VkVideoEncodeH265SessionParametersCreateInfoKHR[] clone(Arena arena, VkVideoEncodeH265SessionParametersCreateInfoKHR[] src) {
        VkVideoEncodeH265SessionParametersCreateInfoKHR[] ret = allocate(arena, src.length);
    ...
    public @pointer(comment="VkVideoEncodeH265SessionParametersAddInfoKHR*") MemorySegment pParametersAddInfoRaw() {
        return segment.get(LAYOUT$pParametersAddInfo, OFFSET$pParametersAddInfo);
    }

    public void pParametersAddInfoRaw(@pointer(comment="VkVideoEncodeH265SessionParametersAddInfoKHR*") MemorySegment value) {
    ...
    public void pParametersAddInfo(@Nullable VkVideoEncodeH265SessionParametersAddInfoKHR value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pParametersAddInfoRaw(s);
    }

    @unsafe public @Nullable VkVideoEncodeH265SessionParametersAddInfoKHR[] pParametersAddInfo(int assumedCount) {
        MemorySegment s = pParametersAddInfoRaw();
        if (s.equals(MemorySegment.NULL)) {
            return null;
        }

        s = s.reinterpret(assumedCount * VkVideoEncodeH265SessionParametersAddInfoKHR.SIZE);
        VkVideoEncodeH265SessionParametersAddInfoKHR[] ret = new VkVideoEncodeH265SessionParametersAddInfoKHR[assumedCount];
        for (int i = 0; i < assumedCount; i ++) {
            ret[i] = new VkVideoEncodeH265SessionParametersAddInfoKHR(s.asSlice(i * VkVideoEncodeH265SessionParametersAddInfoKHR.SIZE, VkVideoEncodeH265SessionParametersAddInfoKHR.SIZE));
        }
        return ret;
    }

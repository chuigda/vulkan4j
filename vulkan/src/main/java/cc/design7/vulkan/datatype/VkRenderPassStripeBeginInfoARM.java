...
///
/// The {@link VkRenderPassStripeBeginInfoARM#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkRenderPassStripeBeginInfoARM#autoInit} to initialize these fields manually for
...
public record VkRenderPassStripeBeginInfoARM(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkRenderPassStripeBeginInfoARM[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.RENDER_PASS_STRIPE_BEGIN_INFO_ARM);
        }
        return ret;
    }

...
public record VkWriteDescriptorSetPartitionedAccelerationStructureNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$accelerationStructureCount = ValueLayout.JAVA_INT.withName("accelerationStructureCount");
    public static final AddressLayout LAYOUT$pAccelerationStructures = ValueLayout.ADDRESS.withTargetLayout(ValueLayout.JAVA_LONG).withName("pAccelerationStructures");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$accelerationStructureCount, LAYOUT$pAccelerationStructures);

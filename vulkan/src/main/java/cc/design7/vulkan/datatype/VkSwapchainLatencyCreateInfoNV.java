...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSwapchainLatencyCreateInfoNV.html">VkSwapchainLatencyCreateInfoNV</a>
@ValueBasedCandidate
public record VkSwapchainLatencyCreateInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$latencyModeEnable = ValueLayout.JAVA_INT.withName("latencyModeEnable");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$latencyModeEnable);

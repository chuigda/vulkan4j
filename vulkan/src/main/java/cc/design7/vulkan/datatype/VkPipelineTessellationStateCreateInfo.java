...
public record VkPipelineTessellationStateCreateInfo(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$patchControlPoints = ValueLayout.JAVA_INT.withName("patchControlPoints");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$flags, LAYOUT$patchControlPoints);

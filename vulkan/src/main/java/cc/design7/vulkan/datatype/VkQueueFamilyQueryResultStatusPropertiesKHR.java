...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkQueueFamilyQueryResultStatusPropertiesKHR.html">VkQueueFamilyQueryResultStatusPropertiesKHR</a>
@ValueBasedCandidate
public record VkQueueFamilyQueryResultStatusPropertiesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$queryResultStatusSupport = ValueLayout.JAVA_INT.withName("queryResultStatusSupport");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$queryResultStatusSupport);
    ...
    public static final PathElement PATH$queryResultStatusSupport = PathElement.groupElement("PATH$queryResultStatusSupport");

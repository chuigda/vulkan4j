...
public record VkSamplerYcbcrConversionImageFormatProperties(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$combinedImageSamplerDescriptorCount = ValueLayout.JAVA_INT.withName("combinedImageSamplerDescriptorCount");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$combinedImageSamplerDescriptorCount);

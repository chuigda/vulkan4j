...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkFenceCreateInfo.html">VkFenceCreateInfo</a>
@ValueBasedCandidate
public record VkFenceCreateInfo(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkFenceCreateInfo allocate(Arena arena) {
        return new VkFenceCreateInfo(arena.allocate(LAYOUT));
    }
    ...
    public static VkFenceCreateInfo[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkFenceCreateInfo(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

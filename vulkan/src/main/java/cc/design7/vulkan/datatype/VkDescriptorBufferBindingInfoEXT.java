...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDescriptorBufferBindingInfoEXT.html">VkDescriptorBufferBindingInfoEXT</a>
@ValueBasedCandidate
public record VkDescriptorBufferBindingInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$address, LAYOUT$usage);

...
///
/// The {@link VkPhysicalDevicePipelineOpacityMicromapFeaturesARM#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDevicePipelineOpacityMicromapFeaturesARM#autoInit} to initialize these fields manually for
...
public record VkPhysicalDevicePipelineOpacityMicromapFeaturesARM(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDevicePipelineOpacityMicromapFeaturesARM[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_PIPELINE_OPACITY_MICROMAP_FEATURES_ARM);
        }
        return ret;
    }

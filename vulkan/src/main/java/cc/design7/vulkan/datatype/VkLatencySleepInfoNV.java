...
public record VkLatencySleepInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$signalSemaphore = ValueLayout.ADDRESS.withName("signalSemaphore");
    public static final OfLong LAYOUT$value = ValueLayout.JAVA_LONG.withName("value");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$signalSemaphore, LAYOUT$value);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceMaintenance4Features.html">VkPhysicalDeviceMaintenance4Features</a>
@ValueBasedCandidate
public record VkPhysicalDeviceMaintenance4Features(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maintenance4);

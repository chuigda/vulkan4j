...
public record VkAccelerationStructureTrianglesDisplacementMicromapNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$displacementBiasAndScaleFormat = ValueLayout.JAVA_INT.withName("displacementBiasAndScaleFormat");
    public static final OfInt LAYOUT$displacementVectorFormat = ValueLayout.JAVA_INT.withName("displacementVectorFormat");
    public static final StructLayout LAYOUT$displacementBiasAndScaleBuffer = VkDeviceOrHostAddressConstKHR.LAYOUT.withName("displacementBiasAndScaleBuffer");
    public static final OfLong LAYOUT$displacementBiasAndScaleStride = ValueLayout.JAVA_LONG.withName("displacementBiasAndScaleStride");
    public static final StructLayout LAYOUT$displacementVectorBuffer = VkDeviceOrHostAddressConstKHR.LAYOUT.withName("displacementVectorBuffer");
    public static final OfLong LAYOUT$displacementVectorStride = ValueLayout.JAVA_LONG.withName("displacementVectorStride");
    public static final StructLayout LAYOUT$displacedMicromapPrimitiveFlags = VkDeviceOrHostAddressConstKHR.LAYOUT.withName("displacedMicromapPrimitiveFlags");
    public static final OfLong LAYOUT$displacedMicromapPrimitiveFlagsStride = ValueLayout.JAVA_LONG.withName("displacedMicromapPrimitiveFlagsStride");
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$displacementBiasAndScaleFormat, LAYOUT$displacementVectorFormat, LAYOUT$displacementBiasAndScaleBuffer, LAYOUT$displacementBiasAndScaleStride, LAYOUT$displacementVectorBuffer, LAYOUT$displacementVectorStride, LAYOUT$displacedMicromapPrimitiveFlags, LAYOUT$displacedMicromapPrimitiveFlagsStride, LAYOUT$indexType, LAYOUT$indexBuffer, LAYOUT$indexStride, LAYOUT$baseTriangle, LAYOUT$usageCountsCount, LAYOUT$pUsageCounts, LAYOUT$ppUsageCounts, LAYOUT$micromap);

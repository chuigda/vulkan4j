...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures.html">VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures</a>
@ValueBasedCandidate
public record VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$separateDepthStencilLayouts);
    ...
    public static VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures[] clone(Arena arena, VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures[] src) {
        VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures[] ret = allocate(arena, src.length);

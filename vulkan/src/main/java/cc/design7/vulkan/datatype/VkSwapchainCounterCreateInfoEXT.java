...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSwapchainCounterCreateInfoEXT.html">VkSwapchainCounterCreateInfoEXT</a>
@ValueBasedCandidate
public record VkSwapchainCounterCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$surfaceCounters = ValueLayout.JAVA_INT.withName("surfaceCounters");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$surfaceCounters);

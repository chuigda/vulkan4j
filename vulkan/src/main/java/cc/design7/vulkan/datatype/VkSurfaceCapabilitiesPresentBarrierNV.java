...
///
/// The {@link VkSurfaceCapabilitiesPresentBarrierNV#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkSurfaceCapabilitiesPresentBarrierNV#autoInit} to initialize these fields manually for
...
public record VkSurfaceCapabilitiesPresentBarrierNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkSurfaceCapabilitiesPresentBarrierNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.SURFACE_CAPABILITIES_PRESENT_BARRIER_NV);
        }
        return ret;
    }

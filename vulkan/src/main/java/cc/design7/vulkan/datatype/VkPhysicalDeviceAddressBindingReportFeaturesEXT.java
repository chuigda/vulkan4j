...
public record VkPhysicalDeviceAddressBindingReportFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$reportAddressBinding = ValueLayout.JAVA_INT.withName("reportAddressBinding");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$reportAddressBinding);

...
public record VkExportMetalDeviceInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$mtlDevice = ValueLayout.ADDRESS.withName("mtlDevice");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$mtlDevice);

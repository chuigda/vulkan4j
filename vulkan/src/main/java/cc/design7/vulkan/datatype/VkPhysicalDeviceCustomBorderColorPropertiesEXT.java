...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceCustomBorderColorPropertiesEXT.html">VkPhysicalDeviceCustomBorderColorPropertiesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceCustomBorderColorPropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$maxCustomBorderColorSamplers = ValueLayout.JAVA_INT.withName("maxCustomBorderColorSamplers");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maxCustomBorderColorSamplers);

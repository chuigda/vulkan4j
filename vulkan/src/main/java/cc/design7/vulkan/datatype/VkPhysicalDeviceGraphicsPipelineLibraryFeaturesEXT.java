...
public record VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$graphicsPipelineLibrary = ValueLayout.JAVA_INT.withName("graphicsPipelineLibrary");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$graphicsPipelineLibrary);

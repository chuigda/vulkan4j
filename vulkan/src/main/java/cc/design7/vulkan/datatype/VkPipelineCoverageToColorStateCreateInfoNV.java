...
public record VkPipelineCoverageToColorStateCreateInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$coverageToColorEnable = ValueLayout.JAVA_INT.withName("coverageToColorEnable");
    public static final OfInt LAYOUT$coverageToColorLocation = ValueLayout.JAVA_INT.withName("coverageToColorLocation");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$flags, LAYOUT$coverageToColorEnable, LAYOUT$coverageToColorLocation);

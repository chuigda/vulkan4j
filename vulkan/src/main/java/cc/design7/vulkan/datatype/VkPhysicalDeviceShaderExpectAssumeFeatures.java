...
///
/// The {@link VkPhysicalDeviceShaderExpectAssumeFeatures#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceShaderExpectAssumeFeatures#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceShaderExpectAssumeFeatures(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceShaderExpectAssumeFeatures[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES);
        }
        return ret;
    }

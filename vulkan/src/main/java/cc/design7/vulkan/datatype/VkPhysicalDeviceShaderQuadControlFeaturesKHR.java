...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceShaderQuadControlFeaturesKHR.html">VkPhysicalDeviceShaderQuadControlFeaturesKHR</a>
@ValueBasedCandidate
public record VkPhysicalDeviceShaderQuadControlFeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$shaderQuadControl = ValueLayout.JAVA_INT.withName("shaderQuadControl");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$shaderQuadControl);

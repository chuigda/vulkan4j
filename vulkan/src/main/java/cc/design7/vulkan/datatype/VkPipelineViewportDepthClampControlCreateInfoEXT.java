...
///
/// The {@link VkPipelineViewportDepthClampControlCreateInfoEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPipelineViewportDepthClampControlCreateInfoEXT#autoInit} to initialize these fields manually for
...
public record VkPipelineViewportDepthClampControlCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPipelineViewportDepthClampControlCreateInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PIPELINE_VIEWPORT_DEPTH_CLAMP_CONTROL_CREATE_INFO_EXT);
        }
        return ret;
    }

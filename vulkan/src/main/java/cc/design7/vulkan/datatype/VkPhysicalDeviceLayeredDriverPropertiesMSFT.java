...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceLayeredDriverPropertiesMSFT.html">VkPhysicalDeviceLayeredDriverPropertiesMSFT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceLayeredDriverPropertiesMSFT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$underlyingAPI = ValueLayout.JAVA_INT.withName("underlyingAPI");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$underlyingAPI);

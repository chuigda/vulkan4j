...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceInheritedViewportScissorFeaturesNV.html">VkPhysicalDeviceInheritedViewportScissorFeaturesNV</a>
@ValueBasedCandidate
public record VkPhysicalDeviceInheritedViewportScissorFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$inheritedViewportScissor2D = ValueLayout.JAVA_INT.withName("inheritedViewportScissor2D");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$inheritedViewportScissor2D);

...
///
/// The {@link VkOpticalFlowImageFormatInfoNV#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkOpticalFlowImageFormatInfoNV#autoInit} to initialize these fields manually for
...
public record VkOpticalFlowImageFormatInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkOpticalFlowImageFormatInfoNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.OPTICAL_FLOW_IMAGE_FORMAT_INFO_NV);
        }
        return ret;
    }

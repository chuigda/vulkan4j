...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkInitializePerformanceApiInfoINTEL.html">VkInitializePerformanceApiInfoINTEL</a>
@ValueBasedCandidate
public record VkInitializePerformanceApiInfoINTEL(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$pUserData);

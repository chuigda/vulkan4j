...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkShaderModuleValidationCacheCreateInfoEXT.html">VkShaderModuleValidationCacheCreateInfoEXT</a>
@ValueBasedCandidate
public record VkShaderModuleValidationCacheCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$validationCache = ValueLayout.ADDRESS.withName("validationCache");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$validationCache);

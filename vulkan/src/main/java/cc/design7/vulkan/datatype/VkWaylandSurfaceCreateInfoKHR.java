...
public record VkWaylandSurfaceCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$display = ValueLayout.ADDRESS.withTargetLayout(ValueLayout.ADDRESS).withName("display");
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$flags, LAYOUT$display, LAYOUT$surface);

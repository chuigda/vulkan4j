...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkConditionalRenderingBeginInfoEXT.html">VkConditionalRenderingBeginInfoEXT</a>
@ValueBasedCandidate
public record VkConditionalRenderingBeginInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$buffer, LAYOUT$offset, LAYOUT$flags);

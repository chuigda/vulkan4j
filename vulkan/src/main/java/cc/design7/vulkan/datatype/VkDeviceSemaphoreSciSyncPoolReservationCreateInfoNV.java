...
///
/// The {@link VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV#autoInit} to initialize these fields manually for
...
public record VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.DEVICE_SEMAPHORE_SCI_SYNC_POOL_RESERVATION_CREATE_INFO_NV);
        }
        return ret;
    }

...
///
/// The {@link VkCopyImageToImageInfo#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkCopyImageToImageInfo#autoInit} to initialize these fields manually for
...
public record VkCopyImageToImageInfo(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkCopyImageToImageInfo[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.COPY_IMAGE_TO_IMAGE_INFO);
        }
        return ret;
    }

...
public record VkPhysicalDeviceDepthClipControlFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$depthClipControl = ValueLayout.JAVA_INT.withName("depthClipControl");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$depthClipControl);

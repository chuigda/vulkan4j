...
///
/// The {@link VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_EXT);
        }
        return ret;
    }

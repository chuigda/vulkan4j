...
public record VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$texelBufferAlignment = ValueLayout.JAVA_INT.withName("texelBufferAlignment");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$texelBufferAlignment);

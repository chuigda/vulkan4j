...
///
/// The {@link VkVideoEncodeAV1SessionCreateInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkVideoEncodeAV1SessionCreateInfoKHR#autoInit} to initialize these fields manually for
...
public record VkVideoEncodeAV1SessionCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeAV1SessionCreateInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.VIDEO_ENCODE_AV1_SESSION_CREATE_INFO_KHR);
        }
        return ret;
    }

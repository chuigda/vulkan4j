...
public record VkXlibSurfaceCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$dpy = ValueLayout.ADDRESS.withTargetLayout(ValueLayout.ADDRESS).withName("dpy");
    public static final ValueLayout LAYOUT$window = NativeLayout.C_LONG.withName("window");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$flags, LAYOUT$dpy, LAYOUT$window);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceExtendedDynamicState3PropertiesEXT.html">VkPhysicalDeviceExtendedDynamicState3PropertiesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceExtendedDynamicState3PropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    public static final OfInt LAYOUT$sType = ValueLayout.JAVA_INT.withName("sType");
    public static final AddressLayout LAYOUT$pNext = ValueLayout.ADDRESS.withName("pNext");
    public static final OfInt LAYOUT$dynamicPrimitiveTopologyUnrestricted = ValueLayout.JAVA_INT.withName("dynamicPrimitiveTopologyUnrestricted");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$dynamicPrimitiveTopologyUnrestricted);
    ...
    public static VkPhysicalDeviceExtendedDynamicState3PropertiesEXT[] clone(Arena arena, VkPhysicalDeviceExtendedDynamicState3PropertiesEXT[] src) {
        VkPhysicalDeviceExtendedDynamicState3PropertiesEXT[] ret = allocate(arena, src.length);
    ...
    public static final PathElement PATH$dynamicPrimitiveTopologyUnrestricted = PathElement.groupElement("PATH$dynamicPrimitiveTopologyUnrestricted");

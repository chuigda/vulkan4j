...
///
/// The {@link VkPhysicalDeviceExtendedDynamicState3PropertiesEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceExtendedDynamicState3PropertiesEXT#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceExtendedDynamicState3PropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceExtendedDynamicState3PropertiesEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_3_PROPERTIES_EXT);
        }
        return ret;
    }

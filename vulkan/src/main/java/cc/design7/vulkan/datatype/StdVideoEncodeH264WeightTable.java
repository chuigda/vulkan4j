...
public record StdVideoEncodeH264WeightTable(@NotNull MemorySegment segment) implements IPointer {
    public static final StructLayout LAYOUT$flags = StdVideoEncodeH264WeightTableFlags.LAYOUT.withName("flags");
    public static final OfByte LAYOUT$luma_log2_weight_denom = ValueLayout.JAVA_BYTE.withName("luma_log2_weight_denom");
    public static final OfByte LAYOUT$chroma_log2_weight_denom = ValueLayout.JAVA_BYTE.withName("chroma_log2_weight_denom");
    public static final OfByte LAYOUT$luma_weight_l0 = ValueLayout.JAVA_BYTE.withName("luma_weight_l0");
    public static final OfByte LAYOUT$luma_offset_l0 = ValueLayout.JAVA_BYTE.withName("luma_offset_l0");
    public static final OfByte LAYOUT$chroma_weight_l0 = ValueLayout.JAVA_BYTE.withName("chroma_weight_l0");
    public static final OfByte LAYOUT$chroma_offset_l0 = ValueLayout.JAVA_BYTE.withName("chroma_offset_l0");
    public static final OfByte LAYOUT$luma_weight_l1 = ValueLayout.JAVA_BYTE.withName("luma_weight_l1");
    public static final OfByte LAYOUT$luma_offset_l1 = ValueLayout.JAVA_BYTE.withName("luma_offset_l1");
    public static final OfByte LAYOUT$chroma_weight_l1 = ValueLayout.JAVA_BYTE.withName("chroma_weight_l1");
    public static final OfByte LAYOUT$chroma_offset_l1 = ValueLayout.JAVA_BYTE.withName("chroma_offset_l1");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$flags, LAYOUT$luma_log2_weight_denom, LAYOUT$chroma_log2_weight_denom, LAYOUT$luma_weight_l0, LAYOUT$luma_offset_l0, LAYOUT$chroma_weight_l0, LAYOUT$chroma_offset_l0, LAYOUT$luma_weight_l1, LAYOUT$luma_offset_l1, LAYOUT$chroma_weight_l1, LAYOUT$chroma_offset_l1);
    ...
    public static StdVideoEncodeH264WeightTable[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new StdVideoEncodeH264WeightTable(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

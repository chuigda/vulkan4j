...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceExternalFormatResolveFeaturesANDROID.html">VkPhysicalDeviceExternalFormatResolveFeaturesANDROID</a>
@ValueBasedCandidate
public record VkPhysicalDeviceExternalFormatResolveFeaturesANDROID(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$externalFormatResolve = ValueLayout.JAVA_INT.withName("externalFormatResolve");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$externalFormatResolve);

...
public record VkPhysicalDeviceToolProperties(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfByte LAYOUT$version = ValueLayout.JAVA_BYTE.withName("version");
    public static final OfInt LAYOUT$purposes = ValueLayout.JAVA_INT.withName("purposes");
    public static final OfByte LAYOUT$description = ValueLayout.JAVA_BYTE.withName("description");
    public static final OfByte LAYOUT$layer = ValueLayout.JAVA_BYTE.withName("layer");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$name, LAYOUT$version, LAYOUT$purposes, LAYOUT$description, LAYOUT$layer);

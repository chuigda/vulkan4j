...
/// Represents a pointer to a {@code VkVideoFormatH265QuantizationMapPropertiesKHR} structure in native memory.
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoFormatH265QuantizationMapPropertiesKHR.html">VkVideoFormatH265QuantizationMapPropertiesKHR</a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkVideoFormatH265QuantizationMapPropertiesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoFormatH265QuantizationMapPropertiesKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoFormatH265QuantizationMapPropertiesKHR(segment.asSlice(i * BYTES, BYTES));
        }
        return ret;
    }

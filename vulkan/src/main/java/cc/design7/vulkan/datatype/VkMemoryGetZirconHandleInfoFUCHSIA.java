...
/// Represents a pointer to a {@code VkMemoryGetZirconHandleInfoFUCHSIA} structure in native memory.
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkMemoryGetZirconHandleInfoFUCHSIA.html">VkMemoryGetZirconHandleInfoFUCHSIA</a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkMemoryGetZirconHandleInfoFUCHSIA(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkMemoryGetZirconHandleInfoFUCHSIA[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkMemoryGetZirconHandleInfoFUCHSIA(segment.asSlice(i * BYTES, BYTES));
        }
        return ret;
    }

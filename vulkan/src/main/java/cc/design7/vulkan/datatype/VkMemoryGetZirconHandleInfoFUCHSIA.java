...
///
/// The {@link VkMemoryGetZirconHandleInfoFUCHSIA#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkMemoryGetZirconHandleInfoFUCHSIA#autoInit} to initialize these fields manually for
...
public record VkMemoryGetZirconHandleInfoFUCHSIA(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkMemoryGetZirconHandleInfoFUCHSIA[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.MEMORY_GET_ZIRCON_HANDLE_INFO_FUCHSIA);
        }
        return ret;
    }

...
/// Represents a pointer to a {@code VkVideoEncodeH265SessionCreateInfoKHR} structure in native memory.
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeH265SessionCreateInfoKHR.html">VkVideoEncodeH265SessionCreateInfoKHR</a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkVideoEncodeH265SessionCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeH265SessionCreateInfoKHR allocate(Arena arena) {
        return new VkVideoEncodeH265SessionCreateInfoKHR(arena.allocate(LAYOUT));
    }
    ...
    public static VkVideoEncodeH265SessionCreateInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoEncodeH265SessionCreateInfoKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

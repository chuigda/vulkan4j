...
public record VkPhysicalDeviceMemoryPriorityFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$memoryPriority = ValueLayout.JAVA_INT.withName("memoryPriority");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$memoryPriority);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceCooperativeMatrixPropertiesNV.html">VkPhysicalDeviceCooperativeMatrixPropertiesNV</a>
@ValueBasedCandidate
public record VkPhysicalDeviceCooperativeMatrixPropertiesNV(@NotNull MemorySegment segment) implements IPointer {
    public static final OfInt LAYOUT$sType = ValueLayout.JAVA_INT.withName("sType");
    public static final AddressLayout LAYOUT$pNext = ValueLayout.ADDRESS.withName("pNext");
    public static final OfInt LAYOUT$cooperativeMatrixSupportedStages = ValueLayout.JAVA_INT.withName("cooperativeMatrixSupportedStages");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$cooperativeMatrixSupportedStages);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkPhysicalDeviceCooperativeMatrixPropertiesNV allocate(Arena arena) {
        return new VkPhysicalDeviceCooperativeMatrixPropertiesNV(arena.allocate(LAYOUT));
    }

    public static VkPhysicalDeviceCooperativeMatrixPropertiesNV[] allocate(Arena arena, int count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceCooperativeMatrixPropertiesNV[] ret = new VkPhysicalDeviceCooperativeMatrixPropertiesNV[count];
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkPhysicalDeviceCooperativeMatrixPropertiesNV(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }
    ...
    public static VkPhysicalDeviceCooperativeMatrixPropertiesNV[] clone(Arena arena, VkPhysicalDeviceCooperativeMatrixPropertiesNV[] src) {
        VkPhysicalDeviceCooperativeMatrixPropertiesNV[] ret = allocate(arena, src.length);

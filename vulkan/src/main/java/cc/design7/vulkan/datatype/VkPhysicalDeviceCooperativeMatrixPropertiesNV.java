...
///
/// The {@link VkPhysicalDeviceCooperativeMatrixPropertiesNV#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceCooperativeMatrixPropertiesNV#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceCooperativeMatrixPropertiesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceCooperativeMatrixPropertiesNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_COOPERATIVE_MATRIX_PROPERTIES_NV);
        }
        return ret;
    }

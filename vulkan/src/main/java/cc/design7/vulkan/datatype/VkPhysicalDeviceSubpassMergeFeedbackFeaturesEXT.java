...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT.html">VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$subpassMergeFeedback = ValueLayout.JAVA_INT.withName("subpassMergeFeedback");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$subpassMergeFeedback);

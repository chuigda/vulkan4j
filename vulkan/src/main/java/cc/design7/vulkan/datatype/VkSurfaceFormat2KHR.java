...
///
/// The {@link VkSurfaceFormat2KHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkSurfaceFormat2KHR#autoInit} to initialize these fields manually for
...
public record VkSurfaceFormat2KHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkSurfaceFormat2KHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.SURFACE_FORMAT_2_KHR);
        }
        return ret;
    }

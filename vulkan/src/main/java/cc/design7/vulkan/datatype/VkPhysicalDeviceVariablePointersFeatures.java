...
public record VkPhysicalDeviceVariablePointersFeatures(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$variablePointersStorageBuffer, LAYOUT$variablePointers);

...
///
/// The {@link VkDebugMarkerObjectTagInfoEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkDebugMarkerObjectTagInfoEXT#autoInit} to initialize these fields manually for
...
public record VkDebugMarkerObjectTagInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkDebugMarkerObjectTagInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.DEBUG_MARKER_OBJECT_TAG_INFO_EXT);
        }
        return ret;
    }

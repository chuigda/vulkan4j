...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceMemoryBudgetPropertiesEXT.html">VkPhysicalDeviceMemoryBudgetPropertiesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceMemoryBudgetPropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfLong LAYOUT$heapBudget = ValueLayout.JAVA_LONG.withName("heapBudget");
    public static final OfLong LAYOUT$heapUsage = ValueLayout.JAVA_LONG.withName("heapUsage");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$heapBudget, LAYOUT$heapUsage);

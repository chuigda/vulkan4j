...
public record VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$shaderSubgroupUniformControlFlow = ValueLayout.JAVA_INT.withName("shaderSubgroupUniformControlFlow");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$shaderSubgroupUniformControlFlow);

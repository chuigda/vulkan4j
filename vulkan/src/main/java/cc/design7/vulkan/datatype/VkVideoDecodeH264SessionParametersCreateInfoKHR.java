...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoDecodeH264SessionParametersCreateInfoKHR.html">VkVideoDecodeH264SessionParametersCreateInfoKHR</a>
@ValueBasedCandidate
public record VkVideoDecodeH264SessionParametersCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$pParametersAddInfo = ValueLayout.ADDRESS.withTargetLayout(VkVideoDecodeH264SessionParametersAddInfoKHR.LAYOUT).withName("pParametersAddInfo");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maxStdSPSCount, LAYOUT$maxStdPPSCount, LAYOUT$pParametersAddInfo);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkVideoDecodeH264SessionParametersCreateInfoKHR allocate(Arena arena) {
        return new VkVideoDecodeH264SessionParametersCreateInfoKHR(arena.allocate(LAYOUT));
    }

    public static VkVideoDecodeH264SessionParametersCreateInfoKHR[] allocate(Arena arena, int count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkVideoDecodeH264SessionParametersCreateInfoKHR[] ret = new VkVideoDecodeH264SessionParametersCreateInfoKHR[count];
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoDecodeH264SessionParametersCreateInfoKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }
    ...
    public static VkVideoDecodeH264SessionParametersCreateInfoKHR[] clone(Arena arena, VkVideoDecodeH264SessionParametersCreateInfoKHR[] src) {
        VkVideoDecodeH264SessionParametersCreateInfoKHR[] ret = allocate(arena, src.length);
    ...
    public void pParametersAddInfo(@Nullable VkVideoDecodeH264SessionParametersAddInfoKHR value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pParametersAddInfoRaw(s);
    }

    @unsafe public @Nullable VkVideoDecodeH264SessionParametersAddInfoKHR[] pParametersAddInfo(int assumedCount) {
        MemorySegment s = pParametersAddInfoRaw();
        if (s.address() == 0) {
            return null;
        }

        s = s.reinterpret(assumedCount * VkVideoDecodeH264SessionParametersAddInfoKHR.SIZE);
        VkVideoDecodeH264SessionParametersAddInfoKHR[] ret = new VkVideoDecodeH264SessionParametersAddInfoKHR[assumedCount];
        for (int i = 0; i < assumedCount; i ++) {
            ret[i] = new VkVideoDecodeH264SessionParametersAddInfoKHR(s.asSlice(i * VkVideoDecodeH264SessionParametersAddInfoKHR.SIZE, VkVideoDecodeH264SessionParametersAddInfoKHR.SIZE));
        }
        return ret;
    }

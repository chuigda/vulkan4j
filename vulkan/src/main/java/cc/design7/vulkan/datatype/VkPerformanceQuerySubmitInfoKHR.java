...
public record VkPerformanceQuerySubmitInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$counterPassIndex = ValueLayout.JAVA_INT.withName("counterPassIndex");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$counterPassIndex);

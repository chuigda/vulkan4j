...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineShaderStageNodeCreateInfoAMDX.html">VkPipelineShaderStageNodeCreateInfoAMDX</a>
@ValueBasedCandidate
public record VkPipelineShaderStageNodeCreateInfoAMDX(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$pName, LAYOUT$index);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDeviceMemoryOverallocationCreateInfoAMD.html">VkDeviceMemoryOverallocationCreateInfoAMD</a>
@ValueBasedCandidate
public record VkDeviceMemoryOverallocationCreateInfoAMD(@NotNull MemorySegment segment) implements IPointer {
    public static final OfInt LAYOUT$sType = ValueLayout.JAVA_INT.withName("sType");
    public static final AddressLayout LAYOUT$pNext = ValueLayout.ADDRESS.withName("pNext");
    public static final OfInt LAYOUT$overallocationBehavior = ValueLayout.JAVA_INT.withName("overallocationBehavior");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$overallocationBehavior);
    ...
    public static final PathElement PATH$overallocationBehavior = PathElement.groupElement("PATH$overallocationBehavior");

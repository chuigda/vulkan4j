...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.html">VkPhysicalDeviceLayeredApiVulkanPropertiesKHR</a>
@ValueBasedCandidate
public record VkPhysicalDeviceLayeredApiVulkanPropertiesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final StructLayout LAYOUT$properties = VkPhysicalDeviceProperties2.LAYOUT.withName("properties");

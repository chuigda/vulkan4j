...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkImageSubresource2.html">VkImageSubresource2</a>
@ValueBasedCandidate
public record VkImageSubresource2(@NotNull MemorySegment segment) implements IPointer {
    public static final OfInt LAYOUT$sType = ValueLayout.JAVA_INT.withName("sType");
    public static final AddressLayout LAYOUT$pNext = ValueLayout.ADDRESS.withName("pNext");
    public static final StructLayout LAYOUT$imageSubresource = VkImageSubresource.LAYOUT.withName("imageSubresource");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$imageSubresource);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkImageSubresource2 allocate(Arena arena) {
        return new VkImageSubresource2(arena.allocate(LAYOUT));
    }
    ...
    public static VkImageSubresource2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkImageSubresource2(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkImportSemaphoreZirconHandleInfoFUCHSIA.html">VkImportSemaphoreZirconHandleInfoFUCHSIA</a>
@ValueBasedCandidate
public record VkImportSemaphoreZirconHandleInfoFUCHSIA(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$zirconHandle = ValueLayout.JAVA_INT.withName("zirconHandle");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$semaphore, LAYOUT$flags, LAYOUT$handleType, LAYOUT$zirconHandle);

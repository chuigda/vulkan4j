...
///
/// The {@link VkQueueFamilyProperties2#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkQueueFamilyProperties2#autoInit} to initialize these fields manually for
...
public record VkQueueFamilyProperties2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkQueueFamilyProperties2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkQueueFamilyProperties2(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.QUEUE_FAMILY_PROPERTIES_2);
        }
        return ret;
    }

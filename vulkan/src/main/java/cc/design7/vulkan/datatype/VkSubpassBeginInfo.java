...
public record VkSubpassBeginInfo(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$contents = ValueLayout.JAVA_INT.withName("contents");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$contents);

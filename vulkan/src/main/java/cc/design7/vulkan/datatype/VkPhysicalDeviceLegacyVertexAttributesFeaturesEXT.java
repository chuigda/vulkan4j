...
public record VkPhysicalDeviceLegacyVertexAttributesFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$legacyVertexAttributes = ValueLayout.JAVA_INT.withName("legacyVertexAttributes");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$legacyVertexAttributes);

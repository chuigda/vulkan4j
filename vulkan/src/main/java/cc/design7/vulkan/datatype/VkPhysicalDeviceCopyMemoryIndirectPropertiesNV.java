...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceCopyMemoryIndirectPropertiesNV.html">VkPhysicalDeviceCopyMemoryIndirectPropertiesNV</a>
@ValueBasedCandidate
public record VkPhysicalDeviceCopyMemoryIndirectPropertiesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$supportedQueues = ValueLayout.JAVA_INT.withName("supportedQueues");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$supportedQueues);

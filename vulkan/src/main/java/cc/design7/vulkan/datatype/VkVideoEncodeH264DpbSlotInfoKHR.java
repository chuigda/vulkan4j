...
///
/// The {@link VkVideoEncodeH264DpbSlotInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkVideoEncodeH264DpbSlotInfoKHR#autoInit} to initialize these fields manually for
...
public record VkVideoEncodeH264DpbSlotInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeH264DpbSlotInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.VIDEO_ENCODE_H264_DPB_SLOT_INFO_KHR);
        }
        return ret;
    }

...
/// Represents a pointer to a {@code VkVideoEncodeH264DpbSlotInfoKHR} structure in native memory.
///
...
public record VkVideoEncodeH264DpbSlotInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeH264DpbSlotInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoEncodeH264DpbSlotInfoKHR(segment.asSlice(i * BYTES, BYTES));
        }
        return ret;
    }

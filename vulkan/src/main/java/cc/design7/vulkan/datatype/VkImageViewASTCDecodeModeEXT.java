...
public record VkImageViewASTCDecodeModeEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$decodeMode = ValueLayout.JAVA_INT.withName("decodeMode");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$decodeMode);

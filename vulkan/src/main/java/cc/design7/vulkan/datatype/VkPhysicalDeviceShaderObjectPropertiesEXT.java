...
public record VkPhysicalDeviceShaderObjectPropertiesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfByte LAYOUT$shaderBinaryUUID = ValueLayout.JAVA_BYTE.withName("shaderBinaryUUID");
    public static final OfInt LAYOUT$shaderBinaryVersion = ValueLayout.JAVA_INT.withName("shaderBinaryVersion");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$shaderBinaryUUID, LAYOUT$shaderBinaryVersion);
    ...
    public static VkPhysicalDeviceShaderObjectPropertiesEXT[] clone(Arena arena, VkPhysicalDeviceShaderObjectPropertiesEXT[] src) {
        VkPhysicalDeviceShaderObjectPropertiesEXT[] ret = allocate(arena, src.length);

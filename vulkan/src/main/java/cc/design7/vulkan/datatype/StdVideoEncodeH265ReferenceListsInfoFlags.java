...
@ValueBasedCandidate
@UnsafeConstructor
public record StdVideoEncodeH265ReferenceListsInfoFlags(@NotNull MemorySegment segment) implements IPointer {
    public static StdVideoEncodeH265ReferenceListsInfoFlags allocate(Arena arena) {
        StdVideoEncodeH265ReferenceListsInfoFlags ret = new StdVideoEncodeH265ReferenceListsInfoFlags(arena.allocate(LAYOUT));
        return ret;
    }

    public static StdVideoEncodeH265ReferenceListsInfoFlags[] allocate(Arena arena, int count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        StdVideoEncodeH265ReferenceListsInfoFlags[] ret = new StdVideoEncodeH265ReferenceListsInfoFlags[count];
        for (int i = 0; i < count; i ++) {
            ret[i] = new StdVideoEncodeH265ReferenceListsInfoFlags(segment.asSlice(i * BYTES, BYTES));
        }
        return ret;
    }
    ...
    public static StdVideoEncodeH265ReferenceListsInfoFlags[] clone(Arena arena, StdVideoEncodeH265ReferenceListsInfoFlags[] src) {
        StdVideoEncodeH265ReferenceListsInfoFlags[] ret = allocate(arena, src.length);

...
public record VkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$relaxedLineRasterization = ValueLayout.JAVA_INT.withName("relaxedLineRasterization");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$relaxedLineRasterization);

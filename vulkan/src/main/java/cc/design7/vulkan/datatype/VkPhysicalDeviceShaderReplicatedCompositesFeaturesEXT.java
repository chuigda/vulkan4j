...
public record VkPhysicalDeviceShaderReplicatedCompositesFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$shaderReplicatedComposites = ValueLayout.JAVA_INT.withName("shaderReplicatedComposites");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$shaderReplicatedComposites);

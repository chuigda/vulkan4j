...
public record VkPhysicalDeviceCommandBufferInheritanceFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$commandBufferInheritance = ValueLayout.JAVA_INT.withName("commandBufferInheritance");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$commandBufferInheritance);

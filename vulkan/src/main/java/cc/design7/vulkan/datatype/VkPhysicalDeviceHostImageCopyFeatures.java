...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceHostImageCopyFeatures.html">VkPhysicalDeviceHostImageCopyFeatures</a>
@ValueBasedCandidate
public record VkPhysicalDeviceHostImageCopyFeatures(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$hostImageCopy);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkPhysicalDeviceHostImageCopyFeatures allocate(Arena arena) {
        return new VkPhysicalDeviceHostImageCopyFeatures(arena.allocate(LAYOUT));
    }
    ...
    public static VkPhysicalDeviceHostImageCopyFeatures[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkPhysicalDeviceHostImageCopyFeatures(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

...
public record StdVideoEncodeH265ReferenceListsInfo(@NotNull MemorySegment segment) implements IPointer {
    public static final StructLayout LAYOUT$flags = StdVideoEncodeH265ReferenceListsInfoFlags.LAYOUT.withName("flags");
    ...
    public static final OfByte LAYOUT$list_entry_l0 = ValueLayout.JAVA_BYTE.withName("list_entry_l0");
    public static final OfByte LAYOUT$list_entry_l1 = ValueLayout.JAVA_BYTE.withName("list_entry_l1");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$flags, LAYOUT$num_ref_idx_l0_active_minus1, LAYOUT$num_ref_idx_l1_active_minus1, LAYOUT$RefPicList0, LAYOUT$RefPicList1, LAYOUT$list_entry_l0, LAYOUT$list_entry_l1);

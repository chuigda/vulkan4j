...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceAmigoProfilingFeaturesSEC.html">VkPhysicalDeviceAmigoProfilingFeaturesSEC</a>
@ValueBasedCandidate
public record VkPhysicalDeviceAmigoProfilingFeaturesSEC(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$amigoProfiling = ValueLayout.JAVA_INT.withName("amigoProfiling");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$amigoProfiling);

...
///
/// The {@link VkImageSparseMemoryRequirementsInfo2#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkImageSparseMemoryRequirementsInfo2#autoInit} to initialize these fields manually for
...
public record VkImageSparseMemoryRequirementsInfo2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkImageSparseMemoryRequirementsInfo2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkImageSparseMemoryRequirementsInfo2(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.IMAGE_SPARSE_MEMORY_REQUIREMENTS_INFO_2);
        }
        return ret;
    }

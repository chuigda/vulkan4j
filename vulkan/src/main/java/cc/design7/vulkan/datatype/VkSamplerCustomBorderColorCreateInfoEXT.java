...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSamplerCustomBorderColorCreateInfoEXT.html">VkSamplerCustomBorderColorCreateInfoEXT</a>
@ValueBasedCandidate
public record VkSamplerCustomBorderColorCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    public static final OfInt LAYOUT$sType = ValueLayout.JAVA_INT.withName("sType");
    public static final AddressLayout LAYOUT$pNext = ValueLayout.ADDRESS.withName("pNext");
    public static final StructLayout LAYOUT$customBorderColor = VkClearColorValue.LAYOUT.withName("customBorderColor");
    public static final OfInt LAYOUT$format = ValueLayout.JAVA_INT.withName("format");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$customBorderColor, LAYOUT$format);
    ...
    public static final PathElement PATH$customBorderColor = PathElement.groupElement("PATH$customBorderColor");

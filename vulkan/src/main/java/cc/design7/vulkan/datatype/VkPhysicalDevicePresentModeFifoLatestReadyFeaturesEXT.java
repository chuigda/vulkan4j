...
///
/// The {@link VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT#autoInit} to initialize these fields manually for
...
public record VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_EXT);
        }
        return ret;
    }

...
public record VkPhysicalDeviceInvocationMaskFeaturesHUAWEI(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$invocationMask = ValueLayout.JAVA_INT.withName("invocationMask");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$invocationMask);

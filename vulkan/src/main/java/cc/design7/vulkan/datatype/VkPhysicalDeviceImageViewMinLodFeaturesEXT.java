...
public record VkPhysicalDeviceImageViewMinLodFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$minLod = ValueLayout.JAVA_INT.withName("minLod");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$minLod);

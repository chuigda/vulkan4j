...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkRenderPassCreationFeedbackCreateInfoEXT.html">VkRenderPassCreationFeedbackCreateInfoEXT</a>
@ValueBasedCandidate
public record VkRenderPassCreationFeedbackCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$pRenderPassFeedback = ValueLayout.ADDRESS.withTargetLayout(VkRenderPassCreationFeedbackInfoEXT.LAYOUT).withName("pRenderPassFeedback");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$pRenderPassFeedback);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkRenderPassCreationControlEXT.html">VkRenderPassCreationControlEXT</a>
@ValueBasedCandidate
public record VkRenderPassCreationControlEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$disallowMerging = ValueLayout.JAVA_INT.withName("disallowMerging");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$disallowMerging);

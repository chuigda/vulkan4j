...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceDisplacementMicromapPropertiesNV.html">VkPhysicalDeviceDisplacementMicromapPropertiesNV</a>
@ValueBasedCandidate
public record VkPhysicalDeviceDisplacementMicromapPropertiesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$maxDisplacementMicromapSubdivisionLevel = ValueLayout.JAVA_INT.withName("maxDisplacementMicromapSubdivisionLevel");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maxDisplacementMicromapSubdivisionLevel);

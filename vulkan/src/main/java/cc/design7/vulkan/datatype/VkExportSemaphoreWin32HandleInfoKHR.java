...
///
/// The {@link VkExportSemaphoreWin32HandleInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkExportSemaphoreWin32HandleInfoKHR#autoInit} to initialize these fields manually for
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkExportSemaphoreWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkExportSemaphoreWin32HandleInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkExportSemaphoreWin32HandleInfoKHR(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHR);
        }
        return ret;
    }

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkQueueFamilyCheckpointPropertiesNV.html">VkQueueFamilyCheckpointPropertiesNV</a>
@ValueBasedCandidate
public record VkQueueFamilyCheckpointPropertiesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$checkpointExecutionStageMask = ValueLayout.JAVA_INT.withName("checkpointExecutionStageMask");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$checkpointExecutionStageMask);

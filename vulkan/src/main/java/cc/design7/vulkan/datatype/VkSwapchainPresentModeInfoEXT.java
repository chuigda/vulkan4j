...
/// Represents a pointer to a {@code VkSwapchainPresentModeInfoEXT} structure in native memory.
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSwapchainPresentModeInfoEXT.html">VkSwapchainPresentModeInfoEXT</a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkSwapchainPresentModeInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkSwapchainPresentModeInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkSwapchainPresentModeInfoEXT(segment.asSlice(i * BYTES, BYTES));
        }
        return ret;
    }

...
/// Represents a pointer to a {@code VkDisplaySurfaceStereoCreateInfoNV} structure in native memory.
///
...
public record VkDisplaySurfaceStereoCreateInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkDisplaySurfaceStereoCreateInfoNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkDisplaySurfaceStereoCreateInfoNV(segment.asSlice(i * BYTES, BYTES));
        }
        return ret;
    }

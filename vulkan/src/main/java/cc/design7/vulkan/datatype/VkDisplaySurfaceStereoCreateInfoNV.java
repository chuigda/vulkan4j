...
///
/// The {@link VkDisplaySurfaceStereoCreateInfoNV#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkDisplaySurfaceStereoCreateInfoNV#autoInit} to initialize these fields manually for
...
public record VkDisplaySurfaceStereoCreateInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkDisplaySurfaceStereoCreateInfoNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.DISPLAY_SURFACE_STEREO_CREATE_INFO_NV);
        }
        return ret;
    }

...
public record VkPhysicalDevicePipelineBinaryFeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$pipelineBinaries = ValueLayout.JAVA_INT.withName("pipelineBinaries");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$pipelineBinaries);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceASTCDecodeFeaturesEXT.html">VkPhysicalDeviceASTCDecodeFeaturesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceASTCDecodeFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$decodeModeSharedExponent = ValueLayout.JAVA_INT.withName("decodeModeSharedExponent");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$decodeModeSharedExponent);

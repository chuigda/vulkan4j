...
public record VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$maxFragmentShadingRateInvocationCount = ValueLayout.JAVA_INT.withName("maxFragmentShadingRateInvocationCount");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maxFragmentShadingRateInvocationCount);

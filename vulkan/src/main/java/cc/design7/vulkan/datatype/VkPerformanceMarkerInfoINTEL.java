...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPerformanceMarkerInfoINTEL.html">VkPerformanceMarkerInfoINTEL</a>
@ValueBasedCandidate
public record VkPerformanceMarkerInfoINTEL(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfLong LAYOUT$marker = ValueLayout.JAVA_LONG.withName("marker");

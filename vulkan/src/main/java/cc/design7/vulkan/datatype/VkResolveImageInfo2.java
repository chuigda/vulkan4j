...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkResolveImageInfo2.html">VkResolveImageInfo2</a>
@ValueBasedCandidate
public record VkResolveImageInfo2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$pRegions = ValueLayout.ADDRESS.withTargetLayout(VkImageResolve2.LAYOUT).withName("pRegions");

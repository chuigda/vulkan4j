...
///
/// The {@link VkDescriptorSetVariableDescriptorCountLayoutSupport#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkDescriptorSetVariableDescriptorCountLayoutSupport#autoInit} to initialize these fields manually for
...
public record VkDescriptorSetVariableDescriptorCountLayoutSupport(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkDescriptorSetVariableDescriptorCountLayoutSupport[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT);
        }
        return ret;
    }

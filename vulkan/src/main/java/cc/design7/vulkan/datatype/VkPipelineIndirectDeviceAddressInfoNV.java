...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineIndirectDeviceAddressInfoNV.html">VkPipelineIndirectDeviceAddressInfoNV</a>
@ValueBasedCandidate
public record VkPipelineIndirectDeviceAddressInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$pipelineBindPoint, LAYOUT$pipeline);

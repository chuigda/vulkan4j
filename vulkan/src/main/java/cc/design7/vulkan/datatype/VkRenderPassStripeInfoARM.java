...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkRenderPassStripeInfoARM.html">VkRenderPassStripeInfoARM</a>
@ValueBasedCandidate
public record VkRenderPassStripeInfoARM(@NotNull MemorySegment segment) implements IPointer {
    public static final OfInt LAYOUT$sType = ValueLayout.JAVA_INT.withName("sType");
    public static final AddressLayout LAYOUT$pNext = ValueLayout.ADDRESS.withName("pNext");
    public static final StructLayout LAYOUT$stripeArea = VkRect2D.LAYOUT.withName("stripeArea");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$stripeArea);
    ...
    public static final PathElement PATH$stripeArea = PathElement.groupElement("PATH$stripeArea");

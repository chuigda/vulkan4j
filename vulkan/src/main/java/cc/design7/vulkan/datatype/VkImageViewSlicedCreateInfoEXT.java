...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkImageViewSlicedCreateInfoEXT.html">VkImageViewSlicedCreateInfoEXT</a>
@ValueBasedCandidate
public record VkImageViewSlicedCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$sliceOffset = ValueLayout.JAVA_INT.withName("sliceOffset");
    public static final OfInt LAYOUT$sliceCount = ValueLayout.JAVA_INT.withName("sliceCount");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$sliceOffset, LAYOUT$sliceCount);

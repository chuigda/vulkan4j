...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkRayTracingPipelineInterfaceCreateInfoKHR.html">VkRayTracingPipelineInterfaceCreateInfoKHR</a>
@ValueBasedCandidate
public record VkRayTracingPipelineInterfaceCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$maxPipelineRayPayloadSize = ValueLayout.JAVA_INT.withName("maxPipelineRayPayloadSize");
    public static final OfInt LAYOUT$maxPipelineRayHitAttributeSize = ValueLayout.JAVA_INT.withName("maxPipelineRayHitAttributeSize");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maxPipelineRayPayloadSize, LAYOUT$maxPipelineRayHitAttributeSize);

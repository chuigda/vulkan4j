...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSurfaceProtectedCapabilitiesKHR.html">VkSurfaceProtectedCapabilitiesKHR</a>
@ValueBasedCandidate
public record VkSurfaceProtectedCapabilitiesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$supportsProtected = ValueLayout.JAVA_INT.withName("supportsProtected");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$supportsProtected);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkSurfaceProtectedCapabilitiesKHR allocate(Arena arena) {
        return new VkSurfaceProtectedCapabilitiesKHR(arena.allocate(LAYOUT));
    }
    ...
    public static VkSurfaceProtectedCapabilitiesKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkSurfaceProtectedCapabilitiesKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }
    ...
    public static final PathElement PATH$supportsProtected = PathElement.groupElement("PATH$supportsProtected");

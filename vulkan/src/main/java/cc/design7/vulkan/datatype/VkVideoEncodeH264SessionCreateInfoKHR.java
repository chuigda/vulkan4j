...
///
/// The {@link VkVideoEncodeH264SessionCreateInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkVideoEncodeH264SessionCreateInfoKHR#autoInit} to initialize these fields manually for
...
public record VkVideoEncodeH264SessionCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeH264SessionCreateInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoEncodeH264SessionCreateInfoKHR(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.VIDEO_ENCODE_H264_SESSION_CREATE_INFO_KHR);
        }
        return ret;
    }

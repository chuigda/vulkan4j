...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceLineRasterizationProperties.html">VkPhysicalDeviceLineRasterizationProperties</a>
@ValueBasedCandidate
public record VkPhysicalDeviceLineRasterizationProperties(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$lineSubPixelPrecisionBits);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkPhysicalDeviceLineRasterizationProperties allocate(Arena arena) {
        return new VkPhysicalDeviceLineRasterizationProperties(arena.allocate(LAYOUT));
    }
    ...
    public static VkPhysicalDeviceLineRasterizationProperties[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkPhysicalDeviceLineRasterizationProperties(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

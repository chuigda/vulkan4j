...
///
/// The {@link VkWriteDescriptorSetAccelerationStructureNV#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkWriteDescriptorSetAccelerationStructureNV#autoInit} to initialize these fields manually for
...
public record VkWriteDescriptorSetAccelerationStructureNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkWriteDescriptorSetAccelerationStructureNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_NV);
        }
        return ret;
    }

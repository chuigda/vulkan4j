...
///
/// The {@link VkMemoryGetFdInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkMemoryGetFdInfoKHR#autoInit} to initialize these fields manually for
...
public record VkMemoryGetFdInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkMemoryGetFdInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.MEMORY_GET_FD_INFO_KHR);
        }
        return ret;
    }

...
/// Represents a pointer to a {@code VkMemoryGetFdInfoKHR} structure in native memory.
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkMemoryGetFdInfoKHR.html">VkMemoryGetFdInfoKHR</a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkMemoryGetFdInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkMemoryGetFdInfoKHR allocate(Arena arena) {
        return new VkMemoryGetFdInfoKHR(arena.allocate(LAYOUT));
    }

    public static VkMemoryGetFdInfoKHR[] allocate(Arena arena, int count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkMemoryGetFdInfoKHR[] ret = new VkMemoryGetFdInfoKHR[count];
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkMemoryGetFdInfoKHR(segment.asSlice(i * BYTES, BYTES));
        }
        return ret;
    }
    ...
    public static VkMemoryGetFdInfoKHR[] clone(Arena arena, VkMemoryGetFdInfoKHR[] src) {
        VkMemoryGetFdInfoKHR[] ret = allocate(arena, src.length);

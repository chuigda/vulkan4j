...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkStreamDescriptorSurfaceCreateInfoGGP.html">VkStreamDescriptorSurfaceCreateInfoGGP</a>
@ValueBasedCandidate
public record VkStreamDescriptorSurfaceCreateInfoGGP(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$streamDescriptor = ValueLayout.JAVA_INT.withName("streamDescriptor");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$flags, LAYOUT$streamDescriptor);

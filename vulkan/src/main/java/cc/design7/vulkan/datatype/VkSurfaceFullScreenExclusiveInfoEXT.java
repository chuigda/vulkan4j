...
///
/// The {@link VkSurfaceFullScreenExclusiveInfoEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkSurfaceFullScreenExclusiveInfoEXT#autoInit} to initialize these fields manually for
...
public record VkSurfaceFullScreenExclusiveInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkSurfaceFullScreenExclusiveInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.SURFACE_FULL_SCREEN_EXCLUSIVE_INFO_EXT);
        }
        return ret;
    }

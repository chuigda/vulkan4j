...
/// Represents a pointer to a {@code VkSurfaceFullScreenExclusiveInfoEXT} structure in native memory.
///
...
public record VkSurfaceFullScreenExclusiveInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkSurfaceFullScreenExclusiveInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkSurfaceFullScreenExclusiveInfoEXT(segment.asSlice(i * BYTES, BYTES));
        }
        return ret;
    }

...
public record VkPipelineRasterizationStateRasterizationOrderAMD(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$rasterizationOrder = ValueLayout.JAVA_INT.withName("rasterizationOrder");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$rasterizationOrder);

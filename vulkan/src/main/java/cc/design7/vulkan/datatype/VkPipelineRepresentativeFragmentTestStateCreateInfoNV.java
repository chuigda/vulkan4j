...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineRepresentativeFragmentTestStateCreateInfoNV.html">VkPipelineRepresentativeFragmentTestStateCreateInfoNV</a>
@ValueBasedCandidate
public record VkPipelineRepresentativeFragmentTestStateCreateInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$representativeFragmentTestEnable = ValueLayout.JAVA_INT.withName("representativeFragmentTestEnable");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$representativeFragmentTestEnable);

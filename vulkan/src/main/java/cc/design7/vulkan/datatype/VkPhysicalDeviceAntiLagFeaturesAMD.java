...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceAntiLagFeaturesAMD.html">VkPhysicalDeviceAntiLagFeaturesAMD</a>
@ValueBasedCandidate
public record VkPhysicalDeviceAntiLagFeaturesAMD(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$antiLag = ValueLayout.JAVA_INT.withName("antiLag");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$antiLag);

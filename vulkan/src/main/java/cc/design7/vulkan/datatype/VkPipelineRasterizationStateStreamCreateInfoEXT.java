...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineRasterizationStateStreamCreateInfoEXT.html">VkPipelineRasterizationStateStreamCreateInfoEXT</a>
@ValueBasedCandidate
public record VkPipelineRasterizationStateStreamCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$rasterizationStream = ValueLayout.JAVA_INT.withName("rasterizationStream");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$flags, LAYOUT$rasterizationStream);
    ...
    public static final PathElement PATH$rasterizationStream = PathElement.groupElement("PATH$rasterizationStream");

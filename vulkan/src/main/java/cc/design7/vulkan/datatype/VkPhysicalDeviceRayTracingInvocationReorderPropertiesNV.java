...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV.html">VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV</a>
@ValueBasedCandidate
public record VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$rayTracingInvocationReorderReorderingHint = ValueLayout.JAVA_INT.withName("rayTracingInvocationReorderReorderingHint");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$rayTracingInvocationReorderReorderingHint);

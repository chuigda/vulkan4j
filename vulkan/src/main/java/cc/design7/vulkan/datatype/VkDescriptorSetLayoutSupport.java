...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDescriptorSetLayoutSupport.html">VkDescriptorSetLayoutSupport</a>
@ValueBasedCandidate
public record VkDescriptorSetLayoutSupport(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$supported = ValueLayout.JAVA_INT.withName("supported");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$supported);

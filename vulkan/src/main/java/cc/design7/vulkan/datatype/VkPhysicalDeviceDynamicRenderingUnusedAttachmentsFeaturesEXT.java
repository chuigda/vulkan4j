...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT.html">VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT</a>
@ValueBasedCandidate
public record VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$dynamicRenderingUnusedAttachments = ValueLayout.JAVA_INT.withName("dynamicRenderingUnusedAttachments");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$dynamicRenderingUnusedAttachments);

...
public record VkMemoryMapPlacedInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$pPlacedAddress = ValueLayout.ADDRESS.withName("pPlacedAddress");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$pPlacedAddress);

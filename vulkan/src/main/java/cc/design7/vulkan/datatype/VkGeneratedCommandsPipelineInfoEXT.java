...
///
/// The {@link VkGeneratedCommandsPipelineInfoEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkGeneratedCommandsPipelineInfoEXT#autoInit} to initialize these fields manually for
...
public record VkGeneratedCommandsPipelineInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkGeneratedCommandsPipelineInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.GENERATED_COMMANDS_PIPELINE_INFO_EXT);
        }
        return ret;
    }

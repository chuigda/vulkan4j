...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceCoverageReductionModeFeaturesNV.html">VkPhysicalDeviceCoverageReductionModeFeaturesNV</a>
@ValueBasedCandidate
public record VkPhysicalDeviceCoverageReductionModeFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$coverageReductionMode);

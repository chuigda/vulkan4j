...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.html">VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR</a>
@ValueBasedCandidate
public record VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$pipelineExecutableInfo = ValueLayout.JAVA_INT.withName("pipelineExecutableInfo");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$pipelineExecutableInfo);

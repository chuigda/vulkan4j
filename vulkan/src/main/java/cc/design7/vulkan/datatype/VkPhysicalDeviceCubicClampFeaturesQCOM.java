...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceCubicClampFeaturesQCOM.html">VkPhysicalDeviceCubicClampFeaturesQCOM</a>
@ValueBasedCandidate
public record VkPhysicalDeviceCubicClampFeaturesQCOM(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$cubicRangeClamp = ValueLayout.JAVA_INT.withName("cubicRangeClamp");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$cubicRangeClamp);

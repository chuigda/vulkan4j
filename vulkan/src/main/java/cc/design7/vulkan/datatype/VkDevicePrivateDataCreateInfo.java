...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDevicePrivateDataCreateInfo.html">VkDevicePrivateDataCreateInfo</a>
@ValueBasedCandidate
public record VkDevicePrivateDataCreateInfo(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$privateDataSlotRequestCount = ValueLayout.JAVA_INT.withName("privateDataSlotRequestCount");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$privateDataSlotRequestCount);

...
/// Represents a pointer to a {@code VkImagePlaneMemoryRequirementsInfo} structure in native memory.
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkImagePlaneMemoryRequirementsInfo.html">VkImagePlaneMemoryRequirementsInfo</a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkImagePlaneMemoryRequirementsInfo(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkImagePlaneMemoryRequirementsInfo allocate(Arena arena) {
        return new VkImagePlaneMemoryRequirementsInfo(arena.allocate(LAYOUT));
    }
    ...
    public static VkImagePlaneMemoryRequirementsInfo[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkImagePlaneMemoryRequirementsInfo(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

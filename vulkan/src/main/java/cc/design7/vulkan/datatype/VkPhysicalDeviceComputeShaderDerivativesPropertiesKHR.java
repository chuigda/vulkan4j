...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.html">VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR</a>
@ValueBasedCandidate
public record VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR(@NotNull MemorySegment segment) implements IPointer {
    public static final OfInt LAYOUT$sType = ValueLayout.JAVA_INT.withName("sType");
    public static final AddressLayout LAYOUT$pNext = ValueLayout.ADDRESS.withName("pNext");
    public static final OfInt LAYOUT$meshAndTaskShaderDerivatives = ValueLayout.JAVA_INT.withName("meshAndTaskShaderDerivatives");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$meshAndTaskShaderDerivatives);
    ...
    public static final PathElement PATH$meshAndTaskShaderDerivatives = PathElement.groupElement("PATH$meshAndTaskShaderDerivatives");

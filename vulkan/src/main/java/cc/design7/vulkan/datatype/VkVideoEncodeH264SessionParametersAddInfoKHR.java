...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeH264SessionParametersAddInfoKHR.html">VkVideoEncodeH264SessionParametersAddInfoKHR</a>
@ValueBasedCandidate
public record VkVideoEncodeH264SessionParametersAddInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    public static final OfInt LAYOUT$sType = ValueLayout.JAVA_INT.withName("sType");
    public static final AddressLayout LAYOUT$pNext = ValueLayout.ADDRESS.withName("pNext");
    public static final OfInt LAYOUT$stdSPSCount = ValueLayout.JAVA_INT.withName("stdSPSCount");
    public static final AddressLayout LAYOUT$pStdSPSs = ValueLayout.ADDRESS.withTargetLayout(StdVideoH264SequenceParameterSet.LAYOUT).withName("pStdSPSs");
    public static final OfInt LAYOUT$stdPPSCount = ValueLayout.JAVA_INT.withName("stdPPSCount");
    public static final AddressLayout LAYOUT$pStdPPSs = ValueLayout.ADDRESS.withTargetLayout(StdVideoH264PictureParameterSet.LAYOUT).withName("pStdPPSs");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$stdSPSCount, LAYOUT$pStdSPSs, LAYOUT$stdPPSCount, LAYOUT$pStdPPSs);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkVideoEncodeH264SessionParametersAddInfoKHR allocate(Arena arena) {
        return new VkVideoEncodeH264SessionParametersAddInfoKHR(arena.allocate(LAYOUT));
    }

    public static VkVideoEncodeH264SessionParametersAddInfoKHR[] allocate(Arena arena, int count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkVideoEncodeH264SessionParametersAddInfoKHR[] ret = new VkVideoEncodeH264SessionParametersAddInfoKHR[count];
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoEncodeH264SessionParametersAddInfoKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }
    ...
    public static VkVideoEncodeH264SessionParametersAddInfoKHR[] clone(Arena arena, VkVideoEncodeH264SessionParametersAddInfoKHR[] src) {
        VkVideoEncodeH264SessionParametersAddInfoKHR[] ret = allocate(arena, src.length);

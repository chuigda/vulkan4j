...
///
/// The {@link VkBufferCaptureDescriptorDataInfoEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkBufferCaptureDescriptorDataInfoEXT#autoInit} to initialize these fields manually for
...
public record VkBufferCaptureDescriptorDataInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkBufferCaptureDescriptorDataInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.BUFFER_CAPTURE_DESCRIPTOR_DATA_INFO_EXT);
        }
        return ret;
    }

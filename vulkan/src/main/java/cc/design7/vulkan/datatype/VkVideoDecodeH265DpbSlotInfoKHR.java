...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoDecodeH265DpbSlotInfoKHR.html">VkVideoDecodeH265DpbSlotInfoKHR</a>
@ValueBasedCandidate
public record VkVideoDecodeH265DpbSlotInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$pStdReferenceInfo = ValueLayout.ADDRESS.withTargetLayout(StdVideoDecodeH265ReferenceInfo.LAYOUT).withName("pStdReferenceInfo");
    ...
    public static VkVideoDecodeH265DpbSlotInfoKHR allocate(Arena arena) {
        return new VkVideoDecodeH265DpbSlotInfoKHR(arena.allocate(LAYOUT));
    }
    ...
    public static VkVideoDecodeH265DpbSlotInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoDecodeH265DpbSlotInfoKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }
    ...
    public @pointer(comment="StdVideoDecodeH265ReferenceInfo*") MemorySegment pStdReferenceInfoRaw() {
        return segment.get(LAYOUT$pStdReferenceInfo, OFFSET$pStdReferenceInfo);
    }

    public void pStdReferenceInfoRaw(@pointer(comment="StdVideoDecodeH265ReferenceInfo*") MemorySegment value) {
    ...
    @unsafe public @Nullable StdVideoDecodeH265ReferenceInfo[] pStdReferenceInfo(int assumedCount) {
        ...
        s = s.reinterpret(assumedCount * StdVideoDecodeH265ReferenceInfo.SIZE);
        StdVideoDecodeH265ReferenceInfo[] ret = new StdVideoDecodeH265ReferenceInfo[assumedCount];
        for (int i = 0; i < assumedCount; i ++) {
            ret[i] = new StdVideoDecodeH265ReferenceInfo(s.asSlice(i * StdVideoDecodeH265ReferenceInfo.SIZE, StdVideoDecodeH265ReferenceInfo.SIZE));
        }
        return ret;
    }

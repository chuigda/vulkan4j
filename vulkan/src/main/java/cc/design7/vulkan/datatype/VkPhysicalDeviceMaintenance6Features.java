...
///
/// The {@link VkPhysicalDeviceMaintenance6Features#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceMaintenance6Features#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceMaintenance6Features(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceMaintenance6Features[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES);
        }
        return ret;
    }

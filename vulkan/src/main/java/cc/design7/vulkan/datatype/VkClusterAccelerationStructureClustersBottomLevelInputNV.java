...
public record VkClusterAccelerationStructureClustersBottomLevelInputNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$maxTotalClusterCount = ValueLayout.JAVA_INT.withName("maxTotalClusterCount");
    public static final OfInt LAYOUT$maxClusterCountPerAccelerationStructure = ValueLayout.JAVA_INT.withName("maxClusterCountPerAccelerationStructure");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maxTotalClusterCount, LAYOUT$maxClusterCountPerAccelerationStructure);
    ...
    public static VkClusterAccelerationStructureClustersBottomLevelInputNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkClusterAccelerationStructureClustersBottomLevelInputNV(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

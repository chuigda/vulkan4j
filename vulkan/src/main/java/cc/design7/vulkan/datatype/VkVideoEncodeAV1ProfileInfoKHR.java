...
///
/// The {@link VkVideoEncodeAV1ProfileInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkVideoEncodeAV1ProfileInfoKHR#autoInit} to initialize these fields manually for
...
public record VkVideoEncodeAV1ProfileInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeAV1ProfileInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoEncodeAV1ProfileInfoKHR(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.VIDEO_ENCODE_AV1_PROFILE_INFO_KHR);
        }
        return ret;
    }

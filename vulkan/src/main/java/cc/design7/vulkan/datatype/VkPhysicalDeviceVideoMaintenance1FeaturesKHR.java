...
///
/// The {@link VkPhysicalDeviceVideoMaintenance1FeaturesKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceVideoMaintenance1FeaturesKHR#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceVideoMaintenance1FeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceVideoMaintenance1FeaturesKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_VIDEO_MAINTENANCE_1_FEATURES_KHR);
        }
        return ret;
    }

...
///
/// The {@link VkPhysicalDeviceMaintenance4Properties#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceMaintenance4Properties#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceMaintenance4Properties(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceMaintenance4Properties[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_MAINTENANCE_4_PROPERTIES);
        }
        return ret;
    }

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures.html">VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures</a>
@ValueBasedCandidate
public record VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$shaderDemoteToHelperInvocation);

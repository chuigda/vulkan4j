...
public record VkPhysicalDevicePresentBarrierFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$presentBarrier = ValueLayout.JAVA_INT.withName("presentBarrier");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$presentBarrier);

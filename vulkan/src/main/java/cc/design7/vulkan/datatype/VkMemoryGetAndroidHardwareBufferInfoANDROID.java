...
/// Represents a pointer to a {@code VkMemoryGetAndroidHardwareBufferInfoANDROID} structure in native memory.
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkMemoryGetAndroidHardwareBufferInfoANDROID.html">VkMemoryGetAndroidHardwareBufferInfoANDROID</a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkMemoryGetAndroidHardwareBufferInfoANDROID(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkMemoryGetAndroidHardwareBufferInfoANDROID[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkMemoryGetAndroidHardwareBufferInfoANDROID(segment.asSlice(i * BYTES, BYTES));
        }
        return ret;
    }

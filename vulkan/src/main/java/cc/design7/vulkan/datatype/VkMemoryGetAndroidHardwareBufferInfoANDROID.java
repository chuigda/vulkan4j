...
///
/// The {@link VkMemoryGetAndroidHardwareBufferInfoANDROID#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkMemoryGetAndroidHardwareBufferInfoANDROID#autoInit} to initialize these fields manually for
...
public record VkMemoryGetAndroidHardwareBufferInfoANDROID(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkMemoryGetAndroidHardwareBufferInfoANDROID[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.MEMORY_GET_ANDROID_HARDWARE_BUFFER_INFO_ANDROID);
        }
        return ret;
    }

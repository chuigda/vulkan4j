...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkMemoryPriorityAllocateInfoEXT.html">VkMemoryPriorityAllocateInfoEXT</a>
@ValueBasedCandidate
public record VkMemoryPriorityAllocateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfFloat LAYOUT$priority = ValueLayout.JAVA_FLOAT.withName("priority");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$priority);

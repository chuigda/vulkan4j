...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkDisplayPlaneProperties2KHR.html">VkDisplayPlaneProperties2KHR</a>
@ValueBasedCandidate
public record VkDisplayPlaneProperties2KHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final StructLayout LAYOUT$displayPlaneProperties = VkDisplayPlanePropertiesKHR.LAYOUT.withName("displayPlaneProperties");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$displayPlaneProperties);

...
/// Represents a pointer to a {@code VkVideoDecodeAV1InlineSessionParametersInfoKHR} structure in native memory.
///
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoDecodeAV1InlineSessionParametersInfoKHR.html">VkVideoDecodeAV1InlineSessionParametersInfoKHR</a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkVideoDecodeAV1InlineSessionParametersInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoDecodeAV1InlineSessionParametersInfoKHR allocate(Arena arena) {
        return new VkVideoDecodeAV1InlineSessionParametersInfoKHR(arena.allocate(LAYOUT));
    }
    ...
    public static VkVideoDecodeAV1InlineSessionParametersInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoDecodeAV1InlineSessionParametersInfoKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

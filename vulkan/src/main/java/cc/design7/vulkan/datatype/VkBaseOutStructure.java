...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkBaseOutStructure.html">VkBaseOutStructure</a>
@ValueBasedCandidate
public record VkBaseOutStructure(@NotNull MemorySegment segment) implements IPointer {
    public static final OfInt LAYOUT$sType = ValueLayout.JAVA_INT.withName("sType");
    public static final AddressLayout LAYOUT$pNext = ValueLayout.ADDRESS.withTargetLayout(VkBaseOutStructure.LAYOUT).withName("pNext");
    ...
    public static VkBaseOutStructure[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkBaseOutStructure(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }

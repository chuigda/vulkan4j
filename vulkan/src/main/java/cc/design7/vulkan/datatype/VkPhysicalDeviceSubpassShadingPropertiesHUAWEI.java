...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceSubpassShadingPropertiesHUAWEI.html">VkPhysicalDeviceSubpassShadingPropertiesHUAWEI</a>
@ValueBasedCandidate
public record VkPhysicalDeviceSubpassShadingPropertiesHUAWEI(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$maxSubpassShadingWorkgroupSizeAspectRatio = ValueLayout.JAVA_INT.withName("maxSubpassShadingWorkgroupSizeAspectRatio");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$maxSubpassShadingWorkgroupSizeAspectRatio);

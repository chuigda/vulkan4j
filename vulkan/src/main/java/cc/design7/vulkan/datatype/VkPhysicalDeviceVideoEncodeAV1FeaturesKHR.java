...
public record VkPhysicalDeviceVideoEncodeAV1FeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$videoEncodeAV1 = ValueLayout.JAVA_INT.withName("videoEncodeAV1");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$videoEncodeAV1);
    ...
    public static VkPhysicalDeviceVideoEncodeAV1FeaturesKHR[] clone(Arena arena, VkPhysicalDeviceVideoEncodeAV1FeaturesKHR[] src) {
        VkPhysicalDeviceVideoEncodeAV1FeaturesKHR[] ret = allocate(arena, src.length);

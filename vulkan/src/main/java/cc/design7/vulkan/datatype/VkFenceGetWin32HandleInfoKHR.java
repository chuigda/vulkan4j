...
///
/// The {@link VkFenceGetWin32HandleInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkFenceGetWin32HandleInfoKHR#autoInit} to initialize these fields manually for
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkFenceGetWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkFenceGetWin32HandleInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkFenceGetWin32HandleInfoKHR(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.FENCE_GET_WIN32_HANDLE_INFO_KHR);
        }
        return ret;
    }

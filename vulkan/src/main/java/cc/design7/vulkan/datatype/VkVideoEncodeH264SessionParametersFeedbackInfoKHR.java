...
///
/// The {@link VkVideoEncodeH264SessionParametersFeedbackInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkVideoEncodeH264SessionParametersFeedbackInfoKHR#autoInit} to initialize these fields manually for
...
public record VkVideoEncodeH264SessionParametersFeedbackInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeH264SessionParametersFeedbackInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoEncodeH264SessionParametersFeedbackInfoKHR(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.VIDEO_ENCODE_H264_SESSION_PARAMETERS_FEEDBACK_INFO_KHR);
        }
        return ret;
    }

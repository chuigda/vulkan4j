...
public record VkPhysicalDeviceCudaKernelLaunchFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$cudaKernelLaunchFeatures = ValueLayout.JAVA_INT.withName("cudaKernelLaunchFeatures");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$cudaKernelLaunchFeatures);

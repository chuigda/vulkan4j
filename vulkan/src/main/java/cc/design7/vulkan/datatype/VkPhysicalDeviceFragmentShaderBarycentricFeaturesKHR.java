...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR.html">VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR</a>
@ValueBasedCandidate
public record VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$fragmentShaderBarycentric = ValueLayout.JAVA_INT.withName("fragmentShaderBarycentric");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$fragmentShaderBarycentric);

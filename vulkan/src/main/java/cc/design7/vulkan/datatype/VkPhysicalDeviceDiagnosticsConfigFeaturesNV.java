...
///
/// The {@link VkPhysicalDeviceDiagnosticsConfigFeaturesNV#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceDiagnosticsConfigFeaturesNV#autoInit} to initialize these fields manually for
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceDiagnosticsConfigFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceDiagnosticsConfigFeaturesNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkPhysicalDeviceDiagnosticsConfigFeaturesNV(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_DIAGNOSTICS_CONFIG_FEATURES_NV);
        }
        return ret;
    }
    ...
    public static VkPhysicalDeviceDiagnosticsConfigFeaturesNV[] clone(Arena arena, VkPhysicalDeviceDiagnosticsConfigFeaturesNV[] src) {
        VkPhysicalDeviceDiagnosticsConfigFeaturesNV[] ret = allocate(arena, src.length);
    ...
    public static final PathElement PATH$diagnosticsConfig = PathElement.groupElement("PATH$diagnosticsConfig");

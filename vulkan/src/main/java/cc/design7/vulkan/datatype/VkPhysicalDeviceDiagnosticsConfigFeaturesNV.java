...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceDiagnosticsConfigFeaturesNV.html">VkPhysicalDeviceDiagnosticsConfigFeaturesNV</a>
@ValueBasedCandidate
public record VkPhysicalDeviceDiagnosticsConfigFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfInt LAYOUT$diagnosticsConfig = ValueLayout.JAVA_INT.withName("diagnosticsConfig");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$diagnosticsConfig);

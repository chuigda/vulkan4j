...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSemaphoreGetWin32HandleInfoKHR.html">VkSemaphoreGetWin32HandleInfoKHR</a>
@ValueBasedCandidate
public record VkSemaphoreGetWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$semaphore, LAYOUT$handleType);
    public static final long SIZE = LAYOUT.byteSize();

    public static VkSemaphoreGetWin32HandleInfoKHR allocate(Arena arena) {
        return new VkSemaphoreGetWin32HandleInfoKHR(arena.allocate(LAYOUT));
    }

    public static VkSemaphoreGetWin32HandleInfoKHR[] allocate(Arena arena, int count) {

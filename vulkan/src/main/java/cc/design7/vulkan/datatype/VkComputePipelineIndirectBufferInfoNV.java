...
public record VkComputePipelineIndirectBufferInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final OfLong LAYOUT$pipelineDeviceAddressCaptureReplay = ValueLayout.JAVA_LONG.withName("pipelineDeviceAddressCaptureReplay");

    public static final MemoryLayout LAYOUT = NativeLayout.structLayout(LAYOUT$sType, LAYOUT$pNext, LAYOUT$deviceAddress, LAYOUT$size, LAYOUT$pipelineDeviceAddressCaptureReplay);

...
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeH264SessionParametersCreateInfoKHR.html">VkVideoEncodeH264SessionParametersCreateInfoKHR</a>
@ValueBasedCandidate
public record VkVideoEncodeH264SessionParametersCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final AddressLayout LAYOUT$pParametersAddInfo = ValueLayout.ADDRESS.withTargetLayout(VkVideoEncodeH264SessionParametersAddInfoKHR.LAYOUT).withName("pParametersAddInfo");
    ...
    public static VkVideoEncodeH264SessionParametersCreateInfoKHR allocate(Arena arena) {
        return new VkVideoEncodeH264SessionParametersCreateInfoKHR(arena.allocate(LAYOUT));
    }

    public static VkVideoEncodeH264SessionParametersCreateInfoKHR[] allocate(Arena arena, int count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkVideoEncodeH264SessionParametersCreateInfoKHR[] ret = new VkVideoEncodeH264SessionParametersCreateInfoKHR[count];
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkVideoEncodeH264SessionParametersCreateInfoKHR(segment.asSlice(i * SIZE, SIZE));
        }
        return ret;
    }
    ...
    public static VkVideoEncodeH264SessionParametersCreateInfoKHR[] clone(Arena arena, VkVideoEncodeH264SessionParametersCreateInfoKHR[] src) {
        VkVideoEncodeH264SessionParametersCreateInfoKHR[] ret = allocate(arena, src.length);
    ...
    public @pointer(comment="VkVideoEncodeH264SessionParametersAddInfoKHR*") MemorySegment pParametersAddInfoRaw() {
        return segment.get(LAYOUT$pParametersAddInfo, OFFSET$pParametersAddInfo);
    }

    public void pParametersAddInfoRaw(@pointer(comment="VkVideoEncodeH264SessionParametersAddInfoKHR*") MemorySegment value) {
    ...
    @unsafe public @Nullable VkVideoEncodeH264SessionParametersAddInfoKHR[] pParametersAddInfo(int assumedCount) {
        ...
        s = s.reinterpret(assumedCount * VkVideoEncodeH264SessionParametersAddInfoKHR.SIZE);
        VkVideoEncodeH264SessionParametersAddInfoKHR[] ret = new VkVideoEncodeH264SessionParametersAddInfoKHR[assumedCount];
        for (int i = 0; i < assumedCount; i ++) {
            ret[i] = new VkVideoEncodeH264SessionParametersAddInfoKHR(s.asSlice(i * VkVideoEncodeH264SessionParametersAddInfoKHR.SIZE, VkVideoEncodeH264SessionParametersAddInfoKHR.SIZE));
        }
        return ret;
    }

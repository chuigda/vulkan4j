...
///
/// The {@link VkImportFenceWin32HandleInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkImportFenceWin32HandleInfoKHR#autoInit} to initialize these fields manually for
...
public record VkImportFenceWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkImportFenceWin32HandleInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.IMPORT_FENCE_WIN32_HANDLE_INFO_KHR);
        }
        return ret;
    }

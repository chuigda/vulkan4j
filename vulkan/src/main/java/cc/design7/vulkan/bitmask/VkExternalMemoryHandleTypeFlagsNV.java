...
public final class VkExternalMemoryHandleTypeFlagsNV {
    public static final int EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_IMAGE = 0x4;
    public static final int EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_IMAGE_KMT = 0x8;
    public static final int EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32 = 0x1;
    public static final int EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT = 0x2;

    public static String explain(@enumtype(VkExternalMemoryHandleTypeFlagsNV.class) int flags) {
        List<String> detectedFlagBits = new ArrayList<>();
        if ((flags & EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_IMAGE) != 0) {
            detectedFlagBits.add("VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_IMAGE_BIT_NV");
        }
        if ((flags & EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_IMAGE_KMT) != 0) {

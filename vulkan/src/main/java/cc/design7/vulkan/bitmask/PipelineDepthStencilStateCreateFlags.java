...
public final class PipelineDepthStencilStateCreateFlags {
    ...
    public static String explain(@enumtype(PipelineDepthStencilStateCreateFlags.class) int flags) {
    ...
    private PipelineDepthStencilStateCreateFlags() {}
}

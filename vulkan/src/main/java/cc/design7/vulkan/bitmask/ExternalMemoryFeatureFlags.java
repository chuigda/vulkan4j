...
public final class ExternalMemoryFeatureFlags {
    public static final int DEDICATED_ONLY = 0x1;
    public static final int EXPORTABLE = 0x2;
    public static final int IMPORTABLE = 0x4;
    
    public static String explain(@enumtype(ExternalMemoryFeatureFlags.class) int flags) {
    ...
    private ExternalMemoryFeatureFlags() {}
}

...
public final class ExternalMemoryHandleTypeFlagsNV {
    ...
    public static String explain(@enumtype(ExternalMemoryHandleTypeFlagsNV.class) int flags) {
    ...
    private ExternalMemoryHandleTypeFlagsNV() {}
}

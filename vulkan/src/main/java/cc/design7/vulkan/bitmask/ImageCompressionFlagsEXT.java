...
public final class ImageCompressionFlagsEXT {
    ...
    public static String explain(@enumtype(ImageCompressionFlagsEXT.class) int flags) {
    ...
    private ImageCompressionFlagsEXT() {}
}

...
public final class VkMemoryPropertyFlags {
    public static final int MEMORY_PROPERTY_DEVICE_COHERENT_AMD = 0x40;
    public static final int MEMORY_PROPERTY_DEVICE_LOCAL = 0x1;
    public static final int MEMORY_PROPERTY_DEVICE_UNCACHED_AMD = 0x80;
    public static final int MEMORY_PROPERTY_HOST_CACHED = 0x8;
    public static final int MEMORY_PROPERTY_HOST_COHERENT = 0x4;
    public static final int MEMORY_PROPERTY_HOST_VISIBLE = 0x2;
    public static final int MEMORY_PROPERTY_LAZILY_ALLOCATED = 0x10;
    public static final int MEMORY_PROPERTY_PROTECTED = 0x20;
    public static final int MEMORY_PROPERTY_RDMA_CAPABLE_NV = 0x100;

    public static String explain(@enumtype(VkMemoryPropertyFlags.class) int flags) {
        List<String> detectedFlagBits = new ArrayList<>();
        if ((flags & MEMORY_PROPERTY_DEVICE_COHERENT_AMD) != 0) {
        ...
        if ((flags & MEMORY_PROPERTY_DEVICE_UNCACHED_AMD) != 0) {
        ...
        if ((flags & MEMORY_PROPERTY_LAZILY_ALLOCATED) != 0) {
            detectedFlagBits.add("VK_MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT");
        }
        if ((flags & MEMORY_PROPERTY_PROTECTED) != 0) {
            detectedFlagBits.add("VK_MEMORY_PROPERTY_PROTECTED_BIT");
        }
        if ((flags & MEMORY_PROPERTY_RDMA_CAPABLE_NV) != 0) {

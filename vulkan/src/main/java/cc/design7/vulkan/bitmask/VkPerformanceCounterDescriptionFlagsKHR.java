...
public final class VkPerformanceCounterDescriptionFlagsKHR {
    public static final int PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED = 0x2;
    public static final int PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING = 0x1;

    public static String explain(@enumtype(VkPerformanceCounterDescriptionFlagsKHR.class) int flags) {
        List<String> detectedFlagBits = new ArrayList<>();
        if ((flags & PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED) != 0) {
            detectedFlagBits.add("VK_PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED_BIT_KHR");
        }
        if ((flags & PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING) != 0) {

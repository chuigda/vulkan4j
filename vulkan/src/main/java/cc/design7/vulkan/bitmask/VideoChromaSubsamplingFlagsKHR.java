...
public final class VideoChromaSubsamplingFlagsKHR {
    ...
    public static String explain(@enumtype(VideoChromaSubsamplingFlagsKHR.class) int flags) {
    ...
    private VideoChromaSubsamplingFlagsKHR() {}
}

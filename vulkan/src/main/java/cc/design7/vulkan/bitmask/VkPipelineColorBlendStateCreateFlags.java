...
public final class VkPipelineColorBlendStateCreateFlags {
    public static final int PIPELINE_COLOR_BLEND_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXT = 0x1;

    public static String explain(@enumtype(VkPipelineColorBlendStateCreateFlags.class) int flags) {
        List<String> detectedFlagBits = new ArrayList<>();
        if ((flags & PIPELINE_COLOR_BLEND_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXT) != 0) {

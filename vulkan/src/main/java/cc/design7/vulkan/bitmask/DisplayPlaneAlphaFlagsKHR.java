...
public final class DisplayPlaneAlphaFlagsKHR {
    ...
    public static String explain(@enumtype(DisplayPlaneAlphaFlagsKHR.class) int flags) {
    ...
    private DisplayPlaneAlphaFlagsKHR() {}
}

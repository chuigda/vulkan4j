...
public final class VkClusterAccelerationStructureIndexFormatFlagsNV {
    public static final int CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_16BIT = 0x2;
    public static final int CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_32BIT = 0x4;
    public static final int CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_8BIT = 0x1;

    public static String explain(@enumtype(VkClusterAccelerationStructureIndexFormatFlagsNV.class) int flags) {
        List<String> detectedFlagBits = new ArrayList<>();
        if ((flags & CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_16BIT) != 0) {
            detectedFlagBits.add("VK_CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_16BIT_NV");
        }
        if ((flags & CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_32BIT) != 0) {
            detectedFlagBits.add("VK_CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_32BIT_NV");
        }
        if ((flags & CLUSTER_ACCELERATION_STRUCTURE_INDEX_FORMAT_8BIT) != 0) {

...
public final class VkOpticalFlowGridSizeFlagsNV {
    public static final int OPTICAL_FLOW_GRID_SIZE_1X1 = 0x1;
    public static final int OPTICAL_FLOW_GRID_SIZE_2X2 = 0x2;
    public static final int OPTICAL_FLOW_GRID_SIZE_4X4 = 0x4;
    public static final int OPTICAL_FLOW_GRID_SIZE_8X8 = 0x8;
    public static final int OPTICAL_FLOW_GRID_SIZE_UNKNOWN = 0x0;

    public static String explain(@enumtype(VkOpticalFlowGridSizeFlagsNV.class) int flags) {
        List<String> detectedFlagBits = new ArrayList<>();
        if ((flags & OPTICAL_FLOW_GRID_SIZE_1X1) != 0) {
            detectedFlagBits.add("VK_OPTICAL_FLOW_GRID_SIZE_1X1_BIT_NV");
        }
        if ((flags & OPTICAL_FLOW_GRID_SIZE_2X2) != 0) {
            detectedFlagBits.add("VK_OPTICAL_FLOW_GRID_SIZE_2X2_BIT_NV");
        }
        if ((flags & OPTICAL_FLOW_GRID_SIZE_4X4) != 0) {
            detectedFlagBits.add("VK_OPTICAL_FLOW_GRID_SIZE_4X4_BIT_NV");
        }
        if ((flags & OPTICAL_FLOW_GRID_SIZE_8X8) != 0) {
            detectedFlagBits.add("VK_OPTICAL_FLOW_GRID_SIZE_8X8_BIT_NV");
        }
        if ((flags & OPTICAL_FLOW_GRID_SIZE_UNKNOWN) != 0) {
    ...
    private VkOpticalFlowGridSizeFlagsNV() {}
}

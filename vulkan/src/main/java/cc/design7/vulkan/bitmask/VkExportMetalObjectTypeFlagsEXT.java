...
public final class VkExportMetalObjectTypeFlagsEXT {
    public static final int EXPORT_METAL_OBJECT_TYPE_METAL_BUFFER = 0x4;
    public static final int EXPORT_METAL_OBJECT_TYPE_METAL_COMMAND_QUEUE = 0x2;
    public static final int EXPORT_METAL_OBJECT_TYPE_METAL_DEVICE = 0x1;
    public static final int EXPORT_METAL_OBJECT_TYPE_METAL_IOSURFACE = 0x10;
    public static final int EXPORT_METAL_OBJECT_TYPE_METAL_SHARED_EVENT = 0x20;
    public static final int EXPORT_METAL_OBJECT_TYPE_METAL_TEXTURE = 0x8;

    public static String explain(@enumtype(VkExportMetalObjectTypeFlagsEXT.class) int flags) {
        List<String> detectedFlagBits = new ArrayList<>();
        if ((flags & EXPORT_METAL_OBJECT_TYPE_METAL_BUFFER) != 0) {
            detectedFlagBits.add("VK_EXPORT_METAL_OBJECT_TYPE_METAL_BUFFER_BIT_EXT");
        }
        if ((flags & EXPORT_METAL_OBJECT_TYPE_METAL_COMMAND_QUEUE) != 0) {
            detectedFlagBits.add("VK_EXPORT_METAL_OBJECT_TYPE_METAL_COMMAND_QUEUE_BIT_EXT");
        }
        if ((flags & EXPORT_METAL_OBJECT_TYPE_METAL_DEVICE) != 0) {
            detectedFlagBits.add("VK_EXPORT_METAL_OBJECT_TYPE_METAL_DEVICE_BIT_EXT");
        }
        if ((flags & EXPORT_METAL_OBJECT_TYPE_METAL_IOSURFACE) != 0) {
            detectedFlagBits.add("VK_EXPORT_METAL_OBJECT_TYPE_METAL_IOSURFACE_BIT_EXT");
        }
        if ((flags & EXPORT_METAL_OBJECT_TYPE_METAL_SHARED_EVENT) != 0) {
            detectedFlagBits.add("VK_EXPORT_METAL_OBJECT_TYPE_METAL_SHARED_EVENT_BIT_EXT");
        }
        if ((flags & EXPORT_METAL_OBJECT_TYPE_METAL_TEXTURE) != 0) {

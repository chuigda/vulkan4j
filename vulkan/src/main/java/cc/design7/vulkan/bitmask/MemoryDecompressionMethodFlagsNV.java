...
public final class MemoryDecompressionMethodFlagsNV {
    public static final long GDEFLATE_1_0 = 0x1L;

    public static String explain(@enumtype(MemoryDecompressionMethodFlagsNV.class) long flags) {
    ...
    private MemoryDecompressionMethodFlagsNV() {}
}

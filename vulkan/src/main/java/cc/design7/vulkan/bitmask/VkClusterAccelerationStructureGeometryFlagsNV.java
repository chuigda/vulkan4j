...
public final class VkClusterAccelerationStructureGeometryFlagsNV {
    public static final int CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_CULL_DISABLE = 0x1;
    public static final int CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_NO_DUPLICATE_ANYHIT_INVOCATION = 0x2;
    public static final int CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_OPAQUE = 0x4;

    public static String explain(@enumtype(VkClusterAccelerationStructureGeometryFlagsNV.class) int flags) {
        List<String> detectedFlagBits = new ArrayList<>();
        if ((flags & CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_CULL_DISABLE) != 0) {
            detectedFlagBits.add("VK_CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_CULL_DISABLE_BIT_NV");
        }
        if ((flags & CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_NO_DUPLICATE_ANYHIT_INVOCATION) != 0) {
            detectedFlagBits.add("VK_CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_NO_DUPLICATE_ANYHIT_INVOCATION_BIT_NV");
        }
        if ((flags & CLUSTER_ACCELERATION_STRUCTURE_GEOMETRY_OPAQUE) != 0) {

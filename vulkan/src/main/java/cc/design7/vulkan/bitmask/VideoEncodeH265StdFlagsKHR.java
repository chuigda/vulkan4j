...
public final class VideoEncodeH265StdFlagsKHR {
    ...
    public static String explain(@enumtype(VideoEncodeH265StdFlagsKHR.class) int flags) {
    ...
    private VideoEncodeH265StdFlagsKHR() {}
}

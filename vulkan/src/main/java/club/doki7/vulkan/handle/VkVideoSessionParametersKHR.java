...
public record VkVideoSessionParametersKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkVideoSessionParametersKHR> {
        ...
        public static Ptr allocate(Arena arena, VkVideoSessionParametersKHR @Nullable values[]) {
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkVideoSessionParametersKHR ...values) {

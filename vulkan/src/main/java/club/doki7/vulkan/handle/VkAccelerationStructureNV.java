...
public record VkAccelerationStructureNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<VkAccelerationStructureNV> {
        ...
        public static Ptr allocate(Arena arena, VkAccelerationStructureNV @Nullable values[]) {
        ...
        public static Ptr allocateV(Arena arena, @Nullable VkAccelerationStructureNV ...values) {

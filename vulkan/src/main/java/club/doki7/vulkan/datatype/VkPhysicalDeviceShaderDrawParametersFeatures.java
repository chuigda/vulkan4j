...
public record VkPhysicalDeviceShaderDrawParametersFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderDrawParametersFeatures {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderDrawParametersFeatures, Iterable<VkPhysicalDeviceShaderDrawParametersFeatures> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderDrawParametersFeatures.BYTES, VkPhysicalDeviceShaderDrawParametersFeatures.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceShaderDrawParametersFeatures> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceShaderDrawParametersFeatures.BYTES) > 0;
            }

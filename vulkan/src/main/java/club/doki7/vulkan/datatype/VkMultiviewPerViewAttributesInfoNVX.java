...
///
/// The {@code allocate} ({@link VkMultiviewPerViewAttributesInfoNVX#allocate(Arena)}, {@link VkMultiviewPerViewAttributesInfoNVX#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkMultiviewPerViewAttributesInfoNVX#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkMultiviewPerViewAttributesInfoNVX(@NotNull MemorySegment segment) implements IVkMultiviewPerViewAttributesInfoNVX {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkMultiviewPerViewAttributesInfoNVX.html"><code>VkMultiviewPerViewAttributesInfoNVX</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkMultiviewPerViewAttributesInfoNVX}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkMultiviewPerViewAttributesInfoNVX to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkMultiviewPerViewAttributesInfoNVX.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkMultiviewPerViewAttributesInfoNVX, Iterable<VkMultiviewPerViewAttributesInfoNVX> {
        public long size() {
            return segment.byteSize() / VkMultiviewPerViewAttributesInfoNVX.BYTES;
        }
        ...
        public @NotNull VkMultiviewPerViewAttributesInfoNVX at(long index) {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMultiviewPerViewAttributesInfoNVX.BYTES, VkMultiviewPerViewAttributesInfoNVX.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkMultiviewPerViewAttributesInfoNVX.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkMultiviewPerViewAttributesInfoNVX.BYTES,
                (end - start) * VkMultiviewPerViewAttributesInfoNVX.BYTES
            ));
        }
        ...
        public static final class Iter implements Iterator<VkMultiviewPerViewAttributesInfoNVX> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkMultiviewPerViewAttributesInfoNVX.BYTES) > 0;
            }

            @Override
            public VkMultiviewPerViewAttributesInfoNVX next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkMultiviewPerViewAttributesInfoNVX ret = new VkMultiviewPerViewAttributesInfoNVX(segment.asSlice(0, VkMultiviewPerViewAttributesInfoNVX.BYTES));
                segment = segment.asSlice(VkMultiviewPerViewAttributesInfoNVX.BYTES);
                return ret;
            }
    ...
    public static VkMultiviewPerViewAttributesInfoNVX.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkMultiviewPerViewAttributesInfoNVX.Ptr ret = new VkMultiviewPerViewAttributesInfoNVX.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.MULTIVIEW_PER_VIEW_ATTRIBUTES_INFO_NVX);
        }
        return ret;
    }

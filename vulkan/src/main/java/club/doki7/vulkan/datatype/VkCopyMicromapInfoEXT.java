...
public record VkCopyMicromapInfoEXT(@NotNull MemorySegment segment) implements IVkCopyMicromapInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyMicromapInfoEXT, Iterable<VkCopyMicromapInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCopyMicromapInfoEXT.BYTES, VkCopyMicromapInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkCopyMicromapInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkCopyMicromapInfoEXT.BYTES) > 0;
            }

...
public record VkSysmemColorSpaceFUCHSIA(@NotNull MemorySegment segment) implements IVkSysmemColorSpaceFUCHSIA {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSysmemColorSpaceFUCHSIA, Iterable<VkSysmemColorSpaceFUCHSIA> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSysmemColorSpaceFUCHSIA.BYTES, VkSysmemColorSpaceFUCHSIA.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSysmemColorSpaceFUCHSIA> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSysmemColorSpaceFUCHSIA.BYTES) > 0;
            }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCooperativeMatrix2FeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceCooperativeMatrix2FeaturesNV#allocate(Arena, int)})

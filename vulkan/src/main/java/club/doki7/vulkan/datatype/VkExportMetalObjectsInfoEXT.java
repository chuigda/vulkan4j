...
public record VkExportMetalObjectsInfoEXT(@NotNull MemorySegment segment) implements IVkExportMetalObjectsInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkExportMetalObjectsInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkExportMetalObjectsInfoEXT.BYTES, VkExportMetalObjectsInfoEXT.BYTES));
        }

...
public record VkPipelineSampleLocationsStateCreateInfoEXT(@NotNull MemorySegment segment) implements IVkPipelineSampleLocationsStateCreateInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineSampleLocationsStateCreateInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineSampleLocationsStateCreateInfoEXT.BYTES, VkPipelineSampleLocationsStateCreateInfoEXT.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int sampleLocationsEnable() {
        return segment.get(LAYOUT$sampleLocationsEnable, OFFSET$sampleLocationsEnable);
    }

    public void sampleLocationsEnable(@Unsigned @NativeType("VkBool32") int value) {

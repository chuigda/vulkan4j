...
///
/// The {@code allocate} ({@link VkExportSemaphoreSciSyncInfoNV#allocate(Arena)}, {@link VkExportSemaphoreSciSyncInfoNV#allocate(Arena, int)})
...
public record VkExportSemaphoreSciSyncInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkExportSemaphoreSciSyncInfoNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.EXPORT_SEMAPHORE_SCI_SYNC_INFO_NV);
        }
        return ret;
    }

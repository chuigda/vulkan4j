...
public record VkDebugReportCallbackCreateInfoEXT(@NotNull MemorySegment segment) implements IVkDebugReportCallbackCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDebugReportCallbackCreateInfoEXT, Iterable<VkDebugReportCallbackCreateInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDebugReportCallbackCreateInfoEXT.BYTES, VkDebugReportCallbackCreateInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDebugReportCallbackCreateInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDebugReportCallbackCreateInfoEXT.BYTES) > 0;
            }

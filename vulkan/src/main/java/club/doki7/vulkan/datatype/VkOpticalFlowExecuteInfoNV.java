...
///
/// The {@code allocate} ({@link VkOpticalFlowExecuteInfoNV#allocate(Arena)}, {@link VkOpticalFlowExecuteInfoNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkOpticalFlowExecuteInfoNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkOpticalFlowExecuteInfoNV(@NotNull MemorySegment segment) implements IVkOpticalFlowExecuteInfoNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkOpticalFlowExecuteInfoNV.html"><code>VkOpticalFlowExecuteInfoNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkOpticalFlowExecuteInfoNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkOpticalFlowExecuteInfoNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkOpticalFlowExecuteInfoNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkOpticalFlowExecuteInfoNV, Iterable<VkOpticalFlowExecuteInfoNV> {
        public long size() {
            return segment.byteSize() / VkOpticalFlowExecuteInfoNV.BYTES;
        }
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkOpticalFlowExecuteInfoNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkOpticalFlowExecuteInfoNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkOpticalFlowExecuteInfoNV.BYTES,
                (end - start) * VkOpticalFlowExecuteInfoNV.BYTES
            ));
        }
        ...
        public static final class Iter implements Iterator<VkOpticalFlowExecuteInfoNV> {
            ...
            @Override
            public VkOpticalFlowExecuteInfoNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkOpticalFlowExecuteInfoNV ret = new VkOpticalFlowExecuteInfoNV(segment.asSlice(0, VkOpticalFlowExecuteInfoNV.BYTES));
                segment = segment.asSlice(VkOpticalFlowExecuteInfoNV.BYTES);
                return ret;
            }
    ...
    public static VkOpticalFlowExecuteInfoNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkOpticalFlowExecuteInfoNV.Ptr ret = new VkOpticalFlowExecuteInfoNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.OPTICAL_FLOW_EXECUTE_INFO_NV);
        }
        return ret;
    }
    ...
    public VkOpticalFlowExecuteInfoNV regionCount(@Unsigned int value) {
        segment.set(LAYOUT$regionCount, OFFSET$regionCount, value);
        return this;
    }

    public VkOpticalFlowExecuteInfoNV pRegions(@Nullable IVkRect2D value) {

...
public record VkComputePipelineCreateInfo(@NotNull MemorySegment segment) implements IVkComputePipelineCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkComputePipelineCreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkComputePipelineCreateInfo.BYTES, VkComputePipelineCreateInfo.BYTES));
        }

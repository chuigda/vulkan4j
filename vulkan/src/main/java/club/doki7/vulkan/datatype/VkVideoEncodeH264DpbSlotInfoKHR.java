...
public record VkVideoEncodeH264DpbSlotInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH264DpbSlotInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH264DpbSlotInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeH264DpbSlotInfoKHR.BYTES, VkVideoEncodeH264DpbSlotInfoKHR.BYTES));
        }

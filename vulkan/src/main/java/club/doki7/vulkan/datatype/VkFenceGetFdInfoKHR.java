...
public record VkFenceGetFdInfoKHR(@NotNull MemorySegment segment) implements IVkFenceGetFdInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkFenceGetFdInfoKHR, Iterable<VkFenceGetFdInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkFenceGetFdInfoKHR.BYTES, VkFenceGetFdInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkFenceGetFdInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkFenceGetFdInfoKHR.BYTES) > 0;
            }

...
public record StdVideoH264SpsVuiFlags(@NotNull MemorySegment segment) implements IStdVideoH264SpsVuiFlags {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoH264SpsVuiFlags, Iterable<StdVideoH264SpsVuiFlags> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoH264SpsVuiFlags.BYTES, StdVideoH264SpsVuiFlags.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoH264SpsVuiFlags> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoH264SpsVuiFlags.BYTES) > 0;
            }

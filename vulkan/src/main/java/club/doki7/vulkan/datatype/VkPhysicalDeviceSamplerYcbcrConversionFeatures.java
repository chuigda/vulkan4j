...
///
/// The {@code allocate} ({@link VkPhysicalDeviceSamplerYcbcrConversionFeatures#allocate(Arena)}, {@link VkPhysicalDeviceSamplerYcbcrConversionFeatures#allocate(Arena, int)})

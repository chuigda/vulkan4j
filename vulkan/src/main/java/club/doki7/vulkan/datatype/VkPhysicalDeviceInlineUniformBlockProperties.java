...
///
/// The {@code allocate} ({@link VkPhysicalDeviceInlineUniformBlockProperties#allocate(Arena)}, {@link VkPhysicalDeviceInlineUniformBlockProperties#allocate(Arena, int)})

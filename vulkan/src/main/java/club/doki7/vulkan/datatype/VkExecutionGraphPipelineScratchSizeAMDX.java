...
///
/// The {@code allocate} ({@link VkExecutionGraphPipelineScratchSizeAMDX#allocate(Arena)}, {@link VkExecutionGraphPipelineScratchSizeAMDX#allocate(Arena, int)})
...
public record VkExecutionGraphPipelineScratchSizeAMDX(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkExecutionGraphPipelineScratchSizeAMDX[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.EXECUTION_GRAPH_PIPELINE_SCRATCH_SIZE_AMDX);
        }
        return ret;
    }

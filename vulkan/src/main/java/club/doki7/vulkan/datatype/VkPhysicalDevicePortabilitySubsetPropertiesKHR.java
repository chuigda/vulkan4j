...
public record VkPhysicalDevicePortabilitySubsetPropertiesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDevicePortabilitySubsetPropertiesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePortabilitySubsetPropertiesKHR, Iterable<VkPhysicalDevicePortabilitySubsetPropertiesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDevicePortabilitySubsetPropertiesKHR.BYTES, VkPhysicalDevicePortabilitySubsetPropertiesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDevicePortabilitySubsetPropertiesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDevicePortabilitySubsetPropertiesKHR.BYTES) > 0;
            }

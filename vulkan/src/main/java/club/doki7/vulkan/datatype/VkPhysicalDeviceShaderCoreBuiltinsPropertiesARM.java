...
public record VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderCoreBuiltinsPropertiesARM {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderCoreBuiltinsPropertiesARM {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM.BYTES, VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM.BYTES));
        }

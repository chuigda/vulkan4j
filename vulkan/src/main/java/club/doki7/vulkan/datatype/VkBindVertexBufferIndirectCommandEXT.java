...
public record VkBindVertexBufferIndirectCommandEXT(@NotNull MemorySegment segment) implements IVkBindVertexBufferIndirectCommandEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBindVertexBufferIndirectCommandEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBindVertexBufferIndirectCommandEXT.BYTES, VkBindVertexBufferIndirectCommandEXT.BYTES));
        }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT#allocate(Arena, int)})

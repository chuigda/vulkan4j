...
public record VkPipelineShaderStageNodeCreateInfoAMDX(@NotNull MemorySegment segment) implements IVkPipelineShaderStageNodeCreateInfoAMDX {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineShaderStageNodeCreateInfoAMDX {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineShaderStageNodeCreateInfoAMDX.BYTES, VkPipelineShaderStageNodeCreateInfoAMDX.BYTES));
        }

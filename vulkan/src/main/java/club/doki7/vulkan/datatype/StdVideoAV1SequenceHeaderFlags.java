...
public record StdVideoAV1SequenceHeaderFlags(@NotNull MemorySegment segment) implements IStdVideoAV1SequenceHeaderFlags {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoAV1SequenceHeaderFlags, Iterable<StdVideoAV1SequenceHeaderFlags> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoAV1SequenceHeaderFlags.BYTES, StdVideoAV1SequenceHeaderFlags.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoAV1SequenceHeaderFlags> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoAV1SequenceHeaderFlags.BYTES) > 0;
            }

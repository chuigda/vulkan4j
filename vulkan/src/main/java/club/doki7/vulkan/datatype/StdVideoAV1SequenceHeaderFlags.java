...
public record StdVideoAV1SequenceHeaderFlags(@NotNull MemorySegment segment) implements IPointer {
    ...
    public boolean still_picture() {
        MemorySegment s = segment.asSlice(OFFSET$bitfield$still_picture_reserved, LAYOUT$still_picture_reserved);
    ...
    public static final long OFFSET$bitfield$still_picture_reserved = LAYOUT.byteOffset(PATH$bitfield$still_picture_reserved);
}

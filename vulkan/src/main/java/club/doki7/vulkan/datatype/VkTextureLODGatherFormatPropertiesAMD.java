...
public record VkTextureLODGatherFormatPropertiesAMD(@NotNull MemorySegment segment) implements IVkTextureLODGatherFormatPropertiesAMD {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkTextureLODGatherFormatPropertiesAMD {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkTextureLODGatherFormatPropertiesAMD.BYTES, VkTextureLODGatherFormatPropertiesAMD.BYTES));
        }

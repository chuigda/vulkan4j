...
///
/// The {@link VkMultisampledRenderToSingleSampledInfoEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkMultisampledRenderToSingleSampledInfoEXT#autoInit} to initialize these fields manually for
...
public record VkMultisampledRenderToSingleSampledInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkMultisampledRenderToSingleSampledInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_INFO_EXT);
        }
        return ret;
    }

...
public record VkTileMemoryBindInfoQCOM(@NotNull MemorySegment segment) implements IVkTileMemoryBindInfoQCOM {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkTileMemoryBindInfoQCOM {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkTileMemoryBindInfoQCOM.BYTES, VkTileMemoryBindInfoQCOM.BYTES));
        }

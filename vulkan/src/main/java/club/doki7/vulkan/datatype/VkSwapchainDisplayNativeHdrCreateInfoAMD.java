...
public record VkSwapchainDisplayNativeHdrCreateInfoAMD(@NotNull MemorySegment segment) implements IVkSwapchainDisplayNativeHdrCreateInfoAMD {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSwapchainDisplayNativeHdrCreateInfoAMD, Iterable<VkSwapchainDisplayNativeHdrCreateInfoAMD> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSwapchainDisplayNativeHdrCreateInfoAMD.BYTES, VkSwapchainDisplayNativeHdrCreateInfoAMD.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSwapchainDisplayNativeHdrCreateInfoAMD> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSwapchainDisplayNativeHdrCreateInfoAMD.BYTES) > 0;
            }

...
public record VkSurfaceCapabilitiesFullScreenExclusiveEXT(@NotNull MemorySegment segment) implements IVkSurfaceCapabilitiesFullScreenExclusiveEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSurfaceCapabilitiesFullScreenExclusiveEXT, Iterable<VkSurfaceCapabilitiesFullScreenExclusiveEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSurfaceCapabilitiesFullScreenExclusiveEXT.BYTES, VkSurfaceCapabilitiesFullScreenExclusiveEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSurfaceCapabilitiesFullScreenExclusiveEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSurfaceCapabilitiesFullScreenExclusiveEXT.BYTES) > 0;
            }
    ...
    public void fullScreenExclusiveSupported(@NativeType("VkBool32") @Unsigned int value) {

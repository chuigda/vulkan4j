...
public record VkOpticalFlowImageFormatInfoNV(@NotNull MemorySegment segment) implements IVkOpticalFlowImageFormatInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkOpticalFlowImageFormatInfoNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkOpticalFlowImageFormatInfoNV.BYTES, VkOpticalFlowImageFormatInfoNV.BYTES));
        }

...
///
/// The {@link VkPipelineViewportCoarseSampleOrderStateCreateInfoNV#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPipelineViewportCoarseSampleOrderStateCreateInfoNV#autoInit} to initialize these fields manually for
...
public record VkPipelineViewportCoarseSampleOrderStateCreateInfoNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPipelineViewportCoarseSampleOrderStateCreateInfoNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PIPELINE_VIEWPORT_COARSE_SAMPLE_ORDER_STATE_CREATE_INFO_NV);
        }
        return ret;
    }

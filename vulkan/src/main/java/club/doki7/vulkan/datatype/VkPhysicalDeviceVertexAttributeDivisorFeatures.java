...
public record VkPhysicalDeviceVertexAttributeDivisorFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVertexAttributeDivisorFeatures {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVertexAttributeDivisorFeatures, Iterable<VkPhysicalDeviceVertexAttributeDivisorFeatures> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES, VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceVertexAttributeDivisorFeatures> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceVertexAttributeDivisorFeatures.BYTES) > 0;
            }

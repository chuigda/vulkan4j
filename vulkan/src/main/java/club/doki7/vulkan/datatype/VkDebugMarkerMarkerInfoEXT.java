...
public record VkDebugMarkerMarkerInfoEXT(@NotNull MemorySegment segment) implements IVkDebugMarkerMarkerInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDebugMarkerMarkerInfoEXT, Iterable<VkDebugMarkerMarkerInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDebugMarkerMarkerInfoEXT.BYTES, VkDebugMarkerMarkerInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDebugMarkerMarkerInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDebugMarkerMarkerInfoEXT.BYTES) > 0;
            }

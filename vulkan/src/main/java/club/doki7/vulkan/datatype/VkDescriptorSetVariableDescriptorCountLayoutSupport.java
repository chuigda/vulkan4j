...
public record VkDescriptorSetVariableDescriptorCountLayoutSupport(@NotNull MemorySegment segment) implements IVkDescriptorSetVariableDescriptorCountLayoutSupport {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDescriptorSetVariableDescriptorCountLayoutSupport {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDescriptorSetVariableDescriptorCountLayoutSupport.BYTES, VkDescriptorSetVariableDescriptorCountLayoutSupport.BYTES));
        }

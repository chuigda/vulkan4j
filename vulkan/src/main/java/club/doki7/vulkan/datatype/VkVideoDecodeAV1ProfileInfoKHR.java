...
///
/// The {@link VkVideoDecodeAV1ProfileInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkVideoDecodeAV1ProfileInfoKHR#autoInit} to initialize these fields manually for
...
public record VkVideoDecodeAV1ProfileInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoDecodeAV1ProfileInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.VIDEO_DECODE_AV1_PROFILE_INFO_KHR);
        }
        return ret;
    }

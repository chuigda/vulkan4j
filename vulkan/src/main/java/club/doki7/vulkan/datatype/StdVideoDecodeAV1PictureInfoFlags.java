...
public record StdVideoDecodeAV1PictureInfoFlags(@NotNull MemorySegment segment) implements IPointer {
    public static StdVideoDecodeAV1PictureInfoFlags allocate(Arena arena) {
        StdVideoDecodeAV1PictureInfoFlags ret = new StdVideoDecodeAV1PictureInfoFlags(arena.allocate(LAYOUT));
        return ret;
    }
    ...
    public static StdVideoDecodeAV1PictureInfoFlags[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new StdVideoDecodeAV1PictureInfoFlags(segment.asSlice(i * BYTES, BYTES));
        }
        return ret;
    }
    ...
    public boolean error_resilient_mode() {
        MemorySegment s = segment.asSlice(OFFSET$bitfield$error_resilient_mode_reserved, LAYOUT$error_resilient_mode_reserved);
    ...
    public static final long OFFSET$bitfield$error_resilient_mode_reserved = LAYOUT.byteOffset(PATH$bitfield$error_resilient_mode_reserved);
}

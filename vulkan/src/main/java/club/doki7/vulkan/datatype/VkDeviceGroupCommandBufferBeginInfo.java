...
///
/// The {@code allocate} ({@link VkDeviceGroupCommandBufferBeginInfo#allocate(Arena)}, {@link VkDeviceGroupCommandBufferBeginInfo#allocate(Arena, int)})
...
public record VkDeviceGroupCommandBufferBeginInfo(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkDeviceGroupCommandBufferBeginInfo[] clone(Arena arena, VkDeviceGroupCommandBufferBeginInfo[] src) {
        VkDeviceGroupCommandBufferBeginInfo[] ret = allocate(arena, src.length);

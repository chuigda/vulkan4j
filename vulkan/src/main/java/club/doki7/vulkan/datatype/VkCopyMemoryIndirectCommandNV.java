...
public record VkCopyMemoryIndirectCommandNV(@NotNull MemorySegment segment) implements IVkCopyMemoryIndirectCommandNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyMemoryIndirectCommandNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCopyMemoryIndirectCommandNV.BYTES, VkCopyMemoryIndirectCommandNV.BYTES));
        }

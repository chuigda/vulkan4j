...
public record VkGeneratedCommandsShaderInfoEXT(@NotNull MemorySegment segment) implements IVkGeneratedCommandsShaderInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkGeneratedCommandsShaderInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkGeneratedCommandsShaderInfoEXT.BYTES, VkGeneratedCommandsShaderInfoEXT.BYTES));
        }

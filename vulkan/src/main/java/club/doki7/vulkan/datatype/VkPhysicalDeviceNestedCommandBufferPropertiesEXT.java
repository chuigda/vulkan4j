...
///
/// The {@code allocate} ({@link VkPhysicalDeviceNestedCommandBufferPropertiesEXT#allocate(Arena)}, {@link VkPhysicalDeviceNestedCommandBufferPropertiesEXT#allocate(Arena, int)})

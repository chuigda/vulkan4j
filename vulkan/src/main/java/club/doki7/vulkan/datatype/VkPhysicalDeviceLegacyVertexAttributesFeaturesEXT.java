...
///
/// The {@code allocate} ({@link VkPhysicalDeviceLegacyVertexAttributesFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceLegacyVertexAttributesFeaturesEXT#allocate(Arena, int)})
...
public record VkPhysicalDeviceLegacyVertexAttributesFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceLegacyVertexAttributesFeaturesEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_FEATURES_EXT);
        }
        return ret;
    }

...
public record VkExternalMemoryAcquireUnmodifiedEXT(@NotNull MemorySegment segment) implements IVkExternalMemoryAcquireUnmodifiedEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkExternalMemoryAcquireUnmodifiedEXT, Iterable<VkExternalMemoryAcquireUnmodifiedEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkExternalMemoryAcquireUnmodifiedEXT.BYTES, VkExternalMemoryAcquireUnmodifiedEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkExternalMemoryAcquireUnmodifiedEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkExternalMemoryAcquireUnmodifiedEXT.BYTES) > 0;
            }

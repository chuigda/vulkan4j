...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFragmentShadingRateEnumsFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceFragmentShadingRateEnumsFeaturesNV#allocate(Arena, int)})

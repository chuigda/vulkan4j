...
public record VkDeviceOrHostAddressConstAMDX(@NotNull MemorySegment segment) implements IVkDeviceOrHostAddressConstAMDX {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDeviceOrHostAddressConstAMDX, Iterable<VkDeviceOrHostAddressConstAMDX> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkDeviceOrHostAddressConstAMDX.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<VkDeviceOrHostAddressConstAMDX> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkDeviceOrHostAddressConstAMDX> {
            ...
            @Override
            public VkDeviceOrHostAddressConstAMDX next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkDeviceOrHostAddressConstAMDX ret = new VkDeviceOrHostAddressConstAMDX(segment.asSlice(0, VkDeviceOrHostAddressConstAMDX.BYTES));
                segment = segment.asSlice(VkDeviceOrHostAddressConstAMDX.BYTES);
                return ret;
            }
    ...
    public VkDeviceOrHostAddressConstAMDX deviceAddress(@NativeType("VkDeviceAddress") @Unsigned long value) {

...
public record VkPhysicalDeviceSubgroupSizeControlFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceSubgroupSizeControlFeatures {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceSubgroupSizeControlFeatures {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceSubgroupSizeControlFeatures.BYTES, VkPhysicalDeviceSubgroupSizeControlFeatures.BYTES));
        }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceTextureCompressionASTCHDRFeatures#allocate(Arena)}, {@link VkPhysicalDeviceTextureCompressionASTCHDRFeatures#allocate(Arena, int)})

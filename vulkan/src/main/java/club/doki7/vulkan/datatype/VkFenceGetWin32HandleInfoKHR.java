...
public record VkFenceGetWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IVkFenceGetWin32HandleInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkFenceGetWin32HandleInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkFenceGetWin32HandleInfoKHR.BYTES, VkFenceGetWin32HandleInfoKHR.BYTES));
        }

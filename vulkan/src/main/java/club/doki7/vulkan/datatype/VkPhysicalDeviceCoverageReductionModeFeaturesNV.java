...
public record VkPhysicalDeviceCoverageReductionModeFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCoverageReductionModeFeaturesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCoverageReductionModeFeaturesNV, Iterable<VkPhysicalDeviceCoverageReductionModeFeaturesNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceCoverageReductionModeFeaturesNV.BYTES, VkPhysicalDeviceCoverageReductionModeFeaturesNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceCoverageReductionModeFeaturesNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceCoverageReductionModeFeaturesNV.BYTES) > 0;
            }

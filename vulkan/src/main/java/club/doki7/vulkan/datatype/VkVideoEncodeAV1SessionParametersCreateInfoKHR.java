...
public record VkVideoEncodeAV1SessionParametersCreateInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1SessionParametersCreateInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1SessionParametersCreateInfoKHR, Iterable<VkVideoEncodeAV1SessionParametersCreateInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES, VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeAV1SessionParametersCreateInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeAV1SessionParametersCreateInfoKHR.BYTES) > 0;
            }

...
public record VkPhysicalDeviceShaderCorePropertiesARM(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderCorePropertiesARM {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderCorePropertiesARM, Iterable<VkPhysicalDeviceShaderCorePropertiesARM> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderCorePropertiesARM.BYTES, VkPhysicalDeviceShaderCorePropertiesARM.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceShaderCorePropertiesARM> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceShaderCorePropertiesARM.BYTES) > 0;
            }

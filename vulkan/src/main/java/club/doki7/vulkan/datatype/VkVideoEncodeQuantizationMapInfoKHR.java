...
public record VkVideoEncodeQuantizationMapInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeQuantizationMapInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeQuantizationMapInfoKHR, Iterable<VkVideoEncodeQuantizationMapInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeQuantizationMapInfoKHR.BYTES, VkVideoEncodeQuantizationMapInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeQuantizationMapInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeQuantizationMapInfoKHR.BYTES) > 0;
            }

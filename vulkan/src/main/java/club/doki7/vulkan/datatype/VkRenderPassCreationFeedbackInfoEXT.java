...
public record VkRenderPassCreationFeedbackInfoEXT(@NotNull MemorySegment segment) implements IVkRenderPassCreationFeedbackInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderPassCreationFeedbackInfoEXT, Iterable<VkRenderPassCreationFeedbackInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderPassCreationFeedbackInfoEXT.BYTES, VkRenderPassCreationFeedbackInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkRenderPassCreationFeedbackInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkRenderPassCreationFeedbackInfoEXT.BYTES) > 0;
            }

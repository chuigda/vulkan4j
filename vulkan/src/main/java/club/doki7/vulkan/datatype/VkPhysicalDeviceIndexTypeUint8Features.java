...
public record VkPhysicalDeviceIndexTypeUint8Features(@NotNull MemorySegment segment) implements IVkPhysicalDeviceIndexTypeUint8Features {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceIndexTypeUint8Features {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceIndexTypeUint8Features.BYTES, VkPhysicalDeviceIndexTypeUint8Features.BYTES));
        }

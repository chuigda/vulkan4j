...
public record VkScreenBufferPropertiesQNX(@NotNull MemorySegment segment) implements IVkScreenBufferPropertiesQNX {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkScreenBufferPropertiesQNX, Iterable<VkScreenBufferPropertiesQNX> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkScreenBufferPropertiesQNX.BYTES, VkScreenBufferPropertiesQNX.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkScreenBufferPropertiesQNX> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkScreenBufferPropertiesQNX.BYTES) > 0;
            }

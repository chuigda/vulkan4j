...
public record VkFilterCubicImageViewImageFormatPropertiesEXT(@NotNull MemorySegment segment) implements IVkFilterCubicImageViewImageFormatPropertiesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkFilterCubicImageViewImageFormatPropertiesEXT, Iterable<VkFilterCubicImageViewImageFormatPropertiesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkFilterCubicImageViewImageFormatPropertiesEXT.BYTES, VkFilterCubicImageViewImageFormatPropertiesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkFilterCubicImageViewImageFormatPropertiesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkFilterCubicImageViewImageFormatPropertiesEXT.BYTES) > 0;
            }

...
public record VkQueryLowLatencySupportNV(@NotNull MemorySegment segment) implements IVkQueryLowLatencySupportNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkQueryLowLatencySupportNV, Iterable<VkQueryLowLatencySupportNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkQueryLowLatencySupportNV.BYTES, VkQueryLowLatencySupportNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkQueryLowLatencySupportNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkQueryLowLatencySupportNV.BYTES) > 0;
            }

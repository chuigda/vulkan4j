...
///
/// The {@code allocate} ({@link VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT#allocate(Arena, int)})

...
public record VkBindImagePlaneMemoryInfo(@NotNull MemorySegment segment) implements IVkBindImagePlaneMemoryInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkBindImagePlaneMemoryInfo, Iterable<VkBindImagePlaneMemoryInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBindImagePlaneMemoryInfo.BYTES, VkBindImagePlaneMemoryInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkBindImagePlaneMemoryInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkBindImagePlaneMemoryInfo.BYTES) > 0;
            }

...
public record VkExternalComputeQueueDataParamsNV(@NotNull MemorySegment segment) implements IVkExternalComputeQueueDataParamsNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkExternalComputeQueueDataParamsNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkExternalComputeQueueDataParamsNV.BYTES, VkExternalComputeQueueDataParamsNV.BYTES));
        }

...
public record VkVideoDecodeH265SessionParametersAddInfoKHR(@NotNull MemorySegment segment) implements IVkVideoDecodeH265SessionParametersAddInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoDecodeH265SessionParametersAddInfoKHR, Iterable<VkVideoDecodeH265SessionParametersAddInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoDecodeH265SessionParametersAddInfoKHR.BYTES, VkVideoDecodeH265SessionParametersAddInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoDecodeH265SessionParametersAddInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoDecodeH265SessionParametersAddInfoKHR.BYTES) > 0;
            }

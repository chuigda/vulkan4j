...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR#allocate(Arena, int)})
...
public record VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_FEATURES_KHR);
        }
        return ret;
    }

...
public record VkMemoryGetAndroidHardwareBufferInfoANDROID(@NotNull MemorySegment segment) implements IVkMemoryGetAndroidHardwareBufferInfoANDROID {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryGetAndroidHardwareBufferInfoANDROID {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMemoryGetAndroidHardwareBufferInfoANDROID.BYTES, VkMemoryGetAndroidHardwareBufferInfoANDROID.BYTES));
        }

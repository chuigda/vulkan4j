...
///
/// The {@link VkQueryPoolVideoEncodeFeedbackCreateInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkQueryPoolVideoEncodeFeedbackCreateInfoKHR#autoInit} to initialize these fields manually for
...
public record VkQueryPoolVideoEncodeFeedbackCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkQueryPoolVideoEncodeFeedbackCreateInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.QUERY_POOL_VIDEO_ENCODE_FEEDBACK_CREATE_INFO_KHR);
        }
        return ret;
    }

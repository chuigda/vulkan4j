...
public record VkBufferViewCreateInfo(@NotNull MemorySegment segment) implements IVkBufferViewCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBufferViewCreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBufferViewCreateInfo.BYTES, VkBufferViewCreateInfo.BYTES));
        }

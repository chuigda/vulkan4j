...
///
/// The {@code allocate} ({@link VkPhysicalDeviceTileMemoryHeapPropertiesQCOM#allocate(Arena)}, {@link VkPhysicalDeviceTileMemoryHeapPropertiesQCOM#allocate(Arena, int)})

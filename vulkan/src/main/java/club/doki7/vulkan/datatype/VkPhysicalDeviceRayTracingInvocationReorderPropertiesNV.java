...
///
/// The {@code allocate} ({@link VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV#allocate(Arena, int)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_RAY_TRACING_INVOCATION_REORDER_PROPERTIES_NV);
        }
        return ret;
    }
    ...
    public static final PathElement PATH$rayTracingInvocationReorderReorderingHint = PathElement.groupElement("PATH$rayTracingInvocationReorderReorderingHint");

...
public record VkPhysicalDevicePresentWaitFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDevicePresentWaitFeaturesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePresentWaitFeaturesKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDevicePresentWaitFeaturesKHR.BYTES, VkPhysicalDevicePresentWaitFeaturesKHR.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int presentWait() {
        return segment.get(LAYOUT$presentWait, OFFSET$presentWait);
    }

    public void presentWait(@Unsigned @NativeType("VkBool32") int value) {

...
public record VkPhysicalDeviceLineRasterizationProperties(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLineRasterizationProperties {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLineRasterizationProperties, Iterable<VkPhysicalDeviceLineRasterizationProperties> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceLineRasterizationProperties.BYTES, VkPhysicalDeviceLineRasterizationProperties.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceLineRasterizationProperties> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceLineRasterizationProperties.BYTES) > 0;
            }

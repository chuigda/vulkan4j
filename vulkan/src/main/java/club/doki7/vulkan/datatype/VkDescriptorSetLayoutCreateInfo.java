...
public record VkDescriptorSetLayoutCreateInfo(@NotNull MemorySegment segment) implements IVkDescriptorSetLayoutCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDescriptorSetLayoutCreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDescriptorSetLayoutCreateInfo.BYTES, VkDescriptorSetLayoutCreateInfo.BYTES));
        }

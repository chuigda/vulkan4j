...
public record VkQueueFamilyCheckpointProperties2NV(@NotNull MemorySegment segment) implements IVkQueueFamilyCheckpointProperties2NV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkQueueFamilyCheckpointProperties2NV, Iterable<VkQueueFamilyCheckpointProperties2NV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkQueueFamilyCheckpointProperties2NV.BYTES, VkQueueFamilyCheckpointProperties2NV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkQueueFamilyCheckpointProperties2NV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkQueueFamilyCheckpointProperties2NV.BYTES) > 0;
            }

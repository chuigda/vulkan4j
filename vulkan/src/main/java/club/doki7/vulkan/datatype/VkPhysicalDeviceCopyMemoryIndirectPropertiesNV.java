...
public record VkPhysicalDeviceCopyMemoryIndirectPropertiesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCopyMemoryIndirectPropertiesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCopyMemoryIndirectPropertiesNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceCopyMemoryIndirectPropertiesNV.BYTES, VkPhysicalDeviceCopyMemoryIndirectPropertiesNV.BYTES));
        }

...
public record VkCuModuleTexturingModeCreateInfoNVX(@NotNull MemorySegment segment) implements IVkCuModuleTexturingModeCreateInfoNVX {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCuModuleTexturingModeCreateInfoNVX {
        public long size() {
    ...
    public @Unsigned @NativeType("VkBool32") int use64bitTexturing() {
        return segment.get(LAYOUT$use64bitTexturing, OFFSET$use64bitTexturing);
    }

    public void use64bitTexturing(@Unsigned @NativeType("VkBool32") int value) {

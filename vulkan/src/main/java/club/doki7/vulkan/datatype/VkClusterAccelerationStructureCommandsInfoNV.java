...
///
/// The {@code allocate} ({@link VkClusterAccelerationStructureCommandsInfoNV#allocate(Arena)}, {@link VkClusterAccelerationStructureCommandsInfoNV#allocate(Arena, int)})

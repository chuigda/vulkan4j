...
public record VkRenderingAttachmentInfo(@NotNull MemorySegment segment) implements IVkRenderingAttachmentInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderingAttachmentInfo, Iterable<VkRenderingAttachmentInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderingAttachmentInfo.BYTES, VkRenderingAttachmentInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkRenderingAttachmentInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkRenderingAttachmentInfo.BYTES) > 0;
            }

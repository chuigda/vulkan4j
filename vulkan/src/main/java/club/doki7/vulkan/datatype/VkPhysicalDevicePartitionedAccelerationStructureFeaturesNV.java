...
public record VkPhysicalDevicePartitionedAccelerationStructureFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDevicePartitionedAccelerationStructureFeaturesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePartitionedAccelerationStructureFeaturesNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDevicePartitionedAccelerationStructureFeaturesNV.BYTES, VkPhysicalDevicePartitionedAccelerationStructureFeaturesNV.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int partitionedAccelerationStructure() {
        return segment.get(LAYOUT$partitionedAccelerationStructure, OFFSET$partitionedAccelerationStructure);
    }

    public void partitionedAccelerationStructure(@Unsigned @NativeType("VkBool32") int value) {

...
public record VkLayerProperties(@NotNull MemorySegment segment) implements IVkLayerProperties {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkLayerProperties, Iterable<VkLayerProperties> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkLayerProperties.BYTES, VkLayerProperties.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkLayerProperties> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkLayerProperties.BYTES) > 0;
            }

...
public record VkDisplayPresentInfoKHR(@NotNull MemorySegment segment) implements IVkDisplayPresentInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDisplayPresentInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDisplayPresentInfoKHR.BYTES, VkDisplayPresentInfoKHR.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int persistent() {
        return segment.get(LAYOUT$persistent, OFFSET$persistent);
    }

    public void persistent(@Unsigned @NativeType("VkBool32") int value) {

...
///
/// The {@code allocate} ({@link VkPipelineViewportDepthClampControlCreateInfoEXT#allocate(Arena)}, {@link VkPipelineViewportDepthClampControlCreateInfoEXT#allocate(Arena, int)})

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceProperties2#allocate(Arena)}, {@link VkPhysicalDeviceProperties2#allocate(Arena, int)})
...
public record VkPhysicalDeviceProperties2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceProperties2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_PROPERTIES_2);
        }
        return ret;
    }

...
///
/// The {@code allocate} ({@link VkSamplerYcbcrConversionImageFormatProperties#allocate(Arena)}, {@link VkSamplerYcbcrConversionImageFormatProperties#allocate(Arena, int)})

...
public record VkAccelerationStructureGeometryKHR(@NotNull MemorySegment segment) implements IVkAccelerationStructureGeometryKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureGeometryKHR, Iterable<VkAccelerationStructureGeometryKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAccelerationStructureGeometryKHR.BYTES, VkAccelerationStructureGeometryKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkAccelerationStructureGeometryKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkAccelerationStructureGeometryKHR.BYTES) > 0;
            }

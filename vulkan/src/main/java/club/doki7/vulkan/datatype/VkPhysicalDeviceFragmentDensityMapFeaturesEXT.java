...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFragmentDensityMapFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceFragmentDensityMapFeaturesEXT#allocate(Arena, int)})

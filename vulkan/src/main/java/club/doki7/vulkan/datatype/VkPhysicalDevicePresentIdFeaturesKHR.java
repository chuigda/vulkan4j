...
public record VkPhysicalDevicePresentIdFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDevicePresentIdFeaturesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePresentIdFeaturesKHR, Iterable<VkPhysicalDevicePresentIdFeaturesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDevicePresentIdFeaturesKHR.BYTES, VkPhysicalDevicePresentIdFeaturesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDevicePresentIdFeaturesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDevicePresentIdFeaturesKHR.BYTES) > 0;
            }

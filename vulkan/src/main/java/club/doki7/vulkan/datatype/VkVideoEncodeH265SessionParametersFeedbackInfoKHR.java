...
public record VkVideoEncodeH265SessionParametersFeedbackInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH265SessionParametersFeedbackInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH265SessionParametersFeedbackInfoKHR, Iterable<VkVideoEncodeH265SessionParametersFeedbackInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeH265SessionParametersFeedbackInfoKHR.BYTES, VkVideoEncodeH265SessionParametersFeedbackInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeH265SessionParametersFeedbackInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeH265SessionParametersFeedbackInfoKHR.BYTES) > 0;
            }
    ...
    public void hasStdVPSOverrides(@NativeType("VkBool32") @Unsigned int value) {

...
public record VkGeneratedCommandsInfoNV(@NotNull MemorySegment segment) implements IVkGeneratedCommandsInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkGeneratedCommandsInfoNV {
        public long size() {
    ...
    public @Unsigned @NativeType("VkDeviceSize") long preprocessOffset() {
        return segment.get(LAYOUT$preprocessOffset, OFFSET$preprocessOffset);
    }

    public void preprocessOffset(@Unsigned @NativeType("VkDeviceSize") long value) {
    ...
    public @Unsigned @NativeType("VkDeviceSize") long sequencesCountOffset() {
        return segment.get(LAYOUT$sequencesCountOffset, OFFSET$sequencesCountOffset);
    }

    public void sequencesCountOffset(@Unsigned @NativeType("VkDeviceSize") long value) {
    ...
    public @Unsigned @NativeType("VkDeviceSize") long sequencesIndexOffset() {
        return segment.get(LAYOUT$sequencesIndexOffset, OFFSET$sequencesIndexOffset);
    }

    public void sequencesIndexOffset(@Unsigned @NativeType("VkDeviceSize") long value) {

...
public record StdVideoH265HrdFlags(@NotNull MemorySegment segment) implements IStdVideoH265HrdFlags {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoH265HrdFlags {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoH265HrdFlags.BYTES, StdVideoH265HrdFlags.BYTES));
        }

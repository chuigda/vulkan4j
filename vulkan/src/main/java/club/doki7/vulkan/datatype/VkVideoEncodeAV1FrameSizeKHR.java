...
public record VkVideoEncodeAV1FrameSizeKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1FrameSizeKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1FrameSizeKHR, Iterable<VkVideoEncodeAV1FrameSizeKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeAV1FrameSizeKHR.BYTES, VkVideoEncodeAV1FrameSizeKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeAV1FrameSizeKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeAV1FrameSizeKHR.BYTES) > 0;
            }

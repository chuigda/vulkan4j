...
public record VkPhysicalDeviceDescriptorIndexingFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceDescriptorIndexingFeatures {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceDescriptorIndexingFeatures {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceDescriptorIndexingFeatures.BYTES, VkPhysicalDeviceDescriptorIndexingFeatures.BYTES));
        }

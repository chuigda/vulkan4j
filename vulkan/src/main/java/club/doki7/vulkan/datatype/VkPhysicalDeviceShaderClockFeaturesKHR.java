...
public record VkPhysicalDeviceShaderClockFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderClockFeaturesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderClockFeaturesKHR, Iterable<VkPhysicalDeviceShaderClockFeaturesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderClockFeaturesKHR.BYTES, VkPhysicalDeviceShaderClockFeaturesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceShaderClockFeaturesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceShaderClockFeaturesKHR.BYTES) > 0;
            }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT#allocate(Arena, int)})

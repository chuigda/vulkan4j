...
///
/// The {@code allocate} ({@link VkPhysicalDeviceExtendedDynamicState3PropertiesEXT#allocate(Arena)}, {@link VkPhysicalDeviceExtendedDynamicState3PropertiesEXT#allocate(Arena, int)})

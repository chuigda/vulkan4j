...
public record VkPhysicalDeviceExtendedDynamicState3PropertiesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExtendedDynamicState3PropertiesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExtendedDynamicState3PropertiesEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceExtendedDynamicState3PropertiesEXT.BYTES, VkPhysicalDeviceExtendedDynamicState3PropertiesEXT.BYTES));
        }
    ...
    public void dynamicPrimitiveTopologyUnrestricted(@NativeType("VkBool32") @Unsigned int value) {

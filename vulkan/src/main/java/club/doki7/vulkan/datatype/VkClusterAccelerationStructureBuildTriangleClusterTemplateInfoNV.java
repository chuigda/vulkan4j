...
public record VkClusterAccelerationStructureBuildTriangleClusterTemplateInfoNV(@NotNull MemorySegment segment) implements IVkClusterAccelerationStructureBuildTriangleClusterTemplateInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkClusterAccelerationStructureBuildTriangleClusterTemplateInfoNV {
        public long size() {
    ...
    public @Unsigned @NativeType("VkDeviceAddress") long instantiationBoundingBoxLimit() {
        return segment.get(LAYOUT$instantiationBoundingBoxLimit, OFFSET$instantiationBoundingBoxLimit);
    }

    public void instantiationBoundingBoxLimit(@Unsigned @NativeType("VkDeviceAddress") long value) {

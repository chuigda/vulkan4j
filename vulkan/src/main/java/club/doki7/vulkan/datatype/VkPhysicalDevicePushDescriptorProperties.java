...
///
/// The {@code allocate} ({@link VkPhysicalDevicePushDescriptorProperties#allocate(Arena)}, {@link VkPhysicalDevicePushDescriptorProperties#allocate(Arena, int)})
...
public record VkPhysicalDevicePushDescriptorProperties(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDevicePushDescriptorProperties[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES);
        }
        return ret;
    }

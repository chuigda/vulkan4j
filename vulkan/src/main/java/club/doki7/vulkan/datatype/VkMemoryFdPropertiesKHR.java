...
public record VkMemoryFdPropertiesKHR(@NotNull MemorySegment segment) implements IVkMemoryFdPropertiesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryFdPropertiesKHR, Iterable<VkMemoryFdPropertiesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMemoryFdPropertiesKHR.BYTES, VkMemoryFdPropertiesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkMemoryFdPropertiesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkMemoryFdPropertiesKHR.BYTES) > 0;
            }

...
public record VkPhysicalDeviceExternalMemoryHostPropertiesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalMemoryHostPropertiesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalMemoryHostPropertiesEXT, Iterable<VkPhysicalDeviceExternalMemoryHostPropertiesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceExternalMemoryHostPropertiesEXT.BYTES, VkPhysicalDeviceExternalMemoryHostPropertiesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceExternalMemoryHostPropertiesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceExternalMemoryHostPropertiesEXT.BYTES) > 0;
            }

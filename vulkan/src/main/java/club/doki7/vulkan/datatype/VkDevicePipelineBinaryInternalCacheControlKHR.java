...
public record VkDevicePipelineBinaryInternalCacheControlKHR(@NotNull MemorySegment segment) implements IVkDevicePipelineBinaryInternalCacheControlKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDevicePipelineBinaryInternalCacheControlKHR, Iterable<VkDevicePipelineBinaryInternalCacheControlKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDevicePipelineBinaryInternalCacheControlKHR.BYTES, VkDevicePipelineBinaryInternalCacheControlKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDevicePipelineBinaryInternalCacheControlKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDevicePipelineBinaryInternalCacheControlKHR.BYTES) > 0;
            }

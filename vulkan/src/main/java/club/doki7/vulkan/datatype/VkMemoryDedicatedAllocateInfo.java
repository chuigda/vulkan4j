...
public record VkMemoryDedicatedAllocateInfo(@NotNull MemorySegment segment) implements IVkMemoryDedicatedAllocateInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryDedicatedAllocateInfo, Iterable<VkMemoryDedicatedAllocateInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMemoryDedicatedAllocateInfo.BYTES, VkMemoryDedicatedAllocateInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkMemoryDedicatedAllocateInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkMemoryDedicatedAllocateInfo.BYTES) > 0;
            }

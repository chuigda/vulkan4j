...
public record VkPipelineIndirectDeviceAddressInfoNV(@NotNull MemorySegment segment) implements IVkPipelineIndirectDeviceAddressInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineIndirectDeviceAddressInfoNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineIndirectDeviceAddressInfoNV.BYTES, VkPipelineIndirectDeviceAddressInfoNV.BYTES));
        }

...
public record VkPhysicalDeviceShaderObjectPropertiesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderObjectPropertiesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderObjectPropertiesEXT, Iterable<VkPhysicalDeviceShaderObjectPropertiesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderObjectPropertiesEXT.BYTES, VkPhysicalDeviceShaderObjectPropertiesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceShaderObjectPropertiesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceShaderObjectPropertiesEXT.BYTES) > 0;
            }

...
///
/// The {@code allocate} ({@link VkPipelineExecutableInternalRepresentationKHR#allocate(Arena)}, {@link VkPipelineExecutableInternalRepresentationKHR#allocate(Arena, int)})

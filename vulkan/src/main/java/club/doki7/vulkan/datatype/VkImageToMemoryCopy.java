...
public record VkImageToMemoryCopy(@NotNull MemorySegment segment) implements IVkImageToMemoryCopy {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageToMemoryCopy, Iterable<VkImageToMemoryCopy> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImageToMemoryCopy.BYTES, VkImageToMemoryCopy.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImageToMemoryCopy> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImageToMemoryCopy.BYTES) > 0;
            }

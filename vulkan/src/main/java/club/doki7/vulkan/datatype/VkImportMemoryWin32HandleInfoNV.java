...
public record VkImportMemoryWin32HandleInfoNV(@NotNull MemorySegment segment) implements IVkImportMemoryWin32HandleInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportMemoryWin32HandleInfoNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImportMemoryWin32HandleInfoNV.BYTES, VkImportMemoryWin32HandleInfoNV.BYTES));
        }

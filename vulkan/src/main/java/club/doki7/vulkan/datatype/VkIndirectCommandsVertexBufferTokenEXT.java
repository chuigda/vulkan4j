...
public record VkIndirectCommandsVertexBufferTokenEXT(@NotNull MemorySegment segment) implements IVkIndirectCommandsVertexBufferTokenEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkIndirectCommandsVertexBufferTokenEXT, Iterable<VkIndirectCommandsVertexBufferTokenEXT> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkIndirectCommandsVertexBufferTokenEXT.BYTES, VkIndirectCommandsVertexBufferTokenEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkIndirectCommandsVertexBufferTokenEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkIndirectCommandsVertexBufferTokenEXT.BYTES,
                (end - start) * VkIndirectCommandsVertexBufferTokenEXT.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkIndirectCommandsVertexBufferTokenEXT.BYTES));
        }

        public VkIndirectCommandsVertexBufferTokenEXT[] toArray() {
            VkIndirectCommandsVertexBufferTokenEXT[] ret = new VkIndirectCommandsVertexBufferTokenEXT[(int) size()];
        ...
        public static final class Iter implements Iterator<VkIndirectCommandsVertexBufferTokenEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkIndirectCommandsVertexBufferTokenEXT.BYTES) > 0;
            }

            @Override
            public VkIndirectCommandsVertexBufferTokenEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkIndirectCommandsVertexBufferTokenEXT ret = new VkIndirectCommandsVertexBufferTokenEXT(segment.asSlice(0, VkIndirectCommandsVertexBufferTokenEXT.BYTES));
                segment = segment.asSlice(VkIndirectCommandsVertexBufferTokenEXT.BYTES);
                return ret;
            }

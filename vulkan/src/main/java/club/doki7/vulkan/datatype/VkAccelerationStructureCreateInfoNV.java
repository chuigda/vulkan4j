...
public record VkAccelerationStructureCreateInfoNV(@NotNull MemorySegment segment) implements IVkAccelerationStructureCreateInfoNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureCreateInfoNV, Iterable<VkAccelerationStructureCreateInfoNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAccelerationStructureCreateInfoNV.BYTES, VkAccelerationStructureCreateInfoNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkAccelerationStructureCreateInfoNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkAccelerationStructureCreateInfoNV.BYTES) > 0;
            }

...
public record VkSurfaceFullScreenExclusiveWin32InfoEXT(@NotNull MemorySegment segment) implements IVkSurfaceFullScreenExclusiveWin32InfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSurfaceFullScreenExclusiveWin32InfoEXT, Iterable<VkSurfaceFullScreenExclusiveWin32InfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSurfaceFullScreenExclusiveWin32InfoEXT.BYTES, VkSurfaceFullScreenExclusiveWin32InfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSurfaceFullScreenExclusiveWin32InfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSurfaceFullScreenExclusiveWin32InfoEXT.BYTES) > 0;
            }

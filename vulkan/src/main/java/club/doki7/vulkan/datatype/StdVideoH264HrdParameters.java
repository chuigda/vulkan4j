...
public record StdVideoH264HrdParameters(@NotNull MemorySegment segment) implements IStdVideoH264HrdParameters {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoH264HrdParameters, Iterable<StdVideoH264HrdParameters> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoH264HrdParameters.BYTES, StdVideoH264HrdParameters.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoH264HrdParameters> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoH264HrdParameters.BYTES) > 0;
            }

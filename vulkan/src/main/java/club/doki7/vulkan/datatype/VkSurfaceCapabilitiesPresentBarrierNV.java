...
public record VkSurfaceCapabilitiesPresentBarrierNV(@NotNull MemorySegment segment) implements IVkSurfaceCapabilitiesPresentBarrierNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSurfaceCapabilitiesPresentBarrierNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSurfaceCapabilitiesPresentBarrierNV.BYTES, VkSurfaceCapabilitiesPresentBarrierNV.BYTES));
        }
    ...
    public void presentBarrierSupported(@NativeType("VkBool32") @Unsigned int value) {

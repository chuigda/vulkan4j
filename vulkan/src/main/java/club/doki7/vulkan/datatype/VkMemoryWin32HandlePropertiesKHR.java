...
public record VkMemoryWin32HandlePropertiesKHR(@NotNull MemorySegment segment) implements IVkMemoryWin32HandlePropertiesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryWin32HandlePropertiesKHR, Iterable<VkMemoryWin32HandlePropertiesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMemoryWin32HandlePropertiesKHR.BYTES, VkMemoryWin32HandlePropertiesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkMemoryWin32HandlePropertiesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkMemoryWin32HandlePropertiesKHR.BYTES) > 0;
            }

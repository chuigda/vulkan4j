...
public record VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT.BYTES, VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT.BYTES));
        }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT#allocate(Arena, int)})

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFeatures2#allocate(Arena)}, {@link VkPhysicalDeviceFeatures2#allocate(Arena, int)})
...
public record VkPhysicalDeviceFeatures2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceFeatures2[] clone(Arena arena, VkPhysicalDeviceFeatures2[] src) {
        VkPhysicalDeviceFeatures2[] ret = allocate(arena, src.length);

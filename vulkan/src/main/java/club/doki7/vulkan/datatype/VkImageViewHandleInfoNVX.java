...
public record VkImageViewHandleInfoNVX(@NotNull MemorySegment segment) implements IVkImageViewHandleInfoNVX {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageViewHandleInfoNVX {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImageViewHandleInfoNVX.BYTES, VkImageViewHandleInfoNVX.BYTES));
        }

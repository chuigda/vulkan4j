...
public record StdVideoAV1QuantizationFlags(@NotNull MemorySegment segment) implements IStdVideoAV1QuantizationFlags {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoAV1QuantizationFlags, Iterable<StdVideoAV1QuantizationFlags> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoAV1QuantizationFlags.BYTES, StdVideoAV1QuantizationFlags.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoAV1QuantizationFlags> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoAV1QuantizationFlags.BYTES) > 0;
            }

...
///
/// The {@link VkPhysicalDeviceMaintenance8FeaturesKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceMaintenance8FeaturesKHR#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceMaintenance8FeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceMaintenance8FeaturesKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkPhysicalDeviceMaintenance8FeaturesKHR(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_MAINTENANCE_8_FEATURES_KHR);
        }
        return ret;
    }

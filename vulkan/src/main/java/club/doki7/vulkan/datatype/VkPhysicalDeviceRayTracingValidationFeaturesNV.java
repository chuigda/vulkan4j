...
///
/// The {@code allocate} ({@link VkPhysicalDeviceRayTracingValidationFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceRayTracingValidationFeaturesNV#allocate(Arena, int)})

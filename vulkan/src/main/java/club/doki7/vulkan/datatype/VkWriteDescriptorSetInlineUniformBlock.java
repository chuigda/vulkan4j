...
public record VkWriteDescriptorSetInlineUniformBlock(@NotNull MemorySegment segment) implements IVkWriteDescriptorSetInlineUniformBlock {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkWriteDescriptorSetInlineUniformBlock, Iterable<VkWriteDescriptorSetInlineUniformBlock> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkWriteDescriptorSetInlineUniformBlock.BYTES, VkWriteDescriptorSetInlineUniformBlock.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkWriteDescriptorSetInlineUniformBlock> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkWriteDescriptorSetInlineUniformBlock.BYTES) > 0;
            }

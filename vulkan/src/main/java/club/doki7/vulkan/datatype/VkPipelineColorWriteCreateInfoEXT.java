...
public record VkPipelineColorWriteCreateInfoEXT(@NotNull MemorySegment segment) implements IVkPipelineColorWriteCreateInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineColorWriteCreateInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineColorWriteCreateInfoEXT.BYTES, VkPipelineColorWriteCreateInfoEXT.BYTES));
        }

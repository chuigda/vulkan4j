...
public record VkVideoEncodeH264CapabilitiesKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH264CapabilitiesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH264CapabilitiesKHR {
        public long size() {
    ...
    public @Unsigned @NativeType("VkBool32") int expectDyadicTemporalLayerPattern() {
        return segment.get(LAYOUT$expectDyadicTemporalLayerPattern, OFFSET$expectDyadicTemporalLayerPattern);
    }

    public void expectDyadicTemporalLayerPattern(@Unsigned @NativeType("VkBool32") int value) {

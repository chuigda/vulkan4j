...
public record StdVideoAV1GlobalMotion(@NotNull MemorySegment segment) implements IStdVideoAV1GlobalMotion {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoAV1GlobalMotion, Iterable<StdVideoAV1GlobalMotion> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoAV1GlobalMotion.BYTES, StdVideoAV1GlobalMotion.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoAV1GlobalMotion> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoAV1GlobalMotion.BYTES) > 0;
            }

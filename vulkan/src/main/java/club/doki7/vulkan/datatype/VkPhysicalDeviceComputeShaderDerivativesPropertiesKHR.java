...
///
/// The {@code allocate} ({@link VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR#allocate(Arena)}, {@link VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR#allocate(Arena, int)})

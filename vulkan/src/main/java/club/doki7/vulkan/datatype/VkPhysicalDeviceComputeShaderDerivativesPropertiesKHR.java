...
public record VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceComputeShaderDerivativesPropertiesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceComputeShaderDerivativesPropertiesKHR, Iterable<VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.BYTES, VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR.BYTES) > 0;
            }
    ...
    public void meshAndTaskShaderDerivatives(@NativeType("VkBool32") @Unsigned int value) {

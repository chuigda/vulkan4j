...
public record VkImageCopy(@NotNull MemorySegment segment) implements IVkImageCopy {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageCopy, Iterable<VkImageCopy> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImageCopy.BYTES, VkImageCopy.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImageCopy> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImageCopy.BYTES) > 0;
            }

...
public record VkPipelineRasterizationDepthClipStateCreateInfoEXT(@NotNull MemorySegment segment) implements IVkPipelineRasterizationDepthClipStateCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineRasterizationDepthClipStateCreateInfoEXT, Iterable<VkPipelineRasterizationDepthClipStateCreateInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineRasterizationDepthClipStateCreateInfoEXT.BYTES, VkPipelineRasterizationDepthClipStateCreateInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineRasterizationDepthClipStateCreateInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineRasterizationDepthClipStateCreateInfoEXT.BYTES) > 0;
            }

...
public record VkSurfacePresentModeCompatibilityEXT(@NotNull MemorySegment segment) implements IVkSurfacePresentModeCompatibilityEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSurfacePresentModeCompatibilityEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSurfacePresentModeCompatibilityEXT.BYTES, VkSurfacePresentModeCompatibilityEXT.BYTES));
        }

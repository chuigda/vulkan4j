...
///
/// The {@link VkSamplerCustomBorderColorCreateInfoEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkSamplerCustomBorderColorCreateInfoEXT#autoInit} to initialize these fields manually for
...
public record VkSamplerCustomBorderColorCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkSamplerCustomBorderColorCreateInfoEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkSamplerCustomBorderColorCreateInfoEXT(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.SAMPLER_CUSTOM_BORDER_COLOR_CREATE_INFO_EXT);
        }
        return ret;
    }

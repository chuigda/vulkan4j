...
///
/// The {@code allocate} ({@link VkPhysicalDeviceNestedCommandBufferFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceNestedCommandBufferFeaturesEXT#allocate(Arena, int)})

...
public record StdVideoEncodeH264WeightTableFlags(@NotNull MemorySegment segment) implements IStdVideoEncodeH264WeightTableFlags {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeH264WeightTableFlags, Iterable<StdVideoEncodeH264WeightTableFlags> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoEncodeH264WeightTableFlags.BYTES, StdVideoEncodeH264WeightTableFlags.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoEncodeH264WeightTableFlags> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoEncodeH264WeightTableFlags.BYTES) > 0;
            }

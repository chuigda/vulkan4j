...
public record VkPhysicalDeviceMaintenance7FeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMaintenance7FeaturesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMaintenance7FeaturesKHR, Iterable<VkPhysicalDeviceMaintenance7FeaturesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceMaintenance7FeaturesKHR.BYTES, VkPhysicalDeviceMaintenance7FeaturesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceMaintenance7FeaturesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceMaintenance7FeaturesKHR.BYTES) > 0;
            }
    ...
    public void maintenance7(@NativeType("VkBool32") @Unsigned int value) {

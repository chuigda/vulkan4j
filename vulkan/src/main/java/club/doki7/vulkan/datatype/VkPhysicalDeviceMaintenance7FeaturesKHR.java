...
public record VkPhysicalDeviceMaintenance7FeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMaintenance7FeaturesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMaintenance7FeaturesKHR {
        public long size() {
    ...
    public @Unsigned @NativeType("VkBool32") int maintenance7() {
        return segment.get(LAYOUT$maintenance7, OFFSET$maintenance7);
    }

    public void maintenance7(@Unsigned @NativeType("VkBool32") int value) {

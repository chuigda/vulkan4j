...
public record VkImageViewAddressPropertiesNVX(@NotNull MemorySegment segment) implements IVkImageViewAddressPropertiesNVX {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageViewAddressPropertiesNVX, Iterable<VkImageViewAddressPropertiesNVX> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImageViewAddressPropertiesNVX.BYTES, VkImageViewAddressPropertiesNVX.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImageViewAddressPropertiesNVX> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImageViewAddressPropertiesNVX.BYTES) > 0;
            }

...
public record VkExportMetalCommandQueueInfoEXT(@NotNull MemorySegment segment) implements IVkExportMetalCommandQueueInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkExportMetalCommandQueueInfoEXT, Iterable<VkExportMetalCommandQueueInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkExportMetalCommandQueueInfoEXT.BYTES, VkExportMetalCommandQueueInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkExportMetalCommandQueueInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkExportMetalCommandQueueInfoEXT.BYTES) > 0;
            }

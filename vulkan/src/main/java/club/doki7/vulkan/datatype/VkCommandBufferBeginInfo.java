...
public record VkCommandBufferBeginInfo(@NotNull MemorySegment segment) implements IVkCommandBufferBeginInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkCommandBufferBeginInfo, Iterable<VkCommandBufferBeginInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCommandBufferBeginInfo.BYTES, VkCommandBufferBeginInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkCommandBufferBeginInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkCommandBufferBeginInfo.BYTES) > 0;
            }

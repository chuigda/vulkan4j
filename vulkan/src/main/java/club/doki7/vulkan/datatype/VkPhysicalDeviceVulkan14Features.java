...
public record VkPhysicalDeviceVulkan14Features(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVulkan14Features {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVulkan14Features, Iterable<VkPhysicalDeviceVulkan14Features> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceVulkan14Features.BYTES, VkPhysicalDeviceVulkan14Features.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceVulkan14Features> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceVulkan14Features.BYTES) > 0;
            }

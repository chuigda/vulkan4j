...
///
/// The {@code allocate} ({@link VkPhysicalDevicePipelineRobustnessProperties#allocate(Arena)}, {@link VkPhysicalDevicePipelineRobustnessProperties#allocate(Arena, int)})

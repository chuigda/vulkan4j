...
///
/// The {@code allocate} ({@link VkVideoDecodeAV1InlineSessionParametersInfoKHR#allocate(Arena)}, {@link VkVideoDecodeAV1InlineSessionParametersInfoKHR#allocate(Arena, int)})

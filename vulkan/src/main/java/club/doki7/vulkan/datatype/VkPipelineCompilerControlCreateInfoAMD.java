...
public record VkPipelineCompilerControlCreateInfoAMD(@NotNull MemorySegment segment) implements IVkPipelineCompilerControlCreateInfoAMD {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineCompilerControlCreateInfoAMD, Iterable<VkPipelineCompilerControlCreateInfoAMD> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineCompilerControlCreateInfoAMD.BYTES, VkPipelineCompilerControlCreateInfoAMD.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineCompilerControlCreateInfoAMD> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineCompilerControlCreateInfoAMD.BYTES) > 0;
            }

...
///
/// The {@link VkPipelineCompilerControlCreateInfoAMD#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPipelineCompilerControlCreateInfoAMD#autoInit} to initialize these fields manually for
...
public record VkPipelineCompilerControlCreateInfoAMD(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final PathElement PATH$compilerControlFlags = PathElement.groupElement("PATH$compilerControlFlags");

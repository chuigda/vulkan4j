...
public record VkPipelineRasterizationLineStateCreateInfo(@NotNull MemorySegment segment) implements IVkPipelineRasterizationLineStateCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineRasterizationLineStateCreateInfo {
        public long size() {
    ...
    public @Unsigned @NativeType("VkBool32") int stippledLineEnable() {
        return segment.get(LAYOUT$stippledLineEnable, OFFSET$stippledLineEnable);
    }

    public void stippledLineEnable(@Unsigned @NativeType("VkBool32") int value) {

...
public record VkPhysicalDeviceMaintenance6Features(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMaintenance6Features {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMaintenance6Features, Iterable<VkPhysicalDeviceMaintenance6Features> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceMaintenance6Features.BYTES, VkPhysicalDeviceMaintenance6Features.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceMaintenance6Features> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceMaintenance6Features.BYTES) > 0;
            }

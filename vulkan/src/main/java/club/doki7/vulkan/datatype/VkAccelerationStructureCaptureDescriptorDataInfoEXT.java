...
public record VkAccelerationStructureCaptureDescriptorDataInfoEXT(@NotNull MemorySegment segment) implements IVkAccelerationStructureCaptureDescriptorDataInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureCaptureDescriptorDataInfoEXT, Iterable<VkAccelerationStructureCaptureDescriptorDataInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAccelerationStructureCaptureDescriptorDataInfoEXT.BYTES, VkAccelerationStructureCaptureDescriptorDataInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkAccelerationStructureCaptureDescriptorDataInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkAccelerationStructureCaptureDescriptorDataInfoEXT.BYTES) > 0;
            }

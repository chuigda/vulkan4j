...
public record VkSurfaceCapabilities2KHR(@NotNull MemorySegment segment) implements IVkSurfaceCapabilities2KHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSurfaceCapabilities2KHR, Iterable<VkSurfaceCapabilities2KHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSurfaceCapabilities2KHR.BYTES, VkSurfaceCapabilities2KHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSurfaceCapabilities2KHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSurfaceCapabilities2KHR.BYTES) > 0;
            }

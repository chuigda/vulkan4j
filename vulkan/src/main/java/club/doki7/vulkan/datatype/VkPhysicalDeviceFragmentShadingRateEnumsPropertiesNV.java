...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV#allocate(Arena, int)})

...
public record VkDedicatedAllocationMemoryAllocateInfoNV(@NotNull MemorySegment segment) implements IVkDedicatedAllocationMemoryAllocateInfoNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDedicatedAllocationMemoryAllocateInfoNV, Iterable<VkDedicatedAllocationMemoryAllocateInfoNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDedicatedAllocationMemoryAllocateInfoNV.BYTES, VkDedicatedAllocationMemoryAllocateInfoNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDedicatedAllocationMemoryAllocateInfoNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDedicatedAllocationMemoryAllocateInfoNV.BYTES) > 0;
            }

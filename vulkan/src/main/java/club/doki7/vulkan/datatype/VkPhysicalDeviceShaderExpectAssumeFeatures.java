...
public record VkPhysicalDeviceShaderExpectAssumeFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderExpectAssumeFeatures {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderExpectAssumeFeatures {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderExpectAssumeFeatures.BYTES, VkPhysicalDeviceShaderExpectAssumeFeatures.BYTES));
        }

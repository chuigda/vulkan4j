...
public record VkImageMemoryRequirementsInfo2(@NotNull MemorySegment segment) implements IVkImageMemoryRequirementsInfo2 {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageMemoryRequirementsInfo2, Iterable<VkImageMemoryRequirementsInfo2> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImageMemoryRequirementsInfo2.BYTES, VkImageMemoryRequirementsInfo2.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImageMemoryRequirementsInfo2> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImageMemoryRequirementsInfo2.BYTES) > 0;
            }

...
public record VkPhysicalDeviceMaintenance4Features(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMaintenance4Features {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMaintenance4Features, Iterable<VkPhysicalDeviceMaintenance4Features> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceMaintenance4Features.BYTES, VkPhysicalDeviceMaintenance4Features.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceMaintenance4Features> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceMaintenance4Features.BYTES) > 0;
            }

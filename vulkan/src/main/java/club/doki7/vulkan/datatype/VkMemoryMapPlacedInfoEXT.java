...
public record VkMemoryMapPlacedInfoEXT(@NotNull MemorySegment segment) implements IVkMemoryMapPlacedInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryMapPlacedInfoEXT, Iterable<VkMemoryMapPlacedInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMemoryMapPlacedInfoEXT.BYTES, VkMemoryMapPlacedInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkMemoryMapPlacedInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkMemoryMapPlacedInfoEXT.BYTES) > 0;
            }

...
public record VkPhysicalDeviceProtectedMemoryFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceProtectedMemoryFeatures {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceProtectedMemoryFeatures, Iterable<VkPhysicalDeviceProtectedMemoryFeatures> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceProtectedMemoryFeatures.BYTES, VkPhysicalDeviceProtectedMemoryFeatures.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceProtectedMemoryFeatures> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceProtectedMemoryFeatures.BYTES) > 0;
            }

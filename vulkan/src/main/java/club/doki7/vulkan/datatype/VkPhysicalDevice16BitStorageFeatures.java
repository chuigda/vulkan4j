...
public record VkPhysicalDevice16BitStorageFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDevice16BitStorageFeatures {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevice16BitStorageFeatures, Iterable<VkPhysicalDevice16BitStorageFeatures> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDevice16BitStorageFeatures.BYTES, VkPhysicalDevice16BitStorageFeatures.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDevice16BitStorageFeatures> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDevice16BitStorageFeatures.BYTES) > 0;
            }

...
public record VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT, Iterable<VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT.BYTES, VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT.BYTES) > 0;
            }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceDeviceMemoryReportFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceDeviceMemoryReportFeaturesEXT#allocate(Arena, int)})

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceAddressBindingReportFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceAddressBindingReportFeaturesEXT#allocate(Arena, int)})

...
public record VkAccelerationStructureDeviceAddressInfoKHR(@NotNull MemorySegment segment) implements IVkAccelerationStructureDeviceAddressInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureDeviceAddressInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAccelerationStructureDeviceAddressInfoKHR.BYTES, VkAccelerationStructureDeviceAddressInfoKHR.BYTES));
        }

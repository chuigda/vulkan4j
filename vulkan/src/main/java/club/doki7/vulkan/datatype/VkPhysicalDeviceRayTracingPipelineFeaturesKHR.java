...
///
/// The {@code allocate} ({@link VkPhysicalDeviceRayTracingPipelineFeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceRayTracingPipelineFeaturesKHR#allocate(Arena, int)})

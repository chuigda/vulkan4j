...
public record StdVideoH265SpsVuiFlags(@NotNull MemorySegment segment) implements IStdVideoH265SpsVuiFlags {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoH265SpsVuiFlags, Iterable<StdVideoH265SpsVuiFlags> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoH265SpsVuiFlags.BYTES, StdVideoH265SpsVuiFlags.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoH265SpsVuiFlags> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoH265SpsVuiFlags.BYTES) > 0;
            }

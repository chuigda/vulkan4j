...
public record VkPartitionedAccelerationStructureUpdateInstanceDataNV(@NotNull MemorySegment segment) implements IVkPartitionedAccelerationStructureUpdateInstanceDataNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPartitionedAccelerationStructureUpdateInstanceDataNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPartitionedAccelerationStructureUpdateInstanceDataNV.BYTES, VkPartitionedAccelerationStructureUpdateInstanceDataNV.BYTES));
        }

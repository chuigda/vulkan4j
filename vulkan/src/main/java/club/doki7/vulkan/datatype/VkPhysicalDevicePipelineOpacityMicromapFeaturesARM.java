...
///
/// The {@code allocate} ({@link VkPhysicalDevicePipelineOpacityMicromapFeaturesARM#allocate(Arena)}, {@link VkPhysicalDevicePipelineOpacityMicromapFeaturesARM#allocate(Arena, int)})

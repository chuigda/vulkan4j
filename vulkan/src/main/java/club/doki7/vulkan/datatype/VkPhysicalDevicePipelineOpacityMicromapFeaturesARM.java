...
public record VkPhysicalDevicePipelineOpacityMicromapFeaturesARM(@NotNull MemorySegment segment) implements IVkPhysicalDevicePipelineOpacityMicromapFeaturesARM {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePipelineOpacityMicromapFeaturesARM {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDevicePipelineOpacityMicromapFeaturesARM.BYTES, VkPhysicalDevicePipelineOpacityMicromapFeaturesARM.BYTES));
        }

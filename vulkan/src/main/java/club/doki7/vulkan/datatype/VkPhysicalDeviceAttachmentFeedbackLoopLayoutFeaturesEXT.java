...
///
/// The {@code allocate} ({@link VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT#allocate(Arena, int)})

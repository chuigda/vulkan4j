...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM#allocate(Arena)}, {@link VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM#allocate(Arena, int)})

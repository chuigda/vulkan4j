...
public record VkVideoEncodeH264RateControlLayerInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH264RateControlLayerInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH264RateControlLayerInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeH264RateControlLayerInfoKHR.BYTES, VkVideoEncodeH264RateControlLayerInfoKHR.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int useMinQp() {
        return segment.get(LAYOUT$useMinQp, OFFSET$useMinQp);
    }

    public void useMinQp(@Unsigned @NativeType("VkBool32") int value) {
    ...
    public @Unsigned @NativeType("VkBool32") int useMaxQp() {
        return segment.get(LAYOUT$useMaxQp, OFFSET$useMaxQp);
    }

    public void useMaxQp(@Unsigned @NativeType("VkBool32") int value) {

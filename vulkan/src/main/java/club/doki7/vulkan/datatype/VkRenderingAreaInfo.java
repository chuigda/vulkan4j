...
public record VkRenderingAreaInfo(@NotNull MemorySegment segment) implements IVkRenderingAreaInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderingAreaInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderingAreaInfo.BYTES, VkRenderingAreaInfo.BYTES));
        }

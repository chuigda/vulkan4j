...
///
/// The {@code allocate} ({@link VkVideoFormatAV1QuantizationMapPropertiesKHR#allocate(Arena)}, {@link VkVideoFormatAV1QuantizationMapPropertiesKHR#allocate(Arena, int)})

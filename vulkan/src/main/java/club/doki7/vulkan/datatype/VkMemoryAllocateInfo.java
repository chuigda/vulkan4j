...
public record VkMemoryAllocateInfo(@NotNull MemorySegment segment) implements IVkMemoryAllocateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryAllocateInfo {
        public long size() {
    ...
    public @Unsigned @NativeType("VkDeviceSize") long allocationSize() {
        return segment.get(LAYOUT$allocationSize, OFFSET$allocationSize);
    }

    public void allocationSize(@Unsigned @NativeType("VkDeviceSize") long value) {

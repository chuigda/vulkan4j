...
public record VkDisplaySurfaceStereoCreateInfoNV(@NotNull MemorySegment segment) implements IVkDisplaySurfaceStereoCreateInfoNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDisplaySurfaceStereoCreateInfoNV, Iterable<VkDisplaySurfaceStereoCreateInfoNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDisplaySurfaceStereoCreateInfoNV.BYTES, VkDisplaySurfaceStereoCreateInfoNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDisplaySurfaceStereoCreateInfoNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDisplaySurfaceStereoCreateInfoNV.BYTES) > 0;
            }

...
public record VkGeneratedCommandsInfoEXT(@NotNull MemorySegment segment) implements IVkGeneratedCommandsInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkGeneratedCommandsInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkGeneratedCommandsInfoEXT.BYTES, VkGeneratedCommandsInfoEXT.BYTES));
        }

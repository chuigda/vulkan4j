...
public record VkFenceGetSciSyncInfoNV(@NotNull MemorySegment segment) implements IVkFenceGetSciSyncInfoNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkFenceGetSciSyncInfoNV, Iterable<VkFenceGetSciSyncInfoNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkFenceGetSciSyncInfoNV.BYTES, VkFenceGetSciSyncInfoNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkFenceGetSciSyncInfoNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkFenceGetSciSyncInfoNV.BYTES) > 0;
            }

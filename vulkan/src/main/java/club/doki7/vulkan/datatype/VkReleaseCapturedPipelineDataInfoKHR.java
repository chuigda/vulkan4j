...
public record VkReleaseCapturedPipelineDataInfoKHR(@NotNull MemorySegment segment) implements IVkReleaseCapturedPipelineDataInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkReleaseCapturedPipelineDataInfoKHR, Iterable<VkReleaseCapturedPipelineDataInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkReleaseCapturedPipelineDataInfoKHR.BYTES, VkReleaseCapturedPipelineDataInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkReleaseCapturedPipelineDataInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkReleaseCapturedPipelineDataInfoKHR.BYTES) > 0;
            }

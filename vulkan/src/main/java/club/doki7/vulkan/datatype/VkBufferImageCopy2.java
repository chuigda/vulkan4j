...
public record VkBufferImageCopy2(@NotNull MemorySegment segment) implements IVkBufferImageCopy2 {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkBufferImageCopy2, Iterable<VkBufferImageCopy2> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBufferImageCopy2.BYTES, VkBufferImageCopy2.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkBufferImageCopy2> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkBufferImageCopy2.BYTES) > 0;
            }

...
public record VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM, Iterable<VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM.BYTES, VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM.BYTES) > 0;
            }
    ...
    public void multiviewPerViewViewports(@NativeType("VkBool32") @Unsigned int value) {

...
public record VkOpticalFlowSessionCreatePrivateDataInfoNV(@NotNull MemorySegment segment) implements IVkOpticalFlowSessionCreatePrivateDataInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkOpticalFlowSessionCreatePrivateDataInfoNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkOpticalFlowSessionCreatePrivateDataInfoNV.BYTES, VkOpticalFlowSessionCreatePrivateDataInfoNV.BYTES));
        }

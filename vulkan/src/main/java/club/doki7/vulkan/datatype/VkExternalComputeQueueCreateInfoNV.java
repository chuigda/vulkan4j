...
public record VkExternalComputeQueueCreateInfoNV(@NotNull MemorySegment segment) implements IVkExternalComputeQueueCreateInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkExternalComputeQueueCreateInfoNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkExternalComputeQueueCreateInfoNV.BYTES, VkExternalComputeQueueCreateInfoNV.BYTES));
        }

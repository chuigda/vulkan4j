...
public record VkStridedDeviceAddressRegionKHR(@NotNull MemorySegment segment) implements IVkStridedDeviceAddressRegionKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkStridedDeviceAddressRegionKHR, Iterable<VkStridedDeviceAddressRegionKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkStridedDeviceAddressRegionKHR.BYTES, VkStridedDeviceAddressRegionKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkStridedDeviceAddressRegionKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkStridedDeviceAddressRegionKHR.BYTES) > 0;
            }

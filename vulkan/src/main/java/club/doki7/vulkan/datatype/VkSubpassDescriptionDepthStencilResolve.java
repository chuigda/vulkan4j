...
public record VkSubpassDescriptionDepthStencilResolve(@NotNull MemorySegment segment) implements IVkSubpassDescriptionDepthStencilResolve {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSubpassDescriptionDepthStencilResolve {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSubpassDescriptionDepthStencilResolve.BYTES, VkSubpassDescriptionDepthStencilResolve.BYTES));
        }

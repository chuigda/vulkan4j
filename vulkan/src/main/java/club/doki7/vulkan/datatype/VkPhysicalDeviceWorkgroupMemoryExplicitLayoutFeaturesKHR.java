...
///
/// The {@code allocate} ({@link VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR#allocate(Arena, int)})

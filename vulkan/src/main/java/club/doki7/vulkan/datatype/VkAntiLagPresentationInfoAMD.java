...
public record VkAntiLagPresentationInfoAMD(@NotNull MemorySegment segment) implements IVkAntiLagPresentationInfoAMD {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAntiLagPresentationInfoAMD {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAntiLagPresentationInfoAMD.BYTES, VkAntiLagPresentationInfoAMD.BYTES));
        }

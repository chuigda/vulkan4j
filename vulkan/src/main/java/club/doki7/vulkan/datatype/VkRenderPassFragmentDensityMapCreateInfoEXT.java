...
public record VkRenderPassFragmentDensityMapCreateInfoEXT(@NotNull MemorySegment segment) implements IVkRenderPassFragmentDensityMapCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderPassFragmentDensityMapCreateInfoEXT, Iterable<VkRenderPassFragmentDensityMapCreateInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES, VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkRenderPassFragmentDensityMapCreateInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkRenderPassFragmentDensityMapCreateInfoEXT.BYTES) > 0;
            }

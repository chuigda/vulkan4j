...
///
/// The {@code allocate} ({@link VkPhysicalDeviceVideoEncodeQualityLevelInfoKHR#allocate(Arena)}, {@link VkPhysicalDeviceVideoEncodeQualityLevelInfoKHR#allocate(Arena, int)})

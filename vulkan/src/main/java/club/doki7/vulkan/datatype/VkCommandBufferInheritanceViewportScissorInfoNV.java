...
///
/// The {@code allocate} ({@link VkCommandBufferInheritanceViewportScissorInfoNV#allocate(Arena)}, {@link VkCommandBufferInheritanceViewportScissorInfoNV#allocate(Arena, int)})

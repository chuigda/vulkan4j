...
public record VkCommandBufferInheritanceViewportScissorInfoNV(@NotNull MemorySegment segment) implements IVkCommandBufferInheritanceViewportScissorInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCommandBufferInheritanceViewportScissorInfoNV {
        public long size() {
    ...
    public @Unsigned @NativeType("VkBool32") int viewportScissor2D() {
        return segment.get(LAYOUT$viewportScissor2D, OFFSET$viewportScissor2D);
    }

    public void viewportScissor2D(@Unsigned @NativeType("VkBool32") int value) {

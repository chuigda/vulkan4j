...
///
/// The {@code allocate} ({@link VkCommandBufferInheritanceViewportScissorInfoNV#allocate(Arena)}, {@link VkCommandBufferInheritanceViewportScissorInfoNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkCommandBufferInheritanceViewportScissorInfoNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkCommandBufferInheritanceViewportScissorInfoNV(@NotNull MemorySegment segment) implements IVkCommandBufferInheritanceViewportScissorInfoNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkCommandBufferInheritanceViewportScissorInfoNV.html"><code>VkCommandBufferInheritanceViewportScissorInfoNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkCommandBufferInheritanceViewportScissorInfoNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkCommandBufferInheritanceViewportScissorInfoNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkCommandBufferInheritanceViewportScissorInfoNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCommandBufferInheritanceViewportScissorInfoNV, Iterable<VkCommandBufferInheritanceViewportScissorInfoNV> {
        public long size() {
            return segment.byteSize() / VkCommandBufferInheritanceViewportScissorInfoNV.BYTES;
        }
        ...
        public @NotNull VkCommandBufferInheritanceViewportScissorInfoNV at(long index) {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCommandBufferInheritanceViewportScissorInfoNV.BYTES, VkCommandBufferInheritanceViewportScissorInfoNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkCommandBufferInheritanceViewportScissorInfoNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkCommandBufferInheritanceViewportScissorInfoNV.BYTES,
                (end - start) * VkCommandBufferInheritanceViewportScissorInfoNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkCommandBufferInheritanceViewportScissorInfoNV.BYTES));
        }

        public VkCommandBufferInheritanceViewportScissorInfoNV[] toArray() {
            VkCommandBufferInheritanceViewportScissorInfoNV[] ret = new VkCommandBufferInheritanceViewportScissorInfoNV[(int) size()];
        ...
        public static final class Iter implements Iterator<VkCommandBufferInheritanceViewportScissorInfoNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkCommandBufferInheritanceViewportScissorInfoNV.BYTES) > 0;
            }

            @Override
            public VkCommandBufferInheritanceViewportScissorInfoNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkCommandBufferInheritanceViewportScissorInfoNV ret = new VkCommandBufferInheritanceViewportScissorInfoNV(segment.asSlice(0, VkCommandBufferInheritanceViewportScissorInfoNV.BYTES));
                segment = segment.asSlice(VkCommandBufferInheritanceViewportScissorInfoNV.BYTES);
                return ret;
            }
    ...
    public static VkCommandBufferInheritanceViewportScissorInfoNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkCommandBufferInheritanceViewportScissorInfoNV.Ptr ret = new VkCommandBufferInheritanceViewportScissorInfoNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.COMMAND_BUFFER_INHERITANCE_VIEWPORT_SCISSOR_INFO_NV);
        }
        return ret;
    }

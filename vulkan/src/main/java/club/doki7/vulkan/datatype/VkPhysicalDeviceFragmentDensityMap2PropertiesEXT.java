...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFragmentDensityMap2PropertiesEXT#allocate(Arena)}, {@link VkPhysicalDeviceFragmentDensityMap2PropertiesEXT#allocate(Arena, int)})

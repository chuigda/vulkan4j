...
public record VkPhysicalDeviceFragmentDensityMap2PropertiesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentDensityMap2PropertiesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentDensityMap2PropertiesEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceFragmentDensityMap2PropertiesEXT.BYTES, VkPhysicalDeviceFragmentDensityMap2PropertiesEXT.BYTES));
        }

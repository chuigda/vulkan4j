...
public record VkPipelineColorBlendAttachmentState(@NotNull MemorySegment segment) implements IVkPipelineColorBlendAttachmentState {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineColorBlendAttachmentState {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineColorBlendAttachmentState.BYTES, VkPipelineColorBlendAttachmentState.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int blendEnable() {
        return segment.get(LAYOUT$blendEnable, OFFSET$blendEnable);
    }

    public void blendEnable(@Unsigned @NativeType("VkBool32") int value) {

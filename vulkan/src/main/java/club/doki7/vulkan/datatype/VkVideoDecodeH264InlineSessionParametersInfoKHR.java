...
public record VkVideoDecodeH264InlineSessionParametersInfoKHR(@NotNull MemorySegment segment) implements IVkVideoDecodeH264InlineSessionParametersInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoDecodeH264InlineSessionParametersInfoKHR, Iterable<VkVideoDecodeH264InlineSessionParametersInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoDecodeH264InlineSessionParametersInfoKHR.BYTES, VkVideoDecodeH264InlineSessionParametersInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoDecodeH264InlineSessionParametersInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoDecodeH264InlineSessionParametersInfoKHR.BYTES) > 0;
            }
    ...
    public void pStdSPS(@Nullable IStdVideoH264SequenceParameterSet value) {
    ...
    public void pStdPPS(@Nullable IStdVideoH264PictureParameterSet value) {
        MemorySegment s = value == null ? MemorySegment.NULL : value.segment();
        pStdPPSRaw(s);
    }

...
public record VkDescriptorBufferBindingInfoEXT(@NotNull MemorySegment segment) implements IVkDescriptorBufferBindingInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDescriptorBufferBindingInfoEXT, Iterable<VkDescriptorBufferBindingInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDescriptorBufferBindingInfoEXT.BYTES, VkDescriptorBufferBindingInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDescriptorBufferBindingInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDescriptorBufferBindingInfoEXT.BYTES) > 0;
            }

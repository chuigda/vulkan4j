...
///
/// The {@code allocate} ({@link VkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG#allocate(Arena)}, {@link VkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG#allocate(Arena, int)})

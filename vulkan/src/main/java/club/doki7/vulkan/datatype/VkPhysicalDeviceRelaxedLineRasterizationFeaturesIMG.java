...
public record VkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG.BYTES, VkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int relaxedLineRasterization() {
        return segment.get(LAYOUT$relaxedLineRasterization, OFFSET$relaxedLineRasterization);
    }

    public void relaxedLineRasterization(@Unsigned @NativeType("VkBool32") int value) {

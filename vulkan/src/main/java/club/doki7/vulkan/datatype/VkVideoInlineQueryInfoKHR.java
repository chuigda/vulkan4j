...
public record VkVideoInlineQueryInfoKHR(@NotNull MemorySegment segment) implements IVkVideoInlineQueryInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoInlineQueryInfoKHR, Iterable<VkVideoInlineQueryInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoInlineQueryInfoKHR.BYTES, VkVideoInlineQueryInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoInlineQueryInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoInlineQueryInfoKHR.BYTES) > 0;
            }

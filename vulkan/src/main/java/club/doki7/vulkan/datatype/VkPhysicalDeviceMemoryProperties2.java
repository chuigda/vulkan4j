...
public record VkPhysicalDeviceMemoryProperties2(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMemoryProperties2 {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMemoryProperties2, Iterable<VkPhysicalDeviceMemoryProperties2> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceMemoryProperties2.BYTES, VkPhysicalDeviceMemoryProperties2.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceMemoryProperties2> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceMemoryProperties2.BYTES) > 0;
            }

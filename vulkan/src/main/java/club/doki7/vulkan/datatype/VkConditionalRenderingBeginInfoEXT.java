...
public record VkConditionalRenderingBeginInfoEXT(@NotNull MemorySegment segment) implements IVkConditionalRenderingBeginInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkConditionalRenderingBeginInfoEXT, Iterable<VkConditionalRenderingBeginInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkConditionalRenderingBeginInfoEXT.BYTES, VkConditionalRenderingBeginInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkConditionalRenderingBeginInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkConditionalRenderingBeginInfoEXT.BYTES) > 0;
            }

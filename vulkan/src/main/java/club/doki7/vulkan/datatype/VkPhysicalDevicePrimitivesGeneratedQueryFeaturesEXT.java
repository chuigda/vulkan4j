...
///
/// The {@code allocate} ({@link VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT#allocate(Arena, int)})

...
public record VkPhysicalDeviceTimelineSemaphoreFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceTimelineSemaphoreFeatures {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceTimelineSemaphoreFeatures {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceTimelineSemaphoreFeatures.BYTES, VkPhysicalDeviceTimelineSemaphoreFeatures.BYTES));
        }

...
///
/// The {@code allocate} ({@link VkVideoDecodeUsageInfoKHR#allocate(Arena)}, {@link VkVideoDecodeUsageInfoKHR#allocate(Arena, int)})
...
public record VkVideoDecodeUsageInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoDecodeUsageInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.VIDEO_DECODE_USAGE_INFO_KHR);
        }
        return ret;
    }

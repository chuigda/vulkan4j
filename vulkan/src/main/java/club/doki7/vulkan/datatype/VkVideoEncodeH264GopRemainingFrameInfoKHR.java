...
public record VkVideoEncodeH264GopRemainingFrameInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH264GopRemainingFrameInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH264GopRemainingFrameInfoKHR, Iterable<VkVideoEncodeH264GopRemainingFrameInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeH264GopRemainingFrameInfoKHR.BYTES, VkVideoEncodeH264GopRemainingFrameInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeH264GopRemainingFrameInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeH264GopRemainingFrameInfoKHR.BYTES) > 0;
            }

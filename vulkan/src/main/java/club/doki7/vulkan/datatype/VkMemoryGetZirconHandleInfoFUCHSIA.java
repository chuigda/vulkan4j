...
public record VkMemoryGetZirconHandleInfoFUCHSIA(@NotNull MemorySegment segment) implements IVkMemoryGetZirconHandleInfoFUCHSIA {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryGetZirconHandleInfoFUCHSIA, Iterable<VkMemoryGetZirconHandleInfoFUCHSIA> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMemoryGetZirconHandleInfoFUCHSIA.BYTES, VkMemoryGetZirconHandleInfoFUCHSIA.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkMemoryGetZirconHandleInfoFUCHSIA> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkMemoryGetZirconHandleInfoFUCHSIA.BYTES) > 0;
            }

...
public record VkPipelinePropertiesIdentifierEXT(@NotNull MemorySegment segment) implements IVkPipelinePropertiesIdentifierEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelinePropertiesIdentifierEXT, Iterable<VkPipelinePropertiesIdentifierEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelinePropertiesIdentifierEXT.BYTES, VkPipelinePropertiesIdentifierEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelinePropertiesIdentifierEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelinePropertiesIdentifierEXT.BYTES) > 0;
            }

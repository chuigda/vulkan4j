...
public record VkImageFormatProperties2(@NotNull MemorySegment segment) implements IVkImageFormatProperties2 {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageFormatProperties2, Iterable<VkImageFormatProperties2> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImageFormatProperties2.BYTES, VkImageFormatProperties2.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImageFormatProperties2> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImageFormatProperties2.BYTES) > 0;
            }

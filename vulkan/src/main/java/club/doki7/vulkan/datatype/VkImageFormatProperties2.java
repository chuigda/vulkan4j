...
///
/// The {@link VkImageFormatProperties2#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkImageFormatProperties2#autoInit} to initialize these fields manually for
...
public record VkImageFormatProperties2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkImageFormatProperties2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.IMAGE_FORMAT_PROPERTIES_2);
        }
        return ret;
    }

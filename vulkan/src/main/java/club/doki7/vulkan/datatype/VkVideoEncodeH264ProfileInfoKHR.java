...
///
/// The {@code allocate} ({@link VkVideoEncodeH264ProfileInfoKHR#allocate(Arena)}, {@link VkVideoEncodeH264ProfileInfoKHR#allocate(Arena, int)})
...
public record VkVideoEncodeH264ProfileInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeH264ProfileInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.VIDEO_ENCODE_H264_PROFILE_INFO_KHR);
        }
        return ret;
    }

...
public record StdVideoEncodeH265WeightTableFlags(@NotNull MemorySegment segment) implements IStdVideoEncodeH265WeightTableFlags {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeH265WeightTableFlags, Iterable<StdVideoEncodeH265WeightTableFlags> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoEncodeH265WeightTableFlags.BYTES, StdVideoEncodeH265WeightTableFlags.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoEncodeH265WeightTableFlags> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoEncodeH265WeightTableFlags.BYTES) > 0;
            }

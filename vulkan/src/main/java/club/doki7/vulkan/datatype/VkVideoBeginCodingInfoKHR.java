...
public record VkVideoBeginCodingInfoKHR(@NotNull MemorySegment segment) implements IVkVideoBeginCodingInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoBeginCodingInfoKHR, Iterable<VkVideoBeginCodingInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoBeginCodingInfoKHR.BYTES, VkVideoBeginCodingInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoBeginCodingInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoBeginCodingInfoKHR.BYTES) > 0;
            }

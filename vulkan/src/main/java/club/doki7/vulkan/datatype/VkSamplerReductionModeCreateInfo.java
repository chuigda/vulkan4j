...
public record VkSamplerReductionModeCreateInfo(@NotNull MemorySegment segment) implements IVkSamplerReductionModeCreateInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSamplerReductionModeCreateInfo, Iterable<VkSamplerReductionModeCreateInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSamplerReductionModeCreateInfo.BYTES, VkSamplerReductionModeCreateInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSamplerReductionModeCreateInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSamplerReductionModeCreateInfo.BYTES) > 0;
            }

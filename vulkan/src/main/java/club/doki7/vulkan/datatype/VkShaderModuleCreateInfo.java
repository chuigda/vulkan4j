...
public record VkShaderModuleCreateInfo(@NotNull MemorySegment segment) implements IVkShaderModuleCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkShaderModuleCreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkShaderModuleCreateInfo.BYTES, VkShaderModuleCreateInfo.BYTES));
        }

...
public record VkPipelineRasterizationStateStreamCreateInfoEXT(@NotNull MemorySegment segment) implements IVkPipelineRasterizationStateStreamCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineRasterizationStateStreamCreateInfoEXT, Iterable<VkPipelineRasterizationStateStreamCreateInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES, VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineRasterizationStateStreamCreateInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineRasterizationStateStreamCreateInfoEXT.BYTES) > 0;
            }

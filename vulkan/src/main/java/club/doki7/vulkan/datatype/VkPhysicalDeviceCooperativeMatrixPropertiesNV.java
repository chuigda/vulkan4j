...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCooperativeMatrixPropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceCooperativeMatrixPropertiesNV#allocate(Arena, int)})

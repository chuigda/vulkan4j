...
public record VkPhysicalDeviceFragmentDensityMap2FeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentDensityMap2FeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentDensityMap2FeaturesEXT, Iterable<VkPhysicalDeviceFragmentDensityMap2FeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceFragmentDensityMap2FeaturesEXT.BYTES, VkPhysicalDeviceFragmentDensityMap2FeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceFragmentDensityMap2FeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceFragmentDensityMap2FeaturesEXT.BYTES) > 0;
            }

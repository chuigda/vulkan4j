...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFragmentDensityMap2FeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceFragmentDensityMap2FeaturesEXT#allocate(Arena, int)})

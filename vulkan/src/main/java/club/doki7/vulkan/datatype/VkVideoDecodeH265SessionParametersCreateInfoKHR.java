...
public record VkVideoDecodeH265SessionParametersCreateInfoKHR(@NotNull MemorySegment segment) implements IVkVideoDecodeH265SessionParametersCreateInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoDecodeH265SessionParametersCreateInfoKHR, Iterable<VkVideoDecodeH265SessionParametersCreateInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoDecodeH265SessionParametersCreateInfoKHR.BYTES, VkVideoDecodeH265SessionParametersCreateInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoDecodeH265SessionParametersCreateInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoDecodeH265SessionParametersCreateInfoKHR.BYTES) > 0;
            }

...
public record VkExportMetalSharedEventInfoEXT(@NotNull MemorySegment segment) implements IVkExportMetalSharedEventInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkExportMetalSharedEventInfoEXT, Iterable<VkExportMetalSharedEventInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkExportMetalSharedEventInfoEXT.BYTES, VkExportMetalSharedEventInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkExportMetalSharedEventInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkExportMetalSharedEventInfoEXT.BYTES) > 0;
            }

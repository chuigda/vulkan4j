...
public record VkPhysicalDeviceClusterAccelerationStructurePropertiesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceClusterAccelerationStructurePropertiesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceClusterAccelerationStructurePropertiesNV, Iterable<VkPhysicalDeviceClusterAccelerationStructurePropertiesNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceClusterAccelerationStructurePropertiesNV.BYTES, VkPhysicalDeviceClusterAccelerationStructurePropertiesNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceClusterAccelerationStructurePropertiesNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceClusterAccelerationStructurePropertiesNV.BYTES) > 0;
            }

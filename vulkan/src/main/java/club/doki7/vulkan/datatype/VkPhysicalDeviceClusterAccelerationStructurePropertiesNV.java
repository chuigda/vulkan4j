...
///
/// The {@code allocate} ({@link VkPhysicalDeviceClusterAccelerationStructurePropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceClusterAccelerationStructurePropertiesNV#allocate(Arena, int)})

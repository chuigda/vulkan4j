...
///
/// The {@link VkPhysicalDeviceDepthClipEnableFeaturesEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceDepthClipEnableFeaturesEXT#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceDepthClipEnableFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceDepthClipEnableFeaturesEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_DEPTH_CLIP_ENABLE_FEATURES_EXT);
        }
        return ret;
    }

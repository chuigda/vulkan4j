...
public record VkRayTracingPipelineInterfaceCreateInfoKHR(@NotNull MemorySegment segment) implements IVkRayTracingPipelineInterfaceCreateInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkRayTracingPipelineInterfaceCreateInfoKHR, Iterable<VkRayTracingPipelineInterfaceCreateInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRayTracingPipelineInterfaceCreateInfoKHR.BYTES, VkRayTracingPipelineInterfaceCreateInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkRayTracingPipelineInterfaceCreateInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkRayTracingPipelineInterfaceCreateInfoKHR.BYTES) > 0;
            }

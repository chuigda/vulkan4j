...
public record VkPhysicalDeviceFragmentShadingRateKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentShadingRateKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentShadingRateKHR, Iterable<VkPhysicalDeviceFragmentShadingRateKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceFragmentShadingRateKHR.BYTES, VkPhysicalDeviceFragmentShadingRateKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceFragmentShadingRateKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceFragmentShadingRateKHR.BYTES) > 0;
            }

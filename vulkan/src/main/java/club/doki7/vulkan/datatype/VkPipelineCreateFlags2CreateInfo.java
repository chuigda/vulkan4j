...
public record VkPipelineCreateFlags2CreateInfo(@NotNull MemorySegment segment) implements IVkPipelineCreateFlags2CreateInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineCreateFlags2CreateInfo, Iterable<VkPipelineCreateFlags2CreateInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineCreateFlags2CreateInfo.BYTES, VkPipelineCreateFlags2CreateInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineCreateFlags2CreateInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineCreateFlags2CreateInfo.BYTES) > 0;
            }

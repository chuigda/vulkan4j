...
public record VkBufferMemoryBarrier2(@NotNull MemorySegment segment) implements IVkBufferMemoryBarrier2 {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBufferMemoryBarrier2 {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBufferMemoryBarrier2.BYTES, VkBufferMemoryBarrier2.BYTES));
        }

...
public record VkPhysicalDeviceDepthBiasControlFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceDepthBiasControlFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceDepthBiasControlFeaturesEXT, Iterable<VkPhysicalDeviceDepthBiasControlFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceDepthBiasControlFeaturesEXT.BYTES, VkPhysicalDeviceDepthBiasControlFeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceDepthBiasControlFeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceDepthBiasControlFeaturesEXT.BYTES) > 0;
            }

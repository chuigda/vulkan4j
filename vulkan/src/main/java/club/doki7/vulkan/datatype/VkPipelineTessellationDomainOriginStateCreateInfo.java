...
///
/// The {@code allocate} ({@link VkPipelineTessellationDomainOriginStateCreateInfo#allocate(Arena)}, {@link VkPipelineTessellationDomainOriginStateCreateInfo#allocate(Arena, int)})

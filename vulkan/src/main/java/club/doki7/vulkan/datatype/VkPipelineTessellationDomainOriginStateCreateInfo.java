...
public record VkPipelineTessellationDomainOriginStateCreateInfo(@NotNull MemorySegment segment) implements IVkPipelineTessellationDomainOriginStateCreateInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineTessellationDomainOriginStateCreateInfo, Iterable<VkPipelineTessellationDomainOriginStateCreateInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineTessellationDomainOriginStateCreateInfo.BYTES, VkPipelineTessellationDomainOriginStateCreateInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineTessellationDomainOriginStateCreateInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineTessellationDomainOriginStateCreateInfo.BYTES) > 0;
            }

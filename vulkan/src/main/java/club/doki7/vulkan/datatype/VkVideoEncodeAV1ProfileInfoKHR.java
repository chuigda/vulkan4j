...
public record VkVideoEncodeAV1ProfileInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1ProfileInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1ProfileInfoKHR, Iterable<VkVideoEncodeAV1ProfileInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeAV1ProfileInfoKHR.BYTES, VkVideoEncodeAV1ProfileInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeAV1ProfileInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeAV1ProfileInfoKHR.BYTES) > 0;
            }

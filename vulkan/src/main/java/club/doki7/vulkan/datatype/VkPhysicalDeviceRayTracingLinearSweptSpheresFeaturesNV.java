...
///
/// The {@code allocate} ({@link VkPhysicalDeviceRayTracingLinearSweptSpheresFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceRayTracingLinearSweptSpheresFeaturesNV#allocate(Arena, int)})

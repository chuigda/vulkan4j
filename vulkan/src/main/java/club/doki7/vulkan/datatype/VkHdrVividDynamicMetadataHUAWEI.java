...
public record VkHdrVividDynamicMetadataHUAWEI(@NotNull MemorySegment segment) implements IVkHdrVividDynamicMetadataHUAWEI {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkHdrVividDynamicMetadataHUAWEI, Iterable<VkHdrVividDynamicMetadataHUAWEI> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkHdrVividDynamicMetadataHUAWEI.BYTES, VkHdrVividDynamicMetadataHUAWEI.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkHdrVividDynamicMetadataHUAWEI> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkHdrVividDynamicMetadataHUAWEI.BYTES) > 0;
            }

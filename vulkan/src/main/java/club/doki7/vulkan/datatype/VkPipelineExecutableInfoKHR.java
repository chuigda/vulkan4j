...
public record VkPipelineExecutableInfoKHR(@NotNull MemorySegment segment) implements IVkPipelineExecutableInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineExecutableInfoKHR, Iterable<VkPipelineExecutableInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineExecutableInfoKHR.BYTES, VkPipelineExecutableInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineExecutableInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineExecutableInfoKHR.BYTES) > 0;
            }

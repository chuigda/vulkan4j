...
public record VkPipelineBinaryInfoKHR(@NotNull MemorySegment segment) implements IVkPipelineBinaryInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineBinaryInfoKHR, Iterable<VkPipelineBinaryInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineBinaryInfoKHR.BYTES, VkPipelineBinaryInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineBinaryInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineBinaryInfoKHR.BYTES) > 0;
            }

...
public record VkAccelerationStructureCreateInfoKHR(@NotNull MemorySegment segment) implements IVkAccelerationStructureCreateInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureCreateInfoKHR, Iterable<VkAccelerationStructureCreateInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAccelerationStructureCreateInfoKHR.BYTES, VkAccelerationStructureCreateInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkAccelerationStructureCreateInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkAccelerationStructureCreateInfoKHR.BYTES) > 0;
            }

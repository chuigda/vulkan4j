...
public record VkImportFenceSciSyncInfoNV(@NotNull MemorySegment segment) implements IVkImportFenceSciSyncInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportFenceSciSyncInfoNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImportFenceSciSyncInfoNV.BYTES, VkImportFenceSciSyncInfoNV.BYTES));
        }

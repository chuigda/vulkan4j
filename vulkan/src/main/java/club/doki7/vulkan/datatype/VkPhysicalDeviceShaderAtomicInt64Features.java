...
public record VkPhysicalDeviceShaderAtomicInt64Features(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderAtomicInt64Features {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderAtomicInt64Features, Iterable<VkPhysicalDeviceShaderAtomicInt64Features> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderAtomicInt64Features.BYTES, VkPhysicalDeviceShaderAtomicInt64Features.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceShaderAtomicInt64Features> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceShaderAtomicInt64Features.BYTES) > 0;
            }

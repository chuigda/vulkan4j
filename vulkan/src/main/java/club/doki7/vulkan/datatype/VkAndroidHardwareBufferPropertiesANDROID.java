...
public record VkAndroidHardwareBufferPropertiesANDROID(@NotNull MemorySegment segment) implements IVkAndroidHardwareBufferPropertiesANDROID {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAndroidHardwareBufferPropertiesANDROID {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAndroidHardwareBufferPropertiesANDROID.BYTES, VkAndroidHardwareBufferPropertiesANDROID.BYTES));
        }

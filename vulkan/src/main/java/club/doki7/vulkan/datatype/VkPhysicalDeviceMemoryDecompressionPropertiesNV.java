...
///
/// The {@code allocate} ({@link VkPhysicalDeviceMemoryDecompressionPropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceMemoryDecompressionPropertiesNV#allocate(Arena, int)})

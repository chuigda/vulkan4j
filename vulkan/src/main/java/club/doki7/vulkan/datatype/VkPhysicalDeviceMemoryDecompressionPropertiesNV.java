...
public record VkPhysicalDeviceMemoryDecompressionPropertiesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMemoryDecompressionPropertiesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMemoryDecompressionPropertiesNV, Iterable<VkPhysicalDeviceMemoryDecompressionPropertiesNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceMemoryDecompressionPropertiesNV.BYTES, VkPhysicalDeviceMemoryDecompressionPropertiesNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceMemoryDecompressionPropertiesNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceMemoryDecompressionPropertiesNV.BYTES) > 0;
            }

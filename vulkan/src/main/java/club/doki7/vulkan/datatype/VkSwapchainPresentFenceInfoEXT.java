...
public record VkSwapchainPresentFenceInfoEXT(@NotNull MemorySegment segment) implements IVkSwapchainPresentFenceInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSwapchainPresentFenceInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSwapchainPresentFenceInfoEXT.BYTES, VkSwapchainPresentFenceInfoEXT.BYTES));
        }

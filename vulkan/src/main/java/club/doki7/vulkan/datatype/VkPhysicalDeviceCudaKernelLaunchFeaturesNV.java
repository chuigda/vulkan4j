...
public record VkPhysicalDeviceCudaKernelLaunchFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCudaKernelLaunchFeaturesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCudaKernelLaunchFeaturesNV {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceCudaKernelLaunchFeaturesNV.BYTES, VkPhysicalDeviceCudaKernelLaunchFeaturesNV.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int cudaKernelLaunchFeatures() {
        return segment.get(LAYOUT$cudaKernelLaunchFeatures, OFFSET$cudaKernelLaunchFeatures);
    }

    public void cudaKernelLaunchFeatures(@Unsigned @NativeType("VkBool32") int value) {

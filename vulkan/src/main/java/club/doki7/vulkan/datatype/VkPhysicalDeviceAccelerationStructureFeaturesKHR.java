...
///
/// The {@code allocate} ({@link VkPhysicalDeviceAccelerationStructureFeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceAccelerationStructureFeaturesKHR#allocate(Arena, int)})

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT#allocate(Arena)}, {@link VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT#allocate(Arena, int)})

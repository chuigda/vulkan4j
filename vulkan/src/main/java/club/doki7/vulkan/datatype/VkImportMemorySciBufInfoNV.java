...
public record VkImportMemorySciBufInfoNV(@NotNull MemorySegment segment) implements IVkImportMemorySciBufInfoNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportMemorySciBufInfoNV, Iterable<VkImportMemorySciBufInfoNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImportMemorySciBufInfoNV.BYTES, VkImportMemorySciBufInfoNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImportMemorySciBufInfoNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImportMemorySciBufInfoNV.BYTES) > 0;
            }

...
///     void* pNext; // optional
///     VkImageUsageFlags sharedPresentSupportedUsageFlags; // optional
...
///
/// The {@link VkSharedPresentSurfaceCapabilitiesKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkSharedPresentSurfaceCapabilitiesKHR#autoInit} to initialize these fields manually for
...
public record VkSharedPresentSurfaceCapabilitiesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkSharedPresentSurfaceCapabilitiesKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkSharedPresentSurfaceCapabilitiesKHR(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.SHARED_PRESENT_SURFACE_CAPABILITIES_KHR);
        }
        return ret;
    }

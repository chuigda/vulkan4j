...
///
/// The {@code allocate} ({@link VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT#allocate(Arena)}, {@link VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT#allocate(Arena, int)})

...
public record VkIndirectCommandsStreamNV(@NotNull MemorySegment segment) implements IVkIndirectCommandsStreamNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkIndirectCommandsStreamNV, Iterable<VkIndirectCommandsStreamNV> {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkIndirectCommandsStreamNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkIndirectCommandsStreamNV> {
            ...
            @Override
            public VkIndirectCommandsStreamNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkIndirectCommandsStreamNV ret = new VkIndirectCommandsStreamNV(segment.asSlice(0, VkIndirectCommandsStreamNV.BYTES));
                segment = segment.asSlice(VkIndirectCommandsStreamNV.BYTES);
                return ret;
            }
    ...
    public VkIndirectCommandsStreamNV buffer(@Nullable VkBuffer value) {
    ...
    public VkIndirectCommandsStreamNV offset(@NativeType("VkDeviceSize") @Unsigned long value) {

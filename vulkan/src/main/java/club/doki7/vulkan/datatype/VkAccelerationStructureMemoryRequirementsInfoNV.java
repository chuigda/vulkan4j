...
///
/// The {@code allocate} ({@link VkAccelerationStructureMemoryRequirementsInfoNV#allocate(Arena)}, {@link VkAccelerationStructureMemoryRequirementsInfoNV#allocate(Arena, int)})

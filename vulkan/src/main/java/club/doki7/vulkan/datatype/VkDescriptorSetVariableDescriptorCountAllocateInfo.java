...
///
/// The {@code allocate} ({@link VkDescriptorSetVariableDescriptorCountAllocateInfo#allocate(Arena)}, {@link VkDescriptorSetVariableDescriptorCountAllocateInfo#allocate(Arena, int)})

...
public record VkAcquireNextImageInfoKHR(@NotNull MemorySegment segment) implements IVkAcquireNextImageInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkAcquireNextImageInfoKHR, Iterable<VkAcquireNextImageInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAcquireNextImageInfoKHR.BYTES, VkAcquireNextImageInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkAcquireNextImageInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkAcquireNextImageInfoKHR.BYTES) > 0;
            }

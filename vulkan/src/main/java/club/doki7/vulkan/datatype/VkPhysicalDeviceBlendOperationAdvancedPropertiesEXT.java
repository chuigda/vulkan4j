...
///
/// The {@code allocate} ({@link VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT#allocate(Arena)}, {@link VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT#allocate(Arena, int)})

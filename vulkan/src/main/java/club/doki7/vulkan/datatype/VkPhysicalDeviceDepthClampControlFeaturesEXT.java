...
///
/// The {@code allocate} ({@link VkPhysicalDeviceDepthClampControlFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceDepthClampControlFeaturesEXT#allocate(Arena, int)})

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceTransformFeedbackFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceTransformFeedbackFeaturesEXT#allocate(Arena, int)})

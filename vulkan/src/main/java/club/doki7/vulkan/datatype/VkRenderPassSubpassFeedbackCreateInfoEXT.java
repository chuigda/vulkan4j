...
public record VkRenderPassSubpassFeedbackCreateInfoEXT(@NotNull MemorySegment segment) implements IVkRenderPassSubpassFeedbackCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderPassSubpassFeedbackCreateInfoEXT, Iterable<VkRenderPassSubpassFeedbackCreateInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderPassSubpassFeedbackCreateInfoEXT.BYTES, VkRenderPassSubpassFeedbackCreateInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkRenderPassSubpassFeedbackCreateInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkRenderPassSubpassFeedbackCreateInfoEXT.BYTES) > 0;
            }

...
public record VkDeviceQueueGlobalPriorityCreateInfo(@NotNull MemorySegment segment) implements IVkDeviceQueueGlobalPriorityCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDeviceQueueGlobalPriorityCreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDeviceQueueGlobalPriorityCreateInfo.BYTES, VkDeviceQueueGlobalPriorityCreateInfo.BYTES));
        }

...
///
/// The {@code allocate} ({@link VkVideoEncodeH265DpbSlotInfoKHR#allocate(Arena)}, {@link VkVideoEncodeH265DpbSlotInfoKHR#allocate(Arena, int)})
...
public record VkVideoEncodeH265DpbSlotInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeH265DpbSlotInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.VIDEO_ENCODE_H265_DPB_SLOT_INFO_KHR);
        }
        return ret;
    }

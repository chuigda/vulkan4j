...
public record VkDebugMarkerObjectTagInfoEXT(@NotNull MemorySegment segment) implements IVkDebugMarkerObjectTagInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDebugMarkerObjectTagInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDebugMarkerObjectTagInfoEXT.BYTES, VkDebugMarkerObjectTagInfoEXT.BYTES));
        }

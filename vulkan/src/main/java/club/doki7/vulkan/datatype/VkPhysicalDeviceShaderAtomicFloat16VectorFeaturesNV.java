...
public record VkPhysicalDeviceShaderAtomicFloat16VectorFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderAtomicFloat16VectorFeaturesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderAtomicFloat16VectorFeaturesNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderAtomicFloat16VectorFeaturesNV.BYTES, VkPhysicalDeviceShaderAtomicFloat16VectorFeaturesNV.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int shaderFloat16VectorAtomics() {
        return segment.get(LAYOUT$shaderFloat16VectorAtomics, OFFSET$shaderFloat16VectorAtomics);
    }

    public void shaderFloat16VectorAtomics(@Unsigned @NativeType("VkBool32") int value) {

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShaderAtomicFloat16VectorFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceShaderAtomicFloat16VectorFeaturesNV#allocate(Arena, int)})

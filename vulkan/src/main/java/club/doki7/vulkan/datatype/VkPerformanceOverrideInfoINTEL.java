...
public record VkPerformanceOverrideInfoINTEL(@NotNull MemorySegment segment) implements IVkPerformanceOverrideInfoINTEL {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPerformanceOverrideInfoINTEL, Iterable<VkPerformanceOverrideInfoINTEL> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPerformanceOverrideInfoINTEL.BYTES, VkPerformanceOverrideInfoINTEL.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPerformanceOverrideInfoINTEL> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPerformanceOverrideInfoINTEL.BYTES) > 0;
            }

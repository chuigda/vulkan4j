...
///
/// The {@code allocate} ({@link VkPhysicalDeviceSamplerFilterMinmaxProperties#allocate(Arena)}, {@link VkPhysicalDeviceSamplerFilterMinmaxProperties#allocate(Arena, int)})

...
public record VkPhysicalDeviceSamplerFilterMinmaxProperties(@NotNull MemorySegment segment) implements IVkPhysicalDeviceSamplerFilterMinmaxProperties {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceSamplerFilterMinmaxProperties {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceSamplerFilterMinmaxProperties.BYTES, VkPhysicalDeviceSamplerFilterMinmaxProperties.BYTES));
        }

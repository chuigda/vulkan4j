...
///
/// The {@code allocate} ({@link VkPhysicalDeviceImageCompressionControlFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceImageCompressionControlFeaturesEXT#allocate(Arena, int)})

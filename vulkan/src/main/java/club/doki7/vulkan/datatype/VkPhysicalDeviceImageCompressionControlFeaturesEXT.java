...
public record VkPhysicalDeviceImageCompressionControlFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageCompressionControlFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageCompressionControlFeaturesEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceImageCompressionControlFeaturesEXT.BYTES, VkPhysicalDeviceImageCompressionControlFeaturesEXT.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int imageCompressionControl() {
        return segment.get(LAYOUT$imageCompressionControl, OFFSET$imageCompressionControl);
    }

    public void imageCompressionControl(@Unsigned @NativeType("VkBool32") int value) {

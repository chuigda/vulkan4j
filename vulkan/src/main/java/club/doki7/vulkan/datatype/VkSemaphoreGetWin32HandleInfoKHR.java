...
public record VkSemaphoreGetWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IVkSemaphoreGetWin32HandleInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSemaphoreGetWin32HandleInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSemaphoreGetWin32HandleInfoKHR.BYTES, VkSemaphoreGetWin32HandleInfoKHR.BYTES));
        }

...
///
/// The {@link VkSemaphoreGetWin32HandleInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkSemaphoreGetWin32HandleInfoKHR#autoInit} to initialize these fields manually for
...
public record VkSemaphoreGetWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkSemaphoreGetWin32HandleInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.SEMAPHORE_GET_WIN32_HANDLE_INFO_KHR);
        }
        return ret;
    }

...
public record VkQueueFamilyProperties2(@NotNull MemorySegment segment) implements IVkQueueFamilyProperties2 {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkQueueFamilyProperties2 {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkQueueFamilyProperties2.BYTES, VkQueueFamilyProperties2.BYTES));
        }

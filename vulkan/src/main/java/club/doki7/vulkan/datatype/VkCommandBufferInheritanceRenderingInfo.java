...
public record VkCommandBufferInheritanceRenderingInfo(@NotNull MemorySegment segment) implements IVkCommandBufferInheritanceRenderingInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCommandBufferInheritanceRenderingInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCommandBufferInheritanceRenderingInfo.BYTES, VkCommandBufferInheritanceRenderingInfo.BYTES));
        }

...
///
/// The {@code allocate} ({@link VkImportSemaphoreSciSyncInfoNV#allocate(Arena)}, {@link VkImportSemaphoreSciSyncInfoNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkImportSemaphoreSciSyncInfoNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkImportSemaphoreSciSyncInfoNV(@NotNull MemorySegment segment) implements IVkImportSemaphoreSciSyncInfoNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkImportSemaphoreSciSyncInfoNV.html"><code>VkImportSemaphoreSciSyncInfoNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkImportSemaphoreSciSyncInfoNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkImportSemaphoreSciSyncInfoNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkImportSemaphoreSciSyncInfoNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportSemaphoreSciSyncInfoNV, Iterable<VkImportSemaphoreSciSyncInfoNV> {
        public long size() {
            return segment.byteSize() / VkImportSemaphoreSciSyncInfoNV.BYTES;
        }
        ...
        public @NotNull VkImportSemaphoreSciSyncInfoNV at(long index) {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImportSemaphoreSciSyncInfoNV.BYTES, VkImportSemaphoreSciSyncInfoNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkImportSemaphoreSciSyncInfoNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkImportSemaphoreSciSyncInfoNV.BYTES,
                (end - start) * VkImportSemaphoreSciSyncInfoNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkImportSemaphoreSciSyncInfoNV.BYTES));
        }

        public VkImportSemaphoreSciSyncInfoNV[] toArray() {
            VkImportSemaphoreSciSyncInfoNV[] ret = new VkImportSemaphoreSciSyncInfoNV[(int) size()];
        ...
        public static final class Iter implements Iterator<VkImportSemaphoreSciSyncInfoNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImportSemaphoreSciSyncInfoNV.BYTES) > 0;
            }

            @Override
            public VkImportSemaphoreSciSyncInfoNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkImportSemaphoreSciSyncInfoNV ret = new VkImportSemaphoreSciSyncInfoNV(segment.asSlice(0, VkImportSemaphoreSciSyncInfoNV.BYTES));
                segment = segment.asSlice(VkImportSemaphoreSciSyncInfoNV.BYTES);
                return ret;
            }
    ...
    public static VkImportSemaphoreSciSyncInfoNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkImportSemaphoreSciSyncInfoNV.Ptr ret = new VkImportSemaphoreSciSyncInfoNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.IMPORT_SEMAPHORE_SCI_SYNC_INFO_NV);
        }
        return ret;
    }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR#allocate(Arena)}, {@link VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR#allocate(Arena, int)})

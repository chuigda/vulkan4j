...
///
/// The {@code allocate} ({@link VkAccelerationStructureTrianglesDisplacementMicromapNV#allocate(Arena)}, {@link VkAccelerationStructureTrianglesDisplacementMicromapNV#allocate(Arena, int)})

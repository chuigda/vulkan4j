...
public record VkRenderingFragmentDensityMapAttachmentInfoEXT(@NotNull MemorySegment segment) implements IVkRenderingFragmentDensityMapAttachmentInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderingFragmentDensityMapAttachmentInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderingFragmentDensityMapAttachmentInfoEXT.BYTES, VkRenderingFragmentDensityMapAttachmentInfoEXT.BYTES));
        }

...
///
/// The {@code allocate} ({@link VkRenderingFragmentDensityMapAttachmentInfoEXT#allocate(Arena)}, {@link VkRenderingFragmentDensityMapAttachmentInfoEXT#allocate(Arena, int)})

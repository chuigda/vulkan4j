...
public record VkPhysicalDeviceVideoEncodeAV1FeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVideoEncodeAV1FeaturesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVideoEncodeAV1FeaturesKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceVideoEncodeAV1FeaturesKHR.BYTES, VkPhysicalDeviceVideoEncodeAV1FeaturesKHR.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int videoEncodeAV1() {
        return segment.get(LAYOUT$videoEncodeAV1, OFFSET$videoEncodeAV1);
    }

    public void videoEncodeAV1(@Unsigned @NativeType("VkBool32") int value) {

...
public record VkVideoEncodeH265QpKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH265QpKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH265QpKHR, Iterable<VkVideoEncodeH265QpKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeH265QpKHR.BYTES, VkVideoEncodeH265QpKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeH265QpKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeH265QpKHR.BYTES) > 0;
            }

...
public record VkPhysicalDeviceShaderObjectFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderObjectFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderObjectFeaturesEXT, Iterable<VkPhysicalDeviceShaderObjectFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderObjectFeaturesEXT.BYTES, VkPhysicalDeviceShaderObjectFeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceShaderObjectFeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceShaderObjectFeaturesEXT.BYTES) > 0;
            }
    ...
    public void shaderObject(@NativeType("VkBool32") @Unsigned int value) {

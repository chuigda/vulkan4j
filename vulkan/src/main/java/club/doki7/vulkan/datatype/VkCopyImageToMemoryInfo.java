...
public record VkCopyImageToMemoryInfo(@NotNull MemorySegment segment) implements IVkCopyImageToMemoryInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyImageToMemoryInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCopyImageToMemoryInfo.BYTES, VkCopyImageToMemoryInfo.BYTES));
        }

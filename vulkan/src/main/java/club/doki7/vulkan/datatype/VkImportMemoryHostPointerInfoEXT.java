...
public record VkImportMemoryHostPointerInfoEXT(@NotNull MemorySegment segment) implements IVkImportMemoryHostPointerInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportMemoryHostPointerInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImportMemoryHostPointerInfoEXT.BYTES, VkImportMemoryHostPointerInfoEXT.BYTES));
        }

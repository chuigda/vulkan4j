...
///
/// The {@code allocate} ({@link VkPipelineViewportExclusiveScissorStateCreateInfoNV#allocate(Arena)}, {@link VkPipelineViewportExclusiveScissorStateCreateInfoNV#allocate(Arena, int)})

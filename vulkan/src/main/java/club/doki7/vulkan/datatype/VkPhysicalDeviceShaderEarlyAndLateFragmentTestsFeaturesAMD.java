...
public record VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD.BYTES, VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int shaderEarlyAndLateFragmentTests() {
        return segment.get(LAYOUT$shaderEarlyAndLateFragmentTests, OFFSET$shaderEarlyAndLateFragmentTests);
    }

    public void shaderEarlyAndLateFragmentTests(@Unsigned @NativeType("VkBool32") int value) {

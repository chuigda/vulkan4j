...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD#allocate(Arena)}, {@link VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD#allocate(Arena, int)})

...
///
/// The {@code allocate} ({@link VkRenderingFragmentShadingRateAttachmentInfoKHR#allocate(Arena)}, {@link VkRenderingFragmentShadingRateAttachmentInfoKHR#allocate(Arena, int)})

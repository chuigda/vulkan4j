...
public record VkRenderingFragmentShadingRateAttachmentInfoKHR(@NotNull MemorySegment segment) implements IVkRenderingFragmentShadingRateAttachmentInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderingFragmentShadingRateAttachmentInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderingFragmentShadingRateAttachmentInfoKHR.BYTES, VkRenderingFragmentShadingRateAttachmentInfoKHR.BYTES));
        }

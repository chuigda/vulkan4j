...
///
/// The {@code allocate} ({@link VkPhysicalDeviceSampleLocationsPropertiesEXT#allocate(Arena)}, {@link VkPhysicalDeviceSampleLocationsPropertiesEXT#allocate(Arena, int)})

...
public record VkVideoEncodeInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeInfoKHR, Iterable<VkVideoEncodeInfoKHR> {
        ...
        public static final class Iter implements Iterator<VkVideoEncodeInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeInfoKHR.BYTES) > 0;
            }
    ...
    public void dstBufferOffset(@NativeType("VkDeviceSize") @Unsigned long value) {
    ...
    public void dstBufferRange(@NativeType("VkDeviceSize") @Unsigned long value) {

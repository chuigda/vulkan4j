...
public record VkImageViewASTCDecodeModeEXT(@NotNull MemorySegment segment) implements IVkImageViewASTCDecodeModeEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageViewASTCDecodeModeEXT, Iterable<VkImageViewASTCDecodeModeEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImageViewASTCDecodeModeEXT.BYTES, VkImageViewASTCDecodeModeEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImageViewASTCDecodeModeEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImageViewASTCDecodeModeEXT.BYTES) > 0;
            }

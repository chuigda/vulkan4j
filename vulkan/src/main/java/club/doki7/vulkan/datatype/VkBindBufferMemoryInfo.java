...
public record VkBindBufferMemoryInfo(@NotNull MemorySegment segment) implements IVkBindBufferMemoryInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBindBufferMemoryInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBindBufferMemoryInfo.BYTES, VkBindBufferMemoryInfo.BYTES));
        }

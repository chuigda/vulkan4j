...
public record VkDrmFormatModifierPropertiesListEXT(@NotNull MemorySegment segment) implements IVkDrmFormatModifierPropertiesListEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDrmFormatModifierPropertiesListEXT, Iterable<VkDrmFormatModifierPropertiesListEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDrmFormatModifierPropertiesListEXT.BYTES, VkDrmFormatModifierPropertiesListEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDrmFormatModifierPropertiesListEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDrmFormatModifierPropertiesListEXT.BYTES) > 0;
            }

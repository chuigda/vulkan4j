...
public record VkPhysicalDeviceTexelBufferAlignmentProperties(@NotNull MemorySegment segment) implements IVkPhysicalDeviceTexelBufferAlignmentProperties {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceTexelBufferAlignmentProperties {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceTexelBufferAlignmentProperties.BYTES, VkPhysicalDeviceTexelBufferAlignmentProperties.BYTES));
        }

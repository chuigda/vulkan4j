...
public record VkVideoEncodeH264QpKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH264QpKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH264QpKHR, Iterable<VkVideoEncodeH264QpKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeH264QpKHR.BYTES, VkVideoEncodeH264QpKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeH264QpKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeH264QpKHR.BYTES) > 0;
            }

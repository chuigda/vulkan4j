...
public record VkSemaphoreTypeCreateInfo(@NotNull MemorySegment segment) implements IVkSemaphoreTypeCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSemaphoreTypeCreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSemaphoreTypeCreateInfo.BYTES, VkSemaphoreTypeCreateInfo.BYTES));
        }

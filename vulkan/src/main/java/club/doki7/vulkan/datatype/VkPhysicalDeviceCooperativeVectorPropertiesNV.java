...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCooperativeVectorPropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceCooperativeVectorPropertiesNV#allocate(Arena, int)})

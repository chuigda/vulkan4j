...
///
/// The {@code allocate} ({@link VkSurfacePresentScalingCapabilitiesEXT#allocate(Arena)}, {@link VkSurfacePresentScalingCapabilitiesEXT#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkSurfacePresentScalingCapabilitiesEXT(@NotNull MemorySegment segment) implements IVkSurfacePresentScalingCapabilitiesEXT {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkSurfacePresentScalingCapabilitiesEXT.html"><code>VkSurfacePresentScalingCapabilitiesEXT</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkSurfacePresentScalingCapabilitiesEXT}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkSurfacePresentScalingCapabilitiesEXT to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkSurfacePresentScalingCapabilitiesEXT.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSurfacePresentScalingCapabilitiesEXT, Iterable<VkSurfacePresentScalingCapabilitiesEXT> {
        public long size() {
            return segment.byteSize() / VkSurfacePresentScalingCapabilitiesEXT.BYTES;
        }
        ...
        public @NotNull VkSurfacePresentScalingCapabilitiesEXT at(long index) {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSurfacePresentScalingCapabilitiesEXT.BYTES, VkSurfacePresentScalingCapabilitiesEXT.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkSurfacePresentScalingCapabilitiesEXT.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkSurfacePresentScalingCapabilitiesEXT.BYTES,
                (end - start) * VkSurfacePresentScalingCapabilitiesEXT.BYTES
            ));
        }
        ...
        public static final class Iter implements Iterator<VkSurfacePresentScalingCapabilitiesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSurfacePresentScalingCapabilitiesEXT.BYTES) > 0;
            }

            @Override
            public VkSurfacePresentScalingCapabilitiesEXT next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkSurfacePresentScalingCapabilitiesEXT ret = new VkSurfacePresentScalingCapabilitiesEXT(segment.asSlice(0, VkSurfacePresentScalingCapabilitiesEXT.BYTES));
                segment = segment.asSlice(VkSurfacePresentScalingCapabilitiesEXT.BYTES);
                return ret;
            }
    ...
    public static VkSurfacePresentScalingCapabilitiesEXT.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkSurfacePresentScalingCapabilitiesEXT.Ptr ret = new VkSurfacePresentScalingCapabilitiesEXT.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.SURFACE_PRESENT_SCALING_CAPABILITIES_EXT);
        }
        return ret;
    }

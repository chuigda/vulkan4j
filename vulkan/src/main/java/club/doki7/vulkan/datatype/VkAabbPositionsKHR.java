...
public record VkAabbPositionsKHR(@NotNull MemorySegment segment) implements IVkAabbPositionsKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAabbPositionsKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAabbPositionsKHR.BYTES, VkAabbPositionsKHR.BYTES));
        }

...
///
/// The {@link VkVideoEncodeRateControlLayerInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkVideoEncodeRateControlLayerInfoKHR#autoInit} to initialize these fields manually for
...
public record VkVideoEncodeRateControlLayerInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeRateControlLayerInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.VIDEO_ENCODE_RATE_CONTROL_LAYER_INFO_KHR);
        }
        return ret;
    }

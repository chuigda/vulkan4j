...
public record VkPhysicalDeviceTileShadingFeaturesQCOM(@NotNull MemorySegment segment) implements IVkPhysicalDeviceTileShadingFeaturesQCOM {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceTileShadingFeaturesQCOM {
        public long size() {

...
public record VkShaderModuleValidationCacheCreateInfoEXT(@NotNull MemorySegment segment) implements IVkShaderModuleValidationCacheCreateInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkShaderModuleValidationCacheCreateInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkShaderModuleValidationCacheCreateInfoEXT.BYTES, VkShaderModuleValidationCacheCreateInfoEXT.BYTES));
        }

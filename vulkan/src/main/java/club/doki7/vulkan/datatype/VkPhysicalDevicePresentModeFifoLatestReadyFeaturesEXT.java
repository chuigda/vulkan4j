...
///
/// The {@code allocate} ({@link VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT#allocate(Arena, int)})

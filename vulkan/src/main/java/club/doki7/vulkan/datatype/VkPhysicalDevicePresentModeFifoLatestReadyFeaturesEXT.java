...
public record VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT.BYTES, VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT.BYTES));
        }

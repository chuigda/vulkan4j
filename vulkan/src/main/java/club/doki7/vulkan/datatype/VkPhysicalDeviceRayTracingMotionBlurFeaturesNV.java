...
public record VkPhysicalDeviceRayTracingMotionBlurFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRayTracingMotionBlurFeaturesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRayTracingMotionBlurFeaturesNV, Iterable<VkPhysicalDeviceRayTracingMotionBlurFeaturesNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceRayTracingMotionBlurFeaturesNV.BYTES, VkPhysicalDeviceRayTracingMotionBlurFeaturesNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceRayTracingMotionBlurFeaturesNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceRayTracingMotionBlurFeaturesNV.BYTES) > 0;
            }
    ...
    public void rayTracingMotionBlur(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public void rayTracingMotionBlurPipelineTraceRaysIndirect(@NativeType("VkBool32") @Unsigned int value) {

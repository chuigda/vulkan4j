...
///
/// The {@code allocate} ({@link VkPhysicalDeviceRayTracingMotionBlurFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceRayTracingMotionBlurFeaturesNV#allocate(Arena, int)})

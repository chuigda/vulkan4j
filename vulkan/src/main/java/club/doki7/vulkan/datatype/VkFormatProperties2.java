...
public record VkFormatProperties2(@NotNull MemorySegment segment) implements IVkFormatProperties2 {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkFormatProperties2, Iterable<VkFormatProperties2> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkFormatProperties2.BYTES, VkFormatProperties2.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkFormatProperties2> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkFormatProperties2.BYTES) > 0;
            }

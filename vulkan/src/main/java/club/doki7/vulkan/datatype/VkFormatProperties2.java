...
///
/// The {@link VkFormatProperties2#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkFormatProperties2#autoInit} to initialize these fields manually for
...
public record VkFormatProperties2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkFormatProperties2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.FORMAT_PROPERTIES_2);
        }
        return ret;
    }

...
///
/// The {@code allocate} ({@link VkAndroidHardwareBufferFormatProperties2ANDROID#allocate(Arena)}, {@link VkAndroidHardwareBufferFormatProperties2ANDROID#allocate(Arena, int)})

...
public record VkMutableDescriptorTypeCreateInfoEXT(@NotNull MemorySegment segment) implements IVkMutableDescriptorTypeCreateInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkMutableDescriptorTypeCreateInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMutableDescriptorTypeCreateInfoEXT.BYTES, VkMutableDescriptorTypeCreateInfoEXT.BYTES));
        }

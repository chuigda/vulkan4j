...
public record VkCommandBufferAllocateInfo(@NotNull MemorySegment segment) implements IVkCommandBufferAllocateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCommandBufferAllocateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCommandBufferAllocateInfo.BYTES, VkCommandBufferAllocateInfo.BYTES));
        }

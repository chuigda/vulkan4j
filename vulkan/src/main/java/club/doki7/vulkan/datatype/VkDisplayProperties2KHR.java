...
///
/// The {@code allocate} ({@link VkDisplayProperties2KHR#allocate(Arena)}, {@link VkDisplayProperties2KHR#allocate(Arena, int)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkDisplayProperties2KHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkDisplayProperties2KHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkDisplayProperties2KHR(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.DISPLAY_PROPERTIES_2_KHR);
        }
        return ret;
    }
    ...
    public static final PathElement PATH$displayProperties = PathElement.groupElement("PATH$displayProperties");

...
public record VkClusterAccelerationStructureClustersBottomLevelInputNV(@NotNull MemorySegment segment) implements IVkClusterAccelerationStructureClustersBottomLevelInputNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkClusterAccelerationStructureClustersBottomLevelInputNV, Iterable<VkClusterAccelerationStructureClustersBottomLevelInputNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkClusterAccelerationStructureClustersBottomLevelInputNV.BYTES, VkClusterAccelerationStructureClustersBottomLevelInputNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkClusterAccelerationStructureClustersBottomLevelInputNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkClusterAccelerationStructureClustersBottomLevelInputNV.BYTES) > 0;
            }

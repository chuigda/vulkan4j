...
public record VkSurfaceFormat2KHR(@NotNull MemorySegment segment) implements IVkSurfaceFormat2KHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSurfaceFormat2KHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSurfaceFormat2KHR.BYTES, VkSurfaceFormat2KHR.BYTES));
        }

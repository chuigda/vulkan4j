...
///
/// The {@code allocate} ({@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#allocate(Arena)}, {@link VkPhysicalDevicePerStageDescriptorSetFeaturesNV#allocate(Arena, int)})

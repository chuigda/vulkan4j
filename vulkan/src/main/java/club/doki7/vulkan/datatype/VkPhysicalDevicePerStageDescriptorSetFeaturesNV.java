...
public record VkPhysicalDevicePerStageDescriptorSetFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDevicePerStageDescriptorSetFeaturesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePerStageDescriptorSetFeaturesNV, Iterable<VkPhysicalDevicePerStageDescriptorSetFeaturesNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDevicePerStageDescriptorSetFeaturesNV.BYTES, VkPhysicalDevicePerStageDescriptorSetFeaturesNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDevicePerStageDescriptorSetFeaturesNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDevicePerStageDescriptorSetFeaturesNV.BYTES) > 0;
            }

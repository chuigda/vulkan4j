...
public record VkApplicationParametersEXT(@NotNull MemorySegment segment) implements IVkApplicationParametersEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkApplicationParametersEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkApplicationParametersEXT.BYTES, VkApplicationParametersEXT.BYTES));
        }

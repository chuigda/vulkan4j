...
public record VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM {
        public long size() {
    ...
    public @Unsigned @NativeType("VkBool32") int multiviewPerViewRenderAreas() {
        return segment.get(LAYOUT$multiviewPerViewRenderAreas, OFFSET$multiviewPerViewRenderAreas);
    }

    public void multiviewPerViewRenderAreas(@Unsigned @NativeType("VkBool32") int value) {

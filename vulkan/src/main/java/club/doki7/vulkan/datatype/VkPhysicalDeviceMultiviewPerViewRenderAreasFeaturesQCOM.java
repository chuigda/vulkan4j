...
///
/// The {@code allocate} ({@link VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM#allocate(Arena)}, {@link VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM#allocate(Arena, int)})

...
public record VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM, Iterable<VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM.BYTES, VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM.BYTES) > 0;
            }
    ...
    public void multiviewPerViewRenderAreas(@NativeType("VkBool32") @Unsigned int value) {

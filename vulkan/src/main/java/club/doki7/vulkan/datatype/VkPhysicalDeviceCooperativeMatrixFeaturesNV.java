...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCooperativeMatrixFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceCooperativeMatrixFeaturesNV#allocate(Arena, int)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceCooperativeMatrixFeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceCooperativeMatrixFeaturesNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES_NV);
        }
        return ret;
    }

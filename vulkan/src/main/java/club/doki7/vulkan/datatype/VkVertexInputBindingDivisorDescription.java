...
public record VkVertexInputBindingDivisorDescription(@NotNull MemorySegment segment) implements IVkVertexInputBindingDivisorDescription {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVertexInputBindingDivisorDescription, Iterable<VkVertexInputBindingDivisorDescription> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVertexInputBindingDivisorDescription.BYTES, VkVertexInputBindingDivisorDescription.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVertexInputBindingDivisorDescription> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVertexInputBindingDivisorDescription.BYTES) > 0;
            }

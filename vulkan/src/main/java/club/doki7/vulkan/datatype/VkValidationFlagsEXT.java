...
public record VkValidationFlagsEXT(@NotNull MemorySegment segment) implements IVkValidationFlagsEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkValidationFlagsEXT, Iterable<VkValidationFlagsEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkValidationFlagsEXT.BYTES, VkValidationFlagsEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkValidationFlagsEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkValidationFlagsEXT.BYTES) > 0;
            }

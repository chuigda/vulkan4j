...
public record VkDescriptorPoolInlineUniformBlockCreateInfo(@NotNull MemorySegment segment) implements IVkDescriptorPoolInlineUniformBlockCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDescriptorPoolInlineUniformBlockCreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDescriptorPoolInlineUniformBlockCreateInfo.BYTES, VkDescriptorPoolInlineUniformBlockCreateInfo.BYTES));
        }

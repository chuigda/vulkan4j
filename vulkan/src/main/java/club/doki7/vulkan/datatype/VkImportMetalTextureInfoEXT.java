...
public record VkImportMetalTextureInfoEXT(@NotNull MemorySegment segment) implements IVkImportMetalTextureInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportMetalTextureInfoEXT, Iterable<VkImportMetalTextureInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImportMetalTextureInfoEXT.BYTES, VkImportMetalTextureInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImportMetalTextureInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImportMetalTextureInfoEXT.BYTES) > 0;
            }

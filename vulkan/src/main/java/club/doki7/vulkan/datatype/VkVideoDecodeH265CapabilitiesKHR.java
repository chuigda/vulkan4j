...
public record VkVideoDecodeH265CapabilitiesKHR(@NotNull MemorySegment segment) implements IVkVideoDecodeH265CapabilitiesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoDecodeH265CapabilitiesKHR, Iterable<VkVideoDecodeH265CapabilitiesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoDecodeH265CapabilitiesKHR.BYTES, VkVideoDecodeH265CapabilitiesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoDecodeH265CapabilitiesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoDecodeH265CapabilitiesKHR.BYTES) > 0;
            }

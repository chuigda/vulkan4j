...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShaderFloatControls2Features#allocate(Arena)}, {@link VkPhysicalDeviceShaderFloatControls2Features#allocate(Arena, int)})

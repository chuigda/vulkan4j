...
///
/// The {@code allocate} ({@link VkPhysicalDeviceVertexAttributeDivisorProperties#allocate(Arena)}, {@link VkPhysicalDeviceVertexAttributeDivisorProperties#allocate(Arena, int)})
...
public record VkPhysicalDeviceVertexAttributeDivisorProperties(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceVertexAttributeDivisorProperties[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES);
        }
        return ret;
    }

...
public record VkVideoEncodeH265SessionParametersCreateInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH265SessionParametersCreateInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH265SessionParametersCreateInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeH265SessionParametersCreateInfoKHR.BYTES, VkVideoEncodeH265SessionParametersCreateInfoKHR.BYTES));
        }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCudaKernelLaunchPropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceCudaKernelLaunchPropertiesNV#allocate(Arena, int)})

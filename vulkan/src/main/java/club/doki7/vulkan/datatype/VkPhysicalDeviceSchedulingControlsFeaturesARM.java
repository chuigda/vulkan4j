...
///
/// The {@code allocate} ({@link VkPhysicalDeviceSchedulingControlsFeaturesARM#allocate(Arena)}, {@link VkPhysicalDeviceSchedulingControlsFeaturesARM#allocate(Arena, int)})

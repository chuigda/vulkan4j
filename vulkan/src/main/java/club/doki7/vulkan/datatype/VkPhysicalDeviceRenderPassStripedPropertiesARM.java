...
public record VkPhysicalDeviceRenderPassStripedPropertiesARM(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRenderPassStripedPropertiesARM {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRenderPassStripedPropertiesARM {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceRenderPassStripedPropertiesARM.BYTES, VkPhysicalDeviceRenderPassStripedPropertiesARM.BYTES));
        }

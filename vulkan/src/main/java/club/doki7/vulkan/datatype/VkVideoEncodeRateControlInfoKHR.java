...
public record VkVideoEncodeRateControlInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeRateControlInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeRateControlInfoKHR, Iterable<VkVideoEncodeRateControlInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeRateControlInfoKHR.BYTES, VkVideoEncodeRateControlInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeRateControlInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeRateControlInfoKHR.BYTES) > 0;
            }

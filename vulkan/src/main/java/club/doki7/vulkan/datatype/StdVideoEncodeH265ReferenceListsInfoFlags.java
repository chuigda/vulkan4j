...
public record StdVideoEncodeH265ReferenceListsInfoFlags(@NotNull MemorySegment segment) implements IStdVideoEncodeH265ReferenceListsInfoFlags {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeH265ReferenceListsInfoFlags, Iterable<StdVideoEncodeH265ReferenceListsInfoFlags> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoEncodeH265ReferenceListsInfoFlags.BYTES, StdVideoEncodeH265ReferenceListsInfoFlags.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoEncodeH265ReferenceListsInfoFlags> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoEncodeH265ReferenceListsInfoFlags.BYTES) > 0;
            }

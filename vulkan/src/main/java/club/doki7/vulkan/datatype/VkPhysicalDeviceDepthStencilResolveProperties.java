...
///
/// The {@code allocate} ({@link VkPhysicalDeviceDepthStencilResolveProperties#allocate(Arena)}, {@link VkPhysicalDeviceDepthStencilResolveProperties#allocate(Arena, int)})

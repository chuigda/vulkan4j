...
public record VkVideoSessionMemoryRequirementsKHR(@NotNull MemorySegment segment) implements IVkVideoSessionMemoryRequirementsKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoSessionMemoryRequirementsKHR, Iterable<VkVideoSessionMemoryRequirementsKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoSessionMemoryRequirementsKHR.BYTES, VkVideoSessionMemoryRequirementsKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoSessionMemoryRequirementsKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoSessionMemoryRequirementsKHR.BYTES) > 0;
            }

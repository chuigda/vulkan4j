...
public record VkPhysicalDeviceMeshShaderFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMeshShaderFeaturesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMeshShaderFeaturesNV, Iterable<VkPhysicalDeviceMeshShaderFeaturesNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceMeshShaderFeaturesNV.BYTES, VkPhysicalDeviceMeshShaderFeaturesNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceMeshShaderFeaturesNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceMeshShaderFeaturesNV.BYTES) > 0;
            }

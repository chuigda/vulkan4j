...
public record VkExportFenceSciSyncInfoNV(@NotNull MemorySegment segment) implements IVkExportFenceSciSyncInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkExportFenceSciSyncInfoNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkExportFenceSciSyncInfoNV.BYTES, VkExportFenceSciSyncInfoNV.BYTES));
        }

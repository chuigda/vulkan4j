...
public record VkDrmFormatModifierPropertiesEXT(@NotNull MemorySegment segment) implements IVkDrmFormatModifierPropertiesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDrmFormatModifierPropertiesEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDrmFormatModifierPropertiesEXT.BYTES, VkDrmFormatModifierPropertiesEXT.BYTES));
        }
    ...
    public static VkDrmFormatModifierPropertiesEXT.Ptr allocate(Arena arena, long count) {
        ...
        VkDrmFormatModifierPropertiesEXT.Ptr ret = new VkDrmFormatModifierPropertiesEXT.Ptr(segment);
        return ret;
    }

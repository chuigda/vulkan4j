...
///
/// The {@code allocate} ({@link VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT#allocate(Arena)}, {@link VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT#allocate(Arena, int)})

...
public record VkDeviceGroupBindSparseInfo(@NotNull MemorySegment segment) implements IVkDeviceGroupBindSparseInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDeviceGroupBindSparseInfo, Iterable<VkDeviceGroupBindSparseInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDeviceGroupBindSparseInfo.BYTES, VkDeviceGroupBindSparseInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDeviceGroupBindSparseInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDeviceGroupBindSparseInfo.BYTES) > 0;
            }

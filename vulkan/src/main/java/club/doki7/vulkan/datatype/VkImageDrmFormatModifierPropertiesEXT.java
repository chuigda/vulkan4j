...
public record VkImageDrmFormatModifierPropertiesEXT(@NotNull MemorySegment segment) implements IVkImageDrmFormatModifierPropertiesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageDrmFormatModifierPropertiesEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImageDrmFormatModifierPropertiesEXT.BYTES, VkImageDrmFormatModifierPropertiesEXT.BYTES));
        }

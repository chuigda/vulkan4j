...
public record VkMemorySciBufPropertiesNV(@NotNull MemorySegment segment) implements IVkMemorySciBufPropertiesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemorySciBufPropertiesNV, Iterable<VkMemorySciBufPropertiesNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMemorySciBufPropertiesNV.BYTES, VkMemorySciBufPropertiesNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkMemorySciBufPropertiesNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkMemorySciBufPropertiesNV.BYTES) > 0;
            }

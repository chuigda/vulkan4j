...
public record VkPhysicalDevicePresentBarrierFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDevicePresentBarrierFeaturesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePresentBarrierFeaturesNV, Iterable<VkPhysicalDevicePresentBarrierFeaturesNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDevicePresentBarrierFeaturesNV.BYTES, VkPhysicalDevicePresentBarrierFeaturesNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDevicePresentBarrierFeaturesNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDevicePresentBarrierFeaturesNV.BYTES) > 0;
            }
    ...
    public void presentBarrier(@NativeType("VkBool32") @Unsigned int value) {

...
public record VkImportMemoryFdInfoKHR(@NotNull MemorySegment segment) implements IVkImportMemoryFdInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportMemoryFdInfoKHR, Iterable<VkImportMemoryFdInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImportMemoryFdInfoKHR.BYTES, VkImportMemoryFdInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImportMemoryFdInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImportMemoryFdInfoKHR.BYTES) > 0;
            }

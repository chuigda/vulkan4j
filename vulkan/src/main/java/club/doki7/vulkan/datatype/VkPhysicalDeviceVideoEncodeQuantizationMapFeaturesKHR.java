...
public record VkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR, Iterable<VkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR.BYTES, VkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR.BYTES) > 0;
            }
    ...
    public void videoEncodeQuantizationMap(@NativeType("VkBool32") @Unsigned int value) {

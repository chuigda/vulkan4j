...
public record StdVideoAV1Segmentation(@NotNull MemorySegment segment) implements IStdVideoAV1Segmentation {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoAV1Segmentation, Iterable<StdVideoAV1Segmentation> {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * StdVideoAV1Segmentation.BYTES));
        }
        ...
        @Override
        public @NotNull Iterator<StdVideoAV1Segmentation> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<StdVideoAV1Segmentation> {

...
public record VkSubpassResolvePerformanceQueryEXT(@NotNull MemorySegment segment) implements IVkSubpassResolvePerformanceQueryEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSubpassResolvePerformanceQueryEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSubpassResolvePerformanceQueryEXT.BYTES, VkSubpassResolvePerformanceQueryEXT.BYTES));
        }
    ...
    public void optimal(@NativeType("VkBool32") @Unsigned int value) {

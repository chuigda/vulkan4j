...
public record VkPhysicalDeviceOpacityMicromapFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceOpacityMicromapFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceOpacityMicromapFeaturesEXT, Iterable<VkPhysicalDeviceOpacityMicromapFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceOpacityMicromapFeaturesEXT.BYTES, VkPhysicalDeviceOpacityMicromapFeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceOpacityMicromapFeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceOpacityMicromapFeaturesEXT.BYTES) > 0;
            }

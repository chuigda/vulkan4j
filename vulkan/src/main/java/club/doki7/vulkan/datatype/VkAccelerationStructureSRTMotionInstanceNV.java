...
public record VkAccelerationStructureSRTMotionInstanceNV(@NotNull MemorySegment segment) implements IVkAccelerationStructureSRTMotionInstanceNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureSRTMotionInstanceNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAccelerationStructureSRTMotionInstanceNV.BYTES, VkAccelerationStructureSRTMotionInstanceNV.BYTES));
        }
    ...
    public static VkAccelerationStructureSRTMotionInstanceNV.Ptr allocate(Arena arena, long count) {
        ...
        VkAccelerationStructureSRTMotionInstanceNV.Ptr ret = new VkAccelerationStructureSRTMotionInstanceNV.Ptr(segment);
        return ret;
    }

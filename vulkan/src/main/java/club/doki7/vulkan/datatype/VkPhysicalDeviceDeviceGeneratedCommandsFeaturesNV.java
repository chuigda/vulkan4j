...
///
/// The {@code allocate} ({@link VkPhysicalDeviceDeviceGeneratedCommandsFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceDeviceGeneratedCommandsFeaturesNV#allocate(Arena, int)})

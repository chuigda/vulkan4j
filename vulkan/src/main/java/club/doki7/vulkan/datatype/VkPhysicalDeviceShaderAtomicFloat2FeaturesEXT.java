...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT#allocate(Arena, int)})

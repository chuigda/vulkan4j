...
public record VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderAtomicFloat2FeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderAtomicFloat2FeaturesEXT {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT.BYTES, VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT.BYTES));
        }

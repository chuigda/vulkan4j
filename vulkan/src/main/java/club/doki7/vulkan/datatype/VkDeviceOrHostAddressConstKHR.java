...
public record VkDeviceOrHostAddressConstKHR(@NotNull MemorySegment segment) implements IVkDeviceOrHostAddressConstKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDeviceOrHostAddressConstKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDeviceOrHostAddressConstKHR.BYTES, VkDeviceOrHostAddressConstKHR.BYTES));
        }
    ...
    public static VkDeviceOrHostAddressConstKHR.Ptr allocate(Arena arena, long count) {
        ...
        VkDeviceOrHostAddressConstKHR.Ptr ret = new VkDeviceOrHostAddressConstKHR.Ptr(segment);
        return ret;
    }

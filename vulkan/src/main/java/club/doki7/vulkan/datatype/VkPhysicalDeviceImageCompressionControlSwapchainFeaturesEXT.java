...
public record VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT, Iterable<VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT.BYTES, VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT.BYTES) > 0;
            }

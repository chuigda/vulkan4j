...
///
/// The {@code allocate} ({@link VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT#allocate(Arena, int)})

...
public record VkPhysicalDeviceMapMemoryPlacedFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMapMemoryPlacedFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMapMemoryPlacedFeaturesEXT, Iterable<VkPhysicalDeviceMapMemoryPlacedFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceMapMemoryPlacedFeaturesEXT.BYTES, VkPhysicalDeviceMapMemoryPlacedFeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceMapMemoryPlacedFeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceMapMemoryPlacedFeaturesEXT.BYTES) > 0;
            }

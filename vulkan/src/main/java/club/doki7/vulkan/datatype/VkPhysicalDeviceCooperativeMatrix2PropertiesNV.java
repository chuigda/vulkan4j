...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCooperativeMatrix2PropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceCooperativeMatrix2PropertiesNV#allocate(Arena, int)})

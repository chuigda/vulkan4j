...
public record VkSwapchainPresentModeInfoEXT(@NotNull MemorySegment segment) implements IVkSwapchainPresentModeInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSwapchainPresentModeInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSwapchainPresentModeInfoEXT.BYTES, VkSwapchainPresentModeInfoEXT.BYTES));
        }

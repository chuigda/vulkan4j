...
///
/// The {@code allocate} ({@link VkPhysicalDeviceExtendedDynamicState2FeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceExtendedDynamicState2FeaturesEXT#allocate(Arena, int)})

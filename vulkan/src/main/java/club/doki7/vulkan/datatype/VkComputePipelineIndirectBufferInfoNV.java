...
public record VkComputePipelineIndirectBufferInfoNV(@NotNull MemorySegment segment) implements IVkComputePipelineIndirectBufferInfoNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkComputePipelineIndirectBufferInfoNV, Iterable<VkComputePipelineIndirectBufferInfoNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkComputePipelineIndirectBufferInfoNV.BYTES, VkComputePipelineIndirectBufferInfoNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkComputePipelineIndirectBufferInfoNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkComputePipelineIndirectBufferInfoNV.BYTES) > 0;
            }

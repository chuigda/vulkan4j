...
public record VkDescriptorSetLayoutBindingFlagsCreateInfo(@NotNull MemorySegment segment) implements IVkDescriptorSetLayoutBindingFlagsCreateInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDescriptorSetLayoutBindingFlagsCreateInfo, Iterable<VkDescriptorSetLayoutBindingFlagsCreateInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDescriptorSetLayoutBindingFlagsCreateInfo.BYTES, VkDescriptorSetLayoutBindingFlagsCreateInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDescriptorSetLayoutBindingFlagsCreateInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDescriptorSetLayoutBindingFlagsCreateInfo.BYTES) > 0;
            }

...
///
/// The {@link VkImageCopy2#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkImageCopy2#autoInit} to initialize these fields manually for
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkImageCopy2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkImageCopy2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.IMAGE_COPY_2);
        }
        return ret;
    }

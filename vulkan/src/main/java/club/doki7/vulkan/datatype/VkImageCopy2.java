...
public record VkImageCopy2(@NotNull MemorySegment segment) implements IVkImageCopy2 {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageCopy2, Iterable<VkImageCopy2> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImageCopy2.BYTES, VkImageCopy2.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImageCopy2> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImageCopy2.BYTES) > 0;
            }

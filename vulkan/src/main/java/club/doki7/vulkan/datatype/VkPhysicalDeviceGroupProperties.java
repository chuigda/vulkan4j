...
public record VkPhysicalDeviceGroupProperties(@NotNull MemorySegment segment) implements IVkPhysicalDeviceGroupProperties {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceGroupProperties, Iterable<VkPhysicalDeviceGroupProperties> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceGroupProperties.BYTES, VkPhysicalDeviceGroupProperties.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceGroupProperties> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceGroupProperties.BYTES) > 0;
            }

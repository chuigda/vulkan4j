...
public record VkWaylandSurfaceCreateInfoKHR(@NotNull MemorySegment segment) implements IVkWaylandSurfaceCreateInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkWaylandSurfaceCreateInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkWaylandSurfaceCreateInfoKHR.BYTES, VkWaylandSurfaceCreateInfoKHR.BYTES));
        }

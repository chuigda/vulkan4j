...
public record VkCudaFunctionCreateInfoNV(@NotNull MemorySegment segment) implements IVkCudaFunctionCreateInfoNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkCudaFunctionCreateInfoNV, Iterable<VkCudaFunctionCreateInfoNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCudaFunctionCreateInfoNV.BYTES, VkCudaFunctionCreateInfoNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkCudaFunctionCreateInfoNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkCudaFunctionCreateInfoNV.BYTES) > 0;
            }

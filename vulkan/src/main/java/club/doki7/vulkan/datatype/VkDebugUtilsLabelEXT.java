...
public record VkDebugUtilsLabelEXT(@NotNull MemorySegment segment) implements IVkDebugUtilsLabelEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDebugUtilsLabelEXT, Iterable<VkDebugUtilsLabelEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDebugUtilsLabelEXT.BYTES, VkDebugUtilsLabelEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDebugUtilsLabelEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDebugUtilsLabelEXT.BYTES) > 0;
            }

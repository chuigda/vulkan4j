...
public record VkValidationFeaturesEXT(@NotNull MemorySegment segment) implements IVkValidationFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkValidationFeaturesEXT, Iterable<VkValidationFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkValidationFeaturesEXT.BYTES, VkValidationFeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkValidationFeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkValidationFeaturesEXT.BYTES) > 0;
            }

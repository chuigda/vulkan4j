...
public record VkPhysicalDeviceProvokingVertexFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceProvokingVertexFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceProvokingVertexFeaturesEXT, Iterable<VkPhysicalDeviceProvokingVertexFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES, VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceProvokingVertexFeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceProvokingVertexFeaturesEXT.BYTES) > 0;
            }

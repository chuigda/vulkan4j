...
///
/// The {@code allocate} ({@link VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV#allocate(Arena, int)})

...
public record VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV.BYTES, VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV.BYTES));
        }
    ...
    public void extendedSparseAddressSpaceSize(@NativeType("VkDeviceSize") @Unsigned long value) {

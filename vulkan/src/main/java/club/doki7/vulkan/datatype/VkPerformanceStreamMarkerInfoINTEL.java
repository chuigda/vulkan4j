...
public record VkPerformanceStreamMarkerInfoINTEL(@NotNull MemorySegment segment) implements IVkPerformanceStreamMarkerInfoINTEL {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPerformanceStreamMarkerInfoINTEL, Iterable<VkPerformanceStreamMarkerInfoINTEL> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPerformanceStreamMarkerInfoINTEL.BYTES, VkPerformanceStreamMarkerInfoINTEL.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPerformanceStreamMarkerInfoINTEL> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPerformanceStreamMarkerInfoINTEL.BYTES) > 0;
            }

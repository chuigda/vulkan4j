...
public record VkTilePropertiesQCOM(@NotNull MemorySegment segment) implements IVkTilePropertiesQCOM {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkTilePropertiesQCOM {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkTilePropertiesQCOM.BYTES, VkTilePropertiesQCOM.BYTES));
        }

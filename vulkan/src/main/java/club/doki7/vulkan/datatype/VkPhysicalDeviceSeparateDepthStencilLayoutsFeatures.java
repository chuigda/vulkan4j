...
///
/// The {@code allocate} ({@link VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures#allocate(Arena)}, {@link VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures#allocate(Arena, int)})

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceExternalSciSync2FeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceExternalSciSync2FeaturesNV#allocate(Arena, int)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceExternalSciSync2FeaturesNV(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceExternalSciSync2FeaturesNV[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkPhysicalDeviceExternalSciSync2FeaturesNV(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_2_FEATURES_NV);
        }
        return ret;
    }

...
public record VkPhysicalDeviceExternalSciSync2FeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalSciSync2FeaturesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalSciSync2FeaturesNV, Iterable<VkPhysicalDeviceExternalSciSync2FeaturesNV> {
        public long size() {
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceExternalSciSync2FeaturesNV> {
            ...
            @Override
            public VkPhysicalDeviceExternalSciSync2FeaturesNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkPhysicalDeviceExternalSciSync2FeaturesNV ret = new VkPhysicalDeviceExternalSciSync2FeaturesNV(segment.asSlice(0, VkPhysicalDeviceExternalSciSync2FeaturesNV.BYTES));
                segment = segment.asSlice(VkPhysicalDeviceExternalSciSync2FeaturesNV.BYTES);
                return ret;
            }

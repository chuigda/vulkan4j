...
/// Represents a pointer to a <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceExternalSciSync2FeaturesNV.html"><code>VkPhysicalDeviceExternalSciSync2FeaturesNV</code></a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
///     VkBool32 sciSyncSemaphore2; // @link substring="sciSyncSemaphore2" target="#sciSyncSemaphore2"
...
///
/// The {@code allocate} ({@link VkPhysicalDeviceExternalSciSync2FeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceExternalSciSync2FeaturesNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkPhysicalDeviceExternalSciSync2FeaturesNV#autoInit}
...
///
/// @see <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceExternalSciSync2FeaturesNV.html"><code>VkPhysicalDeviceExternalSciSync2FeaturesNV</code></a>
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceExternalSciSync2FeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalSciSync2FeaturesNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceExternalSciSync2FeaturesNV.html"><code>VkPhysicalDeviceExternalSciSync2FeaturesNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceExternalSciSync2FeaturesNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceExternalSciSync2FeaturesNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceExternalSciSync2FeaturesNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalSciSync2FeaturesNV {
        public long size() {
        ...
        public @NotNull VkPhysicalDeviceExternalSciSync2FeaturesNV at(long index) {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceExternalSciSync2FeaturesNV.BYTES, VkPhysicalDeviceExternalSciSync2FeaturesNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceExternalSciSync2FeaturesNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceExternalSciSync2FeaturesNV.BYTES,
                (end - start) * VkPhysicalDeviceExternalSciSync2FeaturesNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceExternalSciSync2FeaturesNV.BYTES));
        }

        public VkPhysicalDeviceExternalSciSync2FeaturesNV[] toArray() {
            VkPhysicalDeviceExternalSciSync2FeaturesNV[] ret = new VkPhysicalDeviceExternalSciSync2FeaturesNV[(int) size()];
    ...
    public static VkPhysicalDeviceExternalSciSync2FeaturesNV allocate(Arena arena) {
        VkPhysicalDeviceExternalSciSync2FeaturesNV ret = new VkPhysicalDeviceExternalSciSync2FeaturesNV(arena.allocate(LAYOUT));
        ret.sType(VkStructureType.PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_2_FEATURES_NV);
        return ret;
    }

    public static VkPhysicalDeviceExternalSciSync2FeaturesNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceExternalSciSync2FeaturesNV.Ptr ret = new VkPhysicalDeviceExternalSciSync2FeaturesNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_2_FEATURES_NV);
        }
        return ret;
    }
    ...
    public @Unsigned @NativeType("VkBool32") int sciSyncFence() {
        return segment.get(LAYOUT$sciSyncFence, OFFSET$sciSyncFence);
    }

    public void sciSyncFence(@Unsigned @NativeType("VkBool32") int value) {
        segment.set(LAYOUT$sciSyncFence, OFFSET$sciSyncFence, value);
    }

    public @Unsigned @NativeType("VkBool32") int sciSyncSemaphore2() {
        return segment.get(LAYOUT$sciSyncSemaphore2, OFFSET$sciSyncSemaphore2);
    }

    public void sciSyncSemaphore2(@Unsigned @NativeType("VkBool32") int value) {
        segment.set(LAYOUT$sciSyncSemaphore2, OFFSET$sciSyncSemaphore2, value);
    }

    public @Unsigned @NativeType("VkBool32") int sciSyncImport() {
        return segment.get(LAYOUT$sciSyncImport, OFFSET$sciSyncImport);
    }

    public void sciSyncImport(@Unsigned @NativeType("VkBool32") int value) {
        segment.set(LAYOUT$sciSyncImport, OFFSET$sciSyncImport, value);
    }

    public @Unsigned @NativeType("VkBool32") int sciSyncExport() {
        return segment.get(LAYOUT$sciSyncExport, OFFSET$sciSyncExport);
    }

    public void sciSyncExport(@Unsigned @NativeType("VkBool32") int value) {

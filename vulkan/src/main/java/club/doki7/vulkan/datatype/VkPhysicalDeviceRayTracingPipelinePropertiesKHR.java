...
///
/// The {@code allocate} ({@link VkPhysicalDeviceRayTracingPipelinePropertiesKHR#allocate(Arena)}, {@link VkPhysicalDeviceRayTracingPipelinePropertiesKHR#allocate(Arena, int)})

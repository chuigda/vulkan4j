...
public record VkCopyAccelerationStructureInfoKHR(@NotNull MemorySegment segment) implements IVkCopyAccelerationStructureInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyAccelerationStructureInfoKHR, Iterable<VkCopyAccelerationStructureInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCopyAccelerationStructureInfoKHR.BYTES, VkCopyAccelerationStructureInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkCopyAccelerationStructureInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkCopyAccelerationStructureInfoKHR.BYTES) > 0;
            }

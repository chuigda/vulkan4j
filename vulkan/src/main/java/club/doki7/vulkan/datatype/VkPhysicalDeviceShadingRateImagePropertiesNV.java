...
public record VkPhysicalDeviceShadingRateImagePropertiesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShadingRateImagePropertiesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShadingRateImagePropertiesNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShadingRateImagePropertiesNV.BYTES, VkPhysicalDeviceShadingRateImagePropertiesNV.BYTES));
        }

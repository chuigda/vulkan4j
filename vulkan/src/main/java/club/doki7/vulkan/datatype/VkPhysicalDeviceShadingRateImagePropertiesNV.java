...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShadingRateImagePropertiesNV#allocate(Arena)}, {@link VkPhysicalDeviceShadingRateImagePropertiesNV#allocate(Arena, int)})

...
public record StdVideoDecodeAV1PictureInfo(@NotNull MemorySegment segment) implements IStdVideoDecodeAV1PictureInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoDecodeAV1PictureInfo {
        public long size() {
    ...
    public static StdVideoDecodeAV1PictureInfo.Ptr allocate(Arena arena, long count) {
        ...
        StdVideoDecodeAV1PictureInfo.Ptr ret = new StdVideoDecodeAV1PictureInfo.Ptr(segment);
        return ret;
    }

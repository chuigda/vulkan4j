...
///
/// The {@code allocate} ({@link VkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV#allocate(Arena, int)})

...
public record VkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV.BYTES, VkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV.BYTES));
        }

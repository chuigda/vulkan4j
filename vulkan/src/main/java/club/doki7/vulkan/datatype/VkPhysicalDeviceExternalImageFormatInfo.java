...
public record VkPhysicalDeviceExternalImageFormatInfo(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalImageFormatInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalImageFormatInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceExternalImageFormatInfo.BYTES, VkPhysicalDeviceExternalImageFormatInfo.BYTES));
        }

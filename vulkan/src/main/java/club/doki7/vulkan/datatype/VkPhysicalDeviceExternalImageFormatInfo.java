...
///
/// The {@link VkPhysicalDeviceExternalImageFormatInfo#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceExternalImageFormatInfo#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceExternalImageFormatInfo(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceExternalImageFormatInfo[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO);
        }
        return ret;
    }

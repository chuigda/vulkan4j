...
public record StdVideoAV1FilmGrainFlags(@NotNull MemorySegment segment) implements IStdVideoAV1FilmGrainFlags {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoAV1FilmGrainFlags, Iterable<StdVideoAV1FilmGrainFlags> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoAV1FilmGrainFlags.BYTES, StdVideoAV1FilmGrainFlags.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoAV1FilmGrainFlags> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoAV1FilmGrainFlags.BYTES) > 0;
            }

...
public record VkDescriptorBufferInfo(@NotNull MemorySegment segment) implements IVkDescriptorBufferInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDescriptorBufferInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDescriptorBufferInfo.BYTES, VkDescriptorBufferInfo.BYTES));
        }

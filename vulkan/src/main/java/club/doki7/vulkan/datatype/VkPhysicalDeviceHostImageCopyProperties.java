...
public record VkPhysicalDeviceHostImageCopyProperties(@NotNull MemorySegment segment) implements IVkPhysicalDeviceHostImageCopyProperties {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceHostImageCopyProperties {
        public long size() {
    ...
    public @Unsigned @NativeType("VkBool32") int identicalMemoryTypeRequirements() {
        return segment.get(LAYOUT$identicalMemoryTypeRequirements, OFFSET$identicalMemoryTypeRequirements);
    }

    public void identicalMemoryTypeRequirements(@Unsigned @NativeType("VkBool32") int value) {

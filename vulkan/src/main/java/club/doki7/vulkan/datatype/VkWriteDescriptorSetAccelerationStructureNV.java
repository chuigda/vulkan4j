...
public record VkWriteDescriptorSetAccelerationStructureNV(@NotNull MemorySegment segment) implements IVkWriteDescriptorSetAccelerationStructureNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkWriteDescriptorSetAccelerationStructureNV, Iterable<VkWriteDescriptorSetAccelerationStructureNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkWriteDescriptorSetAccelerationStructureNV.BYTES, VkWriteDescriptorSetAccelerationStructureNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkWriteDescriptorSetAccelerationStructureNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkWriteDescriptorSetAccelerationStructureNV.BYTES) > 0;
            }

...
public record VkPipelineBinaryHandlesInfoKHR(@NotNull MemorySegment segment) implements IVkPipelineBinaryHandlesInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineBinaryHandlesInfoKHR, Iterable<VkPipelineBinaryHandlesInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineBinaryHandlesInfoKHR.BYTES, VkPipelineBinaryHandlesInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineBinaryHandlesInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineBinaryHandlesInfoKHR.BYTES) > 0;
            }

...
///     VkBool32 enablePartitionTranslation; // @link substring="enablePartitionTranslation" target="#enablePartitionTranslation"
...
///
/// The {@code allocate} ({@link VkPartitionedAccelerationStructureFlagsNV#allocate(Arena)}, {@link VkPartitionedAccelerationStructureFlagsNV#allocate(Arena, long)})
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPartitionedAccelerationStructureFlagsNV(@NotNull MemorySegment segment) implements IVkPartitionedAccelerationStructureFlagsNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPartitionedAccelerationStructureFlagsNV.html"><code>VkPartitionedAccelerationStructureFlagsNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPartitionedAccelerationStructureFlagsNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPartitionedAccelerationStructureFlagsNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPartitionedAccelerationStructureFlagsNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPartitionedAccelerationStructureFlagsNV, Iterable<VkPartitionedAccelerationStructureFlagsNV> {
        ...
        public @NotNull VkPartitionedAccelerationStructureFlagsNV at(long index) {
        ...
        public @NotNull Ptr reinterpret(long newSize) {
            return new Ptr(segment.reinterpret(newSize * VkPartitionedAccelerationStructureFlagsNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPartitionedAccelerationStructureFlagsNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPartitionedAccelerationStructureFlagsNV.BYTES,
                (end - start) * VkPartitionedAccelerationStructureFlagsNV.BYTES
            ));
        }
        ...
        @Override
        public @NotNull Iterator<VkPartitionedAccelerationStructureFlagsNV> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<VkPartitionedAccelerationStructureFlagsNV> {
    ...
    public static VkPartitionedAccelerationStructureFlagsNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPartitionedAccelerationStructureFlagsNV.Ptr ret = new VkPartitionedAccelerationStructureFlagsNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PARTITIONED_ACCELERATION_STRUCTURE_FLAGS_NV);
        }
        return ret;
    }
    ...
    public VkPartitionedAccelerationStructureFlagsNV enablePartitionTranslation(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public static final PathElement PATH$enablePartitionTranslation = PathElement.groupElement("enablePartitionTranslation");

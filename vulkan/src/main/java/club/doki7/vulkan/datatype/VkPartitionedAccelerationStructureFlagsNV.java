...
public record VkPartitionedAccelerationStructureFlagsNV(@NotNull MemorySegment segment) implements IVkPartitionedAccelerationStructureFlagsNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPartitionedAccelerationStructureFlagsNV {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPartitionedAccelerationStructureFlagsNV.BYTES, VkPartitionedAccelerationStructureFlagsNV.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int enablePartitionTranslation() {
        return segment.get(LAYOUT$enablePartitionTranslation, OFFSET$enablePartitionTranslation);
    }

    public void enablePartitionTranslation(@Unsigned @NativeType("VkBool32") int value) {

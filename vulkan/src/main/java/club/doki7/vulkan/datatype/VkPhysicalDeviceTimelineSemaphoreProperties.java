...
public record VkPhysicalDeviceTimelineSemaphoreProperties(@NotNull MemorySegment segment) implements IVkPhysicalDeviceTimelineSemaphoreProperties {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceTimelineSemaphoreProperties {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceTimelineSemaphoreProperties.BYTES, VkPhysicalDeviceTimelineSemaphoreProperties.BYTES));
        }

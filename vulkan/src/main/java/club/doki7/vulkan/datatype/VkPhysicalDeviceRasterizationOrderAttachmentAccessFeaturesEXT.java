...
///
/// The {@code allocate} ({@link VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT#allocate(Arena, int)})

...
public record VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT.BYTES, VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT.BYTES));
        }

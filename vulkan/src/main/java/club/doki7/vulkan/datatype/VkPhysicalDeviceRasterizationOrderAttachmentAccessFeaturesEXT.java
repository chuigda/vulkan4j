...
///
/// The {@link VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_FEATURES_EXT);
        }
        return ret;
    }

...
public record VkBlitImageCubicWeightsInfoQCOM(@NotNull MemorySegment segment) implements IVkBlitImageCubicWeightsInfoQCOM {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkBlitImageCubicWeightsInfoQCOM, Iterable<VkBlitImageCubicWeightsInfoQCOM> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBlitImageCubicWeightsInfoQCOM.BYTES, VkBlitImageCubicWeightsInfoQCOM.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkBlitImageCubicWeightsInfoQCOM> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkBlitImageCubicWeightsInfoQCOM.BYTES) > 0;
            }

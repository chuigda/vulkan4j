...
public record StdVideoEncodeH264ReferenceListsInfoFlags(@NotNull MemorySegment segment) implements IStdVideoEncodeH264ReferenceListsInfoFlags {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeH264ReferenceListsInfoFlags, Iterable<StdVideoEncodeH264ReferenceListsInfoFlags> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * StdVideoEncodeH264ReferenceListsInfoFlags.BYTES, StdVideoEncodeH264ReferenceListsInfoFlags.BYTES));
        }
        ...
        public static final class Iter implements Iterator<StdVideoEncodeH264ReferenceListsInfoFlags> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / StdVideoEncodeH264ReferenceListsInfoFlags.BYTES) > 0;
            }

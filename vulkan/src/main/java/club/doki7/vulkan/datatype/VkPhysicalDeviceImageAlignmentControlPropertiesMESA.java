...
public record VkPhysicalDeviceImageAlignmentControlPropertiesMESA(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageAlignmentControlPropertiesMESA {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageAlignmentControlPropertiesMESA, Iterable<VkPhysicalDeviceImageAlignmentControlPropertiesMESA> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceImageAlignmentControlPropertiesMESA.BYTES, VkPhysicalDeviceImageAlignmentControlPropertiesMESA.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceImageAlignmentControlPropertiesMESA> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceImageAlignmentControlPropertiesMESA.BYTES) > 0;
            }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceImageAlignmentControlPropertiesMESA#allocate(Arena)}, {@link VkPhysicalDeviceImageAlignmentControlPropertiesMESA#allocate(Arena, int)})

...
public record VkQueryPoolPerformanceQueryCreateInfoINTEL(@NotNull MemorySegment segment) implements IVkQueryPoolPerformanceQueryCreateInfoINTEL {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkQueryPoolPerformanceQueryCreateInfoINTEL {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkQueryPoolPerformanceQueryCreateInfoINTEL.BYTES, VkQueryPoolPerformanceQueryCreateInfoINTEL.BYTES));
        }

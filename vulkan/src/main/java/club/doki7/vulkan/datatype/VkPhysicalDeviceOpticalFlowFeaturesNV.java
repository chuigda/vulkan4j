...
public record VkPhysicalDeviceOpticalFlowFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceOpticalFlowFeaturesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceOpticalFlowFeaturesNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceOpticalFlowFeaturesNV.BYTES, VkPhysicalDeviceOpticalFlowFeaturesNV.BYTES));
        }
    ...
    public void opticalFlow(@NativeType("VkBool32") @Unsigned int value) {

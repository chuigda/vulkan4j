...
public record VkCopyMemoryToImageInfo(@NotNull MemorySegment segment) implements IVkCopyMemoryToImageInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyMemoryToImageInfo, Iterable<VkCopyMemoryToImageInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCopyMemoryToImageInfo.BYTES, VkCopyMemoryToImageInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkCopyMemoryToImageInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkCopyMemoryToImageInfo.BYTES) > 0;
            }
    ...
    public void pRegions(@Nullable IVkMemoryToImageCopy value) {

...
public record VkScreenSurfaceCreateInfoQNX(@NotNull MemorySegment segment) implements IVkScreenSurfaceCreateInfoQNX {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkScreenSurfaceCreateInfoQNX {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkScreenSurfaceCreateInfoQNX.BYTES, VkScreenSurfaceCreateInfoQNX.BYTES));
        }

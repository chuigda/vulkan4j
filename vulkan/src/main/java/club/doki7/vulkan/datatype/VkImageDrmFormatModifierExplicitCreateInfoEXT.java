...
///
/// The {@code allocate} ({@link VkImageDrmFormatModifierExplicitCreateInfoEXT#allocate(Arena)}, {@link VkImageDrmFormatModifierExplicitCreateInfoEXT#allocate(Arena, int)})

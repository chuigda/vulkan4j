...
public record VkXlibSurfaceCreateInfoKHR(@NotNull MemorySegment segment) implements IVkXlibSurfaceCreateInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkXlibSurfaceCreateInfoKHR, Iterable<VkXlibSurfaceCreateInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkXlibSurfaceCreateInfoKHR.BYTES, VkXlibSurfaceCreateInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkXlibSurfaceCreateInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkXlibSurfaceCreateInfoKHR.BYTES) > 0;
            }

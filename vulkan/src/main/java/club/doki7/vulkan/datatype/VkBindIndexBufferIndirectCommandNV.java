...
public record VkBindIndexBufferIndirectCommandNV(@NotNull MemorySegment segment) implements IVkBindIndexBufferIndirectCommandNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkBindIndexBufferIndirectCommandNV, Iterable<VkBindIndexBufferIndirectCommandNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBindIndexBufferIndirectCommandNV.BYTES, VkBindIndexBufferIndirectCommandNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkBindIndexBufferIndirectCommandNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkBindIndexBufferIndirectCommandNV.BYTES) > 0;
            }

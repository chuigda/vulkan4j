...
public record VkIndirectExecutionSetCreateInfoEXT(@NotNull MemorySegment segment) implements IVkIndirectExecutionSetCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkIndirectExecutionSetCreateInfoEXT, Iterable<VkIndirectExecutionSetCreateInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkIndirectExecutionSetCreateInfoEXT.BYTES, VkIndirectExecutionSetCreateInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkIndirectExecutionSetCreateInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkIndirectExecutionSetCreateInfoEXT.BYTES) > 0;
            }

...
public record VkDisplayEventInfoEXT(@NotNull MemorySegment segment) implements IVkDisplayEventInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDisplayEventInfoEXT, Iterable<VkDisplayEventInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDisplayEventInfoEXT.BYTES, VkDisplayEventInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDisplayEventInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDisplayEventInfoEXT.BYTES) > 0;
            }

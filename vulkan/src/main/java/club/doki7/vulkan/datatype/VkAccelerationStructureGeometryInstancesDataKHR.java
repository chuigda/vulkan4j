...
///
/// The {@code allocate} ({@link VkAccelerationStructureGeometryInstancesDataKHR#allocate(Arena)}, {@link VkAccelerationStructureGeometryInstancesDataKHR#allocate(Arena, int)})

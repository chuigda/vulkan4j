...
public record VkPhysicalDeviceVideoMaintenance2FeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVideoMaintenance2FeaturesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVideoMaintenance2FeaturesKHR, Iterable<VkPhysicalDeviceVideoMaintenance2FeaturesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceVideoMaintenance2FeaturesKHR.BYTES, VkPhysicalDeviceVideoMaintenance2FeaturesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceVideoMaintenance2FeaturesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceVideoMaintenance2FeaturesKHR.BYTES) > 0;
            }
    ...
    public void videoMaintenance2(@NativeType("VkBool32") @Unsigned int value) {

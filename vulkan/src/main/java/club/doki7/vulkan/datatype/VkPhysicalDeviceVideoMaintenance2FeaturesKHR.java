...
///
/// The {@code allocate} ({@link VkPhysicalDeviceVideoMaintenance2FeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceVideoMaintenance2FeaturesKHR#allocate(Arena, int)})

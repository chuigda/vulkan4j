...
///
/// The {@code allocate} ({@link VkAccelerationStructureGeometrySpheresDataNV#allocate(Arena)}, {@link VkAccelerationStructureGeometrySpheresDataNV#allocate(Arena, int)})

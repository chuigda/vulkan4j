...
public record VkAccelerationStructureGeometrySpheresDataNV(@NotNull MemorySegment segment) implements IVkAccelerationStructureGeometrySpheresDataNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureGeometrySpheresDataNV {
        public long size() {
    ...
    public @Unsigned @NativeType("VkDeviceSize") long radiusStride() {
        return segment.get(LAYOUT$radiusStride, OFFSET$radiusStride);
    }

    public void radiusStride(@Unsigned @NativeType("VkDeviceSize") long value) {

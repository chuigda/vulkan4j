...
public record VkImportSemaphoreFdInfoKHR(@NotNull MemorySegment segment) implements IVkImportSemaphoreFdInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportSemaphoreFdInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImportSemaphoreFdInfoKHR.BYTES, VkImportSemaphoreFdInfoKHR.BYTES));
        }

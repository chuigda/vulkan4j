...
///
/// The {@code allocate} ({@link VkPhysicalDeviceDisplacementMicromapFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceDisplacementMicromapFeaturesNV#allocate(Arena, int)})

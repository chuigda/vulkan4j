...
public record VkSemaphoreGetZirconHandleInfoFUCHSIA(@NotNull MemorySegment segment) implements IVkSemaphoreGetZirconHandleInfoFUCHSIA {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSemaphoreGetZirconHandleInfoFUCHSIA, Iterable<VkSemaphoreGetZirconHandleInfoFUCHSIA> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSemaphoreGetZirconHandleInfoFUCHSIA.BYTES, VkSemaphoreGetZirconHandleInfoFUCHSIA.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSemaphoreGetZirconHandleInfoFUCHSIA> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSemaphoreGetZirconHandleInfoFUCHSIA.BYTES) > 0;
            }

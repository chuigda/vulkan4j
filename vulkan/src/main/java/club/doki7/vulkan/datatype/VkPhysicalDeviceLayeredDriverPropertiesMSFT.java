...
public record VkPhysicalDeviceLayeredDriverPropertiesMSFT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLayeredDriverPropertiesMSFT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLayeredDriverPropertiesMSFT, Iterable<VkPhysicalDeviceLayeredDriverPropertiesMSFT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceLayeredDriverPropertiesMSFT.BYTES, VkPhysicalDeviceLayeredDriverPropertiesMSFT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceLayeredDriverPropertiesMSFT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceLayeredDriverPropertiesMSFT.BYTES) > 0;
            }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT#allocate(Arena, int)})

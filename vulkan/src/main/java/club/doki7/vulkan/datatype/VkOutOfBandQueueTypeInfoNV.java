...
public record VkOutOfBandQueueTypeInfoNV(@NotNull MemorySegment segment) implements IVkOutOfBandQueueTypeInfoNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkOutOfBandQueueTypeInfoNV, Iterable<VkOutOfBandQueueTypeInfoNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkOutOfBandQueueTypeInfoNV.BYTES, VkOutOfBandQueueTypeInfoNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkOutOfBandQueueTypeInfoNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkOutOfBandQueueTypeInfoNV.BYTES) > 0;
            }

...
public record VkAccelerationStructureMatrixMotionInstanceNV(@NotNull MemorySegment segment) implements IVkAccelerationStructureMatrixMotionInstanceNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAccelerationStructureMatrixMotionInstanceNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAccelerationStructureMatrixMotionInstanceNV.BYTES, VkAccelerationStructureMatrixMotionInstanceNV.BYTES));
        }

...
///
/// The {@code allocate} ({@link VkVideoEncodeAV1QuantizationMapCapabilitiesKHR#allocate(Arena)}, {@link VkVideoEncodeAV1QuantizationMapCapabilitiesKHR#allocate(Arena, int)})

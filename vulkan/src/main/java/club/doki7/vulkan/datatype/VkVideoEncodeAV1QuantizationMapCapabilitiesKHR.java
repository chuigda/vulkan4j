...
public record VkVideoEncodeAV1QuantizationMapCapabilitiesKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1QuantizationMapCapabilitiesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1QuantizationMapCapabilitiesKHR, Iterable<VkVideoEncodeAV1QuantizationMapCapabilitiesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeAV1QuantizationMapCapabilitiesKHR.BYTES, VkVideoEncodeAV1QuantizationMapCapabilitiesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeAV1QuantizationMapCapabilitiesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeAV1QuantizationMapCapabilitiesKHR.BYTES) > 0;
            }

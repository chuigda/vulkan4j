...
public record VkCommandBufferInheritanceRenderPassTransformInfoQCOM(@NotNull MemorySegment segment) implements IVkCommandBufferInheritanceRenderPassTransformInfoQCOM {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkCommandBufferInheritanceRenderPassTransformInfoQCOM, Iterable<VkCommandBufferInheritanceRenderPassTransformInfoQCOM> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCommandBufferInheritanceRenderPassTransformInfoQCOM.BYTES, VkCommandBufferInheritanceRenderPassTransformInfoQCOM.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkCommandBufferInheritanceRenderPassTransformInfoQCOM> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkCommandBufferInheritanceRenderPassTransformInfoQCOM.BYTES) > 0;
            }

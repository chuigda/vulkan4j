...
///
/// The {@code allocate} ({@link VkCommandBufferInheritanceRenderPassTransformInfoQCOM#allocate(Arena)}, {@link VkCommandBufferInheritanceRenderPassTransformInfoQCOM#allocate(Arena, int)})

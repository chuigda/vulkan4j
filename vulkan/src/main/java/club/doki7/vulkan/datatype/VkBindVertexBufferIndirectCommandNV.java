...
public record VkBindVertexBufferIndirectCommandNV(@NotNull MemorySegment segment) implements IVkBindVertexBufferIndirectCommandNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBindVertexBufferIndirectCommandNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBindVertexBufferIndirectCommandNV.BYTES, VkBindVertexBufferIndirectCommandNV.BYTES));
        }
    ...
    public static VkBindVertexBufferIndirectCommandNV.Ptr allocate(Arena arena, long count) {
        ...
        VkBindVertexBufferIndirectCommandNV.Ptr ret = new VkBindVertexBufferIndirectCommandNV.Ptr(segment);
        return ret;
    }

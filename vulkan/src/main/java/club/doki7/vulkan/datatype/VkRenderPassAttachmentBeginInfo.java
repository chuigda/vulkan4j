...
public record VkRenderPassAttachmentBeginInfo(@NotNull MemorySegment segment) implements IVkRenderPassAttachmentBeginInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderPassAttachmentBeginInfo, Iterable<VkRenderPassAttachmentBeginInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderPassAttachmentBeginInfo.BYTES, VkRenderPassAttachmentBeginInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkRenderPassAttachmentBeginInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkRenderPassAttachmentBeginInfo.BYTES) > 0;
            }

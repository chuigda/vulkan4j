...
public record VkPhysicalDeviceConditionalRenderingFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceConditionalRenderingFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceConditionalRenderingFeaturesEXT, Iterable<VkPhysicalDeviceConditionalRenderingFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceConditionalRenderingFeaturesEXT.BYTES, VkPhysicalDeviceConditionalRenderingFeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceConditionalRenderingFeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceConditionalRenderingFeaturesEXT.BYTES) > 0;
            }

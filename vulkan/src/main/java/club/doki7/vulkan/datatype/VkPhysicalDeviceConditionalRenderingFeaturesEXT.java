...
///
/// The {@code allocate} ({@link VkPhysicalDeviceConditionalRenderingFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceConditionalRenderingFeaturesEXT#allocate(Arena, int)})

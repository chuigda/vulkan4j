...
public record VkPhysicalDeviceLayeredApiPropertiesListKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLayeredApiPropertiesListKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLayeredApiPropertiesListKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceLayeredApiPropertiesListKHR.BYTES, VkPhysicalDeviceLayeredApiPropertiesListKHR.BYTES));
        }

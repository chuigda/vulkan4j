...
public record VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV(@NotNull MemorySegment segment) implements IVkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV.BYTES, VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV.BYTES));
        }

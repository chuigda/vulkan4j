...
///
/// The {@code allocate} ({@link VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV#allocate(Arena)}, {@link VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV#allocate(Arena, int)})

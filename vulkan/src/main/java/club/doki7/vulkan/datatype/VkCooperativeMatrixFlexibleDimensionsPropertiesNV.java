...
///
/// The {@code allocate} ({@link VkCooperativeMatrixFlexibleDimensionsPropertiesNV#allocate(Arena)}, {@link VkCooperativeMatrixFlexibleDimensionsPropertiesNV#allocate(Arena, int)})

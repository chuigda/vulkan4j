...
public record VkDeviceBufferMemoryRequirements(@NotNull MemorySegment segment) implements IVkDeviceBufferMemoryRequirements {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDeviceBufferMemoryRequirements, Iterable<VkDeviceBufferMemoryRequirements> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDeviceBufferMemoryRequirements.BYTES, VkDeviceBufferMemoryRequirements.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDeviceBufferMemoryRequirements> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDeviceBufferMemoryRequirements.BYTES) > 0;
            }

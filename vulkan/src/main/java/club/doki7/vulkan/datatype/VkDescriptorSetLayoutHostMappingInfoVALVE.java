...
public record VkDescriptorSetLayoutHostMappingInfoVALVE(@NotNull MemorySegment segment) implements IVkDescriptorSetLayoutHostMappingInfoVALVE {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDescriptorSetLayoutHostMappingInfoVALVE, Iterable<VkDescriptorSetLayoutHostMappingInfoVALVE> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDescriptorSetLayoutHostMappingInfoVALVE.BYTES, VkDescriptorSetLayoutHostMappingInfoVALVE.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDescriptorSetLayoutHostMappingInfoVALVE> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDescriptorSetLayoutHostMappingInfoVALVE.BYTES) > 0;
            }

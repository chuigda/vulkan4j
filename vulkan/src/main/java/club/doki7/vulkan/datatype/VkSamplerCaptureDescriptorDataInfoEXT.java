...
public record VkSamplerCaptureDescriptorDataInfoEXT(@NotNull MemorySegment segment) implements IVkSamplerCaptureDescriptorDataInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSamplerCaptureDescriptorDataInfoEXT, Iterable<VkSamplerCaptureDescriptorDataInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSamplerCaptureDescriptorDataInfoEXT.BYTES, VkSamplerCaptureDescriptorDataInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSamplerCaptureDescriptorDataInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSamplerCaptureDescriptorDataInfoEXT.BYTES) > 0;
            }

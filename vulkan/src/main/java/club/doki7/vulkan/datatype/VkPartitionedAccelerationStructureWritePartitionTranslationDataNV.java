...
public record VkPartitionedAccelerationStructureWritePartitionTranslationDataNV(@NotNull MemorySegment segment) implements IVkPartitionedAccelerationStructureWritePartitionTranslationDataNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPartitionedAccelerationStructureWritePartitionTranslationDataNV, Iterable<VkPartitionedAccelerationStructureWritePartitionTranslationDataNV> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPartitionedAccelerationStructureWritePartitionTranslationDataNV.BYTES, VkPartitionedAccelerationStructureWritePartitionTranslationDataNV.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPartitionedAccelerationStructureWritePartitionTranslationDataNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPartitionedAccelerationStructureWritePartitionTranslationDataNV.BYTES) > 0;
            }

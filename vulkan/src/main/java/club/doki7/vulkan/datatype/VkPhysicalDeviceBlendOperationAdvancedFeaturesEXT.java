...
///
/// The {@code allocate} ({@link VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT#allocate(Arena, int)})

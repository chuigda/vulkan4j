...
public record VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceBlendOperationAdvancedFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceBlendOperationAdvancedFeaturesEXT, Iterable<VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT.BYTES, VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT.BYTES) > 0;
            }
    ...
    public void advancedBlendCoherentOperations(@NativeType("VkBool32") @Unsigned int value) {

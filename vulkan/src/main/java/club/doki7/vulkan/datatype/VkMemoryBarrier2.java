...
///
/// The {@link VkMemoryBarrier2#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkMemoryBarrier2#autoInit} to initialize these fields manually for
...
public record VkMemoryBarrier2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkMemoryBarrier2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ret[i] = new VkMemoryBarrier2(segment.asSlice(i * BYTES, BYTES));
            ret[i].sType(VkStructureType.MEMORY_BARRIER_2);
        }
        return ret;
    }

...
public record VkMemoryBarrier2(@NotNull MemorySegment segment) implements IVkMemoryBarrier2 {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryBarrier2, Iterable<VkMemoryBarrier2> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMemoryBarrier2.BYTES, VkMemoryBarrier2.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkMemoryBarrier2> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkMemoryBarrier2.BYTES) > 0;
            }

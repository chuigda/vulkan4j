...
public record VkMemoryAllocateFlagsInfo(@NotNull MemorySegment segment) implements IVkMemoryAllocateFlagsInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryAllocateFlagsInfo, Iterable<VkMemoryAllocateFlagsInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMemoryAllocateFlagsInfo.BYTES, VkMemoryAllocateFlagsInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkMemoryAllocateFlagsInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkMemoryAllocateFlagsInfo.BYTES) > 0;
            }

...
public record StdVideoEncodeH264ReferenceInfo(@NotNull MemorySegment segment) implements IStdVideoEncodeH264ReferenceInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IStdVideoEncodeH264ReferenceInfo {
        public long size() {
    ...
    public static StdVideoEncodeH264ReferenceInfo.Ptr allocate(Arena arena, long count) {
        ...
        StdVideoEncodeH264ReferenceInfo.Ptr ret = new StdVideoEncodeH264ReferenceInfo.Ptr(segment);
        return ret;
    }

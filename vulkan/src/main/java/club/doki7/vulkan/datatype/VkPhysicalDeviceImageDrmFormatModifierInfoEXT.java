...
///
/// The {@code allocate} ({@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT#allocate(Arena)}, {@link VkPhysicalDeviceImageDrmFormatModifierInfoEXT#allocate(Arena, int)})

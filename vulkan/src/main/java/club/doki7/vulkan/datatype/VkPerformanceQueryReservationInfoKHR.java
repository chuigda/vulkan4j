...
public record VkPerformanceQueryReservationInfoKHR(@NotNull MemorySegment segment) implements IVkPerformanceQueryReservationInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPerformanceQueryReservationInfoKHR, Iterable<VkPerformanceQueryReservationInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPerformanceQueryReservationInfoKHR.BYTES, VkPerformanceQueryReservationInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPerformanceQueryReservationInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPerformanceQueryReservationInfoKHR.BYTES) > 0;
            }

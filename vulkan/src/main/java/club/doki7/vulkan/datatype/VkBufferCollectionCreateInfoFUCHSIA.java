...
public record VkBufferCollectionCreateInfoFUCHSIA(@NotNull MemorySegment segment) implements IVkBufferCollectionCreateInfoFUCHSIA {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkBufferCollectionCreateInfoFUCHSIA, Iterable<VkBufferCollectionCreateInfoFUCHSIA> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBufferCollectionCreateInfoFUCHSIA.BYTES, VkBufferCollectionCreateInfoFUCHSIA.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkBufferCollectionCreateInfoFUCHSIA> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkBufferCollectionCreateInfoFUCHSIA.BYTES) > 0;
            }
    ...
    public void collectionToken(@NativeType("zx_handle_t") @Unsigned int value) {

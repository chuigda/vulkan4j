...
public record VkMemoryGetFdInfoKHR(@NotNull MemorySegment segment) implements IVkMemoryGetFdInfoKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkMemoryGetFdInfoKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMemoryGetFdInfoKHR.BYTES, VkMemoryGetFdInfoKHR.BYTES));
        }

...
public record VkPerformanceValueINTEL(@NotNull MemorySegment segment) implements IVkPerformanceValueINTEL {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPerformanceValueINTEL {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPerformanceValueINTEL.BYTES, VkPerformanceValueINTEL.BYTES));
        }
    ...
    public static VkPerformanceValueINTEL.Ptr allocate(Arena arena, long count) {
        ...
        VkPerformanceValueINTEL.Ptr ret = new VkPerformanceValueINTEL.Ptr(segment);
        return ret;
    }

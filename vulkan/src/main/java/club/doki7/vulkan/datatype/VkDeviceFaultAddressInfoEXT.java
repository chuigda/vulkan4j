...
public record VkDeviceFaultAddressInfoEXT(@NotNull MemorySegment segment) implements IVkDeviceFaultAddressInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkDeviceFaultAddressInfoEXT {
        public long size() {
    ...
    public static VkDeviceFaultAddressInfoEXT.Ptr allocate(Arena arena, long count) {
        ...
        VkDeviceFaultAddressInfoEXT.Ptr ret = new VkDeviceFaultAddressInfoEXT.Ptr(segment);

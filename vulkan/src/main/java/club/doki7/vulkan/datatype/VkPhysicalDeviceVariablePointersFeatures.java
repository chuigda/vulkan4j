...
///
/// The {@code allocate} ({@link VkPhysicalDeviceVariablePointersFeatures#allocate(Arena)}, {@link VkPhysicalDeviceVariablePointersFeatures#allocate(Arena, int)})
...
public record VkPhysicalDeviceVariablePointersFeatures(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceVariablePointersFeatures[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES);
        }
        return ret;
    }

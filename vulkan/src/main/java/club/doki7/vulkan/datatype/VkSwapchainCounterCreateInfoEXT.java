...
public record VkSwapchainCounterCreateInfoEXT(@NotNull MemorySegment segment) implements IVkSwapchainCounterCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSwapchainCounterCreateInfoEXT, Iterable<VkSwapchainCounterCreateInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSwapchainCounterCreateInfoEXT.BYTES, VkSwapchainCounterCreateInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSwapchainCounterCreateInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSwapchainCounterCreateInfoEXT.BYTES) > 0;
            }

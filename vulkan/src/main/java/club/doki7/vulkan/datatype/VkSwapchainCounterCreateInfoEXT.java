...
///
/// The {@link VkSwapchainCounterCreateInfoEXT#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkSwapchainCounterCreateInfoEXT#autoInit} to initialize these fields manually for
...
public record VkSwapchainCounterCreateInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static final PathElement PATH$surfaceCounters = PathElement.groupElement("PATH$surfaceCounters");

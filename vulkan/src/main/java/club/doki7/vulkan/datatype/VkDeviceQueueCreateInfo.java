...
public record VkDeviceQueueCreateInfo(@NotNull MemorySegment segment) implements IVkDeviceQueueCreateInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkDeviceQueueCreateInfo, Iterable<VkDeviceQueueCreateInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkDeviceQueueCreateInfo.BYTES, VkDeviceQueueCreateInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkDeviceQueueCreateInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkDeviceQueueCreateInfo.BYTES) > 0;
            }

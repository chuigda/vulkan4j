...
public record VkPhysicalDeviceMapMemoryPlacedPropertiesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMapMemoryPlacedPropertiesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceMapMemoryPlacedPropertiesEXT, Iterable<VkPhysicalDeviceMapMemoryPlacedPropertiesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceMapMemoryPlacedPropertiesEXT.BYTES, VkPhysicalDeviceMapMemoryPlacedPropertiesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceMapMemoryPlacedPropertiesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceMapMemoryPlacedPropertiesEXT.BYTES) > 0;
            }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceMapMemoryPlacedPropertiesEXT#allocate(Arena)}, {@link VkPhysicalDeviceMapMemoryPlacedPropertiesEXT#allocate(Arena, int)})

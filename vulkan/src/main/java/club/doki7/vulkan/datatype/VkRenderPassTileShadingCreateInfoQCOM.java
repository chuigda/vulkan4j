...
///
/// The {@code allocate} ({@link VkRenderPassTileShadingCreateInfoQCOM#allocate(Arena)}, {@link VkRenderPassTileShadingCreateInfoQCOM#allocate(Arena, int)})
...
public record VkRenderPassTileShadingCreateInfoQCOM(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkRenderPassTileShadingCreateInfoQCOM[] clone(Arena arena, VkRenderPassTileShadingCreateInfoQCOM[] src) {
        VkRenderPassTileShadingCreateInfoQCOM[] ret = allocate(arena, src.length);

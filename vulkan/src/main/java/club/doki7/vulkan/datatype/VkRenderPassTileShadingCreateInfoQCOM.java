...
///
/// The {@code allocate} ({@link VkRenderPassTileShadingCreateInfoQCOM#allocate(Arena)}, {@link VkRenderPassTileShadingCreateInfoQCOM#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkRenderPassTileShadingCreateInfoQCOM#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkRenderPassTileShadingCreateInfoQCOM(@NotNull MemorySegment segment) implements IVkRenderPassTileShadingCreateInfoQCOM {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkRenderPassTileShadingCreateInfoQCOM.html"><code>VkRenderPassTileShadingCreateInfoQCOM</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkRenderPassTileShadingCreateInfoQCOM}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkRenderPassTileShadingCreateInfoQCOM to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkRenderPassTileShadingCreateInfoQCOM.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderPassTileShadingCreateInfoQCOM, Iterable<VkRenderPassTileShadingCreateInfoQCOM> {
        public long size() {
            return segment.byteSize() / VkRenderPassTileShadingCreateInfoQCOM.BYTES;
        }
        ...
        public @NotNull VkRenderPassTileShadingCreateInfoQCOM at(long index) {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderPassTileShadingCreateInfoQCOM.BYTES, VkRenderPassTileShadingCreateInfoQCOM.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkRenderPassTileShadingCreateInfoQCOM.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkRenderPassTileShadingCreateInfoQCOM.BYTES,
                (end - start) * VkRenderPassTileShadingCreateInfoQCOM.BYTES
            ));
        }
        ...
        public static final class Iter implements Iterator<VkRenderPassTileShadingCreateInfoQCOM> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkRenderPassTileShadingCreateInfoQCOM.BYTES) > 0;
            }

            @Override
            public VkRenderPassTileShadingCreateInfoQCOM next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkRenderPassTileShadingCreateInfoQCOM ret = new VkRenderPassTileShadingCreateInfoQCOM(segment.asSlice(0, VkRenderPassTileShadingCreateInfoQCOM.BYTES));
                segment = segment.asSlice(VkRenderPassTileShadingCreateInfoQCOM.BYTES);
                return ret;
            }
    ...
    public static VkRenderPassTileShadingCreateInfoQCOM.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkRenderPassTileShadingCreateInfoQCOM.Ptr ret = new VkRenderPassTileShadingCreateInfoQCOM.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.RENDER_PASS_TILE_SHADING_CREATE_INFO_QCOM);
        }
        return ret;
    }

    public static VkRenderPassTileShadingCreateInfoQCOM clone(Arena arena, VkRenderPassTileShadingCreateInfoQCOM src) {
        VkRenderPassTileShadingCreateInfoQCOM ret = allocate(arena);
    ...
    public static final PathElement PATH$tileApronSize = PathElement.groupElement("tileApronSize");

...
public record VkSwapchainPresentModesCreateInfoEXT(@NotNull MemorySegment segment) implements IVkSwapchainPresentModesCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSwapchainPresentModesCreateInfoEXT, Iterable<VkSwapchainPresentModesCreateInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSwapchainPresentModesCreateInfoEXT.BYTES, VkSwapchainPresentModesCreateInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSwapchainPresentModesCreateInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSwapchainPresentModesCreateInfoEXT.BYTES) > 0;
            }

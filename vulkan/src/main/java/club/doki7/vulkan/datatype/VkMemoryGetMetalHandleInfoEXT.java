...
///
/// The {@code allocate} ({@link VkMemoryGetMetalHandleInfoEXT#allocate(Arena)}, {@link VkMemoryGetMetalHandleInfoEXT#allocate(Arena, int)})
...
public record VkMemoryGetMetalHandleInfoEXT(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkMemoryGetMetalHandleInfoEXT[] clone(Arena arena, VkMemoryGetMetalHandleInfoEXT[] src) {
        VkMemoryGetMetalHandleInfoEXT[] ret = allocate(arena, src.length);

...
///
/// The {@code allocate} ({@link VkWriteDescriptorSetAccelerationStructureKHR#allocate(Arena)}, {@link VkWriteDescriptorSetAccelerationStructureKHR#allocate(Arena, int)})

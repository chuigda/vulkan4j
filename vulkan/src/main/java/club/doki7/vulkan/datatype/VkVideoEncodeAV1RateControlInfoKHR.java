...
public record VkVideoEncodeAV1RateControlInfoKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1RateControlInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeAV1RateControlInfoKHR, Iterable<VkVideoEncodeAV1RateControlInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeAV1RateControlInfoKHR.BYTES, VkVideoEncodeAV1RateControlInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeAV1RateControlInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeAV1RateControlInfoKHR.BYTES) > 0;
            }

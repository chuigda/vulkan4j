...
public record VkPipelineRasterizationStateRasterizationOrderAMD(@NotNull MemorySegment segment) implements IVkPipelineRasterizationStateRasterizationOrderAMD {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineRasterizationStateRasterizationOrderAMD {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineRasterizationStateRasterizationOrderAMD.BYTES, VkPipelineRasterizationStateRasterizationOrderAMD.BYTES));
        }

...
public record VkRenderPassStripeInfoARM(@NotNull MemorySegment segment) implements IVkRenderPassStripeInfoARM {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderPassStripeInfoARM {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderPassStripeInfoARM.BYTES, VkRenderPassStripeInfoARM.BYTES));
        }

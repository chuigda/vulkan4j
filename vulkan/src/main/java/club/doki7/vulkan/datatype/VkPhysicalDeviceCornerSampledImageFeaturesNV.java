...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCornerSampledImageFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceCornerSampledImageFeaturesNV#allocate(Arena, int)})

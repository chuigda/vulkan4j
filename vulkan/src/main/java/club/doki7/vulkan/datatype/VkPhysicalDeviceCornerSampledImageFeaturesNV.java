...
public record VkPhysicalDeviceCornerSampledImageFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCornerSampledImageFeaturesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCornerSampledImageFeaturesNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceCornerSampledImageFeaturesNV.BYTES, VkPhysicalDeviceCornerSampledImageFeaturesNV.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int cornerSampledImage() {
        return segment.get(LAYOUT$cornerSampledImage, OFFSET$cornerSampledImage);
    }

    public void cornerSampledImage(@Unsigned @NativeType("VkBool32") int value) {

...
public record VkMicromapVersionInfoEXT(@NotNull MemorySegment segment) implements IVkMicromapVersionInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkMicromapVersionInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMicromapVersionInfoEXT.BYTES, VkMicromapVersionInfoEXT.BYTES));
        }

...
///     VkBool32 inheritedViewportScissor2D; // @link substring="inheritedViewportScissor2D" target="#inheritedViewportScissor2D"
...
///
/// The {@code allocate} ({@link VkPhysicalDeviceInheritedViewportScissorFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceInheritedViewportScissorFeaturesNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkPhysicalDeviceInheritedViewportScissorFeaturesNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkPhysicalDeviceInheritedViewportScissorFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceInheritedViewportScissorFeaturesNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceInheritedViewportScissorFeaturesNV.html"><code>VkPhysicalDeviceInheritedViewportScissorFeaturesNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkPhysicalDeviceInheritedViewportScissorFeaturesNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkPhysicalDeviceInheritedViewportScissorFeaturesNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkPhysicalDeviceInheritedViewportScissorFeaturesNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceInheritedViewportScissorFeaturesNV {
        ...
        public @NotNull VkPhysicalDeviceInheritedViewportScissorFeaturesNV at(long index) {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceInheritedViewportScissorFeaturesNV.BYTES, VkPhysicalDeviceInheritedViewportScissorFeaturesNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkPhysicalDeviceInheritedViewportScissorFeaturesNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkPhysicalDeviceInheritedViewportScissorFeaturesNV.BYTES,
                (end - start) * VkPhysicalDeviceInheritedViewportScissorFeaturesNV.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkPhysicalDeviceInheritedViewportScissorFeaturesNV.BYTES));
        }

        public VkPhysicalDeviceInheritedViewportScissorFeaturesNV[] toArray() {
            VkPhysicalDeviceInheritedViewportScissorFeaturesNV[] ret = new VkPhysicalDeviceInheritedViewportScissorFeaturesNV[(int) size()];
    ...
    public static VkPhysicalDeviceInheritedViewportScissorFeaturesNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkPhysicalDeviceInheritedViewportScissorFeaturesNV.Ptr ret = new VkPhysicalDeviceInheritedViewportScissorFeaturesNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.PHYSICAL_DEVICE_INHERITED_VIEWPORT_SCISSOR_FEATURES_NV);
        }
        return ret;
    }

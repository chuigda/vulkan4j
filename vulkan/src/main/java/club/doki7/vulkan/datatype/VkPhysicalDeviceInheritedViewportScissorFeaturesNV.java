...
///
/// The {@code allocate} ({@link VkPhysicalDeviceInheritedViewportScissorFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceInheritedViewportScissorFeaturesNV#allocate(Arena, int)})

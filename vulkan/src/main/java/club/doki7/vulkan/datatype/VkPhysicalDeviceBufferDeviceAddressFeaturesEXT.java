...
public record VkPhysicalDeviceBufferDeviceAddressFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceBufferDeviceAddressFeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceBufferDeviceAddressFeaturesEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceBufferDeviceAddressFeaturesEXT.BYTES, VkPhysicalDeviceBufferDeviceAddressFeaturesEXT.BYTES));
        }

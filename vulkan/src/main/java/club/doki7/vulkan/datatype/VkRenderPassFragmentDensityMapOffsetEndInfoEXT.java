...
public record VkRenderPassFragmentDensityMapOffsetEndInfoEXT(@NotNull MemorySegment segment) implements IVkRenderPassFragmentDensityMapOffsetEndInfoEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderPassFragmentDensityMapOffsetEndInfoEXT {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderPassFragmentDensityMapOffsetEndInfoEXT.BYTES, VkRenderPassFragmentDensityMapOffsetEndInfoEXT.BYTES));
        }

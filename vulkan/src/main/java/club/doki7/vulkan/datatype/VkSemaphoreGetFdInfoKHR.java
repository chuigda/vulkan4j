...
public record VkSemaphoreGetFdInfoKHR(@NotNull MemorySegment segment) implements IVkSemaphoreGetFdInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkSemaphoreGetFdInfoKHR, Iterable<VkSemaphoreGetFdInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSemaphoreGetFdInfoKHR.BYTES, VkSemaphoreGetFdInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkSemaphoreGetFdInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkSemaphoreGetFdInfoKHR.BYTES) > 0;
            }

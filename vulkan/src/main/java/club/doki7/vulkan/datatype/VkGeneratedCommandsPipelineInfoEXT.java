...
public record VkGeneratedCommandsPipelineInfoEXT(@NotNull MemorySegment segment) implements IVkGeneratedCommandsPipelineInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkGeneratedCommandsPipelineInfoEXT, Iterable<VkGeneratedCommandsPipelineInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkGeneratedCommandsPipelineInfoEXT.BYTES, VkGeneratedCommandsPipelineInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkGeneratedCommandsPipelineInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkGeneratedCommandsPipelineInfoEXT.BYTES) > 0;
            }

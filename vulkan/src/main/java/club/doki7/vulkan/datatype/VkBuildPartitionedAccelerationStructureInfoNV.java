...
///
/// The {@code allocate} ({@link VkBuildPartitionedAccelerationStructureInfoNV#allocate(Arena)}, {@link VkBuildPartitionedAccelerationStructureInfoNV#allocate(Arena, int)})

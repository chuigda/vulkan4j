...
public record VkPhysicalDeviceSubpassShadingFeaturesHUAWEI(@NotNull MemorySegment segment) implements IVkPhysicalDeviceSubpassShadingFeaturesHUAWEI {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceSubpassShadingFeaturesHUAWEI {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceSubpassShadingFeaturesHUAWEI.BYTES, VkPhysicalDeviceSubpassShadingFeaturesHUAWEI.BYTES));
        }

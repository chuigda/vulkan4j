...
///
/// The {@code allocate} ({@link VkPhysicalDeviceSubpassShadingFeaturesHUAWEI#allocate(Arena)}, {@link VkPhysicalDeviceSubpassShadingFeaturesHUAWEI#allocate(Arena, int)})

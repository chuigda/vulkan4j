...
public record VkSubpassDependency2(@NotNull MemorySegment segment) implements IVkSubpassDependency2 {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSubpassDependency2 {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSubpassDependency2.BYTES, VkSubpassDependency2.BYTES));
        }

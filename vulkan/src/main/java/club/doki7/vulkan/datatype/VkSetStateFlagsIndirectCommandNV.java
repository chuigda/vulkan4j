...
public record VkSetStateFlagsIndirectCommandNV(@NotNull MemorySegment segment) implements IVkSetStateFlagsIndirectCommandNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSetStateFlagsIndirectCommandNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSetStateFlagsIndirectCommandNV.BYTES, VkSetStateFlagsIndirectCommandNV.BYTES));
        }

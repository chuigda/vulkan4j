...
public record VkPhysicalDeviceExternalSciSyncFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalSciSyncFeaturesNV {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalSciSyncFeaturesNV {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceExternalSciSyncFeaturesNV.BYTES, VkPhysicalDeviceExternalSciSyncFeaturesNV.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int sciSyncSemaphore() {
        return segment.get(LAYOUT$sciSyncSemaphore, OFFSET$sciSyncSemaphore);
    }

    public void sciSyncSemaphore(@Unsigned @NativeType("VkBool32") int value) {

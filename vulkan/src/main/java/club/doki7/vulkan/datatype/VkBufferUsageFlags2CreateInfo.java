...
public record VkBufferUsageFlags2CreateInfo(@NotNull MemorySegment segment) implements IVkBufferUsageFlags2CreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkBufferUsageFlags2CreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkBufferUsageFlags2CreateInfo.BYTES, VkBufferUsageFlags2CreateInfo.BYTES));
        }

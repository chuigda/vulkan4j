...
public record VkPhysicalDeviceConservativeRasterizationPropertiesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceConservativeRasterizationPropertiesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceConservativeRasterizationPropertiesEXT {
        public long size() {

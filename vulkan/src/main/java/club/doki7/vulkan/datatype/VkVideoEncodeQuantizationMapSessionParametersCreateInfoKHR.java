...
///
/// The {@link VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR#autoInit} to initialize these fields manually for
...
public record VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.VIDEO_ENCODE_QUANTIZATION_MAP_SESSION_PARAMETERS_CREATE_INFO_KHR);
        }
        return ret;
    }

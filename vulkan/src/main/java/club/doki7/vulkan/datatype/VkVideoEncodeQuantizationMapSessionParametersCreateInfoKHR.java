...
///
/// The {@code allocate} ({@link VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR#allocate(Arena)}, {@link VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR#allocate(Arena, int)})

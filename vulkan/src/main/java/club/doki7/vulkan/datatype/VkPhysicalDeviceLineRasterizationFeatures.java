...
public record VkPhysicalDeviceLineRasterizationFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLineRasterizationFeatures {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceLineRasterizationFeatures, Iterable<VkPhysicalDeviceLineRasterizationFeatures> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceLineRasterizationFeatures.BYTES, VkPhysicalDeviceLineRasterizationFeatures.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceLineRasterizationFeatures> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceLineRasterizationFeatures.BYTES) > 0;
            }

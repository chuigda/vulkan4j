...
public record VkImageAlignmentControlCreateInfoMESA(@NotNull MemorySegment segment) implements IVkImageAlignmentControlCreateInfoMESA {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkImageAlignmentControlCreateInfoMESA {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImageAlignmentControlCreateInfoMESA.BYTES, VkImageAlignmentControlCreateInfoMESA.BYTES));
        }

...
public record VkCooperativeMatrixPropertiesKHR(@NotNull MemorySegment segment) implements IVkCooperativeMatrixPropertiesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCooperativeMatrixPropertiesKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCooperativeMatrixPropertiesKHR.BYTES, VkCooperativeMatrixPropertiesKHR.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int saturatingAccumulation() {
        return segment.get(LAYOUT$saturatingAccumulation, OFFSET$saturatingAccumulation);
    }

    public void saturatingAccumulation(@Unsigned @NativeType("VkBool32") int value) {

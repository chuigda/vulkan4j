...
public record VkVideoSessionParametersCreateInfoKHR(@NotNull MemorySegment segment) implements IVkVideoSessionParametersCreateInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoSessionParametersCreateInfoKHR, Iterable<VkVideoSessionParametersCreateInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoSessionParametersCreateInfoKHR.BYTES, VkVideoSessionParametersCreateInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoSessionParametersCreateInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoSessionParametersCreateInfoKHR.BYTES) > 0;
            }

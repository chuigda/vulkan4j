...
///
/// The {@link VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR#autoInit} to initialize these fields manually for
...
public record VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.PHYSICAL_DEVICE_SHADER_RELAXED_EXTENDED_INSTRUCTION_FEATURES_KHR);
        }
        return ret;
    }

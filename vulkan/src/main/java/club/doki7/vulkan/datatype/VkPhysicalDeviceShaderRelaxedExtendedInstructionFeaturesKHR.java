...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR#allocate(Arena, int)})

...
public record VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR.BYTES, VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int shaderRelaxedExtendedInstruction() {
        return segment.get(LAYOUT$shaderRelaxedExtendedInstruction, OFFSET$shaderRelaxedExtendedInstruction);
    }

    public void shaderRelaxedExtendedInstruction(@Unsigned @NativeType("VkBool32") int value) {

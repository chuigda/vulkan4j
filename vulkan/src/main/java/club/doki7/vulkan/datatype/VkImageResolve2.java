...
///
/// The {@link VkImageResolve2#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkImageResolve2#autoInit} to initialize these fields manually for
...
public record VkImageResolve2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkImageResolve2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.IMAGE_RESOLVE_2);
        }
        return ret;
    }

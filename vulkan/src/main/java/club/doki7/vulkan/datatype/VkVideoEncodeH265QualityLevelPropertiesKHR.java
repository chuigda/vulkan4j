...
public record VkVideoEncodeH265QualityLevelPropertiesKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH265QualityLevelPropertiesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH265QualityLevelPropertiesKHR, Iterable<VkVideoEncodeH265QualityLevelPropertiesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeH265QualityLevelPropertiesKHR.BYTES, VkVideoEncodeH265QualityLevelPropertiesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkVideoEncodeH265QualityLevelPropertiesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkVideoEncodeH265QualityLevelPropertiesKHR.BYTES) > 0;
            }

...
///
/// The {@link VkSparseImageMemoryRequirements2#allocate} functions will automatically initialize these fields.
/// Also, you may call {@link VkSparseImageMemoryRequirements2#autoInit} to initialize these fields manually for
...
public record VkSparseImageMemoryRequirements2(@NotNull MemorySegment segment) implements IPointer {
    ...
    public static VkSparseImageMemoryRequirements2[] allocate(Arena arena, int count) {
        ...
        for (int i = 0; i < count; i ++) {
            ...
            ret[i].sType(VkStructureType.SPARSE_IMAGE_MEMORY_REQUIREMENTS_2);
        }
        return ret;
    }

...
public record VkPhysicalDeviceBufferDeviceAddressFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceBufferDeviceAddressFeatures {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceBufferDeviceAddressFeatures, Iterable<VkPhysicalDeviceBufferDeviceAddressFeatures> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceBufferDeviceAddressFeatures.BYTES, VkPhysicalDeviceBufferDeviceAddressFeatures.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceBufferDeviceAddressFeatures> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceBufferDeviceAddressFeatures.BYTES) > 0;
            }

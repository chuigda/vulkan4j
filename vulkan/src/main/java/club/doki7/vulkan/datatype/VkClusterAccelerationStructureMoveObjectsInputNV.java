...
///
/// The {@code allocate} ({@link VkClusterAccelerationStructureMoveObjectsInputNV#allocate(Arena)}, {@link VkClusterAccelerationStructureMoveObjectsInputNV#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkClusterAccelerationStructureMoveObjectsInputNV#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkClusterAccelerationStructureMoveObjectsInputNV(@NotNull MemorySegment segment) implements IVkClusterAccelerationStructureMoveObjectsInputNV {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkClusterAccelerationStructureMoveObjectsInputNV.html"><code>VkClusterAccelerationStructureMoveObjectsInputNV</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkClusterAccelerationStructureMoveObjectsInputNV}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkClusterAccelerationStructureMoveObjectsInputNV to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkClusterAccelerationStructureMoveObjectsInputNV.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkClusterAccelerationStructureMoveObjectsInputNV, Iterable<VkClusterAccelerationStructureMoveObjectsInputNV> {
        public long size() {
            return segment.byteSize() / VkClusterAccelerationStructureMoveObjectsInputNV.BYTES;
        }
        ...
        public @NotNull VkClusterAccelerationStructureMoveObjectsInputNV at(long index) {
        ...
        public void write(long index, @NotNull VkClusterAccelerationStructureMoveObjectsInputNV value) {
            MemorySegment s = segment.asSlice(index * VkClusterAccelerationStructureMoveObjectsInputNV.BYTES, VkClusterAccelerationStructureMoveObjectsInputNV.BYTES);
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkClusterAccelerationStructureMoveObjectsInputNV.BYTES, VkClusterAccelerationStructureMoveObjectsInputNV.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkClusterAccelerationStructureMoveObjectsInputNV.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkClusterAccelerationStructureMoveObjectsInputNV.BYTES,
                (end - start) * VkClusterAccelerationStructureMoveObjectsInputNV.BYTES
            ));
        }
        ...
        public static final class Iter implements Iterator<VkClusterAccelerationStructureMoveObjectsInputNV> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkClusterAccelerationStructureMoveObjectsInputNV.BYTES) > 0;
            }

            @Override
            public VkClusterAccelerationStructureMoveObjectsInputNV next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkClusterAccelerationStructureMoveObjectsInputNV ret = new VkClusterAccelerationStructureMoveObjectsInputNV(segment.asSlice(0, VkClusterAccelerationStructureMoveObjectsInputNV.BYTES));
                segment = segment.asSlice(VkClusterAccelerationStructureMoveObjectsInputNV.BYTES);
                return ret;
            }
    ...
    public static VkClusterAccelerationStructureMoveObjectsInputNV.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkClusterAccelerationStructureMoveObjectsInputNV.Ptr ret = new VkClusterAccelerationStructureMoveObjectsInputNV.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.CLUSTER_ACCELERATION_STRUCTURE_MOVE_OBJECTS_INPUT_NV);
        }
        return ret;
    }

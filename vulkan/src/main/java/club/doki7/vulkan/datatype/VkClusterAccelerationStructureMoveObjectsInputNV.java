...
///
/// The {@code allocate} ({@link VkClusterAccelerationStructureMoveObjectsInputNV#allocate(Arena)}, {@link VkClusterAccelerationStructureMoveObjectsInputNV#allocate(Arena, int)})

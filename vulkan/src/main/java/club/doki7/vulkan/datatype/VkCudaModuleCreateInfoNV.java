...
public record VkCudaModuleCreateInfoNV(@NotNull MemorySegment segment) implements IVkCudaModuleCreateInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCudaModuleCreateInfoNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCudaModuleCreateInfoNV.BYTES, VkCudaModuleCreateInfoNV.BYTES));
        }

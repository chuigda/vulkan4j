...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCommandBufferInheritanceFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceCommandBufferInheritanceFeaturesNV#allocate(Arena, int)})

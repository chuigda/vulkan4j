...
///
/// The {@code allocate} ({@link VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV#allocate(Arena, int)})

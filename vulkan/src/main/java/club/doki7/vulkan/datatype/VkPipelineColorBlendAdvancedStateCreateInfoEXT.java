...
public record VkPipelineColorBlendAdvancedStateCreateInfoEXT(@NotNull MemorySegment segment) implements IVkPipelineColorBlendAdvancedStateCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineColorBlendAdvancedStateCreateInfoEXT, Iterable<VkPipelineColorBlendAdvancedStateCreateInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineColorBlendAdvancedStateCreateInfoEXT.BYTES, VkPipelineColorBlendAdvancedStateCreateInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineColorBlendAdvancedStateCreateInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineColorBlendAdvancedStateCreateInfoEXT.BYTES) > 0;
            }

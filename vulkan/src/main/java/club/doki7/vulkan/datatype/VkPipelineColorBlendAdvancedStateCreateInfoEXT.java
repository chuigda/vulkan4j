...
///
/// The {@code allocate} ({@link VkPipelineColorBlendAdvancedStateCreateInfoEXT#allocate(Arena)}, {@link VkPipelineColorBlendAdvancedStateCreateInfoEXT#allocate(Arena, int)})

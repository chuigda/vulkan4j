...
///
/// The {@code allocate} ({@link VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT#allocate(Arena)}, {@link VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT#allocate(Arena, int)})

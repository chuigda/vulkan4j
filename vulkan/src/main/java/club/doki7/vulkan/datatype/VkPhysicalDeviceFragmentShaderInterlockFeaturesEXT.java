...
public record VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentShaderInterlockFeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceFragmentShaderInterlockFeaturesEXT, Iterable<VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT.BYTES, VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT.BYTES));
        }
    ...
    public void fragmentShaderSampleInterlock(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public void fragmentShaderPixelInterlock(@NativeType("VkBool32") @Unsigned int value) {
    ...
    public void fragmentShaderShadingRateInterlock(@NativeType("VkBool32") @Unsigned int value) {

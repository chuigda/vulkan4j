...
public record VkPipelineBinaryCreateInfoKHR(@NotNull MemorySegment segment) implements IVkPipelineBinaryCreateInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineBinaryCreateInfoKHR, Iterable<VkPipelineBinaryCreateInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineBinaryCreateInfoKHR.BYTES, VkPipelineBinaryCreateInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineBinaryCreateInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineBinaryCreateInfoKHR.BYTES) > 0;
            }

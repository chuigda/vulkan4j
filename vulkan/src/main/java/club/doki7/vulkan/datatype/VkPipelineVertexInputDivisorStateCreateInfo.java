...
public record VkPipelineVertexInputDivisorStateCreateInfo(@NotNull MemorySegment segment) implements IVkPipelineVertexInputDivisorStateCreateInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineVertexInputDivisorStateCreateInfo, Iterable<VkPipelineVertexInputDivisorStateCreateInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineVertexInputDivisorStateCreateInfo.BYTES, VkPipelineVertexInputDivisorStateCreateInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPipelineVertexInputDivisorStateCreateInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPipelineVertexInputDivisorStateCreateInfo.BYTES) > 0;
            }

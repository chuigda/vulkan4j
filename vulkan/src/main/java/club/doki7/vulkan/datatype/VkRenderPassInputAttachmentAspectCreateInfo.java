...
public record VkRenderPassInputAttachmentAspectCreateInfo(@NotNull MemorySegment segment) implements IVkRenderPassInputAttachmentAspectCreateInfo {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkRenderPassInputAttachmentAspectCreateInfo, Iterable<VkRenderPassInputAttachmentAspectCreateInfo> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkRenderPassInputAttachmentAspectCreateInfo.BYTES, VkRenderPassInputAttachmentAspectCreateInfo.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkRenderPassInputAttachmentAspectCreateInfo> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkRenderPassInputAttachmentAspectCreateInfo.BYTES) > 0;
            }

...
public record VkSemaphoreSignalInfo(@NotNull MemorySegment segment) implements IVkSemaphoreSignalInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkSemaphoreSignalInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkSemaphoreSignalInfo.BYTES, VkSemaphoreSignalInfo.BYTES));
        }

...
///
/// The {@code allocate} ({@link VkXcbSurfaceCreateInfoKHR#allocate(Arena)}, {@link VkXcbSurfaceCreateInfoKHR#allocate(Arena, long)})
/// functions will automatically initialize these fields. Also, you may call {@link VkXcbSurfaceCreateInfoKHR#autoInit}
...
@ValueBasedCandidate
@UnsafeConstructor
public record VkXcbSurfaceCreateInfoKHR(@NotNull MemorySegment segment) implements IVkXcbSurfaceCreateInfoKHR {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/vulkan/specs/latest/man/html/VkXcbSurfaceCreateInfoKHR.html"><code>VkXcbSurfaceCreateInfoKHR</code></a> structure(s) in native memory.
    ///
    /// Technically speaking, this type has no difference with {@link VkXcbSurfaceCreateInfoKHR}. This type
    /// is introduced mainly for user to distinguish between a pointer to a single structure
    /// and a pointer to (potentially) an array of structure(s). APIs should use interface
    /// IVkXcbSurfaceCreateInfoKHR to handle both types uniformly. See package level documentation for more
    /// details.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    /// ({@code segment != NULL && !segment.equals(MemorySegment.NULL)}), and properly aligned to
    /// {@code VkXcbSurfaceCreateInfoKHR.LAYOUT.byteAlignment()} bytes. To represent null pointer, you may use a Java
    /// {@code null} instead. See the documentation of {@link IPointer#segment()} for more details.
    ///
    /// The constructor of this class is marked as {@link UnsafeConstructor}, because it does not
    /// perform any runtime check. The constructor can be useful for automatic code generators.
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkXcbSurfaceCreateInfoKHR, Iterable<VkXcbSurfaceCreateInfoKHR> {
        public long size() {
            return segment.byteSize() / VkXcbSurfaceCreateInfoKHR.BYTES;
        }
        ...
        public @NotNull VkXcbSurfaceCreateInfoKHR at(long index) {
        ...
        public void write(long index, @NotNull VkXcbSurfaceCreateInfoKHR value) {
            MemorySegment s = segment.asSlice(index * VkXcbSurfaceCreateInfoKHR.BYTES, VkXcbSurfaceCreateInfoKHR.BYTES);
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkXcbSurfaceCreateInfoKHR.BYTES, VkXcbSurfaceCreateInfoKHR.BYTES));
        }

        public @NotNull Ptr offset(long offset) {
            return new Ptr(segment.asSlice(offset * VkXcbSurfaceCreateInfoKHR.BYTES));
        }
        ...
        public @NotNull Ptr slice(long start, long end) {
            return new Ptr(segment.asSlice(
                start * VkXcbSurfaceCreateInfoKHR.BYTES,
                (end - start) * VkXcbSurfaceCreateInfoKHR.BYTES
            ));
        }

        public Ptr slice(long end) {
            return new Ptr(segment.asSlice(0, end * VkXcbSurfaceCreateInfoKHR.BYTES));
        }

        public VkXcbSurfaceCreateInfoKHR[] toArray() {
            VkXcbSurfaceCreateInfoKHR[] ret = new VkXcbSurfaceCreateInfoKHR[(int) size()];
        ...
        public static final class Iter implements Iterator<VkXcbSurfaceCreateInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkXcbSurfaceCreateInfoKHR.BYTES) > 0;
            }

            @Override
            public VkXcbSurfaceCreateInfoKHR next() {
                if (!hasNext()) {
                    throw new NoSuchElementException();
                }
                VkXcbSurfaceCreateInfoKHR ret = new VkXcbSurfaceCreateInfoKHR(segment.asSlice(0, VkXcbSurfaceCreateInfoKHR.BYTES));
                segment = segment.asSlice(VkXcbSurfaceCreateInfoKHR.BYTES);
                return ret;
            }
    ...
    public static VkXcbSurfaceCreateInfoKHR.Ptr allocate(Arena arena, long count) {
        MemorySegment segment = arena.allocate(LAYOUT, count);
        VkXcbSurfaceCreateInfoKHR.Ptr ret = new VkXcbSurfaceCreateInfoKHR.Ptr(segment);
        for (long i = 0; i < count; i++) {
            ret.at(i).sType(VkStructureType.XCB_SURFACE_CREATE_INFO_KHR);
        }
        return ret;
    }

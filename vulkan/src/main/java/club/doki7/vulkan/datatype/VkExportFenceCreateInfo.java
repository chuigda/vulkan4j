...
public record VkExportFenceCreateInfo(@NotNull MemorySegment segment) implements IVkExportFenceCreateInfo {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkExportFenceCreateInfo {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkExportFenceCreateInfo.BYTES, VkExportFenceCreateInfo.BYTES));
        }

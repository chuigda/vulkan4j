...
///
/// The {@code allocate} ({@link VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR#allocate(Arena)}, {@link VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR#allocate(Arena, int)})

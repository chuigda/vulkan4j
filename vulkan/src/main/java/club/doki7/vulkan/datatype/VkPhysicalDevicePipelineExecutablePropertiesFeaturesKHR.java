...
public record VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR, Iterable<VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.BYTES, VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR.BYTES) > 0;
            }
    ...
    public void pipelineExecutableInfo(@NativeType("VkBool32") @Unsigned int value) {

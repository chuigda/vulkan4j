...
public record VkPhysicalDeviceCooperativeMatrixPropertiesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCooperativeMatrixPropertiesKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCooperativeMatrixPropertiesKHR, Iterable<VkPhysicalDeviceCooperativeMatrixPropertiesKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceCooperativeMatrixPropertiesKHR.BYTES, VkPhysicalDeviceCooperativeMatrixPropertiesKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceCooperativeMatrixPropertiesKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceCooperativeMatrixPropertiesKHR.BYTES) > 0;
            }

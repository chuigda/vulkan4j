...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCooperativeMatrixPropertiesKHR#allocate(Arena)}, {@link VkPhysicalDeviceCooperativeMatrixPropertiesKHR#allocate(Arena, int)})

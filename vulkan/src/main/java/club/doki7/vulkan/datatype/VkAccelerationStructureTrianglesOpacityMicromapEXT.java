...
///
/// The {@code allocate} ({@link VkAccelerationStructureTrianglesOpacityMicromapEXT#allocate(Arena)}, {@link VkAccelerationStructureTrianglesOpacityMicromapEXT#allocate(Arena, int)})

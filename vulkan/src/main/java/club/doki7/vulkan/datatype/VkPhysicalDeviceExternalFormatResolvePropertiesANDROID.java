...
///
/// The {@code allocate} ({@link VkPhysicalDeviceExternalFormatResolvePropertiesANDROID#allocate(Arena)}, {@link VkPhysicalDeviceExternalFormatResolvePropertiesANDROID#allocate(Arena, int)})

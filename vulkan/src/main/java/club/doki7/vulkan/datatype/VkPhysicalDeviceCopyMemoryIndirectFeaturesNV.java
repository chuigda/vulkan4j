...
///
/// The {@code allocate} ({@link VkPhysicalDeviceCopyMemoryIndirectFeaturesNV#allocate(Arena)}, {@link VkPhysicalDeviceCopyMemoryIndirectFeaturesNV#allocate(Arena, int)})

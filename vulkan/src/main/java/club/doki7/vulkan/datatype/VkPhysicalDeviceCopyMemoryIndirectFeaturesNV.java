...
public record VkPhysicalDeviceCopyMemoryIndirectFeaturesNV(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCopyMemoryIndirectFeaturesNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceCopyMemoryIndirectFeaturesNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceCopyMemoryIndirectFeaturesNV.BYTES, VkPhysicalDeviceCopyMemoryIndirectFeaturesNV.BYTES));
        }

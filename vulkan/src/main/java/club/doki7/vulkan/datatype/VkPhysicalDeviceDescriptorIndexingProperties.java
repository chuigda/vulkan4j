...
///
/// The {@code allocate} ({@link VkPhysicalDeviceDescriptorIndexingProperties#allocate(Arena)}, {@link VkPhysicalDeviceDescriptorIndexingProperties#allocate(Arena, int)})

...
public record VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT {
        public long size() {
    ...
    public @Unsigned @NativeType("VkBool32") int shaderImageInt64Atomics() {
        return segment.get(LAYOUT$shaderImageInt64Atomics, OFFSET$shaderImageInt64Atomics);
    }

    public void shaderImageInt64Atomics(@Unsigned @NativeType("VkBool32") int value) {
        segment.set(LAYOUT$shaderImageInt64Atomics, OFFSET$shaderImageInt64Atomics, value);
    }

    public @Unsigned @NativeType("VkBool32") int sparseImageInt64Atomics() {
        return segment.get(LAYOUT$sparseImageInt64Atomics, OFFSET$sparseImageInt64Atomics);
    }

    public void sparseImageInt64Atomics(@Unsigned @NativeType("VkBool32") int value) {

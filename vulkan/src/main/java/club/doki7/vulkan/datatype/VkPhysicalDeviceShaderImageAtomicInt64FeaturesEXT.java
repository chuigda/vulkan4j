...
public record VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT, Iterable<VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT.BYTES, VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT.BYTES) > 0;
            }

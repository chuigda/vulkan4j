...
///
/// The {@code allocate} ({@link VkPhysicalDeviceVideoMaintenance1FeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceVideoMaintenance1FeaturesKHR#allocate(Arena, int)})

...
public record VkPhysicalDeviceVideoMaintenance1FeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVideoMaintenance1FeaturesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceVideoMaintenance1FeaturesKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceVideoMaintenance1FeaturesKHR.BYTES, VkPhysicalDeviceVideoMaintenance1FeaturesKHR.BYTES));
        }

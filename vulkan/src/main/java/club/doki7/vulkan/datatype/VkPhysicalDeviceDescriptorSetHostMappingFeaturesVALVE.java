...
///
/// The {@code allocate} ({@link VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE#allocate(Arena)}, {@link VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE#allocate(Arena, int)})

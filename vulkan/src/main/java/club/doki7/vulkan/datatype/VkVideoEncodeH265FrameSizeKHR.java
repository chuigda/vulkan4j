...
public record VkVideoEncodeH265FrameSizeKHR(@NotNull MemorySegment segment) implements IVkVideoEncodeH265FrameSizeKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkVideoEncodeH265FrameSizeKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkVideoEncodeH265FrameSizeKHR.BYTES, VkVideoEncodeH265FrameSizeKHR.BYTES));
        }
    ...
    public static VkVideoEncodeH265FrameSizeKHR.Ptr allocate(Arena arena, long count) {
        ...
        VkVideoEncodeH265FrameSizeKHR.Ptr ret = new VkVideoEncodeH265FrameSizeKHR.Ptr(segment);
        return ret;
    }

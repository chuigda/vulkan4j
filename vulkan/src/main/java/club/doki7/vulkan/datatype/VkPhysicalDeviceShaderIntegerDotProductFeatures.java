...
public record VkPhysicalDeviceShaderIntegerDotProductFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderIntegerDotProductFeatures {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderIntegerDotProductFeatures {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderIntegerDotProductFeatures.BYTES, VkPhysicalDeviceShaderIntegerDotProductFeatures.BYTES));
        }

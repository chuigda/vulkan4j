...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShaderIntegerDotProductFeatures#allocate(Arena)}, {@link VkPhysicalDeviceShaderIntegerDotProductFeatures#allocate(Arena, int)})

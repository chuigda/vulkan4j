...
public record VkCopyDescriptorSet(@NotNull MemorySegment segment) implements IVkCopyDescriptorSet {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkCopyDescriptorSet {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkCopyDescriptorSet.BYTES, VkCopyDescriptorSet.BYTES));
        }

...
public record VkImportFenceWin32HandleInfoKHR(@NotNull MemorySegment segment) implements IVkImportFenceWin32HandleInfoKHR {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkImportFenceWin32HandleInfoKHR, Iterable<VkImportFenceWin32HandleInfoKHR> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkImportFenceWin32HandleInfoKHR.BYTES, VkImportFenceWin32HandleInfoKHR.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkImportFenceWin32HandleInfoKHR> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkImportFenceWin32HandleInfoKHR.BYTES) > 0;
            }

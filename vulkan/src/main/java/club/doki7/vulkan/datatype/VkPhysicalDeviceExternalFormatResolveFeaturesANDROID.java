...
public record VkPhysicalDeviceExternalFormatResolveFeaturesANDROID(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalFormatResolveFeaturesANDROID {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceExternalFormatResolveFeaturesANDROID, Iterable<VkPhysicalDeviceExternalFormatResolveFeaturesANDROID> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceExternalFormatResolveFeaturesANDROID.BYTES, VkPhysicalDeviceExternalFormatResolveFeaturesANDROID.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceExternalFormatResolveFeaturesANDROID> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceExternalFormatResolveFeaturesANDROID.BYTES) > 0;
            }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceExternalFormatResolveFeaturesANDROID#allocate(Arena)}, {@link VkPhysicalDeviceExternalFormatResolveFeaturesANDROID#allocate(Arena, int)})

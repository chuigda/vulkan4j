...
///
/// The {@code allocate} ({@link VkPipelineViewportShadingRateImageStateCreateInfoNV#allocate(Arena)}, {@link VkPipelineViewportShadingRateImageStateCreateInfoNV#allocate(Arena, int)})

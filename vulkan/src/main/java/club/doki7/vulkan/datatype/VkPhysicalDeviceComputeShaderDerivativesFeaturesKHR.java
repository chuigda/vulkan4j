...
///
/// The {@code allocate} ({@link VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR#allocate(Arena, int)})

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShaderQuadControlFeaturesKHR#allocate(Arena)}, {@link VkPhysicalDeviceShaderQuadControlFeaturesKHR#allocate(Arena, int)})

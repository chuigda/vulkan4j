...
public record VkPhysicalDeviceShaderQuadControlFeaturesKHR(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderQuadControlFeaturesKHR {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderQuadControlFeaturesKHR {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderQuadControlFeaturesKHR.BYTES, VkPhysicalDeviceShaderQuadControlFeaturesKHR.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int shaderQuadControl() {
        return segment.get(LAYOUT$shaderQuadControl, OFFSET$shaderQuadControl);
    }

    public void shaderQuadControl(@Unsigned @NativeType("VkBool32") int value) {

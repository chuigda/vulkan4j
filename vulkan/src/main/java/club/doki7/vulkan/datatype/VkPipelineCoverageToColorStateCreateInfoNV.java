...
public record VkPipelineCoverageToColorStateCreateInfoNV(@NotNull MemorySegment segment) implements IVkPipelineCoverageToColorStateCreateInfoNV {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineCoverageToColorStateCreateInfoNV {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineCoverageToColorStateCreateInfoNV.BYTES, VkPipelineCoverageToColorStateCreateInfoNV.BYTES));
        }
    ...
    public @Unsigned @NativeType("VkBool32") int coverageToColorEnable() {
        return segment.get(LAYOUT$coverageToColorEnable, OFFSET$coverageToColorEnable);
    }

    public void coverageToColorEnable(@Unsigned @NativeType("VkBool32") int value) {

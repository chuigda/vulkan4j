...
///
/// The {@code allocate} ({@link VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures#allocate(Arena)}, {@link VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures#allocate(Arena, int)})

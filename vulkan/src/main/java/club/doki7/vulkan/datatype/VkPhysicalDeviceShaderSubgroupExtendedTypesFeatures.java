...
public record VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderSubgroupExtendedTypesFeatures {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceShaderSubgroupExtendedTypesFeatures {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures.BYTES, VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures.BYTES));
        }

...
public record VkMultiDrawInfoEXT(@NotNull MemorySegment segment) implements IVkMultiDrawInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkMultiDrawInfoEXT, Iterable<VkMultiDrawInfoEXT> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkMultiDrawInfoEXT.BYTES, VkMultiDrawInfoEXT.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkMultiDrawInfoEXT> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkMultiDrawInfoEXT.BYTES) > 0;
            }

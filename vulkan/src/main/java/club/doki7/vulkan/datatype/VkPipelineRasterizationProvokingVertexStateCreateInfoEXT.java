...
///
/// The {@code allocate} ({@link VkPipelineRasterizationProvokingVertexStateCreateInfoEXT#allocate(Arena)}, {@link VkPipelineRasterizationProvokingVertexStateCreateInfoEXT#allocate(Arena, int)})

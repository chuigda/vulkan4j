...
public record VkPipelineRasterizationProvokingVertexStateCreateInfoEXT(@NotNull MemorySegment segment) implements IVkPipelineRasterizationProvokingVertexStateCreateInfoEXT {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPipelineRasterizationProvokingVertexStateCreateInfoEXT {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPipelineRasterizationProvokingVertexStateCreateInfoEXT.BYTES, VkPipelineRasterizationProvokingVertexStateCreateInfoEXT.BYTES));
        }

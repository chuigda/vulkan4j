...
///
/// The {@code allocate} ({@link VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI#allocate(Arena)}, {@link VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI#allocate(Arena, int)})

...
public record VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI(@NotNull MemorySegment segment) implements IVkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI {
    ...
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI, Iterable<VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI> {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.BYTES, VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.BYTES));
        }
        ...
        public static final class Iter implements Iterator<VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI> {
            ...
            public boolean hasNext() {
                return (segment.byteSize() / VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI.BYTES) > 0;
            }

...
///
/// The {@code allocate} ({@link VkPhysicalDeviceImageProcessing2PropertiesQCOM#allocate(Arena)}, {@link VkPhysicalDeviceImageProcessing2PropertiesQCOM#allocate(Arena, int)})

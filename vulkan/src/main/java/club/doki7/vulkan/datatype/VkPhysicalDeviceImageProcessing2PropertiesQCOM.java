...
public record VkPhysicalDeviceImageProcessing2PropertiesQCOM(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageProcessing2PropertiesQCOM {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkPhysicalDeviceImageProcessing2PropertiesQCOM {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkPhysicalDeviceImageProcessing2PropertiesQCOM.BYTES, VkPhysicalDeviceImageProcessing2PropertiesQCOM.BYTES));
        }

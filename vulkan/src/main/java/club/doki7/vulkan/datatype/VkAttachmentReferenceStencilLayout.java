...
public record VkAttachmentReferenceStencilLayout(@NotNull MemorySegment segment) implements IVkAttachmentReferenceStencilLayout {
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IVkAttachmentReferenceStencilLayout {
        public long size() {
        ...
        public @NotNull Ptr reinterpret(long index) {
            return new Ptr(segment.asSlice(index * VkAttachmentReferenceStencilLayout.BYTES, VkAttachmentReferenceStencilLayout.BYTES));
        }

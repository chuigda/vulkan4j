...
///
/// The {@code allocate} ({@link VkPipelineViewportDepthClipControlCreateInfoEXT#allocate(Arena)}, {@link VkPipelineViewportDepthClipControlCreateInfoEXT#allocate(Arena, int)})
